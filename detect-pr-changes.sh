...
do  
  ...
  then
    echo -e "\e[32m$api is new\e[0m"
  elif [[ ! -d apis/$api/$api ]]
  then
    echo -e "\e[32m$api was deleted\e[0m"
  else
    echo -e "\e[32mChecking $api for changes\e[0m"
...
echo ""
echo "\e[32mChecking compatibility with previous releases\e[0m"
echo ""
