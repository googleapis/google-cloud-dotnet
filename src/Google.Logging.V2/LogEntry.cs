...
namespace Google.Logging.V2 {
  ...
  public sealed partial class LogEntry : pb::IMessage<LogEntry> {
    ...
    private global::Google.Logging.V2.LogEntryOperation operation_;
    /// <summary>
    ...
    public void MergeFrom(LogEntry other) {
      ...
      if (other.httpRequest_ != null) {
        if (httpRequest_ == null) {
          httpRequest_ = new global::Google.Logging.Type.HttpRequest();
        }
      ...
      if (other.operation_ != null) {
        if (operation_ == null) {
          operation_ = new global::Google.Logging.V2.LogEntryOperation();
        }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 80: {
            severity_ = (global::Google.Logging.Type.LogSeverity) input.ReadEnum();
            break;
          }
          case 90: {
