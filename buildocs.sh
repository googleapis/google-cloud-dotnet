...
# The repo is cloned into a fresh "releasedocs" directory.
...
do
  rm -r ./releasedocs/docs/$project
  mv ./releasebuild/docs/output/assembled/$project ./releasedocs/docs
done

rm -r ./releasedocs/index.html
mv ./releasebuild/docs/output/assembled/index.html ./releasedocs
