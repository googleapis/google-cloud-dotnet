...
{
    // [START run_v2_generated_Tasks_ListTasks_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedTasksClientSnippets
    {
        ...
        public void ListTasksResourceNames()
        {
            ...
            // Make the request
            PagedEnumerable<ListTasksResponse, Task> response = tasksClient.ListTasks(parent);
    ...
    // [END run_v2_generated_Tasks_ListTasks_sync_flattened_resourceNames]
}
