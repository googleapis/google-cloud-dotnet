...
namespace Google.Cloud.Run.V2
{
    ...
    public sealed partial class JobsClientBuilder : gaxgrpc::ClientBuilderBase<JobsClient>
    {
        ...
        private JobsClient BuildImpl()
        {
            ...
            return JobsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class JobsClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Jobs.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
    ...
    public sealed partial class JobsClientImpl : JobsClient
    {
        ...
        public JobsClientImpl(Jobs.JobsClient grpcClient, JobsSettings settings, mel::ILogger logger)
        {
            ...
            _callUpdateJob = clientHelper.BuildApiCall<UpdateJobRequest, lro::Operation>("UpdateJob", grpcClient.UpdateJobAsync, grpcClient.UpdateJob, effectiveSettings.UpdateJobSettings).WithGoogleRequestParam("job.name", request => request.Job?.Name);
            ...
            _callRunJob = clientHelper.BuildApiCall<RunJobRequest, lro::Operation>("RunJob", grpcClient.RunJobAsync, grpcClient.RunJob, effectiveSettings.RunJobSettings).WithGoogleRequestParam("name", request => request.Name);
