...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task GetUserWorkloadsConfigMapRequestObjectAsync()
        {
            ...
            GetUserWorkloadsConfigMapRequest request = new GetUserWorkloadsConfigMapRequest
            {
            ...
            // Make the request
            UserWorkloadsConfigMap response = await environmentsClient.GetUserWorkloadsConfigMapAsync(request);
        }
    }
