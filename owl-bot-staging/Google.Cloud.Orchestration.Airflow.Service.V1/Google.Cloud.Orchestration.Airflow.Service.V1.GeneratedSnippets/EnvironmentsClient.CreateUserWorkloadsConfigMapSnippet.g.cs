...
{
    // [START composer_v1_generated_Environments_CreateUserWorkloadsConfigMap_sync_flattened]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public void CreateUserWorkloadsConfigMap()
        {
            ...
            // Make the request
            UserWorkloadsConfigMap response = environmentsClient.CreateUserWorkloadsConfigMap(parent, userWorkloadsConfigMap);
        }
    }
    // [END composer_v1_generated_Environments_CreateUserWorkloadsConfigMap_sync_flattened]
}
