...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public void DatabaseFailoverRequestObject()
        {
            ...
            // Make the request
            Operation<DatabaseFailoverResponse, OperationMetadata> response = environmentsClient.DatabaseFailover(request);

            // Poll until the returned long-running operation is complete
            Operation<DatabaseFailoverResponse, OperationMetadata> completedResponse = response.PollUntilCompleted();
            ...
            Operation<DatabaseFailoverResponse, OperationMetadata> retrievedResponse = environmentsClient.PollOnceDatabaseFailover(operationName);
