...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task UpdateUserWorkloadsSecretRequestObjectAsync()
        {
            ...
            UpdateUserWorkloadsSecretRequest request = new UpdateUserWorkloadsSecretRequest
            {
                UserWorkloadsSecret = new UserWorkloadsSecret(),
            };
            // Make the request
            UserWorkloadsSecret response = await environmentsClient.UpdateUserWorkloadsSecretAsync(request);
        }
    }
