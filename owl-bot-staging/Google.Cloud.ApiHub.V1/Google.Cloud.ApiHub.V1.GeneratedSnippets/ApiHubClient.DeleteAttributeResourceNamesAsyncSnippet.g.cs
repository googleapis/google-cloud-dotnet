...
{
    // [START apihub_v1_generated_ApiHub_DeleteAttribute_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task DeleteAttributeResourceNamesAsync()
        {
            ...
            AttributeName name = AttributeName.FromProjectLocationAttribute("[PROJECT]", "[LOCATION]", "[ATTRIBUTE]");
            // Make the request
            await apiHubClient.DeleteAttributeAsync(name);
        }
    }
    // [END apihub_v1_generated_ApiHub_DeleteAttribute_async_flattened_resourceNames]
}
