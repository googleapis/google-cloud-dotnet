...
{
    // [START apihub_v1_generated_ApiHub_SearchResources_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public void SearchResourcesResourceNames()
        {
            ...
            string query = "";
            // Make the request
            PagedEnumerable<SearchResourcesResponse, SearchResult> response = apiHubClient.SearchResources(location, query);
            ...
            foreach (SearchResourcesResponse page in response.AsRawResponses())
            {
    ...
    // [END apihub_v1_generated_ApiHub_SearchResources_sync_flattened_resourceNames]
}
