...
{
    // [START apihub_v1_generated_ApiHub_CreateVersion_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task CreateVersionResourceNamesAsync()
        {
            ...
            string versionId = "";
            // Make the request
            Version response = await apiHubClient.CreateVersionAsync(parent, version, versionId);
        }
    }
    // [END apihub_v1_generated_ApiHub_CreateVersion_async_flattened_resourceNames]
}
