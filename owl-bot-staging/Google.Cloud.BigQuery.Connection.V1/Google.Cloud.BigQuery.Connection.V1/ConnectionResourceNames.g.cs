...
namespace Google.Cloud.BigQuery.Connection.V1
{
    ...
    public sealed partial class ClusterName : gax::IResourceName, sys::IEquatable<ClusterName>
    {
        ...
        public static ClusterName FromProjectRegionCluster(string projectId, string regionId, string clusterId) =>
            new ClusterName(ResourceNameType.ProjectRegionCluster, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), regionId: gax::GaxPreconditions.CheckNotNullOrEmpty(regionId, nameof(regionId)), clusterId: gax::GaxPreconditions.CheckNotNullOrEmpty(clusterId, nameof(clusterId)));
        ...
        public static bool TryParse(string clusterName, bool allowUnparsed, out ClusterName result)
        {
            ...
            gax::TemplatedResourceName resourceName;
            if (s_projectRegionCluster.TryParseName(clusterName, out resourceName))
            {
        ...
        private ClusterName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string clusterId = null, string projectId = null, string regionId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            ClusterId = clusterId;
        ...
        /// <param name="regionId">The <c>Region</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="clusterId">The <c>Cluster</c> ID. Must not be <c>null</c> or empty.</param>
        public ClusterName(string projectId, string regionId, string clusterId) : this(ResourceNameType.ProjectRegionCluster, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), regionId: gax::GaxPreconditions.CheckNotNullOrEmpty(regionId, nameof(regionId)), clusterId: gax::GaxPreconditions.CheckNotNullOrEmpty(clusterId, nameof(clusterId)))
        {
        }
    ...
    public partial class MetastoreServiceConfig
    {
        /// <summary>
        /// <see cref="ServiceName"/>-typed view over the <see cref="MetastoreService"/> resource name property.
        /// </summary>
        public ServiceName MetastoreServiceAsServiceName
        {
            get => string.IsNullOrEmpty(MetastoreService) ? null : ServiceName.Parse(MetastoreService, allowUnparsed: true);
            set => MetastoreService = value?.ToString() ?? "";
        }
    }

    public partial class SparkHistoryServerConfig
    {
        /// <summary>
        /// <see cref="ClusterName"/>-typed view over the <see cref="DataprocCluster"/> resource name property.
        /// </summary>
        public ClusterName DataprocClusterAsClusterName
        {
            get => string.IsNullOrEmpty(DataprocCluster) ? null : ClusterName.Parse(DataprocCluster, allowUnparsed: true);
            set => DataprocCluster = value?.ToString() ?? "";
        }
    }
}
