...
{
    // [START notebooks_v1_generated_NotebookService_GetEnvironment_async_flattened]
    ...
    public sealed partial class GeneratedNotebookServiceClientSnippets
    {
        ...
        public async Task GetEnvironmentAsync()
        {
            ...
            string name = "";
            // Make the request
            Environment response = await notebookServiceClient.GetEnvironmentAsync(name);
        }
    }
    // [END notebooks_v1_generated_NotebookService_GetEnvironment_async_flattened]
}
