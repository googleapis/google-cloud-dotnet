...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_BatchDeleteVersions_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public void BatchDeleteVersionsResourceNames()
        {
            ...
            PackageName parent = PackageName.FromProjectLocationRepositoryPackage("[PROJECT]", "[LOCATION]", "[REPOSITORY]", "[PACKAGE]");
            IEnumerable<VersionName> names = new VersionName[]
            {
    ...
    // [END artifactregistry_v1_generated_ArtifactRegistry_BatchDeleteVersions_sync_flattened_resourceNames]
}
