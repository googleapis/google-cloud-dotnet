...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_GetRule_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public void GetRuleResourceNames()
        {
            ...
            RuleName name = RuleName.FromProjectLocationRepositoryRule("[PROJECT]", "[LOCATION]", "[REPOSITORY]", "[RULE]");
            // Make the request
            Rule response = artifactRegistryClient.GetRule(name);
        }
    }
    // [END artifactregistry_v1_generated_ArtifactRegistry_GetRule_sync_flattened_resourceNames]
}
