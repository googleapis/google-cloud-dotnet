...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task DeleteFileRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = await artifactRegistryClient.DeleteFileAsync(request);
            ...
            Operation<Empty, OperationMetadata> retrievedResponse = await artifactRegistryClient.PollOnceDeleteFileAsync(operationName);
