...
namespace Google.Cloud.ApiKeys.V2
{
    ...
    public sealed partial class ApiKeysClientBuilder : gaxgrpc::ClientBuilderBase<ApiKeysClient>
    {
        ...
        private ApiKeysClient BuildImpl()
        {
            ...
            return ApiKeysClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ApiKeysClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ApiKeys.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
