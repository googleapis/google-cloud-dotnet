...
namespace Google.Cloud.Bigtable.V2
{
    ...
    public sealed partial class BigtableSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to <c>BigtableClient.PingAndWarm</c>
        ///  and <c>BigtableClient.PingAndWarmAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>BigtableClient.GenerateInitialChangeStreamPartitions</c> and
        /// <c>BigtableClient.GenerateInitialChangeStreamPartitionsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>BigtableClient.ReadChangeStream</c> and <c>BigtableClient.ReadChangeStreamAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
    ...
    public sealed partial class BigtableClientBuilder : gaxgrpc::ClientBuilderBase<BigtableClient>
    {
        ...
        public BigtableClientBuilder() : base(BigtableClient.ServiceMetadata)
        {
        }
        ...
        private BigtableClient BuildImpl()
        {
            ...
            return BigtableClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class BigtableClient
    {
        ...
        /// <returns>The created <see cref="BigtableClient"/>.</returns>
        internal static BigtableClient Create(grpccore::CallInvoker callInvoker, BigtableSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new BigtableClientImpl(grpcClient, settings, logger);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The server stream.</returns>
        public virtual GenerateInitialChangeStreamPartitionsStream GenerateInitialChangeStreamPartitions(TableName tableName, gaxgrpc::CallSettings callSettings = null) =>
            GenerateInitialChangeStreamPartitions(new GenerateInitialChangeStreamPartitionsRequest
            {
                TableNameAsTableName = gax::GaxPreconditions.CheckNotNull(tableName, nameof(tableName)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The server stream.</returns>
        public virtual GenerateInitialChangeStreamPartitionsStream GenerateInitialChangeStreamPartitions(TableName tableName, string appProfileId, gaxgrpc::CallSettings callSettings = null) =>
            GenerateInitialChangeStreamPartitions(new GenerateInitialChangeStreamPartitionsRequest
            {
                TableNameAsTableName = gax::GaxPreconditions.CheckNotNull(tableName, nameof(tableName)),
                AppProfileId = appProfileId ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The server stream.</returns>
        public virtual ReadChangeStreamStream ReadChangeStream(TableName tableName, gaxgrpc::CallSettings callSettings = null) =>
            ReadChangeStream(new ReadChangeStreamRequest
            {
                TableNameAsTableName = gax::GaxPreconditions.CheckNotNull(tableName, nameof(tableName)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The server stream.</returns>
        public virtual ReadChangeStreamStream ReadChangeStream(TableName tableName, string appProfileId, gaxgrpc::CallSettings callSettings = null) =>
            ReadChangeStream(new ReadChangeStreamRequest
            {
                TableNameAsTableName = gax::GaxPreconditions.CheckNotNull(tableName, nameof(tableName)),
                AppProfileId = appProfileId ?? "",
    ...
    public sealed partial class BigtableClientImpl : BigtableClient
    {
        ...
        public BigtableClientImpl(Bigtable.BigtableClient grpcClient, BigtableSettings settings, mel::ILogger logger)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The server stream.</returns>
        public override BigtableClient.GenerateInitialChangeStreamPartitionsStream GenerateInitialChangeStreamPartitions(GenerateInitialChangeStreamPartitionsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The server stream.</returns>
        public override BigtableClient.ReadChangeStreamStream ReadChangeStream(ReadChangeStreamRequest request, gaxgrpc::CallSettings callSettings = null)
        {
