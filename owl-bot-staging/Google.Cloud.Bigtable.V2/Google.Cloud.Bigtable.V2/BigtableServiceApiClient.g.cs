...
namespace Google.Cloud.Bigtable.V2
{
    ...
    public abstract partial class BigtableServiceApiClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The server stream.</returns>
        public virtual ExecuteQueryStream ExecuteQuery(InstanceName instanceName, string query, gaxgrpc::CallSettings callSettings = null) =>
            ExecuteQuery(new ExecuteQueryRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The server stream.</returns>
        public virtual ExecuteQueryStream ExecuteQuery(InstanceName instanceName, string query, string appProfileId, gaxgrpc::CallSettings callSettings = null) =>
            ExecuteQuery(new ExecuteQueryRequest
            {
                InstanceNameAsInstanceName = gax::GaxPreconditions.CheckNotNull(instanceName, nameof(instanceName)),
                AppProfileId = appProfileId ?? "",
