...
namespace Google.Cloud.Bigtable.V2.Snippets
{
    ...
    public sealed class AllGeneratedBigtableClientSnippets
    {
        ...
        public void PingAndWarmRequestObject()
        {
            ...
            // Make the request
            PingAndWarmResponse response = bigtableClient.PingAndWarm(request);
            // End snippet
        }
        ...
        public async Task PingAndWarmRequestObjectAsync()
        {
            ...
            // Make the request
            PingAndWarmResponse response = await bigtableClient.PingAndWarmAsync(request);
            // End snippet
        }
        ...
        public void PingAndWarm1()
        {
            ...
            // Make the request
            PingAndWarmResponse response = bigtableClient.PingAndWarm(name);
            // End snippet
        }
        ...
        public async Task PingAndWarm1Async()
        {
            ...
            string name = "projects/[PROJECT]/instances/[INSTANCE]";
            // Make the request
            PingAndWarmResponse response = await bigtableClient.PingAndWarmAsync(name);
            // End snippet
        }
        ...
        public void PingAndWarm2()
        {
            ...
            string appProfileId = "";
            // Make the request
            PingAndWarmResponse response = bigtableClient.PingAndWarm(name, appProfileId);
            // End snippet
        }
        ...
        public async Task PingAndWarm2Async()
        {
            ...
            string appProfileId = "";
            // Make the request
            PingAndWarmResponse response = await bigtableClient.PingAndWarmAsync(name, appProfileId);
            // End snippet
        }
        ...
        public async Task GenerateInitialChangeStreamPartitionsRequestObject()
        {
            ...
            // Make the request, returning a streaming response
            BigtableClient.GenerateInitialChangeStreamPartitionsStream response = bigtableClient.GenerateInitialChangeStreamPartitions(request);
        ...
        public async Task GenerateInitialChangeStreamPartitions1()
        {
            ...
            string tableName = "projects/[PROJECT]/instances/[INSTANCE]/tables/[TABLE]";
            // Make the request, returning a streaming response
            BigtableClient.GenerateInitialChangeStreamPartitionsStream response = bigtableClient.GenerateInitialChangeStreamPartitions(tableName);
        ...
        public async Task GenerateInitialChangeStreamPartitions2()
        {
            ...
            string appProfileId = "";
            // Make the request, returning a streaming response
            BigtableClient.GenerateInitialChangeStreamPartitionsStream response = bigtableClient.GenerateInitialChangeStreamPartitions(tableName, appProfileId);
        ...
        public async Task ReadChangeStreamRequestObject()
        {
            ...
            // Make the request, returning a streaming response
            BigtableClient.ReadChangeStreamStream response = bigtableClient.ReadChangeStream(request);
        ...
        public async Task ReadChangeStream1()
        {
            ...
            string tableName = "projects/[PROJECT]/instances/[INSTANCE]/tables/[TABLE]";
            // Make the request, returning a streaming response
            BigtableClient.ReadChangeStreamStream response = bigtableClient.ReadChangeStream(tableName);
        ...
        public async Task ReadChangeStream2()
        {
            ...
            string appProfileId = "";
            // Make the request, returning a streaming response
            BigtableClient.ReadChangeStreamStream response = bigtableClient.ReadChangeStream(tableName, appProfileId);
