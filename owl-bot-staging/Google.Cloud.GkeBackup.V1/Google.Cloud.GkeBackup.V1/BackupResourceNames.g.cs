...
namespace Google.Cloud.GkeBackup.V1
{
    ...
    public sealed partial class BackupName : gax::IResourceName, sys::IEquatable<BackupName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/backupPlans/{backup_plan}/backups/{backup}</c>.
            /// </summary>
            ProjectLocationBackupPlanBackup = 1,
        }

        private static gax::PathTemplate s_projectLocationBackupPlanBackup = new gax::PathTemplate("projects/{project}/locations/{location}/backupPlans/{backup_plan}/backups/{backup}");
        ...
        public static BackupName FromProjectLocationBackupPlanBackup(string projectId, string locationId, string backupPlanId, string backupId) =>
            new BackupName(ResourceNameType.ProjectLocationBackupPlanBackup, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), backupPlanId: gax::GaxPreconditions.CheckNotNullOrEmpty(backupPlanId, nameof(backupPlanId)), backupId: gax::GaxPreconditions.CheckNotNullOrEmpty(backupId, nameof(backupId)));
        ...
        /// <c>projects/{project}/locations/{location}/backupPlans/{backup_plan}/backups/{backup}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string backupPlanId, string backupId) =>
            FormatProjectLocationBackupPlanBackup(projectId, locationId, backupPlanId, backupId);
        ...
        /// <c>projects/{project}/locations/{location}/backupPlans/{backup_plan}/backups/{backup}</c>.
        /// </returns>
        public static string FormatProjectLocationBackupPlanBackup(string projectId, string locationId, string backupPlanId, string backupId) =>
            s_projectLocationBackupPlanBackup.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(backupPlanId, nameof(backupPlanId)), gax::GaxPreconditions.CheckNotNullOrEmpty(backupId, nameof(backupId)));
        ...
        public static bool TryParse(string backupName, bool allowUnparsed, out BackupName result)
        {
            ...
            if (s_projectLocationBackupPlanBackup.TryParseName(backupName, out resourceName))
            {
                result = FromProjectLocationBackupPlanBackup(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private BackupName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string backupId = null, string backupPlanId = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="backupPlanId">The <c>BackupPlan</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="backupId">The <c>Backup</c> ID. Must not be <c>null</c> or empty.</param>
        public BackupName(string projectId, string locationId, string backupPlanId, string backupId) : this(ResourceNameType.ProjectLocationBackupPlanBackup, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), backupPlanId: gax::GaxPreconditions.CheckNotNullOrEmpty(backupPlanId, nameof(backupPlanId)), backupId: gax::GaxPreconditions.CheckNotNullOrEmpty(backupId, nameof(backupId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationBackupPlanBackup: return s_projectLocationBackupPlanBackup.Expand(ProjectId, LocationId, BackupPlanId, BackupId);
