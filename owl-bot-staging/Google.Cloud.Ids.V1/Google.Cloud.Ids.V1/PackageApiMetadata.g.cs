...
namespace Google.Cloud.Ids.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.Ids.V1", GetFileDescriptors)
        ...
        {
            yield return IdsReflection.Descriptor;
