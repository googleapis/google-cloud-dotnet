...
namespace Google.Shopping.Merchant.Accounts.V1Beta
{
    ...
    public sealed partial class EmailPreferencesServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetEmailPreferencesSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UpdateEmailPreferencesSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
