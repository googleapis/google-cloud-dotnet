...
namespace Google.Cloud.TelcoAutomation.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.TelcoAutomation.V1", GetFileDescriptors)
            ...
            .WithHttpRuleOverrides(new scg::Dictionary<string, proto::ByteString>
            {
                ...
                },
                {
                    ...
                    // { "get": "/v1/{name=projects/*/locations}" }
                    proto::ByteString.FromBase64("Eh8vdjEve25hbWU9cHJvamVjdHMvKi9sb2NhdGlvbnN9")
                },
                {
                ...
                },
                {
                    ...
                    // { "get": "/v1/{name=projects/*/locations/*/operations}" }
                    proto::ByteString.FromBase64("EiwvdjEve25hbWU9cHJvamVjdHMvKi9sb2NhdGlvbnMvKi9vcGVyYXRpb25zfQ==")
                },
            });
        ...
        private static scg::IEnumerable<gpr::FileDescriptor> GetFileDescriptors()
        {
            ...
            yield return TelcoautomationReflection.Descriptor;
