...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedDatastreamClientSnippets
    {
        ...
        {
            // Snippet: GetStreamObject(GetStreamObjectRequest, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for GetStreamObjectAsync</summary>
        public async Task GetStreamObjectRequestObjectAsync()
        {
            // Snippet: GetStreamObjectAsync(GetStreamObjectRequest, CallSettings)
            // Additional: GetStreamObjectAsync(GetStreamObjectRequest, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            GetStreamObjectRequest request = new GetStreamObjectRequest
        ...
        {
            // Snippet: GetStreamObject(string, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for GetStreamObjectAsync</summary>
        public async Task GetStreamObjectAsync()
        {
            // Snippet: GetStreamObjectAsync(string, CallSettings)
            // Additional: GetStreamObjectAsync(string, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/streams/[STREAM]/objects/[OBJECT]";
        ...
        {
            // Snippet: GetStreamObject(StreamObjectName, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for GetStreamObjectAsync</summary>
        public async Task GetStreamObjectResourceNamesAsync()
        {
            // Snippet: GetStreamObjectAsync(StreamObjectName, CallSettings)
            // Additional: GetStreamObjectAsync(StreamObjectName, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            StreamObjectName name = StreamObjectName.FromProjectLocationStreamObject("[PROJECT]", "[LOCATION]", "[STREAM]", "[OBJECT]");
        ...
        /// <summary>Snippet for LookupStreamObject</summary>
        public void LookupStreamObjectRequestObject()
        {
            // Snippet: LookupStreamObject(LookupStreamObjectRequest, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for LookupStreamObjectAsync</summary>
        public async Task LookupStreamObjectRequestObjectAsync()
        {
            // Snippet: LookupStreamObjectAsync(LookupStreamObjectRequest, CallSettings)
            // Additional: LookupStreamObjectAsync(LookupStreamObjectRequest, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            LookupStreamObjectRequest request = new LookupStreamObjectRequest
        ...
        /// <summary>Snippet for ListStreamObjects</summary>
        public void ListStreamObjectsRequestObject()
        {
            // Snippet: ListStreamObjects(ListStreamObjectsRequest, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for ListStreamObjectsAsync</summary>
        public async Task ListStreamObjectsRequestObjectAsync()
        {
            // Snippet: ListStreamObjectsAsync(ListStreamObjectsRequest, CallSettings)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            ListStreamObjectsRequest request = new ListStreamObjectsRequest
        ...
        {
            // Snippet: ListStreamObjects(string, string, int?, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for ListStreamObjectsAsync</summary>
        public async Task ListStreamObjectsAsync()
        {
            // Snippet: ListStreamObjectsAsync(string, string, int?, CallSettings)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]/streams/[STREAM]";
        ...
        /// <summary>Snippet for ListStreamObjects</summary>
        public void ListStreamObjectsResourceNames()
        {
            // Snippet: ListStreamObjects(StreamName, string, int?, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for ListStreamObjectsAsync</summary>
        public async Task ListStreamObjectsResourceNamesAsync()
        {
            // Snippet: ListStreamObjectsAsync(StreamName, string, int?, CallSettings)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            StreamName parent = StreamName.FromProjectLocationStream("[PROJECT]", "[LOCATION]", "[STREAM]");
        ...
        /// <summary>Snippet for StartBackfillJob</summary>
        public void StartBackfillJobRequestObject()
        {
            // Snippet: StartBackfillJob(StartBackfillJobRequest, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for StartBackfillJobAsync</summary>
        public async Task StartBackfillJobRequestObjectAsync()
        {
            // Snippet: StartBackfillJobAsync(StartBackfillJobRequest, CallSettings)
            // Additional: StartBackfillJobAsync(StartBackfillJobRequest, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            StartBackfillJobRequest request = new StartBackfillJobRequest
        ...
        {
            // Snippet: StartBackfillJob(string, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for StartBackfillJobAsync</summary>
        public async Task StartBackfillJobAsync()
        {
            // Snippet: StartBackfillJobAsync(string, CallSettings)
            // Additional: StartBackfillJobAsync(string, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            string @object = "projects/[PROJECT]/locations/[LOCATION]/streams/[STREAM]/objects/[OBJECT]";
        ...
        {
            // Snippet: StartBackfillJob(StreamObjectName, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for StartBackfillJobAsync</summary>
        public async Task StartBackfillJobResourceNamesAsync()
        {
            // Snippet: StartBackfillJobAsync(StreamObjectName, CallSettings)
            // Additional: StartBackfillJobAsync(StreamObjectName, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            StreamObjectName @object = StreamObjectName.FromProjectLocationStreamObject("[PROJECT]", "[LOCATION]", "[STREAM]", "[OBJECT]");
        ...
        {
            // Snippet: StopBackfillJob(StopBackfillJobRequest, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for StopBackfillJobAsync</summary>
        public async Task StopBackfillJobRequestObjectAsync()
        {
            // Snippet: StopBackfillJobAsync(StopBackfillJobRequest, CallSettings)
            // Additional: StopBackfillJobAsync(StopBackfillJobRequest, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            StopBackfillJobRequest request = new StopBackfillJobRequest
        ...
        {
            // Snippet: StopBackfillJob(string, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
            string @object = "projects/[PROJECT]/locations/[LOCATION]/streams/[STREAM]/objects/[OBJECT]";
        ...
        /// <summary>Snippet for StopBackfillJobAsync</summary>
        public async Task StopBackfillJobAsync()
        {
            // Snippet: StopBackfillJobAsync(string, CallSettings)
            // Additional: StopBackfillJobAsync(string, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            string @object = "projects/[PROJECT]/locations/[LOCATION]/streams/[STREAM]/objects/[OBJECT]";
        ...
        {
            // Snippet: StopBackfillJob(StreamObjectName, CallSettings)
            // Create client
            DatastreamClient datastreamClient = DatastreamClient.Create();
            // Initialize request argument(s)
            StreamObjectName @object = StreamObjectName.FromProjectLocationStreamObject("[PROJECT]", "[LOCATION]", "[STREAM]", "[OBJECT]");
        ...
        /// <summary>Snippet for StopBackfillJobAsync</summary>
        public async Task StopBackfillJobResourceNamesAsync()
        {
            // Snippet: StopBackfillJobAsync(StreamObjectName, CallSettings)
            // Additional: StopBackfillJobAsync(StreamObjectName, CancellationToken)
            // Create client
            DatastreamClient datastreamClient = await DatastreamClient.CreateAsync();
            // Initialize request argument(s)
            StreamObjectName @object = StreamObjectName.FromProjectLocationStreamObject("[PROJECT]", "[LOCATION]", "[STREAM]", "[OBJECT]");
