...
namespace Google.Ads.AdManager.V1
{
    ...
    public partial class RunReportMetadata
    {
        /// <summary><see cref="ReportName"/>-typed view over the <see cref="Report"/> resource name property.</summary>
        public ReportName ReportAsReportName
        {
            get => string.IsNullOrEmpty(Report) ? null : ReportName.Parse(Report, allowUnparsed: true);
            set => Report = value?.ToString() ?? "";
        }
    }
