...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedBatchServiceClientSnippets
    {
        ...
        public void ListResourceAllowancesResourceNames()
        {
            ...
            // Make the request
            PagedEnumerable<ListResourceAllowancesResponse, ResourceAllowance> response = batchServiceClient.ListResourceAllowances(parent);
            ...
            int pageSize = 10;
            Page<ResourceAllowance> singlePage = response.ReadPage(pageSize);
