...
{
    // [START dialogflow_v3_generated_Generators_DeleteGenerator_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedGeneratorsClientSnippets
    {
        ...
        public async Task DeleteGeneratorResourceNamesAsync()
        {
            ...
            GeneratorName name = GeneratorName.FromProjectLocationAgentGenerator("[PROJECT]", "[LOCATION]", "[AGENT]", "[GENERATOR]");
            // Make the request
            await generatorsClient.DeleteGeneratorAsync(name);
        }
    }
    // [END dialogflow_v3_generated_Generators_DeleteGenerator_async_flattened_resourceNames]
}
