...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedGeneratorsClientSnippets
    {
        ...
        {
            // Snippet: ListGenerators(AgentName, string, int?, CallSettings)
            // Create client
            GeneratorsClient generatorsClient = GeneratorsClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: ListGeneratorsAsync(AgentName, string, int?, CallSettings)
            // Create client
            GeneratorsClient generatorsClient = await GeneratorsClient.CreateAsync();
            // Initialize request argument(s)
            AgentName parent = AgentName.FromProjectLocationAgent("[PROJECT]", "[LOCATION]", "[AGENT]");
        ...
        {
            // Snippet: CreateGenerator(string, Generator, CallSettings)
            // Create client
            GeneratorsClient generatorsClient = GeneratorsClient.Create();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]/agents/[AGENT]";
        ...
        {
            // Snippet: CreateGeneratorAsync(string, Generator, CallSettings)
            // Additional: CreateGeneratorAsync(string, Generator, CancellationToken)
            // Create client
            GeneratorsClient generatorsClient = await GeneratorsClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]/agents/[AGENT]";
        ...
        {
            // Snippet: CreateGenerator(AgentName, Generator, CallSettings)
            // Create client
            GeneratorsClient generatorsClient = GeneratorsClient.Create();
            // Initialize request argument(s)
            AgentName parent = AgentName.FromProjectLocationAgent("[PROJECT]", "[LOCATION]", "[AGENT]");
        ...
        {
            // Snippet: CreateGeneratorAsync(AgentName, Generator, CallSettings)
            // Additional: CreateGeneratorAsync(AgentName, Generator, CancellationToken)
            // Create client
            GeneratorsClient generatorsClient = await GeneratorsClient.CreateAsync();
            // Initialize request argument(s)
            AgentName parent = AgentName.FromProjectLocationAgent("[PROJECT]", "[LOCATION]", "[AGENT]");
