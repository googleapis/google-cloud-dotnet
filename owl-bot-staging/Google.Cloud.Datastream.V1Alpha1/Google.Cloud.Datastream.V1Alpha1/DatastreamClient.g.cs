...
namespace Google.Cloud.Datastream.V1Alpha1
{
    ...
    public sealed partial class DatastreamSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private DatastreamSettings(DatastreamSettings existing) : base(existing)
        {
            ...
            FetchErrorsSettings = existing.FetchErrorsSettings;
            FetchErrorsOperationsSettings = existing.FetchErrorsOperationsSettings.Clone();
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DatastreamClient.FetchErrors</c> and <c>DatastreamClient.FetchErrorsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 1000 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings FetchErrorsSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 5, initialBackoff: sys::TimeSpan.FromMilliseconds(1000), maxBackoff: sys::TimeSpan.FromMilliseconds(10000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable)));

        /// <summary>
        /// Long Running Operation settings for calls to <c>DatastreamClient.FetchErrors</c> and
        /// <c>DatastreamClient.FetchErrorsAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public lro::OperationsSettings FetchErrorsOperationsSettings { get; set; } = new lro::OperationsSettings
        {
            DefaultPollSettings = new gax::PollSettings(gax::Expiration.FromTimeout(sys::TimeSpan.FromHours(24)), sys::TimeSpan.FromSeconds(20), 1.5, sys::TimeSpan.FromSeconds(45)),
        };
    ...
    public abstract partial class DatastreamClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<FetchErrorsResponse, OperationMetadata> FetchErrors(FetchErrorsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<FetchErrorsResponse, OperationMetadata>> FetchErrorsAsync(FetchErrorsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<FetchErrorsResponse, OperationMetadata>> FetchErrorsAsync(FetchErrorsRequest request, st::CancellationToken cancellationToken) =>
            FetchErrorsAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));

        /// <summary>The long-running operations client for <c>FetchErrors</c>.</summary>
        public virtual lro::OperationsClient FetchErrorsOperationsClient => throw new sys::NotImplementedException();

        /// <summary>
        /// Poll an operation once, using an <c>operationName</c> from a previous invocation of <c>FetchErrors</c>.
        /// </summary>
        /// <param name="operationName">
        /// The name of a previously invoked operation. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The result of polling the operation.</returns>
        public virtual lro::Operation<FetchErrorsResponse, OperationMetadata> PollOnceFetchErrors(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<FetchErrorsResponse, OperationMetadata>.PollOnceFromName(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), FetchErrorsOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A task representing the result of polling the operation.</returns>
        public virtual stt::Task<lro::Operation<FetchErrorsResponse, OperationMetadata>> PollOnceFetchErrorsAsync(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<FetchErrorsResponse, OperationMetadata>.PollOnceFromNameAsync(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), FetchErrorsOperationsClient, callSettings);
    ...
    public sealed partial class DatastreamClientImpl : DatastreamClient
    {
        ...
        private readonly gaxgrpc::ApiCall<FetchErrorsRequest, lro::Operation> _callFetchErrors;
        ...
        public DatastreamClientImpl(Datastream.DatastreamClient grpcClient, DatastreamSettings settings, mel::ILogger logger)
        {
            ...
            FetchErrorsOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.FetchErrorsOperationsSettings, logger);
            ...
            _callFetchErrors = clientHelper.BuildApiCall<FetchErrorsRequest, lro::Operation>("FetchErrors", grpcClient.FetchErrorsAsync, grpcClient.FetchErrors, effectiveSettings.FetchErrorsSettings).WithGoogleRequestParam("stream", request => request.Stream);
            Modify_ApiCall(ref _callFetchErrors);
            Modify_FetchErrorsApiCall(ref _callFetchErrors);
        ...
        partial void Modify_FetchErrorsApiCall(ref gaxgrpc::ApiCall<FetchErrorsRequest, lro::Operation> call);
        ...
        partial void Modify_FetchErrorsRequest(ref FetchErrorsRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <summary>The long-running operations client for <c>FetchErrors</c>.</summary>
        public override lro::OperationsClient FetchErrorsOperationsClient { get; }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<FetchErrorsResponse, OperationMetadata> FetchErrors(FetchErrorsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_FetchErrorsRequest(ref request, ref callSettings);
            return new lro::Operation<FetchErrorsResponse, OperationMetadata>(_callFetchErrors.Sync(request, callSettings), FetchErrorsOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<FetchErrorsResponse, OperationMetadata>> FetchErrorsAsync(FetchErrorsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_FetchErrorsRequest(ref request, ref callSettings);
            return new lro::Operation<FetchErrorsResponse, OperationMetadata>(await _callFetchErrors.Async(request, callSettings).ConfigureAwait(false), FetchErrorsOperationsClient);
        }
