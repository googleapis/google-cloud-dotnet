...
namespace Google.Cloud.Datastore.Admin.V1.Snippets
{
    ...
    public sealed partial class GeneratedDatastoreAdminClientSnippets
    {
        ...
        public async Task DeleteIndexRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Index, IndexOperationMetadata> response = await datastoreAdminClient.DeleteIndexAsync(request);
            ...
            Operation<Index, IndexOperationMetadata> retrievedResponse = await datastoreAdminClient.PollOnceDeleteIndexAsync(operationName);
