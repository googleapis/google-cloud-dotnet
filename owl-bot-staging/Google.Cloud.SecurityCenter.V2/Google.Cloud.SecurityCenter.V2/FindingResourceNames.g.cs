...
namespace Google.Cloud.SecurityCenter.V2
{
    ...
    public sealed partial class FindingName : gax::IResourceName, sys::IEquatable<FindingName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>organizations/{organization}/sources/{source}/locations/{location}/findings/{finding}</c>.
            /// </summary>
            OrganizationSourceLocationFinding = 2,

            /// <summary>
            /// A resource name with pattern <c>folders/{folder}/sources/{source}/findings/{finding}</c>.
            /// </summary>
            FolderSourceFinding = 3,

            /// <summary>
            /// A resource name with pattern
            /// <c>folders/{folder}/sources/{source}/locations/{location}/findings/{finding}</c>.
            /// </summary>
            FolderSourceLocationFinding = 4,

            /// <summary>
            /// A resource name with pattern <c>projects/{project}/sources/{source}/findings/{finding}</c>.
            /// </summary>
            ProjectSourceFinding = 5,

            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/sources/{source}/locations/{location}/findings/{finding}</c>.
            /// </summary>
            ProjectSourceLocationFinding = 6,
        }
        ...
        private static gax::PathTemplate s_organizationSourceLocationFinding = new gax::PathTemplate("organizations/{organization}/sources/{source}/locations/{location}/findings/{finding}");
        ...
        private static gax::PathTemplate s_folderSourceLocationFinding = new gax::PathTemplate("folders/{folder}/sources/{source}/locations/{location}/findings/{finding}");
        ...
        private static gax::PathTemplate s_projectSourceLocationFinding = new gax::PathTemplate("projects/{project}/sources/{source}/locations/{location}/findings/{finding}");
        ...
        /// <param name="findingId">The <c>Finding</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="FindingName"/> constructed from the provided ids.</returns>
        public static FindingName FromOrganizationSourceLocationFinding(string organizationId, string sourceId, string locationId, string findingId) =>
            new FindingName(ResourceNameType.OrganizationSourceLocationFinding, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), sourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), findingId: gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        /// <param name="findingId">The <c>Finding</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="FindingName"/> constructed from the provided ids.</returns>
        public static FindingName FromFolderSourceLocationFinding(string folderId, string sourceId, string locationId, string findingId) =>
            new FindingName(ResourceNameType.FolderSourceLocationFinding, folderId: gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), sourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), findingId: gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        /// <param name="findingId">The <c>Finding</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="FindingName"/> constructed from the provided ids.</returns>
        public static FindingName FromProjectSourceLocationFinding(string projectId, string sourceId, string locationId, string findingId) =>
            new FindingName(ResourceNameType.ProjectSourceLocationFinding, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), sourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), findingId: gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        /// <item>
        /// <description><c>folders/{folder}/sources/{source}/locations/{location}/findings/{finding}</c></description>
        /// </item>
        ...
        public static bool TryParse(string findingName, bool allowUnparsed, out FindingName result)
        {
            ...
            if (s_organizationSourceLocationFinding.TryParseName(findingName, out resourceName))
            {
            ...
            if (s_folderSourceLocationFinding.TryParseName(findingName, out resourceName))
            {
            ...
            if (s_projectSourceLocationFinding.TryParseName(findingName, out resourceName))
            {
        ...
        private FindingName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string findingId = null, string folderId = null, string locationId = null, string organizationId = null, string projectId = null, string sourceId = null)
        {
            Type = type;
