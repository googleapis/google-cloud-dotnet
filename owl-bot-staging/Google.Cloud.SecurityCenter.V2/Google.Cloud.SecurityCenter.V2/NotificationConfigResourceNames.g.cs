...
namespace Google.Cloud.SecurityCenter.V2
{
    ...
    public sealed partial class NotificationConfigName : gax::IResourceName, sys::IEquatable<NotificationConfigName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>organizations/{organization}/locations/{location}/notificationConfigs/{notification_config}</c>.
            /// </summary>
            OrganizationLocationNotificationConfig = 1,

            /// <summary>
            /// A resource name with pattern
            /// <c>folders/{folder}/locations/{location}/notificationConfigs/{notification_config}</c>.
            /// </summary>
            FolderLocationNotificationConfig = 2,

            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/notificationConfigs/{notification_config}</c>.
            /// </summary>
            ProjectLocationNotificationConfig = 3,
        }

        private static gax::PathTemplate s_organizationLocationNotificationConfig = new gax::PathTemplate("organizations/{organization}/locations/{location}/notificationConfigs/{notification_config}");

        private static gax::PathTemplate s_folderLocationNotificationConfig = new gax::PathTemplate("folders/{folder}/locations/{location}/notificationConfigs/{notification_config}");

        private static gax::PathTemplate s_projectLocationNotificationConfig = new gax::PathTemplate("projects/{project}/locations/{location}/notificationConfigs/{notification_config}");
        ...
        public static NotificationConfigName FromOrganizationLocationNotificationConfig(string organizationId, string locationId, string notificationConfigId) =>
            new NotificationConfigName(ResourceNameType.OrganizationLocationNotificationConfig, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), notificationConfigId: gax::GaxPreconditions.CheckNotNullOrEmpty(notificationConfigId, nameof(notificationConfigId)));
        ...
        /// </param>
        /// <returns>A new instance of <see cref="NotificationConfigName"/> constructed from the provided ids.</returns>
        public static NotificationConfigName FromFolderLocationNotificationConfig(string folderId, string locationId, string notificationConfigId) =>
            new NotificationConfigName(ResourceNameType.FolderLocationNotificationConfig, folderId: gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), notificationConfigId: gax::GaxPreconditions.CheckNotNullOrEmpty(notificationConfigId, nameof(notificationConfigId)));
        ...
        /// </param>
        /// <returns>A new instance of <see cref="NotificationConfigName"/> constructed from the provided ids.</returns>
        public static NotificationConfigName FromProjectLocationNotificationConfig(string projectId, string locationId, string notificationConfigId) =>
            new NotificationConfigName(ResourceNameType.ProjectLocationNotificationConfig, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), notificationConfigId: gax::GaxPreconditions.CheckNotNullOrEmpty(notificationConfigId, nameof(notificationConfigId)));
        ...
        /// <c>organizations/{organization}/locations/{location}/notificationConfigs/{notification_config}</c>.
        /// </returns>
        public static string Format(string organizationId, string locationId, string notificationConfigId) =>
            FormatOrganizationLocationNotificationConfig(organizationId, locationId, notificationConfigId);
        ...
        /// <c>organizations/{organization}/locations/{location}/notificationConfigs/{notification_config}</c>.
        /// </returns>
        public static string FormatOrganizationLocationNotificationConfig(string organizationId, string locationId, string notificationConfigId) =>
            s_organizationLocationNotificationConfig.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(notificationConfigId, nameof(notificationConfigId)));
        ...
        /// <c>folders/{folder}/locations/{location}/notificationConfigs/{notification_config}</c>.
        /// </returns>
        public static string FormatFolderLocationNotificationConfig(string folderId, string locationId, string notificationConfigId) =>
            s_folderLocationNotificationConfig.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(notificationConfigId, nameof(notificationConfigId)));
        ...
        /// <c>projects/{project}/locations/{location}/notificationConfigs/{notification_config}</c>.
        /// </returns>
        public static string FormatProjectLocationNotificationConfig(string projectId, string locationId, string notificationConfigId) =>
            s_projectLocationNotificationConfig.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(notificationConfigId, nameof(notificationConfigId)));
        ...
        public static bool TryParse(string notificationConfigName, bool allowUnparsed, out NotificationConfigName result)
        {
            ...
            if (s_organizationLocationNotificationConfig.TryParseName(notificationConfigName, out resourceName))
            {
                result = FromOrganizationLocationNotificationConfig(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (s_folderLocationNotificationConfig.TryParseName(notificationConfigName, out resourceName))
            {
                result = FromFolderLocationNotificationConfig(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (s_projectLocationNotificationConfig.TryParseName(notificationConfigName, out resourceName))
            {
                result = FromProjectLocationNotificationConfig(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private NotificationConfigName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string folderId = null, string locationId = null, string notificationConfigId = null, string organizationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// pattern <c>organizations/{organization}/locations/{location}/notificationConfigs/{notification_config}</c>
        /// </summary>
        /// <param name="organizationId">The <c>Organization</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="notificationConfigId">
        /// The <c>NotificationConfig</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public NotificationConfigName(string organizationId, string locationId, string notificationConfigId) : this(ResourceNameType.OrganizationLocationNotificationConfig, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), notificationConfigId: gax::GaxPreconditions.CheckNotNullOrEmpty(notificationConfigId, nameof(notificationConfigId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.OrganizationLocationNotificationConfig: return s_organizationLocationNotificationConfig.Expand(OrganizationId, LocationId, NotificationConfigId);
                case ResourceNameType.FolderLocationNotificationConfig: return s_folderLocationNotificationConfig.Expand(FolderId, LocationId, NotificationConfigId);
                case ResourceNameType.ProjectLocationNotificationConfig: return s_projectLocationNotificationConfig.Expand(ProjectId, LocationId, NotificationConfigId);
