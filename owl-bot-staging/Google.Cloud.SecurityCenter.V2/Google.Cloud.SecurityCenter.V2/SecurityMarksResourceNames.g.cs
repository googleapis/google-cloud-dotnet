...
namespace Google.Cloud.SecurityCenter.V2
{
    ...
    public sealed partial class SecurityMarksName : gax::IResourceName, sys::IEquatable<SecurityMarksName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>organizations/{organization}/sources/{source}/locations/{location}/findings/{finding}/securityMarks</c>
            /// .
            /// </summary>
            OrganizationSourceLocationFinding = 3,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>folders/{folder}/sources/{source}/locations/{location}/findings/{finding}/securityMarks</c>.
            /// </summary>
            FolderSourceLocationFinding = 6,
            ...
            /// .
            /// </summary>
            ProjectSourceFinding = 8,

            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/sources/{source}/locations/{location}/findings/{finding}/securityMarks</c>.
            /// </summary>
            ProjectSourceLocationFinding = 9,
        }
        ...
        private static gax::PathTemplate s_organizationSourceLocationFinding = new gax::PathTemplate("organizations/{organization}/sources/{source}/locations/{location}/findings/{finding}/securityMarks");
        ...
        private static gax::PathTemplate s_folderSourceLocationFinding = new gax::PathTemplate("folders/{folder}/sources/{source}/locations/{location}/findings/{finding}/securityMarks");
        ...
        private static gax::PathTemplate s_projectSourceLocationFinding = new gax::PathTemplate("projects/{project}/sources/{source}/locations/{location}/findings/{finding}/securityMarks");
        ...
        /// <param name="findingId">The <c>Finding</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="SecurityMarksName"/> constructed from the provided ids.</returns>
        public static SecurityMarksName FromOrganizationSourceLocationFinding(string organizationId, string sourceId, string locationId, string findingId) =>
            new SecurityMarksName(ResourceNameType.OrganizationSourceLocationFinding, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), sourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), findingId: gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        /// <param name="findingId">The <c>Finding</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="SecurityMarksName"/> constructed from the provided ids.</returns>
        public static SecurityMarksName FromFolderSourceLocationFinding(string folderId, string sourceId, string locationId, string findingId) =>
            new SecurityMarksName(ResourceNameType.FolderSourceLocationFinding, folderId: gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), sourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), findingId: gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        /// <param name="findingId">The <c>Finding</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="SecurityMarksName"/> constructed from the provided ids.</returns>
        public static SecurityMarksName FromProjectSourceLocationFinding(string projectId, string sourceId, string locationId, string findingId) =>
            new SecurityMarksName(ResourceNameType.ProjectSourceLocationFinding, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), sourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), findingId: gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        /// <c>organizations/{organization}/sources/{source}/locations/{location}/findings/{finding}/securityMarks</c>.
        /// </returns>
        public static string FormatOrganizationSourceLocationFinding(string organizationId, string sourceId, string locationId, string findingId) =>
            s_organizationSourceLocationFinding.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        /// <c>folders/{folder}/sources/{source}/locations/{location}/findings/{finding}/securityMarks</c>.
        /// </returns>
        public static string FormatFolderSourceLocationFinding(string folderId, string sourceId, string locationId, string findingId) =>
            s_folderSourceLocationFinding.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        /// <c>projects/{project}/sources/{source}/locations/{location}/findings/{finding}/securityMarks</c>.
        /// </returns>
        public static string FormatProjectSourceLocationFinding(string projectId, string sourceId, string locationId, string findingId) =>
            s_projectSourceLocationFinding.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)));
        ...
        public static bool TryParse(string securityMarksName, bool allowUnparsed, out SecurityMarksName result)
        {
            ...
            if (s_organizationSourceLocationFinding.TryParseName(securityMarksName, out resourceName))
            {
                result = FromOrganizationSourceLocationFinding(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            ...
            if (s_folderSourceLocationFinding.TryParseName(securityMarksName, out resourceName))
            {
                result = FromFolderSourceLocationFinding(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            ...
            if (s_projectSourceLocationFinding.TryParseName(securityMarksName, out resourceName))
            {
                result = FromProjectSourceLocationFinding(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private SecurityMarksName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string assetId = null, string findingId = null, string folderId = null, string locationId = null, string organizationId = null, string projectId = null, string sourceId = null)
        {
            Type = type;
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.OrganizationSourceLocationFinding: return s_organizationSourceLocationFinding.Expand(OrganizationId, SourceId, LocationId, FindingId);
                ...
                case ResourceNameType.FolderSourceLocationFinding: return s_folderSourceLocationFinding.Expand(FolderId, SourceId, LocationId, FindingId);
                ...
                case ResourceNameType.ProjectSourceLocationFinding: return s_projectSourceLocationFinding.Expand(ProjectId, SourceId, LocationId, FindingId);
