...
namespace Google.Cloud.AccessApproval.V1.Tests
{
    ...
    public sealed class GeneratedAccessApprovalClientTest
    {
        ...
        public void GetApprovalRequestRequestObject()
        {
            ...
            AccessApprovalClient client = new AccessApprovalClientImpl(mockGrpcClient.Object, null, null);
        ...
        [xunit::FactAttribute]
        public async stt::Task InvalidateApprovalRequestRequestObjectAsync()
        {
            moq::Mock<AccessApproval.AccessApprovalClient> mockGrpcClient = new moq::Mock<AccessApproval.AccessApprovalClient>(moq::MockBehavior.Strict);
            InvalidateApprovalRequestMessage request = new InvalidateApprovalRequestMessage
            {
        ...
        public void GetAccessApprovalSettingsRequestObject()
        {
            ...
            AccessApprovalSettings expectedResponse = new AccessApprovalSettings
            {
                ...
                ActiveKeyVersion = "active_key_versionfb97b530",
        ...
        {
            moq::Mock<AccessApproval.AccessApprovalClient> mockGrpcClient = new moq::Mock<AccessApproval.AccessApprovalClient>(moq::MockBehavior.Strict);
            GetAccessApprovalServiceAccountMessage request = new GetAccessApprovalServiceAccountMessage
            {
                Name = "name1c9368b0",
            };
            AccessApprovalServiceAccount expectedResponse = new AccessApprovalServiceAccount
            {
                AccessApprovalServiceAccountName = AccessApprovalServiceAccountName.FromProject("[PROJECT]"),
        ...
        [xunit::FactAttribute]
        public async stt::Task GetAccessApprovalServiceAccountRequestObjectAsync()
        {
            moq::Mock<AccessApproval.AccessApprovalClient> mockGrpcClient = new moq::Mock<AccessApproval.AccessApprovalClient>(moq::MockBehavior.Strict);
            GetAccessApprovalServiceAccountMessage request = new GetAccessApprovalServiceAccountMessage
            {
        ...
        [xunit::FactAttribute]
        public async stt::Task GetAccessApprovalServiceAccountAsync()
        {
            moq::Mock<AccessApproval.AccessApprovalClient> mockGrpcClient = new moq::Mock<AccessApproval.AccessApprovalClient>(moq::MockBehavior.Strict);
            GetAccessApprovalServiceAccountMessage request = new GetAccessApprovalServiceAccountMessage
            {
