...
namespace Google.Cloud.AccessApproval.V1
{
    ...
    public sealed partial class AccessApprovalSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>AccessApprovalClient.InvalidateApprovalRequest</c> and
        /// <c>AccessApprovalClient.InvalidateApprovalRequestAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>AccessApprovalClient.GetAccessApprovalServiceAccount</c> and
        /// <c>AccessApprovalClient.GetAccessApprovalServiceAccountAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
    ...
    public sealed partial class AccessApprovalClientBuilder : gaxgrpc::ClientBuilderBase<AccessApprovalClient>
    {
        ...
        public AccessApprovalClientBuilder() : base(AccessApprovalClient.ServiceMetadata)
        {
        }
        ...
        private AccessApprovalClient BuildImpl()
        {
            ...
            return AccessApprovalClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class AccessApprovalClient
    {
        ...
        /// <returns>The created <see cref="AccessApprovalClient"/>.</returns>
        internal static AccessApprovalClient Create(grpccore::CallInvoker callInvoker, AccessApprovalSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new AccessApprovalClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class AccessApprovalClientImpl : AccessApprovalClient
    {
        ...
        public AccessApprovalClientImpl(AccessApproval.AccessApprovalClient grpcClient, AccessApprovalSettings settings, mel::ILogger logger)
        {
