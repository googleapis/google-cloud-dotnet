...
namespace Google.Cloud.AccessApproval.V1.Snippets
{
    ...
    public sealed class AllGeneratedAccessApprovalClientSnippets
    {
        ...
        public void InvalidateApprovalRequestRequestObject()
        {
            ...
            // Make the request
            ApprovalRequest response = accessApprovalClient.InvalidateApprovalRequest(request);
            // End snippet
        }
        ...
        public async Task InvalidateApprovalRequestRequestObjectAsync()
        {
            ...
            // Make the request
            ApprovalRequest response = await accessApprovalClient.InvalidateApprovalRequestAsync(request);
            // End snippet
        }
        ...
        public void GetAccessApprovalServiceAccountRequestObject()
        {
            ...
            // Make the request
            AccessApprovalServiceAccount response = accessApprovalClient.GetAccessApprovalServiceAccount(request);
            // End snippet
        }
        ...
        public async Task GetAccessApprovalServiceAccountRequestObjectAsync()
        {
            ...
            GetAccessApprovalServiceAccountMessage request = new GetAccessApprovalServiceAccountMessage { Name = "", };
            // Make the request
            AccessApprovalServiceAccount response = await accessApprovalClient.GetAccessApprovalServiceAccountAsync(request);
            // End snippet
        }
        ...
        public void GetAccessApprovalServiceAccount()
        {
            ...
            string name = "";
            // Make the request
            AccessApprovalServiceAccount response = accessApprovalClient.GetAccessApprovalServiceAccount(name);
            // End snippet
        }
        ...
        public async Task GetAccessApprovalServiceAccountAsync()
        {
            ...
            string name = "";
            // Make the request
            AccessApprovalServiceAccount response = await accessApprovalClient.GetAccessApprovalServiceAccountAsync(name);
            // End snippet
        }
    }
}
