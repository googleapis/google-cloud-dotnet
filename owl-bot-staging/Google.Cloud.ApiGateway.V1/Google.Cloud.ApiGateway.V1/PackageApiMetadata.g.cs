...
namespace Google.Cloud.ApiGateway.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.ApiGateway.V1", GetFileDescriptors)
        ...
        {
            yield return ApigatewayReflection.Descriptor;
            yield return ApigatewayServiceReflection.Descriptor;
