...
{
    // [START firestore_v1_generated_FirestoreAdmin_UpdateBackupSchedule_async_flattened]
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task UpdateBackupScheduleAsync()
        {
            ...
            // Make the request
            BackupSchedule response = await firestoreAdminClient.UpdateBackupScheduleAsync(backupSchedule, updateMask);
        }
    }
    // [END firestore_v1_generated_FirestoreAdmin_UpdateBackupSchedule_async_flattened]
}
