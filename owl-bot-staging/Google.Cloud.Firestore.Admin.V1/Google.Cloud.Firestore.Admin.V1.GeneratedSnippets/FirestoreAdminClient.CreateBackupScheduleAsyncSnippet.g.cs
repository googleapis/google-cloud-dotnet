...
{
    // [START firestore_v1_generated_FirestoreAdmin_CreateBackupSchedule_async_flattened]
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task CreateBackupScheduleAsync()
        {
            ...
            // Make the request
            BackupSchedule response = await firestoreAdminClient.CreateBackupScheduleAsync(parent, backupSchedule);
        }
    }
    // [END firestore_v1_generated_FirestoreAdmin_CreateBackupSchedule_async_flattened]
}
