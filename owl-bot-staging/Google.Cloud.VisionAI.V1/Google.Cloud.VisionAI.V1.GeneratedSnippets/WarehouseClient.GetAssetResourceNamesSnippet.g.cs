...
{
    // [START visionai_v1_generated_Warehouse_GetAsset_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void GetAssetResourceNames()
        {
            ...
            AssetName name = AssetName.FromProjectNumberLocationCorpusAsset("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[ASSET]");
            // Make the request
            Asset response = warehouseClient.GetAsset(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_GetAsset_sync_flattened_resourceNames]
}
