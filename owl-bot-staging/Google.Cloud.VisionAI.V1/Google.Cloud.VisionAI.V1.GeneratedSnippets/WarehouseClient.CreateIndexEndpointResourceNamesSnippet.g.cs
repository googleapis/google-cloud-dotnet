...
{
    // [START visionai_v1_generated_Warehouse_CreateIndexEndpoint_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void CreateIndexEndpointResourceNames()
        {
            ...
            // Make the request
            Operation<IndexEndpoint, CreateIndexEndpointMetadata> response = warehouseClient.CreateIndexEndpoint(parent, indexEndpoint, indexEndpointId);
    ...
    // [END visionai_v1_generated_Warehouse_CreateIndexEndpoint_sync_flattened_resourceNames]
}
