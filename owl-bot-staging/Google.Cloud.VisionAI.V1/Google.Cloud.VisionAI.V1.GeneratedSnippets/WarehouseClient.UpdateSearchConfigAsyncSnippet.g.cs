...
{
    // [START visionai_v1_generated_Warehouse_UpdateSearchConfig_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateSearchConfigAsync()
        {
            ...
            // Make the request
            SearchConfig response = await warehouseClient.UpdateSearchConfigAsync(searchConfig, updateMask);
        }
    }
    // [END visionai_v1_generated_Warehouse_UpdateSearchConfig_async_flattened]
}
