...
{
    // [START visionai_v1_generated_Warehouse_UpdateAnnotation_async]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateAnnotationRequestObjectAsync()
        {
            ...
            // Make the request
            Annotation response = await warehouseClient.UpdateAnnotationAsync(request);
        }
    }
    // [END visionai_v1_generated_Warehouse_UpdateAnnotation_async]
}
