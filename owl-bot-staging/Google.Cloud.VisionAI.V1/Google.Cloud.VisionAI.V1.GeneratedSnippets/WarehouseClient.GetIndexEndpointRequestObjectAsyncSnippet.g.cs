...
{
    // [START visionai_v1_generated_Warehouse_GetIndexEndpoint_async]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task GetIndexEndpointRequestObjectAsync()
        {
            ...
            // Make the request
            IndexEndpoint response = await warehouseClient.GetIndexEndpointAsync(request);
        }
    }
    // [END visionai_v1_generated_Warehouse_GetIndexEndpoint_async]
}
