...
{
    // [START visionai_v1_generated_Warehouse_CreateSearchHypernym_sync_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void CreateSearchHypernym()
        {
            ...
            // Make the request
            SearchHypernym response = warehouseClient.CreateSearchHypernym(parent, searchHypernym, searchHypernymId);
        }
    }
    // [END visionai_v1_generated_Warehouse_CreateSearchHypernym_sync_flattened]
}
