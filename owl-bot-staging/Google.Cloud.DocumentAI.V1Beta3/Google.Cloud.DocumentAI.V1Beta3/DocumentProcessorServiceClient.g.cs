...
namespace Google.Cloud.DocumentAI.V1Beta3
{
    ...
    public abstract partial class DocumentProcessorServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="ProcessorType"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListProcessorTypesResponse, ProcessorType> ListProcessorTypes(LocationName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListProcessorTypes(new ListProcessorTypesRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="ProcessorType"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListProcessorTypesResponse, ProcessorType> ListProcessorTypesAsync(LocationName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListProcessorTypesAsync(new ListProcessorTypesRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
