...
namespace Google.Cloud.DocumentAI.V1Beta3
{
    ...
    public sealed partial class EvaluationName : gax::IResourceName, sys::IEquatable<EvaluationName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>
            /// projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processor_version}/evaluations/{evaluation}</c>
            /// .
            /// </summary>
            ProjectLocationProcessorProcessorVersionEvaluation = 1,
        }

        private static gax::PathTemplate s_projectLocationProcessorProcessorVersionEvaluation = new gax::PathTemplate("projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processor_version}/evaluations/{evaluation}");
        ...
        public static EvaluationName FromProjectLocationProcessorProcessorVersionEvaluation(string projectId, string locationId, string processorId, string processorVersionId, string evaluationId) =>
            new EvaluationName(ResourceNameType.ProjectLocationProcessorProcessorVersionEvaluation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), processorId: gax::GaxPreconditions.CheckNotNullOrEmpty(processorId, nameof(processorId)), processorVersionId: gax::GaxPreconditions.CheckNotNullOrEmpty(processorVersionId, nameof(processorVersionId)), evaluationId: gax::GaxPreconditions.CheckNotNullOrEmpty(evaluationId, nameof(evaluationId)));
        ...
        /// .
        /// </returns>
        public static string Format(string projectId, string locationId, string processorId, string processorVersionId, string evaluationId) =>
            FormatProjectLocationProcessorProcessorVersionEvaluation(projectId, locationId, processorId, processorVersionId, evaluationId);
        ...
        /// .
        /// </returns>
        public static string FormatProjectLocationProcessorProcessorVersionEvaluation(string projectId, string locationId, string processorId, string processorVersionId, string evaluationId) =>
            s_projectLocationProcessorProcessorVersionEvaluation.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(processorId, nameof(processorId)), gax::GaxPreconditions.CheckNotNullOrEmpty(processorVersionId, nameof(processorVersionId)), gax::GaxPreconditions.CheckNotNullOrEmpty(evaluationId, nameof(evaluationId)));
        ...
        public static bool TryParse(string evaluationName, bool allowUnparsed, out EvaluationName result)
        {
            ...
            if (s_projectLocationProcessorProcessorVersionEvaluation.TryParseName(evaluationName, out resourceName))
            {
                result = FromProjectLocationProcessorProcessorVersionEvaluation(resourceName[0], resourceName[1], resourceName[2], resourceName[3], resourceName[4]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private EvaluationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string evaluationId = null, string locationId = null, string processorId = null, string processorVersionId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="processorVersionId">The <c>ProcessorVersion</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="evaluationId">The <c>Evaluation</c> ID. Must not be <c>null</c> or empty.</param>
        public EvaluationName(string projectId, string locationId, string processorId, string processorVersionId, string evaluationId) : this(ResourceNameType.ProjectLocationProcessorProcessorVersionEvaluation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), processorId: gax::GaxPreconditions.CheckNotNullOrEmpty(processorId, nameof(processorId)), processorVersionId: gax::GaxPreconditions.CheckNotNullOrEmpty(processorVersionId, nameof(processorVersionId)), evaluationId: gax::GaxPreconditions.CheckNotNullOrEmpty(evaluationId, nameof(evaluationId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationProcessorProcessorVersionEvaluation: return s_projectLocationProcessorProcessorVersionEvaluation.Expand(ProjectId, LocationId, ProcessorId, ProcessorVersionId, EvaluationId);
