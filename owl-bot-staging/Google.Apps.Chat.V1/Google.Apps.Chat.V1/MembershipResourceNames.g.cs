...
namespace Google.Apps.Chat.V1
{
    ...
    public sealed partial class MembershipName : gax::IResourceName, sys::IEquatable<MembershipName>
    {
        ...
        /// <summary>
        /// Creates a <see cref="MembershipName"/> with the pattern <c>spaces/{space}/members/{member}</c>.
        /// </summary>
        ...
        public static MembershipName FromSpaceMember(string spaceId, string memberId) =>
            new MembershipName(ResourceNameType.SpaceMember, spaceId: gax::GaxPreconditions.CheckNotNullOrEmpty(spaceId, nameof(spaceId)), memberId: gax::GaxPreconditions.CheckNotNullOrEmpty(memberId, nameof(memberId)));
        ...
        public static bool TryParse(string membershipName, bool allowUnparsed, out MembershipName result)
        {
            ...
            if (s_spaceMember.TryParseName(membershipName, out resourceName))
            {
        ...
        private MembershipName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string memberId = null, string spaceId = null)
        {
            Type = type;
        ...
        /// <param name="spaceId">The <c>Space</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="memberId">The <c>Member</c> ID. Must not be <c>null</c> or empty.</param>
        public MembershipName(string spaceId, string memberId) : this(ResourceNameType.SpaceMember, spaceId: gax::GaxPreconditions.CheckNotNullOrEmpty(spaceId, nameof(spaceId)), memberId: gax::GaxPreconditions.CheckNotNullOrEmpty(memberId, nameof(memberId)))
        {
        }
    ...
    {
        /// <summary>
        /// <see cref="gacv::MembershipName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gacv::MembershipName MembershipName
        {
            get => string.IsNullOrEmpty(Name) ? null : gacv::MembershipName.Parse(Name, allowUnparsed: true);
