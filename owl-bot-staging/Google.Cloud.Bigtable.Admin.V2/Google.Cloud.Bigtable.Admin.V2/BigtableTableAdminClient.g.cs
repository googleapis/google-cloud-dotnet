...
namespace Google.Cloud.Bigtable.Admin.V2
{
    ...
    public abstract partial class BigtableTableAdminClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Table, UndeleteTableMetadata> UndeleteTable(TableName name, gaxgrpc::CallSettings callSettings = null) =>
            UndeleteTable(new UndeleteTableRequest
            {
                TableName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Table, UndeleteTableMetadata>> UndeleteTableAsync(TableName name, gaxgrpc::CallSettings callSettings = null) =>
            UndeleteTableAsync(new UndeleteTableRequest
            {
                TableName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Table, UndeleteTableMetadata>> UndeleteTableAsync(TableName name, st::CancellationToken cancellationToken) =>
            UndeleteTableAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<AuthorizedView, CreateAuthorizedViewMetadata> CreateAuthorizedView(TableName parent, AuthorizedView authorizedView, string authorizedViewId, gaxgrpc::CallSettings callSettings = null) =>
            CreateAuthorizedView(new CreateAuthorizedViewRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<AuthorizedView, CreateAuthorizedViewMetadata>> CreateAuthorizedViewAsync(TableName parent, AuthorizedView authorizedView, string authorizedViewId, gaxgrpc::CallSettings callSettings = null) =>
            CreateAuthorizedViewAsync(new CreateAuthorizedViewRequest
            {
                ParentAsTableName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                AuthorizedViewId = gax::GaxPreconditions.CheckNotNullOrEmpty(authorizedViewId, nameof(authorizedViewId)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<AuthorizedView, CreateAuthorizedViewMetadata>> CreateAuthorizedViewAsync(TableName parent, AuthorizedView authorizedView, string authorizedViewId, st::CancellationToken cancellationToken) =>
            CreateAuthorizedViewAsync(parent, authorizedView, authorizedViewId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="AuthorizedView"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListAuthorizedViewsResponse, AuthorizedView> ListAuthorizedViews(TableName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListAuthorizedViewsRequest request = new ListAuthorizedViewsRequest
            {
                ParentAsTableName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="AuthorizedView"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListAuthorizedViewsResponse, AuthorizedView> ListAuthorizedViewsAsync(TableName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListAuthorizedViewsRequest request = new ListAuthorizedViewsRequest
            {
                ParentAsTableName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
