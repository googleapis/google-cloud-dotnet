...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedDeliveryServiceClientSnippets
    {
        ...
        {
            // Snippet: SearchTasks(SearchTasksRequest, CallSettings)
            // Create client
            gmfdv::DeliveryServiceClient deliveryServiceClient = gmfdv::DeliveryServiceClient.Create();
            // Initialize request argument(s)
#pragma warning disable CS0612
            gmfdv::SearchTasksRequest request = new gmfdv::SearchTasksRequest { };
#pragma warning restore CS0612
            // Make the request
#pragma warning disable CS0612
            PagedEnumerable<gmfdv::SearchTasksResponse, gmfdv::Task> response = deliveryServiceClient.SearchTasks(request);
#pragma warning restore CS0612
...
#pragma warning disable CS0612
            foreach (gmfdv::SearchTasksResponse page in response.AsRawResponses())
#pragma warning restore CS0612
            {
        ...
        /// <summary>Snippet for SearchTasksAsync</summary>
        public async Task SearchTasksRequestObjectAsync()
        {
            // Snippet: SearchTasksAsync(SearchTasksRequest, CallSettings)
            // Create client
            gmfdv::DeliveryServiceClient deliveryServiceClient = await gmfdv::DeliveryServiceClient.CreateAsync();
            // Initialize request argument(s)
#pragma warning disable CS0612
...
#pragma warning restore CS0612
            // Make the request
#pragma warning disable CS0612
            PagedAsyncEnumerable<gmfdv::SearchTasksResponse, gmfdv::Task> response = deliveryServiceClient.SearchTasksAsync(request);
#pragma warning restore CS0612
            ...
            // Or iterate over pages (of server-defined size), performing one RPC per page
#pragma warning disable CS0612
            await response.AsRawResponses().ForEachAsync((gmfdv::SearchTasksResponse page) =>
#pragma warning restore CS0612
            {
                // Do something with each page of items
                Console.WriteLine("A page of results:");
        ...
        {
            // Snippet: SearchTasks(string, string, int?, CallSettings)
            // Create client
            gmfdv::DeliveryServiceClient deliveryServiceClient = gmfdv::DeliveryServiceClient.Create();
            // Initialize request argument(s)
            string parent = "";
            // Make the request
#pragma warning disable CS0612
            PagedEnumerable<gmfdv::SearchTasksResponse, gmfdv::Task> response = deliveryServiceClient.SearchTasks(parent);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
        ...
        {
            // Snippet: SearchTasksAsync(string, string, int?, CallSettings)
            // Create client
            gmfdv::DeliveryServiceClient deliveryServiceClient = await gmfdv::DeliveryServiceClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "";
            // Make the request
#pragma warning disable CS0612
            PagedAsyncEnumerable<gmfdv::SearchTasksResponse, gmfdv::Task> response = deliveryServiceClient.SearchTasksAsync(parent);
#pragma warning restore CS0612
