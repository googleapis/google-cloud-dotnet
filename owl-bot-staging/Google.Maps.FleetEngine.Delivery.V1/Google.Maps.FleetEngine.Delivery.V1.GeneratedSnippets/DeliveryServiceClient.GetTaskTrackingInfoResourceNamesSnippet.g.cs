...
{
    // [START fleetengine_v1_generated_DeliveryService_GetTaskTrackingInfo_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDeliveryServiceClientSnippets
    {
        ...
        public void GetTaskTrackingInfoResourceNames()
        {
            ...
            TaskTrackingInfoName name = TaskTrackingInfoName.FromProviderTracking("[PROVIDER]", "[TRACKING]");
            // Make the request
            TaskTrackingInfo response = deliveryServiceClient.GetTaskTrackingInfo(name);
        }
    }
    // [END fleetengine_v1_generated_DeliveryService_GetTaskTrackingInfo_sync_flattened_resourceNames]
}
