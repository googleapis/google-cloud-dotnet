...
{
    // [START fleetengine_v1_generated_DeliveryService_ListTasks_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDeliveryServiceClientSnippets
    {
        ...
        public void ListTasksResourceNames()
        {
            ...
            ProviderName parent = ProviderName.FromProvider("[PROVIDER]");
            // Make the request
            PagedEnumerable<ListTasksResponse, Task> response = deliveryServiceClient.ListTasks(parent);
    ...
    // [END fleetengine_v1_generated_DeliveryService_ListTasks_sync_flattened_resourceNames]
}
