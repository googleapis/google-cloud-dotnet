        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.AutoML.V1", GetFileDescriptors)
            ...
            .WithHttpRuleOverrides(new scg::Dictionary<string, proto::ByteString>
            {
                ...
                },
                {
                    ...
                    // { "post": "/v1/{name=projects/*/locations/*/operations/*}:wait", "body": "*" }
                    proto::ByteString.FromBase64("IjMvdjEve25hbWU9cHJvamVjdHMvKi9sb2NhdGlvbnMvKi9vcGVyYXRpb25zLyp9OndhaXQ6ASo=")
                },
            });
