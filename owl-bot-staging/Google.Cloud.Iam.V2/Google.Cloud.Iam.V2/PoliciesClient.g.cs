...
namespace Google.Cloud.Iam.V2
{
    ...
    public sealed partial class PoliciesClientBuilder : gaxgrpc::ClientBuilderBase<PoliciesClient>
    {
        ...
        private PoliciesClient BuildImpl()
        {
            ...
            return PoliciesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class PoliciesClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Policies.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
