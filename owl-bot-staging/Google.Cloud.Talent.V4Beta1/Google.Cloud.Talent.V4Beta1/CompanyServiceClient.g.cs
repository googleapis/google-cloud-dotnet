...
namespace Google.Cloud.Talent.V4Beta1
{
    ...
    public abstract partial class CompanyServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Company UpdateCompany(Company company, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Company> UpdateCompanyAsync(Company company, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Company> UpdateCompanyAsync(Company company, st::CancellationToken cancellationToken) =>
            UpdateCompanyAsync(company, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
