...
namespace Google.Cloud.BeyondCorp.ClientGateways.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.BeyondCorp.ClientGateways.V1", GetFileDescriptors)
        ...
        {
            yield return ClientGatewaysServiceReflection.Descriptor;
