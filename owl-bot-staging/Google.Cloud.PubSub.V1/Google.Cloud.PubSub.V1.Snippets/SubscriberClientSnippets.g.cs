...
namespace Google.Cloud.PubSub.V1.Snippets
{
    ...
    public sealed class AllGeneratedSubscriberClientSnippets
    {
        ...
        public async Task UpdateSubscriptionAsync()
        {
            ...
            FieldMask updateMask = new FieldMask();
            // Make the request
            Subscription response = await subscriberClient.UpdateSubscriptionAsync(subscription, updateMask);
            // End snippet
        }
        ...
        public void ListSubscriptionsRequestObject()
        {
            ...
            // Make the request
            PagedEnumerable<ListSubscriptionsResponse, Subscription> response = subscriberClient.ListSubscriptions(request);
...
#pragma warning restore CS0612
        ...
        public void UpdateSnapshot()
        {
            ...
            FieldMask updateMask = new FieldMask();
            // Make the request
            Snapshot response = subscriberClient.UpdateSnapshot(snapshot, updateMask);
            // End snippet
        }
