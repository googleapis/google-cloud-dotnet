...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedPublisherClientSnippets
    {
        ...
        public void UpdateTopic()
        {
            ...
            // Make the request
            Topic response = publisherClient.UpdateTopic(topic, updateMask);
            // End snippet
        }
        ...
        public async Task UpdateTopicAsync()
        {
            ...
            FieldMask updateMask = new FieldMask();
            // Make the request
            Topic response = await publisherClient.UpdateTopicAsync(topic, updateMask);
            // End snippet
        }
        ...
        public async Task ListTopicsRequestObjectAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListTopicsResponse, Topic> response = publisherClient.ListTopicsAsync(request);
        ...
        public async Task ListTopicsAsync()
        {
            ...
            string project = "projects/[PROJECT]";
            // Make the request
            PagedAsyncEnumerable<ListTopicsResponse, Topic> response = publisherClient.ListTopicsAsync(project);
        ...
        public async Task ListTopicSubscriptionsRequestObjectAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListTopicSubscriptionsResponse, string> response = publisherClient.ListTopicSubscriptionsAsync(request);
        ...
        public void ListTopicSubscriptions()
        {
            ...
            string topic = "projects/[PROJECT]/topics/[TOPIC]";
            // Make the request
            PagedEnumerable<ListTopicSubscriptionsResponse, string> response = publisherClient.ListTopicSubscriptions(topic);
        ...
        public async Task ListTopicSnapshotsRequestObjectAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListTopicSnapshotsResponse, string> response = publisherClient.ListTopicSnapshotsAsync(request);
        ...
        public void ListTopicSnapshots()
        {
            ...
            string topic = "projects/[PROJECT]/topics/[TOPIC]";
            // Make the request
            PagedEnumerable<ListTopicSnapshotsResponse, string> response = publisherClient.ListTopicSnapshots(topic);
        ...
        public async Task ListTopicSnapshotsAsync()
        {
            ...
            string topic = "projects/[PROJECT]/topics/[TOPIC]";
            // Make the request
            PagedAsyncEnumerable<ListTopicSnapshotsResponse, string> response = publisherClient.ListTopicSnapshotsAsync(topic);
