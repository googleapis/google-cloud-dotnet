...
{
    // [START pubsub_v1_generated_Subscriber_Pull_async_flattened2]
    ...
    public sealed partial class GeneratedSubscriberClientSnippets
    {
        ...
        public async Task Pull2Async()
        {
            ...
            int maxMessages = 0;
            // Make the request
            PullResponse response = await subscriberClient.PullAsync(subscription, maxMessages);
        }
    }
    // [END pubsub_v1_generated_Subscriber_Pull_async_flattened2]
}
