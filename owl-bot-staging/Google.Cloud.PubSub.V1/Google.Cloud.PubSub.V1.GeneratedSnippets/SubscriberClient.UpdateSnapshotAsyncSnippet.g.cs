...
{
    // [START pubsub_v1_generated_Subscriber_UpdateSnapshot_async_flattened]
    ...
    public sealed partial class GeneratedSubscriberClientSnippets
    {
        ...
        public async Task UpdateSnapshotAsync()
        {
            ...
            // Make the request
            Snapshot response = await subscriberClient.UpdateSnapshotAsync(snapshot, updateMask);
        }
    }
    // [END pubsub_v1_generated_Subscriber_UpdateSnapshot_async_flattened]
}
