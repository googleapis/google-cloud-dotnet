...
namespace Google.Cloud.PubSub.V1
{
    ...
    public abstract partial class SchemaServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Schema CreateSchema(ProjectName parent, Schema schema, string schemaId, gaxgrpc::CallSettings callSettings = null) =>
            CreateSchema(new CreateSchemaRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Schema> CreateSchemaAsync(ProjectName parent, Schema schema, string schemaId, gaxgrpc::CallSettings callSettings = null) =>
            CreateSchemaAsync(new CreateSchemaRequest
            {
                ParentAsProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Schema = gax::GaxPreconditions.CheckNotNull(schema, nameof(schema)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Schema> CreateSchemaAsync(ProjectName parent, Schema schema, string schemaId, st::CancellationToken cancellationToken) =>
            CreateSchemaAsync(parent, schema, schemaId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Schema"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListSchemasResponse, Schema> ListSchemas(ProjectName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListSchemas(new ListSchemasRequest
            {
                ParentAsProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Schema"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListSchemasResponse, Schema> ListSchemasAsync(ProjectName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListSchemasAsync(new ListSchemasRequest
            {
                ParentAsProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ValidateSchemaResponse ValidateSchema(ProjectName parent, Schema schema, gaxgrpc::CallSettings callSettings = null) =>
            ValidateSchema(new ValidateSchemaRequest
            {
                ParentAsProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Schema = gax::GaxPreconditions.CheckNotNull(schema, nameof(schema)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ValidateSchemaResponse> ValidateSchemaAsync(ProjectName parent, Schema schema, gaxgrpc::CallSettings callSettings = null) =>
            ValidateSchemaAsync(new ValidateSchemaRequest
            {
                ParentAsProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Schema = gax::GaxPreconditions.CheckNotNull(schema, nameof(schema)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ValidateSchemaResponse> ValidateSchemaAsync(ProjectName parent, Schema schema, st::CancellationToken cancellationToken) =>
            ValidateSchemaAsync(parent, schema, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
