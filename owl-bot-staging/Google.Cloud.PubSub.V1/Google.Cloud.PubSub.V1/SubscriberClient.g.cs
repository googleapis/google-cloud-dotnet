...
namespace Google.Cloud.PubSub.V1
{
    ...
    public sealed partial class SubscriberClientBuilder : gaxgrpc::ClientBuilderBase<SubscriberClient>
    {
        ...
        public SubscriberClientBuilder() : base(SubscriberClient.ServiceMetadata)
        {
        }
        ...
        private SubscriberClient BuildImpl()
        {
            ...
            return SubscriberClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class SubscriberClient
    {
        ...
        /// <returns>The created <see cref="SubscriberClient"/>.</returns>
        internal static SubscriberClient Create(grpccore::CallInvoker callInvoker, SubscriberSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new SubscriberClientImpl(grpcClient, settings, logger);
        }
    ...
    public sealed partial class SubscriberClientImpl : SubscriberClient
    {
        ...
        public SubscriberClientImpl(Subscriber.SubscriberClient grpcClient, SubscriberSettings settings, mel::ILogger logger)
        {
