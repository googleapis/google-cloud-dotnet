...
namespace Google.Cloud.CertificateManager.V1
{
    ...
    /// <summary>Resource name for the <c>TargetHttpsProxies</c> resource.</summary>
    public sealed partial class TargetHttpsProxiesName : gax::IResourceName, sys::IEquatable<TargetHttpsProxiesName>
    {
        /// <summary>The possible contents of <see cref="TargetHttpsProxiesName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
        ...
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="TargetHttpsProxiesName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static TargetHttpsProxiesName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new TargetHttpsProxiesName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));
        ...
        /// <returns>A new instance of <see cref="TargetHttpsProxiesName"/> constructed from the provided ids.</returns>
        public static TargetHttpsProxiesName FromProjectLocationTargetHttpsProxy(string projectId, string locationId, string targetHttpsProxyId) =>
            new TargetHttpsProxiesName(ResourceNameType.ProjectLocationTargetHttpsProxy, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), targetHttpsProxyId: gax::GaxPreconditions.CheckNotNullOrEmpty(targetHttpsProxyId, nameof(targetHttpsProxyId)));
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="TargetHttpsProxiesName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="targetHttpsProxiesName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="TargetHttpsProxiesName"/> if successful.</returns>
        public static TargetHttpsProxiesName Parse(string targetHttpsProxiesName) => Parse(targetHttpsProxiesName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="TargetHttpsProxiesName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="TargetHttpsProxiesName"/> if successful.</returns>
        public static TargetHttpsProxiesName Parse(string targetHttpsProxiesName, bool allowUnparsed) =>
            TryParse(targetHttpsProxiesName, allowUnparsed, out TargetHttpsProxiesName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="TargetHttpsProxiesName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="targetHttpsProxiesName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="TargetHttpsProxiesName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string targetHttpsProxiesName, out TargetHttpsProxiesName result) =>
            TryParse(targetHttpsProxiesName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string targetHttpsProxiesName, bool allowUnparsed, out TargetHttpsProxiesName result)
        {
            gax::GaxPreconditions.CheckNotNull(targetHttpsProxiesName, nameof(targetHttpsProxiesName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationTargetHttpsProxy.TryParseName(targetHttpsProxiesName, out resourceName))
            {
                result = FromProjectLocationTargetHttpsProxy(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(targetHttpsProxiesName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private TargetHttpsProxiesName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string targetHttpsProxyId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
            ProjectId = projectId;
            TargetHttpsProxyId = targetHttpsProxyId;
        }
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="targetHttpsProxyId">The <c>TargetHttpsProxy</c> ID. Must not be <c>null</c> or empty.</param>
        public TargetHttpsProxiesName(string projectId, string locationId, string targetHttpsProxyId) : this(ResourceNameType.ProjectLocationTargetHttpsProxy, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), targetHttpsProxyId: gax::GaxPreconditions.CheckNotNullOrEmpty(targetHttpsProxyId, nameof(targetHttpsProxyId)))
        {
        }
        ...
        /// <summary>
        /// The <c>TargetHttpsProxy</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        public string TargetHttpsProxyId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationTargetHttpsProxy: return s_projectLocationTargetHttpsProxy.Expand(ProjectId, LocationId, TargetHttpsProxyId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as TargetHttpsProxiesName);

        /// <inheritdoc/>
        public bool Equals(TargetHttpsProxiesName other) => ToString() == other?.ToString();

        /// <inheritdoc/>
        public static bool operator ==(TargetHttpsProxiesName a, TargetHttpsProxiesName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);

        /// <inheritdoc/>
        public static bool operator !=(TargetHttpsProxiesName a, TargetHttpsProxiesName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>TargetSslProxies</c> resource.</summary>
    public sealed partial class TargetSslProxiesName : gax::IResourceName, sys::IEquatable<TargetSslProxiesName>
    {
        /// <summary>The possible contents of <see cref="TargetSslProxiesName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
        ...
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="TargetSslProxiesName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static TargetSslProxiesName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new TargetSslProxiesName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));
        ...
        /// <returns>A new instance of <see cref="TargetSslProxiesName"/> constructed from the provided ids.</returns>
        public static TargetSslProxiesName FromProjectLocationTargetSslProxy(string projectId, string locationId, string targetSslProxyId) =>
            new TargetSslProxiesName(ResourceNameType.ProjectLocationTargetSslProxy, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), targetSslProxyId: gax::GaxPreconditions.CheckNotNullOrEmpty(targetSslProxyId, nameof(targetSslProxyId)));
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="TargetSslProxiesName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="targetSslProxiesName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="TargetSslProxiesName"/> if successful.</returns>
        public static TargetSslProxiesName Parse(string targetSslProxiesName) => Parse(targetSslProxiesName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="TargetSslProxiesName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        public static TargetSslProxiesName Parse(string targetSslProxiesName, bool allowUnparsed) =>
            TryParse(targetSslProxiesName, allowUnparsed, out TargetSslProxiesName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="TargetSslProxiesName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="targetSslProxiesName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="TargetSslProxiesName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string targetSslProxiesName, out TargetSslProxiesName result) =>
            TryParse(targetSslProxiesName, false, out result);
        ...
        {
            gax::GaxPreconditions.CheckNotNull(targetSslProxiesName, nameof(targetSslProxiesName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationTargetSslProxy.TryParseName(targetSslProxiesName, out resourceName))
            {
                result = FromProjectLocationTargetSslProxy(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(targetSslProxiesName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private TargetSslProxiesName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string targetSslProxyId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
            ProjectId = projectId;
            TargetSslProxyId = targetSslProxyId;
        }
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="targetSslProxyId">The <c>TargetSslProxy</c> ID. Must not be <c>null</c> or empty.</param>
        public TargetSslProxiesName(string projectId, string locationId, string targetSslProxyId) : this(ResourceNameType.ProjectLocationTargetSslProxy, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), targetSslProxyId: gax::GaxPreconditions.CheckNotNullOrEmpty(targetSslProxyId, nameof(targetSslProxyId)))
        {
        }
        ...
        /// <summary>
        /// The <c>TargetSslProxy</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationTargetSslProxy: return s_projectLocationTargetSslProxy.Expand(ProjectId, LocationId, TargetSslProxyId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as TargetSslProxiesName);

        /// <inheritdoc/>
        public bool Equals(TargetSslProxiesName other) => ToString() == other?.ToString();

        /// <inheritdoc/>
        public static bool operator ==(TargetSslProxiesName a, TargetSslProxiesName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);

        /// <inheritdoc/>
        public static bool operator !=(TargetSslProxiesName a, TargetSslProxiesName b) => !(a == b);
    }
