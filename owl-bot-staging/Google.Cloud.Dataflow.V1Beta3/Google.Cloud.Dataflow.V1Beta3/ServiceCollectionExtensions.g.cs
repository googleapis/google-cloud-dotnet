...
using gcdv = Google.Cloud.Dataflow.V1Beta3;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddJobsV1Beta3Client(this IServiceCollection services, sys::Action<gcdv::JobsV1Beta3ClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddMessagesV1Beta3Client(this IServiceCollection services, sys::Action<gcdv::MessagesV1Beta3ClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddMetricsV1Beta3Client(this IServiceCollection services, sys::Action<gcdv::MetricsV1Beta3ClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddTemplatesServiceClient(this IServiceCollection services, sys::Action<gcdv::TemplatesServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
