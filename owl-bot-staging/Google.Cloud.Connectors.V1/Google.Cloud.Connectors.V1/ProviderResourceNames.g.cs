...
namespace Google.Cloud.Connectors.V1
{
    ...
    {
        /// <summary>
        /// <see cref="gccv::ProviderName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::ProviderName ProviderName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::ProviderName.Parse(Name, allowUnparsed: true);
