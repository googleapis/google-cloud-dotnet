...
namespace Google.Cloud.Config.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.Config.V1", GetFileDescriptors)
            ...
            .WithHttpRuleOverrides(new scg::Dictionary<string, proto::ByteString>
            {
                ...
                },
                {
                    ...
                    proto::ByteString.FromBase64("EkAvdjEve3Jlc291cmNlPXByb2plY3RzLyovbG9jYXRpb25zLyovZGVwbG95bWVudHMvKn06Z2V0SWFtUG9saWN5")
                },
                {
                    "google.iam.v1.IAMPolicy.SetIamPolicy",
                    // { "post": "/v1/{resource=projects/*/locations/*/deployments/*}:setIamPolicy", "body": "*" }
                    proto::ByteString.FromBase64("IkAvdjEve3Jlc291cmNlPXByb2plY3RzLyovbG9jYXRpb25zLyovZGVwbG95bWVudHMvKn06c2V0SWFtUG9saWN5OgEq")
                },
                {
                    "google.iam.v1.IAMPolicy.TestIamPermissions",
                    // { "post": "/v1/{resource=projects/*/locations/*/deployments/*}:testIamPermissions", "body": "*" }
                    proto::ByteString.FromBase64("IkYvdjEve3Jlc291cmNlPXByb2plY3RzLyovbG9jYXRpb25zLyovZGVwbG95bWVudHMvKn06dGVzdElhbVBlcm1pc3Npb25zOgEq")
                },
                {
