...
namespace Google.Cloud.Retail.V2
{
    ...
    public sealed partial class ControlServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings CreateControlSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings DeleteControlSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UpdateControlSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetControlSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListControlsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public sealed partial class ControlServiceClientBuilder : gaxgrpc::ClientBuilderBase<ControlServiceClient>
    {
        ...
        private ControlServiceClient BuildImpl()
        {
            ...
            return ControlServiceClient.Create(callInvoker, Settings, Logger);
        }
    ...
    {
        /// <summary>
        /// The default endpoint for the ControlService service, which is a host of "retail.googleapis.com" and a port
        /// of 443.
        /// </summary>
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ControlService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Control CreateControl(CatalogName parent, Control control, string controlId, gaxgrpc::CallSettings callSettings = null) =>
            CreateControl(new CreateControlRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Control> CreateControlAsync(CatalogName parent, Control control, string controlId, gaxgrpc::CallSettings callSettings = null) =>
            CreateControlAsync(new CreateControlRequest
            {
                ParentAsCatalogName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Control = gax::GaxPreconditions.CheckNotNull(control, nameof(control)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Control> CreateControlAsync(CatalogName parent, Control control, string controlId, st::CancellationToken cancellationToken) =>
            CreateControlAsync(parent, control, controlId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
