...
namespace Google.Cloud.Dataform.V1Beta1
{
    ...
    public sealed partial class DataformClientBuilder : gaxgrpc::ClientBuilderBase<DataformClient>
    {
        ...
        private DataformClient BuildImpl()
        {
            ...
            return DataformClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class DataformClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Dataform.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
