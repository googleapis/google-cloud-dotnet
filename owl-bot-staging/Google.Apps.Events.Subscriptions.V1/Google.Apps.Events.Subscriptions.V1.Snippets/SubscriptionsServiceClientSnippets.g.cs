...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedSubscriptionsServiceClientSnippets
    {
        ...
        {
            // Snippet: ListSubscriptions(int, string, string, string, int?, CallSettings)
            // Create client
            SubscriptionsServiceClient subscriptionsServiceClient = SubscriptionsServiceClient.Create();
            // Initialize request argument(s)
            int pageSize = 0;
        ...
        {
            // Snippet: ListSubscriptionsAsync(int, string, string, string, int?, CallSettings)
            // Create client
            SubscriptionsServiceClient subscriptionsServiceClient = await SubscriptionsServiceClient.CreateAsync();
            // Initialize request argument(s)
            int pageSize = 0;
            ...
            string filter = "";
            // Make the request
            PagedAsyncEnumerable<ListSubscriptionsResponse, Subscription> response = subscriptionsServiceClient.ListSubscriptionsAsync(pageSize, pageToken, filter);
