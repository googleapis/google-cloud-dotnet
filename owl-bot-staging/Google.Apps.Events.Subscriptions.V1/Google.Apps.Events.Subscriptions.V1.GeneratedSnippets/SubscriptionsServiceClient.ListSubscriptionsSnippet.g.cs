...
{
    // [START workspaceevents_v1_generated_SubscriptionsService_ListSubscriptions_sync_flattened]
    ...
    public sealed partial class GeneratedSubscriptionsServiceClientSnippets
    {
        ...
        public void ListSubscriptions()
        {
            ...
            string filter = "";
            // Make the request
            PagedEnumerable<ListSubscriptionsResponse, Subscription> response = subscriptionsServiceClient.ListSubscriptions(pageSize, pageToken, filter);
    ...
    // [END workspaceevents_v1_generated_SubscriptionsService_ListSubscriptions_sync_flattened]
}
