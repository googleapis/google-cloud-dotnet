...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class NodeTemplatesSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// Long Running Operation settings for calls to <c>NodeTemplatesClient.Delete</c> and
        /// <c>NodeTemplatesClient.DeleteAsync</c>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Long Running Operation settings for calls to <c>NodeTemplatesClient.Insert</c> and
        /// <c>NodeTemplatesClient.InsertAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
    ...
    public sealed partial class NodeTemplatesClientBuilder : gaxgrpc::ClientBuilderBase<NodeTemplatesClient>
    {
        ...
        public NodeTemplatesClientBuilder() : base(NodeTemplatesClient.ServiceMetadata)
        {
        }
        ...
        private NodeTemplatesClient BuildImpl()
        {
            ...
            return NodeTemplatesClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class NodeTemplatesClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(NodeTemplates.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="NodeTemplatesClient"/>.</returns>
        internal static NodeTemplatesClient Create(grpccore::CallInvoker callInvoker, NodeTemplatesSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new NodeTemplatesClientImpl(grpcClient, settings, logger);
        }
        ...
        public virtual gax::PagedEnumerable<NodeTemplateAggregatedList, scg::KeyValuePair<string, NodeTemplatesScopedList>> AggregatedList(AggregatedListNodeTemplatesRequest request, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// </returns>
        public virtual gax::PagedAsyncEnumerable<NodeTemplateAggregatedList, scg::KeyValuePair<string, NodeTemplatesScopedList>> AggregatedListAsync(AggregatedListNodeTemplatesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="scg::KeyValuePair{TKey,TValue}"/> resources.</returns>
        public virtual gax::PagedEnumerable<NodeTemplateAggregatedList, scg::KeyValuePair<string, NodeTemplatesScopedList>> AggregatedList(string project, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// A pageable asynchronous sequence of <see cref="scg::KeyValuePair{TKey,TValue}"/> resources.
        /// </returns>
        public virtual gax::PagedAsyncEnumerable<NodeTemplateAggregatedList, scg::KeyValuePair<string, NodeTemplatesScopedList>> AggregatedListAsync(string project, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            AggregatedListNodeTemplatesRequest request = new AggregatedListNodeTemplatesRequest
            {
                Project = gax::GaxPreconditions.CheckNotNullOrEmpty(project, nameof(project)),
        ...
        public virtual lro::Operation<Operation, Operation> Delete(DeleteNodeTemplateRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        public virtual stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(DeleteNodeTemplateRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(DeleteNodeTemplateRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> Delete(string project, string region, string nodeTemplate, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(string project, string region, string nodeTemplate, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(string project, string region, string nodeTemplate, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> Insert(InsertNodeTemplateRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> InsertAsync(InsertNodeTemplateRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> InsertAsync(InsertNodeTemplateRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> Insert(string project, string region, NodeTemplate nodeTemplateResource, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> InsertAsync(string project, string region, NodeTemplate nodeTemplateResource, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> InsertAsync(string project, string region, NodeTemplate nodeTemplateResource, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="request">The request object containing all of the parameters for the API call.</param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="NodeTemplate"/> resources.</returns>
        public virtual gax::PagedEnumerable<NodeTemplateList, NodeTemplate> List(ListNodeTemplatesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="request">The request object containing all of the parameters for the API call.</param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="NodeTemplate"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<NodeTemplateList, NodeTemplate> ListAsync(ListNodeTemplatesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="NodeTemplate"/> resources.</returns>
        public virtual gax::PagedEnumerable<NodeTemplateList, NodeTemplate> List(string project, string region, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="NodeTemplate"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<NodeTemplateList, NodeTemplate> ListAsync(string project, string region, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListNodeTemplatesRequest request = new ListNodeTemplatesRequest
            {
                Project = gax::GaxPreconditions.CheckNotNullOrEmpty(project, nameof(project)),
    ...
    public sealed partial class NodeTemplatesClientImpl : NodeTemplatesClient
    {
        ...
        public NodeTemplatesClientImpl(NodeTemplates.NodeTemplatesClient grpcClient, NodeTemplatesSettings settings, mel::ILogger logger)
        {
            ...
            _callAggregatedList = clientHelper.BuildApiCall<AggregatedListNodeTemplatesRequest, NodeTemplateAggregatedList>("AggregatedList", grpcClient.AggregatedListAsync, grpcClient.AggregatedList, effectiveSettings.AggregatedListSettings).WithGoogleRequestParam("project", request => request.Project);
            ...
            _callGet = clientHelper.BuildApiCall<GetNodeTemplateRequest, NodeTemplate>("Get", grpcClient.GetAsync, grpcClient.Get, effectiveSettings.GetSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("node_template", request => request.NodeTemplate);
            Modify_ApiCall(ref _callGet);
            Modify_GetApiCall(ref _callGet);
            _callGetIamPolicy = clientHelper.BuildApiCall<GetIamPolicyNodeTemplateRequest, Policy>("GetIamPolicy", grpcClient.GetIamPolicyAsync, grpcClient.GetIamPolicy, effectiveSettings.GetIamPolicySettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("resource", request => request.Resource);
            Modify_ApiCall(ref _callGetIamPolicy);
            Modify_GetIamPolicyApiCall(ref _callGetIamPolicy);
            _callInsert = clientHelper.BuildApiCall<InsertNodeTemplateRequest, Operation>("Insert", grpcClient.InsertAsync, grpcClient.Insert, effectiveSettings.InsertSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region);
            Modify_ApiCall(ref _callInsert);
            Modify_InsertApiCall(ref _callInsert);
            _callList = clientHelper.BuildApiCall<ListNodeTemplatesRequest, NodeTemplateList>("List", grpcClient.ListAsync, grpcClient.List, effectiveSettings.ListSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region);
            ...
            _callTestIamPermissions = clientHelper.BuildApiCall<TestIamPermissionsNodeTemplateRequest, TestPermissionsResponse>("TestIamPermissions", grpcClient.TestIamPermissionsAsync, grpcClient.TestIamPermissions, effectiveSettings.TestIamPermissionsSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("resource", request => request.Resource);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="scg::KeyValuePair{TKey,TValue}"/> resources.</returns>
        public override gax::PagedEnumerable<NodeTemplateAggregatedList, scg::KeyValuePair<string, NodeTemplatesScopedList>> AggregatedList(AggregatedListNodeTemplatesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_AggregatedListNodeTemplatesRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedEnumerable<AggregatedListNodeTemplatesRequest, NodeTemplateAggregatedList, scg::KeyValuePair<string, NodeTemplatesScopedList>>(_callAggregatedList, request, callSettings);
        }
        ...
        /// A pageable asynchronous sequence of <see cref="scg::KeyValuePair{TKey,TValue}"/> resources.
        /// </returns>
        public override gax::PagedAsyncEnumerable<NodeTemplateAggregatedList, scg::KeyValuePair<string, NodeTemplatesScopedList>> AggregatedListAsync(AggregatedListNodeTemplatesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_AggregatedListNodeTemplatesRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedAsyncEnumerable<AggregatedListNodeTemplatesRequest, NodeTemplateAggregatedList, scg::KeyValuePair<string, NodeTemplatesScopedList>>(_callAggregatedList, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Operation, Operation> Delete(DeleteNodeTemplateRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(DeleteNodeTemplateRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_DeleteNodeTemplateRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Operation, Operation> Insert(InsertNodeTemplateRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Operation, Operation>> InsertAsync(InsertNodeTemplateRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_InsertNodeTemplateRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="NodeTemplate"/> resources.</returns>
        public override gax::PagedEnumerable<NodeTemplateList, NodeTemplate> List(ListNodeTemplatesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListNodeTemplatesRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedEnumerable<ListNodeTemplatesRequest, NodeTemplateList, NodeTemplate>(_callList, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="NodeTemplate"/> resources.</returns>
        public override gax::PagedAsyncEnumerable<NodeTemplateList, NodeTemplate> ListAsync(ListNodeTemplatesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListNodeTemplatesRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedAsyncEnumerable<ListNodeTemplatesRequest, NodeTemplateList, NodeTemplate>(_callList, request, callSettings);
        }
    ...
    public partial class AggregatedListNodeTemplatesRequest : gaxgrpc::IPageRequest
    {
        /// <inheritdoc/>
        public int PageSize
        {
    ...
    public partial class ListNodeTemplatesRequest : gaxgrpc::IPageRequest
    {
        /// <inheritdoc/>
        public int PageSize
        {
    ...
    public partial class NodeTemplateAggregatedList : gaxgrpc::IPageResponse<scg::KeyValuePair<string, NodeTemplatesScopedList>>
    {
        /// <summary>Returns an enumerator that iterates through the resources in this response.</summary>
        public scg::IEnumerator<scg::KeyValuePair<string, NodeTemplatesScopedList>> GetEnumerator() => Items.GetEnumerator();

        sc::IEnumerator sc::IEnumerable.GetEnumerator() => GetEnumerator();
    }

    public partial class NodeTemplateList : gaxgrpc::IPageResponse<NodeTemplate>
    {
        /// <summary>Returns an enumerator that iterates through the resources in this response.</summary>
        public scg::IEnumerator<NodeTemplate> GetEnumerator() => Items.GetEnumerator();
    ...
    {
        public partial class NodeTemplatesClient
        {
            /// <summary>
