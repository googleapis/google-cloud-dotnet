...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class TargetTcpProxiesClientBuilder : gaxgrpc::ClientBuilderBase<TargetTcpProxiesClient>
    {
        ...
        private TargetTcpProxiesClient BuildImpl()
        {
            ...
            return TargetTcpProxiesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class TargetTcpProxiesClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(TargetTcpProxies.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
