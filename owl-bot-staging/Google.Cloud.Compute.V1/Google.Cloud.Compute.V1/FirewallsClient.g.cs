...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class FirewallsClientBuilder : gaxgrpc::ClientBuilderBase<FirewallsClient>
    {
        ...
        private FirewallsClient BuildImpl()
        {
            ...
            return FirewallsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class FirewallsClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Firewalls.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
