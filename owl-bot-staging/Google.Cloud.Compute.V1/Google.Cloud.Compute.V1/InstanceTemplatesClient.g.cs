...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class InstanceTemplatesClientBuilder : gaxgrpc::ClientBuilderBase<InstanceTemplatesClient>
    {
        ...
        private InstanceTemplatesClient BuildImpl()
        {
            ...
            return InstanceTemplatesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class InstanceTemplatesClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(InstanceTemplates.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
