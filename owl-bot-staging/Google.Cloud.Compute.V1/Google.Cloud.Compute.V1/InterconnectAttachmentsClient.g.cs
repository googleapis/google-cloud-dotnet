...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class InterconnectAttachmentsSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// Long Running Operation settings for calls to <c>InterconnectAttachmentsClient.Delete</c> and
        /// <c>InterconnectAttachmentsClient.DeleteAsync</c>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Long Running Operation settings for calls to <c>InterconnectAttachmentsClient.Insert</c> and
        /// <c>InterconnectAttachmentsClient.InsertAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// <summary>
        /// Long Running Operation settings for calls to <c>InterconnectAttachmentsClient.Patch</c> and
        /// <c>InterconnectAttachmentsClient.PatchAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>InterconnectAttachmentsClient.SetLabels</c> and <c>InterconnectAttachmentsClient.SetLabelsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// <summary>
        /// Long Running Operation settings for calls to <c>InterconnectAttachmentsClient.SetLabels</c> and
        /// <c>InterconnectAttachmentsClient.SetLabelsAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
    ...
    public sealed partial class InterconnectAttachmentsClientBuilder : gaxgrpc::ClientBuilderBase<InterconnectAttachmentsClient>
    {
        ...
        public InterconnectAttachmentsClientBuilder() : base(InterconnectAttachmentsClient.ServiceMetadata)
        {
        }
        ...
        private InterconnectAttachmentsClient BuildImpl()
        {
            ...
            return InterconnectAttachmentsClient.Create(callInvoker, GetEffectiveSettings(Settings?.Clone()), Logger);
        }
    ...
    public abstract partial class InterconnectAttachmentsClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(InterconnectAttachments.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
        ...
        /// <returns>The created <see cref="InterconnectAttachmentsClient"/>.</returns>
        internal static InterconnectAttachmentsClient Create(grpccore::CallInvoker callInvoker, InterconnectAttachmentsSettings settings = null, mel::ILogger logger = null)
        {
            ...
            return new InterconnectAttachmentsClientImpl(grpcClient, settings, logger);
        }
        ...
        public virtual lro::Operation<Operation, Operation> Delete(DeleteInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        public virtual stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(DeleteInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(DeleteInterconnectAttachmentRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> Delete(string project, string region, string interconnectAttachment, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(string project, string region, string interconnectAttachment, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(string project, string region, string interconnectAttachment, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> Insert(InsertInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> InsertAsync(InsertInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> InsertAsync(InsertInterconnectAttachmentRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> Insert(string project, string region, InterconnectAttachment interconnectAttachmentResource, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> InsertAsync(string project, string region, InterconnectAttachment interconnectAttachmentResource, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> InsertAsync(string project, string region, InterconnectAttachment interconnectAttachmentResource, st::CancellationToken cancellationToken) =>
        ...
        public virtual gax::PagedEnumerable<InterconnectAttachmentList, InterconnectAttachment> List(ListInterconnectAttachmentsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        public virtual gax::PagedAsyncEnumerable<InterconnectAttachmentList, InterconnectAttachment> ListAsync(ListInterconnectAttachmentsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="InterconnectAttachment"/> resources.</returns>
        public virtual gax::PagedEnumerable<InterconnectAttachmentList, InterconnectAttachment> List(string project, string region, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="InterconnectAttachment"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<InterconnectAttachmentList, InterconnectAttachment> ListAsync(string project, string region, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListInterconnectAttachmentsRequest request = new ListInterconnectAttachmentsRequest
            {
                Project = gax::GaxPreconditions.CheckNotNullOrEmpty(project, nameof(project)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> Patch(PatchInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> PatchAsync(PatchInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> PatchAsync(PatchInterconnectAttachmentRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> Patch(string project, string region, string interconnectAttachment, InterconnectAttachment interconnectAttachmentResource, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> PatchAsync(string project, string region, string interconnectAttachment, InterconnectAttachment interconnectAttachmentResource, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> PatchAsync(string project, string region, string interconnectAttachment, InterconnectAttachment interconnectAttachmentResource, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> SetLabels(SetLabelsInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> SetLabelsAsync(SetLabelsInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> SetLabelsAsync(SetLabelsInterconnectAttachmentRequest request, st::CancellationToken cancellationToken) =>
        ...
        public virtual lro::Operation<Operation, Operation> SetLabels(string project, string region, string resource, RegionSetLabelsRequest regionSetLabelsRequestResource, gaxgrpc::CallSettings callSettings = null) =>
            SetLabels(new SetLabelsInterconnectAttachmentRequest
            {
                Project = gax::GaxPreconditions.CheckNotNullOrEmpty(project, nameof(project)),
                Region = gax::GaxPreconditions.CheckNotNullOrEmpty(region, nameof(region)),
        ...
        public virtual stt::Task<lro::Operation<Operation, Operation>> SetLabelsAsync(string project, string region, string resource, RegionSetLabelsRequest regionSetLabelsRequestResource, gaxgrpc::CallSettings callSettings = null) =>
            SetLabelsAsync(new SetLabelsInterconnectAttachmentRequest
            {
                Project = gax::GaxPreconditions.CheckNotNullOrEmpty(project, nameof(project)),
                Region = gax::GaxPreconditions.CheckNotNullOrEmpty(region, nameof(region)),
                RegionSetLabelsRequestResource = gax::GaxPreconditions.CheckNotNull(regionSetLabelsRequestResource, nameof(regionSetLabelsRequestResource)),
    ...
    public sealed partial class InterconnectAttachmentsClientImpl : InterconnectAttachmentsClient
    {
        ...
        private readonly gaxgrpc::ApiCall<SetLabelsInterconnectAttachmentRequest, Operation> _callSetLabels;
        ...
        public InterconnectAttachmentsClientImpl(InterconnectAttachments.InterconnectAttachmentsClient grpcClient, InterconnectAttachmentsSettings settings, mel::ILogger logger)
        {
            ...
            _callAggregatedList = clientHelper.BuildApiCall<AggregatedListInterconnectAttachmentsRequest, InterconnectAttachmentAggregatedList>("AggregatedList", grpcClient.AggregatedListAsync, grpcClient.AggregatedList, effectiveSettings.AggregatedListSettings).WithGoogleRequestParam("project", request => request.Project);
            Modify_ApiCall(ref _callAggregatedList);
            Modify_AggregatedListApiCall(ref _callAggregatedList);
            _callDelete = clientHelper.BuildApiCall<DeleteInterconnectAttachmentRequest, Operation>("Delete", grpcClient.DeleteAsync, grpcClient.Delete, effectiveSettings.DeleteSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("interconnect_attachment", request => request.InterconnectAttachment);
            Modify_ApiCall(ref _callDelete);
            Modify_DeleteApiCall(ref _callDelete);
            _callGet = clientHelper.BuildApiCall<GetInterconnectAttachmentRequest, InterconnectAttachment>("Get", grpcClient.GetAsync, grpcClient.Get, effectiveSettings.GetSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("interconnect_attachment", request => request.InterconnectAttachment);
            Modify_ApiCall(ref _callGet);
            Modify_GetApiCall(ref _callGet);
            _callInsert = clientHelper.BuildApiCall<InsertInterconnectAttachmentRequest, Operation>("Insert", grpcClient.InsertAsync, grpcClient.Insert, effectiveSettings.InsertSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region);
            Modify_ApiCall(ref _callInsert);
            Modify_InsertApiCall(ref _callInsert);
            _callList = clientHelper.BuildApiCall<ListInterconnectAttachmentsRequest, InterconnectAttachmentList>("List", grpcClient.ListAsync, grpcClient.List, effectiveSettings.ListSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region);
            Modify_ApiCall(ref _callList);
            Modify_ListApiCall(ref _callList);
            _callPatch = clientHelper.BuildApiCall<PatchInterconnectAttachmentRequest, Operation>("Patch", grpcClient.PatchAsync, grpcClient.Patch, effectiveSettings.PatchSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("interconnect_attachment", request => request.InterconnectAttachment);
            Modify_ApiCall(ref _callPatch);
            Modify_PatchApiCall(ref _callPatch);
            _callSetLabels = clientHelper.BuildApiCall<SetLabelsInterconnectAttachmentRequest, Operation>("SetLabels", grpcClient.SetLabelsAsync, grpcClient.SetLabels, effectiveSettings.SetLabelsSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("resource", request => request.Resource);
        ...
        partial void Modify_SetLabelsApiCall(ref gaxgrpc::ApiCall<SetLabelsInterconnectAttachmentRequest, Operation> call);
        ...
        partial void Modify_SetLabelsInterconnectAttachmentRequest(ref SetLabelsInterconnectAttachmentRequest request, ref gaxgrpc::CallSettings settings);
        ...
        public override gax::PagedEnumerable<InterconnectAttachmentAggregatedList, scg::KeyValuePair<string, InterconnectAttachmentsScopedList>> AggregatedList(AggregatedListInterconnectAttachmentsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            ...
            return new gaxgrpc::GrpcPagedEnumerable<AggregatedListInterconnectAttachmentsRequest, InterconnectAttachmentAggregatedList, scg::KeyValuePair<string, InterconnectAttachmentsScopedList>>(_callAggregatedList, request, callSettings);
        }
        ...
        {
            Modify_AggregatedListInterconnectAttachmentsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedAsyncEnumerable<AggregatedListInterconnectAttachmentsRequest, InterconnectAttachmentAggregatedList, scg::KeyValuePair<string, InterconnectAttachmentsScopedList>>(_callAggregatedList, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Operation, Operation> Delete(DeleteInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Operation, Operation>> DeleteAsync(DeleteInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_DeleteInterconnectAttachmentRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Operation, Operation> Insert(InsertInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Operation, Operation>> InsertAsync(InsertInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_InsertInterconnectAttachmentRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="InterconnectAttachment"/> resources.</returns>
        public override gax::PagedEnumerable<InterconnectAttachmentList, InterconnectAttachment> List(ListInterconnectAttachmentsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListInterconnectAttachmentsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedEnumerable<ListInterconnectAttachmentsRequest, InterconnectAttachmentList, InterconnectAttachment>(_callList, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="InterconnectAttachment"/> resources.</returns>
        public override gax::PagedAsyncEnumerable<InterconnectAttachmentList, InterconnectAttachment> ListAsync(ListInterconnectAttachmentsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListInterconnectAttachmentsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedAsyncEnumerable<ListInterconnectAttachmentsRequest, InterconnectAttachmentList, InterconnectAttachment>(_callList, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Operation, Operation> Patch(PatchInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Operation, Operation>> PatchAsync(PatchInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_PatchInterconnectAttachmentRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Operation, Operation> SetLabels(SetLabelsInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_SetLabelsInterconnectAttachmentRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Operation, Operation>> SetLabelsAsync(SetLabelsInterconnectAttachmentRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_SetLabelsInterconnectAttachmentRequest(ref request, ref callSettings);
    ...
    public partial class AggregatedListInterconnectAttachmentsRequest : gaxgrpc::IPageRequest
    {
        /// <inheritdoc/>
        public int PageSize
        {
    ...
    public partial class InterconnectAttachmentAggregatedList : gaxgrpc::IPageResponse<scg::KeyValuePair<string, InterconnectAttachmentsScopedList>>
    {
        /// <summary>Returns an enumerator that iterates through the resources in this response.</summary>
        public scg::IEnumerator<scg::KeyValuePair<string, InterconnectAttachmentsScopedList>> GetEnumerator() =>
            Items.GetEnumerator();

        sc::IEnumerator sc::IEnumerable.GetEnumerator() => GetEnumerator();
    }

    public partial class InterconnectAttachmentList : gaxgrpc::IPageResponse<InterconnectAttachment>
    {
        /// <summary>Returns an enumerator that iterates through the resources in this response.</summary>
        public scg::IEnumerator<InterconnectAttachment> GetEnumerator() => Items.GetEnumerator();
    ...
    {
        public partial class InterconnectAttachmentsClient
        {
            /// <summary>
