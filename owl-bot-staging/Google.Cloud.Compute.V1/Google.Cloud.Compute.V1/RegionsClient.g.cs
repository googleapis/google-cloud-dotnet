...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class RegionsClientBuilder : gaxgrpc::ClientBuilderBase<RegionsClient>
    {
        ...
        private RegionsClient BuildImpl()
        {
            ...
            return RegionsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class RegionsClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Regions.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
