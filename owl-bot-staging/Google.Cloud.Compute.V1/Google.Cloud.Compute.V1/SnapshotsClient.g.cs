...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class SnapshotsClientBuilder : gaxgrpc::ClientBuilderBase<SnapshotsClient>
    {
        ...
        private SnapshotsClient BuildImpl()
        {
            ...
            return SnapshotsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class SnapshotsClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Snapshots.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
