...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class RegionAutoscalersClientBuilder : gaxgrpc::ClientBuilderBase<RegionAutoscalersClient>
    {
        ...
        private RegionAutoscalersClient BuildImpl()
        {
            ...
            return RegionAutoscalersClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class RegionAutoscalersClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(RegionAutoscalers.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
