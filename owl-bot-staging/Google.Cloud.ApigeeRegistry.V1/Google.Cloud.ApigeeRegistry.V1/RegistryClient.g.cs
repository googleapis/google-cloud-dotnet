...
namespace Google.Cloud.ApigeeRegistry.V1
{
    ...
    public sealed partial class RegistryClientBuilder : gaxgrpc::ClientBuilderBase<RegistryClient>
    {
        ...
        private RegistryClient BuildImpl()
        {
            ...
            return RegistryClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class RegistryClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Registry.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
