...
namespace Google.Cloud.ApigeeRegistry.V1
{
    ...
    public sealed partial class ProvisioningClientBuilder : gaxgrpc::ClientBuilderBase<ProvisioningClient>
    {
        ...
        private ProvisioningClient BuildImpl()
        {
            ...
            return ProvisioningClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ProvisioningClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Provisioning.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
