...
{
    // [START apigeeregistry_v1_generated_Registry_ListApis_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedRegistryClientSnippets
    {
        ...
        public async Task ListApisResourceNamesAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListApisResponse, Api> response = registryClient.ListApisAsync(parent);
    ...
    // [END apigeeregistry_v1_generated_Registry_ListApis_async_flattened_resourceNames]
}
