...
{
    // [START apigeeregistry_v1_generated_Registry_GetApi_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedRegistryClientSnippets
    {
        ...
        public async Task GetApiResourceNamesAsync()
        {
            ...
            // Make the request
            Api response = await registryClient.GetApiAsync(name);
        }
    }
    // [END apigeeregistry_v1_generated_Registry_GetApi_async_flattened_resourceNames]
}
