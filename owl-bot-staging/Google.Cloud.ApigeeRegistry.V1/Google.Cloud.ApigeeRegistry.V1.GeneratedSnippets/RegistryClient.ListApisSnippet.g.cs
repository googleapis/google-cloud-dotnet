...
{
    // [START apigeeregistry_v1_generated_Registry_ListApis_sync_flattened]
    ...
    public sealed partial class GeneratedRegistryClientSnippets
    {
        ...
        public void ListApis()
        {
            ...
            // Make the request
            PagedEnumerable<ListApisResponse, Api> response = registryClient.ListApis(parent);
    ...
    // [END apigeeregistry_v1_generated_Registry_ListApis_sync_flattened]
}
