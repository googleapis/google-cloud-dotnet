...
namespace Google.Cloud.Dialogflow.V2Beta1
{
    ...
    public abstract partial class DocumentsClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Document, KnowledgeOperationMetadata> UpdateDocument(Document document, gaxgrpc::CallSettings callSettings = null) =>
            UpdateDocument(new UpdateDocumentRequest
            {
                Document = gax::GaxPreconditions.CheckNotNull(document, nameof(document)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Document, KnowledgeOperationMetadata>> UpdateDocumentAsync(Document document, gaxgrpc::CallSettings callSettings = null) =>
            UpdateDocumentAsync(new UpdateDocumentRequest
            {
                Document = gax::GaxPreconditions.CheckNotNull(document, nameof(document)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Document, KnowledgeOperationMetadata>> UpdateDocumentAsync(Document document, st::CancellationToken cancellationToken) =>
            UpdateDocumentAsync(document, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Document, KnowledgeOperationMetadata> ReloadDocument(string name, GcsSource gcsSource, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Document, KnowledgeOperationMetadata>> ReloadDocumentAsync(string name, GcsSource gcsSource, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Document, KnowledgeOperationMetadata>> ReloadDocumentAsync(string name, GcsSource gcsSource, st::CancellationToken cancellationToken) =>
            ReloadDocumentAsync(name, gcsSource, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Document, KnowledgeOperationMetadata> ReloadDocument(DocumentName name, GcsSource gcsSource, gaxgrpc::CallSettings callSettings = null) =>
            ReloadDocument(new ReloadDocumentRequest
            {
                DocumentName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                GcsSource = gcsSource,
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Document, KnowledgeOperationMetadata>> ReloadDocumentAsync(DocumentName name, GcsSource gcsSource, gaxgrpc::CallSettings callSettings = null) =>
            ReloadDocumentAsync(new ReloadDocumentRequest
            {
                DocumentName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                GcsSource = gcsSource,
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Document, KnowledgeOperationMetadata>> ReloadDocumentAsync(DocumentName name, GcsSource gcsSource, st::CancellationToken cancellationToken) =>
            ReloadDocumentAsync(name, gcsSource, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
