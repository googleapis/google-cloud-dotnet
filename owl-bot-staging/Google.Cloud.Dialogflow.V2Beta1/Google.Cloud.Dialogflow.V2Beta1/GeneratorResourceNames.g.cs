...
namespace Google.Cloud.Dialogflow.V2Beta1
{
    ...
    public sealed partial class GeneratorName : gax::IResourceName, sys::IEquatable<GeneratorName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/generators/{generator}</c>.
            /// </summary>
            ProjectLocationGenerator = 1,
        }

        private static gax::PathTemplate s_projectLocationGenerator = new gax::PathTemplate("projects/{project}/locations/{location}/generators/{generator}");
        ...
        /// <c>projects/{project}/locations/{location}/generators/{generator}</c>.
        /// </summary>
        ...
        public static GeneratorName FromProjectLocationGenerator(string projectId, string locationId, string generatorId) =>
            new GeneratorName(ResourceNameType.ProjectLocationGenerator, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), generatorId: gax::GaxPreconditions.CheckNotNullOrEmpty(generatorId, nameof(generatorId)));
        ...
        /// <c>projects/{project}/locations/{location}/generators/{generator}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string generatorId) =>
            FormatProjectLocationGenerator(projectId, locationId, generatorId);
        ...
        /// <c>projects/{project}/locations/{location}/generators/{generator}</c>.
        /// </returns>
        public static string FormatProjectLocationGenerator(string projectId, string locationId, string generatorId) =>
            s_projectLocationGenerator.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(generatorId, nameof(generatorId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/generators/{generator}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string generatorName, bool allowUnparsed, out GeneratorName result)
        {
            ...
            if (s_projectLocationGenerator.TryParseName(generatorName, out resourceName))
            {
                result = FromProjectLocationGenerator(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private GeneratorName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string generatorId = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="generatorId">The <c>Generator</c> ID. Must not be <c>null</c> or empty.</param>
        public GeneratorName(string projectId, string locationId, string generatorId) : this(ResourceNameType.ProjectLocationGenerator, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), generatorId: gax::GaxPreconditions.CheckNotNullOrEmpty(generatorId, nameof(generatorId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationGenerator: return s_projectLocationGenerator.Expand(ProjectId, LocationId, GeneratorId);
    ...
    {
        /// <summary>
        /// <see cref="gcdv::GeneratorName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcdv::GeneratorName GeneratorName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcdv::GeneratorName.Parse(Name, allowUnparsed: true);
