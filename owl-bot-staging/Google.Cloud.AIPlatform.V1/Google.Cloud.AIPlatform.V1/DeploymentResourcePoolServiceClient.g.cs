...
namespace Google.Cloud.AIPlatform.V1
{
    ...
    public abstract partial class DeploymentResourcePoolServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(DeploymentResourcePoolService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
