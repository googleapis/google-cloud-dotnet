...
namespace Google.Cloud.AIPlatform.V1
{
    ...
    public sealed partial class LlmUtilityServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <c>LlmUtilityServiceClient.CountTokens</c> and <c>LlmUtilityServiceClient.CountTokensAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
    ...
    public abstract partial class LlmUtilityServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(LlmUtilityService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
