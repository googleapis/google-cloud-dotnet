...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::GenAiCacheServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddGenAiCacheServiceClient(this IServiceCollection services, sys::Action<gcav::GenAiCacheServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::GenAiCacheServiceClientBuilder builder = new gcav::GenAiCacheServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddGenAiCacheServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::GenAiCacheServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::GenAiCacheServiceClientBuilder builder = new gcav::GenAiCacheServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::ReasoningEngineExecutionServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddReasoningEngineExecutionServiceClient(this IServiceCollection services, sys::Action<gcav::ReasoningEngineExecutionServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::ReasoningEngineExecutionServiceClientBuilder builder = new gcav::ReasoningEngineExecutionServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddReasoningEngineExecutionServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::ReasoningEngineExecutionServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::ReasoningEngineExecutionServiceClientBuilder builder = new gcav::ReasoningEngineExecutionServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::ReasoningEngineServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddReasoningEngineServiceClient(this IServiceCollection services, sys::Action<gcav::ReasoningEngineServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::ReasoningEngineServiceClientBuilder builder = new gcav::ReasoningEngineServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddReasoningEngineServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::ReasoningEngineServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::ReasoningEngineServiceClientBuilder builder = new gcav::ReasoningEngineServiceClientBuilder();
                action?.Invoke(provider, builder);
