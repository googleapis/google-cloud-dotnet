...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedConfigServiceV2ClientSnippets
    {
        ...
        public void CreateBucketAsyncRequestObject()
        {
            ...
            // Make the request
            Operation<LogBucket, BucketMetadata> response = configServiceV2Client.CreateBucketAsync(request);
            ...
            Operation<LogBucket, BucketMetadata> retrievedResponse = configServiceV2Client.PollOnceCreateBucketAsync(operationName);
        ...
        /// <summary>Snippet for CreateBucketAsyncAsync</summary>
        public async Task CreateBucketAsyncRequestObjectAsync()
        {
            // Snippet: CreateBucketAsyncAsync(CreateBucketRequest, CallSettings)
            // Additional: CreateBucketAsyncAsync(CreateBucketRequest, CancellationToken)
            // Create client
            ConfigServiceV2Client configServiceV2Client = await ConfigServiceV2Client.CreateAsync();
            // Initialize request argument(s)
            CreateBucketRequest request = new CreateBucketRequest
            ...
            // Make the request
            Operation<LogBucket, BucketMetadata> response = await configServiceV2Client.CreateBucketAsyncAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<LogBucket, BucketMetadata> retrievedResponse = await configServiceV2Client.PollOnceCreateBucketAsyncAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public void UpdateBucketAsyncRequestObject()
        {
            ...
            // Make the request
            Operation<LogBucket, BucketMetadata> response = configServiceV2Client.UpdateBucketAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<LogBucket, BucketMetadata> retrievedResponse = configServiceV2Client.PollOnceUpdateBucketAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        {
            // Snippet: UpdateBucketAsyncAsync(UpdateBucketRequest, CallSettings)
            // Additional: UpdateBucketAsyncAsync(UpdateBucketRequest, CancellationToken)
            // Create client
            ConfigServiceV2Client configServiceV2Client = await ConfigServiceV2Client.CreateAsync();
            // Initialize request argument(s)
            UpdateBucketRequest request = new UpdateBucketRequest
