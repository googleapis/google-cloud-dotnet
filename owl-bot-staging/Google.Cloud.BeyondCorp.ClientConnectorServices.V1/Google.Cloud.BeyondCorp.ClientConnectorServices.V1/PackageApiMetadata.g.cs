...
namespace Google.Cloud.BeyondCorp.ClientConnectorServices.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.BeyondCorp.ClientConnectorServices.V1", GetFileDescriptors)
        ...
        {
            yield return ClientConnectorServicesServiceReflection.Descriptor;
