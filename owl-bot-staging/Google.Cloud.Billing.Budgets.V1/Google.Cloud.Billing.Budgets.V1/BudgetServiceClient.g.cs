...
namespace Google.Cloud.Billing.Budgets.V1
{
    ...
    public abstract partial class BudgetServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(BudgetService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc | gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Budget CreateBudget(string parent, Budget budget, gaxgrpc::CallSettings callSettings = null) =>
            CreateBudget(new CreateBudgetRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                Budget = gax::GaxPreconditions.CheckNotNull(budget, nameof(budget)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> CreateBudgetAsync(string parent, Budget budget, gaxgrpc::CallSettings callSettings = null) =>
            CreateBudgetAsync(new CreateBudgetRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                Budget = gax::GaxPreconditions.CheckNotNull(budget, nameof(budget)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> CreateBudgetAsync(string parent, Budget budget, st::CancellationToken cancellationToken) =>
            CreateBudgetAsync(parent, budget, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Budget CreateBudget(gagr::BillingAccountName parent, Budget budget, gaxgrpc::CallSettings callSettings = null) =>
            CreateBudget(new CreateBudgetRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> CreateBudgetAsync(gagr::BillingAccountName parent, Budget budget, gaxgrpc::CallSettings callSettings = null) =>
            CreateBudgetAsync(new CreateBudgetRequest
            {
                ParentAsBillingAccountName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Budget = gax::GaxPreconditions.CheckNotNull(budget, nameof(budget)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> CreateBudgetAsync(gagr::BillingAccountName parent, Budget budget, st::CancellationToken cancellationToken) =>
            CreateBudgetAsync(parent, budget, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Budget UpdateBudget(Budget budget, wkt::FieldMask updateMask, gaxgrpc::CallSettings callSettings = null) =>
            UpdateBudget(new UpdateBudgetRequest
            {
                Budget = gax::GaxPreconditions.CheckNotNull(budget, nameof(budget)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> UpdateBudgetAsync(Budget budget, wkt::FieldMask updateMask, gaxgrpc::CallSettings callSettings = null) =>
            UpdateBudgetAsync(new UpdateBudgetRequest
            {
                Budget = gax::GaxPreconditions.CheckNotNull(budget, nameof(budget)),
                UpdateMask = updateMask,
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> UpdateBudgetAsync(Budget budget, wkt::FieldMask updateMask, st::CancellationToken cancellationToken) =>
            UpdateBudgetAsync(budget, updateMask, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Budget GetBudget(string name, gaxgrpc::CallSettings callSettings = null) =>
            GetBudget(new GetBudgetRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> GetBudgetAsync(string name, gaxgrpc::CallSettings callSettings = null) =>
            GetBudgetAsync(new GetBudgetRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> GetBudgetAsync(string name, st::CancellationToken cancellationToken) =>
            GetBudgetAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Budget GetBudget(BudgetName name, gaxgrpc::CallSettings callSettings = null) =>
            GetBudget(new GetBudgetRequest
            {
                BudgetName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> GetBudgetAsync(BudgetName name, gaxgrpc::CallSettings callSettings = null) =>
            GetBudgetAsync(new GetBudgetRequest
            {
                BudgetName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Budget> GetBudgetAsync(BudgetName name, st::CancellationToken cancellationToken) =>
            GetBudgetAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void DeleteBudget(string name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteBudget(new DeleteBudgetRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteBudgetAsync(string name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteBudgetAsync(new DeleteBudgetRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteBudgetAsync(string name, st::CancellationToken cancellationToken) =>
            DeleteBudgetAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void DeleteBudget(BudgetName name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteBudget(new DeleteBudgetRequest
            {
                BudgetName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteBudgetAsync(BudgetName name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteBudgetAsync(new DeleteBudgetRequest
            {
                BudgetName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteBudgetAsync(BudgetName name, st::CancellationToken cancellationToken) =>
            DeleteBudgetAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
