...
{
    // [START dataplex_v1_generated_DataplexService_UpdateEnvironment_async_flattened]
    ...
    public sealed partial class GeneratedDataplexServiceClientSnippets
    {
        ...
        public async Task UpdateEnvironmentAsync()
        {
            ...
            // Make the request
            Operation<Environment, OperationMetadata> response = await dataplexServiceClient.UpdateEnvironmentAsync(environment, updateMask);
            ...
            Operation<Environment, OperationMetadata> retrievedResponse = await dataplexServiceClient.PollOnceUpdateEnvironmentAsync(operationName);
    ...
    // [END dataplex_v1_generated_DataplexService_UpdateEnvironment_async_flattened]
}
