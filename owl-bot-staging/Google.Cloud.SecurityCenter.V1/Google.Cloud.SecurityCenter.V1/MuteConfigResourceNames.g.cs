...
namespace Google.Cloud.SecurityCenter.V1
{
    ...
    public sealed partial class MuteConfigName : gax::IResourceName, sys::IEquatable<MuteConfigName>
    {
        ...
        private MuteConfigName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string folderId = null, string muteConfigId = null, string organizationId = null, string projectId = null)
        {
            Type = type;
