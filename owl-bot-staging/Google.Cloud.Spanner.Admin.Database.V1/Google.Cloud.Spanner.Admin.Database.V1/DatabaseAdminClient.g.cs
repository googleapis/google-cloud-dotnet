...
namespace Google.Cloud.Spanner.Admin.Database.V1
{
    ...
    public abstract partial class DatabaseAdminClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Backup, CopyBackupMetadata> CopyBackup(InstanceName parent, string backupId, BackupName sourceBackup, wkt::Timestamp expireTime, gaxgrpc::CallSettings callSettings = null) =>
            CopyBackup(new CopyBackupRequest
            {
                ParentAsInstanceName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                BackupId = gax::GaxPreconditions.CheckNotNullOrEmpty(backupId, nameof(backupId)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Backup, CopyBackupMetadata>> CopyBackupAsync(InstanceName parent, string backupId, BackupName sourceBackup, wkt::Timestamp expireTime, gaxgrpc::CallSettings callSettings = null) =>
            CopyBackupAsync(new CopyBackupRequest
            {
                ParentAsInstanceName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                BackupId = gax::GaxPreconditions.CheckNotNullOrEmpty(backupId, nameof(backupId)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Backup, CopyBackupMetadata>> CopyBackupAsync(InstanceName parent, string backupId, BackupName sourceBackup, wkt::Timestamp expireTime, st::CancellationToken cancellationToken) =>
            CopyBackupAsync(parent, backupId, sourceBackup, expireTime, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="DatabaseRole"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListDatabaseRolesResponse, DatabaseRole> ListDatabaseRoles(DatabaseName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListDatabaseRolesRequest request = new ListDatabaseRolesRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="DatabaseRole"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListDatabaseRolesResponse, DatabaseRole> ListDatabaseRolesAsync(DatabaseName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListDatabaseRolesRequest request = new ListDatabaseRolesRequest
            {
                ParentAsDatabaseName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual AddSplitPointsResponse AddSplitPoints(DatabaseName database, scg::IEnumerable<SplitPoints> splitPoints, gaxgrpc::CallSettings callSettings = null) =>
            AddSplitPoints(new AddSplitPointsRequest
            {
                DatabaseAsDatabaseName = gax::GaxPreconditions.CheckNotNull(database, nameof(database)),
                SplitPoints =
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AddSplitPointsResponse> AddSplitPointsAsync(DatabaseName database, scg::IEnumerable<SplitPoints> splitPoints, gaxgrpc::CallSettings callSettings = null) =>
            AddSplitPointsAsync(new AddSplitPointsRequest
            {
                DatabaseAsDatabaseName = gax::GaxPreconditions.CheckNotNull(database, nameof(database)),
                SplitPoints =
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AddSplitPointsResponse> AddSplitPointsAsync(DatabaseName database, scg::IEnumerable<SplitPoints> splitPoints, st::CancellationToken cancellationToken) =>
            AddSplitPointsAsync(database, splitPoints, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual BackupSchedule CreateBackupSchedule(DatabaseName parent, BackupSchedule backupSchedule, string backupScheduleId, gaxgrpc::CallSettings callSettings = null) =>
            CreateBackupSchedule(new CreateBackupScheduleRequest
            {
                ParentAsDatabaseName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                BackupScheduleId = gax::GaxPreconditions.CheckNotNullOrEmpty(backupScheduleId, nameof(backupScheduleId)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BackupSchedule> CreateBackupScheduleAsync(DatabaseName parent, BackupSchedule backupSchedule, string backupScheduleId, gaxgrpc::CallSettings callSettings = null) =>
            CreateBackupScheduleAsync(new CreateBackupScheduleRequest
            {
                ParentAsDatabaseName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                BackupScheduleId = gax::GaxPreconditions.CheckNotNullOrEmpty(backupScheduleId, nameof(backupScheduleId)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BackupSchedule> CreateBackupScheduleAsync(DatabaseName parent, BackupSchedule backupSchedule, string backupScheduleId, st::CancellationToken cancellationToken) =>
            CreateBackupScheduleAsync(parent, backupSchedule, backupScheduleId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="BackupSchedule"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListBackupSchedulesResponse, BackupSchedule> ListBackupSchedules(DatabaseName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListBackupSchedulesRequest request = new ListBackupSchedulesRequest
            {
                ParentAsDatabaseName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="BackupSchedule"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListBackupSchedulesResponse, BackupSchedule> ListBackupSchedulesAsync(DatabaseName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListBackupSchedulesRequest request = new ListBackupSchedulesRequest
            {
                ParentAsDatabaseName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
