...
| [Google.Cloud.BigQuery.Connection.V1](https://googleapis.dev/dotnet/Google.Cloud.BigQuery.Connection.V1/1.2.0) | 1.2.0 | [BigQuery Connection](https://cloud.google.com/bigquery/docs/reference/bigqueryconnection) |
| [Google.Cloud.BigQuery.DataTransfer.V1](https://googleapis.dev/dotnet/Google.Cloud.BigQuery.DataTransfer.V1/3.1.0) | 3.1.0 | [Google BigQuery Data Transfer](https://cloud.google.com/bigquery/transfer/) |
| [Google.Cloud.BigQuery.Reservation.V1](https://googleapis.dev/dotnet/Google.Cloud.BigQuery.Reservation.V1/1.2.0) | 1.2.0 | [BigQuery Reservation](https://cloud.google.com/bigquery/docs/reference/reservations) |
...
| [Google.Cloud.BigQuery.Storage.V1](https://googleapis.dev/dotnet/Google.Cloud.BigQuery.Storage.V1/2.3.0) | 2.3.0 | [Google BigQuery Storage](https://cloud.google.com/bigquery/docs/reference/storage/) |
...
| [Google.Cloud.DataFusion.V1](https://googleapis.dev/dotnet/Google.Cloud.DataFusion.V1/1.0.0-beta01) | 1.0.0-beta01 | [Cloud Data Fusion](https://cloud.google.com/data-fusion/docs/) |
...
| [Google.Cloud.Diagnostics.AspNetCore](https://googleapis.dev/dotnet/Google.Cloud.Diagnostics.AspNetCore/4.3.0-beta03) | 4.3.0-beta03 | Google Cloud Logging, Trace and Error Reporting Instrumentation Libraries for ASP.NET Core |
| [Google.Cloud.Diagnostics.AspNetCore3](https://googleapis.dev/dotnet/Google.Cloud.Diagnostics.AspNetCore3/4.3.0-beta03) | 4.3.0-beta03 | Google Cloud Logging, Trace and Error Reporting Instrumentation Libraries for ASP.NET Core 3 |
| [Google.Cloud.Diagnostics.Common](https://googleapis.dev/dotnet/Google.Cloud.Diagnostics.Common/4.3.0-beta03) | 4.3.0-beta03 | Google Cloud Logging, Trace and Error Reporting Instrumentation Libraries Common Components |
...
| [Google.Cloud.DocumentAI.V1](https://googleapis.dev/dotnet/Google.Cloud.DocumentAI.V1/1.1.0) | 1.1.0 | [Cloud Document AI (V1 API)](https://cloud.google.com/solutions/document-ai) |
...
| [Google.Cloud.Filestore.V1](https://googleapis.dev/dotnet/Google.Cloud.Filestore.V1/1.0.0) | 1.0.0 | Cloud Filestore |
...
| [Google.Cloud.GkeHub.V1Beta1](https://googleapis.dev/dotnet/Google.Cloud.GkeHub.V1Beta1/1.0.0-beta02) | 1.0.0-beta02 | [GKE Hub (V1Beta1 API)](https://cloud.google.com/anthos/multicluster-management/connect/registering-a-cluster) |
| [Google.Cloud.GkeHub.V1](https://googleapis.dev/dotnet/Google.Cloud.GkeHub.V1/1.0.0-beta01) | 1.0.0-beta01 | [GKE Hub (V1 API)](https://cloud.google.com/anthos/multicluster-management/connect/registering-a-cluster) |
...
| [Google.Cloud.NetworkManagement.V1](https://googleapis.dev/dotnet/Google.Cloud.NetworkManagement.V1/1.0.0-beta01) | 1.0.0-beta01 | [Network Management](https://cloud.google.com/network-intelligence-center/docs/) |
...
| [Google.Cloud.RecaptchaEnterprise.V1](https://googleapis.dev/dotnet/Google.Cloud.RecaptchaEnterprise.V1/1.2.0) | 1.2.0 | [Google Cloud reCAPTCHA Enterprise (V1 API)](https://cloud.google.com/recaptcha-enterprise/) |
| [Google.Cloud.RecaptchaEnterprise.V1Beta1](https://googleapis.dev/dotnet/Google.Cloud.RecaptchaEnterprise.V1Beta1/1.0.0-beta04) | 1.0.0-beta04 | [Google Cloud reCAPTCHA Enterprise (V1Beta1 API)](https://cloud.google.com/recaptcha-enterprise/) |
...
| [Google.Cloud.Spanner.Admin.Database.V1](https://googleapis.dev/dotnet/Google.Cloud.Spanner.Admin.Database.V1/3.11.0) | 3.11.0 | [Google Cloud Spanner Database Administration](https://cloud.google.com/spanner/) |
| [Google.Cloud.Spanner.Admin.Instance.V1](https://googleapis.dev/dotnet/Google.Cloud.Spanner.Admin.Instance.V1/3.11.0) | 3.11.0 | [Google Cloud Spanner Instance Administration](https://cloud.google.com/spanner/) |
| [Google.Cloud.Spanner.Data](https://googleapis.dev/dotnet/Google.Cloud.Spanner.Data/3.11.0) | 3.11.0 | Google ADO.NET Provider for Google Cloud Spanner |
...
| [Google.Cloud.Tasks.V2Beta3](https://googleapis.dev/dotnet/Google.Cloud.Tasks.V2Beta3/2.0.0-beta06) | 2.0.0-beta06 | [Google Cloud Tasks (V2Beta3 API)](https://cloud.google.com/tasks/) |
...
| [Google.Cloud.Tpu.V1](https://googleapis.dev/dotnet/Google.Cloud.Tpu.V1/1.0.0) | 1.0.0 | [Cloud TPU](https://cloud.google.com/tpu/) |
...
| [Google.Cloud.Video.Transcoder.V1](https://googleapis.dev/dotnet/Google.Cloud.Video.Transcoder.V1/1.0.0-beta01) | 1.0.0-beta01 | [Transcoder (V1 API)](https://cloud.google.com/transcoder/docs) |
| [Google.Cloud.Video.Transcoder.V1Beta1](https://googleapis.dev/dotnet/Google.Cloud.Video.Transcoder.V1Beta1/1.0.0-beta02) | 1.0.0-beta02 | [Transcoder (V1Beta1 API)](https://cloud.google.com/transcoder/docs) |
...
| [Google.Identity.AccessContextManager.Type](https://googleapis.dev/dotnet/Google.Identity.AccessContextManager.Type/1.1.0) | 1.1.0 | Version-agnostic types for the Google Identity Access Context Manager API |
| [Google.Identity.AccessContextManager.V1](https://googleapis.dev/dotnet/Google.Identity.AccessContextManager.V1/1.2.0) | 1.2.0 | Recommended Google client library to access the Identity Access Context Manager API V1 |
