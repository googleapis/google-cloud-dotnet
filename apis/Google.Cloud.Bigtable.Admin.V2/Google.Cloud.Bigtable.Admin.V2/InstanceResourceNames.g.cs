...
namespace Google.Cloud.Bigtable.Admin.V2
{
    ...
    /// <summary>Resource name for the <c>MemoryLayer</c> resource.</summary>
    public sealed partial class MemoryLayerName : gax::IResourceName, sys::IEquatable<MemoryLayerName>
    {
        /// <summary>The possible contents of <see cref="MemoryLayerName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/instances/{instance}/clusters/{cluster}/memoryLayer</c>
            /// .
            /// </summary>
            ProjectInstanceCluster = 1,
        }

        private static gax::PathTemplate s_projectInstanceCluster = new gax::PathTemplate("projects/{project}/instances/{instance}/clusters/{cluster}/memoryLayer");

        /// <summary>Creates a <see cref="MemoryLayerName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="MemoryLayerName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static MemoryLayerName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new MemoryLayerName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="MemoryLayerName"/> with the pattern
        /// <c>projects/{project}/instances/{instance}/clusters/{cluster}/memoryLayer</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="instanceId">The <c>Instance</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="clusterId">The <c>Cluster</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="MemoryLayerName"/> constructed from the provided ids.</returns>
        public static MemoryLayerName FromProjectInstanceCluster(string projectId, string instanceId, string clusterId) =>
            new MemoryLayerName(ResourceNameType.ProjectInstanceCluster, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), instanceId: gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)), clusterId: gax::GaxPreconditions.CheckNotNullOrEmpty(clusterId, nameof(clusterId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="MemoryLayerName"/> with pattern
        /// <c>projects/{project}/instances/{instance}/clusters/{cluster}/memoryLayer</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="instanceId">The <c>Instance</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="clusterId">The <c>Cluster</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="MemoryLayerName"/> with pattern
        /// <c>projects/{project}/instances/{instance}/clusters/{cluster}/memoryLayer</c>.
        /// </returns>
        public static string Format(string projectId, string instanceId, string clusterId) =>
            FormatProjectInstanceCluster(projectId, instanceId, clusterId);
        ...
        /// <summary>Parses the given resource name string into a new <see cref="MemoryLayerName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/instances/{instance}/clusters/{cluster}/memoryLayer</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        /// <param name="memoryLayerName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="MemoryLayerName"/> if successful.</returns>
        public static MemoryLayerName Parse(string memoryLayerName) => Parse(memoryLayerName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="MemoryLayerName"/> instance; optionally allowing
        ...
        /// </param>
        /// <returns>The parsed <see cref="MemoryLayerName"/> if successful.</returns>
        public static MemoryLayerName Parse(string memoryLayerName, bool allowUnparsed) =>
            TryParse(memoryLayerName, allowUnparsed, out MemoryLayerName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="MemoryLayerName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="memoryLayerName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="MemoryLayerName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string memoryLayerName, out MemoryLayerName result) =>
            TryParse(memoryLayerName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="MemoryLayerName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string memoryLayerName, bool allowUnparsed, out MemoryLayerName result)
        {
            gax::GaxPreconditions.CheckNotNull(memoryLayerName, nameof(memoryLayerName));
            gax::TemplatedResourceName resourceName;
            if (s_projectInstanceCluster.TryParseName(memoryLayerName, out resourceName))
            {
                result = FromProjectInstanceCluster(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(memoryLayerName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private MemoryLayerName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string clusterId = null, string instanceId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            ClusterId = clusterId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="MemoryLayerName"/> class from the component parts of pattern
        /// <c>projects/{project}/instances/{instance}/clusters/{cluster}/memoryLayer</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="instanceId">The <c>Instance</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="clusterId">The <c>Cluster</c> ID. Must not be <c>null</c> or empty.</param>
        public MemoryLayerName(string projectId, string instanceId, string clusterId) : this(ResourceNameType.ProjectInstanceCluster, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), instanceId: gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)), clusterId: gax::GaxPreconditions.CheckNotNullOrEmpty(clusterId, nameof(clusterId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as MemoryLayerName);

        /// <inheritdoc/>
        public bool Equals(MemoryLayerName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(MemoryLayerName a, MemoryLayerName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(MemoryLayerName a, MemoryLayerName b) => !(a == b);
    }
    ...
    public partial class MemoryLayer
    {
        /// <summary>
