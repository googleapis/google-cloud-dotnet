...
namespace Google.Cloud.Iap.V1
{
    ...
    public abstract partial class IdentityAwareProxyOAuthServiceClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(IdentityAwareProxyOAuthService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
