...
{
    // [START storageinsights_v1_generated_StorageInsights_ListDatasetConfigs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedStorageInsightsClientSnippets
    {
        ...
        public async Task ListDatasetConfigsResourceNamesAsync()
        {
            ...
            await foreach (DatasetConfig item in response)
            {
            ...
            await foreach (ListDatasetConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END storageinsights_v1_generated_StorageInsights_ListDatasetConfigs_async_flattened_resourceNames]
}
