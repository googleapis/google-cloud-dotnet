...
{
    /// <summary>Resource name for the <c>ApiNamespace</c> resource.</summary>
    public sealed partial class ApiNamespaceName : gax::IResourceName, sys::IEquatable<ApiNamespaceName>
    {
        /// <summary>The possible contents of <see cref="ApiNamespaceName"/>.</summary>
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/apiNamespaces/{api_namespace}</c>
            /// .
            /// </summary>
        ...
        /// <summary>Creates a <see cref="ApiNamespaceName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ApiNamespaceName"/> containing the provided
        ...
        /// <summary>
        /// Creates a <see cref="ApiNamespaceName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/apiNamespaces/{api_namespace}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="apiNamespaceId">The <c>ApiNamespace</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="ApiNamespaceName"/> constructed from the provided ids.</returns>
        ...
        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ApiNamespaceName"/> with pattern
        /// <c>projects/{project}/locations/{location}/apiNamespaces/{api_namespace}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="apiNamespaceId">The <c>ApiNamespace</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="ApiNamespaceName"/> with pattern
        /// <c>projects/{project}/locations/{location}/apiNamespaces/{api_namespace}</c>.
        /// </returns>
        ...
        /// <summary>Parses the given resource name string into a new <see cref="ApiNamespaceName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/apiNamespaces/{api_namespace}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        /// <param name="apiNamespaceName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="ApiNamespaceName"/> if successful.</returns>
        public static ApiNamespaceName Parse(string apiNamespaceName) => Parse(apiNamespaceName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ApiNamespaceName"/> instance; optionally
        ...
        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ApiNamespaceName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="apiNamespaceName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ApiNamespaceName"/>, or <c>null</c> if parsing failed.
        /// </param>
        ...
        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ApiNamespaceName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="ApiNamespaceName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/apiNamespaces/{api_namespace}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <summary>
        /// The <c>ApiNamespace</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
    ...
    {
        /// <summary>
        /// <see cref="McpServerName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
