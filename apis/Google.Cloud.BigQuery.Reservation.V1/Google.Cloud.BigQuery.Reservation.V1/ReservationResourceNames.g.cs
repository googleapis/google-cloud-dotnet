...
namespace Google.Cloud.BigQuery.Reservation.V1
{
    ...
    /// <summary>Resource name for the <c>ReservationGroup</c> resource.</summary>
    public sealed partial class ReservationGroupName : gax::IResourceName, sys::IEquatable<ReservationGroupName>
    {
        /// <summary>The possible contents of <see cref="ReservationGroupName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <c>projects/{project}/locations/{location}/reservationGroups/{reservation_group}</c>.
            /// </summary>
            ProjectLocationReservationGroup = 1,
        }

        private static gax::PathTemplate s_projectLocationReservationGroup = new gax::PathTemplate("projects/{project}/locations/{location}/reservationGroups/{reservation_group}");

        /// <summary>Creates a <see cref="ReservationGroupName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ReservationGroupName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static ReservationGroupName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new ReservationGroupName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="ReservationGroupName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/reservationGroups/{reservation_group}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="reservationGroupId">The <c>ReservationGroup</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="ReservationGroupName"/> constructed from the provided ids.</returns>
        public static ReservationGroupName FromProjectLocationReservationGroup(string projectId, string locationId, string reservationGroupId) =>
            new ReservationGroupName(ResourceNameType.ProjectLocationReservationGroup, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), reservationGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(reservationGroupId, nameof(reservationGroupId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ReservationGroupName"/> with pattern
        /// <c>projects/{project}/locations/{location}/reservationGroups/{reservation_group}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="reservationGroupId">The <c>ReservationGroup</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="ReservationGroupName"/> with pattern
        /// <c>projects/{project}/locations/{location}/reservationGroups/{reservation_group}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string reservationGroupId) =>
            FormatProjectLocationReservationGroup(projectId, locationId, reservationGroupId);
        ...
        /// <c>projects/{project}/locations/{location}/reservationGroups/{reservation_group}</c>.
        /// </returns>
        public static string FormatProjectLocationReservationGroup(string projectId, string locationId, string reservationGroupId) =>
            s_projectLocationReservationGroup.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(reservationGroupId, nameof(reservationGroupId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ReservationGroupName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="reservationGroupName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="ReservationGroupName"/> if successful.</returns>
        public static ReservationGroupName Parse(string reservationGroupName) => Parse(reservationGroupName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ReservationGroupName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="ReservationGroupName"/> if successful.</returns>
        public static ReservationGroupName Parse(string reservationGroupName, bool allowUnparsed) =>
            TryParse(reservationGroupName, allowUnparsed, out ReservationGroupName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ReservationGroupName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="reservationGroupName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ReservationGroupName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string reservationGroupName, out ReservationGroupName result) =>
            TryParse(reservationGroupName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string reservationGroupName, bool allowUnparsed, out ReservationGroupName result)
        {
            gax::GaxPreconditions.CheckNotNull(reservationGroupName, nameof(reservationGroupName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationReservationGroup.TryParseName(reservationGroupName, out resourceName))
            {
                result = FromProjectLocationReservationGroup(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(reservationGroupName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private ReservationGroupName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string reservationGroupId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="ReservationGroupName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/reservationGroups/{reservation_group}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="reservationGroupId">The <c>ReservationGroup</c> ID. Must not be <c>null</c> or empty.</param>
        public ReservationGroupName(string projectId, string locationId, string reservationGroupId) : this(ResourceNameType.ProjectLocationReservationGroup, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), reservationGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(reservationGroupId, nameof(reservationGroupId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ReservationGroup</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        public string ReservationGroupId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationReservationGroup: return s_projectLocationReservationGroup.Expand(ProjectId, LocationId, ReservationGroupId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as ReservationGroupName);

        /// <inheritdoc/>
        public bool Equals(ReservationGroupName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(ReservationGroupName a, ReservationGroupName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(ReservationGroupName a, ReservationGroupName b) => !(a == b);
    }
    ...
    {
        /// <summary>
        /// <see cref="gcbrv::ReservationGroupName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcbrv::ReservationGroupName ReservationGroupName
        {
    ...
    public partial class CreateReservationGroupRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class GetReservationGroupRequest
    {
        /// <summary>
        /// <see cref="gcbrv::ReservationGroupName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class ListReservationGroupsRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class DeleteReservationGroupRequest
    {
        /// <summary>
        /// <see cref="gcbrv::ReservationGroupName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
