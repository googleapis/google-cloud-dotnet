...
{
    // [START bigqueryreservation_v1_generated_ReservationService_ListAssignments_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedReservationServiceClientSnippets
    {
        ...
        public async Task ListAssignmentsResourceNamesAsync()
        {
            ...
            await foreach (Assignment item in response)
            {
            ...
            await foreach (ListAssignmentsResponse page in response.AsRawResponses())
            {
    ...
    // [END bigqueryreservation_v1_generated_ReservationService_ListAssignments_async_flattened_resourceNames]
}
