...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedReservationServiceClientSnippets
    {
        ...
        public async Task ListReservationGroupsRequestObjectAsync()
        {
            ...
            await foreach (ReservationGroup item in response)
            {
            ...
            await foreach (ListReservationGroupsResponse page in response.AsRawResponses())
            {
    ...
    // [END bigqueryreservation_v1_generated_ReservationService_ListReservationGroups_async]
}
