...
{
    // [START bigqueryreservation_v1_generated_ReservationService_ListReservations_async_flattened]
    ...
    public sealed partial class GeneratedReservationServiceClientSnippets
    {
        ...
        public async Task ListReservationsAsync()
        {
            ...
            await foreach (Reservation item in response)
            {
            ...
            await foreach (ListReservationsResponse page in response.AsRawResponses())
            {
    ...
    // [END bigqueryreservation_v1_generated_ReservationService_ListReservations_async_flattened]
}
