...
{
    // [START transcoder_v1_generated_TranscoderService_ListJobTemplates_async_flattened]
    ...
    public sealed partial class GeneratedTranscoderServiceClientSnippets
    {
        ...
        public async Task ListJobTemplatesAsync()
        {
            ...
            await foreach (JobTemplate item in response)
            {
            ...
            await foreach (ListJobTemplatesResponse page in response.AsRawResponses())
            {
    ...
    // [END transcoder_v1_generated_TranscoderService_ListJobTemplates_async_flattened]
}
