...
namespace Google.Cloud.Tasks.V2Beta2
{
    ...
    public sealed partial class CloudTasksSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>CloudTasksClient.LeaseTasks</c> and <c>CloudTasksClient.LeaseTasksAsync</c>.
        /// </summary>
        /// <remarks>
        /// The default <c>CloudTasksClient.LeaseTasks</c> and
        /// <c>CloudTasksClient.LeaseTasksAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds</description></item>
        /// <item><description>Retry delay multiplier: 1.3</description></item>
        /// <item><description>Retry maximum delay: 60000 milliseconds</description></item>
        ...
        /// Default RPC expiration is 600000 milliseconds.
        /// </remarks>
        public gaxgrpc::CallSettings LeaseTasksSettings { get; set; } = gaxgrpc::CallSettings.FromCallTiming(
            gaxgrpc::CallTiming.FromRetry(new gaxgrpc::RetrySettings(
                retryBackoff: GetDefaultRetryBackoff(),
                timeoutBackoff: GetDefaultTimeoutBackoff(),
                totalExpiration: gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(600000)),
        ...
        /// </summary>
        /// <remarks>
        /// The default <c>CloudTasksClient.AcknowledgeTask</c> and
        /// <c>CloudTasksClient.AcknowledgeTaskAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds</description></item>
        /// <item><description>Retry delay multiplier: 1.3</description></item>
        /// <item><description>Retry maximum delay: 60000 milliseconds</description></item>
        ...
        /// Default RPC expiration is 600000 milliseconds.
        /// </remarks>
        public gaxgrpc::CallSettings AcknowledgeTaskSettings { get; set; } = gaxgrpc::CallSettings.FromCallTiming(
            gaxgrpc::CallTiming.FromRetry(new gaxgrpc::RetrySettings(
                retryBackoff: GetDefaultRetryBackoff(),
                timeoutBackoff: GetDefaultTimeoutBackoff(),
                totalExpiration: gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(600000)),
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>CloudTasksClient.RenewLease</c> and <c>CloudTasksClient.RenewLeaseAsync</c>.
        /// </summary>
        /// <remarks>
        /// The default <c>CloudTasksClient.RenewLease</c> and
        /// <c>CloudTasksClient.RenewLeaseAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds</description></item>
        /// <item><description>Retry delay multiplier: 1.3</description></item>
        /// <item><description>Retry maximum delay: 60000 milliseconds</description></item>
        ...
        /// Default RPC expiration is 600000 milliseconds.
        /// </remarks>
        public gaxgrpc::CallSettings RenewLeaseSettings { get; set; } = gaxgrpc::CallSettings.FromCallTiming(
            gaxgrpc::CallTiming.FromRetry(new gaxgrpc::RetrySettings(
                retryBackoff: GetDefaultRetryBackoff(),
                timeoutBackoff: GetDefaultTimeoutBackoff(),
                totalExpiration: gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(600000)),
        ...
        /// </summary>
        /// <remarks>
        /// The default <c>CloudTasksClient.CancelLease</c> and
        /// <c>CloudTasksClient.CancelLeaseAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds</description></item>
        /// <item><description>Retry delay multiplier: 1.3</description></item>
        /// <item><description>Retry maximum delay: 60000 milliseconds</description></item>
        ...
        /// Default RPC expiration is 600000 milliseconds.
        /// </remarks>
        public gaxgrpc::CallSettings CancelLeaseSettings { get; set; } = gaxgrpc::CallSettings.FromCallTiming(
            gaxgrpc::CallTiming.FromRetry(new gaxgrpc::RetrySettings(
                retryBackoff: GetDefaultRetryBackoff(),
                timeoutBackoff: GetDefaultTimeoutBackoff(),
                totalExpiration: gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(600000)),
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>CloudTasksClient.ListLocations</c> and <c>CloudTasksClient.ListLocationsAsync</c>.
        /// </summary>
        /// <remarks>
        /// The default <c>CloudTasksClient.ListLocations</c> and
        /// <c>CloudTasksClient.ListLocationsAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds</description></item>
        /// <item><description>Retry delay multiplier: 1.3</description></item>
        /// <item><description>Retry maximum delay: 60000 milliseconds</description></item>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>CloudTasksClient.GetLocation</c> and <c>CloudTasksClient.GetLocationAsync</c>.
        /// </summary>
        /// <remarks>
        /// The default <c>CloudTasksClient.GetLocation</c> and
        /// <c>CloudTasksClient.GetLocationAsync</c> <see cref="gaxgrpc::RetrySettings"/> are:
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds</description></item>
        /// <item><description>Retry delay multiplier: 1.3</description></item>
        /// <item><description>Retry maximum delay: 60000 milliseconds</description></item>
    ...
    public abstract partial class CloudTasksClient
    {
        ...
        /// A Task containing the RPC response.
        /// </returns>
        public virtual stt::Task<LeaseTasksResponse> LeaseTasksAsync(
        ...
        public virtual stt::Task<LeaseTasksResponse> LeaseTasksAsync(
            LeaseTasksRequest request,
            st::CancellationToken cancellationToken) => LeaseTasksAsync(
                request,
                gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// The RPC response.
        /// </returns>
        public virtual LeaseTasksResponse LeaseTasks(
            LeaseTasksRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            throw new sys::NotImplementedException();
        ...
        public virtual gax::PagedAsyncEnumerable<gcl::ListLocationsResponse, gcl::Location> ListLocationsAsync(
            ...
            gaxgrpc::CallSettings callSettings = null) => ListLocationsAsync(
                ...
                {
                    NameAsResourceName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                    PageToken = pageToken ?? "",
                    PageSize = pageSize ?? 0,
                },
                callSettings);
    ...
    public sealed partial class CloudTasksClientImpl : CloudTasksClient
    {
        ...
        private readonly gaxgrpc::ApiCall<AcknowledgeTaskRequest, pbwkt::Empty> _callAcknowledgeTask;
        ...
        partial void Modify_AcknowledgeTaskApiCall(ref gaxgrpc::ApiCall<AcknowledgeTaskRequest, pbwkt::Empty> call);
        ...
        /// A Task containing the RPC response.
        /// </returns>
        public override stt::Task<LeaseTasksResponse> LeaseTasksAsync(
            LeaseTasksRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// The RPC response.
        /// </returns>
        public override LeaseTasksResponse LeaseTasks(
            LeaseTasksRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            Modify_LeaseTasksRequest(ref request, ref callSettings);
        ...
        /// A Task that completes when the RPC has completed.
        /// </returns>
        public override stt::Task AcknowledgeTaskAsync(
            AcknowledgeTaskRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// If not null, applies overrides to this RPC call.
        /// </param>
        public override void AcknowledgeTask(
            AcknowledgeTaskRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            Modify_AcknowledgeTaskRequest(ref request, ref callSettings);
        ...
        /// A Task containing the RPC response.
        /// </returns>
        public override stt::Task<Task> RenewLeaseAsync(
            RenewLeaseRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// The RPC response.
        /// </returns>
        public override Task RenewLease(
            RenewLeaseRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            Modify_RenewLeaseRequest(ref request, ref callSettings);
        ...
        /// A Task containing the RPC response.
        /// </returns>
        public override stt::Task<Task> CancelLeaseAsync(
            CancelLeaseRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// The RPC response.
        /// </returns>
        public override Task CancelLease(
            CancelLeaseRequest request,
            gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CancelLeaseRequest(ref request, ref callSettings);
