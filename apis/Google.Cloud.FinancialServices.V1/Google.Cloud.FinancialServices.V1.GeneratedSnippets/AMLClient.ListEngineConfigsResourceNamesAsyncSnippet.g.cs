...
{
    // [START financialservices_v1_generated_AML_ListEngineConfigs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAMLClientSnippets
    {
        ...
        public async Task ListEngineConfigsResourceNamesAsync()
        {
            ...
            await foreach (EngineConfig item in response)
            {
            ...
            await foreach (ListEngineConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END financialservices_v1_generated_AML_ListEngineConfigs_async_flattened_resourceNames]
}
