...
{
    // [START financialservices_v1_generated_AML_ListBacktestResults_async_flattened]
    ...
    public sealed partial class GeneratedAMLClientSnippets
    {
        ...
        public async Task ListBacktestResultsAsync()
        {
            ...
            await foreach (BacktestResult item in response)
            {
            ...
            await foreach (ListBacktestResultsResponse page in response.AsRawResponses())
            {
    ...
    // [END financialservices_v1_generated_AML_ListBacktestResults_async_flattened]
}
