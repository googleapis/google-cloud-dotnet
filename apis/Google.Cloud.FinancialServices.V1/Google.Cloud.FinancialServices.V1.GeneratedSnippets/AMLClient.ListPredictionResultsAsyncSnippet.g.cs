...
{
    // [START financialservices_v1_generated_AML_ListPredictionResults_async_flattened]
    ...
    public sealed partial class GeneratedAMLClientSnippets
    {
        ...
        public async Task ListPredictionResultsAsync()
        {
            ...
            await foreach (PredictionResult item in response)
            {
            ...
            await foreach (ListPredictionResultsResponse page in response.AsRawResponses())
            {
    ...
    // [END financialservices_v1_generated_AML_ListPredictionResults_async_flattened]
}
