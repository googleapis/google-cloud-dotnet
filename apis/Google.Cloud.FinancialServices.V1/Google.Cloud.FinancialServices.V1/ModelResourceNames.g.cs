...
namespace Google.Cloud.FinancialServices.V1
{
    ...
    public sealed partial class ModelName : gax::IResourceName, sys::IEquatable<ModelName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project_num}/locations/{location}/instances/{instance}/models/{model}</c>.
            /// </summary>
            ProjectNumLocationInstanceModel = 1,
        }

        private static gax::PathTemplate s_projectNumLocationInstanceModel = new gax::PathTemplate("projects/{project_num}/locations/{location}/instances/{instance}/models/{model}");
        ...
        public static ModelName FromProjectNumLocationInstanceModel(string projectNumId, string locationId, string instanceId, string modelId) =>
            new ModelName(ResourceNameType.ProjectNumLocationInstanceModel, projectNumId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectNumId, nameof(projectNumId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), instanceId: gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)), modelId: gax::GaxPreconditions.CheckNotNullOrEmpty(modelId, nameof(modelId)));
        ...
        /// <c>projects/{project_num}/locations/{location}/instances/{instance}/models/{model}</c>.
        /// </returns>
        public static string Format(string projectNumId, string locationId, string instanceId, string modelId) =>
            FormatProjectNumLocationInstanceModel(projectNumId, locationId, instanceId, modelId);
        ...
        /// <c>projects/{project_num}/locations/{location}/instances/{instance}/models/{model}</c>.
        /// </returns>
        public static string FormatProjectNumLocationInstanceModel(string projectNumId, string locationId, string instanceId, string modelId) =>
            s_projectNumLocationInstanceModel.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectNumId, nameof(projectNumId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)), gax::GaxPreconditions.CheckNotNullOrEmpty(modelId, nameof(modelId)));
        ...
        public static bool TryParse(string modelName, bool allowUnparsed, out ModelName result)
        {
            ...
            if (s_projectNumLocationInstanceModel.TryParseName(modelName, out resourceName))
            {
                result = FromProjectNumLocationInstanceModel(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ModelName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string instanceId = null, string locationId = null, string modelId = null, string projectNumId = null)
        {
            Type = type;
        ...
        /// <param name="instanceId">The <c>Instance</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="modelId">The <c>Model</c> ID. Must not be <c>null</c> or empty.</param>
        public ModelName(string projectNumId, string locationId, string instanceId, string modelId) : this(ResourceNameType.ProjectNumLocationInstanceModel, projectNumId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectNumId, nameof(projectNumId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), instanceId: gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)), modelId: gax::GaxPreconditions.CheckNotNullOrEmpty(modelId, nameof(modelId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectNumLocationInstanceModel: return s_projectNumLocationInstanceModel.Expand(ProjectNumId, LocationId, InstanceId, ModelId);
    ...
    {
        /// <summary>
        /// <see cref="gcfv::ModelName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcfv::ModelName ModelName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcfv::ModelName.Parse(Name, allowUnparsed: true);
    ...
    public partial class ExportModelMetadataRequest
    {
