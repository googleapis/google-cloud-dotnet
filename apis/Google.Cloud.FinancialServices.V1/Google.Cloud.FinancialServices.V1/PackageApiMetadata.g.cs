...
namespace Google.Cloud.FinancialServices.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.FinancialServices.V1", GetFileDescriptors)
        ...
        {
            yield return BacktestResultReflection.Descriptor;
            yield return BigqueryDestinationReflection.Descriptor;
            yield return DatasetReflection.Descriptor;
            yield return EngineConfigReflection.Descriptor;
            yield return EngineVersionReflection.Descriptor;
            yield return InstanceReflection.Descriptor;
            yield return LineOfBusinessReflection.Descriptor;
            yield return ModelReflection.Descriptor;
            yield return PredictionResultReflection.Descriptor;
