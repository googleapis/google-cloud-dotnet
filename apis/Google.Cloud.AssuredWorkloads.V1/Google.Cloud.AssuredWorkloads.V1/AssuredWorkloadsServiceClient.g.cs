...
namespace Google.Cloud.AssuredWorkloads.V1
{
    ...
    public abstract partial class AssuredWorkloadsServiceClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(AssuredWorkloadsService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
