...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedBatchServiceClientSnippets
    {
        ...
        public void DeleteResourceAllowance()
        {
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = batchServiceClient.DeleteResourceAllowance(name);
            ...
            Operation<Empty, OperationMetadata> retrievedResponse = batchServiceClient.PollOnceDeleteResourceAllowance(operationName);
