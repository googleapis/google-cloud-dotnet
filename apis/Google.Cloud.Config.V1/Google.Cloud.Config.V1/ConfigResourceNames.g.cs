...
namespace Google.Cloud.Config.V1
{
    ...
    /// <summary>Resource name for the <c>ResourceChange</c> resource.</summary>
    public sealed partial class ResourceChangeName : gax::IResourceName, sys::IEquatable<ResourceChangeName>
    {
        /// <summary>The possible contents of <see cref="ResourceChangeName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}</c>.
            /// </summary>
            ProjectLocationPreviewResourceChange = 1,
        }

        private static gax::PathTemplate s_projectLocationPreviewResourceChange = new gax::PathTemplate("projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}");

        /// <summary>Creates a <see cref="ResourceChangeName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ResourceChangeName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static ResourceChangeName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new ResourceChangeName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="ResourceChangeName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="previewId">The <c>Preview</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="resourceChangeId">The <c>ResourceChange</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="ResourceChangeName"/> constructed from the provided ids.</returns>
        public static ResourceChangeName FromProjectLocationPreviewResourceChange(string projectId, string locationId, string previewId, string resourceChangeId) =>
            new ResourceChangeName(ResourceNameType.ProjectLocationPreviewResourceChange, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), previewId: gax::GaxPreconditions.CheckNotNullOrEmpty(previewId, nameof(previewId)), resourceChangeId: gax::GaxPreconditions.CheckNotNullOrEmpty(resourceChangeId, nameof(resourceChangeId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ResourceChangeName"/> with pattern
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <param name="resourceChangeId">The <c>ResourceChange</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="ResourceChangeName"/> with pattern
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string previewId, string resourceChangeId) =>
            FormatProjectLocationPreviewResourceChange(projectId, locationId, previewId, resourceChangeId);
        ...
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}</c>.
        /// </returns>
        public static string FormatProjectLocationPreviewResourceChange(string projectId, string locationId, string previewId, string resourceChangeId) =>
            s_projectLocationPreviewResourceChange.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(previewId, nameof(previewId)), gax::GaxPreconditions.CheckNotNullOrEmpty(resourceChangeId, nameof(resourceChangeId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ResourceChangeName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="resourceChangeName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="ResourceChangeName"/> if successful.</returns>
        public static ResourceChangeName Parse(string resourceChangeName) => Parse(resourceChangeName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ResourceChangeName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="ResourceChangeName"/> if successful.</returns>
        public static ResourceChangeName Parse(string resourceChangeName, bool allowUnparsed) =>
            TryParse(resourceChangeName, allowUnparsed, out ResourceChangeName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ResourceChangeName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="resourceChangeName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ResourceChangeName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string resourceChangeName, out ResourceChangeName result) =>
            TryParse(resourceChangeName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string resourceChangeName, bool allowUnparsed, out ResourceChangeName result)
        {
            gax::GaxPreconditions.CheckNotNull(resourceChangeName, nameof(resourceChangeName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationPreviewResourceChange.TryParseName(resourceChangeName, out resourceName))
            {
                result = FromProjectLocationPreviewResourceChange(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(resourceChangeName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private ResourceChangeName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string previewId = null, string projectId = null, string resourceChangeId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
            PreviewId = previewId;
            ProjectId = projectId;
            ResourceChangeId = resourceChangeId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="ResourceChangeName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="previewId">The <c>Preview</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="resourceChangeId">The <c>ResourceChange</c> ID. Must not be <c>null</c> or empty.</param>
        public ResourceChangeName(string projectId, string locationId, string previewId, string resourceChangeId) : this(ResourceNameType.ProjectLocationPreviewResourceChange, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), previewId: gax::GaxPreconditions.CheckNotNullOrEmpty(previewId, nameof(previewId)), resourceChangeId: gax::GaxPreconditions.CheckNotNullOrEmpty(resourceChangeId, nameof(resourceChangeId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ResourceChange</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        public string ResourceChangeId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationPreviewResourceChange: return s_projectLocationPreviewResourceChange.Expand(ProjectId, LocationId, PreviewId, ResourceChangeId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as ResourceChangeName);

        /// <inheritdoc/>
        public bool Equals(ResourceChangeName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(ResourceChangeName a, ResourceChangeName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(ResourceChangeName a, ResourceChangeName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>ResourceDrift</c> resource.</summary>
    public sealed partial class ResourceDriftName : gax::IResourceName, sys::IEquatable<ResourceDriftName>
    {
        /// <summary>The possible contents of <see cref="ResourceDriftName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}</c>.
            /// </summary>
            ProjectLocationPreviewResourceDrift = 1,
        }

        private static gax::PathTemplate s_projectLocationPreviewResourceDrift = new gax::PathTemplate("projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}");

        /// <summary>Creates a <see cref="ResourceDriftName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ResourceDriftName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static ResourceDriftName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new ResourceDriftName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="ResourceDriftName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="previewId">The <c>Preview</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="resourceDriftId">The <c>ResourceDrift</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="ResourceDriftName"/> constructed from the provided ids.</returns>
        public static ResourceDriftName FromProjectLocationPreviewResourceDrift(string projectId, string locationId, string previewId, string resourceDriftId) =>
            new ResourceDriftName(ResourceNameType.ProjectLocationPreviewResourceDrift, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), previewId: gax::GaxPreconditions.CheckNotNullOrEmpty(previewId, nameof(previewId)), resourceDriftId: gax::GaxPreconditions.CheckNotNullOrEmpty(resourceDriftId, nameof(resourceDriftId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ResourceDriftName"/> with pattern
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <param name="resourceDriftId">The <c>ResourceDrift</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="ResourceDriftName"/> with pattern
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string previewId, string resourceDriftId) =>
            FormatProjectLocationPreviewResourceDrift(projectId, locationId, previewId, resourceDriftId);
        ...
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}</c>.
        /// </returns>
        public static string FormatProjectLocationPreviewResourceDrift(string projectId, string locationId, string previewId, string resourceDriftId) =>
            s_projectLocationPreviewResourceDrift.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(previewId, nameof(previewId)), gax::GaxPreconditions.CheckNotNullOrEmpty(resourceDriftId, nameof(resourceDriftId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ResourceDriftName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="resourceDriftName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="ResourceDriftName"/> if successful.</returns>
        public static ResourceDriftName Parse(string resourceDriftName) => Parse(resourceDriftName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ResourceDriftName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="ResourceDriftName"/> if successful.</returns>
        public static ResourceDriftName Parse(string resourceDriftName, bool allowUnparsed) =>
            TryParse(resourceDriftName, allowUnparsed, out ResourceDriftName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ResourceDriftName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="resourceDriftName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ResourceDriftName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string resourceDriftName, out ResourceDriftName result) =>
            TryParse(resourceDriftName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string resourceDriftName, bool allowUnparsed, out ResourceDriftName result)
        {
            gax::GaxPreconditions.CheckNotNull(resourceDriftName, nameof(resourceDriftName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationPreviewResourceDrift.TryParseName(resourceDriftName, out resourceName))
            {
                result = FromProjectLocationPreviewResourceDrift(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(resourceDriftName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private ResourceDriftName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string previewId = null, string projectId = null, string resourceDriftId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
            PreviewId = previewId;
            ProjectId = projectId;
            ResourceDriftId = resourceDriftId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="ResourceDriftName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="previewId">The <c>Preview</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="resourceDriftId">The <c>ResourceDrift</c> ID. Must not be <c>null</c> or empty.</param>
        public ResourceDriftName(string projectId, string locationId, string previewId, string resourceDriftId) : this(ResourceNameType.ProjectLocationPreviewResourceDrift, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), previewId: gax::GaxPreconditions.CheckNotNullOrEmpty(previewId, nameof(previewId)), resourceDriftId: gax::GaxPreconditions.CheckNotNullOrEmpty(resourceDriftId, nameof(resourceDriftId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ResourceDrift</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        public string ResourceDriftId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationPreviewResourceDrift: return s_projectLocationPreviewResourceDrift.Expand(ProjectId, LocationId, PreviewId, ResourceDriftId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as ResourceDriftName);

        /// <inheritdoc/>
        public bool Equals(ResourceDriftName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(ResourceDriftName a, ResourceDriftName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(ResourceDriftName a, ResourceDriftName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>AutoMigrationConfig</c> resource.</summary>
    public sealed partial class AutoMigrationConfigName : gax::IResourceName, sys::IEquatable<AutoMigrationConfigName>
    {
        /// <summary>The possible contents of <see cref="AutoMigrationConfigName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/autoMigrationConfig</c>.
            /// </summary>
            ProjectLocation = 1,
        }

        private static gax::PathTemplate s_projectLocation = new gax::PathTemplate("projects/{project}/locations/{location}/autoMigrationConfig");

        /// <summary>Creates a <see cref="AutoMigrationConfigName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="AutoMigrationConfigName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static AutoMigrationConfigName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new AutoMigrationConfigName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="AutoMigrationConfigName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/autoMigrationConfig</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// A new instance of <see cref="AutoMigrationConfigName"/> constructed from the provided ids.
        /// </returns>
        public static AutoMigrationConfigName FromProjectLocation(string projectId, string locationId) =>
            new AutoMigrationConfigName(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="AutoMigrationConfigName"/> with pattern
        /// <c>projects/{project}/locations/{location}/autoMigrationConfig</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="AutoMigrationConfigName"/> with pattern
        /// <c>projects/{project}/locations/{location}/autoMigrationConfig</c>.
        /// </returns>
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="AutoMigrationConfigName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>projects/{project}/locations/{location}/autoMigrationConfig</c></description></item>
        /// </list>
        /// </remarks>
        /// <param name="autoMigrationConfigName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="AutoMigrationConfigName"/> if successful.</returns>
        public static AutoMigrationConfigName Parse(string autoMigrationConfigName) => Parse(autoMigrationConfigName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="AutoMigrationConfigName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="AutoMigrationConfigName"/> if successful.</returns>
        public static AutoMigrationConfigName Parse(string autoMigrationConfigName, bool allowUnparsed) =>
            TryParse(autoMigrationConfigName, allowUnparsed, out AutoMigrationConfigName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="AutoMigrationConfigName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="autoMigrationConfigName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="AutoMigrationConfigName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string autoMigrationConfigName, out AutoMigrationConfigName result) =>
            TryParse(autoMigrationConfigName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string autoMigrationConfigName, bool allowUnparsed, out AutoMigrationConfigName result)
        {
            gax::GaxPreconditions.CheckNotNull(autoMigrationConfigName, nameof(autoMigrationConfigName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocation.TryParseName(autoMigrationConfigName, out resourceName))
            {
            ...
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(autoMigrationConfigName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private AutoMigrationConfigName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="AutoMigrationConfigName"/> class from the component parts of
        /// pattern <c>projects/{project}/locations/{location}/autoMigrationConfig</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        public AutoMigrationConfigName(string projectId, string locationId) : this(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as AutoMigrationConfigName);

        /// <inheritdoc/>
        public bool Equals(AutoMigrationConfigName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(AutoMigrationConfigName a, AutoMigrationConfigName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(AutoMigrationConfigName a, AutoMigrationConfigName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>DeploymentGroup</c> resource.</summary>
    public sealed partial class DeploymentGroupName : gax::IResourceName, sys::IEquatable<DeploymentGroupName>
    {
        /// <summary>The possible contents of <see cref="DeploymentGroupName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}</c>.
            /// </summary>
            ProjectLocationDeploymentGroup = 1,
        }

        private static gax::PathTemplate s_projectLocationDeploymentGroup = new gax::PathTemplate("projects/{project}/locations/{location}/deploymentGroups/{deployment_group}");

        /// <summary>Creates a <see cref="DeploymentGroupName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="DeploymentGroupName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static DeploymentGroupName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new DeploymentGroupName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="DeploymentGroupName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="deploymentGroupId">The <c>DeploymentGroup</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="DeploymentGroupName"/> constructed from the provided ids.</returns>
        public static DeploymentGroupName FromProjectLocationDeploymentGroup(string projectId, string locationId, string deploymentGroupId) =>
            new DeploymentGroupName(ResourceNameType.ProjectLocationDeploymentGroup, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), deploymentGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentGroupId, nameof(deploymentGroupId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="DeploymentGroupName"/> with pattern
        /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="deploymentGroupId">The <c>DeploymentGroup</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="DeploymentGroupName"/> with pattern
        /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string deploymentGroupId) =>
            FormatProjectLocationDeploymentGroup(projectId, locationId, deploymentGroupId);
        ...
        /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}</c>.
        /// </returns>
        public static string FormatProjectLocationDeploymentGroup(string projectId, string locationId, string deploymentGroupId) =>
            s_projectLocationDeploymentGroup.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentGroupId, nameof(deploymentGroupId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="DeploymentGroupName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="deploymentGroupName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="DeploymentGroupName"/> if successful.</returns>
        public static DeploymentGroupName Parse(string deploymentGroupName) => Parse(deploymentGroupName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="DeploymentGroupName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="DeploymentGroupName"/> if successful.</returns>
        public static DeploymentGroupName Parse(string deploymentGroupName, bool allowUnparsed) =>
            TryParse(deploymentGroupName, allowUnparsed, out DeploymentGroupName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="DeploymentGroupName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="deploymentGroupName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="DeploymentGroupName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string deploymentGroupName, out DeploymentGroupName result) =>
            TryParse(deploymentGroupName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string deploymentGroupName, bool allowUnparsed, out DeploymentGroupName result)
        {
            gax::GaxPreconditions.CheckNotNull(deploymentGroupName, nameof(deploymentGroupName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationDeploymentGroup.TryParseName(deploymentGroupName, out resourceName))
            {
                result = FromProjectLocationDeploymentGroup(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(deploymentGroupName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private DeploymentGroupName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string deploymentGroupId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="DeploymentGroupName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="deploymentGroupId">The <c>DeploymentGroup</c> ID. Must not be <c>null</c> or empty.</param>
        public DeploymentGroupName(string projectId, string locationId, string deploymentGroupId) : this(ResourceNameType.ProjectLocationDeploymentGroup, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), deploymentGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentGroupId, nameof(deploymentGroupId)))
        {
        }
        ...
        /// <summary>
        /// The <c>DeploymentGroup</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationDeploymentGroup: return s_projectLocationDeploymentGroup.Expand(ProjectId, LocationId, DeploymentGroupId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as DeploymentGroupName);

        /// <inheritdoc/>
        public bool Equals(DeploymentGroupName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(DeploymentGroupName a, DeploymentGroupName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(DeploymentGroupName a, DeploymentGroupName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>DeploymentGroupRevision</c> resource.</summary>
    public sealed partial class DeploymentGroupRevisionName : gax::IResourceName, sys::IEquatable<DeploymentGroupRevisionName>
    {
        /// <summary>The possible contents of <see cref="DeploymentGroupRevisionName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}/revisions/{revision}</c>.
            /// </summary>
            ProjectLocationDeploymentGroupRevision = 1,
        }

        private static gax::PathTemplate s_projectLocationDeploymentGroupRevision = new gax::PathTemplate("projects/{project}/locations/{location}/deploymentGroups/{deployment_group}/revisions/{revision}");

        /// <summary>Creates a <see cref="DeploymentGroupRevisionName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="DeploymentGroupRevisionName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static DeploymentGroupRevisionName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new DeploymentGroupRevisionName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="DeploymentGroupRevisionName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}/revisions/{revision}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <param name="revisionId">The <c>Revision</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// A new instance of <see cref="DeploymentGroupRevisionName"/> constructed from the provided ids.
        /// </returns>
        public static DeploymentGroupRevisionName FromProjectLocationDeploymentGroupRevision(string projectId, string locationId, string deploymentGroupId, string revisionId) =>
            new DeploymentGroupRevisionName(ResourceNameType.ProjectLocationDeploymentGroupRevision, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), deploymentGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentGroupId, nameof(deploymentGroupId)), revisionId: gax::GaxPreconditions.CheckNotNullOrEmpty(revisionId, nameof(revisionId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="DeploymentGroupRevisionName"/> with
        /// pattern <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}/revisions/{revision}</c>
        /// .
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <param name="revisionId">The <c>Revision</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="DeploymentGroupRevisionName"/> with pattern
        /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}/revisions/{revision}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string deploymentGroupId, string revisionId) =>
            FormatProjectLocationDeploymentGroupRevision(projectId, locationId, deploymentGroupId, revisionId);
        ...
        /// <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}/revisions/{revision}</c>.
        /// </returns>
        public static string FormatProjectLocationDeploymentGroupRevision(string projectId, string locationId, string deploymentGroupId, string revisionId) =>
            s_projectLocationDeploymentGroupRevision.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentGroupId, nameof(deploymentGroupId)), gax::GaxPreconditions.CheckNotNullOrEmpty(revisionId, nameof(revisionId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="DeploymentGroupRevisionName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="deploymentGroupRevisionName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="DeploymentGroupRevisionName"/> if successful.</returns>
        public static DeploymentGroupRevisionName Parse(string deploymentGroupRevisionName) =>
            Parse(deploymentGroupRevisionName, false);
        ...
        /// </param>
        /// <returns>The parsed <see cref="DeploymentGroupRevisionName"/> if successful.</returns>
        public static DeploymentGroupRevisionName Parse(string deploymentGroupRevisionName, bool allowUnparsed) =>
            TryParse(deploymentGroupRevisionName, allowUnparsed, out DeploymentGroupRevisionName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="DeploymentGroupRevisionName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="deploymentGroupRevisionName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="DeploymentGroupRevisionName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string deploymentGroupRevisionName, out DeploymentGroupRevisionName result) =>
            TryParse(deploymentGroupRevisionName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string deploymentGroupRevisionName, bool allowUnparsed, out DeploymentGroupRevisionName result)
        {
            gax::GaxPreconditions.CheckNotNull(deploymentGroupRevisionName, nameof(deploymentGroupRevisionName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationDeploymentGroupRevision.TryParseName(deploymentGroupRevisionName, out resourceName))
            {
                result = FromProjectLocationDeploymentGroupRevision(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(deploymentGroupRevisionName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private DeploymentGroupRevisionName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string deploymentGroupId = null, string locationId = null, string projectId = null, string revisionId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            DeploymentGroupId = deploymentGroupId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="DeploymentGroupRevisionName"/> class from the component parts of
        /// pattern <c>projects/{project}/locations/{location}/deploymentGroups/{deployment_group}/revisions/{revision}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="deploymentGroupId">The <c>DeploymentGroup</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="revisionId">The <c>Revision</c> ID. Must not be <c>null</c> or empty.</param>
        public DeploymentGroupRevisionName(string projectId, string locationId, string deploymentGroupId, string revisionId) : this(ResourceNameType.ProjectLocationDeploymentGroupRevision, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), deploymentGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentGroupId, nameof(deploymentGroupId)), revisionId: gax::GaxPreconditions.CheckNotNullOrEmpty(revisionId, nameof(revisionId)))
        {
        }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationDeploymentGroupRevision: return s_projectLocationDeploymentGroupRevision.Expand(ProjectId, LocationId, DeploymentGroupId, RevisionId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as DeploymentGroupRevisionName);

        /// <inheritdoc/>
        public bool Equals(DeploymentGroupRevisionName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(DeploymentGroupRevisionName a, DeploymentGroupRevisionName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(DeploymentGroupRevisionName a, DeploymentGroupRevisionName b) => !(a == b);
    }
    ...
    /// <summary>Resource name for the <c>WarmPool</c> resource.</summary>
    public sealed partial class WarmPoolName : gax::IResourceName, sys::IEquatable<WarmPoolName>
    {
        /// <summary>The possible contents of <see cref="WarmPoolName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/warmPools/{warm_pool}</c>.
            /// </summary>
            ProjectLocationWarmPool = 1,
        }

        private static gax::PathTemplate s_projectLocationWarmPool = new gax::PathTemplate("projects/{project}/locations/{location}/warmPools/{warm_pool}");

        /// <summary>Creates a <see cref="WarmPoolName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="WarmPoolName"/> containing the provided <paramref name="unparsedResourceName"/>
        /// .
        /// </returns>
        public static WarmPoolName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new WarmPoolName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="WarmPoolName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/warmPools/{warm_pool}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="warmPoolId">The <c>WarmPool</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="WarmPoolName"/> constructed from the provided ids.</returns>
        public static WarmPoolName FromProjectLocationWarmPool(string projectId, string locationId, string warmPoolId) =>
            new WarmPoolName(ResourceNameType.ProjectLocationWarmPool, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), warmPoolId: gax::GaxPreconditions.CheckNotNullOrEmpty(warmPoolId, nameof(warmPoolId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="WarmPoolName"/> with pattern
        /// <c>projects/{project}/locations/{location}/warmPools/{warm_pool}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="warmPoolId">The <c>WarmPool</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="WarmPoolName"/> with pattern
        /// <c>projects/{project}/locations/{location}/warmPools/{warm_pool}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string warmPoolId) =>
            FormatProjectLocationWarmPool(projectId, locationId, warmPoolId);
        ...
        /// <c>projects/{project}/locations/{location}/warmPools/{warm_pool}</c>.
        /// </returns>
        public static string FormatProjectLocationWarmPool(string projectId, string locationId, string warmPoolId) =>
            s_projectLocationWarmPool.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(warmPoolId, nameof(warmPoolId)));

        /// <summary>Parses the given resource name string into a new <see cref="WarmPoolName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/warmPools/{warm_pool}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        /// <param name="warmPoolName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="WarmPoolName"/> if successful.</returns>
        public static WarmPoolName Parse(string warmPoolName) => Parse(warmPoolName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="WarmPoolName"/> instance; optionally allowing an
        /// unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="WarmPoolName"/> if successful.</returns>
        public static WarmPoolName Parse(string warmPoolName, bool allowUnparsed) =>
            TryParse(warmPoolName, allowUnparsed, out WarmPoolName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="WarmPoolName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="warmPoolName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="WarmPoolName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string warmPoolName, out WarmPoolName result) => TryParse(warmPoolName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="WarmPoolName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string warmPoolName, bool allowUnparsed, out WarmPoolName result)
        {
            gax::GaxPreconditions.CheckNotNull(warmPoolName, nameof(warmPoolName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationWarmPool.TryParseName(warmPoolName, out resourceName))
            {
                result = FromProjectLocationWarmPool(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(warmPoolName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private WarmPoolName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string warmPoolId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="WarmPoolName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/warmPools/{warm_pool}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="warmPoolId">The <c>WarmPool</c> ID. Must not be <c>null</c> or empty.</param>
        public WarmPoolName(string projectId, string locationId, string warmPoolId) : this(ResourceNameType.ProjectLocationWarmPool, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), warmPoolId: gax::GaxPreconditions.CheckNotNullOrEmpty(warmPoolId, nameof(warmPoolId)))
        {
        }
        ...
        /// <summary>
        /// The <c>WarmPool</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource name.
        /// </summary>
        public string WarmPoolId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationWarmPool: return s_projectLocationWarmPool.Expand(ProjectId, LocationId, WarmPoolId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as WarmPoolName);

        /// <inheritdoc/>
        public bool Equals(WarmPoolName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(WarmPoolName a, WarmPoolName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(WarmPoolName a, WarmPoolName b) => !(a == b);
    }
    ...
    public partial class DeploymentSource
    {
        /// <summary>
    ...
    public partial class CreateDeploymentGroupRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class DeleteDeploymentGroupRequest
    {
        /// <summary>
        /// <see cref="gccv::DeploymentGroupName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::DeploymentGroupName DeploymentGroupName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::DeploymentGroupName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }
    ...
    {
        /// <summary>
        /// <see cref="gccv::ResourceChangeName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::ResourceChangeName ResourceChangeName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::ResourceChangeName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class ListResourceChangesRequest
    {
        /// <summary>
        /// <see cref="PreviewName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class GetResourceChangeRequest
    {
        /// <summary>
        /// <see cref="gccv::ResourceChangeName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    {
        /// <summary>
        /// <see cref="gccv::ResourceDriftName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::ResourceDriftName ResourceDriftName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::ResourceDriftName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class ListResourceDriftsRequest
    {
        /// <summary>
        /// <see cref="PreviewName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class GetResourceDriftRequest
    {
        /// <summary>
        /// <see cref="gccv::ResourceDriftName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class GetAutoMigrationConfigRequest
    {
        /// <summary>
        /// <see cref="gccv::AutoMigrationConfigName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::AutoMigrationConfigName AutoMigrationConfigName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::AutoMigrationConfigName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class AutoMigrationConfig
    {
        /// <summary>
        /// <see cref="gccv::AutoMigrationConfigName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class DeploymentUnit
    {
        /// <summary>
        /// <see cref="DeploymentName"/>-typed view over the <see cref="Deployment"/> resource name property.
        /// </summary>
    ...
    public partial class GetDeploymentGroupRequest
    {
        /// <summary>
        /// <see cref="gccv::DeploymentGroupName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class ListDeploymentGroupsRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class ProvisionDeploymentGroupRequest
    {
        /// <summary>
        /// <see cref="gccv::DeploymentGroupName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class DeprovisionDeploymentGroupRequest
    {
        /// <summary>
        /// <see cref="gccv::DeploymentGroupName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class DeploymentUnitProgress
    {
        /// <summary>
        /// <see cref="DeploymentName"/>-typed view over the <see cref="Deployment"/> resource name property.
        /// </summary>
    ...
    public partial class DeploymentGroupRevision
    {
        /// <summary>
        /// <see cref="gccv::DeploymentGroupRevisionName"/>-typed view over the <see cref="Name"/> resource name
        /// property.
        /// </summary>
        public gccv::DeploymentGroupRevisionName DeploymentGroupRevisionName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::DeploymentGroupRevisionName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class GetDeploymentGroupRevisionRequest
    {
        /// <summary>
        /// <see cref="gccv::DeploymentGroupRevisionName"/>-typed view over the <see cref="Name"/> resource name
        /// property.
    ...
    public partial class ListDeploymentGroupRevisionsRequest
    {
        /// <summary>
        /// <see cref="DeploymentGroupName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
        public DeploymentGroupName ParentAsDeploymentGroupName
        {
            get => string.IsNullOrEmpty(Parent) ? null : DeploymentGroupName.Parse(Parent, allowUnparsed: true);
            set => Parent = value?.ToString() ?? "";
        }
    }
}
