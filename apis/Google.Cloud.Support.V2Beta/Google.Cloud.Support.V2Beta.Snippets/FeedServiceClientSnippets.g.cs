...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedFeedServiceClientSnippets
    {
        /// <summary>Snippet for ShowFeed</summary>
        public void ShowFeedRequestObject()
        {
            // Snippet: ShowFeed(ShowFeedRequest, CallSettings)
            // Create client
        ...
        {
            // Snippet: ShowFeedAsync(ShowFeedRequest, CallSettings)
            // Create client
        ...
        {
            // Snippet: ShowFeed(string, string, int?, CallSettings)
            // Create client
            FeedServiceClient feedServiceClient = FeedServiceClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for ShowFeedAsync</summary>
        public async Task ShowFeedAsync()
        {
            // Snippet: ShowFeedAsync(string, string, int?, CallSettings)
            // Create client
            FeedServiceClient feedServiceClient = await FeedServiceClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "organizations/[ORGANIZATION]/cases/[CASE]";
        ...
        /// <summary>Snippet for ShowFeed</summary>
        public void ShowFeedResourceNames()
        {
            // Snippet: ShowFeed(CaseName, string, int?, CallSettings)
            // Create client
            FeedServiceClient feedServiceClient = FeedServiceClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: ShowFeedAsync(CaseName, string, int?, CallSettings)
            // Create client
            FeedServiceClient feedServiceClient = await FeedServiceClient.CreateAsync();
            // Initialize request argument(s)
            CaseName parent = CaseName.FromOrganizationCase("[ORGANIZATION]", "[CASE]");
