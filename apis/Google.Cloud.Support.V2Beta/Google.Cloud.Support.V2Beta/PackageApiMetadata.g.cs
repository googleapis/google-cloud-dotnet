...
namespace Google.Cloud.Support.V2Beta
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.Support.V2Beta", GetFileDescriptors)
            .WithRequestNumericEnumJsonEncoding(true);

        private static scg::IEnumerable<gpr::FileDescriptor> GetFileDescriptors()
        {
            yield return ActorReflection.Descriptor;
            yield return AttachmentReflection.Descriptor;
            yield return AttachmentServiceReflection.Descriptor;
            yield return CaseReflection.Descriptor;
            yield return CaseServiceReflection.Descriptor;
            ...
            yield return EmailMessageReflection.Descriptor;
