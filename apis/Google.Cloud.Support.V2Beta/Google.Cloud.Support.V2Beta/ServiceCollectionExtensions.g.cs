...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>Adds a singleton <see cref="gcsv::FeedServiceClient"/> to <paramref name="services"/>.</summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        /// <param name="action">
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddFeedServiceClient(this IServiceCollection services, sys::Action<gcsv::FeedServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcsv::FeedServiceClientBuilder builder = new gcsv::FeedServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddFeedServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcsv::FeedServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcsv::FeedServiceClientBuilder builder = new gcsv::FeedServiceClientBuilder();
                action?.Invoke(provider, builder);
