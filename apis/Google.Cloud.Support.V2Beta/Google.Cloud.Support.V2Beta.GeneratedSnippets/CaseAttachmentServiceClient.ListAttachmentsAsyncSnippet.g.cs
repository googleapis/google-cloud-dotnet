...
{
    // [START cloudsupport_v2beta_generated_CaseAttachmentService_ListAttachments_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.Support.V2Beta;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedCaseAttachmentServiceClientSnippets
    {
        ...
        public async Task ListAttachmentsAsync()
        {
            ...
            await foreach (Attachment item in response)
            {
            ...
            await foreach (ListAttachmentsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudsupport_v2beta_generated_CaseAttachmentService_ListAttachments_async_flattened]
}
