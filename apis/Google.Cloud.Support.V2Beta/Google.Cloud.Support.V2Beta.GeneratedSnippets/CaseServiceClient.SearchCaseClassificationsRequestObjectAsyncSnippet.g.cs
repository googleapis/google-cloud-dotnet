...
{
    // [START cloudsupport_v2beta_generated_CaseService_SearchCaseClassifications_async]
    using Google.Api.Gax;
    using Google.Cloud.Support.V2Beta;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedCaseServiceClientSnippets
    {
        ...
        public async Task SearchCaseClassificationsRequestObjectAsync()
        {
            ...
            SearchCaseClassificationsRequest request = new SearchCaseClassificationsRequest
            {
                Query = "",
                Product = new Product(),
            };
            ...
            await foreach (CaseClassification item in response)
            {
            ...
            await foreach (SearchCaseClassificationsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudsupport_v2beta_generated_CaseService_SearchCaseClassifications_async]
}
