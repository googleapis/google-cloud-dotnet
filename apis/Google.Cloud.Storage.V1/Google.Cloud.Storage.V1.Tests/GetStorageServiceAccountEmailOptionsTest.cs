...
{
    public class GetStorageServiceAccountEmailOptionsTest
    {
        [Fact]
        public void ModifyRequest_DefaultOptions()
        {
            var request = new GetRequest(null, "proj");
            var options = new GetStorageServiceAccountEmailOptions();
        ...
        {
            var request = new GetRequest(null, "proj");
            var options = new GetStorageServiceAccountEmailOptions { UserProject = "project" };
            options.ModifyRequest(request);
