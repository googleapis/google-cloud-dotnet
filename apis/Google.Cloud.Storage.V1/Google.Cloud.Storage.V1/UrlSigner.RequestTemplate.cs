...
namespace Google.Cloud.Storage.V1
{
    public sealed partial class UrlSigner
    {
        ...
        public sealed class RequestTemplate
        {
            ...
            /// This will never be null. If null is specified in <see cref="WithHttpMethod(HttpMethod)"/>
            ...
            /// <remarks>
            /// <para>
            /// When using <see cref="SigningVersion.V2"/>, from all the headers supplied in <see cref="ContentHeaders"/>,
            /// only the ones starting with "x-goog-", the Content-MD5 and the Content-Type headers
            /// will be included in the signed URL's signature and therefor must be included in requests made with the created URL.
            /// All other headers supplied in <see cref="ContentHeaders"/> will be ignored when creating the signed URL
            /// so they shouldn't be included in requests made with the created URL.
            /// </para>
            /// <para>
            /// When using <see cref="SigningVersion.V4"/> all headers supplied in <see cref="ContentHeaders"/>
            /// will be included in the signed URL's signature and therefor must be included in requests made with the created URL.
            /// </para>
            /// </remarks>
            ...
            /// </summary>
            /// <remarks>
            /// When using <see cref="SigningVersion.V2"/> custom query parameters are not supported by the signing process
            ...
            /// will throw <see cref="ArgumentException"/> if <see cref="RequestTemplate.QueryParameters"/> is not
