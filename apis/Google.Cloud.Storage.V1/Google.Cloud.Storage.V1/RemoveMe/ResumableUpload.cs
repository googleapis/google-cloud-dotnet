...
namespace Google.Apis.Upload
{
    ...
    public class TmpResumableUpload
    {
        ...
        /// </summary>
        protected byte[] LastMediaRequest { get; set; }
        ...
        protected long BytesServerReceived { get; set; }
        ...
        protected async Task<IUploadProgress> UploadCoreAsync(CancellationToken cancellationToken)
        {
            try
            {
        ...
        protected sealed class ServerErrorCallback : IHttpUnsuccessfulResponseHandler, IHttpExceptionHandler, IDisposable
        {
            ...
            /// </summary>
            public ServerErrorCallback(TmpResumableUpload resumable)
            {
                Owner = resumable;
        ...
        /// </summary>
        private sealed class ResumeableUploadSessionData : IUploadSessionData
        {
            /// <summary>
    ...
    /// </typeparam>
    public abstract class TmpResumableUpload<TRequest> : TmpResumableUpload
    {
        #region Constants
    ...
    /// </typeparam>
    public abstract class TmpResumableUpload<TRequest, TResponse> : TmpResumableUpload<TRequest>
    {
        #region Construction
