...
{
    // [START enterpriseknowledgegraph_v1_generated_EnterpriseKnowledgeGraphService_ListEntityReconciliationJobs_async_flattened]
    ...
    public sealed partial class GeneratedEnterpriseKnowledgeGraphServiceClientSnippets
    {
        ...
        public async Task ListEntityReconciliationJobsAsync()
        {
            ...
            await foreach (EntityReconciliationJob item in response)
            {
            ...
            await foreach (ListEntityReconciliationJobsResponse page in response.AsRawResponses())
            {
    ...
    // [END enterpriseknowledgegraph_v1_generated_EnterpriseKnowledgeGraphService_ListEntityReconciliationJobs_async_flattened]
}
