...
{
    // [START rapidmigrationassessment_v1_generated_RapidMigrationAssessment_ListCollectors_async_flattened]
    ...
    public sealed partial class GeneratedRapidMigrationAssessmentClientSnippets
    {
        ...
        public async Task ListCollectorsAsync()
        {
            ...
            await foreach (Collector item in response)
            {
            ...
            await foreach (ListCollectorsResponse page in response.AsRawResponses())
            {
    ...
    // [END rapidmigrationassessment_v1_generated_RapidMigrationAssessment_ListCollectors_async_flattened]
}
