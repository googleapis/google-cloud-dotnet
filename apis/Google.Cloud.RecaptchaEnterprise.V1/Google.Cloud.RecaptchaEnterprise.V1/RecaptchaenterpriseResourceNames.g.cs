...
namespace Google.Cloud.RecaptchaEnterprise.V1
{
    ...
    public sealed partial class PolicyName : gax::IResourceName, sys::IEquatable<PolicyName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>projects/{project}/keys/{key}/policy</c>.</summary>
            ProjectKey = 1,
        }

        private static gax::PathTemplate s_projectKey = new gax::PathTemplate("projects/{project}/keys/{key}/policy");
        ...
        /// <summary>
        /// Creates a <see cref="PolicyName"/> with the pattern <c>projects/{project}/keys/{key}/policy</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keyId">The <c>Key</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="PolicyName"/> constructed from the provided ids.</returns>
        public static PolicyName FromProjectKey(string projectId, string keyId) =>
            new PolicyName(ResourceNameType.ProjectKey, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), keyId: gax::GaxPreconditions.CheckNotNullOrEmpty(keyId, nameof(keyId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="PolicyName"/> with pattern
        /// <c>projects/{project}/keys/{key}/policy</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keyId">The <c>Key</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>projects/{project}/keys/{key}/policy</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string policyName, bool allowUnparsed, out PolicyName result)
        {
            ...
            gax::TemplatedResourceName resourceName;
            if (s_projectKey.TryParseName(policyName, out resourceName))
            {
                result = FromProjectKey(resourceName[0], resourceName[1]);
                return true;
            }
        ...
        private PolicyName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string keyId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            KeyId = keyId;
        ...
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keyId">The <c>Key</c> ID. Must not be <c>null</c> or empty.</param>
        public PolicyName(string projectId, string keyId) : this(ResourceNameType.ProjectKey, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), keyId: gax::GaxPreconditions.CheckNotNullOrEmpty(keyId, nameof(keyId)))
        {
        }
    ...
    {
        /// <summary>
        /// <see cref="gcrv::PolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcrv::PolicyName PolicyName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcrv::PolicyName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }
