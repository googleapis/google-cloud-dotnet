...
{
    // [START recaptchaenterprise_v1_generated_RecaptchaEnterpriseService_ListIpOverrides_async_flattened]
    ...
    public sealed partial class GeneratedRecaptchaEnterpriseServiceClientSnippets
    {
        ...
        public async Task ListIpOverridesAsync()
        {
            ...
            await foreach (IpOverrideData item in response)
            {
            ...
            await foreach (ListIpOverridesResponse page in response.AsRawResponses())
            {
    ...
    // [END recaptchaenterprise_v1_generated_RecaptchaEnterpriseService_ListIpOverrides_async_flattened]
}
