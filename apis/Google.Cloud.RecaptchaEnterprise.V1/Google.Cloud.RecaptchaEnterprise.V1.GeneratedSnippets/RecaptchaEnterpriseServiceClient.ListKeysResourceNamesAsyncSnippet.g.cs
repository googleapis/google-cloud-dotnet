...
{
    // [START recaptchaenterprise_v1_generated_RecaptchaEnterpriseService_ListKeys_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedRecaptchaEnterpriseServiceClientSnippets
    {
        ...
        public async Task ListKeysResourceNamesAsync()
        {
            ...
            await foreach (Key item in response)
            {
            ...
            await foreach (ListKeysResponse page in response.AsRawResponses())
            {
    ...
    // [END recaptchaenterprise_v1_generated_RecaptchaEnterpriseService_ListKeys_async_flattened_resourceNames]
}
