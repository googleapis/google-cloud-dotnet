...
{
    // [START recaptchaenterprise_v1_generated_RecaptchaEnterpriseService_ListRelatedAccountGroupMemberships_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedRecaptchaEnterpriseServiceClientSnippets
    {
        ...
        public async Task ListRelatedAccountGroupMembershipsResourceNamesAsync()
        {
            ...
            await foreach (RelatedAccountGroupMembership item in response)
            {
            ...
            await foreach (ListRelatedAccountGroupMembershipsResponse page in response.AsRawResponses())
            {
    ...
    // [END recaptchaenterprise_v1_generated_RecaptchaEnterpriseService_ListRelatedAccountGroupMemberships_async_flattened_resourceNames]
}
