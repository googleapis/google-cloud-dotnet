...
{
    // [START recaptchaenterprise_v1_generated_RecaptchaEnterpriseService_ListRelatedAccountGroups_async_flattened]
    ...
    public sealed partial class GeneratedRecaptchaEnterpriseServiceClientSnippets
    {
        ...
        public async Task ListRelatedAccountGroupsAsync()
        {
            ...
            await foreach (RelatedAccountGroup item in response)
            {
            ...
            await foreach (ListRelatedAccountGroupsResponse page in response.AsRawResponses())
            {
    ...
    // [END recaptchaenterprise_v1_generated_RecaptchaEnterpriseService_ListRelatedAccountGroups_async_flattened]
}
