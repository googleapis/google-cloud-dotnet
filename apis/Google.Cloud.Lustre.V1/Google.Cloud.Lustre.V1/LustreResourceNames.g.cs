...
namespace Google.Cloud.Lustre.V1
{
    ...
    /// <summary>Resource name for the <c>ResourcePolicy</c> resource.</summary>
    public sealed partial class ResourcePolicyName : gax::IResourceName, sys::IEquatable<ResourcePolicyName>
    {
        /// <summary>The possible contents of <see cref="ResourcePolicyName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/regions/{region}/resourcePolicies/{resource_policy}</c>
            /// .
            /// </summary>
            ProjectRegionResourcePolicy = 1,

            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/resourcePolicies/{resource_policy}</c>.
            /// </summary>
            ProjectLocationResourcePolicy = 2,
        }

        private static gax::PathTemplate s_projectRegionResourcePolicy = new gax::PathTemplate("projects/{project}/regions/{region}/resourcePolicies/{resource_policy}");

        private static gax::PathTemplate s_projectLocationResourcePolicy = new gax::PathTemplate("projects/{project}/locations/{location}/resourcePolicies/{resource_policy}");

        /// <summary>Creates a <see cref="ResourcePolicyName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ResourcePolicyName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static ResourcePolicyName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new ResourcePolicyName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="ResourcePolicyName"/> with the pattern
        /// <c>projects/{project}/regions/{region}/resourcePolicies/{resource_policy}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="regionId">The <c>Region</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="resourcePolicyId">The <c>ResourcePolicy</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="ResourcePolicyName"/> constructed from the provided ids.</returns>
        public static ResourcePolicyName FromProjectRegionResourcePolicy(string projectId, string regionId, string resourcePolicyId) =>
            new ResourcePolicyName(ResourceNameType.ProjectRegionResourcePolicy, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), regionId: gax::GaxPreconditions.CheckNotNullOrEmpty(regionId, nameof(regionId)), resourcePolicyId: gax::GaxPreconditions.CheckNotNullOrEmpty(resourcePolicyId, nameof(resourcePolicyId)));
        ...
        /// <param name="resourcePolicyId">The <c>ResourcePolicy</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="ResourcePolicyName"/> constructed from the provided ids.</returns>
        public static ResourcePolicyName FromProjectLocationResourcePolicy(string projectId, string locationId, string resourcePolicyId) =>
            new ResourcePolicyName(ResourceNameType.ProjectLocationResourcePolicy, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), resourcePolicyId: gax::GaxPreconditions.CheckNotNullOrEmpty(resourcePolicyId, nameof(resourcePolicyId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ResourcePolicyName"/> with pattern
        /// <c>projects/{project}/regions/{region}/resourcePolicies/{resource_policy}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="regionId">The <c>Region</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="resourcePolicyId">The <c>ResourcePolicy</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="ResourcePolicyName"/> with pattern
        /// <c>projects/{project}/regions/{region}/resourcePolicies/{resource_policy}</c>.
        /// </returns>
        public static string Format(string projectId, string regionId, string resourcePolicyId) =>
            FormatProjectRegionResourcePolicy(projectId, regionId, resourcePolicyId);
        ...
        /// <c>projects/{project}/regions/{region}/resourcePolicies/{resource_policy}</c>.
        /// </returns>
        public static string FormatProjectRegionResourcePolicy(string projectId, string regionId, string resourcePolicyId) =>
            s_projectRegionResourcePolicy.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(regionId, nameof(regionId)), gax::GaxPreconditions.CheckNotNullOrEmpty(resourcePolicyId, nameof(resourcePolicyId)));
        ...
        /// <c>projects/{project}/locations/{location}/resourcePolicies/{resource_policy}</c>.
        /// </returns>
        public static string FormatProjectLocationResourcePolicy(string projectId, string locationId, string resourcePolicyId) =>
            s_projectLocationResourcePolicy.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(resourcePolicyId, nameof(resourcePolicyId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ResourcePolicyName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/regions/{region}/resourcePolicies/{resource_policy}</c></description>
        /// </item>
        /// <item>
        /// <description>
        /// <c>projects/{project}/locations/{location}/resourcePolicies/{resource_policy}</c>
        ...
        /// </list>
        /// </remarks>
        /// <param name="resourcePolicyName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="ResourcePolicyName"/> if successful.</returns>
        public static ResourcePolicyName Parse(string resourcePolicyName) => Parse(resourcePolicyName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ResourcePolicyName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="ResourcePolicyName"/> if successful.</returns>
        public static ResourcePolicyName Parse(string resourcePolicyName, bool allowUnparsed) =>
            TryParse(resourcePolicyName, allowUnparsed, out ResourcePolicyName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ResourcePolicyName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="resourcePolicyName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ResourcePolicyName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string resourcePolicyName, out ResourcePolicyName result) =>
            TryParse(resourcePolicyName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string resourcePolicyName, bool allowUnparsed, out ResourcePolicyName result)
        {
            gax::GaxPreconditions.CheckNotNull(resourcePolicyName, nameof(resourcePolicyName));
            gax::TemplatedResourceName resourceName;
            if (s_projectRegionResourcePolicy.TryParseName(resourcePolicyName, out resourceName))
            {
                result = FromProjectRegionResourcePolicy(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (s_projectLocationResourcePolicy.TryParseName(resourcePolicyName, out resourceName))
            {
                result = FromProjectLocationResourcePolicy(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(resourcePolicyName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private ResourcePolicyName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string regionId = null, string resourcePolicyId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="ResourcePolicyName"/> class from the component parts of pattern
        /// <c>projects/{project}/regions/{region}/resourcePolicies/{resource_policy}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="regionId">The <c>Region</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="resourcePolicyId">The <c>ResourcePolicy</c> ID. Must not be <c>null</c> or empty.</param>
        public ResourcePolicyName(string projectId, string regionId, string resourcePolicyId) : this(ResourceNameType.ProjectRegionResourcePolicy, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), regionId: gax::GaxPreconditions.CheckNotNullOrEmpty(regionId, nameof(regionId)), resourcePolicyId: gax::GaxPreconditions.CheckNotNullOrEmpty(resourcePolicyId, nameof(resourcePolicyId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ResourcePolicy</c> ID. May be <c>null</c>, depending on which resource name is contained by this
        /// instance.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectRegionResourcePolicy: return s_projectRegionResourcePolicy.Expand(ProjectId, RegionId, ResourcePolicyId);
                case ResourceNameType.ProjectLocationResourcePolicy: return s_projectLocationResourcePolicy.Expand(ProjectId, LocationId, ResourcePolicyId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as ResourcePolicyName);

        /// <inheritdoc/>
        public bool Equals(ResourcePolicyName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(ResourcePolicyName a, ResourcePolicyName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(ResourcePolicyName a, ResourcePolicyName b) => !(a == b);
    }
}
