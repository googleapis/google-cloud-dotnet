...
namespace Google.Cloud.Retail.V2Beta
{
    ...
    public sealed partial class ProductServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private ProductServiceSettings(ProductServiceSettings existing) : base(existing)
        {
            ...
            ExportProductsSettings = existing.ExportProductsSettings;
            ExportProductsOperationsSettings = existing.ExportProductsOperationsSettings.Clone();
            OnCopy(existing);
        }
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>ProductServiceClient.ExportProducts</c> and <c>ProductServiceClient.ExportProductsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ExportProductsSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(100), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));

        /// <summary>
        /// Long Running Operation settings for calls to <c>ProductServiceClient.ExportProducts</c> and
        /// <c>ProductServiceClient.ExportProductsAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public lro::OperationsSettings ExportProductsOperationsSettings { get; set; } = new lro::OperationsSettings
        {
            DefaultPollSettings = new gax::PollSettings(gax::Expiration.FromTimeout(sys::TimeSpan.FromHours(24)), sys::TimeSpan.FromSeconds(20), 1.5, sys::TimeSpan.FromSeconds(45)),
        };
    ...
    public abstract partial class ProductServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<ExportProductsResponse, ExportMetadata> ExportProducts(ExportProductsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExportProductsResponse, ExportMetadata>> ExportProductsAsync(ExportProductsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExportProductsResponse, ExportMetadata>> ExportProductsAsync(ExportProductsRequest request, st::CancellationToken cancellationToken) =>
            ExportProductsAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));

        /// <summary>The long-running operations client for <c>ExportProducts</c>.</summary>
        public virtual lro::OperationsClient ExportProductsOperationsClient => throw new sys::NotImplementedException();

        /// <summary>
        /// Poll an operation once, using an <c>operationName</c> from a previous invocation of <c>ExportProducts</c>.
        /// </summary>
        /// <param name="operationName">
        /// The name of a previously invoked operation. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The result of polling the operation.</returns>
        public virtual lro::Operation<ExportProductsResponse, ExportMetadata> PollOnceExportProducts(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<ExportProductsResponse, ExportMetadata>.PollOnceFromName(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), ExportProductsOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A task representing the result of polling the operation.</returns>
        public virtual stt::Task<lro::Operation<ExportProductsResponse, ExportMetadata>> PollOnceExportProductsAsync(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<ExportProductsResponse, ExportMetadata>.PollOnceFromNameAsync(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), ExportProductsOperationsClient, callSettings);
    }
    ...
    public sealed partial class ProductServiceClientImpl : ProductServiceClient
    {
        ...
        private readonly gaxgrpc::ApiCall<ExportProductsRequest, lro::Operation> _callExportProducts;
        ...
        public ProductServiceClientImpl(ProductService.ProductServiceClient grpcClient, ProductServiceSettings settings)
        {
            ...
            ExportProductsOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.ExportProductsOperationsSettings);
            ...
            _callExportProducts = clientHelper.BuildApiCall<ExportProductsRequest, lro::Operation>(grpcClient.ExportProductsAsync, grpcClient.ExportProducts, effectiveSettings.ExportProductsSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callExportProducts);
            Modify_ExportProductsApiCall(ref _callExportProducts);
        ...
        partial void Modify_ExportProductsApiCall(ref gaxgrpc::ApiCall<ExportProductsRequest, lro::Operation> call);
        ...
        partial void Modify_ExportProductsRequest(ref ExportProductsRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <summary>The long-running operations client for <c>ExportProducts</c>.</summary>
        public override lro::OperationsClient ExportProductsOperationsClient { get; }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<ExportProductsResponse, ExportMetadata> ExportProducts(ExportProductsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ExportProductsRequest(ref request, ref callSettings);
            return new lro::Operation<ExportProductsResponse, ExportMetadata>(_callExportProducts.Sync(request, callSettings), ExportProductsOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<ExportProductsResponse, ExportMetadata>> ExportProductsAsync(ExportProductsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ExportProductsRequest(ref request, ref callSettings);
            return new lro::Operation<ExportProductsResponse, ExportMetadata>(await _callExportProducts.Async(request, callSettings).ConfigureAwait(false), ExportProductsOperationsClient);
        }
    }
