...
{
    // [START datalineage_v1_generated_Lineage_ListLineageEvents_async_flattened]
    ...
    public sealed partial class GeneratedLineageClientSnippets
    {
        ...
        public async Task ListLineageEventsAsync()
        {
            ...
            await foreach (LineageEvent item in response)
            {
            ...
            await foreach (ListLineageEventsResponse page in response.AsRawResponses())
            {
    ...
    // [END datalineage_v1_generated_Lineage_ListLineageEvents_async_flattened]
}
