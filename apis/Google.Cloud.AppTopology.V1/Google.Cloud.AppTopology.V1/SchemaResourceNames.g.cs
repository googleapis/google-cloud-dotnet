...
namespace Google.Cloud.AppTopology.V1
{
    ...
    public sealed partial class SchemaName : gax::IResourceName, sys::IEquatable<SchemaName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/domains/{domain}/schema</c>.
            /// </summary>
            ProjectLocationDomain = 1,
        }

        private static gax::PathTemplate s_projectLocationDomain = new gax::PathTemplate("projects/{project}/locations/{location}/domains/{domain}/schema");
        ...
        /// <c>projects/{project}/locations/{location}/domains/{domain}/schema</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="domainId">The <c>Domain</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="SchemaName"/> constructed from the provided ids.</returns>
        public static SchemaName FromProjectLocationDomain(string projectId, string locationId, string domainId) =>
            new SchemaName(ResourceNameType.ProjectLocationDomain, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), domainId: gax::GaxPreconditions.CheckNotNullOrEmpty(domainId, nameof(domainId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/domains/{domain}/schema</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string schemaName, bool allowUnparsed, out SchemaName result)
        {
            ...
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationDomain.TryParseName(schemaName, out resourceName))
            {
                result = FromProjectLocationDomain(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
        ...
        private SchemaName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string domainId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            DomainId = domainId;
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="domainId">The <c>Domain</c> ID. Must not be <c>null</c> or empty.</param>
        public SchemaName(string projectId, string locationId, string domainId) : this(ResourceNameType.ProjectLocationDomain, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), domainId: gax::GaxPreconditions.CheckNotNullOrEmpty(domainId, nameof(domainId)))
        {
        }
