...
namespace Google.Cloud.AppTopology.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.AppTopology.V1", GetFileDescriptors)
        ...
        {
            yield return GraphReflection.Descriptor;
