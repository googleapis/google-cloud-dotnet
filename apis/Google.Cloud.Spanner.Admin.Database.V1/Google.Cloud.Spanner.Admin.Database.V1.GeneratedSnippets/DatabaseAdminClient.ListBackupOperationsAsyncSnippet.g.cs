...
{
    // [START spanner_v1_generated_DatabaseAdmin_ListBackupOperations_async_flattened]
    ...
    public sealed partial class GeneratedDatabaseAdminClientSnippets
    {
        ...
        public async Task ListBackupOperationsAsync()
        {
            ...
            await foreach (ListBackupOperationsResponse page in response.AsRawResponses())
            {
    ...
    // [END spanner_v1_generated_DatabaseAdmin_ListBackupOperations_async_flattened]
}
