...
{
    // [START spanner_v1_generated_DatabaseAdmin_ListDatabaseRoles_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDatabaseAdminClientSnippets
    {
        ...
        public async Task ListDatabaseRolesResourceNamesAsync()
        {
            ...
            await foreach (DatabaseRole item in response)
            {
            ...
            await foreach (ListDatabaseRolesResponse page in response.AsRawResponses())
            {
    ...
    // [END spanner_v1_generated_DatabaseAdmin_ListDatabaseRoles_async_flattened_resourceNames]
}
