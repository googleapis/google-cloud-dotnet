...
{
    // [START spanner_v1_generated_DatabaseAdmin_ListBackupSchedules_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDatabaseAdminClientSnippets
    {
        ...
        public async Task ListBackupSchedulesResourceNamesAsync()
        {
            ...
            await foreach (BackupSchedule item in response)
            {
            ...
            await foreach (ListBackupSchedulesResponse page in response.AsRawResponses())
            {
    ...
    // [END spanner_v1_generated_DatabaseAdmin_ListBackupSchedules_async_flattened_resourceNames]
}
