...
namespace Google.Cloud.RecaptchaEnterprise.V1Beta1
{
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.RecaptchaEnterprise.V1Beta1.ProjectName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
        public Google.Cloud.RecaptchaEnterprise.V1Beta1.ProjectName ParentAsProjectName
        {
            get { return string.IsNullOrEmpty(Parent) ? null : Google.Cloud.RecaptchaEnterprise.V1Beta1.ProjectName.Parse(Parent); }
