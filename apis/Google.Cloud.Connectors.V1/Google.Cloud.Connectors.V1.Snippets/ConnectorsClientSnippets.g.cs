...
namespace Google.Cloud.Connectors.V1.Snippets
{
    ...
    public sealed class AllGeneratedConnectorsClientSnippets
    {
        ...
        {
            // Snippet: GetConnectionSchemaMetadata(ConnectionName, CallSettings)
            // Create client
            ConnectorsClient connectorsClient = ConnectorsClient.Create();
            // Initialize request argument(s)
            ConnectionName name = ConnectionName.FromProjectLocationConnection("[PROJECT]", "[LOCATION]", "[CONNECTION]");
        ...
        {
            // Snippet: GetConnectionSchemaMetadataAsync(ConnectionName, CallSettings)
            // Additional: GetConnectionSchemaMetadataAsync(ConnectionName, CancellationToken)
            // Create client
            ConnectorsClient connectorsClient = await ConnectorsClient.CreateAsync();
            // Initialize request argument(s)
            ConnectionName name = ConnectionName.FromProjectLocationConnection("[PROJECT]", "[LOCATION]", "[CONNECTION]");
