...
namespace Google.Cloud.Connectors.V1
{
    ...
    public sealed partial class ConnectorName : gax::IResourceName, sys::IEquatable<ConnectorName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/providers/{provider}/connectors/{connector}</c>.
            /// </summary>
            ProjectLocationProviderConnector = 1,
        }

        private static gax::PathTemplate s_projectLocationProviderConnector = new gax::PathTemplate("projects/{project}/locations/{location}/providers/{provider}/connectors/{connector}");
        ...
        public static string Format(string projectId, string locationId, string providerId, string connectorId) =>
            FormatProjectLocationProviderConnector(projectId, locationId, providerId, connectorId);
        ...
        public static bool TryParse(string connectorName, bool allowUnparsed, out ConnectorName result)
        {
            ...
            if (s_projectLocationProviderConnector.TryParseName(connectorName, out resourceName))
            {
                result = FromProjectLocationProviderConnector(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ConnectorName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string connectorId = null, string locationId = null, string projectId = null, string providerId = null)
        {
            Type = type;
        ...
        /// <param name="providerId">The <c>Provider</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="connectorId">The <c>Connector</c> ID. Must not be <c>null</c> or empty.</param>
        public ConnectorName(string projectId, string locationId, string providerId, string connectorId) : this(ResourceNameType.ProjectLocationProviderConnector, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), providerId: gax::GaxPreconditions.CheckNotNullOrEmpty(providerId, nameof(providerId)), connectorId: gax::GaxPreconditions.CheckNotNullOrEmpty(connectorId, nameof(connectorId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationProviderConnector: return s_projectLocationProviderConnector.Expand(ProjectId, LocationId, ProviderId, ConnectorId);
    ...
    {
        /// <summary>
        /// <see cref="gccv::ConnectorName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::ConnectorName ConnectorName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::ConnectorName.Parse(Name, allowUnparsed: true);
