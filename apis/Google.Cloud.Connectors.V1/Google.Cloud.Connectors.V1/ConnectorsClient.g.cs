...
namespace Google.Cloud.Connectors.V1
{
    ...
    public sealed partial class ConnectorsClientBuilder : gaxgrpc::ClientBuilderBase<ConnectorsClient>
    {
        ...
        private ConnectorsClient BuildImpl()
        {
            ...
            return ConnectorsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ConnectorsClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Connectors.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ConnectionSchemaMetadata GetConnectionSchemaMetadata(ConnectionName name, gaxgrpc::CallSettings callSettings = null) =>
            GetConnectionSchemaMetadata(new GetConnectionSchemaMetadataRequest
            {
                ConnectionName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ConnectionSchemaMetadata> GetConnectionSchemaMetadataAsync(ConnectionName name, gaxgrpc::CallSettings callSettings = null) =>
            GetConnectionSchemaMetadataAsync(new GetConnectionSchemaMetadataRequest
            {
                ConnectionName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ConnectionSchemaMetadata> GetConnectionSchemaMetadataAsync(ConnectionName name, st::CancellationToken cancellationToken) =>
            GetConnectionSchemaMetadataAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
