...
namespace Google.Ads.AdManager.V1
{
    ...
    public sealed partial class PlacementName : gax::IResourceName, sys::IEquatable<PlacementName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>networks/{network_code}/placements/{placement}</c>.</summary>
            NetworkCodePlacement = 1,
        }

        private static gax::PathTemplate s_networkCodePlacement = new gax::PathTemplate("networks/{network_code}/placements/{placement}");
        ...
        /// <summary>
        /// Creates a <see cref="PlacementName"/> with the pattern <c>networks/{network_code}/placements/{placement}</c>
        /// .
        /// </summary>
        ...
        public static PlacementName FromNetworkCodePlacement(string networkCodeId, string placementId) =>
            new PlacementName(ResourceNameType.NetworkCodePlacement, networkCodeId: gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), placementId: gax::GaxPreconditions.CheckNotNullOrEmpty(placementId, nameof(placementId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="PlacementName"/> with pattern
        /// <c>networks/{network_code}/placements/{placement}</c>.
        /// </summary>
        /// <param name="networkCodeId">The <c>NetworkCode</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="placementId">The <c>Placement</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <c>networks/{network_code}/placements/{placement}</c>.
        /// </returns>
        public static string Format(string networkCodeId, string placementId) =>
            FormatNetworkCodePlacement(networkCodeId, placementId);
        ...
        /// <c>networks/{network_code}/placements/{placement}</c>.
        /// </returns>
        public static string FormatNetworkCodePlacement(string networkCodeId, string placementId) =>
            s_networkCodePlacement.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), gax::GaxPreconditions.CheckNotNullOrEmpty(placementId, nameof(placementId)));

        /// <summary>Parses the given resource name string into a new <see cref="PlacementName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>networks/{network_code}/placements/{placement}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string placementName, bool allowUnparsed, out PlacementName result)
        {
            ...
            if (s_networkCodePlacement.TryParseName(placementName, out resourceName))
            {
                result = FromNetworkCodePlacement(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private PlacementName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string networkCodeId = null, string placementId = null)
        {
            Type = type;
        ...
        /// <param name="networkCodeId">The <c>NetworkCode</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="placementId">The <c>Placement</c> ID. Must not be <c>null</c> or empty.</param>
        public PlacementName(string networkCodeId, string placementId) : this(ResourceNameType.NetworkCodePlacement, networkCodeId: gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), placementId: gax::GaxPreconditions.CheckNotNullOrEmpty(placementId, nameof(placementId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.NetworkCodePlacement: return s_networkCodePlacement.Expand(NetworkCodeId, PlacementId);
    ...
    public partial class Placement
    {
        ...
        /// <summary>
        /// <see cref="AdUnitName"/>-typed view over the <see cref="TargetedAdUnits"/> resource name property.
        /// </summary>
        public gax::ResourceNameList<AdUnitName> TargetedAdUnitsAsAdUnitNames
        {
            get => new gax::ResourceNameList<AdUnitName>(TargetedAdUnits, s => string.IsNullOrEmpty(s) ? null : AdUnitName.Parse(s, allowUnparsed: true));
        }
    }
}
