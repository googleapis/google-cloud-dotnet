...
namespace Google.Ads.AdManager.V1
{
    ...
    public sealed partial class CompanyName : gax::IResourceName, sys::IEquatable<CompanyName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>networks/{network_code}/companies/{company}</c>.</summary>
            NetworkCodeCompany = 1,
        }

        private static gax::PathTemplate s_networkCodeCompany = new gax::PathTemplate("networks/{network_code}/companies/{company}");
        ...
        /// <summary>
        /// Creates a <see cref="CompanyName"/> with the pattern <c>networks/{network_code}/companies/{company}</c>.
        /// </summary>
        ...
        public static CompanyName FromNetworkCodeCompany(string networkCodeId, string companyId) =>
            new CompanyName(ResourceNameType.NetworkCodeCompany, networkCodeId: gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), companyId: gax::GaxPreconditions.CheckNotNullOrEmpty(companyId, nameof(companyId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="CompanyName"/> with pattern
        /// <c>networks/{network_code}/companies/{company}</c>.
        /// </summary>
        /// <param name="networkCodeId">The <c>NetworkCode</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="companyId">The <c>Company</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <c>networks/{network_code}/companies/{company}</c>.
        /// </returns>
        public static string Format(string networkCodeId, string companyId) =>
            FormatNetworkCodeCompany(networkCodeId, companyId);
        ...
        /// <c>networks/{network_code}/companies/{company}</c>.
        /// </returns>
        public static string FormatNetworkCodeCompany(string networkCodeId, string companyId) =>
            s_networkCodeCompany.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), gax::GaxPreconditions.CheckNotNullOrEmpty(companyId, nameof(companyId)));

        /// <summary>Parses the given resource name string into a new <see cref="CompanyName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>networks/{network_code}/companies/{company}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string companyName, bool allowUnparsed, out CompanyName result)
        {
            ...
            if (s_networkCodeCompany.TryParseName(companyName, out resourceName))
            {
                result = FromNetworkCodeCompany(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private CompanyName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string companyId = null, string networkCodeId = null)
        {
            Type = type;
        ...
        /// <param name="networkCodeId">The <c>NetworkCode</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="companyId">The <c>Company</c> ID. Must not be <c>null</c> or empty.</param>
        public CompanyName(string networkCodeId, string companyId) : this(ResourceNameType.NetworkCodeCompany, networkCodeId: gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), companyId: gax::GaxPreconditions.CheckNotNullOrEmpty(companyId, nameof(companyId)))
        {
        }
        ...
        /// <summary>
        /// The <c>Company</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.NetworkCodeCompany: return s_networkCodeCompany.Expand(NetworkCodeId, CompanyId);
    ...
    {
        /// <summary>
        /// <see cref="gaav::CompanyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gaav::CompanyName CompanyName
        {
            get => string.IsNullOrEmpty(Name) ? null : gaav::CompanyName.Parse(Name, allowUnparsed: true);
