...
namespace Google.Ads.AdManager.V1
{
    ...
    public sealed partial class ApplicationName : gax::IResourceName, sys::IEquatable<ApplicationName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>networks/{network_code}/applications/{application}</c>.
            /// </summary>
            NetworkCodeApplication = 1,
        }

        private static gax::PathTemplate s_networkCodeApplication = new gax::PathTemplate("networks/{network_code}/applications/{application}");
        ...
        /// <c>networks/{network_code}/applications/{application}</c>.
        /// </summary>
        ...
        public static ApplicationName FromNetworkCodeApplication(string networkCodeId, string applicationId) =>
            new ApplicationName(ResourceNameType.NetworkCodeApplication, networkCodeId: gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), applicationId: gax::GaxPreconditions.CheckNotNullOrEmpty(applicationId, nameof(applicationId)));
        ...
        /// <c>networks/{network_code}/applications/{application}</c>.
        /// </returns>
        public static string Format(string networkCodeId, string applicationId) =>
            FormatNetworkCodeApplication(networkCodeId, applicationId);
        ...
        /// <c>networks/{network_code}/applications/{application}</c>.
        /// </returns>
        public static string FormatNetworkCodeApplication(string networkCodeId, string applicationId) =>
            s_networkCodeApplication.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), gax::GaxPreconditions.CheckNotNullOrEmpty(applicationId, nameof(applicationId)));

        /// <summary>Parses the given resource name string into a new <see cref="ApplicationName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>networks/{network_code}/applications/{application}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string applicationName, bool allowUnparsed, out ApplicationName result)
        {
            ...
            if (s_networkCodeApplication.TryParseName(applicationName, out resourceName))
            {
                result = FromNetworkCodeApplication(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ApplicationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string applicationId = null, string networkCodeId = null)
        {
            Type = type;
        ...
        /// <param name="networkCodeId">The <c>NetworkCode</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="applicationId">The <c>Application</c> ID. Must not be <c>null</c> or empty.</param>
        public ApplicationName(string networkCodeId, string applicationId) : this(ResourceNameType.NetworkCodeApplication, networkCodeId: gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), applicationId: gax::GaxPreconditions.CheckNotNullOrEmpty(applicationId, nameof(applicationId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.NetworkCodeApplication: return s_networkCodeApplication.Expand(NetworkCodeId, ApplicationId);
    ...
    {
        /// <summary>
        /// <see cref="gaav::ApplicationName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gaav::ApplicationName ApplicationName
        {
            get => string.IsNullOrEmpty(Name) ? null : gaav::ApplicationName.Parse(Name, allowUnparsed: true);
