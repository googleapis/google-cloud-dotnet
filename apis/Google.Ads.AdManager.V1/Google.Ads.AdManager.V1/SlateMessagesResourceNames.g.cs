...
namespace Google.Ads.AdManager.V1
{
    ...
    public sealed partial class SlateName : gax::IResourceName, sys::IEquatable<SlateName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>networks/{network_code}/slates/{slate}</c>.</summary>
            NetworkCodeSlate = 1,
        }

        private static gax::PathTemplate s_networkCodeSlate = new gax::PathTemplate("networks/{network_code}/slates/{slate}");
        ...
        /// <summary>
        /// Creates a <see cref="SlateName"/> with the pattern <c>networks/{network_code}/slates/{slate}</c>.
        /// </summary>
        ...
        public static SlateName FromNetworkCodeSlate(string networkCodeId, string slateId) =>
            new SlateName(ResourceNameType.NetworkCodeSlate, networkCodeId: gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), slateId: gax::GaxPreconditions.CheckNotNullOrEmpty(slateId, nameof(slateId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="SlateName"/> with pattern
        /// <c>networks/{network_code}/slates/{slate}</c>.
        /// </summary>
        /// <param name="networkCodeId">The <c>NetworkCode</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="slateId">The <c>Slate</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <c>networks/{network_code}/slates/{slate}</c>.
        /// </returns>
        public static string Format(string networkCodeId, string slateId) => FormatNetworkCodeSlate(networkCodeId, slateId);
        ...
        /// <c>networks/{network_code}/slates/{slate}</c>.
        /// </returns>
        public static string FormatNetworkCodeSlate(string networkCodeId, string slateId) =>
            s_networkCodeSlate.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), gax::GaxPreconditions.CheckNotNullOrEmpty(slateId, nameof(slateId)));

        /// <summary>Parses the given resource name string into a new <see cref="SlateName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>networks/{network_code}/slates/{slate}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string slateName, bool allowUnparsed, out SlateName result)
        {
            ...
            if (s_networkCodeSlate.TryParseName(slateName, out resourceName))
            {
                result = FromNetworkCodeSlate(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private SlateName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string networkCodeId = null, string slateId = null)
        {
            Type = type;
        ...
        /// <param name="networkCodeId">The <c>NetworkCode</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="slateId">The <c>Slate</c> ID. Must not be <c>null</c> or empty.</param>
        public SlateName(string networkCodeId, string slateId) : this(ResourceNameType.NetworkCodeSlate, networkCodeId: gax::GaxPreconditions.CheckNotNullOrEmpty(networkCodeId, nameof(networkCodeId)), slateId: gax::GaxPreconditions.CheckNotNullOrEmpty(slateId, nameof(slateId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.NetworkCodeSlate: return s_networkCodeSlate.Expand(NetworkCodeId, SlateId);
