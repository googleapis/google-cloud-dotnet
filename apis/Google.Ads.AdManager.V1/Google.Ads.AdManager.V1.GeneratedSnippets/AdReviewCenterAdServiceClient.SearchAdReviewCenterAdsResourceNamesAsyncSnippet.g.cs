...
{
    // [START admanager_v1_generated_AdReviewCenterAdService_SearchAdReviewCenterAds_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAdReviewCenterAdServiceClientSnippets
    {
        ...
        public async Task SearchAdReviewCenterAdsResourceNamesAsync()
        {
            ...
            await foreach (AdReviewCenterAd item in response)
            {
            ...
            await foreach (SearchAdReviewCenterAdsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_AdReviewCenterAdService_SearchAdReviewCenterAds_async_flattened_resourceNames]
}
