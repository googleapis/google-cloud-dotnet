...
{
    // [START admanager_v1_generated_BandwidthGroupService_ListBandwidthGroups_async_flattened_resourceNames]
    using Google.Ads.AdManager.V1;
    using Google.Api.Gax;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedBandwidthGroupServiceClientSnippets
    {
        ...
        public async Task ListBandwidthGroupsResourceNamesAsync()
        {
            ...
            await foreach (BandwidthGroup item in response)
            {
            ...
            await foreach (ListBandwidthGroupsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_BandwidthGroupService_ListBandwidthGroups_async_flattened_resourceNames]
}
