...
{
    // [START admanager_v1_generated_AdUnitService_ListAdUnits_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAdUnitServiceClientSnippets
    {
        ...
        public async Task ListAdUnitsResourceNamesAsync()
        {
            ...
            await foreach (AdUnit item in response)
            {
            ...
            await foreach (ListAdUnitsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_AdUnitService_ListAdUnits_async_flattened_resourceNames]
}
