...
{
    // [START admanager_v1_generated_EntitySignalsMappingService_ListEntitySignalsMappings_async]
    ...
    public sealed partial class GeneratedEntitySignalsMappingServiceClientSnippets
    {
        ...
        public async Task ListEntitySignalsMappingsRequestObjectAsync()
        {
            ...
            await foreach (EntitySignalsMapping item in response)
            {
            ...
            await foreach (ListEntitySignalsMappingsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_EntitySignalsMappingService_ListEntitySignalsMappings_async]
}
