...
{
    // [START admanager_v1_generated_ReportService_FetchReportResultRows_async_flattened]
    ...
    public sealed partial class GeneratedReportServiceClientSnippets
    {
        ...
        public async Task FetchReportResultRowsAsync()
        {
            ...
            await foreach (ReportDataTable.Types.Row item in response)
            {
            ...
            await foreach (FetchReportResultRowsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_ReportService_FetchReportResultRows_async_flattened]
}
