...
{
    // [START admanager_v1_generated_ContentLabelService_ListContentLabels_async_flattened_resourceNames]
    using Google.Ads.AdManager.V1;
    using Google.Api.Gax;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedContentLabelServiceClientSnippets
    {
        ...
        public async Task ListContentLabelsResourceNamesAsync()
        {
            ...
            await foreach (ContentLabel item in response)
            {
            ...
            await foreach (ListContentLabelsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_ContentLabelService_ListContentLabels_async_flattened_resourceNames]
}
