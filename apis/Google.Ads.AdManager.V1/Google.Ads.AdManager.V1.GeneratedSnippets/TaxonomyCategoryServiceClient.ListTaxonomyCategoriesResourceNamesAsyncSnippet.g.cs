...
{
    // [START admanager_v1_generated_TaxonomyCategoryService_ListTaxonomyCategories_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedTaxonomyCategoryServiceClientSnippets
    {
        ...
        public async Task ListTaxonomyCategoriesResourceNamesAsync()
        {
            ...
            await foreach (TaxonomyCategory item in response)
            {
            ...
            await foreach (ListTaxonomyCategoriesResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_TaxonomyCategoryService_ListTaxonomyCategories_async_flattened_resourceNames]
}
