...
{
    // [START admanager_v1_generated_DeviceCategoryService_ListDeviceCategories_async_flattened]
    ...
    public sealed partial class GeneratedDeviceCategoryServiceClientSnippets
    {
        ...
        public async Task ListDeviceCategoriesAsync()
        {
            ...
            await foreach (DeviceCategory item in response)
            {
            ...
            await foreach (ListDeviceCategoriesResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_DeviceCategoryService_ListDeviceCategories_async_flattened]
}
