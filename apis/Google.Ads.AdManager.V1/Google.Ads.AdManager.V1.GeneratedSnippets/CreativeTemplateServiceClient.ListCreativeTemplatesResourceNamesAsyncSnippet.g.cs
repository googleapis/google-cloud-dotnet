...
{
    // [START admanager_v1_generated_CreativeTemplateService_ListCreativeTemplates_async_flattened_resourceNames]
    using Google.Ads.AdManager.V1;
    using Google.Api.Gax;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedCreativeTemplateServiceClientSnippets
    {
        ...
        public async Task ListCreativeTemplatesResourceNamesAsync()
        {
            ...
            await foreach (CreativeTemplate item in response)
            {
            ...
            await foreach (ListCreativeTemplatesResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_CreativeTemplateService_ListCreativeTemplates_async_flattened_resourceNames]
}
