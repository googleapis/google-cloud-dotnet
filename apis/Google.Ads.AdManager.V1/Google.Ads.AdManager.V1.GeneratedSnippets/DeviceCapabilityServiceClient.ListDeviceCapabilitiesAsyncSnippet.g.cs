...
{
    // [START admanager_v1_generated_DeviceCapabilityService_ListDeviceCapabilities_async_flattened]
    ...
    public sealed partial class GeneratedDeviceCapabilityServiceClientSnippets
    {
        ...
        public async Task ListDeviceCapabilitiesAsync()
        {
            ...
            await foreach (DeviceCapability item in response)
            {
            ...
            await foreach (ListDeviceCapabilitiesResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_DeviceCapabilityService_ListDeviceCapabilities_async_flattened]
}
