...
{
    // [START admanager_v1_generated_CmsMetadataValueService_ListCmsMetadataValues_async_flattened]
    using Google.Ads.AdManager.V1;
    using Google.Api.Gax;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedCmsMetadataValueServiceClientSnippets
    {
        ...
        public async Task ListCmsMetadataValuesAsync()
        {
            ...
            await foreach (CmsMetadataValue item in response)
            {
            ...
            await foreach (ListCmsMetadataValuesResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_CmsMetadataValueService_ListCmsMetadataValues_async_flattened]
}
