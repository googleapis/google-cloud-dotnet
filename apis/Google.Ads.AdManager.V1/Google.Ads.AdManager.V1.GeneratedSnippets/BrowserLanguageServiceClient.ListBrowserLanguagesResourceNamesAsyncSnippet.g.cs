...
{
    // [START admanager_v1_generated_BrowserLanguageService_ListBrowserLanguages_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBrowserLanguageServiceClientSnippets
    {
        ...
        public async Task ListBrowserLanguagesResourceNamesAsync()
        {
            ...
            await foreach (BrowserLanguage item in response)
            {
            ...
            await foreach (ListBrowserLanguagesResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_BrowserLanguageService_ListBrowserLanguages_async_flattened_resourceNames]
}
