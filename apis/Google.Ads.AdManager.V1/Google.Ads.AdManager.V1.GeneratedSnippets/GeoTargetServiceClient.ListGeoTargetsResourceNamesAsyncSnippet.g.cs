...
{
    // [START admanager_v1_generated_GeoTargetService_ListGeoTargets_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedGeoTargetServiceClientSnippets
    {
        ...
        public async Task ListGeoTargetsResourceNamesAsync()
        {
            ...
            await foreach (GeoTarget item in response)
            {
            ...
            await foreach (ListGeoTargetsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_GeoTargetService_ListGeoTargets_async_flattened_resourceNames]
}
