...
{
    // [START admanager_v1_generated_BrowserService_ListBrowsers_async_flattened]
    ...
    public sealed partial class GeneratedBrowserServiceClientSnippets
    {
        ...
        public async Task ListBrowsersAsync()
        {
            ...
            await foreach (Browser item in response)
            {
            ...
            await foreach (ListBrowsersResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_BrowserService_ListBrowsers_async_flattened]
}
