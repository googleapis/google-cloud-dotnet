...
{
    // [START admanager_v1_generated_OperatingSystemService_ListOperatingSystems_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedOperatingSystemServiceClientSnippets
    {
        ...
        public async Task ListOperatingSystemsResourceNamesAsync()
        {
            ...
            await foreach (gaav::OperatingSystem item in response)
            {
            ...
            await foreach (gaav::ListOperatingSystemsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_OperatingSystemService_ListOperatingSystems_async_flattened_resourceNames]
}
