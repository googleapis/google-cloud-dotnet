...
{
    // [START admanager_v1_generated_OperatingSystemVersionService_ListOperatingSystemVersions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedOperatingSystemVersionServiceClientSnippets
    {
        ...
        public async Task ListOperatingSystemVersionsResourceNamesAsync()
        {
            ...
            await foreach (OperatingSystemVersion item in response)
            {
            ...
            await foreach (ListOperatingSystemVersionsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_OperatingSystemVersionService_ListOperatingSystemVersions_async_flattened_resourceNames]
}
