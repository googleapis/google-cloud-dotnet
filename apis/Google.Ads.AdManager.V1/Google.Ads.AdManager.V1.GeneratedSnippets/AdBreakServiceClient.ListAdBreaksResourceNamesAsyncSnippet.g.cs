...
{
    // [START admanager_v1_generated_AdBreakService_ListAdBreaks_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAdBreakServiceClientSnippets
    {
        ...
        public async Task ListAdBreaksResourceNamesAsync()
        {
            ...
            await foreach (AdBreak item in response)
            {
            ...
            await foreach (ListAdBreaksResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_AdBreakService_ListAdBreaks_async_flattened_resourceNames]
}
