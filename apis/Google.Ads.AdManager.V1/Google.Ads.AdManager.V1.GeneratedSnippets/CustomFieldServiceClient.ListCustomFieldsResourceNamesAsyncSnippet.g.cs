...
{
    // [START admanager_v1_generated_CustomFieldService_ListCustomFields_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCustomFieldServiceClientSnippets
    {
        ...
        public async Task ListCustomFieldsResourceNamesAsync()
        {
            ...
            await foreach (CustomField item in response)
            {
            ...
            await foreach (ListCustomFieldsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_CustomFieldService_ListCustomFields_async_flattened_resourceNames]
}
