...
{
    // [START admanager_v1_generated_ProgrammaticBuyerService_ListProgrammaticBuyers_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedProgrammaticBuyerServiceClientSnippets
    {
        ...
        public async Task ListProgrammaticBuyersResourceNamesAsync()
        {
            ...
            await foreach (ProgrammaticBuyer item in response)
            {
            ...
            await foreach (ListProgrammaticBuyersResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_ProgrammaticBuyerService_ListProgrammaticBuyers_async_flattened_resourceNames]
}
