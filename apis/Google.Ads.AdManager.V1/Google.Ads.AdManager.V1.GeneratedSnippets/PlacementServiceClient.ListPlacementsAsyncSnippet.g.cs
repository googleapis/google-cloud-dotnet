...
{
    // [START admanager_v1_generated_PlacementService_ListPlacements_async_flattened]
    ...
    public sealed partial class GeneratedPlacementServiceClientSnippets
    {
        ...
        public async Task ListPlacementsAsync()
        {
            ...
            await foreach (Placement item in response)
            {
            ...
            await foreach (ListPlacementsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_PlacementService_ListPlacements_async_flattened]
}
