...
{
    // [START admanager_v1_generated_PrivateAuctionService_ListPrivateAuctions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedPrivateAuctionServiceClientSnippets
    {
        ...
        public async Task ListPrivateAuctionsResourceNamesAsync()
        {
            ...
            await foreach (PrivateAuction item in response)
            {
            ...
            await foreach (ListPrivateAuctionsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_PrivateAuctionService_ListPrivateAuctions_async_flattened_resourceNames]
}
