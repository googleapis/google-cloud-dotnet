...
{
    // [START admanager_v1_generated_TeamService_ListTeams_async_flattened]
    using Google.Ads.AdManager.V1;
    using Google.Api.Gax;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedTeamServiceClientSnippets
    {
        ...
        public async Task ListTeamsAsync()
        {
            ...
            await foreach (Team item in response)
            {
            ...
            await foreach (ListTeamsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_TeamService_ListTeams_async_flattened]
}
