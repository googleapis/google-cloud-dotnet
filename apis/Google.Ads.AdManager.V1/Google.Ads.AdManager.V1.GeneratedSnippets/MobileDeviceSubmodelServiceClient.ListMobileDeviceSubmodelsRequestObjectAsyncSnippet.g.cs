...
{
    // [START admanager_v1_generated_MobileDeviceSubmodelService_ListMobileDeviceSubmodels_async]
    using Google.Ads.AdManager.V1;
    using Google.Api.Gax;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedMobileDeviceSubmodelServiceClientSnippets
    {
        ...
        public async Task ListMobileDeviceSubmodelsRequestObjectAsync()
        {
            ...
            await foreach (MobileDeviceSubmodel item in response)
            {
            ...
            await foreach (ListMobileDeviceSubmodelsResponse page in response.AsRawResponses())
            {
    ...
    // [END admanager_v1_generated_MobileDeviceSubmodelService_ListMobileDeviceSubmodels_async]
}
