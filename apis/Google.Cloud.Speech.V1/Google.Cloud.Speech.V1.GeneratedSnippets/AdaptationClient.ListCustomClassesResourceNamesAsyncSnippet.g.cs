...
{
    // [START speech_v1_generated_Adaptation_ListCustomClasses_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAdaptationClientSnippets
    {
        ...
        public async Task ListCustomClassesResourceNamesAsync()
        {
            ...
            await foreach (CustomClass item in response)
            {
            ...
            await foreach (ListCustomClassesResponse page in response.AsRawResponses())
            {
    ...
    // [END speech_v1_generated_Adaptation_ListCustomClasses_async_flattened_resourceNames]
}
