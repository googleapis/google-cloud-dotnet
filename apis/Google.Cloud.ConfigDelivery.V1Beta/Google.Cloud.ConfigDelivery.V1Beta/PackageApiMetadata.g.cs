...
namespace Google.Cloud.ConfigDelivery.V1Beta
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.ConfigDelivery.V1Beta", GetFileDescriptors)
        ...
        {
            yield return ConfigDeliveryReflection.Descriptor;
