...
{
    // [START servicehealth_v1_generated_ServiceHealth_ListOrganizationImpacts_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedServiceHealthClientSnippets
    {
        ...
        public async Task ListOrganizationImpactsResourceNamesAsync()
        {
            ...
            await foreach (OrganizationImpact item in response)
            {
            ...
            await foreach (ListOrganizationImpactsResponse page in response.AsRawResponses())
            {
    ...
    // [END servicehealth_v1_generated_ServiceHealth_ListOrganizationImpacts_async_flattened_resourceNames]
}
