...
{
    // [START spanner_v1_generated_InstanceAdmin_ListInstancePartitions_async_flattened]
    ...
    public sealed partial class GeneratedInstanceAdminClientSnippets
    {
        ...
        public async Task ListInstancePartitionsAsync()
        {
            ...
            await foreach (InstancePartition item in response)
            {
            ...
            await foreach (ListInstancePartitionsResponse page in response.AsRawResponses())
            {
    ...
    // [END spanner_v1_generated_InstanceAdmin_ListInstancePartitions_async_flattened]
}
