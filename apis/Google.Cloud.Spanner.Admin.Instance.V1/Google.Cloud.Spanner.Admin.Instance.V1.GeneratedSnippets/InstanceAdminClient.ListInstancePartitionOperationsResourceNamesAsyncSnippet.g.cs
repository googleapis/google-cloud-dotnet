...
{
    // [START spanner_v1_generated_InstanceAdmin_ListInstancePartitionOperations_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedInstanceAdminClientSnippets
    {
        ...
        public async Task ListInstancePartitionOperationsResourceNamesAsync()
        {
            ...
            await foreach (ListInstancePartitionOperationsResponse page in response.AsRawResponses())
            {
    ...
    // [END spanner_v1_generated_InstanceAdmin_ListInstancePartitionOperations_async_flattened_resourceNames]
}
