...
{
    // [START spanner_v1_generated_InstanceAdmin_ListInstanceConfigOperations_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedInstanceAdminClientSnippets
    {
        ...
        public async Task ListInstanceConfigOperationsResourceNamesAsync()
        {
            ...
            await foreach (ListInstanceConfigOperationsResponse page in response.AsRawResponses())
            {
    ...
    // [END spanner_v1_generated_InstanceAdmin_ListInstanceConfigOperations_async_flattened_resourceNames]
}
