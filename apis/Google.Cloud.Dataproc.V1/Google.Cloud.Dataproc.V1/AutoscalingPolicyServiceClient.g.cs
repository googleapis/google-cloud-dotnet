...
namespace Google.Cloud.Dataproc.V1
{
    ...
    public sealed partial class AutoscalingPolicyServiceClientImpl : AutoscalingPolicyServiceClient
    {
        ...
        public AutoscalingPolicyServiceClientImpl(AutoscalingPolicyService.AutoscalingPolicyServiceClient grpcClient, AutoscalingPolicyServiceSettings settings)
        {
            ...
            _callCreateAutoscalingPolicy = clientHelper.BuildApiCall<CreateAutoscalingPolicyRequest, AutoscalingPolicy>(grpcClient.CreateAutoscalingPolicyAsync, grpcClient.CreateAutoscalingPolicy, effectiveSettings.CreateAutoscalingPolicySettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateAutoscalingPolicy);
            Modify_CreateAutoscalingPolicyApiCall(ref _callCreateAutoscalingPolicy);
            _callUpdateAutoscalingPolicy = clientHelper.BuildApiCall<UpdateAutoscalingPolicyRequest, AutoscalingPolicy>(grpcClient.UpdateAutoscalingPolicyAsync, grpcClient.UpdateAutoscalingPolicy, effectiveSettings.UpdateAutoscalingPolicySettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"policy.name={(sysnet::WebUtility.UrlEncode(request.Policy.Name))}"));
            Modify_ApiCall(ref _callUpdateAutoscalingPolicy);
            Modify_UpdateAutoscalingPolicyApiCall(ref _callUpdateAutoscalingPolicy);
            _callGetAutoscalingPolicy = clientHelper.BuildApiCall<GetAutoscalingPolicyRequest, AutoscalingPolicy>(grpcClient.GetAutoscalingPolicyAsync, grpcClient.GetAutoscalingPolicy, effectiveSettings.GetAutoscalingPolicySettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            ...
            _callDeleteAutoscalingPolicy = clientHelper.BuildApiCall<DeleteAutoscalingPolicyRequest, wkt::Empty>(grpcClient.DeleteAutoscalingPolicyAsync, grpcClient.DeleteAutoscalingPolicy, effectiveSettings.DeleteAutoscalingPolicySettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
