...
namespace Google.Cloud.Dataproc.V1
{
    ...
    public sealed partial class NodeGroupControllerClientBuilder : gaxgrpc::ClientBuilderBase<NodeGroupControllerClient>
    {
        ...
        private NodeGroupControllerClient BuildImpl()
        {
            ...
            return NodeGroupControllerClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class NodeGroupControllerClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(NodeGroupController.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
