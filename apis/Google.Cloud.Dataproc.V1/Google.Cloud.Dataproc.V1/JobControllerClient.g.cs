...
namespace Google.Cloud.Dataproc.V1
{
    ...
    public sealed partial class JobControllerClientImpl : JobControllerClient
    {
        ...
        public JobControllerClientImpl(JobController.JobControllerClient grpcClient, JobControllerSettings settings)
        {
            ...
            _callSubmitJob = clientHelper.BuildApiCall<SubmitJobRequest, Job>(grpcClient.SubmitJobAsync, grpcClient.SubmitJob, effectiveSettings.SubmitJobSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}"));
            Modify_ApiCall(ref _callSubmitJob);
            Modify_SubmitJobApiCall(ref _callSubmitJob);
            _callGetJob = clientHelper.BuildApiCall<GetJobRequest, Job>(grpcClient.GetJobAsync, grpcClient.GetJob, effectiveSettings.GetJobSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}&job_id={(sysnet::WebUtility.UrlEncode(request.JobId))}"));
            Modify_ApiCall(ref _callGetJob);
            Modify_GetJobApiCall(ref _callGetJob);
            _callListJobs = clientHelper.BuildApiCall<ListJobsRequest, ListJobsResponse>(grpcClient.ListJobsAsync, grpcClient.ListJobs, effectiveSettings.ListJobsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}"));
            Modify_ApiCall(ref _callListJobs);
            Modify_ListJobsApiCall(ref _callListJobs);
            _callUpdateJob = clientHelper.BuildApiCall<UpdateJobRequest, Job>(grpcClient.UpdateJobAsync, grpcClient.UpdateJob, effectiveSettings.UpdateJobSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}&job_id={(sysnet::WebUtility.UrlEncode(request.JobId))}"));
            Modify_ApiCall(ref _callUpdateJob);
            Modify_UpdateJobApiCall(ref _callUpdateJob);
            _callCancelJob = clientHelper.BuildApiCall<CancelJobRequest, Job>(grpcClient.CancelJobAsync, grpcClient.CancelJob, effectiveSettings.CancelJobSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}&job_id={(sysnet::WebUtility.UrlEncode(request.JobId))}"));
            Modify_ApiCall(ref _callCancelJob);
            Modify_CancelJobApiCall(ref _callCancelJob);
            _callDeleteJob = clientHelper.BuildApiCall<DeleteJobRequest, wkt::Empty>(grpcClient.DeleteJobAsync, grpcClient.DeleteJob, effectiveSettings.DeleteJobSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}&job_id={(sysnet::WebUtility.UrlEncode(request.JobId))}"));
