...
namespace Google.Cloud.Dataproc.V1
{
    ...
    public abstract partial class ClusterControllerClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="ClusterControllerClient"/>, applying defaults for all unspecified
        ...
        /// <summary>
        /// Synchronously creates a <see cref="ClusterControllerClient"/>, applying defaults for all unspecified
        /// settings, and creating a channel connecting to the given endpoint with application default credentials where
        /// necessary. See the example for how to use custom credentials.
        /// </summary>
        /// <example>
        ...
        /// <see cref="Create(grpccore::CallInvoker,ClusterControllerSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,ClusterControllerSettings)"/>. Channels which weren't
        /// automatically created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to
        /// <see cref="Create(grpccore::CallInvoker,ClusterControllerSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,ClusterControllerSettings)"/> will create new channels,
    ...
    public sealed partial class ClusterControllerClientImpl : ClusterControllerClient
    {
        ...
        public ClusterControllerClientImpl(ClusterController.ClusterControllerClient grpcClient, ClusterControllerSettings settings)
        {
            ...
            _callCreateCluster = clientHelper.BuildApiCall<CreateClusterRequest, lro::Operation>(grpcClient.CreateClusterAsync, grpcClient.CreateCluster, effectiveSettings.CreateClusterSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}"));
            Modify_ApiCall(ref _callCreateCluster);
            Modify_CreateClusterApiCall(ref _callCreateCluster);
            _callUpdateCluster = clientHelper.BuildApiCall<UpdateClusterRequest, lro::Operation>(grpcClient.UpdateClusterAsync, grpcClient.UpdateCluster, effectiveSettings.UpdateClusterSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}&cluster_name={(sysnet::WebUtility.UrlEncode(request.ClusterName))}"));
            Modify_ApiCall(ref _callUpdateCluster);
            Modify_UpdateClusterApiCall(ref _callUpdateCluster);
            _callDeleteCluster = clientHelper.BuildApiCall<DeleteClusterRequest, lro::Operation>(grpcClient.DeleteClusterAsync, grpcClient.DeleteCluster, effectiveSettings.DeleteClusterSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}&cluster_name={(sysnet::WebUtility.UrlEncode(request.ClusterName))}"));
            Modify_ApiCall(ref _callDeleteCluster);
            Modify_DeleteClusterApiCall(ref _callDeleteCluster);
            _callGetCluster = clientHelper.BuildApiCall<GetClusterRequest, Cluster>(grpcClient.GetClusterAsync, grpcClient.GetCluster, effectiveSettings.GetClusterSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}&cluster_name={(sysnet::WebUtility.UrlEncode(request.ClusterName))}"));
            Modify_ApiCall(ref _callGetCluster);
            Modify_GetClusterApiCall(ref _callGetCluster);
            _callListClusters = clientHelper.BuildApiCall<ListClustersRequest, ListClustersResponse>(grpcClient.ListClustersAsync, grpcClient.ListClusters, effectiveSettings.ListClustersSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}"));
            Modify_ApiCall(ref _callListClusters);
            Modify_ListClustersApiCall(ref _callListClusters);
            _callDiagnoseCluster = clientHelper.BuildApiCall<DiagnoseClusterRequest, lro::Operation>(grpcClient.DiagnoseClusterAsync, grpcClient.DiagnoseCluster, effectiveSettings.DiagnoseClusterSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"project_id={(sysnet::WebUtility.UrlEncode(request.ProjectId))}&region={(sysnet::WebUtility.UrlEncode(request.Region))}&cluster_name={(sysnet::WebUtility.UrlEncode(request.ClusterName))}"));
