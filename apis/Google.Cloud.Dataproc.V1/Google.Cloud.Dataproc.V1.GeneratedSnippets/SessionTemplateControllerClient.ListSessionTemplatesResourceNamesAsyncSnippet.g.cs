...
{
    // [START dataproc_v1_generated_SessionTemplateController_ListSessionTemplates_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSessionTemplateControllerClientSnippets
    {
        ...
        public async Task ListSessionTemplatesResourceNamesAsync()
        {
            ...
            await foreach (SessionTemplate item in response)
            {
            ...
            await foreach (ListSessionTemplatesResponse page in response.AsRawResponses())
            {
    ...
    // [END dataproc_v1_generated_SessionTemplateController_ListSessionTemplates_async_flattened_resourceNames]
}
