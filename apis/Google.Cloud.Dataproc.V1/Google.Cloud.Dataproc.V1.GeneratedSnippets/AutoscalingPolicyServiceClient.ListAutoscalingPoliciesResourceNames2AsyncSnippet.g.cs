...
{
    // [START dataproc_v1_generated_AutoscalingPolicyService_ListAutoscalingPolicies_async_flattened_resourceNames2]
    ...
    public sealed partial class GeneratedAutoscalingPolicyServiceClientSnippets
    {
        ...
        public async Task ListAutoscalingPoliciesResourceNames2Async()
        {
            ...
            await foreach (AutoscalingPolicy item in response)
            {
            ...
            await foreach (ListAutoscalingPoliciesResponse page in response.AsRawResponses())
            {
    ...
    // [END dataproc_v1_generated_AutoscalingPolicyService_ListAutoscalingPolicies_async_flattened_resourceNames2]
}
