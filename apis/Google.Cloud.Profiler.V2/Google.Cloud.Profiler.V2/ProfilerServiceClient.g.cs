...
namespace Google.Cloud.Profiler.V2
{
    ...
    public sealed partial class ProfilerServiceClientBuilder : gaxgrpc::ClientBuilderBase<ProfilerServiceClient>
    {
        ...
        private ProfilerServiceClient BuildImpl()
        {
            ...
            return ProfilerServiceClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ProfilerServiceClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ProfilerService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
