...
{
    // [START cloudprofiler_v2_generated_ExportService_ListProfiles_sync_flattened_resourceNames]
    using Google.Api.Gax;
    using Google.Api.Gax.ResourceNames;
    using Google.Cloud.Profiler.V2;
    using System;

    public sealed partial class GeneratedExportServiceClientSnippets
    {
    ...
    // [END cloudprofiler_v2_generated_ExportService_ListProfiles_sync_flattened_resourceNames]
}
