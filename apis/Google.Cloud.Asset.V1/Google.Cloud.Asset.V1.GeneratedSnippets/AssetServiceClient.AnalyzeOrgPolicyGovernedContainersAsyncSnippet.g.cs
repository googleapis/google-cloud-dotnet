...
{
    // [START cloudasset_v1_generated_AssetService_AnalyzeOrgPolicyGovernedContainers_async_flattened]
    ...
    public sealed partial class GeneratedAssetServiceClientSnippets
    {
        ...
        public async Task AnalyzeOrgPolicyGovernedContainersAsync()
        {
            ...
            await foreach (AnalyzeOrgPolicyGovernedContainersResponse.Types.GovernedContainer item in response)
            {
            ...
            await foreach (AnalyzeOrgPolicyGovernedContainersResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudasset_v1_generated_AssetService_AnalyzeOrgPolicyGovernedContainers_async_flattened]
}
