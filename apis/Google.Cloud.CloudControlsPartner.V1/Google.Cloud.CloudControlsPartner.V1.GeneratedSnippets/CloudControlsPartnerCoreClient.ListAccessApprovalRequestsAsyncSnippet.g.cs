...
{
    // [START cloudcontrolspartner_v1_generated_CloudControlsPartnerCore_ListAccessApprovalRequests_async_flattened]
...
#pragma warning restore CS0612
            ...
            await foreach (AccessApprovalRequest item in response)
            {
            ...
            await foreach (ListAccessApprovalRequestsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudcontrolspartner_v1_generated_CloudControlsPartnerCore_ListAccessApprovalRequests_async_flattened]
}
