...
namespace Google.Cloud.CloudControlsPartner.V1
{
    ...
    public sealed partial class WorkloadName : gax::IResourceName, sys::IEquatable<WorkloadName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}</c>.
            /// </summary>
            OrganizationLocationCustomerWorkload = 1,
        }

        private static gax::PathTemplate s_organizationLocationCustomerWorkload = new gax::PathTemplate("organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}");
        ...
        public static WorkloadName FromOrganizationLocationCustomerWorkload(string organizationId, string locationId, string customerId, string workloadId) =>
            new WorkloadName(ResourceNameType.OrganizationLocationCustomerWorkload, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), workloadId: gax::GaxPreconditions.CheckNotNullOrEmpty(workloadId, nameof(workloadId)));
        ...
        public static bool TryParse(string workloadName, bool allowUnparsed, out WorkloadName result)
        {
            ...
            if (s_organizationLocationCustomerWorkload.TryParseName(workloadName, out resourceName))
            {
        ...
        private WorkloadName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string locationId = null, string organizationId = null, string workloadId = null)
        {
            Type = type;
        ...
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="workloadId">The <c>Workload</c> ID. Must not be <c>null</c> or empty.</param>
        public WorkloadName(string organizationId, string locationId, string customerId, string workloadId) : this(ResourceNameType.OrganizationLocationCustomerWorkload, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), workloadId: gax::GaxPreconditions.CheckNotNullOrEmpty(workloadId, nameof(workloadId)))
        {
        }
    ...
    {
        /// <summary>
        /// <see cref="gccv::WorkloadName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::WorkloadName WorkloadName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::WorkloadName.Parse(Name, allowUnparsed: true);
