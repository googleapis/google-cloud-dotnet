...
{
    // [START bigtable_v2_generated_Bigtable_PrepareQuery_async_flattened2_resourceNames]
    ...
    public sealed partial class GeneratedBigtableServiceApiClientSnippets
    {
        ...
        public async Task PrepareQuery2ResourceNamesAsync()
        {
            ...
            string appProfileId = "";
            // Make the request
            PrepareQueryResponse response = await bigtableServiceApiClient.PrepareQueryAsync(instanceName, query, appProfileId);
        }
    }
    // [END bigtable_v2_generated_Bigtable_PrepareQuery_async_flattened2_resourceNames]
}
