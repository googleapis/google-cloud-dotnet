...
{
    // [START bigtable_v2_generated_Bigtable_PrepareQuery_sync_flattened1_resourceNames]
    ...
    public sealed partial class GeneratedBigtableServiceApiClientSnippets
    {
        ...
        public void PrepareQuery1ResourceNames()
        {
            ...
            string query = "";
            // Make the request
            PrepareQueryResponse response = bigtableServiceApiClient.PrepareQuery(instanceName, query);
        }
    }
    // [END bigtable_v2_generated_Bigtable_PrepareQuery_sync_flattened1_resourceNames]
}
