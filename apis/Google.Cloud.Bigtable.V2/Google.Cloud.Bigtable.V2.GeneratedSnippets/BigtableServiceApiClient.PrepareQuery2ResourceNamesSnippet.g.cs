...
{
    // [START bigtable_v2_generated_Bigtable_PrepareQuery_sync_flattened2_resourceNames]
    ...
    public sealed partial class GeneratedBigtableServiceApiClientSnippets
    {
        ...
        public void PrepareQuery2ResourceNames()
        {
            ...
            string appProfileId = "";
            // Make the request
            PrepareQueryResponse response = bigtableServiceApiClient.PrepareQuery(instanceName, query, appProfileId);
        }
    }
    // [END bigtable_v2_generated_Bigtable_PrepareQuery_sync_flattened2_resourceNames]
}
