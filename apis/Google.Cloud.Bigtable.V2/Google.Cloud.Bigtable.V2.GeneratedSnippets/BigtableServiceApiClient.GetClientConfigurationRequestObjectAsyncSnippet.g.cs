...
{
    // [START bigtable_v2_generated_Bigtable_GetClientConfiguration_async]
    ...
    public sealed partial class GeneratedBigtableServiceApiClientSnippets
    {
        ...
        public async Task GetClientConfigurationRequestObjectAsync()
        {
            ...
            GetClientConfigurationRequest request = new GetClientConfigurationRequest
            {
                InstanceNameAsInstanceName = InstanceName.FromProjectInstance("[PROJECT]", "[INSTANCE]"),
                AppProfileId = "",
            };
            // Make the request
            ClientConfiguration response = await bigtableServiceApiClient.GetClientConfigurationAsync(request);
        }
    }
    // [END bigtable_v2_generated_Bigtable_GetClientConfiguration_async]
}
