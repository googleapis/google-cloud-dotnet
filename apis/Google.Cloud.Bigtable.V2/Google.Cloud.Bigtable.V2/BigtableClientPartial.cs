...
namespace Google.Cloud.Bigtable.V2
{
    ...
    public partial class BigtableClientImpl
    {
        ...
        private static BigtableServiceApiClient[] _clients;
        ...
        /// <inheritdoc/>
        protected override BigtableServiceApiClient GetUnderlyingClient()
        {
            return _clients.Length > 1 ? _clients[GetClientIndex()] : _clients[0];
        }
