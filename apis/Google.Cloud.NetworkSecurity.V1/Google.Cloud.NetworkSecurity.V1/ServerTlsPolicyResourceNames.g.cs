...
namespace Google.Cloud.NetworkSecurity.V1
{
    ...
    public partial class ServerTlsPolicy
    {
        /// <summary>
        /// <see cref="gcnv::ServerTlsPolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcnv::ServerTlsPolicyName ServerTlsPolicyName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcnv::ServerTlsPolicyName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }

        public partial class Types
        {
            public partial class MTLSPolicy
            {
                /// <summary>
                /// <see cref="TrustConfigName"/>-typed view over the <see cref="ClientValidationTrustConfig"/> resource
                /// name property.
                /// </summary>
                public TrustConfigName ClientValidationTrustConfigAsTrustConfigName
                {
                    get => string.IsNullOrEmpty(ClientValidationTrustConfig) ? null : TrustConfigName.Parse(ClientValidationTrustConfig, allowUnparsed: true);
                    set => ClientValidationTrustConfig = value?.ToString() ?? "";
                }
            }
        }
    }

    public partial class ListServerTlsPoliciesRequest
    {
        /// <summary>
    ...
    public partial class GetServerTlsPolicyRequest
    {
        /// <summary>
        /// <see cref="gcnv::ServerTlsPolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class CreateServerTlsPolicyRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class DeleteServerTlsPolicyRequest
    {
        /// <summary>
        /// <see cref="gcnv::ServerTlsPolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
