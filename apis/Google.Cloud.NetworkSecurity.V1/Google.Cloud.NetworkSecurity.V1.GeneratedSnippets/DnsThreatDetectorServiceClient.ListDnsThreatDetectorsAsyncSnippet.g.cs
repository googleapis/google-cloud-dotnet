...
{
    // [START networksecurity_v1_generated_DnsThreatDetectorService_ListDnsThreatDetectors_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.NetworkSecurity.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedDnsThreatDetectorServiceClientSnippets
    {
        ...
        public async Task ListDnsThreatDetectorsAsync()
        {
            ...
            await foreach (DnsThreatDetector item in response)
            {
            ...
            await foreach (ListDnsThreatDetectorsResponse page in response.AsRawResponses())
            {
    ...
    // [END networksecurity_v1_generated_DnsThreatDetectorService_ListDnsThreatDetectors_async_flattened]
}
