...
{
    // [START securitycenter_v1p1beta1_generated_SecurityCenter_GroupFindings_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSecurityCenterClientSnippets
    {
        ...
        public async Task GroupFindingsResourceNamesAsync()
        {
            ...
            await foreach (GroupResult item in response)
            {
            ...
            await foreach (GroupFindingsResponse page in response.AsRawResponses())
            {
    ...
    // [END securitycenter_v1p1beta1_generated_SecurityCenter_GroupFindings_async_flattened_resourceNames]
}
