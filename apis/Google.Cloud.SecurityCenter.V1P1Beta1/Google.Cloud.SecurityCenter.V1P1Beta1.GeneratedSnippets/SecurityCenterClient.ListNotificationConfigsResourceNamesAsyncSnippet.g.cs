...
{
    // [START securitycenter_v1p1beta1_generated_SecurityCenter_ListNotificationConfigs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSecurityCenterClientSnippets
    {
        ...
        public async Task ListNotificationConfigsResourceNamesAsync()
        {
            ...
            await foreach (NotificationConfig item in response)
            {
            ...
            await foreach (ListNotificationConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END securitycenter_v1p1beta1_generated_SecurityCenter_ListNotificationConfigs_async_flattened_resourceNames]
}
