...
{
    // [START securitycenter_v1p1beta1_generated_SecurityCenter_ListAssets_async_flattened_resourceNames3]
    ...
    public sealed partial class GeneratedSecurityCenterClientSnippets
    {
        ...
        public async Task ListAssetsResourceNames3Async()
        {
            ...
            await foreach (ListAssetsResponse.Types.ListAssetsResult item in response)
            {
    ...
    // [END securitycenter_v1p1beta1_generated_SecurityCenter_ListAssets_async_flattened_resourceNames3]
}
