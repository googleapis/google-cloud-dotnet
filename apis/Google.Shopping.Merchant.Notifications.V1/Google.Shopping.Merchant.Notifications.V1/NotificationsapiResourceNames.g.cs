...
using gsmnv = Google.Shopping.Merchant.Notifications.V1;
using sys = System;
...
namespace Google.Shopping.Merchant.Notifications.V1
{
    ...
    /// <summary>Resource name for the <c>NotificationSubscriptionHealthMetrics</c> resource.</summary>
    public sealed partial class NotificationSubscriptionHealthMetricsName : gax::IResourceName, sys::IEquatable<NotificationSubscriptionHealthMetricsName>
    {
        /// <summary>The possible contents of <see cref="NotificationSubscriptionHealthMetricsName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
        ...
        /// <summary>
        /// Creates a <see cref="NotificationSubscriptionHealthMetricsName"/> containing an unparsed resource name.
        /// </summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="NotificationSubscriptionHealthMetricsName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static NotificationSubscriptionHealthMetricsName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new NotificationSubscriptionHealthMetricsName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="NotificationSubscriptionHealthMetricsName"/> with the pattern
        /// <c>accounts/{account}/notificationsubscriptions/{notification_subscription}</c>.
        /// </summary>
        /// <param name="accountId">The <c>Account</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="notificationSubscriptionId">
        ...
        /// </param>
        /// <returns>
        /// A new instance of <see cref="NotificationSubscriptionHealthMetricsName"/> constructed from the provided ids.
        /// </returns>
        public static NotificationSubscriptionHealthMetricsName FromAccountNotificationSubscription(string accountId, string notificationSubscriptionId) =>
            new NotificationSubscriptionHealthMetricsName(ResourceNameType.AccountNotificationSubscription, accountId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountId, nameof(accountId)), notificationSubscriptionId: gax::GaxPreconditions.CheckNotNullOrEmpty(notificationSubscriptionId, nameof(notificationSubscriptionId)));

        /// <summary>
        /// Formats the IDs into the string representation of this
        /// <see cref="NotificationSubscriptionHealthMetricsName"/> with pattern
        /// <c>accounts/{account}/notificationsubscriptions/{notification_subscription}</c>.
        /// </summary>
        /// <param name="accountId">The <c>Account</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="notificationSubscriptionId">
        ...
        /// </param>
        /// <returns>
        /// The string representation of this <see cref="NotificationSubscriptionHealthMetricsName"/> with pattern
        /// <c>accounts/{account}/notificationsubscriptions/{notification_subscription}</c>.
        /// </returns>
        public static string Format(string accountId, string notificationSubscriptionId) =>
            FormatAccountNotificationSubscription(accountId, notificationSubscriptionId);
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="NotificationSubscriptionHealthMetricsName"/>
        /// instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </list>
        /// </remarks>
        /// <param name="notificationSubscriptionHealthMetricsName">
        /// The resource name in string form. Must not be <c>null</c>.
        /// </param>
        /// <returns>The parsed <see cref="NotificationSubscriptionHealthMetricsName"/> if successful.</returns>
        public static NotificationSubscriptionHealthMetricsName Parse(string notificationSubscriptionHealthMetricsName) =>
            Parse(notificationSubscriptionHealthMetricsName, false);
        ...
        /// </param>
        /// <returns>The parsed <see cref="NotificationSubscriptionHealthMetricsName"/> if successful.</returns>
        public static NotificationSubscriptionHealthMetricsName Parse(string notificationSubscriptionHealthMetricsName, bool allowUnparsed) =>
            TryParse(notificationSubscriptionHealthMetricsName, allowUnparsed, out NotificationSubscriptionHealthMetricsName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new
        /// <see cref="NotificationSubscriptionHealthMetricsName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="NotificationSubscriptionHealthMetricsName"/>, or <c>null</c>
        /// if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string notificationSubscriptionHealthMetricsName, out NotificationSubscriptionHealthMetricsName result) =>
            TryParse(notificationSubscriptionHealthMetricsName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new
        /// <see cref="NotificationSubscriptionHealthMetricsName"/> instance; optionally allowing an unparseable
        /// resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string notificationSubscriptionHealthMetricsName, bool allowUnparsed, out NotificationSubscriptionHealthMetricsName result)
        {
            gax::GaxPreconditions.CheckNotNull(notificationSubscriptionHealthMetricsName, nameof(notificationSubscriptionHealthMetricsName));
            gax::TemplatedResourceName resourceName;
            if (s_accountNotificationSubscription.TryParseName(notificationSubscriptionHealthMetricsName, out resourceName))
            {
                result = FromAccountNotificationSubscription(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(notificationSubscriptionHealthMetricsName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private NotificationSubscriptionHealthMetricsName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string accountId = null, string notificationSubscriptionId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            AccountId = accountId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="NotificationSubscriptionHealthMetricsName"/> class from the
        /// component parts of pattern <c>accounts/{account}/notificationsubscriptions/{notification_subscription}</c>
        /// </summary>
        /// <param name="accountId">The <c>Account</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="notificationSubscriptionId">
        /// The <c>NotificationSubscription</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public NotificationSubscriptionHealthMetricsName(string accountId, string notificationSubscriptionId) : this(ResourceNameType.AccountNotificationSubscription, accountId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountId, nameof(accountId)), notificationSubscriptionId: gax::GaxPreconditions.CheckNotNullOrEmpty(notificationSubscriptionId, nameof(notificationSubscriptionId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as NotificationSubscriptionHealthMetricsName);

        /// <inheritdoc/>
        public bool Equals(NotificationSubscriptionHealthMetricsName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(NotificationSubscriptionHealthMetricsName a, NotificationSubscriptionHealthMetricsName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(NotificationSubscriptionHealthMetricsName a, NotificationSubscriptionHealthMetricsName b) => !(a == b);
    }
    ...
    public partial class GetNotificationSubscriptionHealthMetricsRequest
    {
        /// <summary>
        /// <see cref="gsmnv::NotificationSubscriptionHealthMetricsName"/>-typed view over the <see cref="Name"/>
        /// resource name property.
        /// </summary>
        public gsmnv::NotificationSubscriptionHealthMetricsName NotificationSubscriptionHealthMetricsName
        {
            get => string.IsNullOrEmpty(Name) ? null : gsmnv::NotificationSubscriptionHealthMetricsName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class NotificationSubscriptionHealthMetrics
    {
        /// <summary>
        /// <see cref="gsmnv::NotificationSubscriptionHealthMetricsName"/>-typed view over the <see cref="Name"/>
        /// resource name property.
