...
namespace Google.Shopping.Merchant.Notifications.V1
{
    ...
    public sealed partial class NotificationsApiServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private NotificationsApiServiceSettings(NotificationsApiServiceSettings existing) : base(existing)
        {
            ...
            GetNotificationSubscriptionHealthMetricsSettings = existing.GetNotificationSubscriptionHealthMetricsSettings;
            OnCopy(existing);
        }
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>NotificationsApiServiceClient.GetNotificationSubscriptionHealthMetrics</c> and
        /// <c>NotificationsApiServiceClient.GetNotificationSubscriptionHealthMetricsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 1000 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetNotificationSubscriptionHealthMetricsSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 5, initialBackoff: sys::TimeSpan.FromMilliseconds(1000), maxBackoff: sys::TimeSpan.FromMilliseconds(10000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable)));
    ...
    public abstract partial class NotificationsApiServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual NotificationSubscriptionHealthMetrics GetNotificationSubscriptionHealthMetrics(GetNotificationSubscriptionHealthMetricsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<NotificationSubscriptionHealthMetrics> GetNotificationSubscriptionHealthMetricsAsync(GetNotificationSubscriptionHealthMetricsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<NotificationSubscriptionHealthMetrics> GetNotificationSubscriptionHealthMetricsAsync(GetNotificationSubscriptionHealthMetricsRequest request, st::CancellationToken cancellationToken) =>
            GetNotificationSubscriptionHealthMetricsAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual NotificationSubscriptionHealthMetrics GetNotificationSubscriptionHealthMetrics(string name, gaxgrpc::CallSettings callSettings = null) =>
            GetNotificationSubscriptionHealthMetrics(new GetNotificationSubscriptionHealthMetricsRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<NotificationSubscriptionHealthMetrics> GetNotificationSubscriptionHealthMetricsAsync(string name, gaxgrpc::CallSettings callSettings = null) =>
            GetNotificationSubscriptionHealthMetricsAsync(new GetNotificationSubscriptionHealthMetricsRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<NotificationSubscriptionHealthMetrics> GetNotificationSubscriptionHealthMetricsAsync(string name, st::CancellationToken cancellationToken) =>
            GetNotificationSubscriptionHealthMetricsAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual NotificationSubscriptionHealthMetrics GetNotificationSubscriptionHealthMetrics(NotificationSubscriptionHealthMetricsName name, gaxgrpc::CallSettings callSettings = null) =>
            GetNotificationSubscriptionHealthMetrics(new GetNotificationSubscriptionHealthMetricsRequest
            {
                NotificationSubscriptionHealthMetricsName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<NotificationSubscriptionHealthMetrics> GetNotificationSubscriptionHealthMetricsAsync(NotificationSubscriptionHealthMetricsName name, gaxgrpc::CallSettings callSettings = null) =>
            GetNotificationSubscriptionHealthMetricsAsync(new GetNotificationSubscriptionHealthMetricsRequest
            {
                NotificationSubscriptionHealthMetricsName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<NotificationSubscriptionHealthMetrics> GetNotificationSubscriptionHealthMetricsAsync(NotificationSubscriptionHealthMetricsName name, st::CancellationToken cancellationToken) =>
            GetNotificationSubscriptionHealthMetricsAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
    ...
    public sealed partial class NotificationsApiServiceClientImpl : NotificationsApiServiceClient
    {
        ...
        private readonly gaxgrpc::ApiCall<GetNotificationSubscriptionHealthMetricsRequest, NotificationSubscriptionHealthMetrics> _callGetNotificationSubscriptionHealthMetrics;
        ...
        public NotificationsApiServiceClientImpl(NotificationsApiService.NotificationsApiServiceClient grpcClient, NotificationsApiServiceSettings settings, mel::ILogger logger)
        {
            ...
            _callGetNotificationSubscriptionHealthMetrics = clientHelper.BuildApiCall<GetNotificationSubscriptionHealthMetricsRequest, NotificationSubscriptionHealthMetrics>("GetNotificationSubscriptionHealthMetrics", grpcClient.GetNotificationSubscriptionHealthMetricsAsync, grpcClient.GetNotificationSubscriptionHealthMetrics, effectiveSettings.GetNotificationSubscriptionHealthMetricsSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetNotificationSubscriptionHealthMetrics);
            Modify_GetNotificationSubscriptionHealthMetricsApiCall(ref _callGetNotificationSubscriptionHealthMetrics);
        ...
        partial void Modify_GetNotificationSubscriptionHealthMetricsApiCall(ref gaxgrpc::ApiCall<GetNotificationSubscriptionHealthMetricsRequest, NotificationSubscriptionHealthMetrics> call);
        ...
        partial void Modify_GetNotificationSubscriptionHealthMetricsRequest(ref GetNotificationSubscriptionHealthMetricsRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override NotificationSubscriptionHealthMetrics GetNotificationSubscriptionHealthMetrics(GetNotificationSubscriptionHealthMetricsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetNotificationSubscriptionHealthMetricsRequest(ref request, ref callSettings);
            return _callGetNotificationSubscriptionHealthMetrics.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<NotificationSubscriptionHealthMetrics> GetNotificationSubscriptionHealthMetricsAsync(GetNotificationSubscriptionHealthMetricsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetNotificationSubscriptionHealthMetricsRequest(ref request, ref callSettings);
            return _callGetNotificationSubscriptionHealthMetrics.Async(request, callSettings);
        }
    }
