...
namespace GoogleCSharpSnippets
{
    ...
    using Google.Shopping.Merchant.Notifications.V1;
    using System;
    using System.Linq;
    ...
    public sealed class AllGeneratedNotificationsApiServiceClientSnippets
    {
        ...
        /// <summary>Snippet for GetNotificationSubscriptionHealthMetrics</summary>
        public void GetNotificationSubscriptionHealthMetricsRequestObject()
        {
            // Snippet: GetNotificationSubscriptionHealthMetrics(GetNotificationSubscriptionHealthMetricsRequest, CallSettings)
            // Create client
            NotificationsApiServiceClient notificationsApiServiceClient = NotificationsApiServiceClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for GetNotificationSubscriptionHealthMetricsAsync</summary>
        public async Task GetNotificationSubscriptionHealthMetricsRequestObjectAsync()
        {
            // Snippet: GetNotificationSubscriptionHealthMetricsAsync(GetNotificationSubscriptionHealthMetricsRequest, CallSettings)
            // Additional: GetNotificationSubscriptionHealthMetricsAsync(GetNotificationSubscriptionHealthMetricsRequest, CancellationToken)
            // Create client
            NotificationsApiServiceClient notificationsApiServiceClient = await NotificationsApiServiceClient.CreateAsync();
            // Initialize request argument(s)
            GetNotificationSubscriptionHealthMetricsRequest request = new GetNotificationSubscriptionHealthMetricsRequest
        ...
        /// <summary>Snippet for GetNotificationSubscriptionHealthMetrics</summary>
        public void GetNotificationSubscriptionHealthMetrics()
        {
            // Snippet: GetNotificationSubscriptionHealthMetrics(string, CallSettings)
            // Create client
            NotificationsApiServiceClient notificationsApiServiceClient = NotificationsApiServiceClient.Create();
            // Initialize request argument(s)
            string name = "accounts/[ACCOUNT]/notificationsubscriptions/[NOTIFICATION_SUBSCRIPTION]";
        ...
        /// <summary>Snippet for GetNotificationSubscriptionHealthMetricsAsync</summary>
        public async Task GetNotificationSubscriptionHealthMetricsAsync()
        {
            // Snippet: GetNotificationSubscriptionHealthMetricsAsync(string, CallSettings)
            // Additional: GetNotificationSubscriptionHealthMetricsAsync(string, CancellationToken)
            // Create client
            NotificationsApiServiceClient notificationsApiServiceClient = await NotificationsApiServiceClient.CreateAsync();
            // Initialize request argument(s)
            string name = "accounts/[ACCOUNT]/notificationsubscriptions/[NOTIFICATION_SUBSCRIPTION]";
        ...
        /// <summary>Snippet for GetNotificationSubscriptionHealthMetrics</summary>
        public void GetNotificationSubscriptionHealthMetricsResourceNames()
        {
            // Snippet: GetNotificationSubscriptionHealthMetrics(NotificationSubscriptionHealthMetricsName, CallSettings)
            // Create client
            NotificationsApiServiceClient notificationsApiServiceClient = NotificationsApiServiceClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for GetNotificationSubscriptionHealthMetricsAsync</summary>
        public async Task GetNotificationSubscriptionHealthMetricsResourceNamesAsync()
        {
            // Snippet: GetNotificationSubscriptionHealthMetricsAsync(NotificationSubscriptionHealthMetricsName, CallSettings)
            // Additional: GetNotificationSubscriptionHealthMetricsAsync(NotificationSubscriptionHealthMetricsName, CancellationToken)
            // Create client
            NotificationsApiServiceClient notificationsApiServiceClient = await NotificationsApiServiceClient.CreateAsync();
            // Initialize request argument(s)
            NotificationSubscriptionHealthMetricsName name = NotificationSubscriptionHealthMetricsName.FromAccountNotificationSubscription("[ACCOUNT]", "[NOTIFICATION_SUBSCRIPTION]");
