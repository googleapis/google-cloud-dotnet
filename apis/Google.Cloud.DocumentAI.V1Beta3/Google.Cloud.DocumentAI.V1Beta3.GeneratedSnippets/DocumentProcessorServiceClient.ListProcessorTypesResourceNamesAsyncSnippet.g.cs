...
{
    // [START documentai_v1beta3_generated_DocumentProcessorService_ListProcessorTypes_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDocumentProcessorServiceClientSnippets
    {
        ...
        public async Task ListProcessorTypesResourceNamesAsync()
        {
            ...
            await foreach (ProcessorType item in response)
            {
            ...
            await foreach (ListProcessorTypesResponse page in response.AsRawResponses())
            {
    ...
    // [END documentai_v1beta3_generated_DocumentProcessorService_ListProcessorTypes_async_flattened_resourceNames]
}
