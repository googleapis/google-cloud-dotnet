...
{
    // [START documentai_v1beta3_generated_DocumentProcessorService_ListProcessorVersions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDocumentProcessorServiceClientSnippets
    {
        ...
        public async Task ListProcessorVersionsResourceNamesAsync()
        {
            ...
            await foreach (ProcessorVersion item in response)
            {
            ...
            await foreach (ListProcessorVersionsResponse page in response.AsRawResponses())
            {
    ...
    // [END documentai_v1beta3_generated_DocumentProcessorService_ListProcessorVersions_async_flattened_resourceNames]
}
