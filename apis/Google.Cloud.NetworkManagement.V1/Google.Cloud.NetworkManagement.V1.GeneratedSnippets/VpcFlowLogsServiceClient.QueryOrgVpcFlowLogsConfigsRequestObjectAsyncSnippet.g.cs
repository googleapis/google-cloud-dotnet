...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedVpcFlowLogsServiceClientSnippets
    {
        ...
        public async Task QueryOrgVpcFlowLogsConfigsRequestObjectAsync()
        {
            ...
            await foreach (QueryOrgVpcFlowLogsConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkmanagement_v1_generated_VpcFlowLogsService_QueryOrgVpcFlowLogsConfigs_async]
}
