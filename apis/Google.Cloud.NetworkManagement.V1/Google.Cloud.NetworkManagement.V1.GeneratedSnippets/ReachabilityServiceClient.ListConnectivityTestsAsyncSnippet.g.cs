...
{
    // [START networkmanagement_v1_generated_ReachabilityService_ListConnectivityTests_async_flattened]
    ...
    public sealed partial class GeneratedReachabilityServiceClientSnippets
    {
        ...
        public async Task ListConnectivityTestsAsync()
        {
            ...
            await foreach (ConnectivityTest item in response)
            {
            ...
            await foreach (ListConnectivityTestsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkmanagement_v1_generated_ReachabilityService_ListConnectivityTests_async_flattened]
}
