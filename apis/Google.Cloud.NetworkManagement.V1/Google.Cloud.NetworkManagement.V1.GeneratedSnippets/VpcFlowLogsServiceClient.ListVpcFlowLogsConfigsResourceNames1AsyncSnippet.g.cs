...
{
    // [START networkmanagement_v1_generated_VpcFlowLogsService_ListVpcFlowLogsConfigs_async_flattened_resourceNames1]
    ...
    public sealed partial class GeneratedVpcFlowLogsServiceClientSnippets
    {
        ...
        public async Task ListVpcFlowLogsConfigsResourceNames1Async()
        {
            ...
            await foreach (VpcFlowLogsConfig item in response)
            {
            ...
            await foreach (ListVpcFlowLogsConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkmanagement_v1_generated_VpcFlowLogsService_ListVpcFlowLogsConfigs_async_flattened_resourceNames1]
}
