...
namespace Google.Cloud.NetworkManagement.V1
{
    ...
    public sealed partial class VpcFlowLogsConfigName : gax::IResourceName, sys::IEquatable<VpcFlowLogsConfigName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>organizations/{organization}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}</c>.
            /// </summary>
            OrganizationLocationVpcFlowLogsConfig = 2,
        }
        ...
        private static gax::PathTemplate s_organizationLocationVpcFlowLogsConfig = new gax::PathTemplate("organizations/{organization}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}");
        ...
        /// <param name="vpcFlowLogsConfigId">The <c>VpcFlowLogsConfig</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="VpcFlowLogsConfigName"/> constructed from the provided ids.</returns>
        public static VpcFlowLogsConfigName FromOrganizationLocationVpcFlowLogsConfig(string organizationId, string locationId, string vpcFlowLogsConfigId) =>
            new VpcFlowLogsConfigName(ResourceNameType.OrganizationLocationVpcFlowLogsConfig, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), vpcFlowLogsConfigId: gax::GaxPreconditions.CheckNotNullOrEmpty(vpcFlowLogsConfigId, nameof(vpcFlowLogsConfigId)));
        ...
        /// <c>organizations/{organization}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}</c>.
        /// </returns>
        public static string FormatOrganizationLocationVpcFlowLogsConfig(string organizationId, string locationId, string vpcFlowLogsConfigId) =>
            s_organizationLocationVpcFlowLogsConfig.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(vpcFlowLogsConfigId, nameof(vpcFlowLogsConfigId)));
        ...
        public static bool TryParse(string vpcFlowLogsConfigName, bool allowUnparsed, out VpcFlowLogsConfigName result)
        {
            ...
            if (s_organizationLocationVpcFlowLogsConfig.TryParseName(vpcFlowLogsConfigName, out resourceName))
            {
                result = FromOrganizationLocationVpcFlowLogsConfig(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private VpcFlowLogsConfigName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string organizationId = null, string projectId = null, string vpcFlowLogsConfigId = null)
        {
            Type = type;
        ...
        /// <summary>
        /// The <c>VpcFlowLogsConfig</c> ID. May be <c>null</c>, depending on which resource name is contained by this
        /// instance.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.OrganizationLocationVpcFlowLogsConfig: return s_organizationLocationVpcFlowLogsConfig.Expand(OrganizationId, LocationId, VpcFlowLogsConfigId);
