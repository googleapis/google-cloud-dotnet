...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds a singleton <see cref="gcav::DataFoundryServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        ...
        /// </param>
        public static IServiceCollection AddDataFoundryServiceClient(this IServiceCollection services, sys::Action<gcav::DataFoundryServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::DataFoundryServiceClientBuilder builder = new gcav::DataFoundryServiceClientBuilder();
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddDataFoundryServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::DataFoundryServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::DataFoundryServiceClientBuilder builder = new gcav::DataFoundryServiceClientBuilder();
        ...
        /// <summary>Adds a singleton <see cref="gcav::SessionServiceClient"/> to <paramref name="services"/>.</summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        /// <param name="action">
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddSessionServiceClient(this IServiceCollection services, sys::Action<gcav::SessionServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::SessionServiceClientBuilder builder = new gcav::SessionServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddSessionServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::SessionServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::SessionServiceClientBuilder builder = new gcav::SessionServiceClientBuilder();
                action?.Invoke(provider, builder);
