...
namespace Google.Cloud.AIPlatform.V1
{
    ...
    public sealed partial class ScheduleName : gax::IResourceName, sys::IEquatable<ScheduleName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/schedules/{schedule}</c>.
            /// </summary>
            ProjectLocationSchedule = 1,
        }

        private static gax::PathTemplate s_projectLocationSchedule = new gax::PathTemplate("projects/{project}/locations/{location}/schedules/{schedule}");
        ...
        /// <c>projects/{project}/locations/{location}/schedules/{schedule}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description><c>projects/{project}/locations/{location}/schedules/{schedule}</c></description></item>
        /// </list>
        /// </remarks>
    ...
    {
        /// <summary>
        /// <see cref="gcav::ScheduleName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcav::ScheduleName ScheduleName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcav::ScheduleName.Parse(Name, allowUnparsed: true);
