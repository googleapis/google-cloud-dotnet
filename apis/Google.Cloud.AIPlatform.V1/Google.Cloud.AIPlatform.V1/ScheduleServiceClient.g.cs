...
namespace Google.Cloud.AIPlatform.V1
{
    ...
    public sealed partial class ScheduleServiceClientBuilder : gaxgrpc::ClientBuilderBase<ScheduleServiceClient>
    {
        ...
        private ScheduleServiceClient BuildImpl()
        {
            ...
            return ScheduleServiceClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ScheduleServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ScheduleService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
