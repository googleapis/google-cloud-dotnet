...
{
    // [START aiplatform_v1_generated_DatasetService_ListDatasetVersions_async_flattened]
    ...
    public sealed partial class GeneratedDatasetServiceClientSnippets
    {
        ...
        public async Task ListDatasetVersionsAsync()
        {
            ...
            await foreach (DatasetVersion item in response)
            {
            ...
            await foreach (ListDatasetVersionsResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1_generated_DatasetService_ListDatasetVersions_async_flattened]
}
