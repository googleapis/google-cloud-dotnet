...
{
    // [START aiplatform_v1_generated_IndexService_CreateIndex_async_flattened]
    ...
    public sealed partial class GeneratedIndexServiceClientSnippets
    {
        ...
        public async Task CreateIndexAsync()
        {
            ...
            Operation<Index, CreateIndexOperationMetadata> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<Index, CreateIndexOperationMetadata> retrievedResponse = await indexServiceClient.PollOnceCreateIndexAsync(operationName);
    ...
    // [END aiplatform_v1_generated_IndexService_CreateIndex_async_flattened]
}
