...
{
    // [START aiplatform_v1_generated_MigrationService_SearchMigratableResources_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedMigrationServiceClientSnippets
    {
        ...
        public async Task SearchMigratableResourcesResourceNamesAsync()
        {
            ...
            await foreach (MigratableResource item in response)
            {
            ...
            await foreach (SearchMigratableResourcesResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1_generated_MigrationService_SearchMigratableResources_async_flattened_resourceNames]
}
