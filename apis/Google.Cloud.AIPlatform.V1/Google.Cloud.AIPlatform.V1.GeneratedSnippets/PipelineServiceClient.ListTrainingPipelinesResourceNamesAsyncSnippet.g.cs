...
{
    // [START aiplatform_v1_generated_PipelineService_ListTrainingPipelines_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedPipelineServiceClientSnippets
    {
        ...
        public async Task ListTrainingPipelinesResourceNamesAsync()
        {
            ...
            await foreach (TrainingPipeline item in response)
            {
            ...
            await foreach (ListTrainingPipelinesResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1_generated_PipelineService_ListTrainingPipelines_async_flattened_resourceNames]
}
