...
{
    // [START aiplatform_v1_generated_IndexService_UpdateIndex_async_flattened]
    ...
    public sealed partial class GeneratedIndexServiceClientSnippets
    {
        ...
        public async Task UpdateIndexAsync()
        {
            ...
            // Make the request
            Operation<Index, UpdateIndexOperationMetadata> response = await indexServiceClient.UpdateIndexAsync(index, updateMask);
    ...
    // [END aiplatform_v1_generated_IndexService_UpdateIndex_async_flattened]
}
