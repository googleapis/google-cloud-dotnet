...
{
    // [START aiplatform_v1_generated_SessionService_ListEvents_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSessionServiceClientSnippets
    {
        ...
        public async Task ListEventsResourceNamesAsync()
        {
            ...
            await foreach (SessionEvent item in response)
            {
    ...
    // [END aiplatform_v1_generated_SessionService_ListEvents_async_flattened_resourceNames]
}
