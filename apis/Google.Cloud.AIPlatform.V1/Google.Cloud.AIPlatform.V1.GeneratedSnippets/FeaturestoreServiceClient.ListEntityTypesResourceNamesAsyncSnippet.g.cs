...
{
    // [START aiplatform_v1_generated_FeaturestoreService_ListEntityTypes_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedFeaturestoreServiceClientSnippets
    {
        ...
        public async Task ListEntityTypesResourceNamesAsync()
        {
            ...
            await foreach (EntityType item in response)
            {
            ...
            await foreach (ListEntityTypesResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1_generated_FeaturestoreService_ListEntityTypes_async_flattened_resourceNames]
}
