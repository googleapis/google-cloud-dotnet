...
{
    // [START chronicle_v1_generated_ReferenceListService_ListReferenceLists_async_flattened]
    ...
    public sealed partial class GeneratedReferenceListServiceClientSnippets
    {
        ...
        public async Task ListReferenceListsAsync()
        {
            ...
            await foreach (ReferenceList item in response)
            {
            ...
            await foreach (ListReferenceListsResponse page in response.AsRawResponses())
            {
    ...
    // [END chronicle_v1_generated_ReferenceListService_ListReferenceLists_async_flattened]
}
