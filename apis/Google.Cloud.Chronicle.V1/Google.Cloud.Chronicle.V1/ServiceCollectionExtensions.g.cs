...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds a singleton <see cref="gccv::BigQueryExportServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        ...
        /// </param>
        public static IServiceCollection AddBigQueryExportServiceClient(this IServiceCollection services, sys::Action<gccv::BigQueryExportServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gccv::BigQueryExportServiceClientBuilder builder = new gccv::BigQueryExportServiceClientBuilder();
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddBigQueryExportServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gccv::BigQueryExportServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gccv::BigQueryExportServiceClientBuilder builder = new gccv::BigQueryExportServiceClientBuilder();
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddDataAccessControlServiceClient(this IServiceCollection services, sys::Action<gccv::DataAccessControlServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gccv::DataAccessControlServiceClientBuilder builder = new gccv::DataAccessControlServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddDataAccessControlServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gccv::DataAccessControlServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gccv::DataAccessControlServiceClientBuilder builder = new gccv::DataAccessControlServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddEntityServiceClient(this IServiceCollection services, sys::Action<gccv::EntityServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gccv::EntityServiceClientBuilder builder = new gccv::EntityServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddEntityServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gccv::EntityServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gccv::EntityServiceClientBuilder builder = new gccv::EntityServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>Adds a singleton <see cref="gccv::FeedsServiceClient"/> to <paramref name="services"/>.</summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        /// <param name="action">
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddFeedsServiceClient(this IServiceCollection services, sys::Action<gccv::FeedsServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gccv::FeedsServiceClientBuilder builder = new gccv::FeedsServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddFeedsServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gccv::FeedsServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gccv::FeedsServiceClientBuilder builder = new gccv::FeedsServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gccv::FindingsRefinementServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddFindingsRefinementServiceClient(this IServiceCollection services, sys::Action<gccv::FindingsRefinementServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gccv::FindingsRefinementServiceClientBuilder builder = new gccv::FindingsRefinementServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddFindingsRefinementServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gccv::FindingsRefinementServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gccv::FindingsRefinementServiceClientBuilder builder = new gccv::FindingsRefinementServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddInstanceServiceClient(this IServiceCollection services, sys::Action<gccv::InstanceServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddInstanceServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gccv::InstanceServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gccv::InstanceServiceClientBuilder builder = new gccv::InstanceServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gccv::ReferenceListServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddReferenceListServiceClient(this IServiceCollection services, sys::Action<gccv::ReferenceListServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gccv::ReferenceListServiceClientBuilder builder = new gccv::ReferenceListServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddReferenceListServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gccv::ReferenceListServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gccv::ReferenceListServiceClientBuilder builder = new gccv::ReferenceListServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddRuleServiceClient(this IServiceCollection services, sys::Action<gccv::RuleServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gccv::RuleServiceClientBuilder builder = new gccv::RuleServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddRuleServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gccv::RuleServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gccv::RuleServiceClientBuilder builder = new gccv::RuleServiceClientBuilder();
                action?.Invoke(provider, builder);
