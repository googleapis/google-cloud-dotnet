...
namespace Google.Cloud.Chronicle.V1
{
    ...
    public sealed partial class BigQueryExportName : gax::IResourceName, sys::IEquatable<BigQueryExportName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/instances/{instance}/bigQueryExport</c>.
            /// </summary>
            ProjectLocationInstance = 1,
        }

        private static gax::PathTemplate s_projectLocationInstance = new gax::PathTemplate("projects/{project}/locations/{location}/instances/{instance}/bigQueryExport");
        ...
        public static BigQueryExportName FromProjectLocationInstance(string projectId, string locationId, string instanceId) =>
            new BigQueryExportName(ResourceNameType.ProjectLocationInstance, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), instanceId: gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)));
        ...
        public static bool TryParse(string bigQueryExportName, bool allowUnparsed, out BigQueryExportName result)
        {
            ...
            if (s_projectLocationInstance.TryParseName(bigQueryExportName, out resourceName))
            {
        ...
        private BigQueryExportName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string instanceId = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="instanceId">The <c>Instance</c> ID. Must not be <c>null</c> or empty.</param>
        public BigQueryExportName(string projectId, string locationId, string instanceId) : this(ResourceNameType.ProjectLocationInstance, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), instanceId: gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)))
        {
        }
    ...
    {
        /// <summary>
        /// <see cref="gccv::BigQueryExportName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::BigQueryExportName BigQueryExportName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::BigQueryExportName.Parse(Name, allowUnparsed: true);
    ...
    public partial class ProvisionBigQueryExportRequest
    {
        /// <summary>
