...
{
    // [START fleetengine_v1_generated_DeliveryService_DeleteTask_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDeliveryServiceClientSnippets
    {
        ...
        public void DeleteTaskResourceNames()
        {
            ...
            TaskName name = TaskName.FromProviderTask("[PROVIDER]", "[TASK]");
            // Make the request
            deliveryServiceClient.DeleteTask(name);
        }
    }
    // [END fleetengine_v1_generated_DeliveryService_DeleteTask_sync_flattened_resourceNames]
}
