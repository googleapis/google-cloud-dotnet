...
{
    // [START fleetengine_v1_generated_DeliveryService_UpdateDeliveryVehicle_sync_flattened]
    ...
    public sealed partial class GeneratedDeliveryServiceClientSnippets
    {
        ...
        public void UpdateDeliveryVehicle()
        {
            ...
            // Make the request
            DeliveryVehicle response = deliveryServiceClient.UpdateDeliveryVehicle(deliveryVehicle, updateMask);
        }
    }
    // [END fleetengine_v1_generated_DeliveryService_UpdateDeliveryVehicle_sync_flattened]
}
