...
{
    // [START webrisk_v1_generated_WebRiskService_SubmitUri_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWebRiskServiceClientSnippets
    {
        ...
        /// </remarks>
        public void SubmitUriResourceNames()
        {
            // Create client
            ...
            // Make the request
            Operation<Submission, SubmitUriMetadata> response = webRiskServiceClient.SubmitUri(parent, submission);
    ...
    // [END webrisk_v1_generated_WebRiskService_SubmitUri_sync_flattened_resourceNames]
}
