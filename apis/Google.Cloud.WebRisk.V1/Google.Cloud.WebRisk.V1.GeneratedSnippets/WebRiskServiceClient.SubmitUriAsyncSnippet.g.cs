...
{
    // [START webrisk_v1_generated_WebRiskService_SubmitUri_async_flattened]
    ...
    public sealed partial class GeneratedWebRiskServiceClientSnippets
    {
        ...
        /// </remarks>
        public async Task SubmitUriAsync()
        {
            // Create client
            ...
            // Make the request
            Operation<Submission, SubmitUriMetadata> response = await webRiskServiceClient.SubmitUriAsync(parent, submission);
    ...
    // [END webrisk_v1_generated_WebRiskService_SubmitUri_async_flattened]
}
