...
namespace Google.Cloud.WebRisk.V1
{
    ...
    public sealed partial class WebRiskServiceClientBuilder : gaxgrpc::ClientBuilderBase<WebRiskServiceClient>
    {
        ...
        private WebRiskServiceClient BuildImpl()
        {
            ...
            return WebRiskServiceClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class WebRiskServiceClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(WebRiskService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
