...
namespace Google.Cloud.Tasks.V2 {
    ...
    static TaskReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "dGltZRgFIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXASNAoRZGlz",
            "cGF0Y2hfZGVhZGxpbmUYBiABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRp",
            "b24SFgoOZGlzcGF0Y2hfY291bnQYByABKAUSFgoOcmVzcG9uc2VfY291bnQY",
            "CCABKAUSNQoNZmlyc3RfYXR0ZW1wdBgJIAEoCzIeLmdvb2dsZS5jbG91ZC50",
  ...
  public sealed partial class Task : pb::IMessage<Task> {
    ...
    private global::Google.Cloud.Tasks.V2.Task.Types.View view_ = 0;
    /// <summary>
    ...
    public void MergeFrom(Task other) {
      ...
      if (other.firstAttempt_ != null) {
        if (firstAttempt_ == null) {
          firstAttempt_ = new global::Google.Cloud.Tasks.V2.Attempt();
        }
        FirstAttempt.MergeFrom(other.FirstAttempt);
      }
      if (other.lastAttempt_ != null) {
        if (lastAttempt_ == null) {
          lastAttempt_ = new global::Google.Cloud.Tasks.V2.Attempt();
        }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 88: {
            view_ = (global::Google.Cloud.Tasks.V2.Task.Types.View) input.ReadEnum();
            break;
          }
        }
      }
