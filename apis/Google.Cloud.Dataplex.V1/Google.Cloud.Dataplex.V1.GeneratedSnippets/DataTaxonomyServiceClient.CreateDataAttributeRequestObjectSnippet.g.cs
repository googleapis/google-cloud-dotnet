...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedDataTaxonomyServiceClientSnippets
    {
        ...
        public void CreateDataAttributeRequestObject()
        {
            ...
            CreateDataAttributeRequest request = new CreateDataAttributeRequest
            {
                ParentAsDataTaxonomyName = DataTaxonomyName.FromProjectLocationDataTaxonomy("[PROJECT]", "[LOCATION]", "[DATA_TAXONOMY_ID]"),
                DataAttributeId = "",
...
#pragma warning restore CS0612
            ...
            // Make the request
#pragma warning disable CS0612
            Operation<DataAttribute, OperationMetadata> response = dataTaxonomyServiceClient.CreateDataAttribute(request);
#pragma warning restore CS0612
