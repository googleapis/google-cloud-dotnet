...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedDataplexServiceClientSnippets
    {
        ...
        public void UpdateEnvironmentRequestObject()
        {
            ...
            // Make the request
            Operation<Environment, OperationMetadata> response = dataplexServiceClient.UpdateEnvironment(request);
            ...
            Operation<Environment, OperationMetadata> retrievedResponse = dataplexServiceClient.PollOnceUpdateEnvironment(operationName);
