...
{
    // [START dataplex_v1_generated_BusinessGlossaryService_UpdateGlossary_sync_flattened]
    ...
    public sealed partial class GeneratedBusinessGlossaryServiceClientSnippets
    {
        ...
        public void UpdateGlossary()
        {
            ...
            // Make the request
            Operation<Glossary, OperationMetadata> response = businessGlossaryServiceClient.UpdateGlossary(glossary, updateMask);
            ...
            Operation<Glossary, OperationMetadata> retrievedResponse = businessGlossaryServiceClient.PollOnceUpdateGlossary(operationName);
    ...
    // [END dataplex_v1_generated_BusinessGlossaryService_UpdateGlossary_sync_flattened]
}
