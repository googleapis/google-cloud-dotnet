...
{
    // [START dataplex_v1_generated_DataplexService_CreateEnvironment_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataplexServiceClientSnippets
    {
        ...
        public async Task CreateEnvironmentResourceNamesAsync()
        {
            ...
            // Make the request
            Operation<Environment, OperationMetadata> response = await dataplexServiceClient.CreateEnvironmentAsync(parent, environment, environmentId);
    ...
    // [END dataplex_v1_generated_DataplexService_CreateEnvironment_async_flattened_resourceNames]
}
