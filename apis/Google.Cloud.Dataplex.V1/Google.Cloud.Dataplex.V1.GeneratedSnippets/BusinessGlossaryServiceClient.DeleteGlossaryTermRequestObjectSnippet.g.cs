...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedBusinessGlossaryServiceClientSnippets
    {
        ...
        public void DeleteGlossaryTermRequestObject()
        {
            ...
            DeleteGlossaryTermRequest request = new DeleteGlossaryTermRequest
            {
                GlossaryTermName = GlossaryTermName.FromProjectLocationGlossaryGlossaryTerm("[PROJECT]", "[LOCATION]", "[GLOSSARY]", "[GLOSSARY_TERM]"),
            };
            // Make the request
