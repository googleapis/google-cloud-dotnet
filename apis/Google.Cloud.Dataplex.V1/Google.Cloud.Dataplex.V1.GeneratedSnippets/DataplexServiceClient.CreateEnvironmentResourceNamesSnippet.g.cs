...
{
    // [START dataplex_v1_generated_DataplexService_CreateEnvironment_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataplexServiceClientSnippets
    {
        ...
        public void CreateEnvironmentResourceNames()
        {
            ...
            // Make the request
            Operation<Environment, OperationMetadata> response = dataplexServiceClient.CreateEnvironment(parent, environment, environmentId);
            ...
            Operation<Environment, OperationMetadata> retrievedResponse = dataplexServiceClient.PollOnceCreateEnvironment(operationName);
    ...
    // [END dataplex_v1_generated_DataplexService_CreateEnvironment_sync_flattened_resourceNames]
}
