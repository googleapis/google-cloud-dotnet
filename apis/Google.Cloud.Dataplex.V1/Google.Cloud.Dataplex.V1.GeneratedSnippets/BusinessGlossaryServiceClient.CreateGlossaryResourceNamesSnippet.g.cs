...
{
    // [START dataplex_v1_generated_BusinessGlossaryService_CreateGlossary_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBusinessGlossaryServiceClientSnippets
    {
        ...
        public void CreateGlossaryResourceNames()
        {
            ...
            string glossaryId = "";
            // Make the request
            Operation<Glossary, OperationMetadata> response = businessGlossaryServiceClient.CreateGlossary(parent, glossary, glossaryId);
    ...
    // [END dataplex_v1_generated_BusinessGlossaryService_CreateGlossary_sync_flattened_resourceNames]
}
