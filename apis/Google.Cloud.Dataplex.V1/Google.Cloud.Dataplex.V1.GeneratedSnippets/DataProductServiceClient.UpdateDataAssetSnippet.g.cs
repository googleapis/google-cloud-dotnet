...
{
    // [START dataplex_v1_generated_DataProductService_UpdateDataAsset_sync_flattened]
    ...
    public sealed partial class GeneratedDataProductServiceClientSnippets
    {
        ...
        public void UpdateDataAsset()
        {
            ...
            // Make the request
            Operation<DataAsset, OperationMetadata> response = dataProductServiceClient.UpdateDataAsset(dataAsset, updateMask);
    ...
    // [END dataplex_v1_generated_DataProductService_UpdateDataAsset_sync_flattened]
}
