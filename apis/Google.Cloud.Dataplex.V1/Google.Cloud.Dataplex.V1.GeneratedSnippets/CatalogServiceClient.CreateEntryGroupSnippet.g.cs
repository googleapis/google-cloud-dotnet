...
{
    // [START dataplex_v1_generated_CatalogService_CreateEntryGroup_sync_flattened]
    ...
    public sealed partial class GeneratedCatalogServiceClientSnippets
    {
        ...
        public void CreateEntryGroup()
        {
            ...
            string entryGroupId = "";
            // Make the request
            Operation<EntryGroup, OperationMetadata> response = catalogServiceClient.CreateEntryGroup(parent, entryGroup, entryGroupId);
    ...
    // [END dataplex_v1_generated_CatalogService_CreateEntryGroup_sync_flattened]
}
