...
{
    // [START dataplex_v1_generated_BusinessGlossaryService_DeleteGlossaryCategory_sync]
    ...
    public sealed partial class GeneratedBusinessGlossaryServiceClientSnippets
    {
        ...
        public void DeleteGlossaryCategoryRequestObject()
        {
            ...
            DeleteGlossaryCategoryRequest request = new DeleteGlossaryCategoryRequest
            {
                GlossaryCategoryName = GlossaryCategoryName.FromProjectLocationGlossaryGlossaryCategory("[PROJECT]", "[LOCATION]", "[GLOSSARY]", "[GLOSSARY_CATEGORY]"),
            };
            // Make the request
