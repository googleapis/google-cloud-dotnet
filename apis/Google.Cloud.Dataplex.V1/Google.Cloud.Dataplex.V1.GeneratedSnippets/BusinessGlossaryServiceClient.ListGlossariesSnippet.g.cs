...
{
    // [START dataplex_v1_generated_BusinessGlossaryService_ListGlossaries_sync_flattened]
    ...
    public sealed partial class GeneratedBusinessGlossaryServiceClientSnippets
    {
        ...
        public void ListGlossaries()
        {
            ...
            // Make the request
            PagedEnumerable<ListGlossariesResponse, Glossary> response = businessGlossaryServiceClient.ListGlossaries(parent);
    ...
    // [END dataplex_v1_generated_BusinessGlossaryService_ListGlossaries_sync_flattened]
}
