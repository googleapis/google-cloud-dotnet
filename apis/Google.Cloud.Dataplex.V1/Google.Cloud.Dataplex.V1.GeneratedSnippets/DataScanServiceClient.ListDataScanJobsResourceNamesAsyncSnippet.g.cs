...
{
    // [START dataplex_v1_generated_DataScanService_ListDataScanJobs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataScanServiceClientSnippets
    {
        ...
        public async Task ListDataScanJobsResourceNamesAsync()
        {
            ...
            await foreach (gcdv::DataScanJob item in response)
            {
            ...
            await foreach (gcdv::ListDataScanJobsResponse page in response.AsRawResponses())
            {
    ...
    // [END dataplex_v1_generated_DataScanService_ListDataScanJobs_async_flattened_resourceNames]
}
