...
{
    // [START dataplex_v1_generated_DataScanService_ListDataScans_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataScanServiceClientSnippets
    {
        ...
        public async Task ListDataScansResourceNamesAsync()
        {
            ...
            await foreach (gcdv::DataScan item in response)
            {
            ...
            await foreach (gcdv::ListDataScansResponse page in response.AsRawResponses())
            {
    ...
    // [END dataplex_v1_generated_DataScanService_ListDataScans_async_flattened_resourceNames]
}
