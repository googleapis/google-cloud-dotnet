...
{
    // [START dataplex_v1_generated_ContentService_ListContent_async_flattened]
    ...
    public sealed partial class GeneratedContentServiceClientSnippets
    {
        ...
        public async Task ListContentAsync()
        {
            ...
            await foreach (gcdv::Content item in response)
            {
            ...
            await foreach (gcdv::ListContentResponse page in response.AsRawResponses())
            {
    ...
    // [END dataplex_v1_generated_ContentService_ListContent_async_flattened]
}
