...
{
    // [START dataplex_v1_generated_BusinessGlossaryService_CreateGlossaryTerm_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBusinessGlossaryServiceClientSnippets
    {
        ...
        public void CreateGlossaryTermResourceNames()
        {
            ...
            string termId = "";
            // Make the request
            GlossaryTerm response = businessGlossaryServiceClient.CreateGlossaryTerm(parent, term, termId);
        }
    }
    // [END dataplex_v1_generated_BusinessGlossaryService_CreateGlossaryTerm_sync_flattened_resourceNames]
}
