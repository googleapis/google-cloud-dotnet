...
{
    // [START dataplex_v1_generated_DataProductService_CreateDataAsset_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataProductServiceClientSnippets
    {
        ...
        public void CreateDataAssetResourceNames()
        {
            ...
            DataProductName parent = DataProductName.FromProjectLocationDataProduct("[PROJECT]", "[LOCATION]", "[DATA_PRODUCT]");
            DataAsset dataAsset = new DataAsset();
            string dataAssetId = "";
            // Make the request
            Operation<DataAsset, OperationMetadata> response = dataProductServiceClient.CreateDataAsset(parent, dataAsset, dataAssetId);
    ...
    // [END dataplex_v1_generated_DataProductService_CreateDataAsset_sync_flattened_resourceNames]
}
