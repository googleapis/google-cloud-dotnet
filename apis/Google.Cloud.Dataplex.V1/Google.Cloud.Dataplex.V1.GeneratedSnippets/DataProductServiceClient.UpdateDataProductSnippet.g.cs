...
{
    // [START dataplex_v1_generated_DataProductService_UpdateDataProduct_sync_flattened]
    ...
    public sealed partial class GeneratedDataProductServiceClientSnippets
    {
        ...
        public void UpdateDataProduct()
        {
            ...
            // Make the request
            Operation<DataProduct, OperationMetadata> response = dataProductServiceClient.UpdateDataProduct(dataProduct, updateMask);
    ...
    // [END dataplex_v1_generated_DataProductService_UpdateDataProduct_sync_flattened]
}
