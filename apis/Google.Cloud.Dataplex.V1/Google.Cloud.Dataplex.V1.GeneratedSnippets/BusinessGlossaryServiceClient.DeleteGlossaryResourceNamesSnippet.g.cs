...
{
    // [START dataplex_v1_generated_BusinessGlossaryService_DeleteGlossary_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBusinessGlossaryServiceClientSnippets
    {
        ...
        public void DeleteGlossaryResourceNames()
        {
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = businessGlossaryServiceClient.DeleteGlossary(name);
    ...
    // [END dataplex_v1_generated_BusinessGlossaryService_DeleteGlossary_sync_flattened_resourceNames]
}
