...
{
    // [START networkservices_v1_generated_NetworkServices_ListGatewayRouteViews_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListGatewayRouteViewsResourceNamesAsync()
        {
            ...
            await foreach (GatewayRouteView item in response)
            {
            ...
            await foreach (ListGatewayRouteViewsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListGatewayRouteViews_async_flattened_resourceNames]
}
