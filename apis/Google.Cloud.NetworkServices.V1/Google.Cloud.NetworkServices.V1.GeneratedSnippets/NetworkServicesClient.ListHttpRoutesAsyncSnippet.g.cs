...
{
    // [START networkservices_v1_generated_NetworkServices_ListHttpRoutes_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListHttpRoutesAsync()
        {
            ...
            await foreach (HttpRoute item in response)
            {
            ...
            await foreach (ListHttpRoutesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListHttpRoutes_async_flattened]
}
