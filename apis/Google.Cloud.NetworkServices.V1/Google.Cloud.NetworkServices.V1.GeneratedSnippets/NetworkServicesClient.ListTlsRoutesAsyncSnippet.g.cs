...
{
    // [START networkservices_v1_generated_NetworkServices_ListTlsRoutes_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListTlsRoutesAsync()
        {
            ...
            await foreach (TlsRoute item in response)
            {
            ...
            await foreach (ListTlsRoutesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListTlsRoutes_async_flattened]
}
