...
{
    // [START networkservices_v1_generated_NetworkServices_ListServiceBindings_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListServiceBindingsAsync()
        {
            ...
            await foreach (ServiceBinding item in response)
            {
            ...
            await foreach (ListServiceBindingsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListServiceBindings_async_flattened]
}
