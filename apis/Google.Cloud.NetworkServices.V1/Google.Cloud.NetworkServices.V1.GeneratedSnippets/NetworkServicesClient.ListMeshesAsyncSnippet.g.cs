...
{
    // [START networkservices_v1_generated_NetworkServices_ListMeshes_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListMeshesAsync()
        {
            ...
            await foreach (Mesh item in response)
            {
            ...
            await foreach (ListMeshesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListMeshes_async_flattened]
}
