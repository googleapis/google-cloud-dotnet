...
{
    // [START networkservices_v1_generated_DepService_ListLbEdgeExtensions_async_flattened]
    ...
    public sealed partial class GeneratedDepServiceClientSnippets
    {
        ...
        public async Task ListLbEdgeExtensionsAsync()
        {
            ...
            await foreach (LbEdgeExtension item in response)
            {
            ...
            await foreach (ListLbEdgeExtensionsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_DepService_ListLbEdgeExtensions_async_flattened]
}
