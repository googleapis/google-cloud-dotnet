...
{
    // [START networkservices_v1_generated_NetworkServices_ListMeshRouteViews_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListMeshRouteViewsAsync()
        {
            ...
            await foreach (MeshRouteView item in response)
            {
            ...
            await foreach (ListMeshRouteViewsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListMeshRouteViews_async_flattened]
}
