...
{
    // [START networkservices_v1_generated_NetworkServices_ListTcpRoutes_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListTcpRoutesAsync()
        {
            ...
            await foreach (TcpRoute item in response)
            {
            ...
            await foreach (ListTcpRoutesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListTcpRoutes_async_flattened]
}
