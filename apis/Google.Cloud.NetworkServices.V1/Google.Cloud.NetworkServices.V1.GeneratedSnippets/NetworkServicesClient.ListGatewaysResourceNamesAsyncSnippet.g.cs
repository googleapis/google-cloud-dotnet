...
{
    // [START networkservices_v1_generated_NetworkServices_ListGateways_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListGatewaysResourceNamesAsync()
        {
            ...
            await foreach (Gateway item in response)
            {
            ...
            await foreach (ListGatewaysResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListGateways_async_flattened_resourceNames]
}
