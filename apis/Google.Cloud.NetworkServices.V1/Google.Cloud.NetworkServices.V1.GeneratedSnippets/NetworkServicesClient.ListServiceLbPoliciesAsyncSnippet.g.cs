...
{
    // [START networkservices_v1_generated_NetworkServices_ListServiceLbPolicies_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListServiceLbPoliciesAsync()
        {
            ...
            await foreach (ServiceLbPolicy item in response)
            {
            ...
            await foreach (ListServiceLbPoliciesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListServiceLbPolicies_async_flattened]
}
