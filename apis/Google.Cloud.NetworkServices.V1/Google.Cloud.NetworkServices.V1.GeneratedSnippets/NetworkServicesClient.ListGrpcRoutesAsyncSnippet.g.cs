...
{
    // [START networkservices_v1_generated_NetworkServices_ListGrpcRoutes_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListGrpcRoutesAsync()
        {
            ...
            await foreach (GrpcRoute item in response)
            {
            ...
            await foreach (ListGrpcRoutesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListGrpcRoutes_async_flattened]
}
