...
{
    // [START networkservices_v1_generated_NetworkServices_ListWasmPlugins_async_flattened]
    ...
    public sealed partial class GeneratedNetworkServicesClientSnippets
    {
        ...
        public async Task ListWasmPluginsAsync()
        {
            ...
            await foreach (WasmPlugin item in response)
            {
            ...
            await foreach (ListWasmPluginsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkservices_v1_generated_NetworkServices_ListWasmPlugins_async_flattened]
}
