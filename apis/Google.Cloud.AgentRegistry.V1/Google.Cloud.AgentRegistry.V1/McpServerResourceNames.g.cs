...
namespace Google.Cloud.AgentRegistry.V1
{
    ...
    public sealed partial class McpServerName : gax::IResourceName, sys::IEquatable<McpServerName>
    {
        ...
        /// <c>projects/{project}/locations/{location}/mcpServers/{mcp_server}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string mcpServerId) =>
            FormatProjectLocationMcpServer(projectId, locationId, mcpServerId);
        ...
        private McpServerName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string mcpServerId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="mcpServerId">The <c>McpServer</c> ID. Must not be <c>null</c> or empty.</param>
        public McpServerName(string projectId, string locationId, string mcpServerId) : this(ResourceNameType.ProjectLocationMcpServer, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), mcpServerId: gax::GaxPreconditions.CheckNotNullOrEmpty(mcpServerId, nameof(mcpServerId)))
        {
        }
        ...
        /// <summary>
        /// The <c>McpServer</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource name.
        /// </summary>
