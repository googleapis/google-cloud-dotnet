...
namespace Google.Cloud.Talent.V4Beta1
{
    ...
    public abstract partial class JobServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Job CreateJob(TenantOrProjectName parent, Job job, gaxgrpc::CallSettings callSettings = null) =>
            CreateJob(new CreateJobRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Job> CreateJobAsync(TenantOrProjectName parent, Job job, gaxgrpc::CallSettings callSettings = null) =>
            CreateJobAsync(new CreateJobRequest
            {
                ParentAsTenantOrProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Job = gax::GaxPreconditions.CheckNotNull(job, nameof(job)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Job> CreateJobAsync(TenantOrProjectName parent, Job job, st::CancellationToken cancellationToken) =>
            CreateJobAsync(parent, job, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<JobOperationResult, BatchOperationMetadata> BatchCreateJobs(TenantOrProjectName parent, scg::IEnumerable<Job> jobs, gaxgrpc::CallSettings callSettings = null) =>
            BatchCreateJobs(new BatchCreateJobsRequest
            {
                ParentAsTenantOrProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Jobs =
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<JobOperationResult, BatchOperationMetadata>> BatchCreateJobsAsync(TenantOrProjectName parent, scg::IEnumerable<Job> jobs, gaxgrpc::CallSettings callSettings = null) =>
            BatchCreateJobsAsync(new BatchCreateJobsRequest
            {
                ParentAsTenantOrProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Jobs =
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<JobOperationResult, BatchOperationMetadata>> BatchCreateJobsAsync(TenantOrProjectName parent, scg::IEnumerable<Job> jobs, st::CancellationToken cancellationToken) =>
            BatchCreateJobsAsync(parent, jobs, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<JobOperationResult, BatchOperationMetadata>> BatchUpdateJobsAsync(TenantOrProjectName parent, scg::IEnumerable<Job> jobs, gaxgrpc::CallSettings callSettings = null) =>
            BatchUpdateJobsAsync(new BatchUpdateJobsRequest
            {
                ParentAsTenantOrProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Jobs =
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<JobOperationResult, BatchOperationMetadata>> BatchUpdateJobsAsync(TenantOrProjectName parent, scg::IEnumerable<Job> jobs, st::CancellationToken cancellationToken) =>
            BatchUpdateJobsAsync(parent, jobs, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task BatchDeleteJobsAsync(TenantOrProjectName parent, string filter, gaxgrpc::CallSettings callSettings = null) =>
            BatchDeleteJobsAsync(new BatchDeleteJobsRequest
            {
                ParentAsTenantOrProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Filter = gax::GaxPreconditions.CheckNotNullOrEmpty(filter, nameof(filter)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task BatchDeleteJobsAsync(TenantOrProjectName parent, string filter, st::CancellationToken cancellationToken) =>
            BatchDeleteJobsAsync(parent, filter, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Job"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListJobsResponse, Job> ListJobs(TenantOrProjectName parent, string filter, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListJobs(new ListJobsRequest
            {
                ParentAsTenantOrProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Filter = gax::GaxPreconditions.CheckNotNullOrEmpty(filter, nameof(filter)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Job"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListJobsResponse, Job> ListJobsAsync(TenantOrProjectName parent, string filter, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListJobsAsync(new ListJobsRequest
            {
                ParentAsTenantOrProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Filter = gax::GaxPreconditions.CheckNotNullOrEmpty(filter, nameof(filter)),
