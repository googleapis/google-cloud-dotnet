...
namespace Google.Cloud.Talent.V4Beta1
{
    ...
    public abstract partial class ApplicationServiceClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="ApplicationServiceClient"/>, applying defaults for all unspecified
        ...
        /// <summary>
        /// Synchronously creates a <see cref="ApplicationServiceClient"/>, applying defaults for all unspecified
        /// settings, and creating a channel connecting to the given endpoint with application default credentials where
        /// necessary. See the example for how to use custom credentials.
        /// </summary>
        /// <example>
        ...
        /// <see cref="Create(grpccore::CallInvoker,ApplicationServiceSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,ApplicationServiceSettings)"/>. Channels which weren't
        /// automatically created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to
        /// <see cref="Create(grpccore::CallInvoker,ApplicationServiceSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,ApplicationServiceSettings)"/> will create new channels,
