...
namespace Google.Cloud.Talent.V4Beta1
{
    ...
    /// <summary>Resource name for the <c>TenantOrProject</c> resource.</summary>
    public sealed partial class TenantOrProjectName : gax::IResourceName, sys::IEquatable<TenantOrProjectName>
    {
        /// <summary>The possible contents of <see cref="TenantOrProjectName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
        ...
        /// <summary>Creates a <see cref="TenantOrProjectName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="TenantOrProjectName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static TenantOrProjectName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new TenantOrProjectName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="TenantOrProjectName"/> with the pattern <c>projects/{project}/tenants/{tenant}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="tenantId">The <c>Tenant</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="TenantOrProjectName"/> constructed from the provided ids.</returns>
        public static TenantOrProjectName FromProjectTenant(string projectId, string tenantId) =>
            new TenantOrProjectName(ResourceNameType.ProjectTenant, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), tenantId: gax::GaxPreconditions.CheckNotNullOrEmpty(tenantId, nameof(tenantId)));

        /// <summary>Creates a <see cref="TenantOrProjectName"/> with the pattern <c>projects/{project}</c>.</summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="TenantOrProjectName"/> constructed from the provided ids.</returns>
        public static TenantOrProjectName FromProject(string projectId) =>
            new TenantOrProjectName(ResourceNameType.Project, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="TenantOrProjectName"/> with pattern
        /// <c>projects/{project}/tenants/{tenant}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="tenantId">The <c>Tenant</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="TenantOrProjectName"/> with pattern
        /// <c>projects/{project}/tenants/{tenant}</c>.
        /// </returns>
        public static string Format(string projectId, string tenantId) => FormatProjectTenant(projectId, tenantId);
        ...
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="TenantOrProjectName"/> with pattern <c>projects/{project}</c>.
        /// </returns>
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="TenantOrProjectName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="tenantOrProjectName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="TenantOrProjectName"/> if successful.</returns>
        public static TenantOrProjectName Parse(string tenantOrProjectName) => Parse(tenantOrProjectName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="TenantOrProjectName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="TenantOrProjectName"/> if successful.</returns>
        public static TenantOrProjectName Parse(string tenantOrProjectName, bool allowUnparsed) =>
            TryParse(tenantOrProjectName, allowUnparsed, out TenantOrProjectName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="TenantOrProjectName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="tenantOrProjectName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="TenantOrProjectName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string tenantOrProjectName, out TenantOrProjectName result) =>
            TryParse(tenantOrProjectName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string tenantOrProjectName, bool allowUnparsed, out TenantOrProjectName result)
        {
            gax::GaxPreconditions.CheckNotNull(tenantOrProjectName, nameof(tenantOrProjectName));
            gax::TemplatedResourceName resourceName;
            if (s_projectTenant.TryParseName(tenantOrProjectName, out resourceName))
            {
                result = FromProjectTenant(resourceName[0], resourceName[1]);
                return true;
            }
            if (s_project.TryParseName(tenantOrProjectName, out resourceName))
            {
            ...
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(tenantOrProjectName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private TenantOrProjectName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string projectId = null, string tenantId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            ProjectId = projectId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="TenantOrProjectName"/> class from the component parts of pattern
        /// <c>projects/{project}/tenants/{tenant}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="tenantId">The <c>Tenant</c> ID. Must not be <c>null</c> or empty.</param>
        public TenantOrProjectName(string projectId, string tenantId) : this(ResourceNameType.ProjectTenant, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), tenantId: gax::GaxPreconditions.CheckNotNullOrEmpty(tenantId, nameof(tenantId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as TenantOrProjectName);

        /// <inheritdoc/>
        public bool Equals(TenantOrProjectName other) => ToString() == other?.ToString();

        /// <inheritdoc/>
        public static bool operator ==(TenantOrProjectName a, TenantOrProjectName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);

        /// <inheritdoc/>
        public static bool operator !=(TenantOrProjectName a, TenantOrProjectName b) => !(a == b);
    }
