...
namespace Google.Cloud.Talent.V4Beta1
{
    ...
    public sealed partial class TenantServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings CreateTenantSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UpdateTenantSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public sealed partial class TenantServiceClientBuilder : gaxgrpc::ClientBuilderBase<TenantServiceClient>
    {
        ...
        /// <inheritdoc/>
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => TenantServiceClient.DefaultEndpoint;
    ...
    public abstract partial class TenantServiceClient
    {
        ...
        /// <see cref="Create(grpccore::CallInvoker,TenantServiceSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,TenantServiceSettings)"/>. Channels which weren't
        /// automatically created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to
        /// <see cref="Create(grpccore::CallInvoker,TenantServiceSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,TenantServiceSettings)"/> will create new channels, which
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Tenant UpdateTenant(Tenant tenant, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Tenant> UpdateTenantAsync(Tenant tenant, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Tenant> UpdateTenantAsync(Tenant tenant, st::CancellationToken cancellationToken) =>
            UpdateTenantAsync(tenant, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        public virtual gax::PagedEnumerable<ListTenantsResponse, Tenant> ListTenants(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListTenants(new ListTenantsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                PageToken = pageToken ?? "",
                PageSize = pageSize ?? 0,
        ...
        public virtual gax::PagedAsyncEnumerable<ListTenantsResponse, Tenant> ListTenantsAsync(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListTenantsAsync(new ListTenantsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                PageToken = pageToken ?? "",
                PageSize = pageSize ?? 0,
