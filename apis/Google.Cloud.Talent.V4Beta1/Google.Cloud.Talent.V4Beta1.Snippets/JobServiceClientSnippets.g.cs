...
namespace Google.Cloud.Talent.V4Beta1.Snippets
{
    ...
    public sealed class GeneratedJobServiceClientSnippets
    {
        ...
        /// <summary>Snippet for BatchCreateJobs</summary>
        public void BatchCreateJobs_ResourceNames()
        {
        ...
        /// <summary>Snippet for BatchCreateJobsAsync</summary>
        public async Task BatchCreateJobsAsync_ResourceNames()
        {
        ...
        public void GetJob()
        {
            ...
            JobServiceClient jobServiceClient = JobServiceClient.Create();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/jobs/[JOB]";
            // Make the request
        ...
        public void GetJob_ResourceNames()
        {
            ...
            JobServiceClient jobServiceClient = JobServiceClient.Create();
            // Initialize request argument(s)
            JobName name = JobName.FromProjectJob("[PROJECT]", "[JOB]");
            // Make the request
            Job response = jobServiceClient.GetJob(name);
            // End snippet
        }
        ...
        /// <summary>Snippet for BatchUpdateJobs</summary>
        public void BatchUpdateJobs_ResourceNames()
        {
        ...
        /// <summary>Snippet for BatchUpdateJobsAsync</summary>
        public async Task BatchUpdateJobsAsync_ResourceNames()
        {
        ...
        /// <summary>Snippet for BatchDeleteJobsAsync</summary>
        public async Task BatchDeleteJobsAsync_ResourceNames()
        {
