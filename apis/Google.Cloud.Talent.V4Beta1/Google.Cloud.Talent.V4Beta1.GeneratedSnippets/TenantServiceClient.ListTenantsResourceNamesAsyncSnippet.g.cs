...
{
    // [START jobs_v4beta1_generated_TenantService_ListTenants_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedTenantServiceClientSnippets
    {
        ...
        public async Task ListTenantsResourceNamesAsync()
        {
            ...
            await foreach (Tenant item in response)
            {
            ...
            await foreach (ListTenantsResponse page in response.AsRawResponses())
            {
    ...
    // [END jobs_v4beta1_generated_TenantService_ListTenants_async_flattened_resourceNames]
}
