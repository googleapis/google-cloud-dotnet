...
{
    // [START maintenance_v1beta_generated_Maintenance_SummarizeMaintenances_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedMaintenanceClientSnippets
    {
        ...
        public async Task SummarizeMaintenancesResourceNamesAsync()
        {
            ...
            await foreach (MaintenanceSummary item in response)
            {
            ...
            await foreach (SummarizeMaintenancesResponse page in response.AsRawResponses())
            {
    ...
    // [END maintenance_v1beta_generated_Maintenance_SummarizeMaintenances_async_flattened_resourceNames]
}
