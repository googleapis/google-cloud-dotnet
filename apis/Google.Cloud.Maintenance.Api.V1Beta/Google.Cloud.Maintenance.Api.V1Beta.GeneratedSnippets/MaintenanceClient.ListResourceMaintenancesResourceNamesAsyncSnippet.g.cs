...
{
    // [START maintenance_v1beta_generated_Maintenance_ListResourceMaintenances_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedMaintenanceClientSnippets
    {
        ...
        public async Task ListResourceMaintenancesResourceNamesAsync()
        {
            ...
            await foreach (ResourceMaintenance item in response)
            {
            ...
            await foreach (ListResourceMaintenancesResponse page in response.AsRawResponses())
            {
    ...
    // [END maintenance_v1beta_generated_Maintenance_ListResourceMaintenances_async_flattened_resourceNames]
}
