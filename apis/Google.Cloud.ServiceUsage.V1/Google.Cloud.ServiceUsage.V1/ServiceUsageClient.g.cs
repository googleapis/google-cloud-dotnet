...
namespace Google.Cloud.ServiceUsage.V1
{
    ...
    public sealed partial class ServiceUsageClientBuilder : gaxgrpc::ClientBuilderBase<ServiceUsageClient>
    {
        ...
        private ServiceUsageClient BuildImpl()
        {
            ...
            return ServiceUsageClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ServiceUsageClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ServiceUsage.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
