...
namespace Google.Cloud.AlloyDb.V1Beta
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.AlloyDb.V1Beta", GetFileDescriptors)
        ...
        private static scg::IEnumerable<gpr::FileDescriptor> GetFileDescriptors()
        {
            ...
            yield return CsqlServiceReflection.Descriptor;
