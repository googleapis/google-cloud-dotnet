...
{
    // [START alloydb_v1beta_generated_AlloyDBAdmin_ListSupportedDatabaseFlags_async_flattened]
    ...
    public sealed partial class GeneratedAlloyDBAdminClientSnippets
    {
        ...
        public async Task ListSupportedDatabaseFlagsAsync()
        {
            ...
            await foreach (SupportedDatabaseFlag item in response)
            {
            ...
            await foreach (ListSupportedDatabaseFlagsResponse page in response.AsRawResponses())
            {
    ...
    // [END alloydb_v1beta_generated_AlloyDBAdmin_ListSupportedDatabaseFlags_async_flattened]
}
