...
{
    // [START dialogflow_v3_generated_SecuritySettingsService_ListSecuritySettings_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSecuritySettingsServiceClientSnippets
    {
        ...
        public async Task ListSecuritySettingsResourceNamesAsync()
        {
            ...
            await foreach (SecuritySettings item in response)
            {
            ...
            await foreach (ListSecuritySettingsResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v3_generated_SecuritySettingsService_ListSecuritySettings_async_flattened_resourceNames]
}
