...
{
    // [START dialogflow_v3_generated_Environments_ListContinuousTestResults_async_flattened]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task ListContinuousTestResultsAsync()
        {
            ...
            await foreach (ContinuousTestResult item in response)
            {
            ...
            await foreach (ListContinuousTestResultsResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v3_generated_Environments_ListContinuousTestResults_async_flattened]
}
