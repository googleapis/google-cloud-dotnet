...
{
    // [START dialogflow_v3_generated_Environments_LookupEnvironmentHistory_async_flattened]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task LookupEnvironmentHistoryAsync()
        {
            ...
            await foreach (gcdcv::LookupEnvironmentHistoryResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v3_generated_Environments_LookupEnvironmentHistory_async_flattened]
}
