...
{
    // [START dialogflow_v3_generated_Generators_DeleteGenerator_async_flattened]
    ...
    public sealed partial class GeneratedGeneratorsClientSnippets
    {
        ...
        public async Task DeleteGeneratorAsync()
        {
            ...
            string name = "projects/[PROJECT]/locations/[LOCATION]/agents/[AGENT]/generators/[GENERATOR]";
            // Make the request
            await generatorsClient.DeleteGeneratorAsync(name);
        }
    }
    // [END dialogflow_v3_generated_Generators_DeleteGenerator_async_flattened]
}
