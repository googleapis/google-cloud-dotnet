...
{
    // [START dialogflow_v3_generated_TestCases_ListTestCases_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedTestCasesClientSnippets
    {
        ...
        public async Task ListTestCasesResourceNamesAsync()
        {
            ...
            await foreach (TestCase item in response)
            {
            ...
            await foreach (ListTestCasesResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v3_generated_TestCases_ListTestCases_async_flattened_resourceNames]
}
