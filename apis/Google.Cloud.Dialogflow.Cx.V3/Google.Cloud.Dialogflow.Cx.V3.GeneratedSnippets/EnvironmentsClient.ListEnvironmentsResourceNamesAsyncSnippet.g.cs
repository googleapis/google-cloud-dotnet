...
{
    // [START dialogflow_v3_generated_Environments_ListEnvironments_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task ListEnvironmentsResourceNamesAsync()
        {
            ...
            await foreach (gcdcv::Environment item in response)
            {
            ...
            await foreach (gcdcv::ListEnvironmentsResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v3_generated_Environments_ListEnvironments_async_flattened_resourceNames]
}
