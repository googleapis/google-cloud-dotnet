...
{
    // [START dialogflow_v3_generated_Generators_CreateGenerator_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedGeneratorsClientSnippets
    {
        ...
        public async Task CreateGeneratorResourceNamesAsync()
        {
            ...
            // Make the request
            Generator response = await generatorsClient.CreateGeneratorAsync(parent, generator);
        }
    }
    // [END dialogflow_v3_generated_Generators_CreateGenerator_async_flattened_resourceNames]
}
