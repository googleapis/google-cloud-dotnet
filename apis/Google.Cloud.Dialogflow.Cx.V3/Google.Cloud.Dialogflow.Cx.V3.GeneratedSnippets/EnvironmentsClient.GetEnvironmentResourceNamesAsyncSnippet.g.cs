...
{
    // [START dialogflow_v3_generated_Environments_GetEnvironment_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task GetEnvironmentResourceNamesAsync()
        {
            ...
            // Make the request
            Environment response = await environmentsClient.GetEnvironmentAsync(name);
        }
    }
    // [END dialogflow_v3_generated_Environments_GetEnvironment_async_flattened_resourceNames]
}
