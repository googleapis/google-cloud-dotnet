...
namespace Google.Cloud.Dialogflow.Cx.V3
{
    ...
    public sealed partial class ExampleName : gax::IResourceName, sys::IEquatable<ExampleName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/examples/{example}</c>.
            /// </summary>
            ProjectLocationAgentPlaybookExample = 1,
        }

        private static gax::PathTemplate s_projectLocationAgentPlaybookExample = new gax::PathTemplate("projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/examples/{example}");
        ...
        public static ExampleName FromProjectLocationAgentPlaybookExample(string projectId, string locationId, string agentId, string playbookId, string exampleId) =>
            new ExampleName(ResourceNameType.ProjectLocationAgentPlaybookExample, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), agentId: gax::GaxPreconditions.CheckNotNullOrEmpty(agentId, nameof(agentId)), playbookId: gax::GaxPreconditions.CheckNotNullOrEmpty(playbookId, nameof(playbookId)), exampleId: gax::GaxPreconditions.CheckNotNullOrEmpty(exampleId, nameof(exampleId)));
        ...
        /// <c>projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/examples/{example}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string agentId, string playbookId, string exampleId) =>
            FormatProjectLocationAgentPlaybookExample(projectId, locationId, agentId, playbookId, exampleId);
        ...
        /// <c>projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/examples/{example}</c>.
        /// </returns>
        public static string FormatProjectLocationAgentPlaybookExample(string projectId, string locationId, string agentId, string playbookId, string exampleId) =>
            s_projectLocationAgentPlaybookExample.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(agentId, nameof(agentId)), gax::GaxPreconditions.CheckNotNullOrEmpty(playbookId, nameof(playbookId)), gax::GaxPreconditions.CheckNotNullOrEmpty(exampleId, nameof(exampleId)));
        ...
        public static bool TryParse(string exampleName, bool allowUnparsed, out ExampleName result)
        {
            ...
            if (s_projectLocationAgentPlaybookExample.TryParseName(exampleName, out resourceName))
            {
                result = FromProjectLocationAgentPlaybookExample(resourceName[0], resourceName[1], resourceName[2], resourceName[3], resourceName[4]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ExampleName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string agentId = null, string exampleId = null, string locationId = null, string playbookId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="playbookId">The <c>Playbook</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="exampleId">The <c>Example</c> ID. Must not be <c>null</c> or empty.</param>
        public ExampleName(string projectId, string locationId, string agentId, string playbookId, string exampleId) : this(ResourceNameType.ProjectLocationAgentPlaybookExample, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), agentId: gax::GaxPreconditions.CheckNotNullOrEmpty(agentId, nameof(agentId)), playbookId: gax::GaxPreconditions.CheckNotNullOrEmpty(playbookId, nameof(playbookId)), exampleId: gax::GaxPreconditions.CheckNotNullOrEmpty(exampleId, nameof(exampleId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationAgentPlaybookExample: return s_projectLocationAgentPlaybookExample.Expand(ProjectId, LocationId, AgentId, PlaybookId, ExampleId);
    ...
    {
        /// <summary>
        /// <see cref="gcdcv::ExampleName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcdcv::ExampleName ExampleName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcdcv::ExampleName.Parse(Name, allowUnparsed: true);
