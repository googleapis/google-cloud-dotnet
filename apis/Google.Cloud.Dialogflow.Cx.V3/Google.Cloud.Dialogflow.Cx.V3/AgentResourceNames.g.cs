    ...
    public partial class Agent
    {
        ...
        public partial class Types
        {
            public partial class ClientCertificateSettings
            {
                ...
                /// <summary>
                /// <see cref="SecretVersionName"/>-typed view over the <see cref="Passphrase"/> resource name property.
                /// </summary>
                public SecretVersionName PassphraseAsSecretVersionName
                {
                    get => string.IsNullOrEmpty(Passphrase) ? null : SecretVersionName.Parse(Passphrase, allowUnparsed: true);
                    set => Passphrase = value?.ToString() ?? "";
                }
            }
        }
    }
