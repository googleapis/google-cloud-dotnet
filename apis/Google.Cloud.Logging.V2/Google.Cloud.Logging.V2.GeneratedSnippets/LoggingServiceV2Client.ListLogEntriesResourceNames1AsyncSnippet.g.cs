...
{
    // [START logging_v2_generated_LoggingServiceV2_ListLogEntries_async_flattened_resourceNames1]
    ...
    public sealed partial class GeneratedLoggingServiceV2ClientSnippets
    {
        ...
        public async Task ListLogEntriesResourceNames1Async()
        {
            ...
            await foreach (LogEntry item in response)
            {
            ...
            await foreach (ListLogEntriesResponse page in response.AsRawResponses())
            {
    ...
    // [END logging_v2_generated_LoggingServiceV2_ListLogEntries_async_flattened_resourceNames1]
}
