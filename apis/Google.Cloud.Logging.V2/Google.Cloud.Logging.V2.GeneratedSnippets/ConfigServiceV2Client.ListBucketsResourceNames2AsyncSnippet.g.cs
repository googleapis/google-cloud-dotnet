...
{
    // [START logging_v2_generated_ConfigServiceV2_ListBuckets_async_flattened_resourceNames2]
    ...
    public sealed partial class GeneratedConfigServiceV2ClientSnippets
    {
        ...
        public async Task ListBucketsResourceNames2Async()
        {
            ...
            await foreach (LogBucket item in response)
            {
            ...
            await foreach (ListBucketsResponse page in response.AsRawResponses())
            {
    ...
    // [END logging_v2_generated_ConfigServiceV2_ListBuckets_async_flattened_resourceNames2]
}
