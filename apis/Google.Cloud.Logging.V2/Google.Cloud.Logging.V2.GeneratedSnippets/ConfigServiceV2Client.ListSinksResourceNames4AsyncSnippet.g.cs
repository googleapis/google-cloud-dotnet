...
{
    // [START logging_v2_generated_ConfigServiceV2_ListSinks_async_flattened_resourceNames4]
    ...
    public sealed partial class GeneratedConfigServiceV2ClientSnippets
    {
        ...
        public async Task ListSinksResourceNames4Async()
        {
            ...
            await foreach (LogSink item in response)
            {
            ...
            await foreach (ListSinksResponse page in response.AsRawResponses())
            {
    ...
    // [END logging_v2_generated_ConfigServiceV2_ListSinks_async_flattened_resourceNames4]
}
