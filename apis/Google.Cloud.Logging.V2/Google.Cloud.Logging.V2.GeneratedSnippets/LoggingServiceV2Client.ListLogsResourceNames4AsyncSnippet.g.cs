...
{
    // [START logging_v2_generated_LoggingServiceV2_ListLogs_async_flattened_resourceNames4]
    ...
    public sealed partial class GeneratedLoggingServiceV2ClientSnippets
    {
        ...
        public async Task ListLogsResourceNames4Async()
        {
            ...
            await foreach (ListLogsResponse page in response.AsRawResponses())
            {
    ...
    // [END logging_v2_generated_LoggingServiceV2_ListLogs_async_flattened_resourceNames4]
}
