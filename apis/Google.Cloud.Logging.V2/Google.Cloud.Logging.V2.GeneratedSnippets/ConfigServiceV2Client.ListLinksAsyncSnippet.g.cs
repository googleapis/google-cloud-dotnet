...
{
    // [START logging_v2_generated_ConfigServiceV2_ListLinks_async_flattened]
    ...
    public sealed partial class GeneratedConfigServiceV2ClientSnippets
    {
        ...
        public async Task ListLinksAsync()
        {
            ...
            await foreach (Link item in response)
            {
            ...
            await foreach (ListLinksResponse page in response.AsRawResponses())
            {
    ...
    // [END logging_v2_generated_ConfigServiceV2_ListLinks_async_flattened]
}
