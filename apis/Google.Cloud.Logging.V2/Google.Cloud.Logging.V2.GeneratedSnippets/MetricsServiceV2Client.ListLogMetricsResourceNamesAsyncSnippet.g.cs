...
{
    // [START logging_v2_generated_MetricsServiceV2_ListLogMetrics_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedMetricsServiceV2ClientSnippets
    {
        ...
        public async Task ListLogMetricsResourceNamesAsync()
        {
            ...
            await foreach (LogMetric item in response)
            {
            ...
            await foreach (ListLogMetricsResponse page in response.AsRawResponses())
            {
    ...
    // [END logging_v2_generated_MetricsServiceV2_ListLogMetrics_async_flattened_resourceNames]
}
