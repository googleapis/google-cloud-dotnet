...
{
    // [START logging_v2_generated_ConfigServiceV2_ListExclusions_async_flattened_resourceNames1]
    ...
    public sealed partial class GeneratedConfigServiceV2ClientSnippets
    {
        ...
        public async Task ListExclusionsResourceNames1Async()
        {
            ...
            await foreach (LogExclusion item in response)
            {
            ...
            await foreach (ListExclusionsResponse page in response.AsRawResponses())
            {
    ...
    // [END logging_v2_generated_ConfigServiceV2_ListExclusions_async_flattened_resourceNames1]
}
