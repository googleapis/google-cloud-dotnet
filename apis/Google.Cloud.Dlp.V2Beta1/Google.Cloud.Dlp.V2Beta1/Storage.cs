  ...
  public sealed partial class CustomInfoType : pb::IMessage<CustomInfoType> {
    ...
    public void MergeFrom(CustomInfoType other) {
      ...
      switch (other.TypeCase) {
        case TypeOneofCase.Dictionary:
          if (Dictionary == null) {
            Dictionary = new global::Google.Cloud.Dlp.V2Beta1.CustomInfoType.Types.Dictionary();
          }
      ...
      public sealed partial class Dictionary : pb::IMessage<Dictionary> {
        ...
        public void MergeFrom(Dictionary other) {
          ...
          switch (other.SourceCase) {
            case SourceOneofCase.WordList:
              if (WordList == null) {
                WordList = new global::Google.Cloud.Dlp.V2Beta1.CustomInfoType.Types.Dictionary.Types.WordList();
              }
      ...
      switch (other.TypeCase) {
        case TypeOneofCase.DatastoreOptions:
          if (DatastoreOptions == null) {
            DatastoreOptions = new global::Google.Cloud.Dlp.V2Beta1.DatastoreOptions();
          }
          DatastoreOptions.MergeFrom(other.DatastoreOptions);
          break;
        case TypeOneofCase.CloudStorageOptions:
          if (CloudStorageOptions == null) {
            CloudStorageOptions = new global::Google.Cloud.Dlp.V2Beta1.CloudStorageOptions();
          }
          CloudStorageOptions.MergeFrom(other.CloudStorageOptions);
          break;
        case TypeOneofCase.BigQueryOptions:
          if (BigQueryOptions == null) {
            BigQueryOptions = new global::Google.Cloud.Dlp.V2Beta1.BigQueryOptions();
          }
      ...
      switch (other.TypeCase) {
        case TypeOneofCase.CloudStorageKey:
          if (CloudStorageKey == null) {
            CloudStorageKey = new global::Google.Cloud.Dlp.V2Beta1.CloudStorageKey();
          }
          CloudStorageKey.MergeFrom(other.CloudStorageKey);
          break;
        case TypeOneofCase.DatastoreKey:
          if (DatastoreKey == null) {
            DatastoreKey = new global::Google.Cloud.Dlp.V2Beta1.DatastoreKey();
          }
