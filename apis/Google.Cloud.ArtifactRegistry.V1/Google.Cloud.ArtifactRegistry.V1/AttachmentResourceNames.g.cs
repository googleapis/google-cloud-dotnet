...
namespace Google.Cloud.ArtifactRegistry.V1
{
    ...
    public sealed partial class AttachmentName : gax::IResourceName, sys::IEquatable<AttachmentName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/repositories/{repository}/attachments/{attachment}</c>.
            /// </summary>
            ProjectLocationRepositoryAttachment = 1,
        }

        private static gax::PathTemplate s_projectLocationRepositoryAttachment = new gax::PathTemplate("projects/{project}/locations/{location}/repositories/{repository}/attachments/{attachment}");
        ...
        public static AttachmentName FromProjectLocationRepositoryAttachment(string projectId, string locationId, string repositoryId, string attachmentId) =>
            new AttachmentName(ResourceNameType.ProjectLocationRepositoryAttachment, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), repositoryId: gax::GaxPreconditions.CheckNotNullOrEmpty(repositoryId, nameof(repositoryId)), attachmentId: gax::GaxPreconditions.CheckNotNullOrEmpty(attachmentId, nameof(attachmentId)));
        ...
        public static string Format(string projectId, string locationId, string repositoryId, string attachmentId) =>
            FormatProjectLocationRepositoryAttachment(projectId, locationId, repositoryId, attachmentId);
        ...
        public static bool TryParse(string attachmentName, bool allowUnparsed, out AttachmentName result)
        {
            ...
            if (s_projectLocationRepositoryAttachment.TryParseName(attachmentName, out resourceName))
            {
                result = FromProjectLocationRepositoryAttachment(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private AttachmentName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string attachmentId = null, string locationId = null, string projectId = null, string repositoryId = null)
        {
            Type = type;
        ...
        /// <param name="repositoryId">The <c>Repository</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="attachmentId">The <c>Attachment</c> ID. Must not be <c>null</c> or empty.</param>
        public AttachmentName(string projectId, string locationId, string repositoryId, string attachmentId) : this(ResourceNameType.ProjectLocationRepositoryAttachment, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), repositoryId: gax::GaxPreconditions.CheckNotNullOrEmpty(repositoryId, nameof(repositoryId)), attachmentId: gax::GaxPreconditions.CheckNotNullOrEmpty(attachmentId, nameof(attachmentId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationRepositoryAttachment: return s_projectLocationRepositoryAttachment.Expand(ProjectId, LocationId, RepositoryId, AttachmentId);
    ...
    {
        /// <summary>
        /// <see cref="gcav::AttachmentName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcav::AttachmentName AttachmentName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcav::AttachmentName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }

        /// <summary><see cref="FileName"/>-typed view over the <see cref="Files"/> resource name property.</summary>
        public gax::ResourceNameList<FileName> FilesAsFileNames
        {
            get => new gax::ResourceNameList<FileName>(Files, s => string.IsNullOrEmpty(s) ? null : FileName.Parse(s, allowUnparsed: true));
        }
    }
