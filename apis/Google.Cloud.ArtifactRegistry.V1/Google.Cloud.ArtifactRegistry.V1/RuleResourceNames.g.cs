...
namespace Google.Cloud.ArtifactRegistry.V1
{
    ...
    public sealed partial class RuleName : gax::IResourceName, sys::IEquatable<RuleName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/repositories/{repository}/rules/{rule}</c>.
            /// </summary>
            ProjectLocationRepositoryRule = 1,
        }

        private static gax::PathTemplate s_projectLocationRepositoryRule = new gax::PathTemplate("projects/{project}/locations/{location}/repositories/{repository}/rules/{rule}");
        ...
        public static RuleName FromProjectLocationRepositoryRule(string projectId, string locationId, string repositoryId, string ruleId) =>
            new RuleName(ResourceNameType.ProjectLocationRepositoryRule, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), repositoryId: gax::GaxPreconditions.CheckNotNullOrEmpty(repositoryId, nameof(repositoryId)), ruleId: gax::GaxPreconditions.CheckNotNullOrEmpty(ruleId, nameof(ruleId)));
        ...
        public static string Format(string projectId, string locationId, string repositoryId, string ruleId) =>
            FormatProjectLocationRepositoryRule(projectId, locationId, repositoryId, ruleId);
        ...
        public static bool TryParse(string ruleName, bool allowUnparsed, out RuleName result)
        {
            ...
            if (s_projectLocationRepositoryRule.TryParseName(ruleName, out resourceName))
            {
                result = FromProjectLocationRepositoryRule(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private RuleName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string repositoryId = null, string ruleId = null)
        {
            Type = type;
        ...
        /// <param name="repositoryId">The <c>Repository</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="ruleId">The <c>Rule</c> ID. Must not be <c>null</c> or empty.</param>
        public RuleName(string projectId, string locationId, string repositoryId, string ruleId) : this(ResourceNameType.ProjectLocationRepositoryRule, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), repositoryId: gax::GaxPreconditions.CheckNotNullOrEmpty(repositoryId, nameof(repositoryId)), ruleId: gax::GaxPreconditions.CheckNotNullOrEmpty(ruleId, nameof(ruleId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationRepositoryRule: return s_projectLocationRepositoryRule.Expand(ProjectId, LocationId, RepositoryId, RuleId);
    ...
    {
        /// <summary>
        /// <see cref="gcav::RuleName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcav::RuleName RuleName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcav::RuleName.Parse(Name, allowUnparsed: true);
