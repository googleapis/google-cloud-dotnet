...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_ListAttachments_sync_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public void ListAttachments()
        {
            ...
            // Make the request
            PagedEnumerable<ListAttachmentsResponse, Attachment> response = artifactRegistryClient.ListAttachments(parent);
    ...
    // [END artifactregistry_v1_generated_ArtifactRegistry_ListAttachments_sync_flattened]
}
