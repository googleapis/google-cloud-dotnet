...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_UpdateRule_async]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task UpdateRuleRequestObjectAsync()
        {
            ...
            // Make the request
            Rule response = await artifactRegistryClient.UpdateRuleAsync(request);
        }
    }
    // [END artifactregistry_v1_generated_ArtifactRegistry_UpdateRule_async]
}
