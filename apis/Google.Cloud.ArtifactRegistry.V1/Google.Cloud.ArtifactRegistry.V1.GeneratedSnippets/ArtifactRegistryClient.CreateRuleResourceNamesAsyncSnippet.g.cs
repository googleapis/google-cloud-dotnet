...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_CreateRule_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task CreateRuleResourceNamesAsync()
        {
            ...
            string ruleId = "";
            // Make the request
            Rule response = await artifactRegistryClient.CreateRuleAsync(parent, rule, ruleId);
        }
    }
    // [END artifactregistry_v1_generated_ArtifactRegistry_CreateRule_async_flattened_resourceNames]
}
