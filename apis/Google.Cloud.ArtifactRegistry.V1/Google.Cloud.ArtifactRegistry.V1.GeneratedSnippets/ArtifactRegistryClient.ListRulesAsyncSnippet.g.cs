...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_ListRules_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task ListRulesAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListRulesResponse, Rule> response = artifactRegistryClient.ListRulesAsync(parent);
    ...
    // [END artifactregistry_v1_generated_ArtifactRegistry_ListRules_async_flattened]
}
