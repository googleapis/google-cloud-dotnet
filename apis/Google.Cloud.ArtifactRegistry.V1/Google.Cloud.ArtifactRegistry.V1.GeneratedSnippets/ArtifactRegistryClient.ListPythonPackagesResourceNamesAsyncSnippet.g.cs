...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_ListPythonPackages_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task ListPythonPackagesResourceNamesAsync()
        {
            ...
            await foreach (PythonPackage item in response)
            {
            ...
            await foreach (ListPythonPackagesResponse page in response.AsRawResponses())
            {
    ...
    // [END artifactregistry_v1_generated_ArtifactRegistry_ListPythonPackages_async_flattened_resourceNames]
}
