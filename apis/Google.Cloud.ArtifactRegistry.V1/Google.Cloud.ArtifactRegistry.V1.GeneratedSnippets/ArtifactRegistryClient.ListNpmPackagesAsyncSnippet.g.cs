...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_ListNpmPackages_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task ListNpmPackagesAsync()
        {
            ...
            await foreach (NpmPackage item in response)
            {
            ...
            await foreach (ListNpmPackagesResponse page in response.AsRawResponses())
            {
    ...
    // [END artifactregistry_v1_generated_ArtifactRegistry_ListNpmPackages_async_flattened]
}
