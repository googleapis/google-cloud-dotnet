...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_UpdatePackage_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task UpdatePackageAsync()
        {
            ...
            // Make the request
            Package response = await artifactRegistryClient.UpdatePackageAsync(package, updateMask);
        }
    }
    // [END artifactregistry_v1_generated_ArtifactRegistry_UpdatePackage_async_flattened]
}
