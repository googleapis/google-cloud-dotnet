...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_UpdateRule_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task UpdateRuleAsync()
        {
            ...
            // Make the request
            Rule response = await artifactRegistryClient.UpdateRuleAsync(rule, updateMask);
        }
    }
    // [END artifactregistry_v1_generated_ArtifactRegistry_UpdateRule_async_flattened]
}
