...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_ListAttachments_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task ListAttachmentsAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListAttachmentsResponse, Attachment> response = artifactRegistryClient.ListAttachmentsAsync(parent);
    ...
    // [END artifactregistry_v1_generated_ArtifactRegistry_ListAttachments_async_flattened]
}
