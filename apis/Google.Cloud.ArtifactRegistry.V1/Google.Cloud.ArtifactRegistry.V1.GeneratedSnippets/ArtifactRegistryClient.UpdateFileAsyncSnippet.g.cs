...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_UpdateFile_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task UpdateFileAsync()
        {
            ...
            // Make the request
            File response = await artifactRegistryClient.UpdateFileAsync(file, updateMask);
        }
    }
    // [END artifactregistry_v1_generated_ArtifactRegistry_UpdateFile_async_flattened]
}
