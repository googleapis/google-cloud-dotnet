...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_ListMavenArtifacts_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task ListMavenArtifactsAsync()
        {
            ...
            await foreach (MavenArtifact item in response)
            {
            ...
            await foreach (ListMavenArtifactsResponse page in response.AsRawResponses())
            {
    ...
    // [END artifactregistry_v1_generated_ArtifactRegistry_ListMavenArtifacts_async_flattened]
}
