...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_GetVersion_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task GetVersionAsync()
        {
            ...
            string name = "";
            // Make the request
            Version response = await artifactRegistryClient.GetVersionAsync(name);
        }
    }
    // [END artifactregistry_v1_generated_ArtifactRegistry_GetVersion_async_flattened]
}
