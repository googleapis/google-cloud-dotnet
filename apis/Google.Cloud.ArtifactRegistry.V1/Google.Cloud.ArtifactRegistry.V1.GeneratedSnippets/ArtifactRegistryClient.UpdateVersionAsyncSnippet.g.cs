...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_UpdateVersion_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task UpdateVersionAsync()
        {
            ...
            // Make the request
            Version response = await artifactRegistryClient.UpdateVersionAsync(version, updateMask);
        }
    }
    // [END artifactregistry_v1_generated_ArtifactRegistry_UpdateVersion_async_flattened]
}
