...
{
    // [START artifactregistry_v1_generated_ArtifactRegistry_ListDockerImages_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task ListDockerImagesAsync()
        {
            ...
            await foreach (DockerImage item in response)
            {
            ...
            await foreach (ListDockerImagesResponse page in response.AsRawResponses())
            {
    ...
    // [END artifactregistry_v1_generated_ArtifactRegistry_ListDockerImages_async_flattened]
}
