...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedApiHubCollectClientSnippets
    {
        /// <summary>Snippet for CollectApiData</summary>
        public void CollectApiDataRequestObject()
        {
            // Snippet: CollectApiData(CollectApiDataRequest, CallSettings)
            // Create client
        ...
        public async Task CollectApiDataRequestObjectAsync()
        {
            // Snippet: CollectApiDataAsync(CollectApiDataRequest, CallSettings)
            // Additional: CollectApiDataAsync(CollectApiDataRequest, CancellationToken)
            // Create client
        ...
        {
            // Snippet: CollectApiData(string, CollectionType, ApiData, CallSettings)
            // Create client
            ApiHubCollectClient apiHubCollectClient = ApiHubCollectClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for CollectApiDataAsync</summary>
        public async Task CollectApiDataAsync()
        {
            // Snippet: CollectApiDataAsync(string, CollectionType, ApiData, CallSettings)
            // Additional: CollectApiDataAsync(string, CollectionType, ApiData, CancellationToken)
            // Create client
            ApiHubCollectClient apiHubCollectClient = await ApiHubCollectClient.CreateAsync();
            // Initialize request argument(s)
            string location = "projects/[PROJECT]/locations/[LOCATION]";
        ...
        /// <summary>Snippet for CollectApiData</summary>
        public void CollectApiDataResourceNames()
        {
            // Snippet: CollectApiData(LocationName, CollectionType, ApiData, CallSettings)
            // Create client
            ApiHubCollectClient apiHubCollectClient = ApiHubCollectClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: CollectApiDataAsync(LocationName, CollectionType, ApiData, CallSettings)
            // Additional: CollectApiDataAsync(LocationName, CollectionType, ApiData, CancellationToken)
            // Create client
            ApiHubCollectClient apiHubCollectClient = await ApiHubCollectClient.CreateAsync();
            // Initialize request argument(s)
            LocationName location = LocationName.FromProjectLocation("[PROJECT]", "[LOCATION]");
