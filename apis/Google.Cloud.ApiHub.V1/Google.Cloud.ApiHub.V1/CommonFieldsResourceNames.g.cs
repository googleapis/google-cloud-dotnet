...
namespace Google.Cloud.ApiHub.V1
{
    ...
    /// <summary>Resource name for the <c>DiscoveredApiObservation</c> resource.</summary>
    public sealed partial class DiscoveredApiObservationName : gax::IResourceName, sys::IEquatable<DiscoveredApiObservationName>
    {
        /// <summary>The possible contents of <see cref="DiscoveredApiObservationName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}</c>.
            /// </summary>
            ProjectLocationDiscoveredApiObservation = 1,
        }

        private static gax::PathTemplate s_projectLocationDiscoveredApiObservation = new gax::PathTemplate("projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}");

        /// <summary>
        /// Creates a <see cref="DiscoveredApiObservationName"/> containing an unparsed resource name.
        /// </summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="DiscoveredApiObservationName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static DiscoveredApiObservationName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new DiscoveredApiObservationName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="DiscoveredApiObservationName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="discoveredApiObservationId">
        /// The <c>DiscoveredApiObservation</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="DiscoveredApiObservationName"/> constructed from the provided ids.
        /// </returns>
        public static DiscoveredApiObservationName FromProjectLocationDiscoveredApiObservation(string projectId, string locationId, string discoveredApiObservationId) =>
            new DiscoveredApiObservationName(ResourceNameType.ProjectLocationDiscoveredApiObservation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), discoveredApiObservationId: gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiObservationId, nameof(discoveredApiObservationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="DiscoveredApiObservationName"/> with
        /// pattern <c>projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}</c>
        /// .
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// </param>
        /// <returns>
        /// The string representation of this <see cref="DiscoveredApiObservationName"/> with pattern
        /// <c>projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string discoveredApiObservationId) =>
            FormatProjectLocationDiscoveredApiObservation(projectId, locationId, discoveredApiObservationId);
        ...
        public static string FormatProjectLocationDiscoveredApiObservation(string projectId, string locationId, string discoveredApiObservationId) =>
            s_projectLocationDiscoveredApiObservation.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiObservationId, nameof(discoveredApiObservationId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="DiscoveredApiObservationName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="discoveredApiObservationName">
        /// The resource name in string form. Must not be <c>null</c>.
        /// </param>
        /// <returns>The parsed <see cref="DiscoveredApiObservationName"/> if successful.</returns>
        public static DiscoveredApiObservationName Parse(string discoveredApiObservationName) =>
            Parse(discoveredApiObservationName, false);
        ...
        public static DiscoveredApiObservationName Parse(string discoveredApiObservationName, bool allowUnparsed) =>
            TryParse(discoveredApiObservationName, allowUnparsed, out DiscoveredApiObservationName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="DiscoveredApiObservationName"/>
        /// instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="DiscoveredApiObservationName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string discoveredApiObservationName, out DiscoveredApiObservationName result) =>
            TryParse(discoveredApiObservationName, false, out result);
        ...
        {
            gax::GaxPreconditions.CheckNotNull(discoveredApiObservationName, nameof(discoveredApiObservationName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationDiscoveredApiObservation.TryParseName(discoveredApiObservationName, out resourceName))
            {
                result = FromProjectLocationDiscoveredApiObservation(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(discoveredApiObservationName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private DiscoveredApiObservationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string discoveredApiObservationId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            DiscoveredApiObservationId = discoveredApiObservationId;
            LocationId = locationId;
            ProjectId = projectId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="DiscoveredApiObservationName"/> class from the component parts of
        /// pattern <c>projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// The <c>DiscoveredApiObservation</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public DiscoveredApiObservationName(string projectId, string locationId, string discoveredApiObservationId) : this(ResourceNameType.ProjectLocationDiscoveredApiObservation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), discoveredApiObservationId: gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiObservationId, nameof(discoveredApiObservationId)))
        {
        }
        ...
        /// <summary>
        /// The <c>DiscoveredApiObservation</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationDiscoveredApiObservation: return s_projectLocationDiscoveredApiObservation.Expand(ProjectId, LocationId, DiscoveredApiObservationId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as DiscoveredApiObservationName);

        /// <inheritdoc/>
        public bool Equals(DiscoveredApiObservationName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(DiscoveredApiObservationName a, DiscoveredApiObservationName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(DiscoveredApiObservationName a, DiscoveredApiObservationName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>DiscoveredApiOperation</c> resource.</summary>
    public sealed partial class DiscoveredApiOperationName : gax::IResourceName, sys::IEquatable<DiscoveredApiOperationName>
    {
        /// <summary>The possible contents of <see cref="DiscoveredApiOperationName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// A resource name with pattern
            /// <c>
            /// projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}/discoveredApiOperations/{discovered_api_operation}</c>
            /// .
            /// </summary>
            ProjectLocationDiscoveredApiObservationDiscoveredApiOperation = 1,
        }

        private static gax::PathTemplate s_projectLocationDiscoveredApiObservationDiscoveredApiOperation = new gax::PathTemplate("projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}/discoveredApiOperations/{discovered_api_operation}");

        /// <summary>Creates a <see cref="DiscoveredApiOperationName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="DiscoveredApiOperationName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static DiscoveredApiOperationName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new DiscoveredApiOperationName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="DiscoveredApiOperationName"/> with the pattern
        /// <c>
        /// projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}/discoveredApiOperations/{discovered_api_operation}</c>
        /// .
        /// </summary>
        ...
        /// The <c>DiscoveredApiObservation</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="discoveredApiOperationId">
        /// The <c>DiscoveredApiOperation</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="DiscoveredApiOperationName"/> constructed from the provided ids.
        /// </returns>
        public static DiscoveredApiOperationName FromProjectLocationDiscoveredApiObservationDiscoveredApiOperation(string projectId, string locationId, string discoveredApiObservationId, string discoveredApiOperationId) =>
            new DiscoveredApiOperationName(ResourceNameType.ProjectLocationDiscoveredApiObservationDiscoveredApiOperation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), discoveredApiObservationId: gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiObservationId, nameof(discoveredApiObservationId)), discoveredApiOperationId: gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiOperationId, nameof(discoveredApiOperationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="DiscoveredApiOperationName"/> with pattern
        /// 
        /// <c>
        /// projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}/discoveredApiOperations/{discovered_api_operation}</c>
        /// .
        ...
        /// </param>
        /// <returns>
        /// The string representation of this <see cref="DiscoveredApiOperationName"/> with pattern
        /// <c>
        /// projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}/discoveredApiOperations/{discovered_api_operation}</c>
        /// .
        /// </returns>
        public static string Format(string projectId, string locationId, string discoveredApiObservationId, string discoveredApiOperationId) =>
            FormatProjectLocationDiscoveredApiObservationDiscoveredApiOperation(projectId, locationId, discoveredApiObservationId, discoveredApiOperationId);
        ...
        /// .
        /// </returns>
        public static string FormatProjectLocationDiscoveredApiObservationDiscoveredApiOperation(string projectId, string locationId, string discoveredApiObservationId, string discoveredApiOperationId) =>
            s_projectLocationDiscoveredApiObservationDiscoveredApiOperation.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiObservationId, nameof(discoveredApiObservationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiOperationId, nameof(discoveredApiOperationId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="DiscoveredApiOperationName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="discoveredApiOperationName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="DiscoveredApiOperationName"/> if successful.</returns>
        public static DiscoveredApiOperationName Parse(string discoveredApiOperationName) =>
            Parse(discoveredApiOperationName, false);
        ...
        /// </param>
        /// <returns>The parsed <see cref="DiscoveredApiOperationName"/> if successful.</returns>
        public static DiscoveredApiOperationName Parse(string discoveredApiOperationName, bool allowUnparsed) =>
            TryParse(discoveredApiOperationName, allowUnparsed, out DiscoveredApiOperationName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="DiscoveredApiOperationName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="discoveredApiOperationName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="DiscoveredApiOperationName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string discoveredApiOperationName, out DiscoveredApiOperationName result) =>
            TryParse(discoveredApiOperationName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string discoveredApiOperationName, bool allowUnparsed, out DiscoveredApiOperationName result)
        {
            gax::GaxPreconditions.CheckNotNull(discoveredApiOperationName, nameof(discoveredApiOperationName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationDiscoveredApiObservationDiscoveredApiOperation.TryParseName(discoveredApiOperationName, out resourceName))
            {
                result = FromProjectLocationDiscoveredApiObservationDiscoveredApiOperation(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(discoveredApiOperationName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private DiscoveredApiOperationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string discoveredApiObservationId = null, string discoveredApiOperationId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            DiscoveredApiObservationId = discoveredApiObservationId;
            DiscoveredApiOperationId = discoveredApiOperationId;
            LocationId = locationId;
            ProjectId = projectId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="DiscoveredApiOperationName"/> class from the component parts of
        /// pattern
        /// <c>
        /// projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}/discoveredApiOperations/{discovered_api_operation}</c>
        /// </summary>
        ...
        /// The <c>DiscoveredApiOperation</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public DiscoveredApiOperationName(string projectId, string locationId, string discoveredApiObservationId, string discoveredApiOperationId) : this(ResourceNameType.ProjectLocationDiscoveredApiObservationDiscoveredApiOperation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), discoveredApiObservationId: gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiObservationId, nameof(discoveredApiObservationId)), discoveredApiOperationId: gax::GaxPreconditions.CheckNotNullOrEmpty(discoveredApiOperationId, nameof(discoveredApiOperationId)))
        {
        }
        ...
        /// <summary>
        /// The <c>DiscoveredApiOperation</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        public string DiscoveredApiOperationId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationDiscoveredApiObservationDiscoveredApiOperation: return s_projectLocationDiscoveredApiObservationDiscoveredApiOperation.Expand(ProjectId, LocationId, DiscoveredApiObservationId, DiscoveredApiOperationId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as DiscoveredApiOperationName);

        /// <inheritdoc/>
        public bool Equals(DiscoveredApiOperationName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(DiscoveredApiOperationName a, DiscoveredApiOperationName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(DiscoveredApiOperationName a, DiscoveredApiOperationName b) => !(a == b);
    }
    ...
    public partial class GoogleServiceAccountConfig
    {
        /// <summary>
    ...
    public partial class SourceMetadata
    {
        ...
        {
            public partial class PluginInstanceActionSource
            {
                /// <summary>
    ...
    public partial class DiscoveredApiObservation
    {
        /// <summary>
        ...
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="SourceLocations"/> resource name property.
        /// </summary>
        public gax::ResourceNameList<gagr::LocationName> SourceLocationsAsLocationNames
        {
            get => new gax::ResourceNameList<gagr::LocationName>(SourceLocations, s => string.IsNullOrEmpty(s) ? null : gagr::LocationName.Parse(s, allowUnparsed: true));
        }
    }

    public partial class DiscoveredApiOperation
    {
        /// <summary>
