...
namespace Google.Cloud.ApiHub.V1
{
    ...
    public abstract partial class RuntimeProjectAttachmentServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(RuntimeProjectAttachmentService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc | gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
