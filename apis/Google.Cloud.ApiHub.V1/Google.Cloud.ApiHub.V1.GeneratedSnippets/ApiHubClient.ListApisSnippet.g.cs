...
{
    // [START apihub_v1_generated_ApiHub_ListApis_sync_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public void ListApis()
        {
            ...
            // Make the request
            PagedEnumerable<ListApisResponse, Api> response = apiHubClient.ListApis(parent);
    ...
    // [END apihub_v1_generated_ApiHub_ListApis_sync_flattened]
}
