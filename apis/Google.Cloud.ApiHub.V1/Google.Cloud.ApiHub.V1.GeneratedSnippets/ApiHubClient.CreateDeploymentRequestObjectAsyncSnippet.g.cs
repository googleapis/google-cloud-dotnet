...
{
    // [START apihub_v1_generated_ApiHub_CreateDeployment_async]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task CreateDeploymentRequestObjectAsync()
        {
            ...
            // Make the request
            Deployment response = await apiHubClient.CreateDeploymentAsync(request);
        }
    }
    // [END apihub_v1_generated_ApiHub_CreateDeployment_async]
}
