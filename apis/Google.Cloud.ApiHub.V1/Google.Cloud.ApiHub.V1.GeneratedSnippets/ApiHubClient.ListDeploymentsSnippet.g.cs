...
{
    // [START apihub_v1_generated_ApiHub_ListDeployments_sync_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public void ListDeployments()
        {
            ...
            // Make the request
            PagedEnumerable<ListDeploymentsResponse, Deployment> response = apiHubClient.ListDeployments(parent);
    ...
    // [END apihub_v1_generated_ApiHub_ListDeployments_sync_flattened]
}
