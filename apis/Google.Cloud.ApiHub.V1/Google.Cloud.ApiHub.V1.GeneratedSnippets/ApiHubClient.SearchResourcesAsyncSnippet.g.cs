...
{
    // [START apihub_v1_generated_ApiHub_SearchResources_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task SearchResourcesAsync()
        {
            ...
            string query = "";
            // Make the request
            PagedAsyncEnumerable<SearchResourcesResponse, SearchResult> response = apiHubClient.SearchResourcesAsync(location, query);
            ...
            await response.AsRawResponses().ForEachAsync((SearchResourcesResponse page) =>
            {
    ...
    // [END apihub_v1_generated_ApiHub_SearchResources_async_flattened]
}
