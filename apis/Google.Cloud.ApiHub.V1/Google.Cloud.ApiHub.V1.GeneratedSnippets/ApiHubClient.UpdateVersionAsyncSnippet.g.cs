...
{
    // [START apihub_v1_generated_ApiHub_UpdateVersion_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task UpdateVersionAsync()
        {
            ...
            // Make the request
            Version response = await apiHubClient.UpdateVersionAsync(version, updateMask);
        }
    }
    // [END apihub_v1_generated_ApiHub_UpdateVersion_async_flattened]
}
