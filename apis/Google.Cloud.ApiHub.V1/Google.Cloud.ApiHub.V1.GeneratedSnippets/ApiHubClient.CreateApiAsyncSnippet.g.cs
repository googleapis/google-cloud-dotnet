...
{
    // [START apihub_v1_generated_ApiHub_CreateApi_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task CreateApiAsync()
        {
            ...
            string apiId = "";
            // Make the request
            Api response = await apiHubClient.CreateApiAsync(parent, api, apiId);
        }
    }
    // [END apihub_v1_generated_ApiHub_CreateApi_async_flattened]
}
