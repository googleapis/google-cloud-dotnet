...
{
    // [START apihub_v1_generated_ApiHub_CreateAttribute_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task CreateAttributeAsync()
        {
            ...
            string attributeId = "";
            // Make the request
            Attribute response = await apiHubClient.CreateAttributeAsync(parent, attribute, attributeId);
        }
    }
    // [END apihub_v1_generated_ApiHub_CreateAttribute_async_flattened]
}
