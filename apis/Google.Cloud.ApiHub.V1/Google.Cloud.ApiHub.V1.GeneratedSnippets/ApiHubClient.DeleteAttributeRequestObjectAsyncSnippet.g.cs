...
{
    // [START apihub_v1_generated_ApiHub_DeleteAttribute_async]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task DeleteAttributeRequestObjectAsync()
        {
            ...
            {
                AttributeName = AttributeName.FromProjectLocationAttribute("[PROJECT]", "[LOCATION]", "[ATTRIBUTE]"),
            };
            // Make the request
            await apiHubClient.DeleteAttributeAsync(request);
        }
    }
    // [END apihub_v1_generated_ApiHub_DeleteAttribute_async]
}
