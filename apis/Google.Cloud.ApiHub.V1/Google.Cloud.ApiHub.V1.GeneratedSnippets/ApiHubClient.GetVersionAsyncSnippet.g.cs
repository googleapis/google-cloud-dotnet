...
{
    // [START apihub_v1_generated_ApiHub_GetVersion_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task GetVersionAsync()
        {
            ...
            // Make the request
            Version response = await apiHubClient.GetVersionAsync(name);
        }
    }
    // [END apihub_v1_generated_ApiHub_GetVersion_async_flattened]
}
