...
{
    // [START apihub_v1_generated_ApiHub_GetExternalApi_sync]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public void GetExternalApiRequestObject()
        {
            ...
            GetExternalApiRequest request = new GetExternalApiRequest
            {
                ExternalApiName = ExternalApiName.FromProjectLocationExternalApi("[PROJECT]", "[LOCATION]", "[EXTERNAL_API]"),
            };
            // Make the request
            ExternalApi response = apiHubClient.GetExternalApi(request);
        }
    }
    // [END apihub_v1_generated_ApiHub_GetExternalApi_sync]
}
