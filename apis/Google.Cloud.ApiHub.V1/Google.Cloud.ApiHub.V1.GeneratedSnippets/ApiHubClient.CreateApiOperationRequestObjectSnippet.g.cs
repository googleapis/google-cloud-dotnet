...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public void CreateApiOperationRequestObject()
        {
            ...
            CreateApiOperationRequest request = new CreateApiOperationRequest
            {
                ParentAsVersionName = VersionName.FromProjectLocationApiVersion("[PROJECT]", "[LOCATION]", "[API]", "[VERSION]"),
                ApiOperationId = "",
