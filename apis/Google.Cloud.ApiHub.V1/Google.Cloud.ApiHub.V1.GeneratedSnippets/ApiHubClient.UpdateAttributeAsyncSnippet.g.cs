...
{
    // [START apihub_v1_generated_ApiHub_UpdateAttribute_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task UpdateAttributeAsync()
        {
            ...
            // Make the request
            Attribute response = await apiHubClient.UpdateAttributeAsync(attribute, updateMask);
        }
    }
    // [END apihub_v1_generated_ApiHub_UpdateAttribute_async_flattened]
}
