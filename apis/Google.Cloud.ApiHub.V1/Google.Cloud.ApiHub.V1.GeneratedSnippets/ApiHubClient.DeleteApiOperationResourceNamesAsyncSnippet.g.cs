...
{
    // [START apihub_v1_generated_ApiHub_DeleteApiOperation_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task DeleteApiOperationResourceNamesAsync()
        {
            ...
            ApiOperationName name = ApiOperationName.FromProjectLocationApiVersionOperation("[PROJECT]", "[LOCATION]", "[API]", "[VERSION]", "[OPERATION]");
            // Make the request
            await apiHubClient.DeleteApiOperationAsync(name);
        }
    }
    // [END apihub_v1_generated_ApiHub_DeleteApiOperation_async_flattened_resourceNames]
}
