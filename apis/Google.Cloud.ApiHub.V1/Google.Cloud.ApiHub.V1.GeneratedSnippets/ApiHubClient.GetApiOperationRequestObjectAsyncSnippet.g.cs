...
{
    // [START apihub_v1_generated_ApiHub_GetApiOperation_async]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task GetApiOperationRequestObjectAsync()
        {
            ...
            GetApiOperationRequest request = new GetApiOperationRequest
            {
                ApiOperationName = ApiOperationName.FromProjectLocationApiVersionOperation("[PROJECT]", "[LOCATION]", "[API]", "[VERSION]", "[OPERATION]"),
            };
            // Make the request
            ApiOperation response = await apiHubClient.GetApiOperationAsync(request);
        }
    }
