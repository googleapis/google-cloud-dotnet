...
{
    // [START apihub_v1_generated_ApiHubPlugin_ListPlugins_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.ApiHub.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedApiHubPluginClientSnippets
    {
        ...
        public async Task ListPluginsAsync()
        {
            ...
            await foreach (Plugin item in response)
            {
            ...
            await foreach (ListPluginsResponse page in response.AsRawResponses())
            {
    ...
    // [END apihub_v1_generated_ApiHubPlugin_ListPlugins_async_flattened]
}
