...
{
    // [START apihub_v1_generated_ApiHubPlugin_ListPluginInstances_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubPluginClientSnippets
    {
        ...
        public async Task ListPluginInstancesResourceNamesAsync()
        {
            ...
            await foreach (PluginInstance item in response)
            {
            ...
            await foreach (ListPluginInstancesResponse page in response.AsRawResponses())
            {
    ...
    // [END apihub_v1_generated_ApiHubPlugin_ListPluginInstances_async_flattened_resourceNames]
}
