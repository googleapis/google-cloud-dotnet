...
{
    // [START apihub_v1_generated_RuntimeProjectAttachmentService_ListRuntimeProjectAttachments_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedRuntimeProjectAttachmentServiceClientSnippets
    {
        ...
        public async Task ListRuntimeProjectAttachmentsResourceNamesAsync()
        {
            ...
            await foreach (RuntimeProjectAttachment item in response)
            {
            ...
            await foreach (ListRuntimeProjectAttachmentsResponse page in response.AsRawResponses())
            {
    ...
    // [END apihub_v1_generated_RuntimeProjectAttachmentService_ListRuntimeProjectAttachments_async_flattened_resourceNames]
}
