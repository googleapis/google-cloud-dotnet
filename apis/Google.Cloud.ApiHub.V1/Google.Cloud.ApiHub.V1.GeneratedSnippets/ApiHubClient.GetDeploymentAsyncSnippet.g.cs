...
{
    // [START apihub_v1_generated_ApiHub_GetDeployment_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task GetDeploymentAsync()
        {
            ...
            // Make the request
            Deployment response = await apiHubClient.GetDeploymentAsync(name);
        }
    }
    // [END apihub_v1_generated_ApiHub_GetDeployment_async_flattened]
}
