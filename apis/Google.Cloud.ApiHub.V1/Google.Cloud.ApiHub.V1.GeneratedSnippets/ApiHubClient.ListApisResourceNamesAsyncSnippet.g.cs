...
{
    // [START apihub_v1_generated_ApiHub_ListApis_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task ListApisResourceNamesAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListApisResponse, Api> response = apiHubClient.ListApisAsync(parent);
    ...
    // [END apihub_v1_generated_ApiHub_ListApis_async_flattened_resourceNames]
}
