...
{
    // [START apihub_v1_generated_ApiHub_ListDeployments_sync]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public void ListDeploymentsRequestObject()
        {
            ...
            // Make the request
            PagedEnumerable<ListDeploymentsResponse, Deployment> response = apiHubClient.ListDeployments(request);
    ...
    // [END apihub_v1_generated_ApiHub_ListDeployments_sync]
}
