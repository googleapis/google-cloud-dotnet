...
{
    // [START apihub_v1_generated_ApiHub_UpdateDeployment_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task UpdateDeploymentAsync()
        {
            ...
            // Make the request
            Deployment response = await apiHubClient.UpdateDeploymentAsync(deployment, updateMask);
        }
    }
    // [END apihub_v1_generated_ApiHub_UpdateDeployment_async_flattened]
}
