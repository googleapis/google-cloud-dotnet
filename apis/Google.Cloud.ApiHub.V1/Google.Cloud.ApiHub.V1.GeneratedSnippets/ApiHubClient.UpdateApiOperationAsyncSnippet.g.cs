...
{
    // [START apihub_v1_generated_ApiHub_UpdateApiOperation_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task UpdateApiOperationAsync()
        {
            ...
            // Make the request
            ApiOperation response = await apiHubClient.UpdateApiOperationAsync(apiOperation, updateMask);
        }
    }
    // [END apihub_v1_generated_ApiHub_UpdateApiOperation_async_flattened]
}
