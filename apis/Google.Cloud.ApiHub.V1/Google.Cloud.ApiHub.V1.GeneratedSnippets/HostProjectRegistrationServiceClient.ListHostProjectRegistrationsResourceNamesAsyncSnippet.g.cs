...
{
    // [START apihub_v1_generated_HostProjectRegistrationService_ListHostProjectRegistrations_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedHostProjectRegistrationServiceClientSnippets
    {
        ...
        public async Task ListHostProjectRegistrationsResourceNamesAsync()
        {
            ...
            await foreach (HostProjectRegistration item in response)
            {
            ...
            await foreach (ListHostProjectRegistrationsResponse page in response.AsRawResponses())
            {
    ...
    // [END apihub_v1_generated_HostProjectRegistrationService_ListHostProjectRegistrations_async_flattened_resourceNames]
}
