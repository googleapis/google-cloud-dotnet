...
{
    // [START apihub_v1_generated_ApiHubCurate_ListCurations_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubCurateClientSnippets
    {
        ...
        public async Task ListCurationsResourceNamesAsync()
        {
            ...
            await foreach (Curation item in response)
            {
            ...
            await foreach (ListCurationsResponse page in response.AsRawResponses())
            {
    ...
    // [END apihub_v1_generated_ApiHubCurate_ListCurations_async_flattened_resourceNames]
}
