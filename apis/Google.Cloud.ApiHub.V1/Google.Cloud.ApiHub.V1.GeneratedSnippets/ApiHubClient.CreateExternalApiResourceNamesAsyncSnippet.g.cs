...
{
    // [START apihub_v1_generated_ApiHub_CreateExternalApi_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task CreateExternalApiResourceNamesAsync()
        {
            ...
            // Make the request
            ExternalApi response = await apiHubClient.CreateExternalApiAsync(parent, externalApi, externalApiId);
        }
    }
    // [END apihub_v1_generated_ApiHub_CreateExternalApi_async_flattened_resourceNames]
}
