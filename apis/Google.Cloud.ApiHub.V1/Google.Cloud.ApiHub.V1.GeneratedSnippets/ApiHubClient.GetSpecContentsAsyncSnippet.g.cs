...
{
    // [START apihub_v1_generated_ApiHub_GetSpecContents_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task GetSpecContentsAsync()
        {
            ...
            // Make the request
            SpecContents response = await apiHubClient.GetSpecContentsAsync(name);
        }
    }
    // [END apihub_v1_generated_ApiHub_GetSpecContents_async_flattened]
}
