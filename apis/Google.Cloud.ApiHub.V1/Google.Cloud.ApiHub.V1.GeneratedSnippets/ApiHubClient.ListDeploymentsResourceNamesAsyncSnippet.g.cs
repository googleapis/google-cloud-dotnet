...
{
    // [START apihub_v1_generated_ApiHub_ListDeployments_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task ListDeploymentsResourceNamesAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListDeploymentsResponse, Deployment> response = apiHubClient.ListDeploymentsAsync(parent);
    ...
    // [END apihub_v1_generated_ApiHub_ListDeployments_async_flattened_resourceNames]
}
