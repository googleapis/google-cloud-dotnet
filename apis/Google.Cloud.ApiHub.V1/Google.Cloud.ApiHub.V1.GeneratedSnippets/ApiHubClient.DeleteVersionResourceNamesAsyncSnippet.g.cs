...
{
    // [START apihub_v1_generated_ApiHub_DeleteVersion_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task DeleteVersionResourceNamesAsync()
        {
            ...
            VersionName name = VersionName.FromProjectLocationApiVersion("[PROJECT]", "[LOCATION]", "[API]", "[VERSION]");
            // Make the request
            await apiHubClient.DeleteVersionAsync(name);
        }
    }
    // [END apihub_v1_generated_ApiHub_DeleteVersion_async_flattened_resourceNames]
}
