...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public void GetDefinitionRequestObject()
        {
            ...
            GetDefinitionRequest request = new GetDefinitionRequest
            {
                DefinitionName = DefinitionName.FromProjectLocationApiVersionDefinition("[PROJECT]", "[LOCATION]", "[API]", "[VERSION]", "[DEFINITION]"),
            };
            // Make the request
