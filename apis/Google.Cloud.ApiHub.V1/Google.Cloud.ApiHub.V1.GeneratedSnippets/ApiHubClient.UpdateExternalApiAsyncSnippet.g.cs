...
{
    // [START apihub_v1_generated_ApiHub_UpdateExternalApi_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task UpdateExternalApiAsync()
        {
            ...
            // Make the request
            ExternalApi response = await apiHubClient.UpdateExternalApiAsync(externalApi, updateMask);
        }
    }
    // [END apihub_v1_generated_ApiHub_UpdateExternalApi_async_flattened]
}
