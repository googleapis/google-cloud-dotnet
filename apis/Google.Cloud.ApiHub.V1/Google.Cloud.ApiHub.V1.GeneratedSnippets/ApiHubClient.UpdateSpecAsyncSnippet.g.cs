...
{
    // [START apihub_v1_generated_ApiHub_UpdateSpec_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task UpdateSpecAsync()
        {
            ...
            // Make the request
            Spec response = await apiHubClient.UpdateSpecAsync(spec, updateMask);
        }
    }
    // [END apihub_v1_generated_ApiHub_UpdateSpec_async_flattened]
}
