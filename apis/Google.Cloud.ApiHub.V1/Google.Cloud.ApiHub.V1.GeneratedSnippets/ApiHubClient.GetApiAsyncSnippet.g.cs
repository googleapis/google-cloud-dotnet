...
{
    // [START apihub_v1_generated_ApiHub_GetApi_async_flattened]
    ...
    public sealed partial class GeneratedApiHubClientSnippets
    {
        ...
        public async Task GetApiAsync()
        {
            ...
            // Make the request
            Api response = await apiHubClient.GetApiAsync(name);
        }
    }
    // [END apihub_v1_generated_ApiHub_GetApi_async_flattened]
}
