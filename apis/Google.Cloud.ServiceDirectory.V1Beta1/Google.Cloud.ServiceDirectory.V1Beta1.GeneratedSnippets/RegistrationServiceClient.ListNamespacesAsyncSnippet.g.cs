...
{
    // [START servicedirectory_v1beta1_generated_RegistrationService_ListNamespaces_async_flattened]
    ...
    public sealed partial class GeneratedRegistrationServiceClientSnippets
    {
        ...
        public async Task ListNamespacesAsync()
        {
            ...
            await foreach (ListNamespacesResponse page in response.AsRawResponses())
            {
    ...
    // [END servicedirectory_v1beta1_generated_RegistrationService_ListNamespaces_async_flattened]
}
