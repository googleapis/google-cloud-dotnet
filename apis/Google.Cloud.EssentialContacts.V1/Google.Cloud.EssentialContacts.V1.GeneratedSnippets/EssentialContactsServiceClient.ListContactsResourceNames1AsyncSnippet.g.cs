...
{
    // [START essentialcontacts_v1_generated_EssentialContactsService_ListContacts_async_flattened_resourceNames1]
    ...
    public sealed partial class GeneratedEssentialContactsServiceClientSnippets
    {
        ...
        public async Task ListContactsResourceNames1Async()
        {
            ...
            await foreach (Contact item in response)
            {
            ...
            await foreach (ListContactsResponse page in response.AsRawResponses())
            {
    ...
    // [END essentialcontacts_v1_generated_EssentialContactsService_ListContacts_async_flattened_resourceNames1]
}
