...
namespace Google.Cloud.VectorSearch.V1
{
    ...
    {
        /// <summary>
        /// <see cref="gcvv::CryptoKeyName"/>-typed view over the <see cref="CryptoKeyName"/> resource name property.
        /// </summary>
        public gcvv::CryptoKeyName CryptoKeyNameAsCryptoKeyName
        {
            get => string.IsNullOrEmpty(CryptoKeyName) ? null : gcvv::CryptoKeyName.Parse(CryptoKeyName, allowUnparsed: true);
