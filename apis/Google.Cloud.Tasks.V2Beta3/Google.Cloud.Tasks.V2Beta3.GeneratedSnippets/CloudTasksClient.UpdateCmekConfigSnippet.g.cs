...
{
    // [START cloudtasks_v2beta3_generated_CloudTasks_UpdateCmekConfig_sync_flattened]
    ...
    public sealed partial class GeneratedCloudTasksClientSnippets
    {
        ...
        public void UpdateCmekConfig()
        {
            ...
            CmekConfig cmekConfig = new CmekConfig();
            FieldMask updateMask = new FieldMask();
            // Make the request
            CmekConfig response = cloudTasksClient.UpdateCmekConfig(cmekConfig, updateMask);
        }
    }
    // [END cloudtasks_v2beta3_generated_CloudTasks_UpdateCmekConfig_sync_flattened]
}
