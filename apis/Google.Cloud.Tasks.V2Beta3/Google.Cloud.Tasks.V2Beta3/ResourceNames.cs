...
namespace Google.Cloud.Tasks.V2Beta3
{
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Tasks.V2Beta3.LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
        public Google.Cloud.Tasks.V2Beta3.LocationName ParentAsLocationName
        {
            get { return string.IsNullOrEmpty(Parent) ? null : Google.Cloud.Tasks.V2Beta3.LocationName.Parse(Parent); }
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Tasks.V2Beta3.QueueName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
        public Google.Cloud.Tasks.V2Beta3.QueueName ParentAsQueueName
        {
            get { return string.IsNullOrEmpty(Parent) ? null : Google.Cloud.Tasks.V2Beta3.QueueName.Parse(Parent); }
            set { Parent = value != null ? value.ToString() : ""; }
        }
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Tasks.V2Beta3.QueueName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public Google.Cloud.Tasks.V2Beta3.QueueName QueueName
        {
            get { return string.IsNullOrEmpty(Name) ? null : Google.Cloud.Tasks.V2Beta3.QueueName.Parse(Name); }
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Tasks.V2Beta3.TaskName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public Google.Cloud.Tasks.V2Beta3.TaskName TaskName
        {
            get { return string.IsNullOrEmpty(Name) ? null : Google.Cloud.Tasks.V2Beta3.TaskName.Parse(Name); }
            set { Name = value != null ? value.ToString() : ""; }
        }
