...
namespace Google.Cloud.Security.PrivateCA.V1Beta1.Snippets
{
    ...
    public sealed class GeneratedCertificateAuthorityServiceClientSnippets
    {
        ...
        /// <summary>Snippet for CreateCertificateRevocationList</summary>
        public void CreateCertificateRevocationListRequestObject()
        {
            // Snippet: CreateCertificateRevocationList(CreateCertificateRevocationListRequest, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            CreateCertificateRevocationListRequest request = new CreateCertificateRevocationListRequest
            {
                ParentAsCertificateAuthorityName = CertificateAuthorityName.FromProjectLocationCertificateAuthority("[PROJECT]", "[LOCATION]", "[CERTIFICATE_AUTHORITY]"),
            ...
            // Make the request
            Operation<CertificateRevocationList, OperationMetadata> response = certificateAuthorityServiceClient.CreateCertificateRevocationList(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<CertificateRevocationList, OperationMetadata> retrievedResponse = certificateAuthorityServiceClient.PollOnceCreateCertificateRevocationList(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        /// <summary>Snippet for CreateCertificateRevocationListAsync</summary>
        public async Task CreateCertificateRevocationListRequestObjectAsync()
        {
            // Snippet: CreateCertificateRevocationListAsync(CreateCertificateRevocationListRequest, CallSettings)
            // Additional: CreateCertificateRevocationListAsync(CreateCertificateRevocationListRequest, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            CreateCertificateRevocationListRequest request = new CreateCertificateRevocationListRequest
            ...
            // Make the request
            Operation<CertificateRevocationList, OperationMetadata> response = await certificateAuthorityServiceClient.CreateCertificateRevocationListAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<CertificateRevocationList, OperationMetadata> retrievedResponse = await certificateAuthorityServiceClient.PollOnceCreateCertificateRevocationListAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        {
            // Snippet: CreateCertificateRevocationList(string, CertificateRevocationList, string, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]/certificateAuthorities/[CERTIFICATE_AUTHORITY]";
            ...
            // Make the request
            Operation<CertificateRevocationList, OperationMetadata> response = certificateAuthorityServiceClient.CreateCertificateRevocationList(parent, certificateRevocationList, certificateRevocationListId);
        ...
        /// <summary>Snippet for CreateCertificateRevocationListAsync</summary>
        public async Task CreateCertificateRevocationListAsync()
        {
            // Snippet: CreateCertificateRevocationListAsync(string, CertificateRevocationList, string, CallSettings)
            // Additional: CreateCertificateRevocationListAsync(string, CertificateRevocationList, string, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]/certificateAuthorities/[CERTIFICATE_AUTHORITY]";
            ...
            string certificateRevocationListId = "";
            // Make the request
            Operation<CertificateRevocationList, OperationMetadata> response = await certificateAuthorityServiceClient.CreateCertificateRevocationListAsync(parent, certificateRevocationList, certificateRevocationListId);
        ...
        /// <summary>Snippet for CreateCertificateRevocationList</summary>
        public void CreateCertificateRevocationListResourceNames()
        {
            // Snippet: CreateCertificateRevocationList(CertificateAuthorityName, CertificateRevocationList, string, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            CertificateAuthorityName parent = CertificateAuthorityName.FromProjectLocationCertificateAuthority("[PROJECT]", "[LOCATION]", "[CERTIFICATE_AUTHORITY]");
        ...
        /// <summary>Snippet for CreateCertificateRevocationListAsync</summary>
        public async Task CreateCertificateRevocationListResourceNamesAsync()
        {
            // Snippet: CreateCertificateRevocationListAsync(CertificateAuthorityName, CertificateRevocationList, string, CallSettings)
            // Additional: CreateCertificateRevocationListAsync(CertificateAuthorityName, CertificateRevocationList, string, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            CertificateAuthorityName parent = CertificateAuthorityName.FromProjectLocationCertificateAuthority("[PROJECT]", "[LOCATION]", "[CERTIFICATE_AUTHORITY]");
        ...
        /// <summary>Snippet for CreateReusableConfig</summary>
        public void CreateReusableConfigRequestObject()
        {
            // Snippet: CreateReusableConfig(CreateReusableConfigRequest, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            CreateReusableConfigRequest request = new CreateReusableConfigRequest
            {
                ParentAsLocationName = LocationName.FromProjectLocation("[PROJECT]", "[LOCATION]"),
                ReusableConfigId = "",
                ReusableConfig = new ReusableConfig(),
                RequestId = "",
            };
            // Make the request
            Operation<ReusableConfig, OperationMetadata> response = certificateAuthorityServiceClient.CreateReusableConfig(request);

            // Poll until the returned long-running operation is complete
            Operation<ReusableConfig, OperationMetadata> completedResponse = response.PollUntilCompleted();
            // Retrieve the operation result
            ReusableConfig result = completedResponse.Result;

            // Or get the name of the operation
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<ReusableConfig, OperationMetadata> retrievedResponse = certificateAuthorityServiceClient.PollOnceCreateReusableConfig(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
                ReusableConfig retrievedResult = retrievedResponse.Result;
            }
            // End snippet
        }

        /// <summary>Snippet for CreateReusableConfigAsync</summary>
        public async Task CreateReusableConfigRequestObjectAsync()
        {
            // Snippet: CreateReusableConfigAsync(CreateReusableConfigRequest, CallSettings)
            // Additional: CreateReusableConfigAsync(CreateReusableConfigRequest, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            CreateReusableConfigRequest request = new CreateReusableConfigRequest
            ...
            // Make the request
            Operation<ReusableConfig, OperationMetadata> response = await certificateAuthorityServiceClient.CreateReusableConfigAsync(request);

            // Poll until the returned long-running operation is complete
            Operation<ReusableConfig, OperationMetadata> completedResponse = await response.PollUntilCompletedAsync();
            // Retrieve the operation result
            ReusableConfig result = completedResponse.Result;
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<ReusableConfig, OperationMetadata> retrievedResponse = await certificateAuthorityServiceClient.PollOnceCreateReusableConfigAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        {
            // Snippet: CreateReusableConfig(string, ReusableConfig, string, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]";
            ReusableConfig reusableConfig = new ReusableConfig();
            string reusableConfigId = "";
            // Make the request
            Operation<ReusableConfig, OperationMetadata> response = certificateAuthorityServiceClient.CreateReusableConfig(parent, reusableConfig, reusableConfigId);
        ...
        /// <summary>Snippet for CreateReusableConfigAsync</summary>
        public async Task CreateReusableConfigAsync()
        {
            // Snippet: CreateReusableConfigAsync(string, ReusableConfig, string, CallSettings)
            // Additional: CreateReusableConfigAsync(string, ReusableConfig, string, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]";
            ...
            string reusableConfigId = "";
            // Make the request
            Operation<ReusableConfig, OperationMetadata> response = await certificateAuthorityServiceClient.CreateReusableConfigAsync(parent, reusableConfig, reusableConfigId);
        ...
        /// <summary>Snippet for CreateReusableConfig</summary>
        public void CreateReusableConfigResourceNames()
        {
            // Snippet: CreateReusableConfig(LocationName, ReusableConfig, string, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            LocationName parent = LocationName.FromProjectLocation("[PROJECT]", "[LOCATION]");
        ...
        /// <summary>Snippet for CreateReusableConfigAsync</summary>
        public async Task CreateReusableConfigResourceNamesAsync()
        {
            // Snippet: CreateReusableConfigAsync(LocationName, ReusableConfig, string, CallSettings)
            // Additional: CreateReusableConfigAsync(LocationName, ReusableConfig, string, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            LocationName parent = LocationName.FromProjectLocation("[PROJECT]", "[LOCATION]");
        ...
        /// <summary>Snippet for DeleteReusableConfig</summary>
        public void DeleteReusableConfigRequestObject()
        {
            // Snippet: DeleteReusableConfig(DeleteReusableConfigRequest, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            DeleteReusableConfigRequest request = new DeleteReusableConfigRequest
            {
                ReusableConfigName = ReusableConfigName.FromProjectLocationReusableConfig("[PROJECT]", "[LOCATION]", "[REUSABLE_CONFIG]"),
                RequestId = "",
            };
            // Make the request
            Operation<Empty, OperationMetadata> response = certificateAuthorityServiceClient.DeleteReusableConfig(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Empty, OperationMetadata> retrievedResponse = certificateAuthorityServiceClient.PollOnceDeleteReusableConfig(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        /// <summary>Snippet for DeleteReusableConfigAsync</summary>
        public async Task DeleteReusableConfigRequestObjectAsync()
        {
            // Snippet: DeleteReusableConfigAsync(DeleteReusableConfigRequest, CallSettings)
            // Additional: DeleteReusableConfigAsync(DeleteReusableConfigRequest, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            DeleteReusableConfigRequest request = new DeleteReusableConfigRequest
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = await certificateAuthorityServiceClient.DeleteReusableConfigAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Empty, OperationMetadata> retrievedResponse = await certificateAuthorityServiceClient.PollOnceDeleteReusableConfigAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        {
            // Snippet: DeleteReusableConfig(string, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/reusableConfigs/[REUSABLE_CONFIG]";
            // Make the request
            Operation<Empty, OperationMetadata> response = certificateAuthorityServiceClient.DeleteReusableConfig(name);
        ...
        /// <summary>Snippet for DeleteReusableConfigAsync</summary>
        public async Task DeleteReusableConfigAsync()
        {
            // Snippet: DeleteReusableConfigAsync(string, CallSettings)
            // Additional: DeleteReusableConfigAsync(string, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/reusableConfigs/[REUSABLE_CONFIG]";
            // Make the request
            Operation<Empty, OperationMetadata> response = await certificateAuthorityServiceClient.DeleteReusableConfigAsync(name);
        ...
        /// <summary>Snippet for DeleteReusableConfig</summary>
        public void DeleteReusableConfigResourceNames()
        {
            // Snippet: DeleteReusableConfig(ReusableConfigName, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for DeleteReusableConfigAsync</summary>
        public async Task DeleteReusableConfigResourceNamesAsync()
        {
            // Snippet: DeleteReusableConfigAsync(ReusableConfigName, CallSettings)
            // Additional: DeleteReusableConfigAsync(ReusableConfigName, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            ReusableConfigName name = ReusableConfigName.FromProjectLocationReusableConfig("[PROJECT]", "[LOCATION]", "[REUSABLE_CONFIG]");
        ...
        /// <summary>Snippet for UpdateReusableConfig</summary>
        public void UpdateReusableConfigRequestObject()
        {
            // Snippet: UpdateReusableConfig(UpdateReusableConfigRequest, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            UpdateReusableConfigRequest request = new UpdateReusableConfigRequest
            {
                ReusableConfig = new ReusableConfig(),
                UpdateMask = new FieldMask(),
                RequestId = "",
            ...
            // Make the request
            Operation<ReusableConfig, OperationMetadata> response = certificateAuthorityServiceClient.UpdateReusableConfig(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<ReusableConfig, OperationMetadata> retrievedResponse = certificateAuthorityServiceClient.PollOnceUpdateReusableConfig(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        /// <summary>Snippet for UpdateReusableConfigAsync</summary>
        public async Task UpdateReusableConfigRequestObjectAsync()
        {
            // Snippet: UpdateReusableConfigAsync(UpdateReusableConfigRequest, CallSettings)
            // Additional: UpdateReusableConfigAsync(UpdateReusableConfigRequest, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            UpdateReusableConfigRequest request = new UpdateReusableConfigRequest
            ...
            // Make the request
            Operation<ReusableConfig, OperationMetadata> response = await certificateAuthorityServiceClient.UpdateReusableConfigAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<ReusableConfig, OperationMetadata> retrievedResponse = await certificateAuthorityServiceClient.PollOnceUpdateReusableConfigAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        {
            // Snippet: UpdateReusableConfig(ReusableConfig, FieldMask, CallSettings)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = CertificateAuthorityServiceClient.Create();
            // Initialize request argument(s)
            ReusableConfig reusableConfig = new ReusableConfig();
            FieldMask updateMask = new FieldMask();
            // Make the request
            Operation<ReusableConfig, OperationMetadata> response = certificateAuthorityServiceClient.UpdateReusableConfig(reusableConfig, updateMask);
        ...
        /// <summary>Snippet for UpdateReusableConfigAsync</summary>
        public async Task UpdateReusableConfigAsync()
        {
            // Snippet: UpdateReusableConfigAsync(ReusableConfig, FieldMask, CallSettings)
            // Additional: UpdateReusableConfigAsync(ReusableConfig, FieldMask, CancellationToken)
            // Create client
            CertificateAuthorityServiceClient certificateAuthorityServiceClient = await CertificateAuthorityServiceClient.CreateAsync();
            // Initialize request argument(s)
            ReusableConfig reusableConfig = new ReusableConfig();
            FieldMask updateMask = new FieldMask();
            // Make the request
            Operation<ReusableConfig, OperationMetadata> response = await certificateAuthorityServiceClient.UpdateReusableConfigAsync(reusableConfig, updateMask);
