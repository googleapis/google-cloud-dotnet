...
namespace Google.Cloud.Datastore.Admin.V1.Snippets
{
    ...
    public sealed partial class GeneratedDatastoreAdminClientSnippets
    {
        ...
        public void CreateIndexRequestObject()
        {
            ...
            // Make the request
            Operation<Index, IndexOperationMetadata> response = datastoreAdminClient.CreateIndex(request);
            ...
            Operation<Index, IndexOperationMetadata> retrievedResponse = datastoreAdminClient.PollOnceCreateIndex(operationName);
