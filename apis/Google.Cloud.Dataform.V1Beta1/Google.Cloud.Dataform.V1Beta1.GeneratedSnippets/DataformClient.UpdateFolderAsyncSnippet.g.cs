...
{
    // [START dataform_v1beta1_generated_Dataform_UpdateFolder_async_flattened]
    ...
    public sealed partial class GeneratedDataformClientSnippets
    {
        ...
        public async Task UpdateFolderAsync()
        {
            ...
            // Make the request
            Folder response = await dataformClient.UpdateFolderAsync(folder, updateMask);
        }
    }
    // [END dataform_v1beta1_generated_Dataform_UpdateFolder_async_flattened]
}
