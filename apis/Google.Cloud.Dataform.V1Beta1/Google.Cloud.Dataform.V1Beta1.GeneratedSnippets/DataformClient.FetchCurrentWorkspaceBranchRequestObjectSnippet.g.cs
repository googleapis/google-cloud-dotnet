...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedDataformClientSnippets
    {
        ...
        public void FetchCurrentWorkspaceBranchRequestObject()
        {
            ...
            FetchCurrentWorkspaceBranchRequest request = new FetchCurrentWorkspaceBranchRequest
            {
                WorkspaceName = WorkspaceName.FromProjectLocationRepositoryWorkspace("[PROJECT]", "[LOCATION]", "[REPOSITORY]", "[WORKSPACE]"),
            };
            // Make the request
            FetchCurrentWorkspaceBranchResponse response = dataformClient.FetchCurrentWorkspaceBranch(request);
        }
    }
