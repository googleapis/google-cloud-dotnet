...
{
    // [START dataform_v1beta1_generated_Dataform_DeleteTeamFolder_async]
    ...
    public sealed partial class GeneratedDataformClientSnippets
    {
        ...
        public async Task DeleteTeamFolderRequestObjectAsync()
        {
            ...
            DeleteTeamFolderRequest request = new DeleteTeamFolderRequest
            {
                TeamFolderName = TeamFolderName.FromProjectLocationTeamFolder("[PROJECT]", "[LOCATION]", "[TEAM_FOLDER]"),
            };
            // Make the request
            await dataformClient.DeleteTeamFolderAsync(request);
        }
    }
    // [END dataform_v1beta1_generated_Dataform_DeleteTeamFolder_async]
}
