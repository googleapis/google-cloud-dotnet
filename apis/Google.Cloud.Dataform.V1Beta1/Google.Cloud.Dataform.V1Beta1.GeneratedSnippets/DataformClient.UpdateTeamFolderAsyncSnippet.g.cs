...
{
    // [START dataform_v1beta1_generated_Dataform_UpdateTeamFolder_async_flattened]
    ...
    public sealed partial class GeneratedDataformClientSnippets
    {
        ...
        public async Task UpdateTeamFolderAsync()
        {
            ...
            // Make the request
            TeamFolder response = await dataformClient.UpdateTeamFolderAsync(teamFolder, updateMask);
        }
    }
    // [END dataform_v1beta1_generated_Dataform_UpdateTeamFolder_async_flattened]
}
