...
namespace Google.Cloud.TextToSpeech.V1Beta1
{
    ...
    public abstract partial class TextToSpeechClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(TextToSpeech.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
