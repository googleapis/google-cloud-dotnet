...
{
    // [START gkebackup_v1_generated_BackupForGKE_ListRestoreChannels_async_flattened]
    ...
    public sealed partial class GeneratedBackupForGKEClientSnippets
    {
        ...
        public async Task ListRestoreChannelsAsync()
        {
            ...
            await foreach (RestoreChannel item in response)
            {
            ...
            await foreach (ListRestoreChannelsResponse page in response.AsRawResponses())
            {
    ...
    // [END gkebackup_v1_generated_BackupForGKE_ListRestoreChannels_async_flattened]
}
