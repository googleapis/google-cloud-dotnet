...
{
    // [START gkebackup_v1_generated_BackupForGKE_ListBackupPlanBindings_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBackupForGKEClientSnippets
    {
        ...
        public async Task ListBackupPlanBindingsResourceNamesAsync()
        {
            ...
            await foreach (BackupPlanBinding item in response)
            {
            ...
            await foreach (ListBackupPlanBindingsResponse page in response.AsRawResponses())
            {
    ...
    // [END gkebackup_v1_generated_BackupForGKE_ListBackupPlanBindings_async_flattened_resourceNames]
}
