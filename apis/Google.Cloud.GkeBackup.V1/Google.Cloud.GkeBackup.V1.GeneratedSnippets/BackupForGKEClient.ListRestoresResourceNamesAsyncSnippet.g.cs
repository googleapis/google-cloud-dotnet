...
{
    // [START gkebackup_v1_generated_BackupForGKE_ListRestores_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBackupForGKEClientSnippets
    {
        ...
        public async Task ListRestoresResourceNamesAsync()
        {
            ...
            await foreach (Restore item in response)
            {
            ...
            await foreach (ListRestoresResponse page in response.AsRawResponses())
            {
    ...
    // [END gkebackup_v1_generated_BackupForGKE_ListRestores_async_flattened_resourceNames]
}
