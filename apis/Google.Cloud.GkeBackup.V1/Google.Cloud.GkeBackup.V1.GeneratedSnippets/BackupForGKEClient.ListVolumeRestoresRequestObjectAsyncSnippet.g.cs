...
{
    // [START gkebackup_v1_generated_BackupForGKE_ListVolumeRestores_async]
    ...
    public sealed partial class GeneratedBackupForGKEClientSnippets
    {
        ...
        public async Task ListVolumeRestoresRequestObjectAsync()
        {
            ...
            await foreach (VolumeRestore item in response)
            {
            ...
            await foreach (ListVolumeRestoresResponse page in response.AsRawResponses())
            {
