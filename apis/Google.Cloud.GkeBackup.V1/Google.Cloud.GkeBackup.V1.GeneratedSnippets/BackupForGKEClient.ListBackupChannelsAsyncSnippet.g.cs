...
{
    // [START gkebackup_v1_generated_BackupForGKE_ListBackupChannels_async_flattened]
    ...
    public sealed partial class GeneratedBackupForGKEClientSnippets
    {
        ...
        public async Task ListBackupChannelsAsync()
        {
            ...
            await foreach (BackupChannel item in response)
            {
            ...
            await foreach (ListBackupChannelsResponse page in response.AsRawResponses())
            {
    ...
    // [END gkebackup_v1_generated_BackupForGKE_ListBackupChannels_async_flattened]
}
