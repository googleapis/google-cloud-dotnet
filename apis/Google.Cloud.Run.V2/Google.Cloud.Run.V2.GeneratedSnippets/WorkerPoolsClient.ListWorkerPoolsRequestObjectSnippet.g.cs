...
{
    // [START run_v2_generated_WorkerPools_ListWorkerPools_sync]
    ...
    public sealed partial class GeneratedWorkerPoolsClientSnippets
    {
        ...
        public void ListWorkerPoolsRequestObject()
        {
            ...
            // Make the request
            PagedEnumerable<ListWorkerPoolsResponse, WorkerPool> response = workerPoolsClient.ListWorkerPools(request);
