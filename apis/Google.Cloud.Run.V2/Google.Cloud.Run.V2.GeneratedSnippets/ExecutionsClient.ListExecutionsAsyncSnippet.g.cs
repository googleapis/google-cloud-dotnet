...
{
    // [START run_v2_generated_Executions_ListExecutions_async_flattened]
    ...
    public sealed partial class GeneratedExecutionsClientSnippets
    {
        ...
        public async Task ListExecutionsAsync()
        {
            ...
            await foreach (gcrv::Execution item in response)
            {
            ...
            await foreach (gcrv::ListExecutionsResponse page in response.AsRawResponses())
            {
    ...
    // [END run_v2_generated_Executions_ListExecutions_async_flattened]
}
