...
{
    // [START run_v2_generated_WorkerPools_ListWorkerPools_async_flattened]
    ...
    public sealed partial class GeneratedWorkerPoolsClientSnippets
    {
        ...
        public async Task ListWorkerPoolsAsync()
        {
            ...
            await foreach (gcrv::WorkerPool item in response)
            {
            ...
            await foreach (gcrv::ListWorkerPoolsResponse page in response.AsRawResponses())
            {
    ...
    // [END run_v2_generated_WorkerPools_ListWorkerPools_async_flattened]
}
