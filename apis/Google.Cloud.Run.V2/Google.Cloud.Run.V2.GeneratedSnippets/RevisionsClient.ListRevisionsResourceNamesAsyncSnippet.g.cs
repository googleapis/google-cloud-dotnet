...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedRevisionsClientSnippets
    {
        ...
        public async Task ListRevisionsResourceNamesAsync()
        {
            ...
            await foreach (gcrv::Revision item in response)
            {
            ...
            await foreach (gcrv::ListRevisionsResponse page in response.AsRawResponses())
            {
    ...
    // [END run_v2_generated_Revisions_ListRevisions_async_flattened_resourceNames]
}
