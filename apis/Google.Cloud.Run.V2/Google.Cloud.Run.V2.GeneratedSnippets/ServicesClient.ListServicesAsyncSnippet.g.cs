...
{
    // [START run_v2_generated_Services_ListServices_async_flattened]
    ...
    public sealed partial class GeneratedServicesClientSnippets
    {
        ...
        public async Task ListServicesAsync()
        {
            ...
            await foreach (gcrv::Service item in response)
            {
            ...
            await foreach (gcrv::ListServicesResponse page in response.AsRawResponses())
            {
    ...
    // [END run_v2_generated_Services_ListServices_async_flattened]
}
