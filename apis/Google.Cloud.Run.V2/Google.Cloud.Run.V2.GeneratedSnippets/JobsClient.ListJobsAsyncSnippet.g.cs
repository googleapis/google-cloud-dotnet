...
{
    // [START run_v2_generated_Jobs_ListJobs_async_flattened]
    ...
    public sealed partial class GeneratedJobsClientSnippets
    {
        ...
        public async Task ListJobsAsync()
        {
            ...
            await foreach (gcrv::Job item in response)
            {
            ...
            await foreach (gcrv::ListJobsResponse page in response.AsRawResponses())
            {
    ...
    // [END run_v2_generated_Jobs_ListJobs_async_flattened]
}
