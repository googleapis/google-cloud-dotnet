...
namespace Google.Cloud.Run.V2
{
    ...
    {
        /// <summary>
        /// <see cref="gcrv::BuildName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcrv::BuildName BuildName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcrv::BuildName.Parse(Name, allowUnparsed: true);
