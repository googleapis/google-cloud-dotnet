...
namespace Google.Cloud.Run.V2
{
    ...
    public sealed partial class TasksClientBuilder : gaxgrpc::ClientBuilderBase<TasksClient>
    {
        ...
        private TasksClient BuildImpl()
        {
            ...
            return TasksClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class TasksClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Tasks.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
