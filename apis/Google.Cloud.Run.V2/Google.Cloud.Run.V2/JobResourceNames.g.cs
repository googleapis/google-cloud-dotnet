...
namespace Google.Cloud.Run.V2
{
    ...
    {
        /// <summary>
        /// <see cref="gcrv::JobName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcrv::JobName JobName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcrv::JobName.Parse(Name, allowUnparsed: true);
