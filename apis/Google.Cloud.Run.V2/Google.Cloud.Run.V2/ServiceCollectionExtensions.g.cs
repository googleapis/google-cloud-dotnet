...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>Adds a singleton <see cref="gcrv::WorkerPoolsClient"/> to <paramref name="services"/>.</summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        /// <param name="action">
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddWorkerPoolsClient(this IServiceCollection services, sys::Action<gcrv::WorkerPoolsClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcrv::WorkerPoolsClientBuilder builder = new gcrv::WorkerPoolsClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddWorkerPoolsClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcrv::WorkerPoolsClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcrv::WorkerPoolsClientBuilder builder = new gcrv::WorkerPoolsClientBuilder();
                action?.Invoke(provider, builder);
