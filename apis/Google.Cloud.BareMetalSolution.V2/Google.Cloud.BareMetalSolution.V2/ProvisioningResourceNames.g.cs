...
namespace Google.Cloud.BareMetalSolution.V2
{
    ...
    /// <summary>Resource name for the <c>ServerNetworkTemplate</c> resource.</summary>
    public sealed partial class ServerNetworkTemplateName : gax::IResourceName, sys::IEquatable<ServerNetworkTemplateName>
    {
        /// <summary>The possible contents of <see cref="ServerNetworkTemplateName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}</c>.
            /// </summary>
            ProjectLocationServerNetworkTemplate = 1,
        }

        private static gax::PathTemplate s_projectLocationServerNetworkTemplate = new gax::PathTemplate("projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}");

        /// <summary>Creates a <see cref="ServerNetworkTemplateName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ServerNetworkTemplateName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static ServerNetworkTemplateName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new ServerNetworkTemplateName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="ServerNetworkTemplateName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="serverNetworkTemplateId">
        /// The <c>ServerNetworkTemplate</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="ServerNetworkTemplateName"/> constructed from the provided ids.
        /// </returns>
        public static ServerNetworkTemplateName FromProjectLocationServerNetworkTemplate(string projectId, string locationId, string serverNetworkTemplateId) =>
            new ServerNetworkTemplateName(ResourceNameType.ProjectLocationServerNetworkTemplate, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), serverNetworkTemplateId: gax::GaxPreconditions.CheckNotNullOrEmpty(serverNetworkTemplateId, nameof(serverNetworkTemplateId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ServerNetworkTemplateName"/> with pattern
        /// <c>projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// </param>
        /// <returns>
        /// The string representation of this <see cref="ServerNetworkTemplateName"/> with pattern
        /// <c>projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string serverNetworkTemplateId) =>
            FormatProjectLocationServerNetworkTemplate(projectId, locationId, serverNetworkTemplateId);
        ...
        public static string FormatProjectLocationServerNetworkTemplate(string projectId, string locationId, string serverNetworkTemplateId) =>
            s_projectLocationServerNetworkTemplate.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(serverNetworkTemplateId, nameof(serverNetworkTemplateId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ServerNetworkTemplateName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="serverNetworkTemplateName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="ServerNetworkTemplateName"/> if successful.</returns>
        public static ServerNetworkTemplateName Parse(string serverNetworkTemplateName) =>
            Parse(serverNetworkTemplateName, false);
        ...
        public static ServerNetworkTemplateName Parse(string serverNetworkTemplateName, bool allowUnparsed) =>
            TryParse(serverNetworkTemplateName, allowUnparsed, out ServerNetworkTemplateName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ServerNetworkTemplateName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="serverNetworkTemplateName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ServerNetworkTemplateName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string serverNetworkTemplateName, out ServerNetworkTemplateName result) =>
            TryParse(serverNetworkTemplateName, false, out result);
        ...
        {
            gax::GaxPreconditions.CheckNotNull(serverNetworkTemplateName, nameof(serverNetworkTemplateName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationServerNetworkTemplate.TryParseName(serverNetworkTemplateName, out resourceName))
            {
                result = FromProjectLocationServerNetworkTemplate(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(serverNetworkTemplateName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private ServerNetworkTemplateName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string serverNetworkTemplateId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
            ProjectId = projectId;
            ServerNetworkTemplateId = serverNetworkTemplateId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="ServerNetworkTemplateName"/> class from the component parts of
        /// pattern <c>projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="serverNetworkTemplateId">
        /// The <c>ServerNetworkTemplate</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public ServerNetworkTemplateName(string projectId, string locationId, string serverNetworkTemplateId) : this(ResourceNameType.ProjectLocationServerNetworkTemplate, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), serverNetworkTemplateId: gax::GaxPreconditions.CheckNotNullOrEmpty(serverNetworkTemplateId, nameof(serverNetworkTemplateId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ServerNetworkTemplate</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationServerNetworkTemplate: return s_projectLocationServerNetworkTemplate.Expand(ProjectId, LocationId, ServerNetworkTemplateId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as ServerNetworkTemplateName);
    ...
    public partial class ServerNetworkTemplate
    {
        /// <summary>
        /// <see cref="gcbv::ServerNetworkTemplateName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcbv::ServerNetworkTemplateName ServerNetworkTemplateName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcbv::ServerNetworkTemplateName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }
}
