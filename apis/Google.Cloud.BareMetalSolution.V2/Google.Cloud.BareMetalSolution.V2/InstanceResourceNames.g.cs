...
namespace Google.Cloud.BareMetalSolution.V2
{
    ...
    public partial class Instance
    {
        ...
        /// <summary>
        /// <see cref="ServerNetworkTemplateName"/>-typed view over the <see cref="NetworkTemplate"/> resource name
        /// property.
        /// </summary>
        public ServerNetworkTemplateName NetworkTemplateAsServerNetworkTemplateName
        {
            get => string.IsNullOrEmpty(NetworkTemplate) ? null : ServerNetworkTemplateName.Parse(NetworkTemplate, allowUnparsed: true);
            set => NetworkTemplate = value?.ToString() ?? "";
        }
    }
    ...
    public partial class DetachLunRequest
    {
        /// <summary>
        ...
        /// <summary><see cref="LunName"/>-typed view over the <see cref="Lun"/> resource name property.</summary>
        public LunName LunAsLunName
        {
            get => string.IsNullOrEmpty(Lun) ? null : LunName.Parse(Lun, allowUnparsed: true);
            set => Lun = value?.ToString() ?? "";
        }
    }
