...
{
    // [START baremetalsolution_v2_generated_BareMetalSolution_ListVolumeSnapshots_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBareMetalSolutionClientSnippets
    {
        ...
        public async Task ListVolumeSnapshotsResourceNamesAsync()
        {
            ...
            await foreach (VolumeSnapshot item in response)
            {
            ...
            await foreach (ListVolumeSnapshotsResponse page in response.AsRawResponses())
            {
    ...
    // [END baremetalsolution_v2_generated_BareMetalSolution_ListVolumeSnapshots_async_flattened_resourceNames]
}
