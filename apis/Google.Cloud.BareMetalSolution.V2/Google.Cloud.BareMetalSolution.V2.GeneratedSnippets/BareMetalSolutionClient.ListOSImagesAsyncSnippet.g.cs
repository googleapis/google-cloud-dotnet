...
{
    // [START baremetalsolution_v2_generated_BareMetalSolution_ListOSImages_async_flattened]
    ...
    public sealed partial class GeneratedBareMetalSolutionClientSnippets
    {
        ...
        public async Task ListOSImagesAsync()
        {
            ...
            await foreach (OSImage item in response)
            {
            ...
            await foreach (ListOSImagesResponse page in response.AsRawResponses())
            {
    ...
    // [END baremetalsolution_v2_generated_BareMetalSolution_ListOSImages_async_flattened]
}
