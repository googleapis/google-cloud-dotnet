...
{
    // [START baremetalsolution_v2_generated_BareMetalSolution_ListProvisioningQuotas_async_flattened]
    ...
    public sealed partial class GeneratedBareMetalSolutionClientSnippets
    {
        ...
        public async Task ListProvisioningQuotasAsync()
        {
            ...
            await foreach (ProvisioningQuota item in response)
            {
            ...
            await foreach (ListProvisioningQuotasResponse page in response.AsRawResponses())
            {
    ...
    // [END baremetalsolution_v2_generated_BareMetalSolution_ListProvisioningQuotas_async_flattened]
}
