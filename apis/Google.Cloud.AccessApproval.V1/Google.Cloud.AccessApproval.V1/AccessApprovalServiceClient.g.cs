...
namespace Google.Cloud.AccessApproval.V1
{
    ...
    public sealed partial class AccessApprovalServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListApprovalRequestsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetApprovalRequestSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ApproveApprovalRequestSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings DismissApprovalRequestSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetAccessApprovalSettingsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UpdateAccessApprovalSettingsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings DeleteAccessApprovalSettingsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);
    ...
    public abstract partial class AccessApprovalServiceClient
    {
        ...
        internal static AccessApprovalServiceClient Create(grpccore::CallInvoker callInvoker, AccessApprovalServiceSettings settings = null)
        {
            ...
            AccessApprovalService.AccessApprovalServiceClient grpcClient = new AccessApprovalService.AccessApprovalServiceClient(callInvoker);
        ...
        public virtual AccessApprovalService.AccessApprovalServiceClient GrpcClient => throw new sys::NotImplementedException();
    ...
    public sealed partial class AccessApprovalServiceClientImpl : AccessApprovalServiceClient
    {
        ...
        public AccessApprovalServiceClientImpl(AccessApprovalService.AccessApprovalServiceClient grpcClient, AccessApprovalServiceSettings settings)
        {
        ...
        partial void OnConstruction(AccessApprovalService.AccessApprovalServiceClient grpcClient, AccessApprovalServiceSettings effectiveSettings, gaxgrpc::ClientHelper clientHelper);

        /// <summary>The underlying gRPC AccessApprovalService client</summary>
        public override AccessApprovalService.AccessApprovalServiceClient GrpcClient { get; }
