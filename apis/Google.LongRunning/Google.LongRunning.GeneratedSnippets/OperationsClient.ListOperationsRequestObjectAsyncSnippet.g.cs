...
{
    // [START longrunning_generated_Operations_ListOperations_async]
    ...
    public sealed partial class GeneratedOperationsClientSnippets
    {
        ...
        public async Task ListOperationsRequestObjectAsync()
        {
            ...
            await foreach (ListOperationsResponse page in response.AsRawResponses())
            {
    ...
    // [END longrunning_generated_Operations_ListOperations_async]
}
