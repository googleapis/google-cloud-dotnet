...
{
    // [START devicestreaming_v1_generated_DirectAccessService_ListDeviceSessions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDirectAccessServiceClientSnippets
    {
        ...
        public async Task ListDeviceSessionsResourceNamesAsync()
        {
            ...
            await foreach (DeviceSession item in response)
            {
            ...
            await foreach (ListDeviceSessionsResponse page in response.AsRawResponses())
            {
    ...
    // [END devicestreaming_v1_generated_DirectAccessService_ListDeviceSessions_async_flattened_resourceNames]
}
