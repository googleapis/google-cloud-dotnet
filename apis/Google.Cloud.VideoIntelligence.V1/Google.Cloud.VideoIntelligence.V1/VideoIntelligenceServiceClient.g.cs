...
namespace Google.Cloud.VideoIntelligence.V1
{
    ...
    public sealed partial class VideoIntelligenceServiceClientBuilder : gaxgrpc::ClientBuilderBase<VideoIntelligenceServiceClient>
    {
        ...
        private VideoIntelligenceServiceClient BuildImpl()
        {
            ...
            return VideoIntelligenceServiceClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class VideoIntelligenceServiceClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(VideoIntelligenceService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
