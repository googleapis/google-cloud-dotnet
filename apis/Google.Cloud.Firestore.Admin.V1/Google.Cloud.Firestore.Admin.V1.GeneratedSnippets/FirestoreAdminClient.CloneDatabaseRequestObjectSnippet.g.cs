...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public void CloneDatabaseRequestObject()
        {
            ...
            // Make the request
            Operation<Database, CloneDatabaseMetadata> response = firestoreAdminClient.CloneDatabase(request);

            // Poll until the returned long-running operation is complete
            Operation<Database, CloneDatabaseMetadata> completedResponse = response.PollUntilCompleted();
            ...
            Operation<Database, CloneDatabaseMetadata> retrievedResponse = firestoreAdminClient.PollOnceCloneDatabase(operationName);
