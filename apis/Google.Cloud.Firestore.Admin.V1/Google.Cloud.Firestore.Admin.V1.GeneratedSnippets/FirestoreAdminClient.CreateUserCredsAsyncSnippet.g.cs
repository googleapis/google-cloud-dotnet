...
{
    // [START firestore_v1_generated_FirestoreAdmin_CreateUserCreds_async_flattened]
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task CreateUserCredsAsync()
        {
            ...
            string userCredsId = "";
            // Make the request
            UserCreds response = await firestoreAdminClient.CreateUserCredsAsync(parent, userCreds, userCredsId);
        }
    }
    // [END firestore_v1_generated_FirestoreAdmin_CreateUserCreds_async_flattened]
}
