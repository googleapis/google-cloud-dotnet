...
{
    // [START firestore_v1_generated_FirestoreAdmin_GetBackup_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task GetBackupResourceNamesAsync()
        {
            ...
            // Make the request
            Backup response = await firestoreAdminClient.GetBackupAsync(name);
        }
    }
    // [END firestore_v1_generated_FirestoreAdmin_GetBackup_async_flattened_resourceNames]
}
