...
{
    // [START firestore_v1_generated_FirestoreAdmin_DeleteUserCreds_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task DeleteUserCredsResourceNamesAsync()
        {
            ...
            UserCredsName name = UserCredsName.FromProjectDatabaseUserCreds("[PROJECT]", "[DATABASE]", "[USER_CREDS]");
            // Make the request
            await firestoreAdminClient.DeleteUserCredsAsync(name);
        }
    }
    // [END firestore_v1_generated_FirestoreAdmin_DeleteUserCreds_async_flattened_resourceNames]
}
