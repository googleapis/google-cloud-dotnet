...
{
    // [START firestore_v1_generated_FirestoreAdmin_UpdateBackupSchedule_sync_flattened]
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public void UpdateBackupSchedule()
        {
            ...
            // Make the request
            BackupSchedule response = firestoreAdminClient.UpdateBackupSchedule(backupSchedule, updateMask);
        }
    }
    // [END firestore_v1_generated_FirestoreAdmin_UpdateBackupSchedule_sync_flattened]
}
