...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task ListUserCredsRequestObjectAsync()
        {
            ...
            ListUserCredsRequest request = new ListUserCredsRequest
            {
                ParentAsDatabaseName = DatabaseName.FromProjectDatabase("[PROJECT]", "[DATABASE]"),
            };
            // Make the request
            ListUserCredsResponse response = await firestoreAdminClient.ListUserCredsAsync(request);
        }
    }
