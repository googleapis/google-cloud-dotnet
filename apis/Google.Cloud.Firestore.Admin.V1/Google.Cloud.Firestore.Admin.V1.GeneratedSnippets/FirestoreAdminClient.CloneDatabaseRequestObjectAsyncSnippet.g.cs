...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task CloneDatabaseRequestObjectAsync()
        {
            ...
            CloneDatabaseRequest request = new CloneDatabaseRequest
            {
            ...
            // Make the request
            Operation<Database, CloneDatabaseMetadata> response = await firestoreAdminClient.CloneDatabaseAsync(request);

            // Poll until the returned long-running operation is complete
            Operation<Database, CloneDatabaseMetadata> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<Database, CloneDatabaseMetadata> retrievedResponse = await firestoreAdminClient.PollOnceCloneDatabaseAsync(operationName);
