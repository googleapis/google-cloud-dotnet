...
{
    // [START firestore_v1_generated_FirestoreAdmin_GetUserCreds_async_flattened]
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task GetUserCredsAsync()
        {
            ...
            // Make the request
            UserCreds response = await firestoreAdminClient.GetUserCredsAsync(name);
        }
    }
    // [END firestore_v1_generated_FirestoreAdmin_GetUserCreds_async_flattened]
}
