...
{
    // [START firestore_v1_generated_FirestoreAdmin_ResetUserPassword_async_flattened]
    ...
    public sealed partial class GeneratedFirestoreAdminClientSnippets
    {
        ...
        public async Task ResetUserPasswordAsync()
        {
            ...
            // Make the request
            UserCreds response = await firestoreAdminClient.ResetUserPasswordAsync(name);
        }
    }
    // [END firestore_v1_generated_FirestoreAdmin_ResetUserPassword_async_flattened]
}
