...
namespace Google.Cloud.Firestore.Admin.V1
{
    ...
    public abstract partial class FirestoreAdminClient
    {
        ...
        /// <see cref="Create(grpccore::CallInvoker,FirestoreAdminSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,FirestoreAdminSettings)"/>. Channels which weren't
        /// automatically created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to
        /// <see cref="Create(grpccore::CallInvoker,FirestoreAdminSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,FirestoreAdminSettings)"/> will create new channels, which
    ...
    public sealed partial class FirestoreAdminClientImpl : FirestoreAdminClient
    {
        ...
        public FirestoreAdminClientImpl(FirestoreAdmin.FirestoreAdminClient grpcClient, FirestoreAdminSettings settings)
        {
            ...
            _callCreateIndex = clientHelper.BuildApiCall<CreateIndexRequest, lro::Operation>(grpcClient.CreateIndexAsync, grpcClient.CreateIndex, effectiveSettings.CreateIndexSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateIndex);
            Modify_CreateIndexApiCall(ref _callCreateIndex);
            _callListIndexes = clientHelper.BuildApiCall<ListIndexesRequest, ListIndexesResponse>(grpcClient.ListIndexesAsync, grpcClient.ListIndexes, effectiveSettings.ListIndexesSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListIndexes);
            Modify_ListIndexesApiCall(ref _callListIndexes);
            _callGetIndex = clientHelper.BuildApiCall<GetIndexRequest, Index>(grpcClient.GetIndexAsync, grpcClient.GetIndex, effectiveSettings.GetIndexSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetIndex);
            Modify_GetIndexApiCall(ref _callGetIndex);
            _callDeleteIndex = clientHelper.BuildApiCall<DeleteIndexRequest, wkt::Empty>(grpcClient.DeleteIndexAsync, grpcClient.DeleteIndex, effectiveSettings.DeleteIndexSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callDeleteIndex);
            Modify_DeleteIndexApiCall(ref _callDeleteIndex);
            _callGetField = clientHelper.BuildApiCall<GetFieldRequest, Field>(grpcClient.GetFieldAsync, grpcClient.GetField, effectiveSettings.GetFieldSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetField);
            Modify_GetFieldApiCall(ref _callGetField);
            _callUpdateField = clientHelper.BuildApiCall<UpdateFieldRequest, lro::Operation>(grpcClient.UpdateFieldAsync, grpcClient.UpdateField, effectiveSettings.UpdateFieldSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"field.name={(sysnet::WebUtility.UrlEncode(request.Field.Name))}"));
            Modify_ApiCall(ref _callUpdateField);
            Modify_UpdateFieldApiCall(ref _callUpdateField);
            _callListFields = clientHelper.BuildApiCall<ListFieldsRequest, ListFieldsResponse>(grpcClient.ListFieldsAsync, grpcClient.ListFields, effectiveSettings.ListFieldsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListFields);
            Modify_ListFieldsApiCall(ref _callListFields);
            _callExportDocuments = clientHelper.BuildApiCall<ExportDocumentsRequest, lro::Operation>(grpcClient.ExportDocumentsAsync, grpcClient.ExportDocuments, effectiveSettings.ExportDocumentsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callExportDocuments);
            Modify_ExportDocumentsApiCall(ref _callExportDocuments);
            _callImportDocuments = clientHelper.BuildApiCall<ImportDocumentsRequest, lro::Operation>(grpcClient.ImportDocumentsAsync, grpcClient.ImportDocuments, effectiveSettings.ImportDocumentsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
