...
namespace Google.Cloud.Firestore.Admin.V1
{
    ...
    public sealed partial class BackupScheduleName : gax::IResourceName, sys::IEquatable<BackupScheduleName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/databases/{database}/backupSchedules/{backup_schedule}</c>.
            /// </summary>
            ProjectDatabaseBackupSchedule = 1,
        }

        private static gax::PathTemplate s_projectDatabaseBackupSchedule = new gax::PathTemplate("projects/{project}/databases/{database}/backupSchedules/{backup_schedule}");
        ...
        /// <param name="backupScheduleId">The <c>BackupSchedule</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        public static BackupScheduleName FromProjectDatabaseBackupSchedule(string projectId, string databaseId, string backupScheduleId) =>
            new BackupScheduleName(ResourceNameType.ProjectDatabaseBackupSchedule, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), databaseId: gax::GaxPreconditions.CheckNotNullOrEmpty(databaseId, nameof(databaseId)), backupScheduleId: gax::GaxPreconditions.CheckNotNullOrEmpty(backupScheduleId, nameof(backupScheduleId)));
        ...
        public static string Format(string projectId, string databaseId, string backupScheduleId) =>
            FormatProjectDatabaseBackupSchedule(projectId, databaseId, backupScheduleId);
        ...
        public static string FormatProjectDatabaseBackupSchedule(string projectId, string databaseId, string backupScheduleId) =>
            s_projectDatabaseBackupSchedule.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(databaseId, nameof(databaseId)), gax::GaxPreconditions.CheckNotNullOrEmpty(backupScheduleId, nameof(backupScheduleId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/databases/{database}/backupSchedules/{backup_schedule}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string backupScheduleName, bool allowUnparsed, out BackupScheduleName result)
        {
            ...
            if (s_projectDatabaseBackupSchedule.TryParseName(backupScheduleName, out resourceName))
            {
                result = FromProjectDatabaseBackupSchedule(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private BackupScheduleName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string backupScheduleId = null, string databaseId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="databaseId">The <c>Database</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="backupScheduleId">The <c>BackupSchedule</c> ID. Must not be <c>null</c> or empty.</param>
        public BackupScheduleName(string projectId, string databaseId, string backupScheduleId) : this(ResourceNameType.ProjectDatabaseBackupSchedule, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), databaseId: gax::GaxPreconditions.CheckNotNullOrEmpty(databaseId, nameof(databaseId)), backupScheduleId: gax::GaxPreconditions.CheckNotNullOrEmpty(backupScheduleId, nameof(backupScheduleId)))
        {
        }
        ...
        /// <summary>
        /// The <c>BackupSchedule</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectDatabaseBackupSchedule: return s_projectDatabaseBackupSchedule.Expand(ProjectId, DatabaseId, BackupScheduleId);
