...
{
    // [START networkconnectivity_v1alpha1_generated_HubService_ListHubs_async_flattened]
    ...
    public sealed partial class GeneratedHubServiceClientSnippets
    {
        ...
        public async Task ListHubsAsync()
        {
            ...
            await foreach (Hub item in response)
            {
            ...
            await foreach (ListHubsResponse page in response.AsRawResponses())
            {
    ...
    // [END networkconnectivity_v1alpha1_generated_HubService_ListHubs_async_flattened]
}
