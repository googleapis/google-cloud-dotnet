...
{
    // [START networkconnectivity_v1alpha1_generated_HubService_ListSpokes_async_flattened]
    ...
    public sealed partial class GeneratedHubServiceClientSnippets
    {
        ...
        public async Task ListSpokesAsync()
        {
            ...
            await foreach (ListSpokesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkconnectivity_v1alpha1_generated_HubService_ListSpokes_async_flattened]
}
