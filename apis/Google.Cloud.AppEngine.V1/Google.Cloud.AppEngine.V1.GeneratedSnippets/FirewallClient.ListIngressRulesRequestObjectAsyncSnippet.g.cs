...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedFirewallClientSnippets
    {
        ...
        public async Task ListIngressRulesRequestObjectAsync()
        {
            ...
            await foreach (FirewallRule item in response)
            {
            ...
            await foreach (ListIngressRulesResponse page in response.AsRawResponses())
            {
