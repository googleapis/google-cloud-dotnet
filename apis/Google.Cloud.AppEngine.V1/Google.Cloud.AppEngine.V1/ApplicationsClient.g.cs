...
namespace Google.Cloud.AppEngine.V1
{
    ...
    public sealed partial class ApplicationsClientBuilder : gaxgrpc::ClientBuilderBase<ApplicationsClient>
    {
        ...
        private ApplicationsClient BuildImpl()
        {
            ...
            return ApplicationsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ApplicationsClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Applications.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
