...
namespace Google.Cloud.ApigeeConnect.V1
{
    ...
    public sealed partial class TetherClientBuilder : gaxgrpc::ClientBuilderBase<TetherClient>
    {
        ...
        private TetherClient BuildImpl()
        {
            ...
            return TetherClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class TetherClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Tether.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
