...
{
    // [START apigeeregistry_v1_generated_Registry_ListApiVersions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedRegistryClientSnippets
    {
        ...
        public async Task ListApiVersionsResourceNamesAsync()
        {
            ...
            await foreach (ApiVersion item in response)
            {
            ...
            await foreach (ListApiVersionsResponse page in response.AsRawResponses())
            {
    ...
    // [END apigeeregistry_v1_generated_Registry_ListApiVersions_async_flattened_resourceNames]
}
