...
{
    // [START apigeeregistry_v1_generated_Registry_ListApiSpecs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedRegistryClientSnippets
    {
        ...
        public async Task ListApiSpecsResourceNamesAsync()
        {
            ...
            await foreach (ApiSpec item in response)
            {
            ...
            await foreach (ListApiSpecsResponse page in response.AsRawResponses())
            {
    ...
    // [END apigeeregistry_v1_generated_Registry_ListApiSpecs_async_flattened_resourceNames]
}
