...
{
    // [START merchantapi_v1beta_generated_QuotaService_ListQuotaGroups_async_flattened_resourceNames]
    using Google.Api.Gax;
    using Google.Shopping.Merchant.Quota.V1Beta;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedQuotaServiceClientSnippets
    {
        ...
        public async Task ListQuotaGroupsResourceNamesAsync()
        {
            ...
            await foreach (QuotaGroup item in response)
            {
            ...
            await foreach (ListQuotaGroupsResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_QuotaService_ListQuotaGroups_async_flattened_resourceNames]
}
