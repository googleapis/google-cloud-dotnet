...
namespace Google.Cloud.Appoptimize.V1Beta
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.Appoptimize.V1Beta", GetFileDescriptors)
        ...
        {
            yield return AppOptimizeReflection.Descriptor;
