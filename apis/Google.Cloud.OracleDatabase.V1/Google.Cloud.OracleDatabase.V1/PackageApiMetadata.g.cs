...
namespace Google.Cloud.OracleDatabase.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.OracleDatabase.V1", GetFileDescriptors)
        ...
        private static scg::IEnumerable<gpr::FileDescriptor> GetFileDescriptors()
        {
            ...
            yield return AutonomousDatabaseReflection.Descriptor;
            yield return AutonomousDatabaseCharacterSetReflection.Descriptor;
