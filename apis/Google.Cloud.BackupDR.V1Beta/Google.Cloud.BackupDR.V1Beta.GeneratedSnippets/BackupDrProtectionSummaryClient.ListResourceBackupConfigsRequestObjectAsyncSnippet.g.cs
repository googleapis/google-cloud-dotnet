...
{
    // [START backupdr_v1beta_generated_BackupDrProtectionSummary_ListResourceBackupConfigs_async]
    ...
    public sealed partial class GeneratedBackupDrProtectionSummaryClientSnippets
    {
        ...
        public async Task ListResourceBackupConfigsRequestObjectAsync()
        {
            ...
            await foreach (ResourceBackupConfig item in response)
            {
            ...
            await foreach (ListResourceBackupConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END backupdr_v1beta_generated_BackupDrProtectionSummary_ListResourceBackupConfigs_async]
}
