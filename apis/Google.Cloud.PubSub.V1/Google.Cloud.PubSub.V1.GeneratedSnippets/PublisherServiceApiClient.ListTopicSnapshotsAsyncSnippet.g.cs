...
{
    // [START pubsub_v1_generated_Publisher_ListTopicSnapshots_async_flattened]
    ...
    public sealed partial class GeneratedPublisherServiceApiClientSnippets
    {
        ...
        public async Task ListTopicSnapshotsAsync()
        {
            ...
            await foreach (ListTopicSnapshotsResponse page in response.AsRawResponses())
            {
    ...
    // [END pubsub_v1_generated_Publisher_ListTopicSnapshots_async_flattened]
}
