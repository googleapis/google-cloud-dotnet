...
{
    // [START pubsub_v1_generated_Publisher_ListTopicSubscriptions_async]
    ...
    public sealed partial class GeneratedPublisherServiceApiClientSnippets
    {
        ...
        public async Task ListTopicSubscriptionsRequestObjectAsync()
        {
            ...
            await foreach (ListTopicSubscriptionsResponse page in response.AsRawResponses())
            {
    ...
    // [END pubsub_v1_generated_Publisher_ListTopicSubscriptions_async]
}
