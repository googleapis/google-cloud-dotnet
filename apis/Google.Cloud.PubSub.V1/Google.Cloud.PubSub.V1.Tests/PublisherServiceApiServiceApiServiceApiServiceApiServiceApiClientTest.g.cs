...
namespace Google.Cloud.PubSub.V1.Tests
{
    ...
    public sealed class GeneratedPublisherServiceApiServiceApiServiceApiServiceApiServiceApiClientTest
    {
        [xunit::FactAttribute]
        public void CreateTopicRequestObject()
        {
            moq::Mock<PublisherServiceApiServiceApiServiceApiServiceApiServiceApi.PublisherServiceApiServiceApiServiceApiServiceApiServiceApiClient> mockGrpcClient = new moq::Mock<PublisherServiceApiServiceApiServiceApiServiceApiServiceApi.PublisherServiceApiServiceApiServiceApiServiceApiServiceApiClient>(moq::MockBehavior.Strict);
            ...
            PublisherServiceApiServiceApiServiceApiServiceApiServiceApiClient client = new PublisherServiceApiServiceApiServiceApiServiceApiServiceApiClientImpl(mockGrpcClient.Object, null);
