...
namespace Google.Cloud.PubSub.V1.Tests
{
    ...
    public sealed class GeneratedSubscriberServiceApiServiceApiServiceApiServiceApiClientTest
    {
        [xunit::FactAttribute]
        public void CreateSubscriptionRequestObject()
        {
            moq::Mock<SubscriberServiceApiServiceApiServiceApiServiceApi.SubscriberServiceApiServiceApiServiceApiServiceApiClient> mockGrpcClient = new moq::Mock<SubscriberServiceApiServiceApiServiceApiServiceApi.SubscriberServiceApiServiceApiServiceApiServiceApiClient>(moq::MockBehavior.Strict);
            ...
            SubscriberServiceApiServiceApiServiceApiServiceApiClient client = new SubscriberServiceApiServiceApiServiceApiServiceApiClientImpl(mockGrpcClient.Object, null);
