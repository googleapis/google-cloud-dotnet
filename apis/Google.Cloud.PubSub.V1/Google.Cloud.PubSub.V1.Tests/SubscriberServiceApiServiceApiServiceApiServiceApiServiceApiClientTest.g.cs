...
namespace Google.Cloud.PubSub.V1.Tests
{
    ...
    public sealed class GeneratedSubscriberServiceApiServiceApiServiceApiServiceApiServiceApiClientTest
    {
        [xunit::FactAttribute]
        public void CreateSubscriptionRequestObject()
        {
            moq::Mock<SubscriberServiceApiServiceApiServiceApiServiceApiServiceApi.SubscriberServiceApiServiceApiServiceApiServiceApiServiceApiClient> mockGrpcClient = new moq::Mock<SubscriberServiceApiServiceApiServiceApiServiceApiServiceApi.SubscriberServiceApiServiceApiServiceApiServiceApiServiceApiClient>(moq::MockBehavior.Strict);
            ...
            SubscriberServiceApiServiceApiServiceApiServiceApiServiceApiClient client = new SubscriberServiceApiServiceApiServiceApiServiceApiServiceApiClientImpl(mockGrpcClient.Object, null);
