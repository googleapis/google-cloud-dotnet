...
namespace Google.Cloud.PubSub.V1.Tests
{
    ...
    public sealed class GeneratedPublisherServiceApiServiceApiServiceApiServiceApiClientTest
    {
        [xunit::FactAttribute]
        public void CreateTopicRequestObject()
        {
            moq::Mock<PublisherServiceApiServiceApiServiceApiServiceApi.PublisherServiceApiServiceApiServiceApiServiceApiClient> mockGrpcClient = new moq::Mock<PublisherServiceApiServiceApiServiceApiServiceApi.PublisherServiceApiServiceApiServiceApiServiceApiClient>(moq::MockBehavior.Strict);
            ...
            PublisherServiceApiServiceApiServiceApiServiceApiClient client = new PublisherServiceApiServiceApiServiceApiServiceApiClientImpl(mockGrpcClient.Object, null);
