    ...
    private void TriggerSend()
    {
        ...
        async Task Send()
        {
            ...
            lock (_lock)
            {
                ...
                // If messages for a removed key are published again, they key and its state will be added back to the dictionary,
                // as if it were a new key.
                // Note that if unordered messages have been sent the state dictionary will forever containg the entry with empty string as a key.
