...
public abstract partial class SubscriberClient
{
    ...
    public sealed class ShutdownOptions
    {
        ...
        /// <summary>
        /// The timeout for the shutdown process.
        /// If null, a default timeout based on the maximum extension duration is used.
        /// Zero or negative values will trigger an immediate hard-stop.
        /// </summary>
