...
namespace Google.Cloud.PubSub.V1
{
    ...
    public partial class IngestionDataSourceSettings
    {
        public partial class Types
        {
            public partial class AwsMsk
            {
                /// <summary>
    ...
    public partial class IngestionFailureEvent
    {
    ...
    public partial class ListTopicSnapshotsResponse
    {
        /// <summary>
        /// <see cref="SnapshotName"/>-typed view over the <see cref="Snapshots"/> resource name property.
        /// </summary>
        public gax::ResourceNameList<SnapshotName> SnapshotsAsSnapshotNames
        {
            get => new gax::ResourceNameList<SnapshotName>(Snapshots, s => string.IsNullOrEmpty(s) ? null : SnapshotName.Parse(s, allowUnparsed: true));
        }
    }
    ...
    public partial class Subscription
    {
        ...
        public partial class Types
        {
            public partial class AnalyticsHubSubscriptionInfo
            {
                /// <summary>
                /// <see cref="ListingName"/>-typed view over the <see cref="Listing"/> resource name property.
                /// </summary>
                public ListingName ListingAsListingName
                {
                    get => string.IsNullOrEmpty(Listing) ? null : ListingName.Parse(Listing, allowUnparsed: true);
                    set => Listing = value?.ToString() ?? "";
                }
            }
        }
    }
    ...
    {
        /// <summary>
        /// <see cref="TopicName"/>-typed view over the <see cref="DeadLetterTopic"/> resource name property.
        /// </summary>
        public TopicName DeadLetterTopicAsTopicName
        {
            get => string.IsNullOrEmpty(DeadLetterTopic) ? null : TopicName.Parse(DeadLetterTopic, allowUnparsed: true);
            set => DeadLetterTopic = value?.ToString() ?? "";
        }
    }
