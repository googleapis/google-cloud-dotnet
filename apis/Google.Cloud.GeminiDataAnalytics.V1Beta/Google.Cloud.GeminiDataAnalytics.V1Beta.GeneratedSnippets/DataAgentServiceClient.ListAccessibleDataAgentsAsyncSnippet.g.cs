...
{
    // [START geminidataanalytics_v1beta_generated_DataAgentService_ListAccessibleDataAgents_async_flattened]
    ...
    public sealed partial class GeneratedDataAgentServiceClientSnippets
    {
        ...
        public async Task ListAccessibleDataAgentsAsync()
        {
            ...
            await foreach (DataAgent item in response)
            {
            ...
            await foreach (ListAccessibleDataAgentsResponse page in response.AsRawResponses())
            {
    ...
    // [END geminidataanalytics_v1beta_generated_DataAgentService_ListAccessibleDataAgents_async_flattened]
}
