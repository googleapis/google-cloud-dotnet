...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>Adds a singleton <see cref="gcgv::DataA2AServiceClient"/> to <paramref name="services"/>.</summary>
        /// <param name="services">
        ...
        /// </param>
        public static IServiceCollection AddDataA2AServiceClient(this IServiceCollection services, sys::Action<gcgv::DataA2AServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcgv::DataA2AServiceClientBuilder builder = new gcgv::DataA2AServiceClientBuilder();
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddDataA2AServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcgv::DataA2AServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcgv::DataA2AServiceClientBuilder builder = new gcgv::DataA2AServiceClientBuilder();
