...
{
    // [START billingbudgets_v1_generated_BudgetService_ListBudgets_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBudgetServiceClientSnippets
    {
        ...
        public async Task ListBudgetsResourceNamesAsync()
        {
            ...
            await foreach (Budget item in response)
            {
            ...
            await foreach (ListBudgetsResponse page in response.AsRawResponses())
            {
    ...
    // [END billingbudgets_v1_generated_BudgetService_ListBudgets_async_flattened_resourceNames]
}
