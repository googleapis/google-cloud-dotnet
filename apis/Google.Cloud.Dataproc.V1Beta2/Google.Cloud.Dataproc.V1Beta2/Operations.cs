    ...
    static OperationsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3RvEh1nb29nbGUuY2xvdWQuZGF0YXByb2MudjFiZXRhMhocZ29vZ2xlL2Fw",
            "aS9hbm5vdGF0aW9ucy5wcm90bxofZ29vZ2xlL3Byb3RvYnVmL3RpbWVzdGFt",
            "cC5wcm90byL6AQoWQ2x1c3Rlck9wZXJhdGlvblN0YXR1cxJKCgVzdGF0ZRgB",
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            state_ = (global::Google.Cloud.Dataproc.V1Beta2.ClusterOperationStatus.Types.State) input.ReadEnum();
            break;
          }
          case 18: {
  ...
  public sealed partial class ClusterOperationMetadata : pb::IMessage<ClusterOperationMetadata> {
    ...
    public void MergeFrom(ClusterOperationMetadata other) {
      ...
      if (other.status_ != null) {
        if (status_ == null) {
          status_ = new global::Google.Cloud.Dataproc.V1Beta2.ClusterOperationStatus();
        }
