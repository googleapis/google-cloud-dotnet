...
namespace Google.Cloud.AIPlatform.V1Beta1
{
    ...
    {
        /// <summary>
        /// <see cref="ModelName"/>-typed view over the <see cref="TunedTeacherModelSource"/> resource name property.
        /// </summary>
        public ModelName TunedTeacherModelSourceAsModelName
        {
            get => string.IsNullOrEmpty(TunedTeacherModelSource) ? null : ModelName.Parse(TunedTeacherModelSource, allowUnparsed: true);
