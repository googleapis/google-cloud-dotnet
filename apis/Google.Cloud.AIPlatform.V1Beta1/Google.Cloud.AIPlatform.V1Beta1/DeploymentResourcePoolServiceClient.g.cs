...
namespace Google.Cloud.AIPlatform.V1Beta1
{
    ...
    public abstract partial class DeploymentResourcePoolServiceClient
    {
        ...
        public virtual gax::PagedEnumerable<QueryDeployedModelsResponse, DeployedModelRef> QueryDeployedModels(QueryDeployedModelsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        public virtual gax::PagedAsyncEnumerable<QueryDeployedModelsResponse, DeployedModelRef> QueryDeployedModelsAsync(QueryDeployedModelsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
    ...
    public sealed partial class DeploymentResourcePoolServiceClientImpl : DeploymentResourcePoolServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="DeployedModelRef"/> resources.</returns>
        public override gax::PagedEnumerable<QueryDeployedModelsResponse, DeployedModelRef> QueryDeployedModels(QueryDeployedModelsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_QueryDeployedModelsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedEnumerable<QueryDeployedModelsRequest, QueryDeployedModelsResponse, DeployedModelRef>(_callQueryDeployedModels, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="DeployedModelRef"/> resources.</returns>
        public override gax::PagedAsyncEnumerable<QueryDeployedModelsResponse, DeployedModelRef> QueryDeployedModelsAsync(QueryDeployedModelsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_QueryDeployedModelsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedAsyncEnumerable<QueryDeployedModelsRequest, QueryDeployedModelsResponse, DeployedModelRef>(_callQueryDeployedModels, request, callSettings);
        }
    }
    ...
    public partial class QueryDeployedModelsResponse : gaxgrpc::IPageResponse<DeployedModelRef>
    {
        /// <summary>Returns an enumerator that iterates through the resources in this response.</summary>
        public scg::IEnumerator<DeployedModelRef> GetEnumerator() => DeployedModelRefs.GetEnumerator();
