...
namespace Google.Cloud.AIPlatform.V1Beta1
{
    ...
    {
        /// <summary>
        /// <see cref="gcav::ExtensionName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcav::ExtensionName ExtensionName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcav::ExtensionName.Parse(Name, allowUnparsed: true);
    ...
    public partial class AuthConfig
    {
        public partial class Types
        {
            ...
            {
                /// <summary>
                /// <see cref="SecretVersionName"/>-typed view over the <see cref="ApiKeySecret"/> resource name
                /// property.
                /// </summary>
                public SecretVersionName ApiKeySecretAsSecretVersionName
                {
                    get => string.IsNullOrEmpty(ApiKeySecret) ? null : SecretVersionName.Parse(ApiKeySecret, allowUnparsed: true);
                    set => ApiKeySecret = value?.ToString() ?? "";
                }
            }

            public partial class HttpBasicAuthConfig
            {
                /// <summary>
                /// <see cref="SecretVersionName"/>-typed view over the <see cref="CredentialSecret"/> resource name
                /// property.
                /// </summary>
                public SecretVersionName CredentialSecretAsSecretVersionName
                {
                    get => string.IsNullOrEmpty(CredentialSecret) ? null : SecretVersionName.Parse(CredentialSecret, allowUnparsed: true);
                    set => CredentialSecret = value?.ToString() ?? "";
                }
            }
        }
    }

    public partial class ExtensionPrivateServiceConnectConfig
    {
        /// <summary>
        /// <see cref="ServiceName"/>-typed view over the <see cref="ServiceDirectory"/> resource name property.
        /// </summary>
        public ServiceName ServiceDirectoryAsServiceName
        {
            get => string.IsNullOrEmpty(ServiceDirectory) ? null : ServiceName.Parse(ServiceDirectory, allowUnparsed: true);
            set => ServiceDirectory = value?.ToString() ?? "";
        }
    }
}
