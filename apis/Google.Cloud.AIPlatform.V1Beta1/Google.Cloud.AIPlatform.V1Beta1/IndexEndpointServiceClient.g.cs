...
namespace Google.Cloud.AIPlatform.V1Beta1
{
    ...
    public sealed partial class IndexEndpointServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings CreateIndexEndpointSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(5000)));
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetIndexEndpointSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(5000)));
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListIndexEndpointsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(5000)));
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UpdateIndexEndpointSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(5000)));
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings DeleteIndexEndpointSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(5000)));
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings DeployIndexSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(5000)));
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UndeployIndexSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(5000)));
