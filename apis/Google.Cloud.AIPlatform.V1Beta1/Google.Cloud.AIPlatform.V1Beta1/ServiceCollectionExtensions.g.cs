...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::ExampleStoreServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddExampleStoreServiceClient(this IServiceCollection services, sys::Action<gcav::ExampleStoreServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::ExampleStoreServiceClientBuilder builder = new gcav::ExampleStoreServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddExampleStoreServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::ExampleStoreServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::ExampleStoreServiceClientBuilder builder = new gcav::ExampleStoreServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::ExtensionExecutionServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddExtensionExecutionServiceClient(this IServiceCollection services, sys::Action<gcav::ExtensionExecutionServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::ExtensionExecutionServiceClientBuilder builder = new gcav::ExtensionExecutionServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddExtensionExecutionServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::ExtensionExecutionServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::ExtensionExecutionServiceClientBuilder builder = new gcav::ExtensionExecutionServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::ExtensionRegistryServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddExtensionRegistryServiceClient(this IServiceCollection services, sys::Action<gcav::ExtensionRegistryServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::ExtensionRegistryServiceClientBuilder builder = new gcav::ExtensionRegistryServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddExtensionRegistryServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::ExtensionRegistryServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::ExtensionRegistryServiceClientBuilder builder = new gcav::ExtensionRegistryServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::MemoryBankServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddMemoryBankServiceClient(this IServiceCollection services, sys::Action<gcav::MemoryBankServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::MemoryBankServiceClientBuilder builder = new gcav::MemoryBankServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddMemoryBankServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::MemoryBankServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::MemoryBankServiceClientBuilder builder = new gcav::MemoryBankServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::ModelMonitoringServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddModelMonitoringServiceClient(this IServiceCollection services, sys::Action<gcav::ModelMonitoringServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::ModelMonitoringServiceClientBuilder builder = new gcav::ModelMonitoringServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddModelMonitoringServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::ModelMonitoringServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::ModelMonitoringServiceClientBuilder builder = new gcav::ModelMonitoringServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::OnlineEvaluatorServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddOnlineEvaluatorServiceClient(this IServiceCollection services, sys::Action<gcav::OnlineEvaluatorServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::OnlineEvaluatorServiceClientBuilder builder = new gcav::OnlineEvaluatorServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddOnlineEvaluatorServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::OnlineEvaluatorServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::OnlineEvaluatorServiceClientBuilder builder = new gcav::OnlineEvaluatorServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcav::ReasoningEngineRuntimeRevisionServiceClient"/> to
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddReasoningEngineRuntimeRevisionServiceClient(this IServiceCollection services, sys::Action<gcav::ReasoningEngineRuntimeRevisionServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcav::ReasoningEngineRuntimeRevisionServiceClientBuilder builder = new gcav::ReasoningEngineRuntimeRevisionServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddReasoningEngineRuntimeRevisionServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcav::ReasoningEngineRuntimeRevisionServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcav::ReasoningEngineRuntimeRevisionServiceClientBuilder builder = new gcav::ReasoningEngineRuntimeRevisionServiceClientBuilder();
                action?.Invoke(provider, builder);
