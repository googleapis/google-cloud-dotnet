...
{
    // [START aiplatform_v1beta1_generated_GenAiTuningService_ListTuningJobs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedGenAiTuningServiceClientSnippets
    {
        ...
        public async Task ListTuningJobsResourceNamesAsync()
        {
            ...
            await foreach (TuningJob item in response)
            {
            ...
            await foreach (ListTuningJobsResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_GenAiTuningService_ListTuningJobs_async_flattened_resourceNames]
}
