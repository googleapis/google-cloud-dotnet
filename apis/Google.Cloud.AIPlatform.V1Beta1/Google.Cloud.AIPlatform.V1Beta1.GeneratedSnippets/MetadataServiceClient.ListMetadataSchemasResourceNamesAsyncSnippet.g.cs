...
{
    // [START aiplatform_v1beta1_generated_MetadataService_ListMetadataSchemas_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedMetadataServiceClientSnippets
    {
        ...
        public async Task ListMetadataSchemasResourceNamesAsync()
        {
            ...
            await foreach (MetadataSchema item in response)
            {
            ...
            await foreach (ListMetadataSchemasResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_MetadataService_ListMetadataSchemas_async_flattened_resourceNames]
}
