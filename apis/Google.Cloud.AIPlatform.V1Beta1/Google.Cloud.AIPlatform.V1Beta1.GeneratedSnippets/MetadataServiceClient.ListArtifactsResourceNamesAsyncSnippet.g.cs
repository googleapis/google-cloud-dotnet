...
{
    // [START aiplatform_v1beta1_generated_MetadataService_ListArtifacts_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedMetadataServiceClientSnippets
    {
        ...
        public async Task ListArtifactsResourceNamesAsync()
        {
            ...
            await foreach (Artifact item in response)
            {
            ...
            await foreach (ListArtifactsResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_MetadataService_ListArtifacts_async_flattened_resourceNames]
}
