...
{
    // [START aiplatform_v1beta1_generated_IndexService_ListIndexes_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedIndexServiceClientSnippets
    {
        ...
        public async Task ListIndexesResourceNamesAsync()
        {
            ...
            await foreach (gcav::Index item in response)
            {
            ...
            await foreach (gcav::ListIndexesResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_IndexService_ListIndexes_async_flattened_resourceNames]
}
