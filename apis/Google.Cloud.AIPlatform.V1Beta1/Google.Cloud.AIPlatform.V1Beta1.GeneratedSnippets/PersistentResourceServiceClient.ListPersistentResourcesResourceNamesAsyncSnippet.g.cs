...
{
    // [START aiplatform_v1beta1_generated_PersistentResourceService_ListPersistentResources_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedPersistentResourceServiceClientSnippets
    {
        ...
        public async Task ListPersistentResourcesResourceNamesAsync()
        {
            ...
            await foreach (PersistentResource item in response)
            {
            ...
            await foreach (ListPersistentResourcesResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_PersistentResourceService_ListPersistentResources_async_flattened_resourceNames]
}
