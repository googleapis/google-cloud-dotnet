...
{
    // [START aiplatform_v1beta1_generated_GenAiCacheService_ListCachedContents_async_flattened]
    ...
    public sealed partial class GeneratedGenAiCacheServiceClientSnippets
    {
        ...
        public async Task ListCachedContentsAsync()
        {
            ...
            await foreach (CachedContent item in response)
            {
            ...
            await foreach (ListCachedContentsResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_GenAiCacheService_ListCachedContents_async_flattened]
}
