...
{
    // [START aiplatform_v1beta1_generated_ExtensionRegistryService_ListExtensions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedExtensionRegistryServiceClientSnippets
    {
        ...
        public async Task ListExtensionsResourceNamesAsync()
        {
            ...
            await foreach (Extension item in response)
            {
            ...
            await foreach (ListExtensionsResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_ExtensionRegistryService_ListExtensions_async_flattened_resourceNames]
}
