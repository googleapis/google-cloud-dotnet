...
{
    // [START aiplatform_v1beta1_generated_DatasetService_ListSavedQueries_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDatasetServiceClientSnippets
    {
        ...
        public async Task ListSavedQueriesResourceNamesAsync()
        {
            ...
            await foreach (SavedQuery item in response)
            {
            ...
            await foreach (ListSavedQueriesResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_DatasetService_ListSavedQueries_async_flattened_resourceNames]
}
