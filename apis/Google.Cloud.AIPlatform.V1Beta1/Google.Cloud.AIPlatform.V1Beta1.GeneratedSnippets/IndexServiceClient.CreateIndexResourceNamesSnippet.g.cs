...
{
    // [START aiplatform_v1beta1_generated_IndexService_CreateIndex_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedIndexServiceClientSnippets
    {
        ...
        public void CreateIndexResourceNames()
        {
            ...
            Operation<Index, CreateIndexOperationMetadata> completedResponse = response.PollUntilCompleted();
            ...
            Operation<Index, CreateIndexOperationMetadata> retrievedResponse = indexServiceClient.PollOnceCreateIndex(operationName);
    ...
    // [END aiplatform_v1beta1_generated_IndexService_CreateIndex_sync_flattened_resourceNames]
}
