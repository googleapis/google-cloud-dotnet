...
{
    // [START aiplatform_v1beta1_generated_DatasetService_ListDataItems_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDatasetServiceClientSnippets
    {
        ...
        public async Task ListDataItemsResourceNamesAsync()
        {
            ...
            await foreach (DataItem item in response)
            {
            ...
            await foreach (ListDataItemsResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_DatasetService_ListDataItems_async_flattened_resourceNames]
}
