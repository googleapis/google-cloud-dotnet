...
{
    // [START aiplatform_v1beta1_generated_SpecialistPoolService_ListSpecialistPools_async_flattened]
    ...
    public sealed partial class GeneratedSpecialistPoolServiceClientSnippets
    {
        ...
        public async Task ListSpecialistPoolsAsync()
        {
            ...
            await foreach (SpecialistPool item in response)
            {
            ...
            await foreach (ListSpecialistPoolsResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_SpecialistPoolService_ListSpecialistPools_async_flattened]
}
