...
{
    // [START aiplatform_v1beta1_generated_MetadataService_ListMetadataStores_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedMetadataServiceClientSnippets
    {
        ...
        public async Task ListMetadataStoresResourceNamesAsync()
        {
            ...
            await foreach (MetadataStore item in response)
            {
            ...
            await foreach (ListMetadataStoresResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_MetadataService_ListMetadataStores_async_flattened_resourceNames]
}
