...
{
    // [START aiplatform_v1beta1_generated_ExampleStoreService_ListExampleStores_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedExampleStoreServiceClientSnippets
    {
        ...
        public async Task ListExampleStoresResourceNamesAsync()
        {
            ...
            await foreach (ExampleStore item in response)
            {
            ...
            await foreach (ListExampleStoresResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_ExampleStoreService_ListExampleStores_async_flattened_resourceNames]
}
