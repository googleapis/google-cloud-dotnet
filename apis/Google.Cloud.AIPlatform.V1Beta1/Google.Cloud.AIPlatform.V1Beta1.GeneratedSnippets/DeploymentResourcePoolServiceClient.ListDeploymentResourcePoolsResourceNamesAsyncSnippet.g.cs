...
{
    // [START aiplatform_v1beta1_generated_DeploymentResourcePoolService_ListDeploymentResourcePools_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDeploymentResourcePoolServiceClientSnippets
    {
        ...
        public async Task ListDeploymentResourcePoolsResourceNamesAsync()
        {
            ...
            await foreach (DeploymentResourcePool item in response)
            {
            ...
            await foreach (ListDeploymentResourcePoolsResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_DeploymentResourcePoolService_ListDeploymentResourcePools_async_flattened_resourceNames]
}
