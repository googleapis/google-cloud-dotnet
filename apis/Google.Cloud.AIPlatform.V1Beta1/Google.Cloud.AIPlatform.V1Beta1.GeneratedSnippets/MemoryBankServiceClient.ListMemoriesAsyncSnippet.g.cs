...
{
    // [START aiplatform_v1beta1_generated_MemoryBankService_ListMemories_async_flattened]
    ...
    public sealed partial class GeneratedMemoryBankServiceClientSnippets
    {
        ...
        public async Task ListMemoriesAsync()
        {
            ...
            await foreach (Memory item in response)
            {
            ...
            await foreach (ListMemoriesResponse page in response.AsRawResponses())
            {
    ...
    // [END aiplatform_v1beta1_generated_MemoryBankService_ListMemories_async_flattened]
}
