...
sed -i 's/^\( *\)Schema/\1OpenApiSchema/g' $GOOGLEAPIS/google/cloud/aiplatform/v1beta1/*.proto
...
sed -i '/repeated DeployedModel deployed_models = 1 \[deprecated = true\]/d' \
  $GOOGLEAPIS/google/cloud/aiplatform/v1beta1/deployment_resource_pool_service.proto
