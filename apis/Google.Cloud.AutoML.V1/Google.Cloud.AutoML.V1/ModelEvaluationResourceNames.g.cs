...
namespace Google.Cloud.AutoML.V1
{
    ...
    public sealed partial class ModelEvaluationName : gax::IResourceName, sys::IEquatable<ModelEvaluationName>
    {
        ...
        /// <param name="modelEvaluationId">The <c>ModelEvaluation</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="ModelEvaluationName"/> constructed from the provided ids.</returns>
        public static ModelEvaluationName FromProjectLocationModelModelEvaluation(string projectId, string locationId, string modelId, string modelEvaluationId) =>
            new ModelEvaluationName(ResourceNameType.ProjectLocationModelModelEvaluation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), modelId: gax::GaxPreconditions.CheckNotNullOrEmpty(modelId, nameof(modelId)), modelEvaluationId: gax::GaxPreconditions.CheckNotNullOrEmpty(modelEvaluationId, nameof(modelEvaluationId)));
        ...
        public static string Format(string projectId, string locationId, string modelId, string modelEvaluationId) =>
            FormatProjectLocationModelModelEvaluation(projectId, locationId, modelId, modelEvaluationId);
        ...
        /// <c>projects/{project}/locations/{location}/models/{model}/modelEvaluations/{model_evaluation}</c>.
        /// </returns>
        public static string FormatProjectLocationModelModelEvaluation(string projectId, string locationId, string modelId, string modelEvaluationId) =>
        ...
        public static bool TryParse(string modelEvaluationName, bool allowUnparsed, out ModelEvaluationName result)
        {
            ...
            if (s_projectLocationModelModelEvaluation.TryParseName(modelEvaluationName, out resourceName))
            {
                result = FromProjectLocationModelModelEvaluation(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ModelEvaluationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string modelId = null, string modelEvaluationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <summary>
        /// The <c>ModelEvaluation</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationModelModelEvaluation: return s_projectLocationModelModelEvaluation.Expand(ProjectId, LocationId, ModelId, ModelEvaluationId);
