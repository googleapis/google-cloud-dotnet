...
{
    // [START vmmigration_v1_generated_VmMigration_ListCloneJobs_async]
    ...
    public sealed partial class GeneratedVmMigrationClientSnippets
    {
        ...
        public async Task ListCloneJobsRequestObjectAsync()
        {
            ...
            await foreach (CloneJob item in response)
            {
            ...
            await foreach (ListCloneJobsResponse page in response.AsRawResponses())
            {
