...
{
    // [START vmmigration_v1_generated_VmMigration_ListMigratingVms_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedVmMigrationClientSnippets
    {
        ...
        public async Task ListMigratingVmsResourceNamesAsync()
        {
            ...
            await foreach (MigratingVm item in response)
            {
            ...
            await foreach (ListMigratingVmsResponse page in response.AsRawResponses())
            {
    ...
    // [END vmmigration_v1_generated_VmMigration_ListMigratingVms_async_flattened_resourceNames]
}
