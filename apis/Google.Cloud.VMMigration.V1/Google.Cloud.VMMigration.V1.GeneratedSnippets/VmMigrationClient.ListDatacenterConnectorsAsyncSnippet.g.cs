...
{
    // [START vmmigration_v1_generated_VmMigration_ListDatacenterConnectors_async_flattened]
    ...
    public sealed partial class GeneratedVmMigrationClientSnippets
    {
        ...
        public async Task ListDatacenterConnectorsAsync()
        {
            ...
            await foreach (DatacenterConnector item in response)
            {
            ...
            await foreach (ListDatacenterConnectorsResponse page in response.AsRawResponses())
            {
    ...
    // [END vmmigration_v1_generated_VmMigration_ListDatacenterConnectors_async_flattened]
}
