...
{
    // [START vmmigration_v1_generated_VmMigration_ListImageImports_async_flattened]
    ...
    public sealed partial class GeneratedVmMigrationClientSnippets
    {
        ...
        public async Task ListImageImportsAsync()
        {
            ...
            await foreach (ImageImport item in response)
            {
            ...
            await foreach (ListImageImportsResponse page in response.AsRawResponses())
            {
    ...
    // [END vmmigration_v1_generated_VmMigration_ListImageImports_async_flattened]
}
