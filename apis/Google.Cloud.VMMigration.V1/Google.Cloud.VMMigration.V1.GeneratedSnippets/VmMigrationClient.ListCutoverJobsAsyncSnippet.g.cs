...
{
    // [START vmmigration_v1_generated_VmMigration_ListCutoverJobs_async_flattened]
    ...
    public sealed partial class GeneratedVmMigrationClientSnippets
    {
        ...
        public async Task ListCutoverJobsAsync()
        {
            ...
            await foreach (CutoverJob item in response)
            {
            ...
            await foreach (ListCutoverJobsResponse page in response.AsRawResponses())
            {
    ...
    // [END vmmigration_v1_generated_VmMigration_ListCutoverJobs_async_flattened]
}
