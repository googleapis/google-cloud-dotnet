...
{
    // [START vmmigration_v1_generated_VmMigration_ListDiskMigrationJobs_async_flattened]
    ...
    public sealed partial class GeneratedVmMigrationClientSnippets
    {
        ...
        public async Task ListDiskMigrationJobsAsync()
        {
            ...
            await foreach (DiskMigrationJob item in response)
            {
            ...
            await foreach (ListDiskMigrationJobsResponse page in response.AsRawResponses())
            {
    ...
    // [END vmmigration_v1_generated_VmMigration_ListDiskMigrationJobs_async_flattened]
}
