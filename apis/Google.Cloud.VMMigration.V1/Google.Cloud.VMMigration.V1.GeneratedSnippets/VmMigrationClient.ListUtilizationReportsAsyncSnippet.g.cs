...
{
    // [START vmmigration_v1_generated_VmMigration_ListUtilizationReports_async_flattened]
    ...
    public sealed partial class GeneratedVmMigrationClientSnippets
    {
        ...
        public async Task ListUtilizationReportsAsync()
        {
            ...
            await foreach (UtilizationReport item in response)
            {
            ...
            await foreach (ListUtilizationReportsResponse page in response.AsRawResponses())
            {
    ...
    // [END vmmigration_v1_generated_VmMigration_ListUtilizationReports_async_flattened]
}
