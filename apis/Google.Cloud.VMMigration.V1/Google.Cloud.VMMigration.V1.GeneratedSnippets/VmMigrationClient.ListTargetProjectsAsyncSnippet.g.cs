...
{
    // [START vmmigration_v1_generated_VmMigration_ListTargetProjects_async_flattened]
    ...
    public sealed partial class GeneratedVmMigrationClientSnippets
    {
        ...
        public async Task ListTargetProjectsAsync()
        {
            ...
            await foreach (TargetProject item in response)
            {
            ...
            await foreach (ListTargetProjectsResponse page in response.AsRawResponses())
            {
    ...
    // [END vmmigration_v1_generated_VmMigration_ListTargetProjects_async_flattened]
}
