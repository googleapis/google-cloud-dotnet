...
namespace Google.Cloud.NetworkConnectivity.V1.Snippets
{
    ...
    public sealed class GeneratedHubServiceClientSnippets
    {
        ...
        {
            // Snippet: DeactivateSpoke(DeactivateSpokeRequest, CallSettings)
            // Create client
            HubServiceClient hubServiceClient = HubServiceClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: DeactivateSpokeAsync(DeactivateSpokeRequest, CallSettings)
            // Additional: DeactivateSpokeAsync(DeactivateSpokeRequest, CancellationToken)
            // Create client
            HubServiceClient hubServiceClient = await HubServiceClient.CreateAsync();
            // Initialize request argument(s)
            DeactivateSpokeRequest request = new DeactivateSpokeRequest
        ...
        {
            // Snippet: DeactivateSpoke(string, CallSettings)
            // Create client
            HubServiceClient hubServiceClient = HubServiceClient.Create();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/spokes/[SPOKE]";
        ...
        {
            // Snippet: DeactivateSpokeAsync(string, CallSettings)
            // Additional: DeactivateSpokeAsync(string, CancellationToken)
            // Create client
            HubServiceClient hubServiceClient = await HubServiceClient.CreateAsync();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/spokes/[SPOKE]";
        ...
        {
            // Snippet: DeactivateSpoke(SpokeName, CallSettings)
            // Create client
            HubServiceClient hubServiceClient = HubServiceClient.Create();
            // Initialize request argument(s)
            SpokeName name = SpokeName.FromProjectLocationSpoke("[PROJECT]", "[LOCATION]", "[SPOKE]");
        ...
        {
            // Snippet: DeactivateSpokeAsync(SpokeName, CallSettings)
            // Additional: DeactivateSpokeAsync(SpokeName, CancellationToken)
            // Create client
            HubServiceClient hubServiceClient = await HubServiceClient.CreateAsync();
            // Initialize request argument(s)
            SpokeName name = SpokeName.FromProjectLocationSpoke("[PROJECT]", "[LOCATION]", "[SPOKE]");
        ...
        {
            // Snippet: ActivateSpoke(ActivateSpokeRequest, CallSettings)
            // Create client
            HubServiceClient hubServiceClient = HubServiceClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: ActivateSpokeAsync(ActivateSpokeRequest, CallSettings)
            // Additional: ActivateSpokeAsync(ActivateSpokeRequest, CancellationToken)
            // Create client
            HubServiceClient hubServiceClient = await HubServiceClient.CreateAsync();
            // Initialize request argument(s)
            ActivateSpokeRequest request = new ActivateSpokeRequest
        ...
        {
            // Snippet: ActivateSpoke(string, CallSettings)
            // Create client
            HubServiceClient hubServiceClient = HubServiceClient.Create();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/spokes/[SPOKE]";
        ...
        {
            // Snippet: ActivateSpokeAsync(string, CallSettings)
            // Additional: ActivateSpokeAsync(string, CancellationToken)
            // Create client
            HubServiceClient hubServiceClient = await HubServiceClient.CreateAsync();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/spokes/[SPOKE]";
        ...
        {
            // Snippet: ActivateSpoke(SpokeName, CallSettings)
            // Create client
            HubServiceClient hubServiceClient = HubServiceClient.Create();
            // Initialize request argument(s)
            SpokeName name = SpokeName.FromProjectLocationSpoke("[PROJECT]", "[LOCATION]", "[SPOKE]");
        ...
        {
            // Snippet: ActivateSpokeAsync(SpokeName, CallSettings)
            // Additional: ActivateSpokeAsync(SpokeName, CancellationToken)
            // Create client
            HubServiceClient hubServiceClient = await HubServiceClient.CreateAsync();
            // Initialize request argument(s)
            SpokeName name = SpokeName.FromProjectLocationSpoke("[PROJECT]", "[LOCATION]", "[SPOKE]");
