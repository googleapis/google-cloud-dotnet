...
{
    // [START networkconnectivity_v1_generated_CrossNetworkAutomationService_ListServiceConnectionPolicies_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCrossNetworkAutomationServiceClientSnippets
    {
        ...
        public async Task ListServiceConnectionPoliciesResourceNamesAsync()
        {
            ...
            await foreach (ServiceConnectionPolicy item in response)
            {
            ...
            await foreach (ListServiceConnectionPoliciesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkconnectivity_v1_generated_CrossNetworkAutomationService_ListServiceConnectionPolicies_async_flattened_resourceNames]
}
