...
{
    // [START networkconnectivity_v1_generated_InternalRangeService_ListInternalRanges_async]
    ...
    public sealed partial class GeneratedInternalRangeServiceClientSnippets
    {
        ...
        public async Task ListInternalRangesRequestObjectAsync()
        {
            ...
            await foreach (InternalRange item in response)
            {
            ...
            await foreach (ListInternalRangesResponse page in response.AsRawResponses())
            {
