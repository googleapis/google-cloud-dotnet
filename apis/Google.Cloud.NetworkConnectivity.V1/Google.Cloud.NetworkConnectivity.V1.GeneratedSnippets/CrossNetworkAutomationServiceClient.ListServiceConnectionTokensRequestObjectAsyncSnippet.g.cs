...
{
    // [START networkconnectivity_v1_generated_CrossNetworkAutomationService_ListServiceConnectionTokens_async]
    ...
    public sealed partial class GeneratedCrossNetworkAutomationServiceClientSnippets
    {
        ...
        public async Task ListServiceConnectionTokensRequestObjectAsync()
        {
            ...
            await foreach (ServiceConnectionToken item in response)
            {
            ...
            await foreach (ListServiceConnectionTokensResponse page in response.AsRawResponses())
            {
    ...
    // [END networkconnectivity_v1_generated_CrossNetworkAutomationService_ListServiceConnectionTokens_async]
}
