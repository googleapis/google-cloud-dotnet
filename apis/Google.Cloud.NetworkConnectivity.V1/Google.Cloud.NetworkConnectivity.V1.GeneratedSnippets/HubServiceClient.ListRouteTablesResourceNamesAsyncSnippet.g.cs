...
{
    // [START networkconnectivity_v1_generated_HubService_ListRouteTables_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedHubServiceClientSnippets
    {
        ...
        public async Task ListRouteTablesResourceNamesAsync()
        {
            ...
            await foreach (RouteTable item in response)
            {
            ...
            await foreach (ListRouteTablesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkconnectivity_v1_generated_HubService_ListRouteTables_async_flattened_resourceNames]
}
