...
namespace Google.Cloud.NetworkConnectivity.V1
{
    ...
    public sealed partial class PolicyBasedRouteName : gax::IResourceName, sys::IEquatable<PolicyBasedRouteName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/{location}/global/PolicyBasedRoutes/{policy_based_route}</c>.
            /// </summary>
            ProjectLocationPolicyBasedRoute = 1,
        }

        private static gax::PathTemplate s_projectLocationPolicyBasedRoute = new gax::PathTemplate("projects/{project}/{location}/global/PolicyBasedRoutes/{policy_based_route}");
        ...
        public static PolicyBasedRouteName FromProjectLocationPolicyBasedRoute(string projectId, string locationId, string policyBasedRouteId) =>
            new PolicyBasedRouteName(ResourceNameType.ProjectLocationPolicyBasedRoute, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), policyBasedRouteId: gax::GaxPreconditions.CheckNotNullOrEmpty(policyBasedRouteId, nameof(policyBasedRouteId)));
        ...
        /// <c>projects/{project}/{location}/global/PolicyBasedRoutes/{policy_based_route}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string policyBasedRouteId) =>
            FormatProjectLocationPolicyBasedRoute(projectId, locationId, policyBasedRouteId);
        ...
        /// <c>projects/{project}/{location}/global/PolicyBasedRoutes/{policy_based_route}</c>.
        /// </returns>
        public static string FormatProjectLocationPolicyBasedRoute(string projectId, string locationId, string policyBasedRouteId) =>
            s_projectLocationPolicyBasedRoute.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(policyBasedRouteId, nameof(policyBasedRouteId)));
        ...
        public static bool TryParse(string policyBasedRouteName, bool allowUnparsed, out PolicyBasedRouteName result)
        {
            ...
            if (s_projectLocationPolicyBasedRoute.TryParseName(policyBasedRouteName, out resourceName))
            {
                result = FromProjectLocationPolicyBasedRoute(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private PolicyBasedRouteName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string policyBasedRouteId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="policyBasedRouteId">The <c>PolicyBasedRoute</c> ID. Must not be <c>null</c> or empty.</param>
        public PolicyBasedRouteName(string projectId, string locationId, string policyBasedRouteId) : this(ResourceNameType.ProjectLocationPolicyBasedRoute, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), policyBasedRouteId: gax::GaxPreconditions.CheckNotNullOrEmpty(policyBasedRouteId, nameof(policyBasedRouteId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationPolicyBasedRoute: return s_projectLocationPolicyBasedRoute.Expand(ProjectId, LocationId, PolicyBasedRouteId);
