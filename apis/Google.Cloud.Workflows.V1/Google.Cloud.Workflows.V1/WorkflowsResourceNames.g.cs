...
namespace Google.Cloud.Workflows.V1
{
    ...
    public sealed partial class CryptoKeyName : gax::IResourceName, sys::IEquatable<CryptoKeyName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}</c>.
            /// </summary>
            ProjectLocationKeyRingCryptoKey = 1,
        }

        private static gax::PathTemplate s_projectLocationKeyRingCryptoKey = new gax::PathTemplate("projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}");
    ...
    public sealed partial class CryptoKeyVersionName : gax::IResourceName, sys::IEquatable<CryptoKeyVersionName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// A resource name with pattern
            /// <c>
            /// projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}/cryptoKeyVersions/{cryptoKeyVersion}</c>
            /// .
            /// </summary>
            ProjectLocationKeyRingCryptoKeyCryptoKeyVersion = 1,
        }

        private static gax::PathTemplate s_projectLocationKeyRingCryptoKeyCryptoKeyVersion = new gax::PathTemplate("projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}/cryptoKeyVersions/{cryptoKeyVersion}");
    ...
    {
        /// <summary>
        /// <see cref="gcwcv::WorkflowName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcwcv::WorkflowName WorkflowName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcwcv::WorkflowName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }

        /// <summary>
        /// <see cref="gcwv::CryptoKeyName"/>-typed view over the <see cref="CryptoKeyName"/> resource name property.
        /// </summary>
        public gcwv::CryptoKeyName CryptoKeyNameAsCryptoKeyName
        {
            get => string.IsNullOrEmpty(CryptoKeyName) ? null : gcwv::CryptoKeyName.Parse(CryptoKeyName, allowUnparsed: true);
            set => CryptoKeyName = value?.ToString() ?? "";
        }

        /// <summary>
        /// <see cref="gcwv::CryptoKeyName"/>-typed view over the <see cref="AllKmsKeys"/> resource name property.
        /// </summary>
        public gax::ResourceNameList<gcwv::CryptoKeyName> AllKmsKeysAsCryptoKeyNames
        {
            get => new gax::ResourceNameList<gcwv::CryptoKeyName>(AllKmsKeys, s => string.IsNullOrEmpty(s) ? null : gcwv::CryptoKeyName.Parse(s, allowUnparsed: true));
        }

        /// <summary>
        /// <see cref="CryptoKeyVersionName"/>-typed view over the <see cref="AllKmsKeysVersions"/> resource name
        /// property.
        /// </summary>
        public gax::ResourceNameList<CryptoKeyVersionName> AllKmsKeysVersionsAsCryptoKeyVersionNames
        {
            get => new gax::ResourceNameList<CryptoKeyVersionName>(AllKmsKeysVersions, s => string.IsNullOrEmpty(s) ? null : CryptoKeyVersionName.Parse(s, allowUnparsed: true));
        }
    ...
    public partial class ListWorkflowRevisionsRequest
    {
        /// <summary>
        /// <see cref="gcwcv::WorkflowName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
