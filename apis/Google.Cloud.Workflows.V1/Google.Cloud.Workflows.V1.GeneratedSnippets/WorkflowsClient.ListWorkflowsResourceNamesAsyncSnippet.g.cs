...
{
    // [START workflows_v1_generated_Workflows_ListWorkflows_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWorkflowsClientSnippets
    {
        ...
        public async Task ListWorkflowsResourceNamesAsync()
        {
            ...
            await foreach (Workflow item in response)
            {
            ...
            await foreach (ListWorkflowsResponse page in response.AsRawResponses())
            {
    ...
    // [END workflows_v1_generated_Workflows_ListWorkflows_async_flattened_resourceNames]
}
