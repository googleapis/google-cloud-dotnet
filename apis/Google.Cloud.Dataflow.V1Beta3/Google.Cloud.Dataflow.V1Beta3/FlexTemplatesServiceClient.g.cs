...
namespace Google.Cloud.Dataflow.V1Beta3
{
    ...
    public abstract partial class FlexTemplatesServiceClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(FlexTemplatesService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
