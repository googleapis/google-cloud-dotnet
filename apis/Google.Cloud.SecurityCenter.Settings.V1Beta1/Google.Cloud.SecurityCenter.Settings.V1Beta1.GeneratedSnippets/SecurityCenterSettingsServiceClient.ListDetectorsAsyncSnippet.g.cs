...
{
    // [START securitycenter_v1beta1_generated_SecurityCenterSettingsService_ListDetectors_async_flattened]
    ...
    public sealed partial class GeneratedSecurityCenterSettingsServiceClientSnippets
    {
        ...
        public async Task ListDetectorsAsync()
        {
            ...
            await foreach (Detector item in response)
            {
            ...
            await foreach (ListDetectorsResponse page in response.AsRawResponses())
            {
    ...
    // [END securitycenter_v1beta1_generated_SecurityCenterSettingsService_ListDetectors_async_flattened]
}
