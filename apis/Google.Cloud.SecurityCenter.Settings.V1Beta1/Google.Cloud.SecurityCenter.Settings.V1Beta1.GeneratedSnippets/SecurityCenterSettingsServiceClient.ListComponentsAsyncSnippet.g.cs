...
{
    // [START securitycenter_v1beta1_generated_SecurityCenterSettingsService_ListComponents_async_flattened]
    ...
    public sealed partial class GeneratedSecurityCenterSettingsServiceClientSnippets
    {
        ...
        public async Task ListComponentsAsync()
        {
            ...
            await foreach (ListComponentsResponse page in response.AsRawResponses())
            {
    ...
    // [END securitycenter_v1beta1_generated_SecurityCenterSettingsService_ListComponents_async_flattened]
}
