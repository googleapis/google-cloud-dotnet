...
namespace Google.Cloud.Ces.V1
{
    ...
    public sealed partial class ConversationName : gax::IResourceName, sys::IEquatable<ConversationName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/apps/{app}/conversations/{conversation}</c>.
            /// </summary>
            ProjectLocationAppConversation = 1,
        }

        private static gax::PathTemplate s_projectLocationAppConversation = new gax::PathTemplate("projects/{project}/locations/{location}/apps/{app}/conversations/{conversation}");
        ...
        public static ConversationName FromProjectLocationAppConversation(string projectId, string locationId, string appId, string conversationId) =>
            new ConversationName(ResourceNameType.ProjectLocationAppConversation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), appId: gax::GaxPreconditions.CheckNotNullOrEmpty(appId, nameof(appId)), conversationId: gax::GaxPreconditions.CheckNotNullOrEmpty(conversationId, nameof(conversationId)));
        ...
        /// <c>projects/{project}/locations/{location}/apps/{app}/conversations/{conversation}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string appId, string conversationId) =>
            FormatProjectLocationAppConversation(projectId, locationId, appId, conversationId);
        ...
        /// <c>projects/{project}/locations/{location}/apps/{app}/conversations/{conversation}</c>.
        /// </returns>
        public static string FormatProjectLocationAppConversation(string projectId, string locationId, string appId, string conversationId) =>
            s_projectLocationAppConversation.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(appId, nameof(appId)), gax::GaxPreconditions.CheckNotNullOrEmpty(conversationId, nameof(conversationId)));
        ...
        public static bool TryParse(string conversationName, bool allowUnparsed, out ConversationName result)
        {
            ...
            if (s_projectLocationAppConversation.TryParseName(conversationName, out resourceName))
            {
                result = FromProjectLocationAppConversation(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ConversationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string appId = null, string conversationId = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="appId">The <c>App</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="conversationId">The <c>Conversation</c> ID. Must not be <c>null</c> or empty.</param>
        public ConversationName(string projectId, string locationId, string appId, string conversationId) : this(ResourceNameType.ProjectLocationAppConversation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), appId: gax::GaxPreconditions.CheckNotNullOrEmpty(appId, nameof(appId)), conversationId: gax::GaxPreconditions.CheckNotNullOrEmpty(conversationId, nameof(conversationId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationAppConversation: return s_projectLocationAppConversation.Expand(ProjectId, LocationId, AppId, ConversationId);
