...
namespace Google.Cloud.Ces.V1
{
    ...
    public sealed partial class SessionName : gax::IResourceName, sys::IEquatable<SessionName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/apps/{app}/sessions/{session}</c>
            /// .
            /// </summary>
            ProjectLocationAppSession = 1,
        }

        private static gax::PathTemplate s_projectLocationAppSession = new gax::PathTemplate("projects/{project}/locations/{location}/apps/{app}/sessions/{session}");
        ...
        /// <c>projects/{project}/locations/{location}/apps/{app}/sessions/{session}</c>.
        /// </summary>
        ...
        public static SessionName FromProjectLocationAppSession(string projectId, string locationId, string appId, string sessionId) =>
            new SessionName(ResourceNameType.ProjectLocationAppSession, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), appId: gax::GaxPreconditions.CheckNotNullOrEmpty(appId, nameof(appId)), sessionId: gax::GaxPreconditions.CheckNotNullOrEmpty(sessionId, nameof(sessionId)));
        ...
        /// <c>projects/{project}/locations/{location}/apps/{app}/sessions/{session}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string appId, string sessionId) =>
            FormatProjectLocationAppSession(projectId, locationId, appId, sessionId);
        ...
        /// <c>projects/{project}/locations/{location}/apps/{app}/sessions/{session}</c>.
        /// </returns>
        public static string FormatProjectLocationAppSession(string projectId, string locationId, string appId, string sessionId) =>
            s_projectLocationAppSession.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(appId, nameof(appId)), gax::GaxPreconditions.CheckNotNullOrEmpty(sessionId, nameof(sessionId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/apps/{app}/sessions/{session}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string sessionName, bool allowUnparsed, out SessionName result)
        {
            ...
            if (s_projectLocationAppSession.TryParseName(sessionName, out resourceName))
            {
                result = FromProjectLocationAppSession(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private SessionName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string appId = null, string locationId = null, string projectId = null, string sessionId = null)
        {
            Type = type;
        ...
        /// <param name="appId">The <c>App</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="sessionId">The <c>Session</c> ID. Must not be <c>null</c> or empty.</param>
        public SessionName(string projectId, string locationId, string appId, string sessionId) : this(ResourceNameType.ProjectLocationAppSession, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), appId: gax::GaxPreconditions.CheckNotNullOrEmpty(appId, nameof(appId)), sessionId: gax::GaxPreconditions.CheckNotNullOrEmpty(sessionId, nameof(sessionId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationAppSession: return s_projectLocationAppSession.Expand(ProjectId, LocationId, AppId, SessionId);
