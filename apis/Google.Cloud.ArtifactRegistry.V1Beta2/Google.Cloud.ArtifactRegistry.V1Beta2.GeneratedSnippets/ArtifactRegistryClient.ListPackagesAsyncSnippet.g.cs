...
{
    // [START artifactregistry_v1beta2_generated_ArtifactRegistry_ListPackages_async_flattened]
    ...
    public sealed partial class GeneratedArtifactRegistryClientSnippets
    {
        ...
        public async Task ListPackagesAsync()
        {
            ...
            await foreach (Package item in response)
            {
            ...
            await foreach (ListPackagesResponse page in response.AsRawResponses())
            {
    ...
    // [END artifactregistry_v1beta2_generated_ArtifactRegistry_ListPackages_async_flattened]
}
