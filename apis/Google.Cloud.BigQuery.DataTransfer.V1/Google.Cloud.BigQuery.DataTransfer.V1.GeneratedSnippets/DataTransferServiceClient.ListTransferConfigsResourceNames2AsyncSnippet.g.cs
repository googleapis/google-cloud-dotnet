...
{
    // [START bigquerydatatransfer_v1_generated_DataTransferService_ListTransferConfigs_async_flattened_resourceNames2]
    ...
    public sealed partial class GeneratedDataTransferServiceClientSnippets
    {
        ...
        public async Task ListTransferConfigsResourceNames2Async()
        {
            ...
            await foreach (TransferConfig item in response)
            {
            ...
            await foreach (ListTransferConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END bigquerydatatransfer_v1_generated_DataTransferService_ListTransferConfigs_async_flattened_resourceNames2]
}
