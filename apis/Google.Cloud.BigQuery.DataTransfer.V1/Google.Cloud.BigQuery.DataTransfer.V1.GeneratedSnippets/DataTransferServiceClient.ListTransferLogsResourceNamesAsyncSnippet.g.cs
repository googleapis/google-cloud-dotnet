...
{
    // [START bigquerydatatransfer_v1_generated_DataTransferService_ListTransferLogs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataTransferServiceClientSnippets
    {
        ...
        public async Task ListTransferLogsResourceNamesAsync()
        {
            ...
            await foreach (TransferMessage item in response)
            {
            ...
            await foreach (ListTransferLogsResponse page in response.AsRawResponses())
            {
    ...
    // [END bigquerydatatransfer_v1_generated_DataTransferService_ListTransferLogs_async_flattened_resourceNames]
}
