...
{
    // [START bigquerydatatransfer_v1_generated_DataTransferService_ListTransferRuns_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataTransferServiceClientSnippets
    {
        ...
        public async Task ListTransferRunsResourceNamesAsync()
        {
            ...
            await foreach (TransferRun item in response)
            {
            ...
            await foreach (ListTransferRunsResponse page in response.AsRawResponses())
            {
    ...
    // [END bigquerydatatransfer_v1_generated_DataTransferService_ListTransferRuns_async_flattened_resourceNames]
}
