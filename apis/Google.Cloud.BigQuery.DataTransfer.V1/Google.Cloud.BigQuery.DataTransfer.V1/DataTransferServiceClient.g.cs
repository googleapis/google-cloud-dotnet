...
namespace Google.Cloud.BigQuery.DataTransfer.V1
{
    ...
    public sealed partial class DataTransferServiceClientImpl : DataTransferServiceClient
    {
        ...
        public DataTransferServiceClientImpl(DataTransferService.DataTransferServiceClient grpcClient, DataTransferServiceSettings settings)
        {
            ...
            _callGetDataSource = clientHelper.BuildApiCall<GetDataSourceRequest, DataSource>(grpcClient.GetDataSourceAsync, grpcClient.GetDataSource, effectiveSettings.GetDataSourceSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetDataSource);
            Modify_GetDataSourceApiCall(ref _callGetDataSource);
            _callListDataSources = clientHelper.BuildApiCall<ListDataSourcesRequest, ListDataSourcesResponse>(grpcClient.ListDataSourcesAsync, grpcClient.ListDataSources, effectiveSettings.ListDataSourcesSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListDataSources);
            Modify_ListDataSourcesApiCall(ref _callListDataSources);
            _callCreateTransferConfig = clientHelper.BuildApiCall<CreateTransferConfigRequest, TransferConfig>(grpcClient.CreateTransferConfigAsync, grpcClient.CreateTransferConfig, effectiveSettings.CreateTransferConfigSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateTransferConfig);
            Modify_CreateTransferConfigApiCall(ref _callCreateTransferConfig);
            _callUpdateTransferConfig = clientHelper.BuildApiCall<UpdateTransferConfigRequest, TransferConfig>(grpcClient.UpdateTransferConfigAsync, grpcClient.UpdateTransferConfig, effectiveSettings.UpdateTransferConfigSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"transfer_config.name={(sysnet::WebUtility.UrlEncode(request.TransferConfig.Name))}"));
            Modify_ApiCall(ref _callUpdateTransferConfig);
            Modify_UpdateTransferConfigApiCall(ref _callUpdateTransferConfig);
            _callDeleteTransferConfig = clientHelper.BuildApiCall<DeleteTransferConfigRequest, wkt::Empty>(grpcClient.DeleteTransferConfigAsync, grpcClient.DeleteTransferConfig, effectiveSettings.DeleteTransferConfigSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callDeleteTransferConfig);
            Modify_DeleteTransferConfigApiCall(ref _callDeleteTransferConfig);
            _callGetTransferConfig = clientHelper.BuildApiCall<GetTransferConfigRequest, TransferConfig>(grpcClient.GetTransferConfigAsync, grpcClient.GetTransferConfig, effectiveSettings.GetTransferConfigSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetTransferConfig);
            Modify_GetTransferConfigApiCall(ref _callGetTransferConfig);
            _callListTransferConfigs = clientHelper.BuildApiCall<ListTransferConfigsRequest, ListTransferConfigsResponse>(grpcClient.ListTransferConfigsAsync, grpcClient.ListTransferConfigs, effectiveSettings.ListTransferConfigsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListTransferConfigs);
            Modify_ListTransferConfigsApiCall(ref _callListTransferConfigs);
            _callScheduleTransferRuns = clientHelper.BuildApiCall<ScheduleTransferRunsRequest, ScheduleTransferRunsResponse>(grpcClient.ScheduleTransferRunsAsync, grpcClient.ScheduleTransferRuns, effectiveSettings.ScheduleTransferRunsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callScheduleTransferRuns);
            Modify_ScheduleTransferRunsApiCall(ref _callScheduleTransferRuns);
            _callStartManualTransferRuns = clientHelper.BuildApiCall<StartManualTransferRunsRequest, StartManualTransferRunsResponse>(grpcClient.StartManualTransferRunsAsync, grpcClient.StartManualTransferRuns, effectiveSettings.StartManualTransferRunsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callStartManualTransferRuns);
            Modify_StartManualTransferRunsApiCall(ref _callStartManualTransferRuns);
            _callGetTransferRun = clientHelper.BuildApiCall<GetTransferRunRequest, TransferRun>(grpcClient.GetTransferRunAsync, grpcClient.GetTransferRun, effectiveSettings.GetTransferRunSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetTransferRun);
            Modify_GetTransferRunApiCall(ref _callGetTransferRun);
            _callDeleteTransferRun = clientHelper.BuildApiCall<DeleteTransferRunRequest, wkt::Empty>(grpcClient.DeleteTransferRunAsync, grpcClient.DeleteTransferRun, effectiveSettings.DeleteTransferRunSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callDeleteTransferRun);
            Modify_DeleteTransferRunApiCall(ref _callDeleteTransferRun);
            _callListTransferRuns = clientHelper.BuildApiCall<ListTransferRunsRequest, ListTransferRunsResponse>(grpcClient.ListTransferRunsAsync, grpcClient.ListTransferRuns, effectiveSettings.ListTransferRunsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListTransferRuns);
            Modify_ListTransferRunsApiCall(ref _callListTransferRuns);
            _callListTransferLogs = clientHelper.BuildApiCall<ListTransferLogsRequest, ListTransferLogsResponse>(grpcClient.ListTransferLogsAsync, grpcClient.ListTransferLogs, effectiveSettings.ListTransferLogsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListTransferLogs);
            Modify_ListTransferLogsApiCall(ref _callListTransferLogs);
            _callCheckValidCreds = clientHelper.BuildApiCall<CheckValidCredsRequest, CheckValidCredsResponse>(grpcClient.CheckValidCredsAsync, grpcClient.CheckValidCreds, effectiveSettings.CheckValidCredsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
