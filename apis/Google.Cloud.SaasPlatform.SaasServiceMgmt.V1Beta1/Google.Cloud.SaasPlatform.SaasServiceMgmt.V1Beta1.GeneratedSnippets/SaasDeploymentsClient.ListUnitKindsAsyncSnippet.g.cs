...
{
    // [START saasservicemgmt_v1beta1_generated_SaasDeployments_ListUnitKinds_async_flattened]
    ...
    public sealed partial class GeneratedSaasDeploymentsClientSnippets
    {
        ...
        public async Task ListUnitKindsAsync()
        {
            ...
            await foreach (UnitKind item in response)
            {
            ...
            await foreach (ListUnitKindsResponse page in response.AsRawResponses())
            {
    ...
    // [END saasservicemgmt_v1beta1_generated_SaasDeployments_ListUnitKinds_async_flattened]
}
