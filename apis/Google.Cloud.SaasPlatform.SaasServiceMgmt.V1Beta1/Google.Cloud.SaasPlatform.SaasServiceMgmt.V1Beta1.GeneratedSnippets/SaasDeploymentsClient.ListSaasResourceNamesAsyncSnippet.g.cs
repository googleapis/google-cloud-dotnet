...
{
    // [START saasservicemgmt_v1beta1_generated_SaasDeployments_ListSaas_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSaasDeploymentsClientSnippets
    {
        ...
        public async Task ListSaasResourceNamesAsync()
        {
            ...
            await foreach (Saas item in response)
            {
            ...
            await foreach (ListSaasResponse page in response.AsRawResponses())
            {
    ...
    // [END saasservicemgmt_v1beta1_generated_SaasDeployments_ListSaas_async_flattened_resourceNames]
}
