...
{
    // [START saasservicemgmt_v1beta1_generated_SaasDeployments_ListUnits_async_flattened]
    ...
    public sealed partial class GeneratedSaasDeploymentsClientSnippets
    {
        ...
        public async Task ListUnitsAsync()
        {
            ...
            await foreach (Unit item in response)
            {
            ...
            await foreach (ListUnitsResponse page in response.AsRawResponses())
            {
    ...
    // [END saasservicemgmt_v1beta1_generated_SaasDeployments_ListUnits_async_flattened]
}
