...
{
    // [START saasservicemgmt_v1beta1_generated_SaasDeployments_ListUnitOperations_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSaasDeploymentsClientSnippets
    {
        ...
        public async Task ListUnitOperationsResourceNamesAsync()
        {
            ...
            await foreach (UnitOperation item in response)
            {
            ...
            await foreach (ListUnitOperationsResponse page in response.AsRawResponses())
            {
    ...
    // [END saasservicemgmt_v1beta1_generated_SaasDeployments_ListUnitOperations_async_flattened_resourceNames]
}
