...
namespace Google.Cloud.OsLogin.V1Beta.Snippets
{
    ...
    public sealed class GeneratedOsLoginServiceClientSnippets
    {
        ...
        public void ImportSshPublicKey_RequestObject()
        {
            ...
            {
                ParentAsSshPublicKeyName = SshPublicKeyName.FromUserFingerprint("[USER]", "[FINGERPRINT]"),
        ...
        public void ImportSshPublicKey1()
        {
            ...
            OsLoginServiceClient osLoginServiceClient = OsLoginServiceClient.Create();
            // Initialize request argument(s)
            string parent = "users/[USER]/sshPublicKeys/[FINGERPRINT]";
        ...
        {
            // Snippet: ImportSshPublicKey(SshPublicKeyName, SshPublicKey, CallSettings)
            // Create client
            OsLoginServiceClient osLoginServiceClient = OsLoginServiceClient.Create();
            // Initialize request argument(s)
            SshPublicKeyName parent = SshPublicKeyName.FromUserFingerprint("[USER]", "[FINGERPRINT]");
            SshPublicKey sshPublicKey = new SshPublicKey();
            // Make the request
            ImportSshPublicKeyResponse response = osLoginServiceClient.ImportSshPublicKey(parent, sshPublicKey);
            // End snippet
        ...
        {
            // Snippet: ImportSshPublicKeyAsync(SshPublicKeyName, SshPublicKey, CallSettings)
            // Additional: ImportSshPublicKeyAsync(SshPublicKeyName, SshPublicKey, CancellationToken)
            // Create client
            OsLoginServiceClient osLoginServiceClient = await OsLoginServiceClient.CreateAsync();
            // Initialize request argument(s)
            SshPublicKeyName parent = SshPublicKeyName.FromUserFingerprint("[USER]", "[FINGERPRINT]");
        ...
        {
            // Snippet: ImportSshPublicKey(SshPublicKeyName, SshPublicKey, string, CallSettings)
            // Create client
            OsLoginServiceClient osLoginServiceClient = OsLoginServiceClient.Create();
            // Initialize request argument(s)
            SshPublicKeyName parent = SshPublicKeyName.FromUserFingerprint("[USER]", "[FINGERPRINT]");
        ...
        {
            // Snippet: ImportSshPublicKeyAsync(SshPublicKeyName, SshPublicKey, string, CallSettings)
            // Additional: ImportSshPublicKeyAsync(SshPublicKeyName, SshPublicKey, string, CancellationToken)
            // Create client
            OsLoginServiceClient osLoginServiceClient = await OsLoginServiceClient.CreateAsync();
            // Initialize request argument(s)
            SshPublicKeyName parent = SshPublicKeyName.FromUserFingerprint("[USER]", "[FINGERPRINT]");
