...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class SpannerDbContextOptionsExtensions
    {
        ...
        /// <list type="bullet">
        /// <item>Does not support specifying secondary indices in queries.</item>
        /// <item>Timezone is defaulted to UTC.</item>
        /// <item>Updates to data will not be returned by subequent database queries until the transaction is commited (read your own writes).</item>
        /// <item>Cloud Spanner does not support database generated column values or constraints.</item>
        /// <item>Migration support is limited to simple Create and Delete.</item>
        /// <item>Migration commands are never executed within a transaction, so may be partially executed if interrupted.</item>
        /// </list>
        /// </summary>
