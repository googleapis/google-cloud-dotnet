...
namespace Google.Cloud.GkeConnect.Gateway.V1Beta1
{
    ...
    public sealed partial class GatewayServiceClientBuilder : gaxgrpc::ClientBuilderBase<GatewayServiceClient>
    {
        ...
        private GatewayServiceClient BuildImpl()
        {
            ...
            return GatewayServiceClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class GatewayServiceClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(GatewayService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
