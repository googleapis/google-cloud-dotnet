...
{
    // [START cloudsecuritycompliance_v1_generated_Monitoring_ListControlComplianceSummaries_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedMonitoringClientSnippets
    {
        ...
        public async Task ListControlComplianceSummariesResourceNamesAsync()
        {
            ...
            await foreach (ControlComplianceSummary item in response)
            {
            ...
            await foreach (ListControlComplianceSummariesResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudsecuritycompliance_v1_generated_Monitoring_ListControlComplianceSummaries_async_flattened_resourceNames]
}
