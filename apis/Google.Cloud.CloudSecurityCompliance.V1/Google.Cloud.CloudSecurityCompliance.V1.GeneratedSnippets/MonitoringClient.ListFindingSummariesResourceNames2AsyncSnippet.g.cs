...
{
    // [START cloudsecuritycompliance_v1_generated_Monitoring_ListFindingSummaries_async_flattened_resourceNames2]
    ...
    public sealed partial class GeneratedMonitoringClientSnippets
    {
        ...
        public async Task ListFindingSummariesResourceNames2Async()
        {
            ...
            await foreach (ListFindingSummariesResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudsecuritycompliance_v1_generated_Monitoring_ListFindingSummaries_async_flattened_resourceNames2]
}
