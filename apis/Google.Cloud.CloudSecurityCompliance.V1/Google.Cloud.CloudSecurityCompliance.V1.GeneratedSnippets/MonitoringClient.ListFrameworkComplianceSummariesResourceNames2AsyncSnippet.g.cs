...
{
    // [START cloudsecuritycompliance_v1_generated_Monitoring_ListFrameworkComplianceSummaries_async_flattened_resourceNames2]
    ...
    public sealed partial class GeneratedMonitoringClientSnippets
    {
        ...
        public async Task ListFrameworkComplianceSummariesResourceNames2Async()
        {
            ...
            await foreach (FrameworkComplianceSummary item in response)
            {
            ...
            await foreach (ListFrameworkComplianceSummariesResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudsecuritycompliance_v1_generated_Monitoring_ListFrameworkComplianceSummaries_async_flattened_resourceNames2]
}
