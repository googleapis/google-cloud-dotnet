...
{
    // [START meet_v2_generated_SpacesService_ListMembers_async]
    ...
    public sealed partial class GeneratedSpacesServiceClientSnippets
    {
        ...
        public async Task ListMembersRequestObjectAsync()
        {
            ...
            await foreach (Member item in response)
            {
            ...
            await foreach (ListMembersResponse page in response.AsRawResponses())
            {
    ...
    // [END meet_v2_generated_SpacesService_ListMembers_async]
}
