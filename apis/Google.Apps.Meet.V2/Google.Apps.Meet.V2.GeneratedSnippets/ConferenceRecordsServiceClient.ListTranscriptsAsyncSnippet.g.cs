...
{
    // [START meet_v2_generated_ConferenceRecordsService_ListTranscripts_async_flattened]
    ...
    public sealed partial class GeneratedConferenceRecordsServiceClientSnippets
    {
        ...
        public async Task ListTranscriptsAsync()
        {
            ...
            await foreach (Transcript item in response)
            {
            ...
            await foreach (ListTranscriptsResponse page in response.AsRawResponses())
            {
    ...
    // [END meet_v2_generated_ConferenceRecordsService_ListTranscripts_async_flattened]
}
