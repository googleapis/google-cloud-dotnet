...
{
    // [START meet_v2_generated_ConferenceRecordsService_ListRecordings_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedConferenceRecordsServiceClientSnippets
    {
        ...
        public async Task ListRecordingsResourceNamesAsync()
        {
            ...
            await foreach (Recording item in response)
            {
            ...
            await foreach (ListRecordingsResponse page in response.AsRawResponses())
            {
    ...
    // [END meet_v2_generated_ConferenceRecordsService_ListRecordings_async_flattened_resourceNames]
}
