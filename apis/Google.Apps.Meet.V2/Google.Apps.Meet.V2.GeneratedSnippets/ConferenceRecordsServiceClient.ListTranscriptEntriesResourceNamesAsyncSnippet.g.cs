...
{
    // [START meet_v2_generated_ConferenceRecordsService_ListTranscriptEntries_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedConferenceRecordsServiceClientSnippets
    {
        ...
        public async Task ListTranscriptEntriesResourceNamesAsync()
        {
            ...
            await foreach (TranscriptEntry item in response)
            {
            ...
            await foreach (ListTranscriptEntriesResponse page in response.AsRawResponses())
            {
    ...
    // [END meet_v2_generated_ConferenceRecordsService_ListTranscriptEntries_async_flattened_resourceNames]
}
