...
namespace Google.Cloud.HypercomputeCluster.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.HypercomputeCluster.V1", GetFileDescriptors)
        ...
        {
            yield return HypercomputeClusterReflection.Descriptor;
