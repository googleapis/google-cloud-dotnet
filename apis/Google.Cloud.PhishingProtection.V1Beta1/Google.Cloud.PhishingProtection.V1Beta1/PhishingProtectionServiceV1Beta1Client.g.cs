...
namespace Google.Cloud.PhishingProtection.V1Beta1
{
    ...
    public abstract partial class PhishingProtectionServiceV1Beta1Client
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(PhishingProtectionServiceV1Beta1.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
