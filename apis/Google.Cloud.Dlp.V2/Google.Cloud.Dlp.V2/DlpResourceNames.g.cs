...
namespace Google.Cloud.Dlp.V2
{
    ...
    public sealed partial class ContentPolicyName : gax::IResourceName, sys::IEquatable<ContentPolicyName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// .
            /// </summary>
            ProjectLocationContentPolicy = 1,
        }
        ...
        /// <c>projects/{project}/locations/{location}/contentPolicies/{content_policy}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string contentPolicyId) =>
            FormatProjectLocationContentPolicy(projectId, locationId, contentPolicyId);
        ...
        private ContentPolicyName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string contentPolicyId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="contentPolicyId">The <c>ContentPolicy</c> ID. Must not be <c>null</c> or empty.</param>
        public ContentPolicyName(string projectId, string locationId, string contentPolicyId) : this(ResourceNameType.ProjectLocationContentPolicy, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), contentPolicyId: gax::GaxPreconditions.CheckNotNullOrEmpty(contentPolicyId, nameof(contentPolicyId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ContentPolicy</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
    ...
    public partial class CreateContentPolicyRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class GetContentPolicyRequest
    {
        /// <summary>
        /// <see cref="gcdv::ContentPolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcdv::ContentPolicyName ContentPolicyName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcdv::ContentPolicyName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class ListContentPoliciesRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class UpdateContentPolicyRequest
    {
        /// <summary>
        /// <see cref="gcdv::ContentPolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class DeleteContentPolicyRequest
    {
        /// <summary>
        /// <see cref="gcdv::ContentPolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class ContentPolicy
    {
        /// <summary>
        /// <see cref="gcdv::ContentPolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
