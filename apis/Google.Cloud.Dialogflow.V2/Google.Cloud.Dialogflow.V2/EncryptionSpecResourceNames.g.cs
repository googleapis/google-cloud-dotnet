...
namespace Google.Cloud.Dialogflow.V2
{
    ...
    {
        /// <summary>
        /// <see cref="gcdv::EncryptionSpecName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcdv::EncryptionSpecName EncryptionSpecName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcdv::EncryptionSpecName.Parse(Name, allowUnparsed: true);
