...
namespace Google.Cloud.Dialogflow.V2
{
    ...
    public sealed partial class KnowledgeBasesClientBuilder : gaxgrpc::ClientBuilderBase<KnowledgeBasesClient>
    {
        ...
        private KnowledgeBasesClient BuildImpl()
        {
            ...
            return KnowledgeBasesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class KnowledgeBasesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(KnowledgeBases.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
