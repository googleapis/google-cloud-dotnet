...
namespace Google.Cloud.Dialogflow.V2
{
    ...
    public abstract partial class AgentsClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="AgentsClient"/>, applying defaults for all unspecified settings, and
        ...
        /// <summary>
        /// Synchronously creates a <see cref="AgentsClient"/>, applying defaults for all unspecified settings, and
        /// creating a channel connecting to the given endpoint with application default credentials where necessary.
        /// See the example for how to use custom credentials.
        /// </summary>
        /// <example>
        ...
        /// <summary>
        /// Shuts down any channels automatically created by <see cref="Create(grpccore::CallInvoker,AgentsSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,AgentsSettings)"/>. Channels which weren't automatically
        /// created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to <see cref="Create(grpccore::CallInvoker,AgentsSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,AgentsSettings)"/> will create new channels, which could in
    ...
    public sealed partial class AgentsClientImpl : AgentsClient
    {
        ...
        public AgentsClientImpl(Agents.AgentsClient grpcClient, AgentsSettings settings)
        {
            ...
            _callGetAgent = clientHelper.BuildApiCall<GetAgentRequest, Agent>(grpcClient.GetAgentAsync, grpcClient.GetAgent, effectiveSettings.GetAgentSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callGetAgent);
            Modify_GetAgentApiCall(ref _callGetAgent);
            _callSetAgent = clientHelper.BuildApiCall<SetAgentRequest, Agent>(grpcClient.SetAgentAsync, grpcClient.SetAgent, effectiveSettings.SetAgentSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"agent.parent={(sysnet::WebUtility.UrlEncode(request.Agent.Parent))}"));
            Modify_ApiCall(ref _callSetAgent);
            Modify_SetAgentApiCall(ref _callSetAgent);
            _callDeleteAgent = clientHelper.BuildApiCall<DeleteAgentRequest, wkt::Empty>(grpcClient.DeleteAgentAsync, grpcClient.DeleteAgent, effectiveSettings.DeleteAgentSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callDeleteAgent);
            Modify_DeleteAgentApiCall(ref _callDeleteAgent);
            _callSearchAgents = clientHelper.BuildApiCall<SearchAgentsRequest, SearchAgentsResponse>(grpcClient.SearchAgentsAsync, grpcClient.SearchAgents, effectiveSettings.SearchAgentsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callSearchAgents);
            Modify_SearchAgentsApiCall(ref _callSearchAgents);
            _callTrainAgent = clientHelper.BuildApiCall<TrainAgentRequest, lro::Operation>(grpcClient.TrainAgentAsync, grpcClient.TrainAgent, effectiveSettings.TrainAgentSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callTrainAgent);
            Modify_TrainAgentApiCall(ref _callTrainAgent);
            _callExportAgent = clientHelper.BuildApiCall<ExportAgentRequest, lro::Operation>(grpcClient.ExportAgentAsync, grpcClient.ExportAgent, effectiveSettings.ExportAgentSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callExportAgent);
            Modify_ExportAgentApiCall(ref _callExportAgent);
            _callImportAgent = clientHelper.BuildApiCall<ImportAgentRequest, lro::Operation>(grpcClient.ImportAgentAsync, grpcClient.ImportAgent, effectiveSettings.ImportAgentSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callImportAgent);
            Modify_ImportAgentApiCall(ref _callImportAgent);
            _callRestoreAgent = clientHelper.BuildApiCall<RestoreAgentRequest, lro::Operation>(grpcClient.RestoreAgentAsync, grpcClient.RestoreAgent, effectiveSettings.RestoreAgentSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
