...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcdv::CompanionAgentsClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddCompanionAgentsClient(this IServiceCollection services, sys::Action<gcdv::CompanionAgentsClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcdv::CompanionAgentsClientBuilder builder = new gcdv::CompanionAgentsClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddCompanionAgentsClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcdv::CompanionAgentsClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcdv::CompanionAgentsClientBuilder builder = new gcdv::CompanionAgentsClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddConversationDatasetsClient(this IServiceCollection services, sys::Action<gcdv::ConversationDatasetsClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddConversationModelsClient(this IServiceCollection services, sys::Action<gcdv::ConversationModelsClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcdv::GeneratorEvaluationsClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddGeneratorEvaluationsClient(this IServiceCollection services, sys::Action<gcdv::GeneratorEvaluationsClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcdv::GeneratorEvaluationsClientBuilder builder = new gcdv::GeneratorEvaluationsClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddGeneratorEvaluationsClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcdv::GeneratorEvaluationsClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcdv::GeneratorEvaluationsClientBuilder builder = new gcdv::GeneratorEvaluationsClientBuilder();
                action?.Invoke(provider, builder);
