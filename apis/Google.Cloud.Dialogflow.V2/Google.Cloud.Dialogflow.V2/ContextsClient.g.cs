...
namespace Google.Cloud.Dialogflow.V2
{
    ...
    public abstract partial class ContextsClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="ContextsClient"/>, applying defaults for all unspecified settings, and
        ...
        /// <summary>
        /// Synchronously creates a <see cref="ContextsClient"/>, applying defaults for all unspecified settings, and
        /// creating a channel connecting to the given endpoint with application default credentials where necessary.
        /// See the example for how to use custom credentials.
        /// </summary>
        /// <example>
        ...
        /// <see cref="Create(grpccore::CallInvoker,ContextsSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,ContextsSettings)"/>. Channels which weren't automatically
        /// created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to <see cref="Create(grpccore::CallInvoker,ContextsSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,ContextsSettings)"/> will create new channels, which could
    ...
    public sealed partial class ContextsClientImpl : ContextsClient
    {
        ...
        public ContextsClientImpl(Contexts.ContextsClient grpcClient, ContextsSettings settings)
        {
            ...
            _callListContexts = clientHelper.BuildApiCall<ListContextsRequest, ListContextsResponse>(grpcClient.ListContextsAsync, grpcClient.ListContexts, effectiveSettings.ListContextsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListContexts);
            Modify_ListContextsApiCall(ref _callListContexts);
            _callGetContext = clientHelper.BuildApiCall<GetContextRequest, Context>(grpcClient.GetContextAsync, grpcClient.GetContext, effectiveSettings.GetContextSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetContext);
            Modify_GetContextApiCall(ref _callGetContext);
            _callCreateContext = clientHelper.BuildApiCall<CreateContextRequest, Context>(grpcClient.CreateContextAsync, grpcClient.CreateContext, effectiveSettings.CreateContextSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateContext);
            Modify_CreateContextApiCall(ref _callCreateContext);
            _callUpdateContext = clientHelper.BuildApiCall<UpdateContextRequest, Context>(grpcClient.UpdateContextAsync, grpcClient.UpdateContext, effectiveSettings.UpdateContextSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"context.name={(sysnet::WebUtility.UrlEncode(request.Context.Name))}"));
            Modify_ApiCall(ref _callUpdateContext);
            Modify_UpdateContextApiCall(ref _callUpdateContext);
            _callDeleteContext = clientHelper.BuildApiCall<DeleteContextRequest, wkt::Empty>(grpcClient.DeleteContextAsync, grpcClient.DeleteContext, effectiveSettings.DeleteContextSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callDeleteContext);
            Modify_DeleteContextApiCall(ref _callDeleteContext);
            _callDeleteAllContexts = clientHelper.BuildApiCall<DeleteAllContextsRequest, wkt::Empty>(grpcClient.DeleteAllContextsAsync, grpcClient.DeleteAllContexts, effectiveSettings.DeleteAllContextsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
