...
namespace Google.Cloud.Dialogflow.V2
{
    ...
    public sealed partial class SessionEntityTypesClientImpl : SessionEntityTypesClient
    {
        ...
        public SessionEntityTypesClientImpl(SessionEntityTypes.SessionEntityTypesClient grpcClient, SessionEntityTypesSettings settings)
        {
            ...
            _callListSessionEntityTypes = clientHelper.BuildApiCall<ListSessionEntityTypesRequest, ListSessionEntityTypesResponse>(grpcClient.ListSessionEntityTypesAsync, grpcClient.ListSessionEntityTypes, effectiveSettings.ListSessionEntityTypesSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListSessionEntityTypes);
            Modify_ListSessionEntityTypesApiCall(ref _callListSessionEntityTypes);
            _callGetSessionEntityType = clientHelper.BuildApiCall<GetSessionEntityTypeRequest, SessionEntityType>(grpcClient.GetSessionEntityTypeAsync, grpcClient.GetSessionEntityType, effectiveSettings.GetSessionEntityTypeSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetSessionEntityType);
            Modify_GetSessionEntityTypeApiCall(ref _callGetSessionEntityType);
            _callCreateSessionEntityType = clientHelper.BuildApiCall<CreateSessionEntityTypeRequest, SessionEntityType>(grpcClient.CreateSessionEntityTypeAsync, grpcClient.CreateSessionEntityType, effectiveSettings.CreateSessionEntityTypeSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateSessionEntityType);
            Modify_CreateSessionEntityTypeApiCall(ref _callCreateSessionEntityType);
            _callUpdateSessionEntityType = clientHelper.BuildApiCall<UpdateSessionEntityTypeRequest, SessionEntityType>(grpcClient.UpdateSessionEntityTypeAsync, grpcClient.UpdateSessionEntityType, effectiveSettings.UpdateSessionEntityTypeSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"session_entity_type.name={(sysnet::WebUtility.UrlEncode(request.SessionEntityType.Name))}"));
            Modify_ApiCall(ref _callUpdateSessionEntityType);
            Modify_UpdateSessionEntityTypeApiCall(ref _callUpdateSessionEntityType);
            _callDeleteSessionEntityType = clientHelper.BuildApiCall<DeleteSessionEntityTypeRequest, wkt::Empty>(grpcClient.DeleteSessionEntityTypeAsync, grpcClient.DeleteSessionEntityType, effectiveSettings.DeleteSessionEntityTypeSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
