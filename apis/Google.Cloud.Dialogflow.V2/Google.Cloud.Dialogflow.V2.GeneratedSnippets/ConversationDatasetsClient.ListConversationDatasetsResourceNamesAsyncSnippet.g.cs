...
{
    // [START dialogflow_v2_generated_ConversationDatasets_ListConversationDatasets_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedConversationDatasetsClientSnippets
    {
        ...
        public async Task ListConversationDatasetsResourceNamesAsync()
        {
            ...
            await foreach (ConversationDataset item in response)
            {
            ...
            await foreach (ListConversationDatasetsResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2_generated_ConversationDatasets_ListConversationDatasets_async_flattened_resourceNames]
}
