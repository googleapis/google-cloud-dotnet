...
{
    // [START dialogflow_v2_generated_KnowledgeBases_ListKnowledgeBases_async_flattened]
    ...
    public sealed partial class GeneratedKnowledgeBasesClientSnippets
    {
        ...
        public async Task ListKnowledgeBasesAsync()
        {
            ...
            await foreach (KnowledgeBase item in response)
            {
            ...
            await foreach (ListKnowledgeBasesResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2_generated_KnowledgeBases_ListKnowledgeBases_async_flattened]
}
