...
{
    // [START dialogflow_v2_generated_Contexts_ListContexts_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedContextsClientSnippets
    {
        ...
        public async Task ListContextsResourceNamesAsync()
        {
            ...
            await foreach (Context item in response)
            {
            ...
            await foreach (ListContextsResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2_generated_Contexts_ListContexts_async_flattened_resourceNames]
}
