...
namespace Google.Ads.MarketingPlatform.Admin.V1Alpha
{
    ...
    public abstract partial class MarketingplatformAdminServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="AnalyticsAccountLink"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListAnalyticsAccountLinksResponse, AnalyticsAccountLink> ListAnalyticsAccountLinks(gagr::OrganizationName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListAnalyticsAccountLinksRequest request = new ListAnalyticsAccountLinksRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="AnalyticsAccountLink"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListAnalyticsAccountLinksResponse, AnalyticsAccountLink> ListAnalyticsAccountLinksAsync(gagr::OrganizationName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListAnalyticsAccountLinksRequest request = new ListAnalyticsAccountLinksRequest
            {
                ParentAsOrganizationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual AnalyticsAccountLink CreateAnalyticsAccountLink(gagr::OrganizationName parent, AnalyticsAccountLink analyticsAccountLink, gaxgrpc::CallSettings callSettings = null) =>
            CreateAnalyticsAccountLink(new CreateAnalyticsAccountLinkRequest
            {
                ParentAsOrganizationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                AnalyticsAccountLink = gax::GaxPreconditions.CheckNotNull(analyticsAccountLink, nameof(analyticsAccountLink)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AnalyticsAccountLink> CreateAnalyticsAccountLinkAsync(gagr::OrganizationName parent, AnalyticsAccountLink analyticsAccountLink, gaxgrpc::CallSettings callSettings = null) =>
            CreateAnalyticsAccountLinkAsync(new CreateAnalyticsAccountLinkRequest
            {
                ParentAsOrganizationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                AnalyticsAccountLink = gax::GaxPreconditions.CheckNotNull(analyticsAccountLink, nameof(analyticsAccountLink)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AnalyticsAccountLink> CreateAnalyticsAccountLinkAsync(gagr::OrganizationName parent, AnalyticsAccountLink analyticsAccountLink, st::CancellationToken cancellationToken) =>
            CreateAnalyticsAccountLinkAsync(parent, analyticsAccountLink, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
