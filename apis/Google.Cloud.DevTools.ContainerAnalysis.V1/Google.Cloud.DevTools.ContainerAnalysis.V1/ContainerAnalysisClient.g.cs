...
namespace Google.Cloud.DevTools.ContainerAnalysis.V1
{
    ...
    public abstract partial class ContainerAnalysisClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ContainerAnalysis.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
