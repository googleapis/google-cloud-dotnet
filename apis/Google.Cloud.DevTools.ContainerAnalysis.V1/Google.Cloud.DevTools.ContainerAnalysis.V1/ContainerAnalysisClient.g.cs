...
namespace Google.Cloud.DevTools.ContainerAnalysis.V1
{
    ...
    public abstract partial class ContainerAnalysisClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="ContainerAnalysisClient"/>, applying defaults for all unspecified
        ...
        /// <summary>
        /// Synchronously creates a <see cref="ContainerAnalysisClient"/>, applying defaults for all unspecified
        /// settings, and creating a channel connecting to the given endpoint with application default credentials where
        /// necessary. See the example for how to use custom credentials.
        /// </summary>
        /// <example>
        ...
        /// <see cref="Create(grpccore::CallInvoker,ContainerAnalysisSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,ContainerAnalysisSettings)"/>. Channels which weren't
        /// automatically created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to
        /// <see cref="Create(grpccore::CallInvoker,ContainerAnalysisSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,ContainerAnalysisSettings)"/> will create new channels,
