...
{
    // [START merchantapi_v1beta_generated_AccountTaxService_ListAccountTax_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAccountTaxServiceClientSnippets
    {
        ...
        public async Task ListAccountTaxResourceNamesAsync()
        {
            ...
            await foreach (AccountTax item in response)
            {
            ...
            await foreach (ListAccountTaxResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_AccountTaxService_ListAccountTax_async_flattened_resourceNames]
}
