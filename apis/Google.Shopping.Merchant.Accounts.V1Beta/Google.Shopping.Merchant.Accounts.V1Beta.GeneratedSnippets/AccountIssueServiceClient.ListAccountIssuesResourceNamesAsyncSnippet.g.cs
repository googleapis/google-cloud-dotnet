...
{
    // [START merchantapi_v1beta_generated_AccountIssueService_ListAccountIssues_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAccountIssueServiceClientSnippets
    {
        ...
        public async Task ListAccountIssuesResourceNamesAsync()
        {
            ...
            await foreach (AccountIssue item in response)
            {
            ...
            await foreach (ListAccountIssuesResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_AccountIssueService_ListAccountIssues_async_flattened_resourceNames]
}
