...
{
    // [START merchantapi_v1beta_generated_ProgramsService_ListPrograms_async_flattened]
    using Google.Api.Gax;
    using Google.Shopping.Merchant.Accounts.V1Beta;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedProgramsServiceClientSnippets
    {
        ...
        public async Task ListProgramsAsync()
        {
            ...
            await foreach (Program item in response)
            {
            ...
            await foreach (ListProgramsResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_ProgramsService_ListPrograms_async_flattened]
}
