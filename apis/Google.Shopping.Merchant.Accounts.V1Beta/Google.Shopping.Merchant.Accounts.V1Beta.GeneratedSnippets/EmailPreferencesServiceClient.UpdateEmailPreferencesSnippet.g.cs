...
{
    // [START merchantapi_v1beta_generated_EmailPreferencesService_UpdateEmailPreferences_sync_flattened]
    using Google.Protobuf.WellKnownTypes;
    using Google.Shopping.Merchant.Accounts.V1Beta;

    public sealed partial class GeneratedEmailPreferencesServiceClientSnippets
    {
    ...
    // [END merchantapi_v1beta_generated_EmailPreferencesService_UpdateEmailPreferences_sync_flattened]
}
