...
{
    // [START metastore_v1beta_generated_DataprocMetastore_ListMetadataImports_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataprocMetastoreClientSnippets
    {
        ...
        public async Task ListMetadataImportsResourceNamesAsync()
        {
            ...
            await foreach (MetadataImport item in response)
            {
            ...
            await foreach (ListMetadataImportsResponse page in response.AsRawResponses())
            {
    ...
    // [END metastore_v1beta_generated_DataprocMetastore_ListMetadataImports_async_flattened_resourceNames]
}
