...
namespace Google.Cloud.Metastore.V1Beta
{
    ...
    public abstract partial class DataprocMetastoreFederationClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(DataprocMetastoreFederation.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
