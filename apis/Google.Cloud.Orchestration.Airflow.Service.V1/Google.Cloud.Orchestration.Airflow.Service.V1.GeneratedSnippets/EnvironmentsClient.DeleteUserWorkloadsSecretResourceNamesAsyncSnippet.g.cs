...
{
    // [START composer_v1_generated_Environments_DeleteUserWorkloadsSecret_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task DeleteUserWorkloadsSecretResourceNamesAsync()
        {
            ...
            UserWorkloadsSecretName name = UserWorkloadsSecretName.FromProjectLocationEnvironmentUserWorkloadsSecret("[PROJECT]", "[LOCATION]", "[ENVIRONMENT]", "[USER_WORKLOADS_SECRET]");
            // Make the request
            await environmentsClient.DeleteUserWorkloadsSecretAsync(name);
        }
    }
    // [END composer_v1_generated_Environments_DeleteUserWorkloadsSecret_async_flattened_resourceNames]
}
