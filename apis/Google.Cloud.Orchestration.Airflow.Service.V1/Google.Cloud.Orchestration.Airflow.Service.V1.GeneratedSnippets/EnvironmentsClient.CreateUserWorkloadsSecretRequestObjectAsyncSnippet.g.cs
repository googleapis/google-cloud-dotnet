...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task CreateUserWorkloadsSecretRequestObjectAsync()
        {
            ...
            CreateUserWorkloadsSecretRequest request = new CreateUserWorkloadsSecretRequest
            {
            ...
            // Make the request
            UserWorkloadsSecret response = await environmentsClient.CreateUserWorkloadsSecretAsync(request);
        }
    }
