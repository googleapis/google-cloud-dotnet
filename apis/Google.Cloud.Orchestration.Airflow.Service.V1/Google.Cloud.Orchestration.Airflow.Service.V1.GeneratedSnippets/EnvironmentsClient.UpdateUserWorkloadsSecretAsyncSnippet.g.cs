...
{
    // [START composer_v1_generated_Environments_UpdateUserWorkloadsSecret_async_flattened]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task UpdateUserWorkloadsSecretAsync()
        {
            ...
            // Make the request
            UserWorkloadsSecret response = await environmentsClient.UpdateUserWorkloadsSecretAsync(userWorkloadsSecret);
        }
    }
    // [END composer_v1_generated_Environments_UpdateUserWorkloadsSecret_async_flattened]
}
