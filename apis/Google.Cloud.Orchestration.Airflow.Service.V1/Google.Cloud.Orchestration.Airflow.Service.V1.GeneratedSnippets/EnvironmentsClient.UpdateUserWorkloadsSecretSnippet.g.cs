...
{
    // [START composer_v1_generated_Environments_UpdateUserWorkloadsSecret_sync_flattened]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public void UpdateUserWorkloadsSecret()
        {
            ...
            // Make the request
            UserWorkloadsSecret response = environmentsClient.UpdateUserWorkloadsSecret(userWorkloadsSecret);
        }
    }
    // [END composer_v1_generated_Environments_UpdateUserWorkloadsSecret_sync_flattened]
}
