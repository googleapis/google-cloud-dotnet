...
{
    // [START composer_v1_generated_Environments_DeleteUserWorkloadsConfigMap_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task DeleteUserWorkloadsConfigMapResourceNamesAsync()
        {
            ...
            UserWorkloadsConfigMapName name = UserWorkloadsConfigMapName.FromProjectLocationEnvironmentUserWorkloadsConfigMap("[PROJECT]", "[LOCATION]", "[ENVIRONMENT]", "[USER_WORKLOADS_CONFIG_MAP]");
            // Make the request
            await environmentsClient.DeleteUserWorkloadsConfigMapAsync(name);
        }
    }
    // [END composer_v1_generated_Environments_DeleteUserWorkloadsConfigMap_async_flattened_resourceNames]
}
