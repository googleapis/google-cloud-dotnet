...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task CreateUserWorkloadsConfigMapRequestObjectAsync()
        {
            ...
            CreateUserWorkloadsConfigMapRequest request = new CreateUserWorkloadsConfigMapRequest
            {
            ...
            // Make the request
            UserWorkloadsConfigMap response = await environmentsClient.CreateUserWorkloadsConfigMapAsync(request);
        }
    }
