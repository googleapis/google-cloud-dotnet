...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public void GetUserWorkloadsSecretRequestObject()
        {
            ...
            GetUserWorkloadsSecretRequest request = new GetUserWorkloadsSecretRequest
            {
                UserWorkloadsSecretName = UserWorkloadsSecretName.FromProjectLocationEnvironmentUserWorkloadsSecret("[PROJECT]", "[LOCATION]", "[ENVIRONMENT]", "[USER_WORKLOADS_SECRET]"),
            };
            // Make the request
