...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientSnippets
    {
        ...
        public async Task ExecuteAirflowCommandRequestObjectAsync()
        {
            ...
            ExecuteAirflowCommandRequest request = new ExecuteAirflowCommandRequest
            {
                Environment = "",
                Command = "",
                Subcommand = "",
            ...
            // Make the request
            ExecuteAirflowCommandResponse response = await environmentsClient.ExecuteAirflowCommandAsync(request);
        }
    }
