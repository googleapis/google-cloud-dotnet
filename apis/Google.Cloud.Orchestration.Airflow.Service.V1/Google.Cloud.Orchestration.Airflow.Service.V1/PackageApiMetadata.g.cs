...
namespace Google.Cloud.Orchestration.Airflow.Service.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.Orchestration.Airflow.Service.V1", GetFileDescriptors)
        ...
        {
            yield return EnvironmentsReflection.Descriptor;
            yield return ImageVersionsReflection.Descriptor;
