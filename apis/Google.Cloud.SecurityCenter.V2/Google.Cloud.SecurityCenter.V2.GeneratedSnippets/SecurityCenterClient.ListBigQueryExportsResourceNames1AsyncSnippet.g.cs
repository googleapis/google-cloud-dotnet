...
{
    // [START securitycenter_v2_generated_SecurityCenter_ListBigQueryExports_async_flattened_resourceNames1]
    ...
    public sealed partial class GeneratedSecurityCenterClientSnippets
    {
        ...
        public async Task ListBigQueryExportsResourceNames1Async()
        {
            ...
            await foreach (BigQueryExport item in response)
            {
            ...
            await foreach (ListBigQueryExportsResponse page in response.AsRawResponses())
            {
    ...
    // [END securitycenter_v2_generated_SecurityCenter_ListBigQueryExports_async_flattened_resourceNames1]
}
