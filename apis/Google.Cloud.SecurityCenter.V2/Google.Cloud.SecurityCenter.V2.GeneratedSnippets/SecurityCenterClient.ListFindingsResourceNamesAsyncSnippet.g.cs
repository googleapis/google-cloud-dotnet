...
{
    // [START securitycenter_v2_generated_SecurityCenter_ListFindings_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSecurityCenterClientSnippets
    {
        ...
        public async Task ListFindingsResourceNamesAsync()
        {
            ...
            await foreach (ListFindingsResponse.Types.ListFindingsResult item in response)
            {
    ...
    // [END securitycenter_v2_generated_SecurityCenter_ListFindings_async_flattened_resourceNames]
}
