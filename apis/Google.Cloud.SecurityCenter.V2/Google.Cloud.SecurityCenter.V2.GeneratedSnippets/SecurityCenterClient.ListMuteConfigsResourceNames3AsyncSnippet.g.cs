...
{
    // [START securitycenter_v2_generated_SecurityCenter_ListMuteConfigs_async_flattened_resourceNames3]
    ...
    public sealed partial class GeneratedSecurityCenterClientSnippets
    {
        ...
        public async Task ListMuteConfigsResourceNames3Async()
        {
            ...
            await foreach (MuteConfig item in response)
            {
            ...
            await foreach (ListMuteConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END securitycenter_v2_generated_SecurityCenter_ListMuteConfigs_async_flattened_resourceNames3]
}
