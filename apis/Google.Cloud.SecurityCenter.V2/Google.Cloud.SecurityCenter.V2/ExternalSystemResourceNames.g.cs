...
namespace Google.Cloud.SecurityCenter.V2
{
    ...
    public sealed partial class ExternalSystemName : gax::IResourceName, sys::IEquatable<ExternalSystemName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// A resource name with pattern
            /// <c>
            /// organizations/{organization}/sources/{source}/locations/{location}/findings/{finding}/externalSystems/{externalsystem}</c>
            /// .
            /// </summary>
            OrganizationSourceLocationFindingExternalsystem = 2,

            /// <summary>
            /// A resource name with pattern
            /// <c>folders/{folder}/sources/{source}/findings/{finding}/externalSystems/{externalsystem}</c>.
            /// </summary>
            FolderSourceFindingExternalsystem = 3,

            /// <summary>
            /// A resource name with pattern
            /// <c>
            /// folders/{folder}/sources/{source}/locations/{location}/findings/{finding}/externalSystems/{externalsystem}</c>
            /// .
            /// </summary>
            FolderSourceLocationFindingExternalsystem = 4,

            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/sources/{source}/findings/{finding}/externalSystems/{externalsystem}</c>.
            /// </summary>
            ProjectSourceFindingExternalsystem = 5,

            /// <summary>
            /// A resource name with pattern
            /// <c>
            /// projects/{project}/sources/{source}/locations/{location}/findings/{finding}/externalSystems/{externalsystem}</c>
            /// .
            /// </summary>
            ProjectSourceLocationFindingExternalsystem = 6,
        }
        ...
        private static gax::PathTemplate s_organizationSourceLocationFindingExternalsystem = new gax::PathTemplate("organizations/{organization}/sources/{source}/locations/{location}/findings/{finding}/externalSystems/{externalsystem}");
        ...
        private static gax::PathTemplate s_folderSourceLocationFindingExternalsystem = new gax::PathTemplate("folders/{folder}/sources/{source}/locations/{location}/findings/{finding}/externalSystems/{externalsystem}");
        ...
        private static gax::PathTemplate s_projectSourceLocationFindingExternalsystem = new gax::PathTemplate("projects/{project}/sources/{source}/locations/{location}/findings/{finding}/externalSystems/{externalsystem}");
        ...
        public static ExternalSystemName FromFolderSourceLocationFindingExternalsystem(string folderId, string sourceId, string locationId, string findingId, string externalsystemId) =>
            new ExternalSystemName(ResourceNameType.FolderSourceLocationFindingExternalsystem, folderId: gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), sourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), findingId: gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)), externalsystemId: gax::GaxPreconditions.CheckNotNullOrEmpty(externalsystemId, nameof(externalsystemId)));
        ...
        public static ExternalSystemName FromProjectSourceLocationFindingExternalsystem(string projectId, string sourceId, string locationId, string findingId, string externalsystemId) =>
            new ExternalSystemName(ResourceNameType.ProjectSourceLocationFindingExternalsystem, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), sourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), findingId: gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)), externalsystemId: gax::GaxPreconditions.CheckNotNullOrEmpty(externalsystemId, nameof(externalsystemId)));
        ...
        public static string FormatOrganizationSourceLocationFindingExternalsystem(string organizationId, string sourceId, string locationId, string findingId, string externalsystemId) =>
            s_organizationSourceLocationFindingExternalsystem.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)), gax::GaxPreconditions.CheckNotNullOrEmpty(externalsystemId, nameof(externalsystemId)));
        ...
        public static string FormatFolderSourceLocationFindingExternalsystem(string folderId, string sourceId, string locationId, string findingId, string externalsystemId) =>
            s_folderSourceLocationFindingExternalsystem.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)), gax::GaxPreconditions.CheckNotNullOrEmpty(externalsystemId, nameof(externalsystemId)));
        ...
        public static string FormatProjectSourceLocationFindingExternalsystem(string projectId, string sourceId, string locationId, string findingId, string externalsystemId) =>
            s_projectSourceLocationFindingExternalsystem.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(sourceId, nameof(sourceId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(findingId, nameof(findingId)), gax::GaxPreconditions.CheckNotNullOrEmpty(externalsystemId, nameof(externalsystemId)));
        ...
        public static bool TryParse(string externalSystemName, bool allowUnparsed, out ExternalSystemName result)
        {
            ...
            if (s_organizationSourceLocationFindingExternalsystem.TryParseName(externalSystemName, out resourceName))
            {
                result = FromOrganizationSourceLocationFindingExternalsystem(resourceName[0], resourceName[1], resourceName[2], resourceName[3], resourceName[4]);
                return true;
            }
            ...
            if (s_folderSourceLocationFindingExternalsystem.TryParseName(externalSystemName, out resourceName))
            {
                result = FromFolderSourceLocationFindingExternalsystem(resourceName[0], resourceName[1], resourceName[2], resourceName[3], resourceName[4]);
                return true;
            }
            ...
            if (s_projectSourceLocationFindingExternalsystem.TryParseName(externalSystemName, out resourceName))
            {
                result = FromProjectSourceLocationFindingExternalsystem(resourceName[0], resourceName[1], resourceName[2], resourceName[3], resourceName[4]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ExternalSystemName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string externalsystemId = null, string findingId = null, string folderId = null, string locationId = null, string organizationId = null, string projectId = null, string sourceId = null)
        {
            Type = type;
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.OrganizationSourceLocationFindingExternalsystem: return s_organizationSourceLocationFindingExternalsystem.Expand(OrganizationId, SourceId, LocationId, FindingId, ExternalsystemId);
                ...
                case ResourceNameType.FolderSourceLocationFindingExternalsystem: return s_folderSourceLocationFindingExternalsystem.Expand(FolderId, SourceId, LocationId, FindingId, ExternalsystemId);
                ...
                case ResourceNameType.ProjectSourceLocationFindingExternalsystem: return s_projectSourceLocationFindingExternalsystem.Expand(ProjectId, SourceId, LocationId, FindingId, ExternalsystemId);
