...
namespace Google.Cloud.Notebooks.V1 {
  ...
  /// <summary>Holder for reflection information generated from google/cloud/notebooks/v1/diagnostic_config.proto</summary>
  public static partial class DiagnosticConfigReflection {

    #region Descriptor
    /// <summary>File descriptor for google/cloud/notebooks/v1/diagnostic_config.proto</summary>
    ...
    static DiagnosticConfigReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Cloud.Notebooks.V1.DiagnosticConfig), global::Google.Cloud.Notebooks.V1.DiagnosticConfig.Parser, new[]{ "GcsBucket", "RelativePath", "RepairFlagEnabled", "PacketCaptureFlagEnabled", "CopyHomeFilesFlagEnabled" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Google.Cloud.Notebooks.V1.DiagnosticConfigReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public DiagnosticConfig(DiagnosticConfig other) : this() {
      ...
      repairFlagEnabled_ = other.repairFlagEnabled_;
      packetCaptureFlagEnabled_ = other.packetCaptureFlagEnabled_;
      copyHomeFilesFlagEnabled_ = other.copyHomeFilesFlagEnabled_;
    ...
    /// <summary>Field number for the "repair_flag_enabled" field.</summary>
    public const int RepairFlagEnabledFieldNumber = 3;
    private bool repairFlagEnabled_;
    /// <summary>
    /// Optional. Enables flag to repair service for instance
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool RepairFlagEnabled {
      get { return repairFlagEnabled_; }
      set {
        repairFlagEnabled_ = value;
      }
    }

    /// <summary>Field number for the "packet_capture_flag_enabled" field.</summary>
    public const int PacketCaptureFlagEnabledFieldNumber = 4;
    private bool packetCaptureFlagEnabled_;
    /// <summary>
    /// Optional. Enables flag to capture packets from the instance for 30 seconds
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool PacketCaptureFlagEnabled {
      get { return packetCaptureFlagEnabled_; }
      set {
        packetCaptureFlagEnabled_ = value;
      }
    }

    /// <summary>Field number for the "copy_home_files_flag_enabled" field.</summary>
    public const int CopyHomeFilesFlagEnabledFieldNumber = 5;
    private bool copyHomeFilesFlagEnabled_;
    /// <summary>
    /// Optional. Enables flag to copy all `/home/jupyter` folder contents
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool CopyHomeFilesFlagEnabled {
      get { return copyHomeFilesFlagEnabled_; }
      set {
    ...
    public bool Equals(DiagnosticConfig other) {
      ...
      if (RepairFlagEnabled != other.RepairFlagEnabled) return false;
      if (PacketCaptureFlagEnabled != other.PacketCaptureFlagEnabled) return false;
      if (CopyHomeFilesFlagEnabled != other.CopyHomeFilesFlagEnabled) return false;
    ...
    public override int GetHashCode() {
      ...
      if (RepairFlagEnabled != false) hash ^= RepairFlagEnabled.GetHashCode();
      if (PacketCaptureFlagEnabled != false) hash ^= PacketCaptureFlagEnabled.GetHashCode();
      if (CopyHomeFilesFlagEnabled != false) hash ^= CopyHomeFilesFlagEnabled.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (RepairFlagEnabled != false) {
        output.WriteRawTag(24);
        output.WriteBool(RepairFlagEnabled);
      }
      if (PacketCaptureFlagEnabled != false) {
        output.WriteRawTag(32);
        output.WriteBool(PacketCaptureFlagEnabled);
      }
      if (CopyHomeFilesFlagEnabled != false) {
        output.WriteRawTag(40);
        output.WriteBool(CopyHomeFilesFlagEnabled);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(DiagnosticConfig other) {
      ...
      if (other.RepairFlagEnabled != false) {
        RepairFlagEnabled = other.RepairFlagEnabled;
      }
      if (other.PacketCaptureFlagEnabled != false) {
        PacketCaptureFlagEnabled = other.PacketCaptureFlagEnabled;
      }
      if (other.CopyHomeFilesFlagEnabled != false) {
        CopyHomeFilesFlagEnabled = other.CopyHomeFilesFlagEnabled;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 24: {
            RepairFlagEnabled = input.ReadBool();
            break;
          }
          case 32: {
            PacketCaptureFlagEnabled = input.ReadBool();
            break;
          }
          case 40: {
            CopyHomeFilesFlagEnabled = input.ReadBool();
            break;
          }
        }
      }
