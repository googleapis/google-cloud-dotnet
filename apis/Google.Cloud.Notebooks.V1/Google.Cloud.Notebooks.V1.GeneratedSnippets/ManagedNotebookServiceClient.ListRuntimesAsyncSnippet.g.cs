...
{
    // [START notebooks_v1_generated_ManagedNotebookService_ListRuntimes_async_flattened]
    ...
    public sealed partial class GeneratedManagedNotebookServiceClientSnippets
    {
        ...
        public async Task ListRuntimesAsync()
        {
            ...
            await foreach (Runtime item in response)
            {
            ...
            await foreach (ListRuntimesResponse page in response.AsRawResponses())
            {
    ...
    // [END notebooks_v1_generated_ManagedNotebookService_ListRuntimes_async_flattened]
}
