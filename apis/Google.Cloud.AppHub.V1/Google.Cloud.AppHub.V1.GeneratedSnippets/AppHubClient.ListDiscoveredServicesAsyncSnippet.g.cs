...
{
    // [START apphub_v1_generated_AppHub_ListDiscoveredServices_async_flattened]
    ...
    public sealed partial class GeneratedAppHubClientSnippets
    {
        ...
        public async Task ListDiscoveredServicesAsync()
        {
            ...
            await foreach (DiscoveredService item in response)
            {
            ...
            await foreach (ListDiscoveredServicesResponse page in response.AsRawResponses())
            {
    ...
    // [END apphub_v1_generated_AppHub_ListDiscoveredServices_async_flattened]
}
