...
{
    // [START apphub_v1_generated_AppHub_ListDiscoveredWorkloads_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAppHubClientSnippets
    {
        ...
        public async Task ListDiscoveredWorkloadsResourceNamesAsync()
        {
            ...
            await foreach (DiscoveredWorkload item in response)
            {
            ...
            await foreach (ListDiscoveredWorkloadsResponse page in response.AsRawResponses())
            {
    ...
    // [END apphub_v1_generated_AppHub_ListDiscoveredWorkloads_async_flattened_resourceNames]
}
