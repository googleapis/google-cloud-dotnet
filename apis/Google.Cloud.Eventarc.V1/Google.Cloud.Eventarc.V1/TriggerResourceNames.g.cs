...
namespace Google.Cloud.Eventarc.V1
{
    ...
    /// <summary>Resource name for the <c>Integration</c> resource.</summary>
    public sealed partial class IntegrationName : gax::IResourceName, sys::IEquatable<IntegrationName>
    {
        /// <summary>The possible contents of <see cref="IntegrationName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/integrations/{integration}</c>.
            /// </summary>
            ProjectLocationIntegration = 1,
        }

        private static gax::PathTemplate s_projectLocationIntegration = new gax::PathTemplate("projects/{project}/locations/{location}/integrations/{integration}");

        /// <summary>Creates a <see cref="IntegrationName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="IntegrationName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static IntegrationName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new IntegrationName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="IntegrationName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/integrations/{integration}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="integrationId">The <c>Integration</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="IntegrationName"/> constructed from the provided ids.</returns>
        public static IntegrationName FromProjectLocationIntegration(string projectId, string locationId, string integrationId) =>
            new IntegrationName(ResourceNameType.ProjectLocationIntegration, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), integrationId: gax::GaxPreconditions.CheckNotNullOrEmpty(integrationId, nameof(integrationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="IntegrationName"/> with pattern
        /// <c>projects/{project}/locations/{location}/integrations/{integration}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="integrationId">The <c>Integration</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="IntegrationName"/> with pattern
        /// <c>projects/{project}/locations/{location}/integrations/{integration}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string integrationId) =>
            FormatProjectLocationIntegration(projectId, locationId, integrationId);
        ...
        /// <c>projects/{project}/locations/{location}/integrations/{integration}</c>.
        /// </returns>
        public static string FormatProjectLocationIntegration(string projectId, string locationId, string integrationId) =>
            s_projectLocationIntegration.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(integrationId, nameof(integrationId)));

        /// <summary>Parses the given resource name string into a new <see cref="IntegrationName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/integrations/{integration}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        /// <param name="integrationName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="IntegrationName"/> if successful.</returns>
        public static IntegrationName Parse(string integrationName) => Parse(integrationName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="IntegrationName"/> instance; optionally allowing
        ...
        /// </param>
        /// <returns>The parsed <see cref="IntegrationName"/> if successful.</returns>
        public static IntegrationName Parse(string integrationName, bool allowUnparsed) =>
            TryParse(integrationName, allowUnparsed, out IntegrationName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="IntegrationName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="integrationName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="IntegrationName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string integrationName, out IntegrationName result) =>
            TryParse(integrationName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="IntegrationName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string integrationName, bool allowUnparsed, out IntegrationName result)
        {
            gax::GaxPreconditions.CheckNotNull(integrationName, nameof(integrationName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationIntegration.TryParseName(integrationName, out resourceName))
            {
                result = FromProjectLocationIntegration(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(integrationName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private IntegrationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string integrationId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="IntegrationName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/integrations/{integration}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="integrationId">The <c>Integration</c> ID. Must not be <c>null</c> or empty.</param>
        public IntegrationName(string projectId, string locationId, string integrationId) : this(ResourceNameType.ProjectLocationIntegration, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), integrationId: gax::GaxPreconditions.CheckNotNullOrEmpty(integrationId, nameof(integrationId)))
        {
        }
        ...
        /// <summary>
        /// The <c>Integration</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationIntegration: return s_projectLocationIntegration.Expand(ProjectId, LocationId, IntegrationId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as IntegrationName);

        /// <inheritdoc/>
        public bool Equals(IntegrationName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(IntegrationName a, IntegrationName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(IntegrationName a, IntegrationName b) => !(a == b);
    }
