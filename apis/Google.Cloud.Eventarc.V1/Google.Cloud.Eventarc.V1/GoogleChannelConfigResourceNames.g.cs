...
{
    /// <summary>Resource name for the <c>GoogleChannelConfig</c> resource.</summary>
    public sealed partial class GoogleChannelConfigName : gax::IResourceName, sys::IEquatable<GoogleChannelConfigName>
    {
        /// <summary>The possible contents of <see cref="GoogleChannelConfigName"/>.</summary>
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/googleChannelConfig</c>.
            /// </summary>
            ProjectLocation = 1,
        }

        private static gax::PathTemplate s_projectLocation = new gax::PathTemplate("projects/{project}/locations/{location}/googleChannelConfig");

        /// <summary>Creates a <see cref="GoogleChannelConfigName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="GoogleChannelConfigName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static GoogleChannelConfigName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new GoogleChannelConfigName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="GoogleChannelConfigName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/googleChannelConfig</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// A new instance of <see cref="GoogleChannelConfigName"/> constructed from the provided ids.
        /// </returns>
        public static GoogleChannelConfigName FromProjectLocation(string projectId, string locationId) =>
            new GoogleChannelConfigName(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="GoogleChannelConfigName"/> with pattern
        /// <c>projects/{project}/locations/{location}/googleChannelConfig</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="GoogleChannelConfigName"/> with pattern
        /// <c>projects/{project}/locations/{location}/googleChannelConfig</c>.
        /// </returns>
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="GoogleChannelConfigName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>projects/{project}/locations/{location}/googleChannelConfig</c></description></item>
        /// </list>
        /// </remarks>
        /// <param name="googleChannelConfigName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="GoogleChannelConfigName"/> if successful.</returns>
        public static GoogleChannelConfigName Parse(string googleChannelConfigName) => Parse(googleChannelConfigName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="GoogleChannelConfigName"/> instance; optionally
        ...
        public static GoogleChannelConfigName Parse(string googleChannelConfigName, bool allowUnparsed) =>
            TryParse(googleChannelConfigName, allowUnparsed, out GoogleChannelConfigName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="GoogleChannelConfigName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="googleChannelConfigName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="GoogleChannelConfigName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string googleChannelConfigName, out GoogleChannelConfigName result) =>
            TryParse(googleChannelConfigName, false, out result);
        ...
        {
            gax::GaxPreconditions.CheckNotNull(googleChannelConfigName, nameof(googleChannelConfigName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocation.TryParseName(googleChannelConfigName, out resourceName))
            {
            ...
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(googleChannelConfigName, out gax::UnparsedResourceName unparsedResourceName))
                {
        ...
        private GoogleChannelConfigName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="GoogleChannelConfigName"/> class from the component parts of
        /// pattern <c>projects/{project}/locations/{location}/googleChannelConfig</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        public GoogleChannelConfigName(string projectId, string locationId) : this(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as GoogleChannelConfigName);

        /// <inheritdoc/>
        public bool Equals(GoogleChannelConfigName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(GoogleChannelConfigName a, GoogleChannelConfigName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(GoogleChannelConfigName a, GoogleChannelConfigName b) => !(a == b);
    }
    ...
    public partial class GoogleChannelConfig
    {
        /// <summary>
