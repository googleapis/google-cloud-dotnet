...
{
    // [START eventarc_v1_generated_Eventarc_ListTriggers_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedEventarcClientSnippets
    {
        ...
        public async Task ListTriggersResourceNamesAsync()
        {
            ...
            await foreach (Trigger item in response)
            {
            ...
            await foreach (ListTriggersResponse page in response.AsRawResponses())
            {
    ...
    // [END eventarc_v1_generated_Eventarc_ListTriggers_async_flattened_resourceNames]
}
