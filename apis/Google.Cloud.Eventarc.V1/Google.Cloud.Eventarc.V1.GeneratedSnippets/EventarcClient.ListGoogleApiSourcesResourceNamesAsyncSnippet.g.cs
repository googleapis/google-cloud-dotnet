...
{
    // [START eventarc_v1_generated_Eventarc_ListGoogleApiSources_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedEventarcClientSnippets
    {
        ...
        public async Task ListGoogleApiSourcesResourceNamesAsync()
        {
            ...
            await foreach (GoogleApiSource item in response)
            {
            ...
            await foreach (ListGoogleApiSourcesResponse page in response.AsRawResponses())
            {
    ...
    // [END eventarc_v1_generated_Eventarc_ListGoogleApiSources_async_flattened_resourceNames]
}
