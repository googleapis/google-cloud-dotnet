...
{
    // [START eventarc_v1_generated_Eventarc_ListChannelConnections_async_flattened]
    ...
    public sealed partial class GeneratedEventarcClientSnippets
    {
        ...
        public async Task ListChannelConnectionsAsync()
        {
            ...
            await foreach (ChannelConnection item in response)
            {
            ...
            await foreach (ListChannelConnectionsResponse page in response.AsRawResponses())
            {
    ...
    // [END eventarc_v1_generated_Eventarc_ListChannelConnections_async_flattened]
}
