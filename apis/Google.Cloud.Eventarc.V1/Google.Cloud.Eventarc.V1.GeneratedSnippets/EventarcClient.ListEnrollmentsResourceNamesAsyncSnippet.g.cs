...
{
    // [START eventarc_v1_generated_Eventarc_ListEnrollments_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedEventarcClientSnippets
    {
        ...
        public async Task ListEnrollmentsResourceNamesAsync()
        {
            ...
            await foreach (Enrollment item in response)
            {
            ...
            await foreach (ListEnrollmentsResponse page in response.AsRawResponses())
            {
    ...
    // [END eventarc_v1_generated_Eventarc_ListEnrollments_async_flattened_resourceNames]
}
