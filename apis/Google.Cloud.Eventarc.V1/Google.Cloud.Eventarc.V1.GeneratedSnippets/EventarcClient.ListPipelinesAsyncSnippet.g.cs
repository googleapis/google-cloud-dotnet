...
{
    // [START eventarc_v1_generated_Eventarc_ListPipelines_async_flattened]
    ...
    public sealed partial class GeneratedEventarcClientSnippets
    {
        ...
        public async Task ListPipelinesAsync()
        {
            ...
            await foreach (Pipeline item in response)
            {
            ...
            await foreach (ListPipelinesResponse page in response.AsRawResponses())
            {
    ...
    // [END eventarc_v1_generated_Eventarc_ListPipelines_async_flattened]
}
