...
namespace Google.Cloud.Commerce.Consumer.Procurement.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.Commerce.Consumer.Procurement.V1", GetFileDescriptors)
            ...
            {
                {
                    ...
                    proto::ByteString.FromBase64("EjIvdjEve25hbWU9YmlsbGluZ0FjY291bnRzLyovb3JkZXJzLyovb3BlcmF0aW9ucy8qfQ==")
                },
            });
