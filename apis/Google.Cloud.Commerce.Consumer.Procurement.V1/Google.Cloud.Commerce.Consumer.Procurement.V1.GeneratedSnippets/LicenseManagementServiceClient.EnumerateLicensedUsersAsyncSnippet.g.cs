...
{
    // [START cloudcommerceconsumerprocurement_v1_generated_LicenseManagementService_EnumerateLicensedUsers_async_flattened]
    ...
    public sealed partial class GeneratedLicenseManagementServiceClientSnippets
    {
        ...
        public async Task EnumerateLicensedUsersAsync()
        {
            ...
            await foreach (LicensedUser item in response)
            {
            ...
            await foreach (EnumerateLicensedUsersResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudcommerceconsumerprocurement_v1_generated_LicenseManagementService_EnumerateLicensedUsers_async_flattened]
}
