...
namespace Google.Cloud.Scheduler.V1Beta1 {
  ...
  public sealed partial class HttpTarget : pb::IMessage<HttpTarget> {
    ...
    private global::Google.Cloud.Scheduler.V1Beta1.HttpMethod httpMethod_ = 0;
    /// <summary>
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 16: {
            httpMethod_ = (global::Google.Cloud.Scheduler.V1Beta1.HttpMethod) input.ReadEnum();
            break;
          }
          case 26: {
  ...
  public sealed partial class AppEngineHttpTarget : pb::IMessage<AppEngineHttpTarget> {
    ...
    public void MergeFrom(AppEngineHttpTarget other) {
      ...
      if (other.appEngineRouting_ != null) {
        if (appEngineRouting_ == null) {
          appEngineRouting_ = new global::Google.Cloud.Scheduler.V1Beta1.AppEngineRouting();
        }
