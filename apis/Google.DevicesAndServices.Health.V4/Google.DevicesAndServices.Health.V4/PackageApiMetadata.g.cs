...
namespace Google.DevicesAndServices.Health.V4
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.DevicesAndServices.Health.V4", GetFileDescriptors)
            .WithRequestNumericEnumJsonEncoding(true);

        private static scg::IEnumerable<gpr::FileDescriptor> GetFileDescriptors()
        {
            yield return DataCoordinatesReflection.Descriptor;
            ...
            yield return MedicalDeviceInfoReflection.Descriptor;
