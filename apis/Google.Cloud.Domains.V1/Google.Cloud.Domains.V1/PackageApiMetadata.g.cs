...
namespace Google.Cloud.Domains.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.Domains.V1", GetFileDescriptors)
        ...
        {
            yield return DomainsReflection.Descriptor;
