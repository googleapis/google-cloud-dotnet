...
using gcsv = Google.Cloud.StorageBatchOperations.V1;
using sys = System;
...
namespace Google.Cloud.StorageBatchOperations.V1
{
    ...
    /// <summary>Resource name for the <c>BucketOperation</c> resource.</summary>
    public sealed partial class BucketOperationName : gax::IResourceName, sys::IEquatable<BucketOperationName>
    {
        /// <summary>The possible contents of <see cref="BucketOperationName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <c>projects/{project}/locations/{location}/jobs/{job}/bucketOperations/{bucket_operation}</c>.
            /// </summary>
            ProjectLocationJobBucketOperation = 1,
        }

        private static gax::PathTemplate s_projectLocationJobBucketOperation = new gax::PathTemplate("projects/{project}/locations/{location}/jobs/{job}/bucketOperations/{bucket_operation}");

        /// <summary>Creates a <see cref="BucketOperationName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="BucketOperationName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static BucketOperationName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new BucketOperationName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="BucketOperationName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/jobs/{job}/bucketOperations/{bucket_operation}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="jobId">The <c>Job</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="bucketOperationId">The <c>BucketOperation</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="BucketOperationName"/> constructed from the provided ids.</returns>
        public static BucketOperationName FromProjectLocationJobBucketOperation(string projectId, string locationId, string jobId, string bucketOperationId) =>
            new BucketOperationName(ResourceNameType.ProjectLocationJobBucketOperation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), jobId: gax::GaxPreconditions.CheckNotNullOrEmpty(jobId, nameof(jobId)), bucketOperationId: gax::GaxPreconditions.CheckNotNullOrEmpty(bucketOperationId, nameof(bucketOperationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="BucketOperationName"/> with pattern
        /// <c>projects/{project}/locations/{location}/jobs/{job}/bucketOperations/{bucket_operation}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <param name="bucketOperationId">The <c>BucketOperation</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="BucketOperationName"/> with pattern
        /// <c>projects/{project}/locations/{location}/jobs/{job}/bucketOperations/{bucket_operation}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string jobId, string bucketOperationId) =>
            FormatProjectLocationJobBucketOperation(projectId, locationId, jobId, bucketOperationId);
        ...
        public static string FormatProjectLocationJobBucketOperation(string projectId, string locationId, string jobId, string bucketOperationId) =>
            s_projectLocationJobBucketOperation.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(jobId, nameof(jobId)), gax::GaxPreconditions.CheckNotNullOrEmpty(bucketOperationId, nameof(bucketOperationId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="BucketOperationName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="bucketOperationName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="BucketOperationName"/> if successful.</returns>
        public static BucketOperationName Parse(string bucketOperationName) => Parse(bucketOperationName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="BucketOperationName"/> instance; optionally
        ...
        public static BucketOperationName Parse(string bucketOperationName, bool allowUnparsed) =>
            TryParse(bucketOperationName, allowUnparsed, out BucketOperationName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="BucketOperationName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="bucketOperationName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="BucketOperationName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string bucketOperationName, out BucketOperationName result) =>
            TryParse(bucketOperationName, false, out result);
        ...
        {
            gax::GaxPreconditions.CheckNotNull(bucketOperationName, nameof(bucketOperationName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationJobBucketOperation.TryParseName(bucketOperationName, out resourceName))
            {
                result = FromProjectLocationJobBucketOperation(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(bucketOperationName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private BucketOperationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string bucketOperationId = null, string jobId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            BucketOperationId = bucketOperationId;
            JobId = jobId;
            LocationId = locationId;
            ProjectId = projectId;
        }
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="BucketOperationName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/jobs/{job}/bucketOperations/{bucket_operation}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="jobId">The <c>Job</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="bucketOperationId">The <c>BucketOperation</c> ID. Must not be <c>null</c> or empty.</param>
        public BucketOperationName(string projectId, string locationId, string jobId, string bucketOperationId) : this(ResourceNameType.ProjectLocationJobBucketOperation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), jobId: gax::GaxPreconditions.CheckNotNullOrEmpty(jobId, nameof(jobId)), bucketOperationId: gax::GaxPreconditions.CheckNotNullOrEmpty(bucketOperationId, nameof(bucketOperationId)))
        {
        }
        ...
        /// <summary>
        /// The <c>BucketOperation</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationJobBucketOperation: return s_projectLocationJobBucketOperation.Expand(ProjectId, LocationId, JobId, BucketOperationId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as BucketOperationName);

        /// <inheritdoc/>
        public bool Equals(BucketOperationName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(BucketOperationName a, BucketOperationName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(BucketOperationName a, BucketOperationName b) => !(a == b);
    }
    ...
    public partial class BucketOperation
    {
        /// <summary>
    ...
    public partial class RewriteObject
    {
        /// <summary>
