...
{
    // [START storagebatchoperations_v1_generated_StorageBatchOperations_ListJobs_async_flattened]
    ...
    public sealed partial class GeneratedStorageBatchOperationsClientSnippets
    {
        ...
        public async Task ListJobsAsync()
        {
            ...
            await foreach (Job item in response)
            {
            ...
            await foreach (ListJobsResponse page in response.AsRawResponses())
            {
    ...
    // [END storagebatchoperations_v1_generated_StorageBatchOperations_ListJobs_async_flattened]
}
