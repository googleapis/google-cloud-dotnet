...
{
    // [START css_v1_generated_AccountLabelsService_ListAccountLabels_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAccountLabelsServiceClientSnippets
    {
        ...
        public async Task ListAccountLabelsResourceNamesAsync()
        {
            ...
            await foreach (AccountLabel item in response)
            {
            ...
            await foreach (ListAccountLabelsResponse page in response.AsRawResponses())
            {
    ...
    // [END css_v1_generated_AccountLabelsService_ListAccountLabels_async_flattened_resourceNames]
}
