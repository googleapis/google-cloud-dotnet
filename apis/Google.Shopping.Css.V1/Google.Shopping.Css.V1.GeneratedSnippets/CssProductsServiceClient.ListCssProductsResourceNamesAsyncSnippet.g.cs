...
{
    // [START css_v1_generated_CssProductsService_ListCssProducts_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCssProductsServiceClientSnippets
    {
        ...
        public async Task ListCssProductsResourceNamesAsync()
        {
            ...
            await foreach (CssProduct item in response)
            {
            ...
            await foreach (ListCssProductsResponse page in response.AsRawResponses())
            {
    ...
    // [END css_v1_generated_CssProductsService_ListCssProducts_async_flattened_resourceNames]
}
