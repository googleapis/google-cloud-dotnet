...
{
    // [START css_v1_generated_AccountsService_ListChildAccounts_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAccountsServiceClientSnippets
    {
        ...
        public async Task ListChildAccountsResourceNamesAsync()
        {
            ...
            await foreach (ListChildAccountsResponse page in response.AsRawResponses())
            {
    ...
    // [END css_v1_generated_AccountsService_ListChildAccounts_async_flattened_resourceNames]
}
