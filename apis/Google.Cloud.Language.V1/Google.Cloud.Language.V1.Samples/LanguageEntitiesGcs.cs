...
//   usage: dotnet run [--gcs_content_uri "gs://cloud-samples-data/language/entity.txt"]
...
namespace Google.Cloud.Language.V1.Samples
{
    ...
    public class LanguageEntitiesGcs
    {
        ...
        public static void SampleAnalyzeEntities(string gcsContentUri)
        {
            ...
            // string gcsContentUri = "gs://cloud-samples-data/language/entity.txt"
        ...
        public static void Main(string[] args)
        {
            new Parser(with => with.CaseInsensitiveEnumValues = true).ParseArguments<Options>(args)
                .WithParsed<Options>(opts =>
                    LanguageEntitiesGcs.SampleAnalyzeEntities(opts.GcsContentUri));
        }

        public class Options
        {
            [Option("gcs_content_uri", Default = "gs://cloud-samples-data/language/entity.txt")]
