...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddIssueResolutionServiceClient(this IServiceCollection services, sys::Action<gsmiv::IssueResolutionServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gsmiv::IssueResolutionServiceClientBuilder builder = new gsmiv::IssueResolutionServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddIssueResolutionServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gsmiv::IssueResolutionServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gsmiv::IssueResolutionServiceClientBuilder builder = new gsmiv::IssueResolutionServiceClientBuilder();
                action?.Invoke(provider, builder);
