...
using gsmiv = Google.Shopping.Merchant.IssueResolution.V1;
using sys = System;
...
namespace Google.Shopping.Merchant.IssueResolution.V1
{
    ...
    public partial class RenderAccountIssuesRequest
    {
        /// <summary>
        /// <see cref="gsmiv::AccountName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gsmiv::AccountName AccountName
        {
            get => string.IsNullOrEmpty(Name) ? null : gsmiv::AccountName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class RenderProductIssuesRequest
    {
        /// <summary>
        /// <see cref="gsmiv::ProductName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gsmiv::ProductName ProductName
        {
            get => string.IsNullOrEmpty(Name) ? null : gsmiv::ProductName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }
