...
namespace Google.Analytics.Admin.V1Alpha
{
    ...
    /// <summary>Resource name for the <c>ReportingDataAnnotation</c> resource.</summary>
    public sealed partial class ReportingDataAnnotationName : gax::IResourceName, sys::IEquatable<ReportingDataAnnotationName>
    {
        /// <summary>The possible contents of <see cref="ReportingDataAnnotationName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>properties/{property}/reportingDataAnnotations/{reporting_data_annotation}</c>.
            /// </summary>
            PropertyReportingDataAnnotation = 1,
        }

        private static gax::PathTemplate s_propertyReportingDataAnnotation = new gax::PathTemplate("properties/{property}/reportingDataAnnotations/{reporting_data_annotation}");

        /// <summary>Creates a <see cref="ReportingDataAnnotationName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ReportingDataAnnotationName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static ReportingDataAnnotationName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new ReportingDataAnnotationName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="ReportingDataAnnotationName"/> with the pattern
        /// <c>properties/{property}/reportingDataAnnotations/{reporting_data_annotation}</c>.
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="reportingDataAnnotationId">
        /// The <c>ReportingDataAnnotation</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="ReportingDataAnnotationName"/> constructed from the provided ids.
        /// </returns>
        public static ReportingDataAnnotationName FromPropertyReportingDataAnnotation(string propertyId, string reportingDataAnnotationId) =>
            new ReportingDataAnnotationName(ResourceNameType.PropertyReportingDataAnnotation, propertyId: gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)), reportingDataAnnotationId: gax::GaxPreconditions.CheckNotNullOrEmpty(reportingDataAnnotationId, nameof(reportingDataAnnotationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ReportingDataAnnotationName"/> with
        /// pattern <c>properties/{property}/reportingDataAnnotations/{reporting_data_annotation}</c>.
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="reportingDataAnnotationId">
        /// The <c>ReportingDataAnnotation</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// The string representation of this <see cref="ReportingDataAnnotationName"/> with pattern
        /// <c>properties/{property}/reportingDataAnnotations/{reporting_data_annotation}</c>.
        /// </returns>
        public static string Format(string propertyId, string reportingDataAnnotationId) =>
            FormatPropertyReportingDataAnnotation(propertyId, reportingDataAnnotationId);
        ...
        /// <c>properties/{property}/reportingDataAnnotations/{reporting_data_annotation}</c>.
        /// </returns>
        public static string FormatPropertyReportingDataAnnotation(string propertyId, string reportingDataAnnotationId) =>
            s_propertyReportingDataAnnotation.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)), gax::GaxPreconditions.CheckNotNullOrEmpty(reportingDataAnnotationId, nameof(reportingDataAnnotationId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ReportingDataAnnotationName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="reportingDataAnnotationName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="ReportingDataAnnotationName"/> if successful.</returns>
        public static ReportingDataAnnotationName Parse(string reportingDataAnnotationName) =>
            Parse(reportingDataAnnotationName, false);
        ...
        /// </param>
        /// <returns>The parsed <see cref="ReportingDataAnnotationName"/> if successful.</returns>
        public static ReportingDataAnnotationName Parse(string reportingDataAnnotationName, bool allowUnparsed) =>
            TryParse(reportingDataAnnotationName, allowUnparsed, out ReportingDataAnnotationName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ReportingDataAnnotationName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="reportingDataAnnotationName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ReportingDataAnnotationName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string reportingDataAnnotationName, out ReportingDataAnnotationName result) =>
            TryParse(reportingDataAnnotationName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string reportingDataAnnotationName, bool allowUnparsed, out ReportingDataAnnotationName result)
        {
            gax::GaxPreconditions.CheckNotNull(reportingDataAnnotationName, nameof(reportingDataAnnotationName));
            gax::TemplatedResourceName resourceName;
            if (s_propertyReportingDataAnnotation.TryParseName(reportingDataAnnotationName, out resourceName))
            {
                result = FromPropertyReportingDataAnnotation(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(reportingDataAnnotationName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private ReportingDataAnnotationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string propertyId = null, string reportingDataAnnotationId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            PropertyId = propertyId;
            ReportingDataAnnotationId = reportingDataAnnotationId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="ReportingDataAnnotationName"/> class from the component parts of
        /// pattern <c>properties/{property}/reportingDataAnnotations/{reporting_data_annotation}</c>
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="reportingDataAnnotationId">
        /// The <c>ReportingDataAnnotation</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public ReportingDataAnnotationName(string propertyId, string reportingDataAnnotationId) : this(ResourceNameType.PropertyReportingDataAnnotation, propertyId: gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)), reportingDataAnnotationId: gax::GaxPreconditions.CheckNotNullOrEmpty(reportingDataAnnotationId, nameof(reportingDataAnnotationId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ReportingDataAnnotation</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        public string ReportingDataAnnotationId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.PropertyReportingDataAnnotation: return s_propertyReportingDataAnnotation.Expand(PropertyId, ReportingDataAnnotationId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as ReportingDataAnnotationName);

        /// <inheritdoc/>
        public bool Equals(ReportingDataAnnotationName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(ReportingDataAnnotationName a, ReportingDataAnnotationName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(ReportingDataAnnotationName a, ReportingDataAnnotationName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>SubpropertySyncConfig</c> resource.</summary>
    public sealed partial class SubpropertySyncConfigName : gax::IResourceName, sys::IEquatable<SubpropertySyncConfigName>
    {
        /// <summary>The possible contents of <see cref="SubpropertySyncConfigName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern <c>properties/{property}/subpropertySyncConfigs/{subproperty_sync_config}</c>
            /// .
            /// </summary>
            PropertySubpropertySyncConfig = 1,
        }

        private static gax::PathTemplate s_propertySubpropertySyncConfig = new gax::PathTemplate("properties/{property}/subpropertySyncConfigs/{subproperty_sync_config}");

        /// <summary>Creates a <see cref="SubpropertySyncConfigName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="SubpropertySyncConfigName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static SubpropertySyncConfigName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new SubpropertySyncConfigName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="SubpropertySyncConfigName"/> with the pattern
        /// <c>properties/{property}/subpropertySyncConfigs/{subproperty_sync_config}</c>.
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="subpropertySyncConfigId">
        /// The <c>SubpropertySyncConfig</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="SubpropertySyncConfigName"/> constructed from the provided ids.
        /// </returns>
        public static SubpropertySyncConfigName FromPropertySubpropertySyncConfig(string propertyId, string subpropertySyncConfigId) =>
            new SubpropertySyncConfigName(ResourceNameType.PropertySubpropertySyncConfig, propertyId: gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)), subpropertySyncConfigId: gax::GaxPreconditions.CheckNotNullOrEmpty(subpropertySyncConfigId, nameof(subpropertySyncConfigId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="SubpropertySyncConfigName"/> with pattern
        /// <c>properties/{property}/subpropertySyncConfigs/{subproperty_sync_config}</c>.
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="subpropertySyncConfigId">
        ...
        /// </param>
        /// <returns>
        /// The string representation of this <see cref="SubpropertySyncConfigName"/> with pattern
        /// <c>properties/{property}/subpropertySyncConfigs/{subproperty_sync_config}</c>.
        /// </returns>
        public static string Format(string propertyId, string subpropertySyncConfigId) =>
            FormatPropertySubpropertySyncConfig(propertyId, subpropertySyncConfigId);
        ...
        /// <c>properties/{property}/subpropertySyncConfigs/{subproperty_sync_config}</c>.
        /// </returns>
        public static string FormatPropertySubpropertySyncConfig(string propertyId, string subpropertySyncConfigId) =>
            s_propertySubpropertySyncConfig.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)), gax::GaxPreconditions.CheckNotNullOrEmpty(subpropertySyncConfigId, nameof(subpropertySyncConfigId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="SubpropertySyncConfigName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        /// <description><c>properties/{property}/subpropertySyncConfigs/{subproperty_sync_config}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        /// <param name="subpropertySyncConfigName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="SubpropertySyncConfigName"/> if successful.</returns>
        public static SubpropertySyncConfigName Parse(string subpropertySyncConfigName) =>
            Parse(subpropertySyncConfigName, false);
        ...
        /// </param>
        /// <returns>The parsed <see cref="SubpropertySyncConfigName"/> if successful.</returns>
        public static SubpropertySyncConfigName Parse(string subpropertySyncConfigName, bool allowUnparsed) =>
            TryParse(subpropertySyncConfigName, allowUnparsed, out SubpropertySyncConfigName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="SubpropertySyncConfigName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="subpropertySyncConfigName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="SubpropertySyncConfigName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string subpropertySyncConfigName, out SubpropertySyncConfigName result) =>
            TryParse(subpropertySyncConfigName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string subpropertySyncConfigName, bool allowUnparsed, out SubpropertySyncConfigName result)
        {
            gax::GaxPreconditions.CheckNotNull(subpropertySyncConfigName, nameof(subpropertySyncConfigName));
            gax::TemplatedResourceName resourceName;
            if (s_propertySubpropertySyncConfig.TryParseName(subpropertySyncConfigName, out resourceName))
            {
                result = FromPropertySubpropertySyncConfig(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(subpropertySyncConfigName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private SubpropertySyncConfigName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string propertyId = null, string subpropertySyncConfigId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            PropertyId = propertyId;
            SubpropertySyncConfigId = subpropertySyncConfigId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="SubpropertySyncConfigName"/> class from the component parts of
        /// pattern <c>properties/{property}/subpropertySyncConfigs/{subproperty_sync_config}</c>
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="subpropertySyncConfigId">
        /// The <c>SubpropertySyncConfig</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public SubpropertySyncConfigName(string propertyId, string subpropertySyncConfigId) : this(ResourceNameType.PropertySubpropertySyncConfig, propertyId: gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)), subpropertySyncConfigId: gax::GaxPreconditions.CheckNotNullOrEmpty(subpropertySyncConfigId, nameof(subpropertySyncConfigId)))
        {
        }
        ...
        /// <summary>
        /// The <c>SubpropertySyncConfig</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        public string SubpropertySyncConfigId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.PropertySubpropertySyncConfig: return s_propertySubpropertySyncConfig.Expand(PropertyId, SubpropertySyncConfigId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as SubpropertySyncConfigName);

        /// <inheritdoc/>
        public bool Equals(SubpropertySyncConfigName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(SubpropertySyncConfigName a, SubpropertySyncConfigName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(SubpropertySyncConfigName a, SubpropertySyncConfigName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>ReportingIdentitySettings</c> resource.</summary>
    public sealed partial class ReportingIdentitySettingsName : gax::IResourceName, sys::IEquatable<ReportingIdentitySettingsName>
    {
        /// <summary>The possible contents of <see cref="ReportingIdentitySettingsName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,

            /// <summary>A resource name with pattern <c>properties/{property}/reportingIdentitySettings</c>.</summary>
            Property = 1,
        }

        private static gax::PathTemplate s_property = new gax::PathTemplate("properties/{property}/reportingIdentitySettings");

        /// <summary>
        /// Creates a <see cref="ReportingIdentitySettingsName"/> containing an unparsed resource name.
        /// </summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ReportingIdentitySettingsName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static ReportingIdentitySettingsName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new ReportingIdentitySettingsName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="ReportingIdentitySettingsName"/> with the pattern
        /// <c>properties/{property}/reportingIdentitySettings</c>.
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// A new instance of <see cref="ReportingIdentitySettingsName"/> constructed from the provided ids.
        /// </returns>
        public static ReportingIdentitySettingsName FromProperty(string propertyId) =>
            new ReportingIdentitySettingsName(ResourceNameType.Property, propertyId: gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ReportingIdentitySettingsName"/> with
        /// pattern <c>properties/{property}/reportingIdentitySettings</c>.
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="ReportingIdentitySettingsName"/> with pattern
        /// <c>properties/{property}/reportingIdentitySettings</c>.
        /// </returns>
        public static string Format(string propertyId) => FormatProperty(propertyId);
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="ReportingIdentitySettingsName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>properties/{property}/reportingIdentitySettings</c></description></item>
        /// </list>
        /// </remarks>
        /// <param name="reportingIdentitySettingsName">
        /// The resource name in string form. Must not be <c>null</c>.
        /// </param>
        /// <returns>The parsed <see cref="ReportingIdentitySettingsName"/> if successful.</returns>
        public static ReportingIdentitySettingsName Parse(string reportingIdentitySettingsName) =>
            Parse(reportingIdentitySettingsName, false);
        ...
        /// </param>
        /// <returns>The parsed <see cref="ReportingIdentitySettingsName"/> if successful.</returns>
        public static ReportingIdentitySettingsName Parse(string reportingIdentitySettingsName, bool allowUnparsed) =>
            TryParse(reportingIdentitySettingsName, allowUnparsed, out ReportingIdentitySettingsName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ReportingIdentitySettingsName"/>
        /// instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ReportingIdentitySettingsName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string reportingIdentitySettingsName, out ReportingIdentitySettingsName result) =>
            TryParse(reportingIdentitySettingsName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string reportingIdentitySettingsName, bool allowUnparsed, out ReportingIdentitySettingsName result)
        {
            gax::GaxPreconditions.CheckNotNull(reportingIdentitySettingsName, nameof(reportingIdentitySettingsName));
            gax::TemplatedResourceName resourceName;
            if (s_property.TryParseName(reportingIdentitySettingsName, out resourceName))
            {
                result = FromProperty(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(reportingIdentitySettingsName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private ReportingIdentitySettingsName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string propertyId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            PropertyId = propertyId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="ReportingIdentitySettingsName"/> class from the component parts of
        /// pattern <c>properties/{property}/reportingIdentitySettings</c>
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        public ReportingIdentitySettingsName(string propertyId) : this(ResourceNameType.Property, propertyId: gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as ReportingIdentitySettingsName);

        /// <inheritdoc/>
        public bool Equals(ReportingIdentitySettingsName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(ReportingIdentitySettingsName a, ReportingIdentitySettingsName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(ReportingIdentitySettingsName a, ReportingIdentitySettingsName b) => !(a == b);
    }

    /// <summary>Resource name for the <c>UserProvidedDataSettings</c> resource.</summary>
    public sealed partial class UserProvidedDataSettingsName : gax::IResourceName, sys::IEquatable<UserProvidedDataSettingsName>
    {
        /// <summary>The possible contents of <see cref="UserProvidedDataSettingsName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,

            /// <summary>A resource name with pattern <c>properties/{property}/userProvidedDataSettings</c>.</summary>
            Property = 1,
        }

        private static gax::PathTemplate s_property = new gax::PathTemplate("properties/{property}/userProvidedDataSettings");

        /// <summary>
        /// Creates a <see cref="UserProvidedDataSettingsName"/> containing an unparsed resource name.
        /// </summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="UserProvidedDataSettingsName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static UserProvidedDataSettingsName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new UserProvidedDataSettingsName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="UserProvidedDataSettingsName"/> with the pattern
        /// <c>properties/{property}/userProvidedDataSettings</c>.
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// A new instance of <see cref="UserProvidedDataSettingsName"/> constructed from the provided ids.
        /// </returns>
        public static UserProvidedDataSettingsName FromProperty(string propertyId) =>
            new UserProvidedDataSettingsName(ResourceNameType.Property, propertyId: gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="UserProvidedDataSettingsName"/> with
        /// pattern <c>properties/{property}/userProvidedDataSettings</c>.
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="UserProvidedDataSettingsName"/> with pattern
        /// <c>properties/{property}/userProvidedDataSettings</c>.
        /// </returns>
        public static string Format(string propertyId) => FormatProperty(propertyId);
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="UserProvidedDataSettingsName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>properties/{property}/userProvidedDataSettings</c></description></item>
        /// </list>
        /// </remarks>
        /// <param name="userProvidedDataSettingsName">
        /// The resource name in string form. Must not be <c>null</c>.
        /// </param>
        /// <returns>The parsed <see cref="UserProvidedDataSettingsName"/> if successful.</returns>
        public static UserProvidedDataSettingsName Parse(string userProvidedDataSettingsName) =>
            Parse(userProvidedDataSettingsName, false);
        ...
        /// </param>
        /// <returns>The parsed <see cref="UserProvidedDataSettingsName"/> if successful.</returns>
        public static UserProvidedDataSettingsName Parse(string userProvidedDataSettingsName, bool allowUnparsed) =>
            TryParse(userProvidedDataSettingsName, allowUnparsed, out UserProvidedDataSettingsName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="UserProvidedDataSettingsName"/>
        /// instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="UserProvidedDataSettingsName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string userProvidedDataSettingsName, out UserProvidedDataSettingsName result) =>
            TryParse(userProvidedDataSettingsName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string userProvidedDataSettingsName, bool allowUnparsed, out UserProvidedDataSettingsName result)
        {
            gax::GaxPreconditions.CheckNotNull(userProvidedDataSettingsName, nameof(userProvidedDataSettingsName));
            gax::TemplatedResourceName resourceName;
            if (s_property.TryParseName(userProvidedDataSettingsName, out resourceName))
            {
                result = FromProperty(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(userProvidedDataSettingsName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private UserProvidedDataSettingsName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string propertyId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            PropertyId = propertyId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="UserProvidedDataSettingsName"/> class from the component parts of
        /// pattern <c>properties/{property}/userProvidedDataSettings</c>
        /// </summary>
        /// <param name="propertyId">The <c>Property</c> ID. Must not be <c>null</c> or empty.</param>
        public UserProvidedDataSettingsName(string propertyId) : this(ResourceNameType.Property, propertyId: gax::GaxPreconditions.CheckNotNullOrEmpty(propertyId, nameof(propertyId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as UserProvidedDataSettingsName);

        /// <inheritdoc/>
        public bool Equals(UserProvidedDataSettingsName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(UserProvidedDataSettingsName a, UserProvidedDataSettingsName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(UserProvidedDataSettingsName a, UserProvidedDataSettingsName b) => !(a == b);
    }
    ...
    public partial class ReportingDataAnnotation
    {
        /// <summary>
    ...
    public partial class SubpropertySyncConfig
    {
        /// <summary>
    ...
    public partial class ReportingIdentitySettings
    {
        /// <summary>
    ...
    public partial class UserProvidedDataSettings
    {
        /// <summary>
