...
{
    // [START policysimulator_v1_generated_Simulator_ListReplayResults_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSimulatorClientSnippets
    {
        ...
        public async Task ListReplayResultsResourceNamesAsync()
        {
            ...
            await foreach (ReplayResult item in response)
            {
            ...
            await foreach (ListReplayResultsResponse page in response.AsRawResponses())
            {
    ...
    // [END policysimulator_v1_generated_Simulator_ListReplayResults_async_flattened_resourceNames]
}
