...
namespace Google.Cloud.Iam.V2.Snippets
{
    ...
    public sealed class AllGeneratedPoliciesClientSnippets
    {
        ...
        public void ListApplicablePoliciesRequestObject()
        {
            // Snippet: ListApplicablePolicies(ListApplicablePoliciesRequest, CallSettings)
            // Create client
            PoliciesClient policiesClient = PoliciesClient.Create();
            // Initialize request argument(s)
            ListApplicablePoliciesRequest request = new ListApplicablePoliciesRequest
            {
                AttachmentPoint = "",
                Filter = "",
            };
            // Make the request
            PagedEnumerable<ListApplicablePoliciesResponse, Policy> response = policiesClient.ListApplicablePolicies(request);
        ...
        public async Task ListApplicablePoliciesRequestObjectAsync()
        {
            // Snippet: ListApplicablePoliciesAsync(ListApplicablePoliciesRequest, CallSettings)
            // Create client
            PoliciesClient policiesClient = await PoliciesClient.CreateAsync();
            // Initialize request argument(s)
            ListApplicablePoliciesRequest request = new ListApplicablePoliciesRequest
            ...
            // Make the request
            PagedAsyncEnumerable<ListApplicablePoliciesResponse, Policy> response = policiesClient.ListApplicablePoliciesAsync(request);
        ...
        {
            // Snippet: ListApplicablePolicies(string, string, int?, CallSettings)
            // Create client
            PoliciesClient policiesClient = PoliciesClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: ListApplicablePoliciesAsync(string, string, int?, CallSettings)
            // Create client
            PoliciesClient policiesClient = await PoliciesClient.CreateAsync();
            // Initialize request argument(s)
            string attachmentPoint = "";
