...
namespace Google.Cloud.CommerceProducer.V1Beta
{
    ...
    public sealed partial class SkuGroupName : gax::IResourceName, sys::IEquatable<SkuGroupName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/skuGroups/{sku_group}</c>.
            /// </summary>
            ProjectLocationSkuGroup = 1,
        }

        private static gax::PathTemplate s_projectLocationSkuGroup = new gax::PathTemplate("projects/{project}/locations/{location}/skuGroups/{sku_group}");
        ...
        /// <summary>
        /// Creates a <see cref="SkuGroupName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/skuGroups/{sku_group}</c>.
        /// </summary>
        ...
        public static SkuGroupName FromProjectLocationSkuGroup(string projectId, string locationId, string skuGroupId) =>
            new SkuGroupName(ResourceNameType.ProjectLocationSkuGroup, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), skuGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(skuGroupId, nameof(skuGroupId)));
        ...
        /// <c>projects/{project}/locations/{location}/skuGroups/{sku_group}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string skuGroupId) =>
            FormatProjectLocationSkuGroup(projectId, locationId, skuGroupId);
        ...
        /// <c>projects/{project}/locations/{location}/skuGroups/{sku_group}</c>.
        /// </returns>
        public static string FormatProjectLocationSkuGroup(string projectId, string locationId, string skuGroupId) =>
            s_projectLocationSkuGroup.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(skuGroupId, nameof(skuGroupId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/skuGroups/{sku_group}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string skuGroupName, bool allowUnparsed, out SkuGroupName result)
        {
            ...
            if (s_projectLocationSkuGroup.TryParseName(skuGroupName, out resourceName))
            {
                result = FromProjectLocationSkuGroup(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private SkuGroupName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string skuGroupId = null)
        {
            Type = type;
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="skuGroupId">The <c>SkuGroup</c> ID. Must not be <c>null</c> or empty.</param>
        public SkuGroupName(string projectId, string locationId, string skuGroupId) : this(ResourceNameType.ProjectLocationSkuGroup, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), skuGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(skuGroupId, nameof(skuGroupId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationSkuGroup: return s_projectLocationSkuGroup.Expand(ProjectId, LocationId, SkuGroupId);
    ...
    public partial class SkuGroup
    {
        ...
        /// <summary><see cref="SkuName"/>-typed view over the <see cref="Skus"/> resource name property.</summary>
