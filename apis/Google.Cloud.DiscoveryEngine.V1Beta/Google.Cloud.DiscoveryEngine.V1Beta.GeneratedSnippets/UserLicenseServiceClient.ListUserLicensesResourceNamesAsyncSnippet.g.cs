...
{
    // [START discoveryengine_v1beta_generated_UserLicenseService_ListUserLicenses_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedUserLicenseServiceClientSnippets
    {
        ...
        public async Task ListUserLicensesResourceNamesAsync()
        {
            ...
            await foreach (UserLicense item in response)
            {
            ...
            await foreach (ListUserLicensesResponse page in response.AsRawResponses())
            {
    ...
    // [END discoveryengine_v1beta_generated_UserLicenseService_ListUserLicenses_async_flattened_resourceNames]
}
