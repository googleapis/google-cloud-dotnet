...
{
    // [START discoveryengine_v1beta_generated_DocumentService_ListDocuments_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDocumentServiceClientSnippets
    {
        ...
        public async Task ListDocumentsResourceNamesAsync()
        {
            ...
            await foreach (Document item in response)
            {
            ...
            await foreach (ListDocumentsResponse page in response.AsRawResponses())
            {
    ...
    // [END discoveryengine_v1beta_generated_DocumentService_ListDocuments_async_flattened_resourceNames]
}
