...
{
    // [START discoveryengine_v1beta_generated_DataStoreService_ListDataStores_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataStoreServiceClientSnippets
    {
        ...
        public async Task ListDataStoresResourceNamesAsync()
        {
            ...
            await foreach (DataStore item in response)
            {
            ...
            await foreach (ListDataStoresResponse page in response.AsRawResponses())
            {
    ...
    // [END discoveryengine_v1beta_generated_DataStoreService_ListDataStores_async_flattened_resourceNames]
}
