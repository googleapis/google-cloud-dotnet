...
{
    // [START discoveryengine_v1beta_generated_SampleQuerySetService_ListSampleQuerySets_async_flattened]
    ...
    public sealed partial class GeneratedSampleQuerySetServiceClientSnippets
    {
        ...
        public async Task ListSampleQuerySetsAsync()
        {
            ...
            await foreach (SampleQuerySet item in response)
            {
            ...
            await foreach (ListSampleQuerySetsResponse page in response.AsRawResponses())
            {
    ...
    // [END discoveryengine_v1beta_generated_SampleQuerySetService_ListSampleQuerySets_async_flattened]
}
