...
namespace Google.Cloud.DiscoveryEngine.V1Beta
{
    ...
    public partial class GroundingConfig
    {
        /// <summary>
        /// <see cref="gcdv::GroundingConfigName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcdv::GroundingConfigName GroundingConfigName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcdv::GroundingConfigName.Parse(Name, allowUnparsed: true);
