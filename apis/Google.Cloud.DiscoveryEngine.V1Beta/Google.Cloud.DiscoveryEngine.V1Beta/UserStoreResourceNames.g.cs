...
namespace Google.Cloud.DiscoveryEngine.V1Beta
{
    ...
    public partial class UserStore
    {
        ...
        /// <summary>
        /// <see cref="LicenseConfigName"/>-typed view over the <see cref="DefaultLicenseConfig"/> resource name
        /// property.
        /// </summary>
        public LicenseConfigName DefaultLicenseConfigAsLicenseConfigName
        {
            get => string.IsNullOrEmpty(DefaultLicenseConfig) ? null : LicenseConfigName.Parse(DefaultLicenseConfig, allowUnparsed: true);
            set => DefaultLicenseConfig = value?.ToString() ?? "";
        }
    }
}
