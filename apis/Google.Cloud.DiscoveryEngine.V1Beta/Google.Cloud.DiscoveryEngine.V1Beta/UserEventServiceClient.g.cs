...
namespace Google.Cloud.DiscoveryEngine.V1Beta
{
    ...
    {
        /// <summary>
        /// The default endpoint for the UserEventService service, which is a host of "discoveryengine.googleapis.com"
        /// and a port of 443.
        /// </summary>
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(UserEventService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata> ImportUserEvents(ImportUserEventsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata>> ImportUserEventsAsync(ImportUserEventsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata>> ImportUserEventsAsync(ImportUserEventsRequest request, st::CancellationToken cancellationToken) =>
        ...
        public virtual lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata> PollOnceImportUserEvents(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata>.PollOnceFromName(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), ImportUserEventsOperationsClient, callSettings);
        ...
        public virtual stt::Task<lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata>> PollOnceImportUserEventsAsync(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata>.PollOnceFromNameAsync(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), ImportUserEventsOperationsClient, callSettings);
    }
    ...
    public sealed partial class UserEventServiceClientImpl : UserEventServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata> ImportUserEvents(ImportUserEventsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ImportUserEventsRequest(ref request, ref callSettings);
            return new lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata>(_callImportUserEvents.Sync(request, callSettings), ImportUserEventsOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata>> ImportUserEventsAsync(ImportUserEventsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ImportUserEventsRequest(ref request, ref callSettings);
            return new lro::Operation<ImportUserEventsResponse, ImportUserEventsMetadata>(await _callImportUserEvents.Async(request, callSettings).ConfigureAwait(false), ImportUserEventsOperationsClient);
        }
    }
