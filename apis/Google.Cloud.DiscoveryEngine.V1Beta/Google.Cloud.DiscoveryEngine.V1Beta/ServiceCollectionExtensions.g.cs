...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds a singleton <see cref="gcdv::AclConfigServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        ...
        /// </param>
        public static IServiceCollection AddAclConfigServiceClient(this IServiceCollection services, sys::Action<gcdv::AclConfigServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcdv::AclConfigServiceClientBuilder builder = new gcdv::AclConfigServiceClientBuilder();
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddAclConfigServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcdv::AclConfigServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcdv::AclConfigServiceClientBuilder builder = new gcdv::AclConfigServiceClientBuilder();
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcdv::EvaluationServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddEvaluationServiceClient(this IServiceCollection services, sys::Action<gcdv::EvaluationServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcdv::EvaluationServiceClientBuilder builder = new gcdv::EvaluationServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddEvaluationServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcdv::EvaluationServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcdv::EvaluationServiceClientBuilder builder = new gcdv::EvaluationServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcdv::LicenseConfigServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddLicenseConfigServiceClient(this IServiceCollection services, sys::Action<gcdv::LicenseConfigServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcdv::LicenseConfigServiceClientBuilder builder = new gcdv::LicenseConfigServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddLicenseConfigServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcdv::LicenseConfigServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcdv::LicenseConfigServiceClientBuilder builder = new gcdv::LicenseConfigServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcdv::SampleQueryServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddSampleQueryServiceClient(this IServiceCollection services, sys::Action<gcdv::SampleQueryServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcdv::SampleQueryServiceClientBuilder builder = new gcdv::SampleQueryServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddSampleQueryServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcdv::SampleQueryServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcdv::SampleQueryServiceClientBuilder builder = new gcdv::SampleQueryServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcdv::SampleQuerySetServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddSampleQuerySetServiceClient(this IServiceCollection services, sys::Action<gcdv::SampleQuerySetServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcdv::SampleQuerySetServiceClientBuilder builder = new gcdv::SampleQuerySetServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddSampleQuerySetServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcdv::SampleQuerySetServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcdv::SampleQuerySetServiceClientBuilder builder = new gcdv::SampleQuerySetServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcdv::UserStoreServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddUserStoreServiceClient(this IServiceCollection services, sys::Action<gcdv::UserStoreServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcdv::UserStoreServiceClientBuilder builder = new gcdv::UserStoreServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddUserStoreServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcdv::UserStoreServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcdv::UserStoreServiceClientBuilder builder = new gcdv::UserStoreServiceClientBuilder();
                action?.Invoke(provider, builder);
