...
{
    // [START recommendationengine_v1beta1_generated_PredictionService_Predict_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedPredictionServiceClientSnippets
    {
        ...
        public async Task PredictResourceNamesAsync()
        {
            ...
            await foreach (PredictResponse.Types.PredictionResult item in response)
            {
            ...
            await foreach (PredictResponse page in response.AsRawResponses())
            {
    ...
    // [END recommendationengine_v1beta1_generated_PredictionService_Predict_async_flattened_resourceNames]
}
