...
{
    // [START recommendationengine_v1beta1_generated_PredictionApiKeyRegistry_ListPredictionApiKeyRegistrations_async_flattened]
    ...
    public sealed partial class GeneratedPredictionApiKeyRegistryClientSnippets
    {
        ...
        public async Task ListPredictionApiKeyRegistrationsAsync()
        {
            ...
            await foreach (PredictionApiKeyRegistration item in response)
            {
            ...
            await foreach (ListPredictionApiKeyRegistrationsResponse page in response.AsRawResponses())
            {
    ...
    // [END recommendationengine_v1beta1_generated_PredictionApiKeyRegistry_ListPredictionApiKeyRegistrations_async_flattened]
}
