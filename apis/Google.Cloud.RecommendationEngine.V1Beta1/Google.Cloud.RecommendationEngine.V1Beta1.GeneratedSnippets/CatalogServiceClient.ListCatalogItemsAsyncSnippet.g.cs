...
{
    // [START recommendationengine_v1beta1_generated_CatalogService_ListCatalogItems_async_flattened]
    ...
    public sealed partial class GeneratedCatalogServiceClientSnippets
    {
        ...
        public async Task ListCatalogItemsAsync()
        {
            ...
            await foreach (CatalogItem item in response)
            {
            ...
            await foreach (ListCatalogItemsResponse page in response.AsRawResponses())
            {
    ...
    // [END recommendationengine_v1beta1_generated_CatalogService_ListCatalogItems_async_flattened]
}
