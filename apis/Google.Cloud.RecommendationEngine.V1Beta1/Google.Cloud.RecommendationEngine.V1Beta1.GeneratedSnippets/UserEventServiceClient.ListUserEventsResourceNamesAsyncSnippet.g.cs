...
{
    // [START recommendationengine_v1beta1_generated_UserEventService_ListUserEvents_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedUserEventServiceClientSnippets
    {
        ...
        public async Task ListUserEventsResourceNamesAsync()
        {
            ...
            await foreach (UserEvent item in response)
            {
            ...
            await foreach (ListUserEventsResponse page in response.AsRawResponses())
            {
    ...
    // [END recommendationengine_v1beta1_generated_UserEventService_ListUserEvents_async_flattened_resourceNames]
}
