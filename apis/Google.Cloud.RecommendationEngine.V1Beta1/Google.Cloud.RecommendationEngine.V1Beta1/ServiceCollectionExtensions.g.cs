...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddPredictionApiKeyRegistryClient(this IServiceCollection services, sys::Action<gcrv::PredictionApiKeyRegistryClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
