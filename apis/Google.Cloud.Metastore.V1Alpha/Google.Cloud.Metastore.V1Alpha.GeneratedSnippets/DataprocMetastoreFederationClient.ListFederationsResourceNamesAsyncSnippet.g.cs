...
{
    // [START metastore_v1alpha_generated_DataprocMetastoreFederation_ListFederations_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDataprocMetastoreFederationClientSnippets
    {
        ...
        public async Task ListFederationsResourceNamesAsync()
        {
            ...
            await foreach (Federation item in response)
            {
            ...
            await foreach (ListFederationsResponse page in response.AsRawResponses())
            {
    ...
    // [END metastore_v1alpha_generated_DataprocMetastoreFederation_ListFederations_async_flattened_resourceNames]
}
