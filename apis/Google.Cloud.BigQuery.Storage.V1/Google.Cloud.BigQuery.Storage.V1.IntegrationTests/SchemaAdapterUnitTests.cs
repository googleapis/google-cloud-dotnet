...
namespace Google.Cloud.BigQuery.Storage.V1.IntegrationTests
{
    public class SchemaAdapterUnitTests
    {
        ...
        public void NormalizeDescriptor_SimpleMessage()
        {
            ...
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_SimpleTestMessage", normalizedDescriptor.Name);
        ...
        public void NormalizeDescriptor_OneOfTestMessage()
        {
            ...
            Assert.NotNull(normalizedDescriptor);
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_OneOfTestMessage", normalizedDescriptor.Name);
        ...
        public void NormalizeDescriptor_ComplexTestMessage()
        {
            ...
            Assert.NotNull(normalizedDescriptor);
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_ComplexTestMessage", normalizedDescriptor.Name);
            ...
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_NestedMessage", fields[6].TypeName);
            ...
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_NestedMessage", fields[7].TypeName);
            ...
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_Status_E.Status", fields[8].TypeName);
            ...
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_NestedMessage", nestedMessage.Name);
            ...
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_Status_E", statusEnumContainer.Name);
        ...
        public void NormalizeDescriptor_BusinessMessage()
        {
            ...
            Assert.NotNull(normalizedDescriptor);
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_BusinessChangedEvent", normalizedDescriptor.Name);
            ...
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_Business", businessField.TypeName);

            Assert.Equal(3, normalizedDescriptor.NestedType.Count);

            var businessMessage = normalizedDescriptor.NestedType.FirstOrDefault(n => n.Name == "Google_Cloud_BigQuery_Storage_V1_Tests_Business");
            ...
            Assert.Equal("Google_Cloud_BigQuery_Storage_V1_Tests_BusinessStatus_E.BusinessStatus", statusField.TypeName);
            ...
            var businessStatusEnum = normalizedDescriptor.NestedType.FirstOrDefault(n => n.Name == "Google_Cloud_BigQuery_Storage_V1_Tests_BusinessStatus_E");
