...
{
    // [START cloudlocationfinder_v1_generated_CloudLocationFinder_ListCloudLocations_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.LocationFinder.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedCloudLocationFinderClientSnippets
    {
        ...
        public async Task ListCloudLocationsAsync()
        {
            ...
            await foreach (CloudLocation item in response)
            {
            ...
            await foreach (ListCloudLocationsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudlocationfinder_v1_generated_CloudLocationFinder_ListCloudLocations_async_flattened]
}
