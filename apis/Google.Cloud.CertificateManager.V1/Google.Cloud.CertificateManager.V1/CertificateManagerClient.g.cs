...
namespace Google.Cloud.CertificateManager.V1
{
    ...
    public sealed partial class CertificateManagerClientBuilder : gaxgrpc::ClientBuilderBase<CertificateManagerClient>
    {
        ...
        private CertificateManagerClient BuildImpl()
        {
            ...
            return CertificateManagerClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class CertificateManagerClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(CertificateManager.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
