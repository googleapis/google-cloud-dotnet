...
{
    // [START developerconnect_v1_generated_DeveloperConnect_ListAccountConnectors_async_flattened]
    ...
    public sealed partial class GeneratedDeveloperConnectClientSnippets
    {
        ...
        public async Task ListAccountConnectorsAsync()
        {
            ...
            await foreach (AccountConnector item in response)
            {
            ...
            await foreach (ListAccountConnectorsResponse page in response.AsRawResponses())
            {
    ...
    // [END developerconnect_v1_generated_DeveloperConnect_ListAccountConnectors_async_flattened]
}
