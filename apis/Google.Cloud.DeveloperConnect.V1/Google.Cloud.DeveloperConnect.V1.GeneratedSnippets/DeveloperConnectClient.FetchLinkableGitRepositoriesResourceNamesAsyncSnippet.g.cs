...
{
    // [START developerconnect_v1_generated_DeveloperConnect_FetchLinkableGitRepositories_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedDeveloperConnectClientSnippets
    {
        ...
        public async Task FetchLinkableGitRepositoriesResourceNamesAsync()
        {
            ...
            await foreach (LinkableGitRepository item in response)
            {
            ...
            await foreach (FetchLinkableGitRepositoriesResponse page in response.AsRawResponses())
            {
    ...
    // [END developerconnect_v1_generated_DeveloperConnect_FetchLinkableGitRepositories_async_flattened_resourceNames]
}
