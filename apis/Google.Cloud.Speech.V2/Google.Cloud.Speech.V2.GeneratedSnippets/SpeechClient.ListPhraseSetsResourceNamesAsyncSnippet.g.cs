...
{
    // [START speech_v2_generated_Speech_ListPhraseSets_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSpeechClientSnippets
    {
        ...
        public async Task ListPhraseSetsResourceNamesAsync()
        {
            ...
            await foreach (PhraseSet item in response)
            {
            ...
            await foreach (ListPhraseSetsResponse page in response.AsRawResponses())
            {
    ...
    // [END speech_v2_generated_Speech_ListPhraseSets_async_flattened_resourceNames]
}
