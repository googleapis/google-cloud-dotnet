...
namespace Google.Cloud.Diagnostics.Common
{
    ...
    /// </summary>
    public class TraceDecisionPredicate
    {
        ...
        /// <summary>
        /// A <see cref="TraceDecisionPredicate"/> that does not have any affect on
        /// trace decisions.
        /// </summary>
        public static TraceDecisionPredicate DoNothing() => Create(null, false);
