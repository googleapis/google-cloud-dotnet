...
namespace Google.Cloud.Diagnostics.Common.Tests
{
    public class ReportEventsToTest
    {
        ...
        public void Logging_ProjectId()
        {
            ...
            Assert.Equal(EventTarget.Logging, reportEventsTo.Target);
            ...
            Assert.Equal(LogTarget.Project, reportEventsTo.LogTo.Target);
        ...
        public void ErrorReporting()
        {
            ...
            Assert.Equal(EventTarget.ErrorReporting, reportEventsTo.Target);
