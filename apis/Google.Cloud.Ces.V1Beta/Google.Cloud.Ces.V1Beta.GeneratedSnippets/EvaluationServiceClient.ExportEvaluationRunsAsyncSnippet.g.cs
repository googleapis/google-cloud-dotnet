...
{
    // [START ces_v1beta_generated_EvaluationService_ExportEvaluationRuns_async_flattened]
    ...
    public sealed partial class GeneratedEvaluationServiceClientSnippets
    {
        ...
        /// </remarks>
        public async Task ExportEvaluationRunsAsync()
        {
            // Create client
            ...
            // Make the request
            Operation<ExportEvaluationRunsResponse, ExportEvaluationRunsOperationMetadata> response = await evaluationServiceClient.ExportEvaluationRunsAsync(parent, names);
    ...
    // [END ces_v1beta_generated_EvaluationService_ExportEvaluationRuns_async_flattened]
}
