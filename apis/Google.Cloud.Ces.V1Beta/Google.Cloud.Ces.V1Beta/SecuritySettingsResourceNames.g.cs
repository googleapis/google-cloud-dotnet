...
namespace Google.Cloud.Ces.V1Beta
{
    ...
    public sealed partial class SecuritySettingsName : gax::IResourceName, sys::IEquatable<SecuritySettingsName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/securitySettings</c>.
            /// </summary>
            ProjectLocation = 1,
        }

        private static gax::PathTemplate s_projectLocation = new gax::PathTemplate("projects/{project}/locations/{location}/securitySettings");
        ...
        /// <c>projects/{project}/locations/{location}/securitySettings</c>.
        /// </summary>
        ...
        public static SecuritySettingsName FromProjectLocation(string projectId, string locationId) =>
            new SecuritySettingsName(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)));
        ...
        /// <list type="bullet">
        /// <item><description><c>projects/{project}/locations/{location}/securitySettings</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string securitySettingsName, bool allowUnparsed, out SecuritySettingsName result)
        {
            ...
            if (s_projectLocation.TryParseName(securitySettingsName, out resourceName))
            {
        ...
        private SecuritySettingsName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        public SecuritySettingsName(string projectId, string locationId) : this(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)))
        {
        }
