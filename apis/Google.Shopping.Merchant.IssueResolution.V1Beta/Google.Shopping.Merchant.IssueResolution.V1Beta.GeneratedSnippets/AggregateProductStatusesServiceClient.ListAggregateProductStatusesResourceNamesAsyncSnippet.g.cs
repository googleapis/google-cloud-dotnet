...
{
    // [START merchantapi_v1beta_generated_AggregateProductStatusesService_ListAggregateProductStatuses_async_flattened_resourceNames]
    using Google.Api.Gax;
    using Google.Shopping.Merchant.IssueResolution.V1Beta;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedAggregateProductStatusesServiceClientSnippets
    {
        ...
        public async Task ListAggregateProductStatusesResourceNamesAsync()
        {
            ...
            await foreach (AggregateProductStatus item in response)
            {
            ...
            await foreach (ListAggregateProductStatusesResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_AggregateProductStatusesService_ListAggregateProductStatuses_async_flattened_resourceNames]
}
