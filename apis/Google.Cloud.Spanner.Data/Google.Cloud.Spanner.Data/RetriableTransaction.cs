                ...
                return await ExecuteHelper.WithErrorTranslationAndProfiling(
                    async () =>
                    {
                        ...
                        try
                        {
                            ...
                            managedTransaction = await _connection.AcquireManagedTransaction(_prevTransactionId != null ? _creationOptions.WithPreviousTransactionId(_prevTransactionId) : _creationOptions, out effectiveCreationOptions).ConfigureAwait(false);
