...
namespace Google.Cloud.Spanner.Data
{
    ...
    public sealed class SpannerConnection : DbConnection
    {
        ...
        public SpannerCommand CreateDeleteCommand(
            KeySet keySet,
            string databaseTable) => new SpannerCommand(
            SpannerCommandTextBuilder.CreateDeleteTextBuilder(databaseTable), this, GaxPreconditions.CheckNotNull(keySet, nameof(keySet)));
