...
namespace Google.Cloud.Spanner.Data
{
    ...
    public sealed class SpannerDataAdapter : DbDataAdapter, IDbDataAdapter
    {
        ...
        /// </summary>
        /// <param name="autoGeneratedCommandTable">The Spanner database table to use for automatically generated commands.</param>
        /// <param name="connection">A connection to the Spanner database.</param>
        public SpannerDataAdapter(string autoGeneratedCommandTable, SpannerConnection connection)
        {
        ...
        {
            if (rowUpdatingEventArgs.Command == null && AutoCreateCommands)
            {
                //show a friendly exception before this bails later in case
                //the user forgot to set this property.
                if (string.IsNullOrEmpty(AutoGeneratedCommandTable))
                {
