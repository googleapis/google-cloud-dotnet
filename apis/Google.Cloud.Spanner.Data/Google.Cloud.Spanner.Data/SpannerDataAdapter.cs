...
namespace Google.Cloud.Spanner.Data
{
    ...
    public sealed class SpannerDataAdapter : DbDataAdapter, IDbDataAdapter
    {
        ...
        /// </summary>
        public ISet<string> AutoGeneratedCommandPrimaryKeys { get; } = new HashSet<string>();
        ...
        /// <param name="autoGeneratedCommandTable">
        ...
        /// <paramref name="autoGeneratedCommandTable" />.
        /// </param>
        public SpannerDataAdapter(
            SpannerConnection connection,
            string autoGeneratedCommandTable,
        ...
        private SpannerCommand GetBuiltInsertCommand()
        {
            ...
            {
                _builtInsertCommand =
                    SpannerConnection.CreateInsertCommand(
                        AutoGeneratedCommandTable,
                        SpannerColumnCollection.FromParameterCollection(_parsedParameterCollection));
            }
        ...
        private SpannerCommand GetBuiltUpdateCommand()
        {
            ...
            {
                _builtUpdateCommand =
                    SpannerConnection.CreateUpdateCommand(
                        AutoGeneratedCommandTable,
                        SpannerColumnCollection.FromParameterCollection(_parsedParameterCollection));
            }
        ...
        private SpannerCommand GetBuiltDeleteCommand()
        {
            ...
            {
                var deleteCollection = new SpannerParameterCollection();
                ...
                _builtDeleteCommand =
                    SpannerConnection.CreateDeleteCommand(
                        AutoGeneratedCommandTable, SpannerColumnCollection.FromParameterCollection(deleteCollection));
            }
        ...
        private SpannerCommand GetBuiltSelectCommand()
        {
            ...
            {
                _builtSelectCommand =
                    SpannerConnection.CreateSelectCommand($"SELECT * FROM {AutoGeneratedCommandTable}");
            }
