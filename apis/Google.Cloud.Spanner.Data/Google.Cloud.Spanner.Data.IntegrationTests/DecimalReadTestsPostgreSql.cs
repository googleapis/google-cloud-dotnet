...
{
    [Collection(nameof(DecimalTableFixturePostgreSql))]
    public class DecimalReadTestsPostgreSql
    {
        private readonly DecimalTableFixturePostgreSql _fixture;

        public DecimalReadTestsPostgreSql(DecimalTableFixturePostgreSql fixture) =>
            _fixture = fixture;
