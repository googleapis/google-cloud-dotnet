    ...
    public class WriteTests
    {
        ...
        private async Task ExecuteWriteNullsTest(Func<SpannerParameterCollection, Task<int>> insertCommand)
        {
            ...
            var parameters = new SpannerParameterCollection
            {
                ...
                { "EnumValue", SpannerDbType.FromClrType(typeof(Character.Types.CharacterClass)), null },
                ...
                { "Float32ArrayValue", SpannerDbType.ArrayOf(SpannerDbType.Float32), null },
                ...
                { "EnumArrayValue", SpannerDbType.ArrayOf(SpannerDbType.FromClrType(typeof(Character.Types.CharacterClass))), null },
        ...
        public async Task WriteEmpties()
        {
            var parameters = new SpannerParameterCollection
            {
                ...
                { "Float32ArrayValue", SpannerDbType.ArrayOf(SpannerDbType.Float32), new float[0] },
