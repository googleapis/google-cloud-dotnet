...
[Collection(nameof(SpannerReaderRoleFixturePg))]
[CommonTestDiagnostics]
[Trait(Constants.SupportedOnEmulator, Constants.No)]
public class SpannerGranularAccessPostgreSqlTest
{
    private readonly SpannerReaderRoleFixturePg _fixture;

    public SpannerGranularAccessPostgreSqlTest(SpannerReaderRoleFixturePg fixture) =>
        _fixture = fixture;
    ...
    public async Task WriteWithReaderDbRoleTest()
    {
        ...
        using var readerConnection = _fixture.GetReadOnlyConnection();
        var insertCmd = readerConnection.CreateInsertCommand(_fixture.TableName, new SpannerParameterCollection
            {
