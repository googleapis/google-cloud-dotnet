...
namespace Google.Cloud.Spanner.Data.IntegrationTests
{
    ...
    public class TransactionTests : TransactionTestBase
    {
        ...
        [Fact]
        public async Task TransactionOptionsSetCorrectly()
        {
            ...
            {
                await connection.OpenAsync();
                var options = SpannerTransactionCreationOptions.ReadWrite.WithReadLockMode(ReadLockMode.Pessimistic).WithIsolationLevel(System.Data.IsolationLevel.Serializable);
