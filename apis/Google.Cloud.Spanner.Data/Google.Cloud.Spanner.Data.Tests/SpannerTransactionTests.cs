...
public class SpannerTransactionTests
{
    ...
    public void MaxCommitDelay_DefaultsToNull()
    {
        ...
        spannerClientMock.SetupCreateSessionAsync();
    ...
    public void SpannerTransactionIsolationLevel_FromConnectionString()
    {
        ...
        SpannerClient spannerClientMock = SpannerClientHelpers.CreateMockClient(Logger.DefaultLogger).SetupCreateSessionAsync();
