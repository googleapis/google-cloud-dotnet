...
namespace Google.Cloud.DataFusion.V1
{
    ...
    public sealed partial class DataFusionClientBuilder : gaxgrpc::ClientBuilderBase<DataFusionClient>
    {
        ...
        private DataFusionClient BuildImpl()
        {
            ...
            return DataFusionClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class DataFusionClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(DataFusion.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
