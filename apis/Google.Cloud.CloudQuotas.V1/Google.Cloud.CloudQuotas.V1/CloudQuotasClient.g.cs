...
namespace Google.Cloud.CloudQuotas.V1
{
    ...
    public sealed partial class CloudQuotasClientBuilder : gaxgrpc::ClientBuilderBase<CloudQuotasClient>
    {
        ...
        private CloudQuotasClient BuildImpl()
        {
            ...
            return CloudQuotasClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class CloudQuotasClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(CloudQuotas.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
