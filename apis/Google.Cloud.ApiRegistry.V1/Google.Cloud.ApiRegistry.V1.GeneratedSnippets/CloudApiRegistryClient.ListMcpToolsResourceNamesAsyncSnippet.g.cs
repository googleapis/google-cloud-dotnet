...
{
    // [START cloudapiregistry_v1_generated_CloudApiRegistry_ListMcpTools_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCloudApiRegistryClientSnippets
    {
        ...
        public async Task ListMcpToolsResourceNamesAsync()
        {
            ...
            await foreach (McpTool item in response)
            {
            ...
            await foreach (ListMcpToolsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudapiregistry_v1_generated_CloudApiRegistry_ListMcpTools_async_flattened_resourceNames]
}
