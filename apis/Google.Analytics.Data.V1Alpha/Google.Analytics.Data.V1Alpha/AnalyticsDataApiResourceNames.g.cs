...
namespace Google.Analytics.Data.V1Alpha
{
    ...
    public sealed partial class MetadataName : gax::IResourceName, sys::IEquatable<MetadataName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>metadata</c>.</summary>
            Metadata = 1,
        ...
        /// <summary>Creates a <see cref="MetadataName"/> with the pattern <c>metadata</c>.</summary>
        /// <returns>A new instance of <see cref="MetadataName"/> constructed from the provided ids.</returns>
        public static MetadataName FromMetadata() => new MetadataName(ResourceNameType.Metadata);
        ...
        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="MetadataName"/> with pattern <c>metadata</c>
        /// .
        /// </summary>
        /// <returns>
        /// The string representation of this <see cref="MetadataName"/> with pattern <c>metadata</c>.
        /// </returns>
        public static string Format() => FormatMetadata();
        ...
        /// The string representation of this <see cref="MetadataName"/> with pattern <c>metadata</c>.
        /// </returns>
        public static string FormatMetadata() => s_metadata.Expand();
        ...
        /// <list type="bullet">
        /// <item><description><c>metadata</c></description></item>
        /// <item><description><c>properties/{property}/metadata</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string metadataName, bool allowUnparsed, out MetadataName result)
        {
            ...
            if (s_metadata.TryParseName(metadataName, out resourceName))
            {
                result = FromMetadata();
                return true;
            }
        ...
        /// <c>metadata</c>
        /// </summary>
        public MetadataName() : this(ResourceNameType.Metadata)
        {
        }
