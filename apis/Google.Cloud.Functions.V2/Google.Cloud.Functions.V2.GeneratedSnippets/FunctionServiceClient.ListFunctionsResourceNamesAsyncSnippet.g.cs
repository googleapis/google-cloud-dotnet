...
{
    // [START cloudfunctions_v2_generated_FunctionService_ListFunctions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedFunctionServiceClientSnippets
    {
        ...
        public async Task ListFunctionsResourceNamesAsync()
        {
            ...
            await foreach (Function item in response)
            {
            ...
            await foreach (ListFunctionsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudfunctions_v2_generated_FunctionService_ListFunctions_async_flattened_resourceNames]
}
