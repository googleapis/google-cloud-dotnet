...
{
    // [START networkconnectivity_v1beta_generated_HubService_ListHubSpokes_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedHubServiceClientSnippets
    {
        ...
        public async Task ListHubSpokesResourceNamesAsync()
        {
            ...
            await foreach (Spoke item in response)
            {
            ...
            await foreach (ListHubSpokesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkconnectivity_v1beta_generated_HubService_ListHubSpokes_async_flattened_resourceNames]
}
