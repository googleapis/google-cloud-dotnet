...
{
    // [START networkconnectivity_v1beta_generated_PolicyBasedRoutingService_ListPolicyBasedRoutes_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedPolicyBasedRoutingServiceClientSnippets
    {
        ...
        public async Task ListPolicyBasedRoutesResourceNamesAsync()
        {
            ...
            await foreach (PolicyBasedRoute item in response)
            {
            ...
            await foreach (ListPolicyBasedRoutesResponse page in response.AsRawResponses())
            {
    ...
    // [END networkconnectivity_v1beta_generated_PolicyBasedRoutingService_ListPolicyBasedRoutes_async_flattened_resourceNames]
}
