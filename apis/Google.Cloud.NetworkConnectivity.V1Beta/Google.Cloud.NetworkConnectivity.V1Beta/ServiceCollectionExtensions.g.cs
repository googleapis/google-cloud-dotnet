...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds a singleton <see cref="gcnv::DataTransferServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        ...
        /// </param>
        public static IServiceCollection AddDataTransferServiceClient(this IServiceCollection services, sys::Action<gcnv::DataTransferServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcnv::DataTransferServiceClientBuilder builder = new gcnv::DataTransferServiceClientBuilder();
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddDataTransferServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcnv::DataTransferServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcnv::DataTransferServiceClientBuilder builder = new gcnv::DataTransferServiceClientBuilder();
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcnv::TransportManagerClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddTransportManagerClient(this IServiceCollection services, sys::Action<gcnv::TransportManagerClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcnv::TransportManagerClientBuilder builder = new gcnv::TransportManagerClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddTransportManagerClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcnv::TransportManagerClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcnv::TransportManagerClientBuilder builder = new gcnv::TransportManagerClientBuilder();
                action?.Invoke(provider, builder);
