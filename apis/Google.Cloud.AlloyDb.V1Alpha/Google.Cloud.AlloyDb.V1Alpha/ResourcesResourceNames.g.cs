...
namespace Google.Cloud.AlloyDb.V1Alpha
{
    ...
    public partial class Cluster
    {
        ...
        public partial class Types
        {
            ...
            public partial class SecondaryConfig
            {
                /// <summary>
                /// <see cref="gcav::ClusterName"/>-typed view over the <see cref="PrimaryClusterName"/> resource name
                /// property.
                /// </summary>
                public gcav::ClusterName PrimaryClusterNameAsClusterName
                {
                    get => string.IsNullOrEmpty(PrimaryClusterName) ? null : gcav::ClusterName.Parse(PrimaryClusterName, allowUnparsed: true);
                    set => PrimaryClusterName = value?.ToString() ?? "";
                }
            }

            public partial class PrimaryConfig
            {
                /// <summary>
                /// <see cref="gcav::ClusterName"/>-typed view over the <see cref="SecondaryClusterNames"/> resource
                /// name property.
                /// </summary>
                public gax::ResourceNameList<gcav::ClusterName> SecondaryClusterNamesAsClusterNames
                {
                    get => new gax::ResourceNameList<gcav::ClusterName>(SecondaryClusterNames, s => string.IsNullOrEmpty(s) ? null : gcav::ClusterName.Parse(s, allowUnparsed: true));
                }
            }
        }
    }
    ...
    public partial class Instance
    {
        ...
        public partial class Types
        {
            public partial class PscInstanceConfig
            {
                /// <summary>
                /// <see cref="ServiceAttachmentName"/>-typed view over the <see cref="ServiceAttachmentLink"/> resource
                /// name property.
                /// </summary>
                public ServiceAttachmentName ServiceAttachmentLinkAsServiceAttachmentName
                {
                    get => string.IsNullOrEmpty(ServiceAttachmentLink) ? null : ServiceAttachmentName.Parse(ServiceAttachmentLink, allowUnparsed: true);
                    set => ServiceAttachmentLink = value?.ToString() ?? "";
                }
            }
