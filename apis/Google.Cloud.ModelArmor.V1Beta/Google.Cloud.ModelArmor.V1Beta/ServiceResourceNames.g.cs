...
using gcmv = Google.Cloud.ModelArmor.V1Beta;
using sys = System;
...
namespace Google.Cloud.ModelArmor.V1Beta
{
    ...
    /// <summary>Resource name for the <c>FloorSetting</c> resource.</summary>
    public sealed partial class FloorSettingName : gax::IResourceName, sys::IEquatable<FloorSettingName>
    {
        /// <summary>The possible contents of <see cref="FloorSettingName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/floorSetting</c>.
            /// </summary>
            ProjectLocation = 1,

            /// <summary>
            /// A resource name with pattern <c>folders/{folder}/locations/{location}/floorSetting</c>.
            /// </summary>
            FolderLocation = 2,

            /// <summary>
            /// A resource name with pattern <c>organizations/{organization}/locations/{location}/floorSetting</c>.
            /// </summary>
            OrganizationLocation = 3,
        }

        private static gax::PathTemplate s_projectLocation = new gax::PathTemplate("projects/{project}/locations/{location}/floorSetting");

        private static gax::PathTemplate s_folderLocation = new gax::PathTemplate("folders/{folder}/locations/{location}/floorSetting");

        private static gax::PathTemplate s_organizationLocation = new gax::PathTemplate("organizations/{organization}/locations/{location}/floorSetting");

        /// <summary>Creates a <see cref="FloorSettingName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="FloorSettingName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static FloorSettingName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new FloorSettingName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="FloorSettingName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/floorSetting</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="FloorSettingName"/> constructed from the provided ids.</returns>
        public static FloorSettingName FromProjectLocation(string projectId, string locationId) =>
            new FloorSettingName(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)));

        /// <summary>
        /// Creates a <see cref="FloorSettingName"/> with the pattern
        /// <c>folders/{folder}/locations/{location}/floorSetting</c>.
        /// </summary>
        /// <param name="folderId">The <c>Folder</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="FloorSettingName"/> constructed from the provided ids.</returns>
        public static FloorSettingName FromFolderLocation(string folderId, string locationId) =>
            new FloorSettingName(ResourceNameType.FolderLocation, folderId: gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)));

        /// <summary>
        /// Creates a <see cref="FloorSettingName"/> with the pattern
        /// <c>organizations/{organization}/locations/{location}/floorSetting</c>.
        /// </summary>
        /// <param name="organizationId">The <c>Organization</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="FloorSettingName"/> constructed from the provided ids.</returns>
        public static FloorSettingName FromOrganizationLocation(string organizationId, string locationId) =>
            new FloorSettingName(ResourceNameType.OrganizationLocation, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="FloorSettingName"/> with pattern
        /// <c>projects/{project}/locations/{location}/floorSetting</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="FloorSettingName"/> with pattern
        /// <c>projects/{project}/locations/{location}/floorSetting</c>.
        /// </returns>
        ...
        /// <summary>Parses the given resource name string into a new <see cref="FloorSettingName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>projects/{project}/locations/{location}/floorSetting</c></description></item>
        /// <item><description><c>folders/{folder}/locations/{location}/floorSetting</c></description></item>
        /// <item>
        /// <description><c>organizations/{organization}/locations/{location}/floorSetting</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        /// <param name="floorSettingName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="FloorSettingName"/> if successful.</returns>
        public static FloorSettingName Parse(string floorSettingName) => Parse(floorSettingName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="FloorSettingName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        public static FloorSettingName Parse(string floorSettingName, bool allowUnparsed) =>
            TryParse(floorSettingName, allowUnparsed, out FloorSettingName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="FloorSettingName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="floorSettingName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="FloorSettingName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string floorSettingName, out FloorSettingName result) =>
            TryParse(floorSettingName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="FloorSettingName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        {
            gax::GaxPreconditions.CheckNotNull(floorSettingName, nameof(floorSettingName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocation.TryParseName(floorSettingName, out resourceName))
            {
                result = FromProjectLocation(resourceName[0], resourceName[1]);
                return true;
            }
            if (s_folderLocation.TryParseName(floorSettingName, out resourceName))
            {
                result = FromFolderLocation(resourceName[0], resourceName[1]);
                return true;
            }
            if (s_organizationLocation.TryParseName(floorSettingName, out resourceName))
            {
            ...
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(floorSettingName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private FloorSettingName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string folderId = null, string locationId = null, string organizationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            FolderId = folderId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="FloorSettingName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/floorSetting</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        public FloorSettingName(string projectId, string locationId) : this(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as FloorSettingName);

        /// <inheritdoc/>
        public bool Equals(FloorSettingName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(FloorSettingName a, FloorSettingName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(FloorSettingName a, FloorSettingName b) => !(a == b);
    }

    public partial class Template
    {
        /// <summary>
        /// <see cref="gcmv::TemplateName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcmv::TemplateName TemplateName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcmv::TemplateName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class FloorSetting
    {
        /// <summary>
        /// <see cref="gcmv::FloorSettingName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcmv::FloorSettingName FloorSettingName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcmv::FloorSettingName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }
    ...
    public partial class GetFloorSettingRequest
    {
        /// <summary>
        /// <see cref="gcmv::FloorSettingName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class SanitizeUserPromptRequest
    {
        /// <summary>
        /// <see cref="gcmv::TemplateName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class SanitizeModelResponseRequest
    {
        /// <summary>
        /// <see cref="gcmv::TemplateName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
