...
namespace Google.Cloud.DataCatalog.V1
{
    ...
    public abstract partial class PolicyTagManagerSerializationClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(PolicyTagManagerSerialization.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
