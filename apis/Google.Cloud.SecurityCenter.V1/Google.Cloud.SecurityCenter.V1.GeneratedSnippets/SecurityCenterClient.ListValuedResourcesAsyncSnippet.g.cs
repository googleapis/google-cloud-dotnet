...
{
    // [START securitycenter_v1_generated_SecurityCenter_ListValuedResources_async_flattened]
    ...
    public sealed partial class GeneratedSecurityCenterClientSnippets
    {
        ...
        public async Task ListValuedResourcesAsync()
        {
            ...
            await foreach (ValuedResource item in response)
            {
            ...
            await foreach (ListValuedResourcesResponse page in response.AsRawResponses())
            {
    ...
    // [END securitycenter_v1_generated_SecurityCenter_ListValuedResources_async_flattened]
}
