...
{
    // [START securitycenter_v1_generated_SecurityCenter_ListResourceValueConfigs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSecurityCenterClientSnippets
    {
        ...
        public async Task ListResourceValueConfigsResourceNamesAsync()
        {
            ...
            await foreach (ResourceValueConfig item in response)
            {
            ...
            await foreach (ListResourceValueConfigsResponse page in response.AsRawResponses())
            {
    ...
    // [END securitycenter_v1_generated_SecurityCenter_ListResourceValueConfigs_async_flattened_resourceNames]
}
