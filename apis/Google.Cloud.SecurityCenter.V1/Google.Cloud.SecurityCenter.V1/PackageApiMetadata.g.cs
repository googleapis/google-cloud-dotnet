            ...
            {
                {
                    ...
                    proto::ByteString.FromBase64("Ii4vdjEve25hbWU9b3JnYW5pemF0aW9ucy8qL29wZXJhdGlvbnMvKn06Y2FuY2Vs")
                },
                {
                    "google.longrunning.Operations.DeleteOperation",
                    // { "delete": "/v1/{name=organizations/*/operations/*}" }
                    proto::ByteString.FromBase64("KicvdjEve25hbWU9b3JnYW5pemF0aW9ucy8qL29wZXJhdGlvbnMvKn0=")
                },
                {
                    "google.longrunning.Operations.GetOperation",
                    // { "get": "/v1/{name=organizations/*/operations/*}" }
                    proto::ByteString.FromBase64("EicvdjEve25hbWU9b3JnYW5pemF0aW9ucy8qL29wZXJhdGlvbnMvKn0=")
                },
                {
                    "google.longrunning.Operations.ListOperations",
                    // { "get": "/v1/{name=organizations/*/operations}" }
                    proto::ByteString.FromBase64("EiUvdjEve25hbWU9b3JnYW5pemF0aW9ucy8qL29wZXJhdGlvbnN9")
                },
            });
