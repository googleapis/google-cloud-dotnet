...
{
    // [START spanner_v1_generated_Spanner_BatchWrite_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSpannerClientSnippets
    {
        ...
        public async Task BatchWriteResourceNames()
        {
            ...
            IEnumerable<BatchWriteRequest.Types.MutationGroup> mutationGroups = new BatchWriteRequest.Types.MutationGroup[]
            {
                new BatchWriteRequest.Types.MutationGroup(),
            };
            // Make the request, returning a streaming response
            using SpannerClient.BatchWriteStream response = spannerClient.BatchWrite(session, mutationGroups);
    ...
    // [END spanner_v1_generated_Spanner_BatchWrite_sync_flattened_resourceNames]
}
