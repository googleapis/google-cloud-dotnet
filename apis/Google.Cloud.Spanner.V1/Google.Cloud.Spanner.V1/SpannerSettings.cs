...
namespace Google.Cloud.Spanner.V1
{
    ...
    public partial class SpannerSettings
    {
        /// <summary>
        ...
        /// <summary>
        /// In previous releases, this property returned a filter used by default for "LongRunning" RPC methods.
        /// It is now unused, and may not represent the current default behavior.
        /// </summary>
        [Obsolete("This member is no longer called by other code in this library. Please use the individual CallSettings properties.")]
        ...
        /// <summary>
        /// In previous releases, this method returned the backoff used by default for "Streaming" RPC methods.
        /// It is now unused, and may not represent the current default behavior.
        /// </summary>
        [Obsolete("This member is no longer called by other code in this library. Please use the individual CallSettings properties.")]
        ...
        /// <summary>
        /// In previous releases, this method returned the backoff used by default for "LongRunning" RPC methods.
        /// It is now unused, and may not represent the current default behavior.
        /// </summary>
        [Obsolete("This member is no longer called by other code in this library. Please use the individual CallSettings properties.")]
