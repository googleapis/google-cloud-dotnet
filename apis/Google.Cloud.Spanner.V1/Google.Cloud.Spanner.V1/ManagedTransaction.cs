...
namespace Google.Cloud.Spanner.V1
{
    ...
    public partial class ManagedTransaction
    {
        ...
        /// <summary>
        /// The Spanner session resource associated to managed transaction.
        /// Won't be null.
        /// </summary>
        internal Session Session => _multiplexSession;
        ...
        private SpannerClient Client => _client;

        /// <summary>
        /// Whether the transaction is single use or not.
        ...
        /// </item>
        /// <item>
        /// The managed transaction has been created with some transaction options but no command execution has
        ...
        internal ManagedTransaction(ManagedSession managedSession, ByteString transactionId, TransactionOptions transactionOptions, bool singleUseTransaction, Timestamp readTimestamp)
        {
            _multiplexSession = managedSession.Session;
            _client = managedSession.Client;
            _timeout = managedSession.Options.Timeout;
            ...
            Mutation mutationKey = null)
        {
            ...
            async Task<Transaction> BeginTransactionAsync(CancellationToken cancellationToken, Mutation mutationKey = null)
            {
                ...
                var callSettings = Client.Settings.BeginTransactionSettings
                    .WithExpiration(Expiration.FromTimeout(_timeout))
        ...
        public Task<CommitResponse> CommitAsync(CommitRequest request, CallSettings callSettings)
        {
            ...
            return ExecuteMaybeWithTransactionSelectorAsync(
                ...
                mutationKey: request.Mutations.Count > 0 ? MaybeFetchMutationKey(request.Mutations) : null);
            ...
            Mutation MaybeFetchMutationKey(Protobuf.Collections.RepeatedField<Mutation> mutations)
            {
                ...
                // 1. It is not a Delete mutation (MutationCase != MutationType.Delete)
                // OR
        ...
        /// Will be modified to include session information from this managed transaction.
        /// May be modified to include transaction and directed read options information
        /// from this managed transaction and its underlying <see cref="SpannerClient"/>.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A <see cref="ReliableStreamReader"/> for the streaming SQL request.</returns>
        public ReliableStreamReader ReadStreamReaderAsync(ReadRequest request, CallSettings callSettings) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A <see cref="ReliableStreamReader"/> for the streaming SQL request.</returns>
        public ReliableStreamReader ExecuteSqlStreamReaderAsync(ExecuteSqlRequest request, CallSettings callSettings) =>
            ExecuteReadOrQueryStreamReader(ReadOrQueryRequest.FromRequest(request), callSettings);
        ...
        public Task<ResultSet> ExecuteSqlAsync(ExecuteSqlRequest request, CallSettings callSettings)
        {
            ...
            // This needs to be made async now with multiplex sessions as we need to check/update the Precommit token
