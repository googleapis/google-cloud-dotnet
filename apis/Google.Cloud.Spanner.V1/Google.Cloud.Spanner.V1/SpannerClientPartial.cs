...
namespace Google.Cloud.Spanner.V1
{
    ...
    public partial class SpannerClientImpl
    {
        ...
        {
            var requestId = _requestIdSource.ForNewRequest();
            ...
            var newSettings = CallSettings.FromHeaderMutation(metadata => metadata.Add(RequestId.HeaderKey, requestId.IncrementAttempt().ToString()));
