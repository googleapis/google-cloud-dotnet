...
namespace Google.Cloud.Spanner.V1
{
    ...
    public partial class SpannerClientImpl
    {
        ...
        /// </summary>
        private SpannerRequestId.Source _requestIdSource;

        /// <summary>
        /// The process ID, assigned to each outgoing request in the x-goog-spanner-request-id header.
        /// This can be overridden, but only before it has been accessed.
        /// </summary>
        public string ProcessId
        {
            get => SpannerRequestId.ProcessId;
            set => SpannerRequestId.ProcessId = value;
        }
        ...
        partial void OnConstruction(Spanner.SpannerClient grpcClient, SpannerSettings effectiveSettings, ClientHelper clientHelper)
        {
            ...
            _requestIdSource = new SpannerRequestId.Source();
        }
        ...
        {
            var requestId = _requestIdSource.Next();
