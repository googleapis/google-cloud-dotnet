...
{
    // [START cloud_generated_Locations_ListLocations_async]
    using Google.Api.Gax;
    using Google.Cloud.Location;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedLocationsClientSnippets
    {
        ...
        public async Task ListLocationsRequestObjectAsync()
        {
            ...
            await foreach (Location item in response)
            {
            ...
            await foreach (ListLocationsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloud_generated_Locations_ListLocations_async]
}
