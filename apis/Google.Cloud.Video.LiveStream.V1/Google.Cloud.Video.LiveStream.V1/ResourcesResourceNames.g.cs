...
namespace Google.Cloud.Video.LiveStream.V1
{
    ...
    /// <summary>Resource name for the <c>DvrSession</c> resource.</summary>
    public sealed partial class DvrSessionName : gax::IResourceName, sys::IEquatable<DvrSessionName>
    {
        /// <summary>The possible contents of <see cref="DvrSessionName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/channels/{channel}/dvrSessions/{dvr_session}</c>.
            /// </summary>
            ProjectLocationChannelDvrSession = 1,
        }

        private static gax::PathTemplate s_projectLocationChannelDvrSession = new gax::PathTemplate("projects/{project}/locations/{location}/channels/{channel}/dvrSessions/{dvr_session}");

        /// <summary>Creates a <see cref="DvrSessionName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="DvrSessionName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static DvrSessionName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new DvrSessionName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="DvrSessionName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/channels/{channel}/dvrSessions/{dvr_session}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="channelId">The <c>Channel</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="dvrSessionId">The <c>DvrSession</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="DvrSessionName"/> constructed from the provided ids.</returns>
        public static DvrSessionName FromProjectLocationChannelDvrSession(string projectId, string locationId, string channelId, string dvrSessionId) =>
            new DvrSessionName(ResourceNameType.ProjectLocationChannelDvrSession, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), channelId: gax::GaxPreconditions.CheckNotNullOrEmpty(channelId, nameof(channelId)), dvrSessionId: gax::GaxPreconditions.CheckNotNullOrEmpty(dvrSessionId, nameof(dvrSessionId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="DvrSessionName"/> with pattern
        /// <c>projects/{project}/locations/{location}/channels/{channel}/dvrSessions/{dvr_session}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <param name="dvrSessionId">The <c>DvrSession</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="DvrSessionName"/> with pattern
        /// <c>projects/{project}/locations/{location}/channels/{channel}/dvrSessions/{dvr_session}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string channelId, string dvrSessionId) =>
            FormatProjectLocationChannelDvrSession(projectId, locationId, channelId, dvrSessionId);
        ...
        /// <c>projects/{project}/locations/{location}/channels/{channel}/dvrSessions/{dvr_session}</c>.
        /// </returns>
        public static string FormatProjectLocationChannelDvrSession(string projectId, string locationId, string channelId, string dvrSessionId) =>
            s_projectLocationChannelDvrSession.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(channelId, nameof(channelId)), gax::GaxPreconditions.CheckNotNullOrEmpty(dvrSessionId, nameof(dvrSessionId)));

        /// <summary>Parses the given resource name string into a new <see cref="DvrSessionName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        ...
        /// </list>
        /// </remarks>
        /// <param name="dvrSessionName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="DvrSessionName"/> if successful.</returns>
        public static DvrSessionName Parse(string dvrSessionName) => Parse(dvrSessionName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="DvrSessionName"/> instance; optionally allowing
        ...
        /// </param>
        /// <returns>The parsed <see cref="DvrSessionName"/> if successful.</returns>
        public static DvrSessionName Parse(string dvrSessionName, bool allowUnparsed) =>
            TryParse(dvrSessionName, allowUnparsed, out DvrSessionName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="DvrSessionName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="dvrSessionName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="DvrSessionName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string dvrSessionName, out DvrSessionName result) =>
            TryParse(dvrSessionName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="DvrSessionName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string dvrSessionName, bool allowUnparsed, out DvrSessionName result)
        {
            gax::GaxPreconditions.CheckNotNull(dvrSessionName, nameof(dvrSessionName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationChannelDvrSession.TryParseName(dvrSessionName, out resourceName))
            {
                result = FromProjectLocationChannelDvrSession(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(dvrSessionName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private DvrSessionName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string channelId = null, string dvrSessionId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            ChannelId = channelId;
            DvrSessionId = dvrSessionId;
            LocationId = locationId;
            ProjectId = projectId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="DvrSessionName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/channels/{channel}/dvrSessions/{dvr_session}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="channelId">The <c>Channel</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="dvrSessionId">The <c>DvrSession</c> ID. Must not be <c>null</c> or empty.</param>
        public DvrSessionName(string projectId, string locationId, string channelId, string dvrSessionId) : this(ResourceNameType.ProjectLocationChannelDvrSession, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), channelId: gax::GaxPreconditions.CheckNotNullOrEmpty(channelId, nameof(channelId)), dvrSessionId: gax::GaxPreconditions.CheckNotNullOrEmpty(dvrSessionId, nameof(dvrSessionId)))
        {
        }
        ...
        /// <summary>
        /// The <c>DvrSession</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource name.
        /// </summary>
        public string DvrSessionId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationChannelDvrSession: return s_projectLocationChannelDvrSession.Expand(ProjectId, LocationId, ChannelId, DvrSessionId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as DvrSessionName);

        /// <inheritdoc/>
        public bool Equals(DvrSessionName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(DvrSessionName a, DvrSessionName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(DvrSessionName a, DvrSessionName b) => !(a == b);
    }
    ...
    public partial class DvrSession
    {
        /// <summary>
