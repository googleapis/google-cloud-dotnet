...
{
    // [START storage_v2_generated_StorageControl_GetIntelligenceFinding_async_flattened]
    ...
    public sealed partial class GeneratedStorageControlClientSnippets
    {
        ...
        public async Task GetIntelligenceFindingAsync()
        {
            ...
            // Make the request
            IntelligenceFinding response = await storageControlClient.GetIntelligenceFindingAsync(name);
        }
    }
    // [END storage_v2_generated_StorageControl_GetIntelligenceFinding_async_flattened]
}
