...
{
    // [START storage_v2_generated_StorageControl_SummarizeIntelligenceFindings_sync_flattened]
    ...
    public sealed partial class GeneratedStorageControlClientSnippets
    {
        ...
        public void SummarizeIntelligenceFindings()
        {
            ...
            string parent = "";
            // Make the request
            PagedEnumerable<SummarizeIntelligenceFindingsResponse, FindingSummary> response = storageControlClient.SummarizeIntelligenceFindings(parent);
            ...
            foreach (SummarizeIntelligenceFindingsResponse page in response.AsRawResponses())
            {
    ...
    // [END storage_v2_generated_StorageControl_SummarizeIntelligenceFindings_sync_flattened]
}
