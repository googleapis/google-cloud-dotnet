...
{
    // [START storage_v2_generated_StorageControl_GetRapidCache_async_flattened]
    ...
    public sealed partial class GeneratedStorageControlClientSnippets
    {
        ...
        public async Task GetRapidCacheAsync()
        {
            ...
            // Make the request
            RapidCache response = await storageControlClient.GetRapidCacheAsync(name);
        }
    }
    // [END storage_v2_generated_StorageControl_GetRapidCache_async_flattened]
}
