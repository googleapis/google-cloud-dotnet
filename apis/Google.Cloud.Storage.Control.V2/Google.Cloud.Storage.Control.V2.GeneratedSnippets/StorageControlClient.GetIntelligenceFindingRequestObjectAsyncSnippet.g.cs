...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedStorageControlClientSnippets
    {
        ...
        public async Task GetIntelligenceFindingRequestObjectAsync()
        {
            ...
            GetIntelligenceFindingRequest request = new GetIntelligenceFindingRequest
            {
                IntelligenceFindingName = IntelligenceFindingName.FromProjectLocationIntelligenceFinding("[PROJECT]", "[LOCATION]", "[INTELLIGENCE_FINDING]"),
            };
            // Make the request
            IntelligenceFinding response = await storageControlClient.GetIntelligenceFindingAsync(request);
        }
    }
