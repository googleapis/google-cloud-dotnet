...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedStorageControlClientSnippets
    {
        ...
        public void GetIntelligenceFindingRevisionRequestObject()
        {
            ...
            GetIntelligenceFindingRevisionRequest request = new GetIntelligenceFindingRevisionRequest
            {
                IntelligenceFindingRevisionName = IntelligenceFindingRevisionName.FromProjectLocationIntelligenceFindingRevision("[PROJECT]", "[LOCATION]", "[INTELLIGENCE_FINDING]", "[REVISION]"),
            };
            // Make the request
            IntelligenceFindingRevision response = storageControlClient.GetIntelligenceFindingRevision(request);
        }
    }
