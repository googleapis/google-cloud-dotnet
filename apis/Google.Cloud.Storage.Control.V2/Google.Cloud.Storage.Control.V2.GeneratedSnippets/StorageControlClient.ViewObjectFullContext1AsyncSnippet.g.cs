...
{
    // [START storage_v2_generated_StorageControl_ViewObjectFullContext_async_flattened1]
    ...
    public sealed partial class GeneratedStorageControlClientSnippets
    {
        ...
        public async Task ViewObjectFullContext1Async()
        {
            ...
            string contextKey = "";
            // Make the request
            ObjectFullContext response = await storageControlClient.ViewObjectFullContextAsync(name, contextKey);
        }
    }
    // [END storage_v2_generated_StorageControl_ViewObjectFullContext_async_flattened1]
}
