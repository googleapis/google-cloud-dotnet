...
{
    // [START storage_v2_generated_StorageControl_UpdateManagedFolder_async_flattened]
    ...
    public sealed partial class GeneratedStorageControlClientSnippets
    {
        ...
        public async Task UpdateManagedFolderAsync()
        {
            ...
            // Make the request
            ManagedFolder response = await storageControlClient.UpdateManagedFolderAsync(managedFolder, updateMask);
        }
    }
    // [END storage_v2_generated_StorageControl_UpdateManagedFolder_async_flattened]
}
