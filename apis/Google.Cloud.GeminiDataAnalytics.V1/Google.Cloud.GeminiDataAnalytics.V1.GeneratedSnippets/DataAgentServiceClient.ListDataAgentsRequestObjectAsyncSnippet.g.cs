...
{
    // [START geminidataanalytics_v1_generated_DataAgentService_ListDataAgents_async]
    using Google.Api.Gax;
    using Google.Api.Gax.ResourceNames;
    using Google.Cloud.GeminiDataAnalytics.V1;
    using System;
    ...
    public sealed partial class GeneratedDataAgentServiceClientSnippets
    {
        ...
        public async Task ListDataAgentsRequestObjectAsync()
        {
            ...
            await foreach (ListDataAgentsResponse page in response.AsRawResponses())
            {
    ...
    // [END geminidataanalytics_v1_generated_DataAgentService_ListDataAgents_async]
}
