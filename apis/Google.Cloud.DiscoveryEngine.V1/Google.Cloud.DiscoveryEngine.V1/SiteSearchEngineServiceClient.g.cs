...
namespace Google.Cloud.DiscoveryEngine.V1
{
    ...
    public abstract partial class SiteSearchEngineServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(SiteSearchEngineService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
