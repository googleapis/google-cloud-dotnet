...
{
    // [START discoveryengine_v1_generated_ConversationalSearchService_ListSessions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedConversationalSearchServiceClientSnippets
    {
        ...
        public async Task ListSessionsResourceNamesAsync()
        {
            ...
            await foreach (Session item in response)
            {
            ...
            await foreach (ListSessionsResponse page in response.AsRawResponses())
            {
    ...
    // [END discoveryengine_v1_generated_ConversationalSearchService_ListSessions_async_flattened_resourceNames]
}
