...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedDataformClientSnippets
    {
        ...
        public async Task DeleteFolderTreeRequestObjectAsync()
        {
            ...
            DeleteFolderTreeRequest request = new DeleteFolderTreeRequest
            {
                FolderName = FolderName.FromProjectLocationFolder("[PROJECT]", "[LOCATION]", "[FOLDER]"),
                Force = false,
            };
            // Make the request
            Operation<Empty, DeleteFolderTreeMetadata> response = await dataformClient.DeleteFolderTreeAsync(request);
