...
{
    // [START dataform_v1_generated_Dataform_GetFolder_async_flattened]
    ...
    public sealed partial class GeneratedDataformClientSnippets
    {
        ...
        public async Task GetFolderAsync()
        {
            ...
            // Make the request
            Folder response = await dataformClient.GetFolderAsync(name);
        }
    }
    // [END dataform_v1_generated_Dataform_GetFolder_async_flattened]
}
