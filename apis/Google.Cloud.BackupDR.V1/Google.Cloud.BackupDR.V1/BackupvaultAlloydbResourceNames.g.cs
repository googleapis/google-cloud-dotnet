...
namespace Google.Cloud.BackupDR.V1
{
    ...
    public partial class AlloyDBClusterDataSourceProperties
    {
        /// <summary>
        /// <see cref="gcbv::ClusterName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcbv::ClusterName ClusterName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcbv::ClusterName.Parse(Name, allowUnparsed: true);
