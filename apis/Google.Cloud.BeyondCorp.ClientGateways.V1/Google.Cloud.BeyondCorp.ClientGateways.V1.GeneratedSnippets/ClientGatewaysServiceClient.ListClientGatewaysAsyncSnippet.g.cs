...
{
    // [START beyondcorp_v1_generated_ClientGatewaysService_ListClientGateways_async_flattened]
    ...
    public sealed partial class GeneratedClientGatewaysServiceClientSnippets
    {
        ...
        public async Task ListClientGatewaysAsync()
        {
            ...
            await foreach (ClientGateway item in response)
            {
            ...
            await foreach (ListClientGatewaysResponse page in response.AsRawResponses())
            {
    ...
    // [END beyondcorp_v1_generated_ClientGatewaysService_ListClientGateways_async_flattened]
}
