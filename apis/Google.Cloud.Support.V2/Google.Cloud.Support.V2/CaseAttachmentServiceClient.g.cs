...
namespace Google.Cloud.Support.V2
{
    ...
    public sealed partial class CaseAttachmentServiceClientBuilder : gaxgrpc::ClientBuilderBase<CaseAttachmentServiceClient>
    {
        ...
        private CaseAttachmentServiceClient BuildImpl()
        {
            ...
            return CaseAttachmentServiceClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class CaseAttachmentServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(CaseAttachmentService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
