...
{
    // [START binaryauthorization_v1beta1_generated_BinauthzManagementServiceV1Beta1_ListAttestors_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedBinauthzManagementServiceV1Beta1ClientSnippets
    {
        ...
        public async Task ListAttestorsResourceNamesAsync()
        {
            ...
            await foreach (Attestor item in response)
            {
            ...
            await foreach (ListAttestorsResponse page in response.AsRawResponses())
            {
    ...
    // [END binaryauthorization_v1beta1_generated_BinauthzManagementServiceV1Beta1_ListAttestors_async_flattened_resourceNames]
}
