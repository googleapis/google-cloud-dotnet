...
{
    // [START kmsinventory_v1_generated_KeyDashboardService_ListCryptoKeys_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedKeyDashboardServiceClientSnippets
    {
        ...
        public async Task ListCryptoKeysResourceNamesAsync()
        {
            ...
            await foreach (gckv::CryptoKey item in response)
            {
            ...
            await foreach (ListCryptoKeysResponse page in response.AsRawResponses())
            {
    ...
    // [END kmsinventory_v1_generated_KeyDashboardService_ListCryptoKeys_async_flattened_resourceNames]
}
