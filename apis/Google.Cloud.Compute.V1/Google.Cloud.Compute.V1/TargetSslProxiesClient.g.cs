...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class TargetSslProxiesClientBuilder : gaxgrpc::ClientBuilderBase<TargetSslProxiesClient>
    {
        ...
        private TargetSslProxiesClient BuildImpl()
        {
            ...
            return TargetSslProxiesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class TargetSslProxiesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(TargetSslProxies.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
