...
namespace Google.Cloud.Compute.V1
{
    ...
    public abstract partial class MachineTypesClient
    {
        ...
        /// <returns>
        /// A pageable sequence of <see cref="scg::KeyValuePair{string,MachineTypesScopedList}"/> resources.
        /// </returns>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>
        /// A pageable asynchronous sequence of <see cref="scg::KeyValuePair{string,MachineTypesScopedList}"/>
        /// resources.
        /// </returns>
