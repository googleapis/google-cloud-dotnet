...
namespace Google.Cloud.Compute.V1
{
    ...
    public static partial class GlobalOperations
    {
        public partial class GlobalOperationsClient
        {
            ...
            {
                grpccore::CallInvoker forwardingCallInvoker = ForwardingCallInvoker<lro::GetOperationRequest>.Create(callInvoker, "/google.longrunning.Operations/GetOperation", __Method_Get, GetGlobalOperationRequest.ParseLroRequest, (request, response) => response.ToLroResponse(request.Name));
