...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class DiskTypesClientBuilder : gaxgrpc::ClientBuilderBase<DiskTypesClient>
    {
        ...
        private DiskTypesClient BuildImpl()
        {
            ...
            return DiskTypesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class DiskTypesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(DiskTypes.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
