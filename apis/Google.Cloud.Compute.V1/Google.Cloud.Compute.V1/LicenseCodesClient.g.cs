...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class LicenseCodesClientBuilder : gaxgrpc::ClientBuilderBase<LicenseCodesClient>
    {
        ...
        private LicenseCodesClient BuildImpl()
        {
            ...
            return LicenseCodesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class LicenseCodesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(LicenseCodes.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
