...
namespace Google.Cloud.Compute.V1
{
    ...
    public abstract partial class NetworkEdgeSecurityServicesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(NetworkEdgeSecurityServices.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
