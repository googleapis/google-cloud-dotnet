...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class RegionHealthChecksClientBuilder : gaxgrpc::ClientBuilderBase<RegionHealthChecksClient>
    {
        ...
        private RegionHealthChecksClient BuildImpl()
        {
            ...
            return RegionHealthChecksClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class RegionHealthChecksClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(RegionHealthChecks.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
