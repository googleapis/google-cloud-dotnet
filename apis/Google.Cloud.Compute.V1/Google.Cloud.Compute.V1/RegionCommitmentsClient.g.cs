...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class RegionCommitmentsClientBuilder : gaxgrpc::ClientBuilderBase<RegionCommitmentsClient>
    {
        ...
        private RegionCommitmentsClient BuildImpl()
        {
            ...
            return RegionCommitmentsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class RegionCommitmentsClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(RegionCommitments.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
