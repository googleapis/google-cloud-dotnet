...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class TargetInstancesClientBuilder : gaxgrpc::ClientBuilderBase<TargetInstancesClient>
    {
        ...
        private TargetInstancesClient BuildImpl()
        {
            ...
            return TargetInstancesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class TargetInstancesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(TargetInstances.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
