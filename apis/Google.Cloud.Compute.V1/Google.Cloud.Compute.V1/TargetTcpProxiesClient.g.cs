...
namespace Google.Cloud.Compute.V1
{
    ...
    public abstract partial class TargetTcpProxiesClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual TargetTcpProxyList List(ListTargetTcpProxiesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<TargetTcpProxyList> ListAsync(ListTargetTcpProxiesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<TargetTcpProxyList> ListAsync(ListTargetTcpProxiesRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual TargetTcpProxyList List(string project, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<TargetTcpProxyList> ListAsync(string project, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<TargetTcpProxyList> ListAsync(string project, st::CancellationToken cancellationToken) =>
    ...
    public sealed partial class TargetTcpProxiesClientImpl : TargetTcpProxiesClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override TargetTcpProxyList List(ListTargetTcpProxiesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<TargetTcpProxyList> ListAsync(ListTargetTcpProxiesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListTargetTcpProxiesRequest(ref request, ref callSettings);
