...
namespace Google.Cloud.Compute.V1
{
    ...
    public static partial class GlobalOrganizationOperations
    {
        public partial class GlobalOrganizationOperationsClient
        {
            ...
            {
                grpccore::CallInvoker forwardingCallInvoker = ForwardingCallInvoker<lro::GetOperationRequest>.Create(callInvoker, "/google.longrunning.Operations/GetOperation", __Method_Get, GetGlobalOrganizationOperationRequest.ParseLroRequest, (request, response) => response.ToLroResponse(request.Name));
