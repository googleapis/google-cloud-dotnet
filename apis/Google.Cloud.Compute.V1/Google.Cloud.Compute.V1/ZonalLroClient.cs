...
namespace Google.Cloud.Compute.V1
{
    ...
    internal class ZonalLroClient : lro::OperationsClient
    {
        internal static PathTemplate NameTemplate { get; } = new PathTemplate("projects/{project}/zones/{zone}/operations/{operation}");
        private readonly ZoneOperationsClient _client;
        ...
        internal ZonalLroClient(ZoneOperations.ZoneOperationsClient grpcClient, OperationsSettings settings)
        {
            settings = settings ?? OperationsSettings.GetDefault();
            _getSettings = settings.GetOperationSettings;
            _client = new ZoneOperationsClientImpl(grpcClient, new ZoneOperationsSettings
            {
                // General settings
        ...
        public override lro.Operation GetOperation(GetOperationRequest request, CallSettings callSettings = null)
        {
            ...
            var computeRequest = new GetZoneOperationRequest
            {
