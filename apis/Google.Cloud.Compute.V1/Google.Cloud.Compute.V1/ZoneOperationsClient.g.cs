...
namespace Google.Cloud.Compute.V1
{
    ...
    public static partial class ZoneOperations
    {
        public partial class ZoneOperationsClient
        {
            ...
            {
                grpccore::CallInvoker forwardingCallInvoker = ForwardingCallInvoker<lro::GetOperationRequest>.Create(callInvoker, "/google.longrunning.Operations/GetOperation", __Method_Get, GetZoneOperationRequest.ParseLroRequest, (request, response) => response.ToLroResponse(request.Name));
