...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class NetworkFirewallPoliciesClientBuilder : gaxgrpc::ClientBuilderBase<NetworkFirewallPoliciesClient>
    {
        ...
        private NetworkFirewallPoliciesClient BuildImpl()
        {
            ...
            return NetworkFirewallPoliciesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class NetworkFirewallPoliciesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(NetworkFirewallPolicies.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
