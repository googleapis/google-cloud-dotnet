...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class AutoscalersClientBuilder : gaxgrpc::ClientBuilderBase<AutoscalersClient>
    {
        ...
        private AutoscalersClient BuildImpl()
        {
            ...
            return AutoscalersClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class AutoscalersClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Autoscalers.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
