...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class NodeGroupsClientBuilder : gaxgrpc::ClientBuilderBase<NodeGroupsClient>
    {
        ...
        private NodeGroupsClient BuildImpl()
        {
            ...
            return NodeGroupsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class NodeGroupsClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(NodeGroups.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
