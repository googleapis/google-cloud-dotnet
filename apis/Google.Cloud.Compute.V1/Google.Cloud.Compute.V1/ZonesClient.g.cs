...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class ZonesClientBuilder : gaxgrpc::ClientBuilderBase<ZonesClient>
    {
        ...
        private ZonesClient BuildImpl()
        {
            ...
            return ZonesClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ZonesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(Zones.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
