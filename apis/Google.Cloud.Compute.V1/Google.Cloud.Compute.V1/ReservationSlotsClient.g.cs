...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class ReservationSlotsSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <c>ReservationSlotsClient.GetVersion</c> and <c>ReservationSlotsClient.GetVersionAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        ...
        /// <summary>
        /// Long Running Operation settings for calls to <c>ReservationSlotsClient.GetVersion</c> and
        /// <c>ReservationSlotsClient.GetVersionAsync</c>.
        /// </summary>
        /// <remarks>
    ...
    public abstract partial class ReservationSlotsClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> GetVersion(GetVersionReservationSlotRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> GetVersionAsync(GetVersionReservationSlotRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> GetVersionAsync(GetVersionReservationSlotRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// </param>
        /// <param name="reservationSlotsGetVersionRequestResource">
        /// The body resource for this request
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Operation, Operation> GetVersion(string project, string zone, string parentName, string reservationSlot, ReservationSlotsGetVersionRequest reservationSlotsGetVersionRequestResource, gaxgrpc::CallSettings callSettings = null) =>
            GetVersion(new GetVersionReservationSlotRequest
            {
                ParentName = gax::GaxPreconditions.CheckNotNullOrEmpty(parentName, nameof(parentName)),
                Project = gax::GaxPreconditions.CheckNotNullOrEmpty(project, nameof(project)),
                ReservationSlot = gax::GaxPreconditions.CheckNotNullOrEmpty(reservationSlot, nameof(reservationSlot)),
                ReservationSlotsGetVersionRequestResource = gax::GaxPreconditions.CheckNotNull(reservationSlotsGetVersionRequestResource, nameof(reservationSlotsGetVersionRequestResource)),
                Zone = gax::GaxPreconditions.CheckNotNullOrEmpty(zone, nameof(zone)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> GetVersionAsync(string project, string zone, string parentName, string reservationSlot, ReservationSlotsGetVersionRequest reservationSlotsGetVersionRequestResource, gaxgrpc::CallSettings callSettings = null) =>
            GetVersionAsync(new GetVersionReservationSlotRequest
            {
                ParentName = gax::GaxPreconditions.CheckNotNullOrEmpty(parentName, nameof(parentName)),
                Project = gax::GaxPreconditions.CheckNotNullOrEmpty(project, nameof(project)),
                ReservationSlot = gax::GaxPreconditions.CheckNotNullOrEmpty(reservationSlot, nameof(reservationSlot)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Operation, Operation>> GetVersionAsync(string project, string zone, string parentName, string reservationSlot, ReservationSlotsGetVersionRequest reservationSlotsGetVersionRequestResource, st::CancellationToken cancellationToken) =>
            GetVersionAsync(project, zone, parentName, reservationSlot, reservationSlotsGetVersionRequestResource, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    public sealed partial class ReservationSlotsClientImpl : ReservationSlotsClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Operation, Operation> GetVersion(GetVersionReservationSlotRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetVersionReservationSlotRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Operation, Operation>> GetVersionAsync(GetVersionReservationSlotRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetVersionReservationSlotRequest(ref request, ref callSettings);
