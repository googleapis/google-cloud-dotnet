...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class RegionSecurityPoliciesClientBuilder : gaxgrpc::ClientBuilderBase<RegionSecurityPoliciesClient>
    {
        ...
        public RegionSecurityPoliciesClientBuilder()
        {
            UseJwtAccessWithScopes = RegionSecurityPoliciesClient.UseJwtAccessWithScopes;
        }
        ...
        private RegionSecurityPoliciesClient BuildImpl()
        {
            ...
            return RegionSecurityPoliciesClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => RegionSecurityPoliciesClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => RegionSecurityPoliciesClient.DefaultScopes;
    ...
    public abstract partial class RegionSecurityPoliciesClient
    {
        ...
        /// <returns>The created <see cref="RegionSecurityPoliciesClient"/>.</returns>
        internal static RegionSecurityPoliciesClient Create(grpccore::CallInvoker callInvoker, RegionSecurityPoliciesSettings settings = null)
        {
            ...
            return new RegionSecurityPoliciesClientImpl(grpcClient, settings);
        }
    ...
    public sealed partial class RegionSecurityPoliciesClientImpl : RegionSecurityPoliciesClient
    {
        ...
        /// </param>
        public RegionSecurityPoliciesClientImpl(RegionSecurityPolicies.RegionSecurityPoliciesClient grpcClient, RegionSecurityPoliciesSettings settings)
        {
            ...
            _callGet = clientHelper.BuildApiCall<GetRegionSecurityPolicyRequest, SecurityPolicy>(grpcClient.GetAsync, grpcClient.Get, effectiveSettings.GetSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("security_policy", request => request.SecurityPolicy);
            Modify_ApiCall(ref _callGet);
            Modify_GetApiCall(ref _callGet);
            _callInsert = clientHelper.BuildApiCall<InsertRegionSecurityPolicyRequest, Operation>(grpcClient.InsertAsync, grpcClient.Insert, effectiveSettings.InsertSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region);
            Modify_ApiCall(ref _callInsert);
            Modify_InsertApiCall(ref _callInsert);
            _callList = clientHelper.BuildApiCall<ListRegionSecurityPoliciesRequest, SecurityPolicyList>(grpcClient.ListAsync, grpcClient.List, effectiveSettings.ListSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region);
            Modify_ApiCall(ref _callList);
            Modify_ListApiCall(ref _callList);
            _callPatch = clientHelper.BuildApiCall<PatchRegionSecurityPolicyRequest, Operation>(grpcClient.PatchAsync, grpcClient.Patch, effectiveSettings.PatchSettings).WithGoogleRequestParam("project", request => request.Project).WithGoogleRequestParam("region", request => request.Region).WithGoogleRequestParam("security_policy", request => request.SecurityPolicy);
