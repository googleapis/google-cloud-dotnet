...
namespace Google.Cloud.Compute.V1
{
    ...
    public sealed partial class RegionOperationsClientBuilder : gaxgrpc::ClientBuilderBase<RegionOperationsClient>
    {
        ...
        private RegionOperationsClient BuildImpl()
        {
            ...
            return RegionOperationsClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class RegionOperationsClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(RegionOperations.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
