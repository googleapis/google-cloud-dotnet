...
namespace Google.Cloud.Compute.V1
{
    ...
    public abstract partial class GlobalPublicDelegatedPrefixesClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(GlobalPublicDelegatedPrefixes.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
