...
namespace Google.Cloud.Compute.V1.Tests
{
    ...
    public sealed class GeneratedRegionSslPoliciesClientTest
    {
        [xunit::FactAttribute]
        public void GetRequestObject()
        {
            moq::Mock<RegionSslPolicies.RegionSslPoliciesClient> mockGrpcClient = new moq::Mock<RegionSslPolicies.RegionSslPoliciesClient>(moq::MockBehavior.Strict);
            ...
            RegionSslPoliciesClient client = new RegionSslPoliciesClientImpl(mockGrpcClient.Object, null, null);
        ...
        public void Get()
        {
            ...
            mockGrpcClient.Setup(x => x.Get(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            RegionSslPoliciesClient client = new RegionSslPoliciesClientImpl(mockGrpcClient.Object, null, null);
            SslPolicy response = client.Get(request.Project, request.Region, request.SslPolicy);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }
        ...
        public async stt::Task GetAsync()
        {
            ...
            mockGrpcClient.Setup(x => x.GetAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<SslPolicy>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            RegionSslPoliciesClient client = new RegionSslPoliciesClientImpl(mockGrpcClient.Object, null, null);
            SslPolicy responseCallSettings = await client.GetAsync(request.Project, request.Region, request.SslPolicy, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            SslPolicy responseCancellationToken = await client.GetAsync(request.Project, request.Region, request.SslPolicy, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void ListAvailableFeatures()
        {
            ...
            mockGrpcClient.Setup(x => x.ListAvailableFeatures(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            RegionSslPoliciesClient client = new RegionSslPoliciesClientImpl(mockGrpcClient.Object, null, null);
            SslPoliciesListAvailableFeaturesResponse response = client.ListAvailableFeatures(request.Project, request.Region);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }
        ...
        public async stt::Task ListAvailableFeaturesAsync()
        {
            ...
            mockGrpcClient.Setup(x => x.ListAvailableFeaturesAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<SslPoliciesListAvailableFeaturesResponse>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            RegionSslPoliciesClient client = new RegionSslPoliciesClientImpl(mockGrpcClient.Object, null, null);
            SslPoliciesListAvailableFeaturesResponse responseCallSettings = await client.ListAvailableFeaturesAsync(request.Project, request.Region, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            SslPoliciesListAvailableFeaturesResponse responseCancellationToken = await client.ListAvailableFeaturesAsync(request.Project, request.Region, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
    }
