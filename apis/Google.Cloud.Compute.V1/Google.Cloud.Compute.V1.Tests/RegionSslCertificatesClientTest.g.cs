...
namespace Google.Cloud.Compute.V1.Tests
{
    ...
    public sealed class GeneratedRegionSslCertificatesClientTest
    {
        ...
        public void List()
        {
            ...
            mockGrpcClient.Setup(x => x.List(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            RegionSslCertificatesClient client = new RegionSslCertificatesClientImpl(mockGrpcClient.Object, null);
            SslCertificateList response = client.List(request.Project, request.Region);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }
        ...
        public async stt::Task ListAsync()
        {
            ...
            mockGrpcClient.Setup(x => x.ListAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<SslCertificateList>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            RegionSslCertificatesClient client = new RegionSslCertificatesClientImpl(mockGrpcClient.Object, null);
            SslCertificateList responseCallSettings = await client.ListAsync(request.Project, request.Region, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            SslCertificateList responseCancellationToken = await client.ListAsync(request.Project, request.Region, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
    }
