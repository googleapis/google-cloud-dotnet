...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedRegionSnapshotSettingsClientSnippets
    {
        /// <summary>Snippet for Get</summary>
        public void GetRequestObject()
        {
            // Snippet: Get(GetRegionSnapshotSettingRequest, CallSettings)
            // Create client
        ...
        {
            // Snippet: GetAsync(GetRegionSnapshotSettingRequest, CallSettings)
            // Additional: GetAsync(GetRegionSnapshotSettingRequest, CancellationToken)
            // Create client
        ...
        {
            // Snippet: Patch(PatchRegionSnapshotSettingRequest, CallSettings)
            // Create client
            RegionSnapshotSettingsClient regionSnapshotSettingsClient = RegionSnapshotSettingsClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: PatchAsync(PatchRegionSnapshotSettingRequest, CallSettings)
            // Additional: PatchAsync(PatchRegionSnapshotSettingRequest, CancellationToken)
            // Create client
            RegionSnapshotSettingsClient regionSnapshotSettingsClient = await RegionSnapshotSettingsClient.CreateAsync();
            // Initialize request argument(s)
            PatchRegionSnapshotSettingRequest request = new PatchRegionSnapshotSettingRequest
        ...
        public void Patch()
        {
            // Snippet: Patch(string, string, SnapshotSettings, CallSettings)
            // Create client
            RegionSnapshotSettingsClient regionSnapshotSettingsClient = RegionSnapshotSettingsClient.Create();
            // Initialize request argument(s)
            string project = "";
        ...
        {
            // Snippet: PatchAsync(string, string, SnapshotSettings, CallSettings)
            // Additional: PatchAsync(string, string, SnapshotSettings, CancellationToken)
            // Create client
            RegionSnapshotSettingsClient regionSnapshotSettingsClient = await RegionSnapshotSettingsClient.CreateAsync();
            // Initialize request argument(s)
            string project = "";
