...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedNetworkProfilesClientSnippets
    {
        /// <summary>Snippet for Get</summary>
        public void GetRequestObject()
        {
            // Snippet: Get(GetNetworkProfileRequest, CallSettings)
            // Create client
        ...
        {
            // Snippet: GetAsync(GetNetworkProfileRequest, CallSettings)
            // Additional: GetAsync(GetNetworkProfileRequest, CancellationToken)
            // Create client
        ...
        {
            // Snippet: List(ListNetworkProfilesRequest, CallSettings)
            // Create client
            NetworkProfilesClient networkProfilesClient = NetworkProfilesClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: ListAsync(ListNetworkProfilesRequest, CallSettings)
            // Create client
            NetworkProfilesClient networkProfilesClient = await NetworkProfilesClient.CreateAsync();
            // Initialize request argument(s)
            ListNetworkProfilesRequest request = new ListNetworkProfilesRequest
            ...
            // Iterate over all response items, lazily performing RPCs as required
            await foreach (NetworkProfile item in response)
            {
                // Do something with each item
                Console.WriteLine(item);
            }
            ...
            // Or iterate over pages (of server-defined size), performing one RPC per page
            await foreach (NetworkProfilesListResponse page in response.AsRawResponses())
            {
                // Do something with each page of items
                Console.WriteLine("A page of results:");
                foreach (NetworkProfile item in page)
