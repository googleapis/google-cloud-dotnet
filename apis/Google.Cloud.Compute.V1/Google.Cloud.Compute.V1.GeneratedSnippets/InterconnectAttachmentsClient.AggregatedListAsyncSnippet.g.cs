...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedInterconnectAttachmentsClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, InterconnectAttachmentsScopedList> item in response)
            {
            ...
            await foreach (InterconnectAttachmentAggregatedList page in response.AsRawResponses())
            {
