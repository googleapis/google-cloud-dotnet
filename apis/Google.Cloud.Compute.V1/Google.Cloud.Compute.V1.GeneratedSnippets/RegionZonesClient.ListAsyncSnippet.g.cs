...
{
    // [START compute_v1_generated_RegionZones_List_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedRegionZonesClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (ZoneList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_RegionZones_List_async_flattened]
}
