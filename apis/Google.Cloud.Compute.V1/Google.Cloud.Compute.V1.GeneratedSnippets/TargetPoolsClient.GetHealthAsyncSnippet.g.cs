...
{
    // [START compute_v1_generated_TargetPools_GetHealth_async_flattened]
    ...
    public sealed partial class GeneratedTargetPoolsClientSnippets
    {
        ...
        public async Task GetHealthAsync()
        {
            ...
            string region = "";
            string targetPool = "";
            InstanceReference instanceReferenceResource = new InstanceReference { Instance = "", };
            // Make the request
    ...
    // [END compute_v1_generated_TargetPools_GetHealth_async_flattened]
}
