...
{
    // [START compute_v1_generated_ForwardingRules_List_async_flattened]
    ...
    public sealed partial class GeneratedForwardingRulesClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (ForwardingRule item in response)
            {
            ...
            await foreach (ForwardingRuleList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_ForwardingRules_List_async_flattened]
}
