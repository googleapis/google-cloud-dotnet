...
{
    // [START compute_v1_generated_TargetHttpProxies_SetUrlMap_async_flattened]
    ...
    public sealed partial class GeneratedTargetHttpProxiesClientSnippets
    {
        ...
        public async Task SetUrlMapAsync()
        {
            ...
            UrlMapReference urlMapReferenceResource = new UrlMapReference { UrlMap = "", };
            // Make the request
    ...
    // [END compute_v1_generated_TargetHttpProxies_SetUrlMap_async_flattened]
}
