...
{
    // [START compute_v1_generated_InstantSnapshots_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedInstantSnapshotsClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, InstantSnapshotsScopedList> item in response)
            {
            ...
            await foreach (InstantSnapshotAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_InstantSnapshots_AggregatedList_async_flattened]
}
