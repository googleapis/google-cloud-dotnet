...
{
    // [START compute_v1_generated_PublicDelegatedPrefixes_Announce_sync_flattened]
    using Google.Cloud.Compute.V1;
    using lro = Google.LongRunning;

    public sealed partial class GeneratedPublicDelegatedPrefixesClientSnippets
    {
    ...
    // [END compute_v1_generated_PublicDelegatedPrefixes_Announce_sync_flattened]
}
