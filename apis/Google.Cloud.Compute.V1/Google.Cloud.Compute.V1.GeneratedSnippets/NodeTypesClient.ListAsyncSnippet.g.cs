...
{
    // [START compute_v1_generated_NodeTypes_List_async_flattened]
    ...
    public sealed partial class GeneratedNodeTypesClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (NodeTypeList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_NodeTypes_List_async_flattened]
}
