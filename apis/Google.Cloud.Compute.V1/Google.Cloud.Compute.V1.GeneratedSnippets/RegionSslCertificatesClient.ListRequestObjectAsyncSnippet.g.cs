...
{
    // [START compute_v1_generated_RegionSslCertificates_List_async]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedRegionSslCertificatesClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (SslCertificate item in response)
            {
            ...
            await foreach (SslCertificateList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_RegionSslCertificates_List_async]
}
