...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedVpnTunnelsClientSnippets
    {
        ...
        public async Task AggregatedListRequestObjectAsync()
        {
            ...
            await foreach (KeyValuePair<string, VpnTunnelsScopedList> item in response)
            {
            ...
            await foreach (VpnTunnelAggregatedList page in response.AsRawResponses())
            {
