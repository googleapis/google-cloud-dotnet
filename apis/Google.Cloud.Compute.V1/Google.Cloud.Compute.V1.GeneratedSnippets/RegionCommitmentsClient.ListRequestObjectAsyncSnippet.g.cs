...
{
    // [START compute_v1_generated_RegionCommitments_List_async]
    ...
    public sealed partial class GeneratedRegionCommitmentsClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (Commitment item in response)
            {
            ...
            await foreach (CommitmentList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_RegionCommitments_List_async]
}
