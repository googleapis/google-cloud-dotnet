...
{
    // [START compute_v1_generated_ServiceAttachments_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedServiceAttachmentsClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, ServiceAttachmentsScopedList> item in response)
            {
            ...
            await foreach (ServiceAttachmentAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_ServiceAttachments_AggregatedList_async_flattened]
}
