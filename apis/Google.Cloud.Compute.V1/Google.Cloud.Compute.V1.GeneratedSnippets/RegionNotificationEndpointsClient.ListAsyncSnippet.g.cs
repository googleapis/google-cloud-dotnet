...
{
    // [START compute_v1_generated_RegionNotificationEndpoints_List_async_flattened]
    ...
    public sealed partial class GeneratedRegionNotificationEndpointsClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (NotificationEndpoint item in response)
            {
            ...
            await foreach (NotificationEndpointList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_RegionNotificationEndpoints_List_async_flattened]
}
