...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedTargetInstancesClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, TargetInstancesScopedList> item in response)
            {
            ...
            await foreach (TargetInstanceAggregatedList page in response.AsRawResponses())
            {
