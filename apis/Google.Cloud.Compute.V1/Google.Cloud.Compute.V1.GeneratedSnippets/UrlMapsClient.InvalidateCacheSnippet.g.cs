...
{
    // [START compute_v1_generated_UrlMaps_InvalidateCache_sync_flattened]
    ...
    public sealed partial class GeneratedUrlMapsClientSnippets
    {
        ...
        public void InvalidateCache()
        {
            ...
            string project = "";
            string urlMap = "";
            CacheInvalidationRule cacheInvalidationRuleResource = new CacheInvalidationRule { Host = "", Path = "", };
            // Make the request
    ...
    // [END compute_v1_generated_UrlMaps_InvalidateCache_sync_flattened]
}
