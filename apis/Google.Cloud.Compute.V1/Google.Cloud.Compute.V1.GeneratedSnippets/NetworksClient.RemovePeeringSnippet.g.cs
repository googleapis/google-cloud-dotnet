...
{
    // [START compute_v1_generated_Networks_RemovePeering_sync_flattened]
    ...
    public sealed partial class GeneratedNetworksClientSnippets
    {
        ...
        public void RemovePeering()
        {
            ...
            string project = "";
            string network = "";
            NetworksRemovePeeringRequest networksRemovePeeringRequestResource = new NetworksRemovePeeringRequest { Name = "", };
            // Make the request
    ...
    // [END compute_v1_generated_Networks_RemovePeering_sync_flattened]
}
