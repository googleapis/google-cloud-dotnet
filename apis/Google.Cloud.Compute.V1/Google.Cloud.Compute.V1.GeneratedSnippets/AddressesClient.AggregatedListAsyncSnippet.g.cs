...
{
    // [START compute_v1_generated_Addresses_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedAddressesClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, AddressesScopedList> item in response)
            {
            ...
            await foreach (AddressAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_Addresses_AggregatedList_async_flattened]
}
