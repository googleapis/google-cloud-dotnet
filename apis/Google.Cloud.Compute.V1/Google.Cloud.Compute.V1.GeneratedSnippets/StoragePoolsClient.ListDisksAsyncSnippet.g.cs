...
{
    // [START compute_v1_generated_StoragePools_ListDisks_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedStoragePoolsClientSnippets
    {
        ...
        public async Task ListDisksAsync()
        {
            ...
            await foreach (StoragePoolDisk item in response)
            {
            ...
            await foreach (StoragePoolListDisks page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_StoragePools_ListDisks_async_flattened]
}
