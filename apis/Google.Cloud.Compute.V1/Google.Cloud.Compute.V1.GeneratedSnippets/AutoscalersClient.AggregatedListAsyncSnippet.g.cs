...
{
    // [START compute_v1_generated_Autoscalers_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedAutoscalersClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, AutoscalersScopedList> item in response)
            {
            ...
            await foreach (AutoscalerAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_Autoscalers_AggregatedList_async_flattened]
}
