...
{
    // [START compute_v1_generated_ReservationSubBlocks_List_async]
    ...
    public sealed partial class GeneratedReservationSubBlocksClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (ReservationSubBlock item in response)
            {
            ...
            await foreach (ReservationSubBlocksListResponse page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_ReservationSubBlocks_List_async]
}
