...
{
    // [START compute_v1_generated_RegionInstances_BulkInsert_async]
            ...
            BulkInsertRegionInstanceRequest request = new BulkInsertRegionInstanceRequest
            {
                ...
                BulkInsertInstanceResourceResource = new BulkInsertInstanceResource
                {
                    ...
                    PerInstanceProperties =
                    {
                        {
                            "",
                            new BulkInsertInstanceResourcePerInstanceProperties
                            {
                                Name = "",
                                Hostname = "",
                            }
                    ...
                    LocationPolicy = new LocationPolicy
                    {
                        ...
                        Locations =
                        {
                            {
                                "",
                                new LocationPolicyLocation
                                {
                                    Constraints = new LocationPolicyLocationConstraints { MaxCount = 0, },
                                    Preference = "",
                                }
                            },
                        },
    ...
    // [END compute_v1_generated_RegionInstances_BulkInsert_async]
}
