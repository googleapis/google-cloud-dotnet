...
{
    // [START compute_v1_generated_BackendServices_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedBackendServicesClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, BackendServicesScopedList> item in response)
            {
            ...
            await foreach (BackendServiceAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_BackendServices_AggregatedList_async_flattened]
}
