...
{
    // [START compute_v1_generated_NodeGroups_SimulateMaintenanceEvent_async_flattened]
    ...
    public sealed partial class GeneratedNodeGroupsClientSnippets
    {
        ...
        public async Task SimulateMaintenanceEventAsync()
        {
            ...
            string zone = "";
            string nodeGroup = "";
            NodeGroupsSimulateMaintenanceEventRequest nodeGroupsSimulateMaintenanceEventRequestResource = new NodeGroupsSimulateMaintenanceEventRequest { Nodes = { "", }, };
            // Make the request
    ...
    // [END compute_v1_generated_NodeGroups_SimulateMaintenanceEvent_async_flattened]
}
