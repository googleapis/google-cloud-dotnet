...
{
    // [START compute_v1_generated_NodeGroups_SetNodeTemplate_async_flattened]
    ...
    public sealed partial class GeneratedNodeGroupsClientSnippets
    {
        ...
        public async Task SetNodeTemplateAsync()
        {
            ...
            string zone = "";
            string nodeGroup = "";
            NodeGroupsSetNodeTemplateRequest nodeGroupsSetNodeTemplateRequestResource = new NodeGroupsSetNodeTemplateRequest { NodeTemplate = "", };
            // Make the request
    ...
    // [END compute_v1_generated_NodeGroups_SetNodeTemplate_async_flattened]
}
