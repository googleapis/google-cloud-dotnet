...
{
    // [START compute_v1_generated_TargetHttpsProxies_AggregatedList_async]
    ...
    public sealed partial class GeneratedTargetHttpsProxiesClientSnippets
    {
        ...
        public async Task AggregatedListRequestObjectAsync()
        {
            ...
            await foreach (KeyValuePair<string, TargetHttpsProxiesScopedList> item in response)
            {
            ...
            await foreach (TargetHttpsProxyAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_TargetHttpsProxies_AggregatedList_async]
}
