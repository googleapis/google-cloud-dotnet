...
{
    // [START compute_v1_generated_PreviewFeatures_List_async]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedPreviewFeaturesClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (PreviewFeature item in response)
            {
            ...
            await foreach (PreviewFeatureList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_PreviewFeatures_List_async]
}
