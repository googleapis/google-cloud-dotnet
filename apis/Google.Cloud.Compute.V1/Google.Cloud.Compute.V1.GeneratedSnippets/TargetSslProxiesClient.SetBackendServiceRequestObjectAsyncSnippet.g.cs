...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedTargetSslProxiesClientSnippets
    {
        ...
        public async Task SetBackendServiceRequestObjectAsync()
        {
            ...
            {
                RequestId = "",
                TargetSslProxiesSetBackendServiceRequestResource = new TargetSslProxiesSetBackendServiceRequest { Service = "", },
                Project = "",
                TargetSslProxy = "",
            };
            // Make the request
    ...
    // [END compute_v1_generated_TargetSslProxies_SetBackendService_async]
}
