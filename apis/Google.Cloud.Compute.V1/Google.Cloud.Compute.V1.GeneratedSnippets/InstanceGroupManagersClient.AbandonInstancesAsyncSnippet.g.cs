...
{
    // [START compute_v1_generated_InstanceGroupManagers_AbandonInstances_async_flattened]
    ...
    public sealed partial class GeneratedInstanceGroupManagersClientSnippets
    {
        ...
        public async Task AbandonInstancesAsync()
        {
            ...
            InstanceGroupManagersAbandonInstancesRequest instanceGroupManagersAbandonInstancesRequestResource = new InstanceGroupManagersAbandonInstancesRequest { Instances = { "", }, };
            // Make the request
    ...
    // [END compute_v1_generated_InstanceGroupManagers_AbandonInstances_async_flattened]
}
