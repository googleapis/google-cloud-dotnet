...
{
    // [START compute_v1_generated_StoragePools_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedStoragePoolsClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, StoragePoolsScopedList> item in response)
            {
            ...
            await foreach (StoragePoolAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_StoragePools_AggregatedList_async_flattened]
}
