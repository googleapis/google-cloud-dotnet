...
{
    // [START compute_v1_generated_PublicAdvertisedPrefixes_List_async_flattened]
    ...
    public sealed partial class GeneratedPublicAdvertisedPrefixesClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (PublicAdvertisedPrefix item in response)
            {
            ...
            await foreach (PublicAdvertisedPrefixList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_PublicAdvertisedPrefixes_List_async_flattened]
}
