...
{
    // [START compute_v1_generated_Disks_Resize_sync_flattened]
    ...
    public sealed partial class GeneratedDisksClientSnippets
    {
        ...
        public void Resize()
        {
            ...
            string zone = "";
            string disk = "";
            DisksResizeRequest disksResizeRequestResource = new DisksResizeRequest { SizeGb = 0L, };
            // Make the request
    ...
    // [END compute_v1_generated_Disks_Resize_sync_flattened]
}
