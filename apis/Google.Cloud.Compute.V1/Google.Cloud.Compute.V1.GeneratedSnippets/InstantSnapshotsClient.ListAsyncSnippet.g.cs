...
{
    // [START compute_v1_generated_InstantSnapshots_List_async_flattened]
    ...
    public sealed partial class GeneratedInstantSnapshotsClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (InstantSnapshot item in response)
            {
            ...
            await foreach (InstantSnapshotList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_InstantSnapshots_List_async_flattened]
}
