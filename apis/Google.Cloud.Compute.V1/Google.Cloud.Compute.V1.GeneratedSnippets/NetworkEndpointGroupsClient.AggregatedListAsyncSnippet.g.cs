...
{
    // [START compute_v1_generated_NetworkEndpointGroups_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedNetworkEndpointGroupsClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, NetworkEndpointGroupsScopedList> item in response)
            {
            ...
            await foreach (NetworkEndpointGroupAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_NetworkEndpointGroups_AggregatedList_async_flattened]
}
