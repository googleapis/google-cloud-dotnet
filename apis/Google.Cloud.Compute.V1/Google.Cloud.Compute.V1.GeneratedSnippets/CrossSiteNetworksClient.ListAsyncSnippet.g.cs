...
{
    // [START compute_v1_generated_CrossSiteNetworks_List_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedCrossSiteNetworksClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (CrossSiteNetwork item in response)
            {
            ...
            await foreach (CrossSiteNetworkList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_CrossSiteNetworks_List_async_flattened]
}
