...
{
    // [START compute_v1_generated_Instances_SetMinCpuPlatform_async_flattened]
    ...
    public sealed partial class GeneratedInstancesClientSnippets
    {
        ...
        public async Task SetMinCpuPlatformAsync()
        {
            ...
            string zone = "";
            string instance = "";
            InstancesSetMinCpuPlatformRequest instancesSetMinCpuPlatformRequestResource = new InstancesSetMinCpuPlatformRequest { MinCpuPlatform = "", };
            // Make the request
    ...
    // [END compute_v1_generated_Instances_SetMinCpuPlatform_async_flattened]
}
