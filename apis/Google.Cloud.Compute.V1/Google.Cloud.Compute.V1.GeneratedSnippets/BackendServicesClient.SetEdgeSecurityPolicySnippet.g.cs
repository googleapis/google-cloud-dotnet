...
{
    // [START compute_v1_generated_BackendServices_SetEdgeSecurityPolicy_sync_flattened]
    using Google.Cloud.Compute.V1;
    using lro = Google.LongRunning;

    public sealed partial class GeneratedBackendServicesClientSnippets
    {
    ...
    // [END compute_v1_generated_BackendServices_SetEdgeSecurityPolicy_sync_flattened]
}
