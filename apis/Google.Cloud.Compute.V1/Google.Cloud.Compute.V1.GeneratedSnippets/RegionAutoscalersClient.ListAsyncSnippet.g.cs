...
{
    // [START compute_v1_generated_RegionAutoscalers_List_async_flattened]
    ...
    public sealed partial class GeneratedRegionAutoscalersClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (Autoscaler item in response)
            {
            ...
            await foreach (RegionAutoscalerList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_RegionAutoscalers_List_async_flattened]
}
