...
{
    // [START compute_v1_generated_InstanceGroups_ListInstances_async_flattened]
    ...
    public sealed partial class GeneratedInstanceGroupsClientSnippets
    {
        ...
        public async Task ListInstancesAsync()
        {
            ...
            InstanceGroupsListInstancesRequest instanceGroupsListInstancesRequestResource = new InstanceGroupsListInstancesRequest { InstanceState = "", };
            // Make the request
    ...
    // [END compute_v1_generated_InstanceGroups_ListInstances_async_flattened]
}
