...
{
    // [START compute_v1_generated_Images_List_async_flattened]
    ...
    public sealed partial class GeneratedImagesClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (Image item in response)
            {
            ...
            await foreach (ImageList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_Images_List_async_flattened]
}
