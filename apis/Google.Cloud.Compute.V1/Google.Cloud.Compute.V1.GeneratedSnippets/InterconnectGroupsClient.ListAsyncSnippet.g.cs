...
{
    // [START compute_v1_generated_InterconnectGroups_List_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedInterconnectGroupsClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (InterconnectGroup item in response)
            {
            ...
            await foreach (InterconnectGroupsListResponse page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_InterconnectGroups_List_async_flattened]
}
