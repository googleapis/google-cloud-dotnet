...
{
    // [START compute_v1_generated_InterconnectRemoteLocations_List_async]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedInterconnectRemoteLocationsClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (InterconnectRemoteLocation item in response)
            {
            ...
            await foreach (InterconnectRemoteLocationList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_InterconnectRemoteLocations_List_async]
}
