...
{
    // [START compute_v1_generated_ExternalVpnGateways_List_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedExternalVpnGatewaysClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (ExternalVpnGateway item in response)
            {
            ...
            await foreach (ExternalVpnGatewayList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_ExternalVpnGateways_List_async_flattened]
}
