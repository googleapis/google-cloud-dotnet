...
{
    // [START compute_v1_generated_NetworkAttachments_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedNetworkAttachmentsClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, NetworkAttachmentsScopedList> item in response)
            {
            ...
            await foreach (NetworkAttachmentAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_NetworkAttachments_AggregatedList_async_flattened]
}
