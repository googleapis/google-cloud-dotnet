...
{
    // [START compute_v1_generated_RegionTargetHttpProxies_List_async]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedRegionTargetHttpProxiesClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (TargetHttpProxy item in response)
            {
            ...
            await foreach (TargetHttpProxyList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_RegionTargetHttpProxies_List_async]
}
