...
{
    // [START compute_v1_generated_Projects_ListXpnHosts_async_flattened]
    ...
    public sealed partial class GeneratedProjectsClientSnippets
    {
        ...
        public async Task ListXpnHostsAsync()
        {
            ...
            string project = "";
            ProjectsListXpnHostsRequest projectsListXpnHostsRequestResource = new ProjectsListXpnHostsRequest { Organization = "", };
            // Make the request
    ...
    // [END compute_v1_generated_Projects_ListXpnHosts_async_flattened]
}
