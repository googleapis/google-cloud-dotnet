...
{
    // [START compute_v1_generated_Projects_ListXpnHosts_async]
    ...
    public sealed partial class GeneratedProjectsClientSnippets
    {
        ...
        public async Task ListXpnHostsRequestObjectAsync()
        {
            ...
            await foreach (Project item in response)
            {
            ...
            await foreach (XpnHostList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_Projects_ListXpnHosts_async]
}
