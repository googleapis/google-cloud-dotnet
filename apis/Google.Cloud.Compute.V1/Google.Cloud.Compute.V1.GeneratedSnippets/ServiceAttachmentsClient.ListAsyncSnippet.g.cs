...
{
    // [START compute_v1_generated_ServiceAttachments_List_async_flattened]
    ...
    public sealed partial class GeneratedServiceAttachmentsClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (ServiceAttachment item in response)
            {
            ...
            await foreach (ServiceAttachmentList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_ServiceAttachments_List_async_flattened]
}
