...
{
    // [START compute_v1_generated_Projects_SetDefaultNetworkTier_async_flattened]
    ...
    public sealed partial class GeneratedProjectsClientSnippets
    {
        ...
        public async Task SetDefaultNetworkTierAsync()
        {
            ...
            string project = "";
            ProjectsSetDefaultNetworkTierRequest projectsSetDefaultNetworkTierRequestResource = new ProjectsSetDefaultNetworkTierRequest { NetworkTier = "", };
            // Make the request
    ...
    // [END compute_v1_generated_Projects_SetDefaultNetworkTier_async_flattened]
}
