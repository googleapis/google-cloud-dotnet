...
{
    // [START compute_v1_generated_TargetSslProxies_List_async_flattened]
    ...
    public sealed partial class GeneratedTargetSslProxiesClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (TargetSslProxy item in response)
            {
            ...
            await foreach (TargetSslProxyList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_TargetSslProxies_List_async_flattened]
}
