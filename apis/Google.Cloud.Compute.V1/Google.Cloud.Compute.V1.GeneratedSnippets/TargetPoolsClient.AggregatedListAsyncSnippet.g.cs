...
{
    // [START compute_v1_generated_TargetPools_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedTargetPoolsClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, TargetPoolsScopedList> item in response)
            {
            ...
            await foreach (TargetPoolAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_TargetPools_AggregatedList_async_flattened]
}
