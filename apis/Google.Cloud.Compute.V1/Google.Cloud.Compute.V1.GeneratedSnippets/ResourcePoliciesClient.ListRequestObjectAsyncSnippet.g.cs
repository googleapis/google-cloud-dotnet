...
{
    // [START compute_v1_generated_ResourcePolicies_List_async]
    ...
    public sealed partial class GeneratedResourcePoliciesClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (ResourcePolicy item in response)
            {
            ...
            await foreach (ResourcePolicyList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_ResourcePolicies_List_async]
}
