...
{
    // [START compute_v1_generated_TargetHttpProxies_AggregatedList_async_flattened]
    ...
    public sealed partial class GeneratedTargetHttpProxiesClientSnippets
    {
        ...
        public async Task AggregatedListAsync()
        {
            ...
            await foreach (KeyValuePair<string, TargetHttpProxiesScopedList> item in response)
            {
            ...
            await foreach (TargetHttpProxyAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_TargetHttpProxies_AggregatedList_async_flattened]
}
