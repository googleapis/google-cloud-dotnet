...
{
    // [START compute_v1_generated_RegionBackendServices_GetHealth_async_flattened]
    ...
    public sealed partial class GeneratedRegionBackendServicesClientSnippets
    {
        ...
        public async Task GetHealthAsync()
        {
            ...
            ResourceGroupReference resourceGroupReferenceResource = new ResourceGroupReference { Group = "", };
            // Make the request
    ...
    // [END compute_v1_generated_RegionBackendServices_GetHealth_async_flattened]
}
