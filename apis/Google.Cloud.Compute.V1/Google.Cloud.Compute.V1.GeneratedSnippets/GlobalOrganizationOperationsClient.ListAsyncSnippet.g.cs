...
{
    // [START compute_v1_generated_GlobalOrganizationOperations_List_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedGlobalOrganizationOperationsClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (Operation item in response)
            {
            ...
            await foreach (OperationList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_GlobalOrganizationOperations_List_async_flattened]
}
