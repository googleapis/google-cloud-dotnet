...
{
    // [START compute_v1_generated_SecurityPolicies_AggregatedList_async]
    ...
    public sealed partial class GeneratedSecurityPoliciesClientSnippets
    {
        ...
        public async Task AggregatedListRequestObjectAsync()
        {
            ...
            await foreach (KeyValuePair<string, SecurityPoliciesScopedList> item in response)
            {
            ...
            await foreach (SecurityPoliciesAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_SecurityPolicies_AggregatedList_async]
}
