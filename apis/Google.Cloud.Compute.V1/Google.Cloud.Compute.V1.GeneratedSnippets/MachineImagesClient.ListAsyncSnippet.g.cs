...
{
    // [START compute_v1_generated_MachineImages_List_async_flattened]
    ...
    public sealed partial class GeneratedMachineImagesClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (MachineImage item in response)
            {
            ...
            await foreach (MachineImageList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_MachineImages_List_async_flattened]
}
