...
{
    // [START compute_v1_generated_InstanceGroupManagerResizeRequests_List_async]
    ...
    public sealed partial class GeneratedInstanceGroupManagerResizeRequestsClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (InstanceGroupManagerResizeRequestsListResponse page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_InstanceGroupManagerResizeRequests_List_async]
}
