...
{
    // [START compute_v1_generated_VpnGateways_AggregatedList_async]
    ...
    public sealed partial class GeneratedVpnGatewaysClientSnippets
    {
        ...
        public async Task AggregatedListRequestObjectAsync()
        {
            ...
            await foreach (KeyValuePair<string, VpnGatewaysScopedList> item in response)
            {
            ...
            await foreach (VpnGatewayAggregatedList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_VpnGateways_AggregatedList_async]
}
