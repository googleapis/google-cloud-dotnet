...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedTargetVpnGatewaysClientSnippets
    {
        ...
        public async Task AggregatedListRequestObjectAsync()
        {
            ...
            await foreach (KeyValuePair<string, TargetVpnGatewaysScopedList> item in response)
            {
            ...
            await foreach (TargetVpnGatewayAggregatedList page in response.AsRawResponses())
            {
