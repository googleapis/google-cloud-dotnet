...
{
    // [START compute_v1_generated_TargetGrpcProxies_List_async_flattened]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedTargetGrpcProxiesClientSnippets
    {
        ...
        public async Task ListAsync()
        {
            ...
            await foreach (TargetGrpcProxy item in response)
            {
            ...
            await foreach (TargetGrpcProxyList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_TargetGrpcProxies_List_async_flattened]
}
