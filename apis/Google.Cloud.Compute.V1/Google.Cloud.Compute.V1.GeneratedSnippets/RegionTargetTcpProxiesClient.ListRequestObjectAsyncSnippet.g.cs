...
{
    // [START compute_v1_generated_RegionTargetTcpProxies_List_async]
    using Google.Api.Gax;
    using Google.Cloud.Compute.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedRegionTargetTcpProxiesClientSnippets
    {
        ...
        public async Task ListRequestObjectAsync()
        {
            ...
            await foreach (TargetTcpProxy item in response)
            {
            ...
            await foreach (TargetTcpProxyList page in response.AsRawResponses())
            {
    ...
    // [END compute_v1_generated_RegionTargetTcpProxies_List_async]
}
