...
{
    // [START compute_v1_generated_TargetHttpsProxies_SetCertificateMap_async_flattened]
    using Google.Cloud.Compute.V1;
    using System.Threading.Tasks;
    using lro = Google.LongRunning;

    public sealed partial class GeneratedTargetHttpsProxiesClientSnippets
    {
        ...
        public async Task SetCertificateMapAsync()
        {
            ...
            TargetHttpsProxiesSetCertificateMapRequest targetHttpsProxiesSetCertificateMapRequestResource = new TargetHttpsProxiesSetCertificateMapRequest { CertificateMap = "", };
            // Make the request
    ...
    // [END compute_v1_generated_TargetHttpsProxies_SetCertificateMap_async_flattened]
}
