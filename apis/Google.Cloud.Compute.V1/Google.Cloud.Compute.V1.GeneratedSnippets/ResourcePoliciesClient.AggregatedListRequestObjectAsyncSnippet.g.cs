...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedResourcePoliciesClientSnippets
    {
        ...
        public async Task AggregatedListRequestObjectAsync()
        {
            ...
            await foreach (KeyValuePair<string, ResourcePoliciesScopedList> item in response)
            {
            ...
            await foreach (ResourcePolicyAggregatedList page in response.AsRawResponses())
            {
