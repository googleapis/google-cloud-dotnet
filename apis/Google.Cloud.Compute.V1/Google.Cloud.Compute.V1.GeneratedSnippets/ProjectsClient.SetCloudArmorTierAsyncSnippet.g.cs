...
{
    // [START compute_v1_generated_Projects_SetCloudArmorTier_async_flattened]
    ...
    public sealed partial class GeneratedProjectsClientSnippets
    {
        ...
        public async Task SetCloudArmorTierAsync()
        {
            ...
            string project = "";
            ProjectsSetCloudArmorTierRequest projectsSetCloudArmorTierRequestResource = new ProjectsSetCloudArmorTierRequest { CloudArmorTier = "", };
            // Make the request
    ...
    // [END compute_v1_generated_Projects_SetCloudArmorTier_async_flattened]
}
