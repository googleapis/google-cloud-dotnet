...
{
    // [START merchantapi_v1beta_generated_LocalInventoryService_ListLocalInventories_async_flattened]
    ...
    public sealed partial class GeneratedLocalInventoryServiceClientSnippets
    {
        ...
        public async Task ListLocalInventoriesAsync()
        {
            ...
            await foreach (LocalInventory item in response)
            {
            ...
            await foreach (ListLocalInventoriesResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_LocalInventoryService_ListLocalInventories_async_flattened]
}
