...
{
    // [START storagetransfer_v1_generated_StorageTransferService_ListAgentPools_async_flattened]
    ...
    public sealed partial class GeneratedStorageTransferServiceClientSnippets
    {
        ...
        public async Task ListAgentPoolsAsync()
        {
            ...
            await foreach (AgentPool item in response)
            {
            ...
            await foreach (ListAgentPoolsResponse page in response.AsRawResponses())
            {
    ...
    // [END storagetransfer_v1_generated_StorageTransferService_ListAgentPools_async_flattened]
}
