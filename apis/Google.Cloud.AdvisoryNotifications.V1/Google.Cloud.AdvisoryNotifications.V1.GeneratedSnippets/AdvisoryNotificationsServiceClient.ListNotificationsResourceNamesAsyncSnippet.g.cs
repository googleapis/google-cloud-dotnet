...
{
    // [START advisorynotifications_v1_generated_AdvisoryNotificationsService_ListNotifications_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAdvisoryNotificationsServiceClientSnippets
    {
        ...
        public async Task ListNotificationsResourceNamesAsync()
        {
            ...
            await foreach (Notification item in response)
            {
            ...
            await foreach (ListNotificationsResponse page in response.AsRawResponses())
            {
    ...
    // [END advisorynotifications_v1_generated_AdvisoryNotificationsService_ListNotifications_async_flattened_resourceNames]
}
