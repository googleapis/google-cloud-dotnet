...
namespace Google.Cloud.Speech.V1P1Beta1 {
  ...
  public static partial class Adaptation
  {
    ...
    static readonly grpc::Method<global::Google.Cloud.Speech.V1P1Beta1.DeleteCustomClassRequest, global::Google.Protobuf.WellKnownTypes.Empty> __Method_DeleteCustomClass = new grpc::Method<global::Google.Cloud.Speech.V1P1Beta1.DeleteCustomClassRequest, global::Google.Protobuf.WellKnownTypes.Empty>(
        ...
        __ServiceName,
        "DeleteCustomClass",
        __Marshaller_google_cloud_speech_v1p1beta1_DeleteCustomClassRequest,
        __Marshaller_google_protobuf_Empty);

    /// <summary>Service descriptor</summary>
    public static global::Google.Protobuf.Reflection.ServiceDescriptor Descriptor
    {
      get { return global::Google.Cloud.Speech.V1P1Beta1.CloudSpeechAdaptationReflection.Descriptor.Services[0]; }
    }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, AdaptationBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_GetPhraseSet, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.GetPhraseSetRequest, global::Google.Cloud.Speech.V1P1Beta1.PhraseSet>(serviceImpl.GetPhraseSet));
      serviceBinder.AddMethod(__Method_ListPhraseSet, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.ListPhraseSetRequest, global::Google.Cloud.Speech.V1P1Beta1.ListPhraseSetResponse>(serviceImpl.ListPhraseSet));
      serviceBinder.AddMethod(__Method_UpdatePhraseSet, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.UpdatePhraseSetRequest, global::Google.Cloud.Speech.V1P1Beta1.PhraseSet>(serviceImpl.UpdatePhraseSet));
      serviceBinder.AddMethod(__Method_DeletePhraseSet, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.DeletePhraseSetRequest, global::Google.Protobuf.WellKnownTypes.Empty>(serviceImpl.DeletePhraseSet));
      serviceBinder.AddMethod(__Method_CreateCustomClass, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.CreateCustomClassRequest, global::Google.Cloud.Speech.V1P1Beta1.CustomClass>(serviceImpl.CreateCustomClass));
      serviceBinder.AddMethod(__Method_GetCustomClass, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.GetCustomClassRequest, global::Google.Cloud.Speech.V1P1Beta1.CustomClass>(serviceImpl.GetCustomClass));
      serviceBinder.AddMethod(__Method_ListCustomClasses, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.ListCustomClassesRequest, global::Google.Cloud.Speech.V1P1Beta1.ListCustomClassesResponse>(serviceImpl.ListCustomClasses));
      serviceBinder.AddMethod(__Method_UpdateCustomClass, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.UpdateCustomClassRequest, global::Google.Cloud.Speech.V1P1Beta1.CustomClass>(serviceImpl.UpdateCustomClass));
      serviceBinder.AddMethod(__Method_DeleteCustomClass, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Speech.V1P1Beta1.DeleteCustomClassRequest, global::Google.Protobuf.WellKnownTypes.Empty>(serviceImpl.DeleteCustomClass));
    }
