...
namespace GoogleCSharpSnippets
{
    ...
    {
        /// <summary>Snippet for SearchFuzzedVehiclesAsync</summary>
        /// <remarks>
        ...
        /// </remarks>
        public async Task SearchFuzzedVehiclesRequestObjectAsync()
        {
            // Create client
...
#pragma warning disable CS0612
            SearchVehiclesResponse response = await vehicleServiceClient.SearchFuzzedVehiclesAsync(request);
