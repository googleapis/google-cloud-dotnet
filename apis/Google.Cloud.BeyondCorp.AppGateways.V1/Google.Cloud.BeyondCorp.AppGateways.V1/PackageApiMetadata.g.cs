...
namespace Google.Cloud.BeyondCorp.AppGateways.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.BeyondCorp.AppGateways.V1", GetFileDescriptors)
        ...
        {
            yield return AppGatewaysServiceReflection.Descriptor;
