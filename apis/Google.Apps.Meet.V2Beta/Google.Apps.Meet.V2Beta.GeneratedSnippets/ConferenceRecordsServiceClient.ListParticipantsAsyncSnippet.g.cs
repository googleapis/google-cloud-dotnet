...
{
    // [START meet_v2beta_generated_ConferenceRecordsService_ListParticipants_async_flattened]
    ...
    public sealed partial class GeneratedConferenceRecordsServiceClientSnippets
    {
        ...
        public async Task ListParticipantsAsync()
        {
            ...
            await foreach (Participant item in response)
            {
            ...
            await foreach (ListParticipantsResponse page in response.AsRawResponses())
            {
    ...
    // [END meet_v2beta_generated_ConferenceRecordsService_ListParticipants_async_flattened]
}
