...
{
    // [START meet_v2beta_generated_ConferenceRecordsService_ListParticipantSessions_async_flattened]
    ...
    public sealed partial class GeneratedConferenceRecordsServiceClientSnippets
    {
        ...
        public async Task ListParticipantSessionsAsync()
        {
            ...
            await foreach (ParticipantSession item in response)
            {
            ...
            await foreach (ListParticipantSessionsResponse page in response.AsRawResponses())
            {
    ...
    // [END meet_v2beta_generated_ConferenceRecordsService_ListParticipantSessions_async_flattened]
}
