...
namespace Google.Cloud.GkeMultiCloud.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.GkeMultiCloud.V1", GetFileDescriptors)
        ...
        {
            yield return AttachedResourcesReflection.Descriptor;
            yield return AttachedServiceReflection.Descriptor;
