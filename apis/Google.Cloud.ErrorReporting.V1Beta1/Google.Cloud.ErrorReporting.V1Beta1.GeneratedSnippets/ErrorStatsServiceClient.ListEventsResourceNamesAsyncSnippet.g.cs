...
{
    // [START clouderrorreporting_v1beta1_generated_ErrorStatsService_ListEvents_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedErrorStatsServiceClientSnippets
    {
        ...
        public async Task ListEventsResourceNamesAsync()
        {
            ...
            await foreach (ErrorEvent item in response)
            {
    ...
    // [END clouderrorreporting_v1beta1_generated_ErrorStatsService_ListEvents_async_flattened_resourceNames]
}
