...
{
    // [START privateca_v1_generated_CertificateAuthorityService_ListCertificateAuthorities_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCertificateAuthorityServiceClientSnippets
    {
        ...
        public async Task ListCertificateAuthoritiesResourceNamesAsync()
        {
            ...
            await foreach (CertificateAuthority item in response)
            {
            ...
            await foreach (ListCertificateAuthoritiesResponse page in response.AsRawResponses())
            {
    ...
    // [END privateca_v1_generated_CertificateAuthorityService_ListCertificateAuthorities_async_flattened_resourceNames]
}
