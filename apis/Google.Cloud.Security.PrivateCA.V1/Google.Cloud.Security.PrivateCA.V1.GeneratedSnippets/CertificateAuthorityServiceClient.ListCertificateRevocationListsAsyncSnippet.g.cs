...
{
    // [START privateca_v1_generated_CertificateAuthorityService_ListCertificateRevocationLists_async_flattened]
    ...
    public sealed partial class GeneratedCertificateAuthorityServiceClientSnippets
    {
        ...
        public async Task ListCertificateRevocationListsAsync()
        {
            ...
            await foreach (CertificateRevocationList item in response)
            {
            ...
            await foreach (ListCertificateRevocationListsResponse page in response.AsRawResponses())
            {
    ...
    // [END privateca_v1_generated_CertificateAuthorityService_ListCertificateRevocationLists_async_flattened]
}
