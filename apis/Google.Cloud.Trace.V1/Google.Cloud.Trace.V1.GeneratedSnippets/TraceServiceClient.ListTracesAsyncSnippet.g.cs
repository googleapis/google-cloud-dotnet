...
{
    // [START cloudtrace_v1_generated_TraceService_ListTraces_async_flattened]
    ...
    public sealed partial class GeneratedTraceServiceClientSnippets
    {
        ...
        public async Task ListTracesAsync()
        {
            ...
            await foreach (Trace item in response)
            {
            ...
            await foreach (ListTracesResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudtrace_v1_generated_TraceService_ListTraces_async_flattened]
}
