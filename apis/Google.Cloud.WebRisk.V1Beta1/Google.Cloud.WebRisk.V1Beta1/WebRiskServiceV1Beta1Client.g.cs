...
namespace Google.Cloud.WebRisk.V1Beta1
{
    ...
    public abstract partial class WebRiskServiceV1Beta1Client
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(WebRiskServiceV1Beta1.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
