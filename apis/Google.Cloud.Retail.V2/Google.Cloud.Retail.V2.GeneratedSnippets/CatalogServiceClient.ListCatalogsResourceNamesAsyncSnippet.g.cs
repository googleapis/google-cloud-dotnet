...
{
    // [START retail_v2_generated_CatalogService_ListCatalogs_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCatalogServiceClientSnippets
    {
        ...
        public async Task ListCatalogsResourceNamesAsync()
        {
            ...
            await foreach (Catalog item in response)
            {
            ...
            await foreach (ListCatalogsResponse page in response.AsRawResponses())
            {
    ...
    // [END retail_v2_generated_CatalogService_ListCatalogs_async_flattened_resourceNames]
}
