...
namespace Google.Cloud.Retail.V2
{
    ...
    public sealed partial class ServingConfigServiceClientBuilder : gaxgrpc::ClientBuilderBase<ServingConfigServiceClient>
    {
        ...
        private ServingConfigServiceClient BuildImpl()
        {
            ...
            return ServingConfigServiceClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class ServingConfigServiceClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ServingConfigService.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
