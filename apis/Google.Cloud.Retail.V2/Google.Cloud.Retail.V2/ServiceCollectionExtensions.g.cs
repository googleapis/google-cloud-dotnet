...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gcrv::ConversationalSearchServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddConversationalSearchServiceClient(this IServiceCollection services, sys::Action<gcrv::ConversationalSearchServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gcrv::ConversationalSearchServiceClientBuilder builder = new gcrv::ConversationalSearchServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddConversationalSearchServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gcrv::ConversationalSearchServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gcrv::ConversationalSearchServiceClientBuilder builder = new gcrv::ConversationalSearchServiceClientBuilder();
                action?.Invoke(provider, builder);
