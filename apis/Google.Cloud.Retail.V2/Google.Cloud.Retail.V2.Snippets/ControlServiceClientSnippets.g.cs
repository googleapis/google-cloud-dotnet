...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedControlServiceClientSnippets
    {
        ...
        {
            // Snippet: CreateControl(CatalogName, Control, string, CallSettings)
            // Create client
            ControlServiceClient controlServiceClient = ControlServiceClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: CreateControlAsync(CatalogName, Control, string, CallSettings)
            // Additional: CreateControlAsync(CatalogName, Control, string, CancellationToken)
            // Create client
            ControlServiceClient controlServiceClient = await ControlServiceClient.CreateAsync();
            // Initialize request argument(s)
            CatalogName parent = CatalogName.FromProjectLocationCatalog("[PROJECT]", "[LOCATION]", "[CATALOG]");
        ...
        {
            // Snippet: ListControls(CatalogName, string, int?, CallSettings)
            // Create client
            ControlServiceClient controlServiceClient = ControlServiceClient.Create();
            // Initialize request argument(s)
            CatalogName parent = CatalogName.FromProjectLocationCatalog("[PROJECT]", "[LOCATION]", "[CATALOG]");
        ...
        {
            // Snippet: ListControlsAsync(CatalogName, string, int?, CallSettings)
            // Create client
            ControlServiceClient controlServiceClient = await ControlServiceClient.CreateAsync();
            // Initialize request argument(s)
            CatalogName parent = CatalogName.FromProjectLocationCatalog("[PROJECT]", "[LOCATION]", "[CATALOG]");
