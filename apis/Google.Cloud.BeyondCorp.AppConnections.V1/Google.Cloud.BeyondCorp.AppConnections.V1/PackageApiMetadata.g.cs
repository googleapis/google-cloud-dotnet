...
namespace Google.Cloud.BeyondCorp.AppConnections.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.BeyondCorp.AppConnections.V1", GetFileDescriptors)
        ...
        {
            yield return AppConnectionsServiceReflection.Descriptor;
