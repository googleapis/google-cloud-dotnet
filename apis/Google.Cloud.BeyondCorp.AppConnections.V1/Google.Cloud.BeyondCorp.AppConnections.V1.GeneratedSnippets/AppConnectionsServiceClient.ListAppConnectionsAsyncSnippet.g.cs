...
{
    // [START beyondcorp_v1_generated_AppConnectionsService_ListAppConnections_async_flattened]
    ...
    public sealed partial class GeneratedAppConnectionsServiceClientSnippets
    {
        ...
        public async Task ListAppConnectionsAsync()
        {
            ...
            await foreach (ListAppConnectionsResponse page in response.AsRawResponses())
            {
    ...
    // [END beyondcorp_v1_generated_AppConnectionsService_ListAppConnections_async_flattened]
}
