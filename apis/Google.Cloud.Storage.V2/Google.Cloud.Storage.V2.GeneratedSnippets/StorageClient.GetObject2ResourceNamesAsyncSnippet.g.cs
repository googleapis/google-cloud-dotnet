...
{
    // [START storage_v2_generated_Storage_GetObject_async_flattened2_resourceNames]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task GetObject2ResourceNamesAsync()
        {
            ...
            long generation = 0L;
            // Make the request
            Object response = await storageClient.GetObjectAsync(bucket, @object, generation);
        }
    }
    // [END storage_v2_generated_Storage_GetObject_async_flattened2_resourceNames]
}
