...
{
    // [START storage_v2_generated_Storage_CreateNotificationConfig_async]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task CreateNotificationConfigRequestObjectAsync()
        {
            ...
            // Make the request
            NotificationConfig response = await storageClient.CreateNotificationConfigAsync(request);
        }
    }
    // [END storage_v2_generated_Storage_CreateNotificationConfig_async]
}
