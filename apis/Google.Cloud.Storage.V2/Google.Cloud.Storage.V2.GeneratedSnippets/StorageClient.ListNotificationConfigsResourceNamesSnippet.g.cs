...
{
    // [START storage_v2_generated_Storage_ListNotificationConfigs_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public void ListNotificationConfigsResourceNames()
        {
            ...
            // Make the request
            PagedEnumerable<ListNotificationConfigsResponse, NotificationConfig> response = storageClient.ListNotificationConfigs(parent);
    ...
    // [END storage_v2_generated_Storage_ListNotificationConfigs_sync_flattened_resourceNames]
}
