...
{
    // [START storage_v2_generated_Storage_RestoreObject_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task RestoreObjectResourceNamesAsync()
        {
            ...
            long generation = 0L;
            // Make the request
            Object response = await storageClient.RestoreObjectAsync(bucket, @object, generation);
        }
    }
    // [END storage_v2_generated_Storage_RestoreObject_async_flattened_resourceNames]
}
