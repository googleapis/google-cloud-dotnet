...
{
    // [START storage_v2_generated_Storage_GetObject_async_flattened1]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task GetObject1Async()
        {
            ...
            string @object = "";
            // Make the request
            Object response = await storageClient.GetObjectAsync(bucket, @object);
        }
    }
    // [END storage_v2_generated_Storage_GetObject_async_flattened1]
}
