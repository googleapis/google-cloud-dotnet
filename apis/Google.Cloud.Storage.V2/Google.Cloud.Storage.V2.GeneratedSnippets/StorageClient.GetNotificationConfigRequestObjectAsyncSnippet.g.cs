...
{
    // [START storage_v2_generated_Storage_GetNotificationConfig_async]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task GetNotificationConfigRequestObjectAsync()
        {
            ...
            {
                NotificationConfigName = NotificationConfigName.FromProjectBucketNotificationConfig("[PROJECT]", "[BUCKET]", "[NOTIFICATION_CONFIG]"),
            };
            // Make the request
            NotificationConfig response = await storageClient.GetNotificationConfigAsync(request);
        }
    }
    // [END storage_v2_generated_Storage_GetNotificationConfig_async]
}
