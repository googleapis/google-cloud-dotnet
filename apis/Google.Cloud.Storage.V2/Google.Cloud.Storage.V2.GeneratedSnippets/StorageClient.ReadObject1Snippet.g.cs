...
{
    // [START storage_v2_generated_Storage_ReadObject_sync_flattened1]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task ReadObject1()
        {
            ...
            using StorageClient.ReadObjectStream response = storageClient.ReadObject(bucket, @object);
    ...
    // [END storage_v2_generated_Storage_ReadObject_sync_flattened1]
}
