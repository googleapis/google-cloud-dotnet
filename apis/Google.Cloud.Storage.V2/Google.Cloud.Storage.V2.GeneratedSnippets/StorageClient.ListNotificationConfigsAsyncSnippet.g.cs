...
{
    // [START storage_v2_generated_Storage_ListNotificationConfigs_async_flattened]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task ListNotificationConfigsAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListNotificationConfigsResponse, NotificationConfig> response = storageClient.ListNotificationConfigsAsync(parent);
    ...
    // [END storage_v2_generated_Storage_ListNotificationConfigs_async_flattened]
}
