...
{
    // [START storage_v2_generated_Storage_CreateNotificationConfig_async_flattened]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task CreateNotificationConfigAsync()
        {
            ...
            // Make the request
            NotificationConfig response = await storageClient.CreateNotificationConfigAsync(parent, notificationConfig);
        }
    }
    // [END storage_v2_generated_Storage_CreateNotificationConfig_async_flattened]
}
