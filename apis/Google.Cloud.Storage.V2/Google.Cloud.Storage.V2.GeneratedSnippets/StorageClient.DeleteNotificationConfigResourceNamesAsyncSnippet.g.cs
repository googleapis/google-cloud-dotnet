...
{
    // [START storage_v2_generated_Storage_DeleteNotificationConfig_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task DeleteNotificationConfigResourceNamesAsync()
        {
            ...
            NotificationConfigName name = NotificationConfigName.FromProjectBucketNotificationConfig("[PROJECT]", "[BUCKET]", "[NOTIFICATION_CONFIG]");
            // Make the request
            await storageClient.DeleteNotificationConfigAsync(name);
        }
    }
    // [END storage_v2_generated_Storage_DeleteNotificationConfig_async_flattened_resourceNames]
}
