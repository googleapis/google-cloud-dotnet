...
{
    // [START storage_v2_generated_Storage_MoveObject_async_flattened]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task MoveObjectAsync()
        {
            ...
            // Make the request
            Object response = await storageClient.MoveObjectAsync(bucket, sourceObject, destinationObject);
        }
    }
    // [END storage_v2_generated_Storage_MoveObject_async_flattened]
}
