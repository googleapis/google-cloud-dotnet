...
{
    // [START storage_v2_generated_Storage_ListNotificationConfigs_async]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task ListNotificationConfigsRequestObjectAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListNotificationConfigsResponse, NotificationConfig> response = storageClient.ListNotificationConfigsAsync(request);
    ...
    // [END storage_v2_generated_Storage_ListNotificationConfigs_async]
}
