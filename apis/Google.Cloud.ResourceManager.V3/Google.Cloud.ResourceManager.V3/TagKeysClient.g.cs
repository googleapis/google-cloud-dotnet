...
namespace Google.Cloud.ResourceManager.V3
{
    ...
    public sealed partial class TagKeysClientBuilder : gaxgrpc::ClientBuilderBase<TagKeysClient>
    {
        ...
        private TagKeysClient BuildImpl()
        {
            ...
            return TagKeysClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class TagKeysClient
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(TagKeys.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
