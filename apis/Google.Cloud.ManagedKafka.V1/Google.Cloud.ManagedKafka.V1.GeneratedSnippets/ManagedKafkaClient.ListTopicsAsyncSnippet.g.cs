...
{
    // [START managedkafka_v1_generated_ManagedKafka_ListTopics_async_flattened]
    ...
    public sealed partial class GeneratedManagedKafkaClientSnippets
    {
        ...
        public async Task ListTopicsAsync()
        {
            ...
            await foreach (Topic item in response)
            {
            ...
            await foreach (ListTopicsResponse page in response.AsRawResponses())
            {
    ...
    // [END managedkafka_v1_generated_ManagedKafka_ListTopics_async_flattened]
}
