...
{
    // [START managedkafka_v1_generated_ManagedKafka_ListAcls_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedManagedKafkaClientSnippets
    {
        ...
        public async Task ListAclsResourceNamesAsync()
        {
            ...
            await foreach (Acl item in response)
            {
            ...
            await foreach (ListAclsResponse page in response.AsRawResponses())
            {
    ...
    // [END managedkafka_v1_generated_ManagedKafka_ListAcls_async_flattened_resourceNames]
}
