...
{
    // [START managedkafka_v1_generated_ManagedKafka_ListConsumerGroups_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedManagedKafkaClientSnippets
    {
        ...
        public async Task ListConsumerGroupsResourceNamesAsync()
        {
            ...
            await foreach (ConsumerGroup item in response)
            {
            ...
            await foreach (ListConsumerGroupsResponse page in response.AsRawResponses())
            {
    ...
    // [END managedkafka_v1_generated_ManagedKafka_ListConsumerGroups_async_flattened_resourceNames]
}
