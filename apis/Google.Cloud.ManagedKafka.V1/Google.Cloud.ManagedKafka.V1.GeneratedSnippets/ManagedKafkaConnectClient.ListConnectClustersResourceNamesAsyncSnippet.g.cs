...
{
    // [START managedkafka_v1_generated_ManagedKafkaConnect_ListConnectClusters_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedManagedKafkaConnectClientSnippets
    {
        ...
        public async Task ListConnectClustersResourceNamesAsync()
        {
            ...
            await foreach (ConnectCluster item in response)
            {
            ...
            await foreach (ListConnectClustersResponse page in response.AsRawResponses())
            {
    ...
    // [END managedkafka_v1_generated_ManagedKafkaConnect_ListConnectClusters_async_flattened_resourceNames]
}
