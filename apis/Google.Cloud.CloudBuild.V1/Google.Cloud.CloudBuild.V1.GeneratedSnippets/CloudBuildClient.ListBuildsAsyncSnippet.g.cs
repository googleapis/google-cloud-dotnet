...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedCloudBuildClientSnippets
    {
        ...
        public async Task ListBuildsAsync()
        {
            ...
            await foreach (Build item in response)
            {
            ...
            await foreach (ListBuildsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudbuild_v1_generated_CloudBuild_ListBuilds_async_flattened]
}
