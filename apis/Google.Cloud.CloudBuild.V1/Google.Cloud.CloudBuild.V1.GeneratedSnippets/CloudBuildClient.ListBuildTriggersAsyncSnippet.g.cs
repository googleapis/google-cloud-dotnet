...
{
    // [START cloudbuild_v1_generated_CloudBuild_ListBuildTriggers_async_flattened]
    ...
    public sealed partial class GeneratedCloudBuildClientSnippets
    {
        ...
        public async Task ListBuildTriggersAsync()
        {
            ...
            await foreach (BuildTrigger item in response)
            {
            ...
            await foreach (ListBuildTriggersResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudbuild_v1_generated_CloudBuild_ListBuildTriggers_async_flattened]
}
