...
{
    /// <summary>Resource name for the <c>DefaultServiceAccount</c> resource.</summary>
    public sealed partial class DefaultServiceAccountName : gax::IResourceName, sys::IEquatable<DefaultServiceAccountName>
    {
        /// <summary>The possible contents of <see cref="DefaultServiceAccountName"/>.</summary>
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/defaultServiceAccount</c>.
            /// </summary>
            ProjectLocation = 1,
        }

        private static gax::PathTemplate s_projectLocation = new gax::PathTemplate("projects/{project}/locations/{location}/defaultServiceAccount");

        /// <summary>Creates a <see cref="DefaultServiceAccountName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="DefaultServiceAccountName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static DefaultServiceAccountName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new DefaultServiceAccountName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="DefaultServiceAccountName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/defaultServiceAccount</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// A new instance of <see cref="DefaultServiceAccountName"/> constructed from the provided ids.
        /// </returns>
        public static DefaultServiceAccountName FromProjectLocation(string projectId, string locationId) =>
            new DefaultServiceAccountName(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="DefaultServiceAccountName"/> with pattern
        /// <c>projects/{project}/locations/{location}/defaultServiceAccount</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="DefaultServiceAccountName"/> with pattern
        /// <c>projects/{project}/locations/{location}/defaultServiceAccount</c>.
        /// </returns>
        ...
        /// <summary>
        /// Parses the given resource name string into a new <see cref="DefaultServiceAccountName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/defaultServiceAccount</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        /// <param name="defaultServiceAccountName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="DefaultServiceAccountName"/> if successful.</returns>
        public static DefaultServiceAccountName Parse(string defaultServiceAccountName) =>
            Parse(defaultServiceAccountName, false);
        ...
        /// </param>
        /// <returns>The parsed <see cref="DefaultServiceAccountName"/> if successful.</returns>
        public static DefaultServiceAccountName Parse(string defaultServiceAccountName, bool allowUnparsed) =>
            TryParse(defaultServiceAccountName, allowUnparsed, out DefaultServiceAccountName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="DefaultServiceAccountName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="defaultServiceAccountName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="DefaultServiceAccountName"/>, or <c>null</c> if parsing
        /// failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string defaultServiceAccountName, out DefaultServiceAccountName result) =>
            TryParse(defaultServiceAccountName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string defaultServiceAccountName, bool allowUnparsed, out DefaultServiceAccountName result)
        {
            gax::GaxPreconditions.CheckNotNull(defaultServiceAccountName, nameof(defaultServiceAccountName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocation.TryParseName(defaultServiceAccountName, out resourceName))
            {
            ...
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(defaultServiceAccountName, out gax::UnparsedResourceName unparsedResourceName))
                {
        ...
        private DefaultServiceAccountName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="DefaultServiceAccountName"/> class from the component parts of
        /// pattern <c>projects/{project}/locations/{location}/defaultServiceAccount</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        public DefaultServiceAccountName(string projectId, string locationId) : this(ResourceNameType.ProjectLocation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as DefaultServiceAccountName);

        /// <inheritdoc/>
        public bool Equals(DefaultServiceAccountName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(DefaultServiceAccountName a, DefaultServiceAccountName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(DefaultServiceAccountName a, DefaultServiceAccountName b) => !(a == b);
    }
    ...
    public partial class GetDefaultServiceAccountRequest
    {
        /// <summary>
        /// <see cref="gccv::DefaultServiceAccountName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gccv::DefaultServiceAccountName DefaultServiceAccountName
        {
            get => string.IsNullOrEmpty(Name) ? null : gccv::DefaultServiceAccountName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class DefaultServiceAccount
    {
        /// <summary>
        /// <see cref="gccv::DefaultServiceAccountName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class ConnectedRepository
    {
        /// <summary>
    ...
    public partial class Dependency
    {
        ...
        {
            public partial class GitSourceRepository
            {
                /// <summary>
                /// <see cref="GitRepositoryLinkName"/>-typed view over the <see cref="DeveloperConnect"/> resource name
                /// property.
                /// </summary>
                public GitRepositoryLinkName DeveloperConnectAsGitRepositoryLinkName
                {
                    get => string.IsNullOrEmpty(DeveloperConnect) ? null : GitRepositoryLinkName.Parse(DeveloperConnect, allowUnparsed: true);
                    set => DeveloperConnect = value?.ToString() ?? "";
                }
            }
        }
    }
    ...
    public partial class PrivatePoolV1Config
    {
        public partial class Types
        {
            ...
            public partial class PrivateServiceConnect
            {
                /// <summary>
                /// <see cref="NetworkAttachmentName"/>-typed view over the <see cref="NetworkAttachment"/> resource
                /// name property.
                /// </summary>
