...
{
    // [START edgenetwork_v1_generated_EdgeNetwork_ListRouters_async_flattened]
    ...
    public sealed partial class GeneratedEdgeNetworkClientSnippets
    {
        ...
        public async Task ListRoutersAsync()
        {
            ...
            await foreach (ListRoutersResponse page in response.AsRawResponses())
            {
    ...
    // [END edgenetwork_v1_generated_EdgeNetwork_ListRouters_async_flattened]
}
