...
{
    // [START edgenetwork_v1_generated_EdgeNetwork_ListInterconnects_async_flattened]
    ...
    public sealed partial class GeneratedEdgeNetworkClientSnippets
    {
        ...
        public async Task ListInterconnectsAsync()
        {
            ...
            await foreach (Interconnect item in response)
            {
            ...
            await foreach (ListInterconnectsResponse page in response.AsRawResponses())
            {
    ...
    // [END edgenetwork_v1_generated_EdgeNetwork_ListInterconnects_async_flattened]
}
