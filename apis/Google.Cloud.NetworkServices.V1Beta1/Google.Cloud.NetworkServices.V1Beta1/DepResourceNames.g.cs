...
namespace Google.Cloud.NetworkServices.V1Beta1
{
    ...
    /// <summary>Resource name for the <c>ExtensionBinding</c> resource.</summary>
    public sealed partial class ExtensionBindingName : gax::IResourceName, sys::IEquatable<ExtensionBindingName>
    {
        /// <summary>The possible contents of <see cref="ExtensionBindingName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/extensionBindings/{extension_binding}</c>.
            /// </summary>
            ProjectLocationExtensionBinding = 1,
        }

        private static gax::PathTemplate s_projectLocationExtensionBinding = new gax::PathTemplate("projects/{project}/locations/{location}/extensionBindings/{extension_binding}");

        /// <summary>Creates a <see cref="ExtensionBindingName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="ExtensionBindingName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static ExtensionBindingName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new ExtensionBindingName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="ExtensionBindingName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/extensionBindings/{extension_binding}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="extensionBindingId">The <c>ExtensionBinding</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="ExtensionBindingName"/> constructed from the provided ids.</returns>
        public static ExtensionBindingName FromProjectLocationExtensionBinding(string projectId, string locationId, string extensionBindingId) =>
            new ExtensionBindingName(ResourceNameType.ProjectLocationExtensionBinding, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), extensionBindingId: gax::GaxPreconditions.CheckNotNullOrEmpty(extensionBindingId, nameof(extensionBindingId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ExtensionBindingName"/> with pattern
        /// <c>projects/{project}/locations/{location}/extensionBindings/{extension_binding}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="extensionBindingId">The <c>ExtensionBinding</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="ExtensionBindingName"/> with pattern
        /// <c>projects/{project}/locations/{location}/extensionBindings/{extension_binding}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string extensionBindingId) =>
            FormatProjectLocationExtensionBinding(projectId, locationId, extensionBindingId);
        ...
        /// <c>projects/{project}/locations/{location}/extensionBindings/{extension_binding}</c>.
        /// </returns>
        public static string FormatProjectLocationExtensionBinding(string projectId, string locationId, string extensionBindingId) =>
            s_projectLocationExtensionBinding.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(extensionBindingId, nameof(extensionBindingId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ExtensionBindingName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="extensionBindingName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="ExtensionBindingName"/> if successful.</returns>
        public static ExtensionBindingName Parse(string extensionBindingName) => Parse(extensionBindingName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="ExtensionBindingName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="ExtensionBindingName"/> if successful.</returns>
        public static ExtensionBindingName Parse(string extensionBindingName, bool allowUnparsed) =>
            TryParse(extensionBindingName, allowUnparsed, out ExtensionBindingName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="ExtensionBindingName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="extensionBindingName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="ExtensionBindingName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string extensionBindingName, out ExtensionBindingName result) =>
            TryParse(extensionBindingName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string extensionBindingName, bool allowUnparsed, out ExtensionBindingName result)
        {
            gax::GaxPreconditions.CheckNotNull(extensionBindingName, nameof(extensionBindingName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationExtensionBinding.TryParseName(extensionBindingName, out resourceName))
            {
                result = FromProjectLocationExtensionBinding(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(extensionBindingName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private ExtensionBindingName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string extensionBindingId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            ExtensionBindingId = extensionBindingId;
            LocationId = locationId;
            ProjectId = projectId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="ExtensionBindingName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/extensionBindings/{extension_binding}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="extensionBindingId">The <c>ExtensionBinding</c> ID. Must not be <c>null</c> or empty.</param>
        public ExtensionBindingName(string projectId, string locationId, string extensionBindingId) : this(ResourceNameType.ProjectLocationExtensionBinding, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), extensionBindingId: gax::GaxPreconditions.CheckNotNullOrEmpty(extensionBindingId, nameof(extensionBindingId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ExtensionBinding</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        public string ExtensionBindingId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationExtensionBinding: return s_projectLocationExtensionBinding.Expand(ProjectId, LocationId, ExtensionBindingId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as ExtensionBindingName);

        /// <inheritdoc/>
        public bool Equals(ExtensionBindingName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(ExtensionBindingName a, ExtensionBindingName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(ExtensionBindingName a, ExtensionBindingName b) => !(a == b);
    }
    ...
    public partial class ExtensionBinding
    {
        /// <summary>
        /// <see cref="gcnv::ExtensionBindingName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcnv::ExtensionBindingName ExtensionBindingName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcnv::ExtensionBindingName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class ListExtensionBindingsRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class GetExtensionBindingRequest
    {
        /// <summary>
        /// <see cref="gcnv::ExtensionBindingName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    public partial class CreateExtensionBindingRequest
    {
        /// <summary>
        /// <see cref="gagr::LocationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
    ...
    public partial class DeleteExtensionBindingRequest
    {
        /// <summary>
        /// <see cref="gcnv::ExtensionBindingName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
