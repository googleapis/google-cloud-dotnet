...
namespace Google.Cloud.NetworkServices.V1Beta1
{
    ...
    public sealed partial class DepServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private DepServiceSettings(DepServiceSettings existing) : base(existing)
        {
            ...
            ListExtensionBindingsSettings = existing.ListExtensionBindingsSettings;
            GetExtensionBindingSettings = existing.GetExtensionBindingSettings;
            CreateExtensionBindingSettings = existing.CreateExtensionBindingSettings;
            CreateExtensionBindingOperationsSettings = existing.CreateExtensionBindingOperationsSettings.Clone();
            UpdateExtensionBindingSettings = existing.UpdateExtensionBindingSettings;
            UpdateExtensionBindingOperationsSettings = existing.UpdateExtensionBindingOperationsSettings.Clone();
            DeleteExtensionBindingSettings = existing.DeleteExtensionBindingSettings;
            DeleteExtensionBindingOperationsSettings = existing.DeleteExtensionBindingOperationsSettings.Clone();
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DepServiceClient.ListExtensionBindings</c> and <c>DepServiceClient.ListExtensionBindingsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListExtensionBindingsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DepServiceClient.GetExtensionBinding</c> and <c>DepServiceClient.GetExtensionBindingAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetExtensionBindingSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DepServiceClient.CreateExtensionBinding</c> and <c>DepServiceClient.CreateExtensionBindingAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings CreateExtensionBindingSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// Long Running Operation settings for calls to <c>DepServiceClient.CreateExtensionBinding</c> and
        /// <c>DepServiceClient.CreateExtensionBindingAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public lro::OperationsSettings CreateExtensionBindingOperationsSettings { get; set; } = new lro::OperationsSettings
        {
            DefaultPollSettings = new gax::PollSettings(gax::Expiration.FromTimeout(sys::TimeSpan.FromHours(24)), sys::TimeSpan.FromSeconds(20), 1.5, sys::TimeSpan.FromSeconds(45)),
        };
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DepServiceClient.UpdateExtensionBinding</c> and <c>DepServiceClient.UpdateExtensionBindingAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UpdateExtensionBindingSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// Long Running Operation settings for calls to <c>DepServiceClient.UpdateExtensionBinding</c> and
        /// <c>DepServiceClient.UpdateExtensionBindingAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public lro::OperationsSettings UpdateExtensionBindingOperationsSettings { get; set; } = new lro::OperationsSettings
        {
            DefaultPollSettings = new gax::PollSettings(gax::Expiration.FromTimeout(sys::TimeSpan.FromHours(24)), sys::TimeSpan.FromSeconds(20), 1.5, sys::TimeSpan.FromSeconds(45)),
        };
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DepServiceClient.DeleteExtensionBinding</c> and <c>DepServiceClient.DeleteExtensionBindingAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings DeleteExtensionBindingSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// Long Running Operation settings for calls to <c>DepServiceClient.DeleteExtensionBinding</c> and
        /// <c>DepServiceClient.DeleteExtensionBindingAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public lro::OperationsSettings DeleteExtensionBindingOperationsSettings { get; set; } = new lro::OperationsSettings
        {
            DefaultPollSettings = new gax::PollSettings(gax::Expiration.FromTimeout(sys::TimeSpan.FromHours(24)), sys::TimeSpan.FromSeconds(20), 1.5, sys::TimeSpan.FromSeconds(45)),
        };
    ...
    public abstract partial class DepServiceClient
    {
        ...
        /// <param name="request">The request object containing all of the parameters for the API call.</param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="ExtensionBinding"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListExtensionBindingsResponse, ExtensionBinding> ListExtensionBindings(ListExtensionBindingsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="request">The request object containing all of the parameters for the API call.</param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="ExtensionBinding"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListExtensionBindingsResponse, ExtensionBinding> ListExtensionBindingsAsync(ListExtensionBindingsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="ExtensionBinding"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListExtensionBindingsResponse, ExtensionBinding> ListExtensionBindings(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ...
            return ListExtensionBindings(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="ExtensionBinding"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListExtensionBindingsResponse, ExtensionBinding> ListExtensionBindingsAsync(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListExtensionBindingsRequest request = new ListExtensionBindingsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
            ...
            return ListExtensionBindingsAsync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="ExtensionBinding"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListExtensionBindingsResponse, ExtensionBinding> ListExtensionBindings(gagr::LocationName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListExtensionBindingsRequest request = new ListExtensionBindingsRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="ExtensionBinding"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListExtensionBindingsResponse, ExtensionBinding> ListExtensionBindingsAsync(gagr::LocationName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListExtensionBindingsRequest request = new ListExtensionBindingsRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ExtensionBinding GetExtensionBinding(GetExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ExtensionBinding> GetExtensionBindingAsync(GetExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ExtensionBinding> GetExtensionBindingAsync(GetExtensionBindingRequest request, st::CancellationToken cancellationToken) =>
            GetExtensionBindingAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ExtensionBinding GetExtensionBinding(string name, gaxgrpc::CallSettings callSettings = null) =>
            GetExtensionBinding(new GetExtensionBindingRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ExtensionBinding> GetExtensionBindingAsync(string name, gaxgrpc::CallSettings callSettings = null) =>
            GetExtensionBindingAsync(new GetExtensionBindingRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ExtensionBinding> GetExtensionBindingAsync(string name, st::CancellationToken cancellationToken) =>
            GetExtensionBindingAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ExtensionBinding GetExtensionBinding(ExtensionBindingName name, gaxgrpc::CallSettings callSettings = null) =>
            GetExtensionBinding(new GetExtensionBindingRequest
            {
                ExtensionBindingName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ExtensionBinding> GetExtensionBindingAsync(ExtensionBindingName name, gaxgrpc::CallSettings callSettings = null) =>
            GetExtensionBindingAsync(new GetExtensionBindingRequest
            {
                ExtensionBindingName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ExtensionBinding> GetExtensionBindingAsync(ExtensionBindingName name, st::CancellationToken cancellationToken) =>
            GetExtensionBindingAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<ExtensionBinding, OperationMetadata> CreateExtensionBinding(CreateExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> CreateExtensionBindingAsync(CreateExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> CreateExtensionBindingAsync(CreateExtensionBindingRequest request, st::CancellationToken cancellationToken) =>
            CreateExtensionBindingAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));

        /// <summary>The long-running operations client for <c>CreateExtensionBinding</c>.</summary>
        public virtual lro::OperationsClient CreateExtensionBindingOperationsClient => throw new sys::NotImplementedException();

        /// <summary>
        /// Poll an operation once, using an <c>operationName</c> from a previous invocation of
        /// <c>CreateExtensionBinding</c>.
        /// </summary>
        /// <param name="operationName">
        /// The name of a previously invoked operation. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The result of polling the operation.</returns>
        public virtual lro::Operation<ExtensionBinding, OperationMetadata> PollOnceCreateExtensionBinding(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<ExtensionBinding, OperationMetadata>.PollOnceFromName(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), CreateExtensionBindingOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A task representing the result of polling the operation.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> PollOnceCreateExtensionBindingAsync(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<ExtensionBinding, OperationMetadata>.PollOnceFromNameAsync(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), CreateExtensionBindingOperationsClient, callSettings);
        ...
        /// in the format `projects/{project}/locations/{location}`.
        /// </param>
        /// <param name="extensionBinding">
        /// Required. `ExtensionBinding` resource to be created.
        /// </param>
        /// <param name="extensionBindingId">
        /// Required. Short name of the `ExtensionBinding` resource to be created.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<ExtensionBinding, OperationMetadata> CreateExtensionBinding(string parent, ExtensionBinding extensionBinding, string extensionBindingId, gaxgrpc::CallSettings callSettings = null) =>
            CreateExtensionBinding(new CreateExtensionBindingRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                ExtensionBindingId = gax::GaxPreconditions.CheckNotNullOrEmpty(extensionBindingId, nameof(extensionBindingId)),
                ExtensionBinding = gax::GaxPreconditions.CheckNotNull(extensionBinding, nameof(extensionBinding)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> CreateExtensionBindingAsync(string parent, ExtensionBinding extensionBinding, string extensionBindingId, gaxgrpc::CallSettings callSettings = null) =>
            CreateExtensionBindingAsync(new CreateExtensionBindingRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                ExtensionBindingId = gax::GaxPreconditions.CheckNotNullOrEmpty(extensionBindingId, nameof(extensionBindingId)),
                ExtensionBinding = gax::GaxPreconditions.CheckNotNull(extensionBinding, nameof(extensionBinding)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> CreateExtensionBindingAsync(string parent, ExtensionBinding extensionBinding, string extensionBindingId, st::CancellationToken cancellationToken) =>
            CreateExtensionBindingAsync(parent, extensionBinding, extensionBindingId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<ExtensionBinding, OperationMetadata> CreateExtensionBinding(gagr::LocationName parent, ExtensionBinding extensionBinding, string extensionBindingId, gaxgrpc::CallSettings callSettings = null) =>
            CreateExtensionBinding(new CreateExtensionBindingRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                ExtensionBindingId = gax::GaxPreconditions.CheckNotNullOrEmpty(extensionBindingId, nameof(extensionBindingId)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> CreateExtensionBindingAsync(gagr::LocationName parent, ExtensionBinding extensionBinding, string extensionBindingId, gaxgrpc::CallSettings callSettings = null) =>
            CreateExtensionBindingAsync(new CreateExtensionBindingRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                ExtensionBindingId = gax::GaxPreconditions.CheckNotNullOrEmpty(extensionBindingId, nameof(extensionBindingId)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> CreateExtensionBindingAsync(gagr::LocationName parent, ExtensionBinding extensionBinding, string extensionBindingId, st::CancellationToken cancellationToken) =>
            CreateExtensionBindingAsync(parent, extensionBinding, extensionBindingId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<ExtensionBinding, OperationMetadata> UpdateExtensionBinding(UpdateExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> UpdateExtensionBindingAsync(UpdateExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> UpdateExtensionBindingAsync(UpdateExtensionBindingRequest request, st::CancellationToken cancellationToken) =>
            UpdateExtensionBindingAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));

        /// <summary>The long-running operations client for <c>UpdateExtensionBinding</c>.</summary>
        public virtual lro::OperationsClient UpdateExtensionBindingOperationsClient => throw new sys::NotImplementedException();

        /// <summary>
        /// Poll an operation once, using an <c>operationName</c> from a previous invocation of
        /// <c>UpdateExtensionBinding</c>.
        /// </summary>
        /// <param name="operationName">
        /// The name of a previously invoked operation. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The result of polling the operation.</returns>
        public virtual lro::Operation<ExtensionBinding, OperationMetadata> PollOnceUpdateExtensionBinding(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<ExtensionBinding, OperationMetadata>.PollOnceFromName(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), UpdateExtensionBindingOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A task representing the result of polling the operation.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> PollOnceUpdateExtensionBindingAsync(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<ExtensionBinding, OperationMetadata>.PollOnceFromNameAsync(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), UpdateExtensionBindingOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<ExtensionBinding, OperationMetadata> UpdateExtensionBinding(ExtensionBinding extensionBinding, wkt::FieldMask updateMask, gaxgrpc::CallSettings callSettings = null) =>
            UpdateExtensionBinding(new UpdateExtensionBindingRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> UpdateExtensionBindingAsync(ExtensionBinding extensionBinding, wkt::FieldMask updateMask, gaxgrpc::CallSettings callSettings = null) =>
            UpdateExtensionBindingAsync(new UpdateExtensionBindingRequest
            {
                UpdateMask = updateMask,
                ExtensionBinding = gax::GaxPreconditions.CheckNotNull(extensionBinding, nameof(extensionBinding)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> UpdateExtensionBindingAsync(ExtensionBinding extensionBinding, wkt::FieldMask updateMask, st::CancellationToken cancellationToken) =>
            UpdateExtensionBindingAsync(extensionBinding, updateMask, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<wkt::Empty, OperationMetadata> DeleteExtensionBinding(DeleteExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, OperationMetadata>> DeleteExtensionBindingAsync(DeleteExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, OperationMetadata>> DeleteExtensionBindingAsync(DeleteExtensionBindingRequest request, st::CancellationToken cancellationToken) =>
            DeleteExtensionBindingAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));

        /// <summary>The long-running operations client for <c>DeleteExtensionBinding</c>.</summary>
        public virtual lro::OperationsClient DeleteExtensionBindingOperationsClient => throw new sys::NotImplementedException();

        /// <summary>
        /// Poll an operation once, using an <c>operationName</c> from a previous invocation of
        /// <c>DeleteExtensionBinding</c>.
        /// </summary>
        /// <param name="operationName">
        /// The name of a previously invoked operation. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The result of polling the operation.</returns>
        public virtual lro::Operation<wkt::Empty, OperationMetadata> PollOnceDeleteExtensionBinding(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<wkt::Empty, OperationMetadata>.PollOnceFromName(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), DeleteExtensionBindingOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A task representing the result of polling the operation.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, OperationMetadata>> PollOnceDeleteExtensionBindingAsync(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<wkt::Empty, OperationMetadata>.PollOnceFromNameAsync(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), DeleteExtensionBindingOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<wkt::Empty, OperationMetadata> DeleteExtensionBinding(string name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteExtensionBinding(new DeleteExtensionBindingRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, OperationMetadata>> DeleteExtensionBindingAsync(string name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteExtensionBindingAsync(new DeleteExtensionBindingRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, OperationMetadata>> DeleteExtensionBindingAsync(string name, st::CancellationToken cancellationToken) =>
            DeleteExtensionBindingAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<wkt::Empty, OperationMetadata> DeleteExtensionBinding(ExtensionBindingName name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteExtensionBinding(new DeleteExtensionBindingRequest
            {
                ExtensionBindingName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, OperationMetadata>> DeleteExtensionBindingAsync(ExtensionBindingName name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteExtensionBindingAsync(new DeleteExtensionBindingRequest
            {
                ExtensionBindingName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<wkt::Empty, OperationMetadata>> DeleteExtensionBindingAsync(ExtensionBindingName name, st::CancellationToken cancellationToken) =>
            DeleteExtensionBindingAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
    ...
    public sealed partial class DepServiceClientImpl : DepServiceClient
    {
        ...
        private readonly gaxgrpc::ApiCall<ListExtensionBindingsRequest, ListExtensionBindingsResponse> _callListExtensionBindings;

        private readonly gaxgrpc::ApiCall<GetExtensionBindingRequest, ExtensionBinding> _callGetExtensionBinding;

        private readonly gaxgrpc::ApiCall<CreateExtensionBindingRequest, lro::Operation> _callCreateExtensionBinding;

        private readonly gaxgrpc::ApiCall<UpdateExtensionBindingRequest, lro::Operation> _callUpdateExtensionBinding;

        private readonly gaxgrpc::ApiCall<DeleteExtensionBindingRequest, lro::Operation> _callDeleteExtensionBinding;
        ...
        public DepServiceClientImpl(DepService.DepServiceClient grpcClient, DepServiceSettings settings, mel::ILogger logger)
        {
            ...
            CreateExtensionBindingOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.CreateExtensionBindingOperationsSettings, logger);
            UpdateExtensionBindingOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.UpdateExtensionBindingOperationsSettings, logger);
            DeleteExtensionBindingOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.DeleteExtensionBindingOperationsSettings, logger);
            ...
            _callListExtensionBindings = clientHelper.BuildApiCall<ListExtensionBindingsRequest, ListExtensionBindingsResponse>("ListExtensionBindings", grpcClient.ListExtensionBindingsAsync, grpcClient.ListExtensionBindings, effectiveSettings.ListExtensionBindingsSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callListExtensionBindings);
            Modify_ListExtensionBindingsApiCall(ref _callListExtensionBindings);
            _callGetExtensionBinding = clientHelper.BuildApiCall<GetExtensionBindingRequest, ExtensionBinding>("GetExtensionBinding", grpcClient.GetExtensionBindingAsync, grpcClient.GetExtensionBinding, effectiveSettings.GetExtensionBindingSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetExtensionBinding);
            Modify_GetExtensionBindingApiCall(ref _callGetExtensionBinding);
            _callCreateExtensionBinding = clientHelper.BuildApiCall<CreateExtensionBindingRequest, lro::Operation>("CreateExtensionBinding", grpcClient.CreateExtensionBindingAsync, grpcClient.CreateExtensionBinding, effectiveSettings.CreateExtensionBindingSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callCreateExtensionBinding);
            Modify_CreateExtensionBindingApiCall(ref _callCreateExtensionBinding);
            _callUpdateExtensionBinding = clientHelper.BuildApiCall<UpdateExtensionBindingRequest, lro::Operation>("UpdateExtensionBinding", grpcClient.UpdateExtensionBindingAsync, grpcClient.UpdateExtensionBinding, effectiveSettings.UpdateExtensionBindingSettings).WithGoogleRequestParam("extension_binding.name", request => request.ExtensionBinding?.Name);
            Modify_ApiCall(ref _callUpdateExtensionBinding);
            Modify_UpdateExtensionBindingApiCall(ref _callUpdateExtensionBinding);
            _callDeleteExtensionBinding = clientHelper.BuildApiCall<DeleteExtensionBindingRequest, lro::Operation>("DeleteExtensionBinding", grpcClient.DeleteExtensionBindingAsync, grpcClient.DeleteExtensionBinding, effectiveSettings.DeleteExtensionBindingSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callDeleteExtensionBinding);
            Modify_DeleteExtensionBindingApiCall(ref _callDeleteExtensionBinding);
        ...
        partial void Modify_ListExtensionBindingsApiCall(ref gaxgrpc::ApiCall<ListExtensionBindingsRequest, ListExtensionBindingsResponse> call);

        partial void Modify_GetExtensionBindingApiCall(ref gaxgrpc::ApiCall<GetExtensionBindingRequest, ExtensionBinding> call);

        partial void Modify_CreateExtensionBindingApiCall(ref gaxgrpc::ApiCall<CreateExtensionBindingRequest, lro::Operation> call);

        partial void Modify_UpdateExtensionBindingApiCall(ref gaxgrpc::ApiCall<UpdateExtensionBindingRequest, lro::Operation> call);

        partial void Modify_DeleteExtensionBindingApiCall(ref gaxgrpc::ApiCall<DeleteExtensionBindingRequest, lro::Operation> call);
        ...
        partial void Modify_ListExtensionBindingsRequest(ref ListExtensionBindingsRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_GetExtensionBindingRequest(ref GetExtensionBindingRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_CreateExtensionBindingRequest(ref CreateExtensionBindingRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_UpdateExtensionBindingRequest(ref UpdateExtensionBindingRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_DeleteExtensionBindingRequest(ref DeleteExtensionBindingRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="ExtensionBinding"/> resources.</returns>
        public override gax::PagedEnumerable<ListExtensionBindingsResponse, ExtensionBinding> ListExtensionBindings(ListExtensionBindingsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListExtensionBindingsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedEnumerable<ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>(_callListExtensionBindings, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="ExtensionBinding"/> resources.</returns>
        public override gax::PagedAsyncEnumerable<ListExtensionBindingsResponse, ExtensionBinding> ListExtensionBindingsAsync(ListExtensionBindingsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListExtensionBindingsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedAsyncEnumerable<ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>(_callListExtensionBindings, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override ExtensionBinding GetExtensionBinding(GetExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetExtensionBindingRequest(ref request, ref callSettings);
            return _callGetExtensionBinding.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<ExtensionBinding> GetExtensionBindingAsync(GetExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetExtensionBindingRequest(ref request, ref callSettings);
            return _callGetExtensionBinding.Async(request, callSettings);
        }

        /// <summary>The long-running operations client for <c>CreateExtensionBinding</c>.</summary>
        public override lro::OperationsClient CreateExtensionBindingOperationsClient { get; }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<ExtensionBinding, OperationMetadata> CreateExtensionBinding(CreateExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CreateExtensionBindingRequest(ref request, ref callSettings);
            return new lro::Operation<ExtensionBinding, OperationMetadata>(_callCreateExtensionBinding.Sync(request, callSettings), CreateExtensionBindingOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> CreateExtensionBindingAsync(CreateExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CreateExtensionBindingRequest(ref request, ref callSettings);
            return new lro::Operation<ExtensionBinding, OperationMetadata>(await _callCreateExtensionBinding.Async(request, callSettings).ConfigureAwait(false), CreateExtensionBindingOperationsClient);
        }

        /// <summary>The long-running operations client for <c>UpdateExtensionBinding</c>.</summary>
        public override lro::OperationsClient UpdateExtensionBindingOperationsClient { get; }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<ExtensionBinding, OperationMetadata> UpdateExtensionBinding(UpdateExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_UpdateExtensionBindingRequest(ref request, ref callSettings);
            return new lro::Operation<ExtensionBinding, OperationMetadata>(_callUpdateExtensionBinding.Sync(request, callSettings), UpdateExtensionBindingOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<ExtensionBinding, OperationMetadata>> UpdateExtensionBindingAsync(UpdateExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_UpdateExtensionBindingRequest(ref request, ref callSettings);
            return new lro::Operation<ExtensionBinding, OperationMetadata>(await _callUpdateExtensionBinding.Async(request, callSettings).ConfigureAwait(false), UpdateExtensionBindingOperationsClient);
        }

        /// <summary>The long-running operations client for <c>DeleteExtensionBinding</c>.</summary>
        public override lro::OperationsClient DeleteExtensionBindingOperationsClient { get; }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<wkt::Empty, OperationMetadata> DeleteExtensionBinding(DeleteExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_DeleteExtensionBindingRequest(ref request, ref callSettings);
            return new lro::Operation<wkt::Empty, OperationMetadata>(_callDeleteExtensionBinding.Sync(request, callSettings), DeleteExtensionBindingOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<wkt::Empty, OperationMetadata>> DeleteExtensionBindingAsync(DeleteExtensionBindingRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_DeleteExtensionBindingRequest(ref request, ref callSettings);
            return new lro::Operation<wkt::Empty, OperationMetadata>(await _callDeleteExtensionBinding.Async(request, callSettings).ConfigureAwait(false), DeleteExtensionBindingOperationsClient);
        }
    }
    ...
    public partial class ListExtensionBindingsRequest : gaxgrpc::IPageRequest
    {
    }
    ...
    public partial class ListExtensionBindingsResponse : gaxgrpc::IPageResponse<ExtensionBinding>
    {
        /// <summary>Returns an enumerator that iterates through the resources in this response.</summary>
        public scg::IEnumerator<ExtensionBinding> GetEnumerator() => ExtensionBindings.GetEnumerator();
