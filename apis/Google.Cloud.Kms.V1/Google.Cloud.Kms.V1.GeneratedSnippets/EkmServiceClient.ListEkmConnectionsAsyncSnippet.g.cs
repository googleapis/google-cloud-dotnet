...
{
    // [START cloudkms_v1_generated_EkmService_ListEkmConnections_async_flattened]
    ...
    public sealed partial class GeneratedEkmServiceClientSnippets
    {
        ...
        public async Task ListEkmConnectionsAsync()
        {
            ...
            await foreach (EkmConnection item in response)
            {
            ...
            await foreach (ListEkmConnectionsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudkms_v1_generated_EkmService_ListEkmConnections_async_flattened]
}
