...
{
    // [START cloudkms_v1_generated_KeyManagementService_ListKeyRings_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedKeyManagementServiceClientSnippets
    {
        ...
        public async Task ListKeyRingsResourceNamesAsync()
        {
            ...
            await foreach (KeyRing item in response)
            {
            ...
            await foreach (ListKeyRingsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudkms_v1_generated_KeyManagementService_ListKeyRings_async_flattened_resourceNames]
}
