...
{
    // [START cloudkms_v1_generated_KeyManagementService_ListCryptoKeyVersions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedKeyManagementServiceClientSnippets
    {
        ...
        public async Task ListCryptoKeyVersionsResourceNamesAsync()
        {
            ...
            await foreach (CryptoKeyVersion item in response)
            {
            ...
            await foreach (ListCryptoKeyVersionsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudkms_v1_generated_KeyManagementService_ListCryptoKeyVersions_async_flattened_resourceNames]
}
