...
{
    // [START cloudkms_v1_generated_KeyManagementService_ListCryptoKeys_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedKeyManagementServiceClientSnippets
    {
        ...
        public async Task ListCryptoKeysResourceNamesAsync()
        {
            ...
            await foreach (CryptoKey item in response)
            {
    ...
    // [END cloudkms_v1_generated_KeyManagementService_ListCryptoKeys_async_flattened_resourceNames]
}
