...
namespace Google.Cloud.Kms.V1
{
    ...
    public abstract partial class KeyManagementServiceClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="KeyManagementServiceClient"/>, applying defaults for all unspecified
        ...
        /// <summary>
        /// Synchronously creates a <see cref="KeyManagementServiceClient"/>, applying defaults for all unspecified
        /// settings, and creating a channel connecting to the given endpoint with application default credentials where
        /// necessary. See the example for how to use custom credentials.
        /// </summary>
        /// <example>
        ...
        /// <see cref="Create(grpccore::CallInvoker,KeyManagementServiceSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,KeyManagementServiceSettings)"/>. Channels which weren't
        /// automatically created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to
        /// <see cref="Create(grpccore::CallInvoker,KeyManagementServiceSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,KeyManagementServiceSettings)"/> will create new channels,
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="CryptoKeyVersion"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListCryptoKeyVersionsResponse, CryptoKeyVersion> ListCryptoKeyVersions(KeyRingName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListCryptoKeyVersions(new ListCryptoKeyVersionsRequest
            {
                ParentAsKeyRingName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="CryptoKeyVersion"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListCryptoKeyVersionsResponse, CryptoKeyVersion> ListCryptoKeyVersionsAsync(KeyRingName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListCryptoKeyVersionsAsync(new ListCryptoKeyVersionsRequest
            {
                ParentAsKeyRingName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual EncryptResponse Encrypt(CryptoKeyName name, proto::ByteString plaintext, gaxgrpc::CallSettings callSettings = null) =>
            Encrypt(new EncryptRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<EncryptResponse> EncryptAsync(CryptoKeyName name, proto::ByteString plaintext, gaxgrpc::CallSettings callSettings = null) =>
            EncryptAsync(new EncryptRequest
            {
                CryptoKeyName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                Plaintext = gax::GaxPreconditions.CheckNotNull(plaintext, nameof(plaintext)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<EncryptResponse> EncryptAsync(CryptoKeyName name, proto::ByteString plaintext, st::CancellationToken cancellationToken) =>
            EncryptAsync(name, plaintext, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    public sealed partial class KeyManagementServiceClientImpl : KeyManagementServiceClient
    {
        ...
        public KeyManagementServiceClientImpl(KeyManagementService.KeyManagementServiceClient grpcClient, KeyManagementServiceSettings settings)
        {
            ...
            _callListKeyRings = clientHelper.BuildApiCall<ListKeyRingsRequest, ListKeyRingsResponse>(grpcClient.ListKeyRingsAsync, grpcClient.ListKeyRings, effectiveSettings.ListKeyRingsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListKeyRings);
            Modify_ListKeyRingsApiCall(ref _callListKeyRings);
            _callListCryptoKeys = clientHelper.BuildApiCall<ListCryptoKeysRequest, ListCryptoKeysResponse>(grpcClient.ListCryptoKeysAsync, grpcClient.ListCryptoKeys, effectiveSettings.ListCryptoKeysSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListCryptoKeys);
            Modify_ListCryptoKeysApiCall(ref _callListCryptoKeys);
            _callListCryptoKeyVersions = clientHelper.BuildApiCall<ListCryptoKeyVersionsRequest, ListCryptoKeyVersionsResponse>(grpcClient.ListCryptoKeyVersionsAsync, grpcClient.ListCryptoKeyVersions, effectiveSettings.ListCryptoKeyVersionsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListCryptoKeyVersions);
            Modify_ListCryptoKeyVersionsApiCall(ref _callListCryptoKeyVersions);
            _callListImportJobs = clientHelper.BuildApiCall<ListImportJobsRequest, ListImportJobsResponse>(grpcClient.ListImportJobsAsync, grpcClient.ListImportJobs, effectiveSettings.ListImportJobsSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callListImportJobs);
            Modify_ListImportJobsApiCall(ref _callListImportJobs);
            _callGetKeyRing = clientHelper.BuildApiCall<GetKeyRingRequest, KeyRing>(grpcClient.GetKeyRingAsync, grpcClient.GetKeyRing, effectiveSettings.GetKeyRingSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetKeyRing);
            Modify_GetKeyRingApiCall(ref _callGetKeyRing);
            _callGetCryptoKey = clientHelper.BuildApiCall<GetCryptoKeyRequest, CryptoKey>(grpcClient.GetCryptoKeyAsync, grpcClient.GetCryptoKey, effectiveSettings.GetCryptoKeySettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetCryptoKey);
            Modify_GetCryptoKeyApiCall(ref _callGetCryptoKey);
            _callGetCryptoKeyVersion = clientHelper.BuildApiCall<GetCryptoKeyVersionRequest, CryptoKeyVersion>(grpcClient.GetCryptoKeyVersionAsync, grpcClient.GetCryptoKeyVersion, effectiveSettings.GetCryptoKeyVersionSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetCryptoKeyVersion);
            Modify_GetCryptoKeyVersionApiCall(ref _callGetCryptoKeyVersion);
            _callGetPublicKey = clientHelper.BuildApiCall<GetPublicKeyRequest, PublicKey>(grpcClient.GetPublicKeyAsync, grpcClient.GetPublicKey, effectiveSettings.GetPublicKeySettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetPublicKey);
            Modify_GetPublicKeyApiCall(ref _callGetPublicKey);
            _callGetImportJob = clientHelper.BuildApiCall<GetImportJobRequest, ImportJob>(grpcClient.GetImportJobAsync, grpcClient.GetImportJob, effectiveSettings.GetImportJobSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callGetImportJob);
            Modify_GetImportJobApiCall(ref _callGetImportJob);
            _callCreateKeyRing = clientHelper.BuildApiCall<CreateKeyRingRequest, KeyRing>(grpcClient.CreateKeyRingAsync, grpcClient.CreateKeyRing, effectiveSettings.CreateKeyRingSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateKeyRing);
            Modify_CreateKeyRingApiCall(ref _callCreateKeyRing);
            _callCreateCryptoKey = clientHelper.BuildApiCall<CreateCryptoKeyRequest, CryptoKey>(grpcClient.CreateCryptoKeyAsync, grpcClient.CreateCryptoKey, effectiveSettings.CreateCryptoKeySettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateCryptoKey);
            Modify_CreateCryptoKeyApiCall(ref _callCreateCryptoKey);
            _callCreateCryptoKeyVersion = clientHelper.BuildApiCall<CreateCryptoKeyVersionRequest, CryptoKeyVersion>(grpcClient.CreateCryptoKeyVersionAsync, grpcClient.CreateCryptoKeyVersion, effectiveSettings.CreateCryptoKeyVersionSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateCryptoKeyVersion);
            Modify_CreateCryptoKeyVersionApiCall(ref _callCreateCryptoKeyVersion);
            _callImportCryptoKeyVersion = clientHelper.BuildApiCall<ImportCryptoKeyVersionRequest, CryptoKeyVersion>(grpcClient.ImportCryptoKeyVersionAsync, grpcClient.ImportCryptoKeyVersion, effectiveSettings.ImportCryptoKeyVersionSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callImportCryptoKeyVersion);
            Modify_ImportCryptoKeyVersionApiCall(ref _callImportCryptoKeyVersion);
            _callCreateImportJob = clientHelper.BuildApiCall<CreateImportJobRequest, ImportJob>(grpcClient.CreateImportJobAsync, grpcClient.CreateImportJob, effectiveSettings.CreateImportJobSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"parent={(sysnet::WebUtility.UrlEncode(request.Parent))}"));
            Modify_ApiCall(ref _callCreateImportJob);
            Modify_CreateImportJobApiCall(ref _callCreateImportJob);
            _callUpdateCryptoKey = clientHelper.BuildApiCall<UpdateCryptoKeyRequest, CryptoKey>(grpcClient.UpdateCryptoKeyAsync, grpcClient.UpdateCryptoKey, effectiveSettings.UpdateCryptoKeySettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"crypto_key.name={(sysnet::WebUtility.UrlEncode(request.CryptoKey.Name))}"));
            Modify_ApiCall(ref _callUpdateCryptoKey);
            Modify_UpdateCryptoKeyApiCall(ref _callUpdateCryptoKey);
            _callUpdateCryptoKeyVersion = clientHelper.BuildApiCall<UpdateCryptoKeyVersionRequest, CryptoKeyVersion>(grpcClient.UpdateCryptoKeyVersionAsync, grpcClient.UpdateCryptoKeyVersion, effectiveSettings.UpdateCryptoKeyVersionSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"crypto_key_version.name={(sysnet::WebUtility.UrlEncode(request.CryptoKeyVersion.Name))}"));
            Modify_ApiCall(ref _callUpdateCryptoKeyVersion);
            Modify_UpdateCryptoKeyVersionApiCall(ref _callUpdateCryptoKeyVersion);
            _callEncrypt = clientHelper.BuildApiCall<EncryptRequest, EncryptResponse>(grpcClient.EncryptAsync, grpcClient.Encrypt, effectiveSettings.EncryptSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callEncrypt);
            Modify_EncryptApiCall(ref _callEncrypt);
            _callDecrypt = clientHelper.BuildApiCall<DecryptRequest, DecryptResponse>(grpcClient.DecryptAsync, grpcClient.Decrypt, effectiveSettings.DecryptSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callDecrypt);
            Modify_DecryptApiCall(ref _callDecrypt);
            _callAsymmetricSign = clientHelper.BuildApiCall<AsymmetricSignRequest, AsymmetricSignResponse>(grpcClient.AsymmetricSignAsync, grpcClient.AsymmetricSign, effectiveSettings.AsymmetricSignSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callAsymmetricSign);
            Modify_AsymmetricSignApiCall(ref _callAsymmetricSign);
            _callAsymmetricDecrypt = clientHelper.BuildApiCall<AsymmetricDecryptRequest, AsymmetricDecryptResponse>(grpcClient.AsymmetricDecryptAsync, grpcClient.AsymmetricDecrypt, effectiveSettings.AsymmetricDecryptSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callAsymmetricDecrypt);
            Modify_AsymmetricDecryptApiCall(ref _callAsymmetricDecrypt);
            _callUpdateCryptoKeyPrimaryVersion = clientHelper.BuildApiCall<UpdateCryptoKeyPrimaryVersionRequest, CryptoKey>(grpcClient.UpdateCryptoKeyPrimaryVersionAsync, grpcClient.UpdateCryptoKeyPrimaryVersion, effectiveSettings.UpdateCryptoKeyPrimaryVersionSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            ...
            _callDestroyCryptoKeyVersion = clientHelper.BuildApiCall<DestroyCryptoKeyVersionRequest, CryptoKeyVersion>(grpcClient.DestroyCryptoKeyVersionAsync, grpcClient.DestroyCryptoKeyVersion, effectiveSettings.DestroyCryptoKeyVersionSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
            Modify_ApiCall(ref _callDestroyCryptoKeyVersion);
            Modify_DestroyCryptoKeyVersionApiCall(ref _callDestroyCryptoKeyVersion);
            _callRestoreCryptoKeyVersion = clientHelper.BuildApiCall<RestoreCryptoKeyVersionRequest, CryptoKeyVersion>(grpcClient.RestoreCryptoKeyVersionAsync, grpcClient.RestoreCryptoKeyVersion, effectiveSettings.RestoreCryptoKeyVersionSettings).WithCallSettingsOverlay(request => gaxgrpc::CallSettings.FromHeader("x-goog-request-params", $"name={(sysnet::WebUtility.UrlEncode(request.Name))}"));
