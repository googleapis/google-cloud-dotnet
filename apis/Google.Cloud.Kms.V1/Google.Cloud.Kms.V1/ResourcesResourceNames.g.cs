...
{
    /// <summary>Resource name for the <c>KeyRing</c> resource.</summary>
    public sealed partial class KeyRingName : gax::IResourceName, sys::IEquatable<KeyRingName>
    {
        /// <summary>The possible contents of <see cref="KeyRingName"/>.</summary>
        ...
        /// <summary>Creates a <see cref="KeyRingName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="KeyRingName"/> containing the provided <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static KeyRingName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new KeyRingName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="KeyRingName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/keyRings/{key_ring}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keyRingId">The <c>KeyRing</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="KeyRingName"/> constructed from the provided ids.</returns>
        public static KeyRingName FromProjectLocationKeyRing(string projectId, string locationId, string keyRingId) =>
            new KeyRingName(ResourceNameType.ProjectLocationKeyRing, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), keyRingId: gax::GaxPreconditions.CheckNotNullOrEmpty(keyRingId, nameof(keyRingId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="KeyRingName"/> with pattern
        /// <c>projects/{project}/locations/{location}/keyRings/{key_ring}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keyRingId">The <c>KeyRing</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="KeyRingName"/> with pattern
        /// <c>projects/{project}/locations/{location}/keyRings/{key_ring}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string keyRingId) =>
            FormatProjectLocationKeyRing(projectId, locationId, keyRingId);
        ...
        /// <c>projects/{project}/locations/{location}/keyRings/{key_ring}</c>.
        /// </returns>
        public static string FormatProjectLocationKeyRing(string projectId, string locationId, string keyRingId) =>
            s_projectLocationKeyRing.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(keyRingId, nameof(keyRingId)));

        /// <summary>Parses the given resource name string into a new <see cref="KeyRingName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>projects/{project}/locations/{location}/keyRings/{key_ring}</c></description></item>
        /// </list>
        /// </remarks>
        /// <param name="keyRingName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="KeyRingName"/> if successful.</returns>
        public static KeyRingName Parse(string keyRingName) => Parse(keyRingName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="KeyRingName"/> instance; optionally allowing an
        ...
        /// </param>
        /// <returns>The parsed <see cref="KeyRingName"/> if successful.</returns>
        public static KeyRingName Parse(string keyRingName, bool allowUnparsed) =>
            TryParse(keyRingName, allowUnparsed, out KeyRingName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="KeyRingName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="keyRingName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="KeyRingName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string keyRingName, out KeyRingName result) => TryParse(keyRingName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="KeyRingName"/> instance; optionally
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string keyRingName, bool allowUnparsed, out KeyRingName result)
        {
            gax::GaxPreconditions.CheckNotNull(keyRingName, nameof(keyRingName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationKeyRing.TryParseName(keyRingName, out resourceName))
            {
                result = FromProjectLocationKeyRing(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(keyRingName, out gax::UnparsedResourceName unparsedResourceName))
                {
        ...
        private KeyRingName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string keyRingId = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="KeyRingName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/keyRings/{key_ring}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keyRingId">The <c>KeyRing</c> ID. Must not be <c>null</c> or empty.</param>
        public KeyRingName(string projectId, string locationId, string keyRingId) : this(ResourceNameType.ProjectLocationKeyRing, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), keyRingId: gax::GaxPreconditions.CheckNotNullOrEmpty(keyRingId, nameof(keyRingId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationKeyRing: return s_projectLocationKeyRing.Expand(ProjectId, LocationId, KeyRingId);
    ...
    /// <summary>Resource name for the <c>PublicKey</c> resource.</summary>
    public sealed partial class PublicKeyName : gax::IResourceName, sys::IEquatable<PublicKeyName>
    {
        /// <summary>The possible contents of <see cref="PublicKeyName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
        ...
        /// <summary>Creates a <see cref="PublicKeyName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="PublicKeyName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static PublicKeyName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new PublicKeyName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="PublicKeyName"/> with the pattern
        /// <c>
        /// projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/publicKey</c>
        /// .
        /// </summary>
        ...
        /// <param name="cryptoKeyId">The <c>CryptoKey</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="cryptoKeyVersionId">The <c>CryptoKeyVersion</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="PublicKeyName"/> constructed from the provided ids.</returns>
        public static PublicKeyName FromProjectLocationKeyRingCryptoKeyCryptoKeyVersion(string projectId, string locationId, string keyRingId, string cryptoKeyId, string cryptoKeyVersionId) =>
            new PublicKeyName(ResourceNameType.ProjectLocationKeyRingCryptoKeyCryptoKeyVersion, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), keyRingId: gax::GaxPreconditions.CheckNotNullOrEmpty(keyRingId, nameof(keyRingId)), cryptoKeyId: gax::GaxPreconditions.CheckNotNullOrEmpty(cryptoKeyId, nameof(cryptoKeyId)), cryptoKeyVersionId: gax::GaxPreconditions.CheckNotNullOrEmpty(cryptoKeyVersionId, nameof(cryptoKeyVersionId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="PublicKeyName"/> with pattern
        /// <c>
        /// projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/publicKey</c>
        /// .
        /// </summary>
        ...
        /// <param name="cryptoKeyVersionId">The <c>CryptoKeyVersion</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="PublicKeyName"/> with pattern
        /// <c>
        /// projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/publicKey</c>
        /// .
        /// </returns>
        ...
        /// <summary>Parses the given resource name string into a new <see cref="PublicKeyName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        ...
        /// </list>
        /// </remarks>
        /// <param name="publicKeyName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="PublicKeyName"/> if successful.</returns>
        public static PublicKeyName Parse(string publicKeyName) => Parse(publicKeyName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="PublicKeyName"/> instance; optionally allowing
        /// an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="PublicKeyName"/> if successful.</returns>
        public static PublicKeyName Parse(string publicKeyName, bool allowUnparsed) =>
            TryParse(publicKeyName, allowUnparsed, out PublicKeyName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="PublicKeyName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="publicKeyName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="PublicKeyName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string publicKeyName, out PublicKeyName result) => TryParse(publicKeyName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="PublicKeyName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string publicKeyName, bool allowUnparsed, out PublicKeyName result)
        {
            gax::GaxPreconditions.CheckNotNull(publicKeyName, nameof(publicKeyName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationKeyRingCryptoKeyCryptoKeyVersion.TryParseName(publicKeyName, out resourceName))
            {
                result = FromProjectLocationKeyRingCryptoKeyCryptoKeyVersion(resourceName[0], resourceName[1], resourceName[2], resourceName[3], resourceName[4]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(publicKeyName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private PublicKeyName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string cryptoKeyId = null, string cryptoKeyVersionId = null, string keyRingId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CryptoKeyId = cryptoKeyId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="PublicKeyName"/> class from the component parts of pattern
        /// <c>
        /// projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/publicKey</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <param name="cryptoKeyId">The <c>CryptoKey</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="cryptoKeyVersionId">The <c>CryptoKeyVersion</c> ID. Must not be <c>null</c> or empty.</param>
        public PublicKeyName(string projectId, string locationId, string keyRingId, string cryptoKeyId, string cryptoKeyVersionId) : this(ResourceNameType.ProjectLocationKeyRingCryptoKeyCryptoKeyVersion, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), keyRingId: gax::GaxPreconditions.CheckNotNullOrEmpty(keyRingId, nameof(keyRingId)), cryptoKeyId: gax::GaxPreconditions.CheckNotNullOrEmpty(cryptoKeyId, nameof(cryptoKeyId)), cryptoKeyVersionId: gax::GaxPreconditions.CheckNotNullOrEmpty(cryptoKeyVersionId, nameof(cryptoKeyVersionId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as PublicKeyName);

        /// <inheritdoc/>
        public bool Equals(PublicKeyName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(PublicKeyName a, PublicKeyName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(PublicKeyName a, PublicKeyName b) => !(a == b);
    }
    ...
    public sealed partial class ImportJobName : gax::IResourceName, sys::IEquatable<ImportJobName>
    {
        ...
        public static ImportJobName FromProjectLocationKeyRingImportJob(string projectId, string locationId, string keyRingId, string importJobId) =>
            new ImportJobName(ResourceNameType.ProjectLocationKeyRingImportJob, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), keyRingId: gax::GaxPreconditions.CheckNotNullOrEmpty(keyRingId, nameof(keyRingId)), importJobId: gax::GaxPreconditions.CheckNotNullOrEmpty(importJobId, nameof(importJobId)));
        ...
        public static string Format(string projectId, string locationId, string keyRingId, string importJobId) =>
            FormatProjectLocationKeyRingImportJob(projectId, locationId, keyRingId, importJobId);
        ...
        public static string FormatProjectLocationKeyRingImportJob(string projectId, string locationId, string keyRingId, string importJobId) =>
            s_projectLocationKeyRingImportJob.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(keyRingId, nameof(keyRingId)), gax::GaxPreconditions.CheckNotNullOrEmpty(importJobId, nameof(importJobId)));
        ...
        public static bool TryParse(string importJobName, bool allowUnparsed, out ImportJobName result)
        {
            ...
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationKeyRingImportJob.TryParseName(importJobName, out resourceName))
            {
                result = FromProjectLocationKeyRingImportJob(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ImportJobName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string importJobId = null, string keyRingId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
        ...
        /// <param name="keyRingId">The <c>KeyRing</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="importJobId">The <c>ImportJob</c> ID. Must not be <c>null</c> or empty.</param>
        public ImportJobName(string projectId, string locationId, string keyRingId, string importJobId) : this(ResourceNameType.ProjectLocationKeyRingImportJob, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), keyRingId: gax::GaxPreconditions.CheckNotNullOrEmpty(keyRingId, nameof(keyRingId)), importJobId: gax::GaxPreconditions.CheckNotNullOrEmpty(importJobId, nameof(importJobId)))
        {
        }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationKeyRingImportJob: return s_projectLocationKeyRingImportJob.Expand(ProjectId, LocationId, KeyRingId, ImportJobId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
    ...
    /// <summary>Resource name for the <c>RetiredResource</c> resource.</summary>
    public sealed partial class RetiredResourceName : gax::IResourceName, sys::IEquatable<RetiredResourceName>
    {
        /// <summary>The possible contents of <see cref="RetiredResourceName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
            ...
            /// <summary>
            /// A resource name with pattern
            /// <c>projects/{project}/locations/{location}/retiredResources/{retired_resource}</c>.
            /// </summary>
            ProjectLocationRetiredResource = 1,
        }

        private static gax::PathTemplate s_projectLocationRetiredResource = new gax::PathTemplate("projects/{project}/locations/{location}/retiredResources/{retired_resource}");

        /// <summary>Creates a <see cref="RetiredResourceName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="RetiredResourceName"/> containing the provided
        /// <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static RetiredResourceName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new RetiredResourceName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="RetiredResourceName"/> with the pattern
        /// <c>projects/{project}/locations/{location}/retiredResources/{retired_resource}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="retiredResourceId">The <c>RetiredResource</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="RetiredResourceName"/> constructed from the provided ids.</returns>
        public static RetiredResourceName FromProjectLocationRetiredResource(string projectId, string locationId, string retiredResourceId) =>
            new RetiredResourceName(ResourceNameType.ProjectLocationRetiredResource, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), retiredResourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(retiredResourceId, nameof(retiredResourceId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="RetiredResourceName"/> with pattern
        /// <c>projects/{project}/locations/{location}/retiredResources/{retired_resource}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="retiredResourceId">The <c>RetiredResource</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="RetiredResourceName"/> with pattern
        /// <c>projects/{project}/locations/{location}/retiredResources/{retired_resource}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string retiredResourceId) =>
            FormatProjectLocationRetiredResource(projectId, locationId, retiredResourceId);
        ...
        /// <c>projects/{project}/locations/{location}/retiredResources/{retired_resource}</c>.
        /// </returns>
        public static string FormatProjectLocationRetiredResource(string projectId, string locationId, string retiredResourceId) =>
            s_projectLocationRetiredResource.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(retiredResourceId, nameof(retiredResourceId)));

        /// <summary>
        /// Parses the given resource name string into a new <see cref="RetiredResourceName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        /// <param name="retiredResourceName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="RetiredResourceName"/> if successful.</returns>
        public static RetiredResourceName Parse(string retiredResourceName) => Parse(retiredResourceName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="RetiredResourceName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns>The parsed <see cref="RetiredResourceName"/> if successful.</returns>
        public static RetiredResourceName Parse(string retiredResourceName, bool allowUnparsed) =>
            TryParse(retiredResourceName, allowUnparsed, out RetiredResourceName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="RetiredResourceName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="retiredResourceName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="RetiredResourceName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string retiredResourceName, out RetiredResourceName result) =>
            TryParse(retiredResourceName, false, out result);
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string retiredResourceName, bool allowUnparsed, out RetiredResourceName result)
        {
            gax::GaxPreconditions.CheckNotNull(retiredResourceName, nameof(retiredResourceName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationRetiredResource.TryParseName(retiredResourceName, out resourceName))
            {
                result = FromProjectLocationRetiredResource(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(retiredResourceName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private RetiredResourceName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string retiredResourceId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
            ProjectId = projectId;
            RetiredResourceId = retiredResourceId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="RetiredResourceName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/retiredResources/{retired_resource}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="retiredResourceId">The <c>RetiredResource</c> ID. Must not be <c>null</c> or empty.</param>
        public RetiredResourceName(string projectId, string locationId, string retiredResourceId) : this(ResourceNameType.ProjectLocationRetiredResource, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), retiredResourceId: gax::GaxPreconditions.CheckNotNullOrEmpty(retiredResourceId, nameof(retiredResourceId)))
        {
        }
        ...
        /// <summary>
        /// The <c>RetiredResource</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        public string RetiredResourceId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationRetiredResource: return s_projectLocationRetiredResource.Expand(ProjectId, LocationId, RetiredResourceId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as RetiredResourceName);

        /// <inheritdoc/>
        public bool Equals(RetiredResourceName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(RetiredResourceName a, RetiredResourceName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(RetiredResourceName a, RetiredResourceName b) => !(a == b);
    }
