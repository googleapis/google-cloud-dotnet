...
namespace Google.Cloud.Firestore.V1Beta1 {
    ...
    static FirestoreReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Cg9uZXh0X3BhZ2VfdG9rZW4YAiABKAkyrRIKCUZpcmVzdG9yZRKeAQoLR2V0",
            ...
            "LyovZGF0YWJhc2VzLyp9L2RvY3VtZW50czpyb2xsYmFjazoBKhKrAQoIUnVu",
            "UXVlcnkSKS5nb29nbGUuZmlyZXN0b3JlLnYxYmV0YTEuUnVuUXVlcnlSZXF1",
            "ZXN0GiouZ29vZ2xlLmZpcmVzdG9yZS52MWJldGExLlJ1blF1ZXJ5UmVzcG9u",
            "c2UiRoLT5JMCQCI7L3YxYmV0YTEve3BhcmVudD1wcm9qZWN0cy8qL2RhdGFi",
            "YXNlcy8qL2RvY3VtZW50c306cnVuUXVlcnk6ASowARKjAQoFV3JpdGUSJi5n",
            "b29nbGUuZmlyZXN0b3JlLnYxYmV0YTEuV3JpdGVSZXF1ZXN0GicuZ29vZ2xl",
            "LmZpcmVzdG9yZS52MWJldGExLldyaXRlUmVzcG9uc2UiRYLT5JMCPyI6L3Yx",
            "YmV0YTEve2RhdGFiYXNlPXByb2plY3RzLyovZGF0YWJhc2VzLyp9L2RvY3Vt",
            "ZW50czp3cml0ZToBKigBMAESpwEKBkxpc3RlbhInLmdvb2dsZS5maXJlc3Rv",
            "cmUudjFiZXRhMS5MaXN0ZW5SZXF1ZXN0GiguZ29vZ2xlLmZpcmVzdG9yZS52",
            "MWJldGExLkxpc3RlblJlc3BvbnNlIkaC0+STAkAiOy92MWJldGExL3tkYXRh",
            "YmFzZT1wcm9qZWN0cy8qL2RhdGFiYXNlcy8qfS9kb2N1bWVudHM6bGlzdGVu",
            "OgEqKAEwARLNAQoRTGlzdENvbGxlY3Rpb25JZHMSMi5nb29nbGUuZmlyZXN0",
            "b3JlLnYxYmV0YTEuTGlzdENvbGxlY3Rpb25JZHNSZXF1ZXN0GjMuZ29vZ2xl",
            "LmZpcmVzdG9yZS52MWJldGExLkxpc3RDb2xsZWN0aW9uSWRzUmVzcG9uc2Ui",
            "T4LT5JMCSSJEL3YxYmV0YTEve3BhcmVudD1wcm9qZWN0cy8qL2RhdGFiYXNl",
            "cy8qL2RvY3VtZW50c306bGlzdENvbGxlY3Rpb25JZHM6ASpCvAEKHGNvbS5n",
            "b29nbGUuZmlyZXN0b3JlLnYxYmV0YTFCDkZpcmVzdG9yZVByb3RvUAFaQWdv",
    ...
    public void MergeFrom(BatchGetDocumentsRequest other) {
      ...
      switch (other.ConsistencySelectorCase) {
        case ConsistencySelectorOneofCase.Transaction:
          ...
          break;
        case ConsistencySelectorOneofCase.NewTransaction:
          NewTransaction = other.NewTransaction;
          break;
        case ConsistencySelectorOneofCase.ReadTime:
          ReadTime = other.ReadTime;
          break;
  ...
  public sealed partial class RunQueryRequest : pb::IMessage<RunQueryRequest> {
    ...
    public void MergeFrom(RunQueryRequest other) {
      ...
      switch (other.QueryTypeCase) {
        case QueryTypeOneofCase.StructuredQuery:
          StructuredQuery = other.StructuredQuery;
          break;
      }
  ...
  public sealed partial class ListenResponse : pb::IMessage<ListenResponse> {
    ...
    public void MergeFrom(ListenResponse other) {
      ...
      switch (other.ResponseTypeCase) {
        case ResponseTypeOneofCase.TargetChange:
          TargetChange = other.TargetChange;
          break;
        case ResponseTypeOneofCase.DocumentChange:
          DocumentChange = other.DocumentChange;
          break;
        case ResponseTypeOneofCase.DocumentDelete:
          DocumentDelete = other.DocumentDelete;
          break;
        case ResponseTypeOneofCase.DocumentRemove:
          DocumentRemove = other.DocumentRemove;
          break;
        case ResponseTypeOneofCase.Filter:
          Filter = other.Filter;
          break;
