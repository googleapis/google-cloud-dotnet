...
namespace Google.Cloud.AuditManager.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.AuditManager.V1", GetFileDescriptors)
        ...
        {
            yield return AuditmanagerReflection.Descriptor;
