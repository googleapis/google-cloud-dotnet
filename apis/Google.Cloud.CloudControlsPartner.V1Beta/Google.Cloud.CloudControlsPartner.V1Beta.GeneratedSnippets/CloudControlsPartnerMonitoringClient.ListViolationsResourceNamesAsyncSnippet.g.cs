...
{
    // [START cloudcontrolspartner_v1beta_generated_CloudControlsPartnerMonitoring_ListViolations_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCloudControlsPartnerMonitoringClientSnippets
    {
        ...
        public async Task ListViolationsResourceNamesAsync()
        {
            ...
            await foreach (Violation item in response)
            {
            ...
            await foreach (ListViolationsResponse page in response.AsRawResponses())
            {
    ...
    // [END cloudcontrolspartner_v1beta_generated_CloudControlsPartnerMonitoring_ListViolations_async_flattened_resourceNames]
}
