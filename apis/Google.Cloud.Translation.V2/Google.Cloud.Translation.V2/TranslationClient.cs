...
namespace Google.Cloud.Translation.V2
{
    ...
    /// if many short-lived instances of <see cref="TranslationClient"/> are being created.
    /// Most code would be expected to create a single <c>TranslationClient</c> instance, and use this instance throughout
    ...
    {
        internal static readonly string[] Scopes = new[] { TranslateService.Scope.CloudPlatform };

        internal static ScopedCredentialProvider ScopedCredentialProvider { get; } =
            new ScopedCredentialProvider(Scopes);
