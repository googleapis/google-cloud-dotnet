...
{
    public class AdvancedTranslationClientImplTest
    {
        private static readonly AdvancedTranslationClient ThrowingServiceClient =
            new AdvancedTranslationClientImpl(new TranslateService(new BaseClientService.Initializer
            {
