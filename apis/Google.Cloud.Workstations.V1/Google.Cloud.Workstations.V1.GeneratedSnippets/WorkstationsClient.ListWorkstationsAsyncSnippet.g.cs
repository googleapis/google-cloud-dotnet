...
{
    // [START workstations_v1_generated_Workstations_ListWorkstations_async_flattened]
    ...
    public sealed partial class GeneratedWorkstationsClientSnippets
    {
        ...
        public async Task ListWorkstationsAsync()
        {
            ...
            await foreach (Workstation item in response)
            {
            ...
            await foreach (ListWorkstationsResponse page in response.AsRawResponses())
            {
    ...
    // [END workstations_v1_generated_Workstations_ListWorkstations_async_flattened]
}
