        ...
        public void GetPolicyRequestObject()
        {
            ...
            Policy expectedResponse = new Policy
            {
                ...
                Spec = new PolicySpec
                {
                    ...
                    Rules =
                    {
                        new PolicySpec.Types.PolicyRule
                        {
                            Values = new PolicySpec.Types.PolicyRule.Types.StringValues
                            {
                                AllowedValues =
                                {
                                    "allowed_valuesd9457710",
                                },
                                DeniedValues =
                                {
                                    "denied_values745c99d1",
                                },
                            },
                            AllowAll = true,
                            DenyAll = false,
