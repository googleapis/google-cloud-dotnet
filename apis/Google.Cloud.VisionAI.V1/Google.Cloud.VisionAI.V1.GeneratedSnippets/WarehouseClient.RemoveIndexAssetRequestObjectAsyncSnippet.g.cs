...
{
    // [START visionai_v1_generated_Warehouse_RemoveIndexAsset_async]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task RemoveIndexAssetRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<RemoveIndexAssetResponse, RemoveIndexAssetMetadata> response = await warehouseClient.RemoveIndexAssetAsync(request);

            // Poll until the returned long-running operation is complete
            Operation<RemoveIndexAssetResponse, RemoveIndexAssetMetadata> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<RemoveIndexAssetResponse, RemoveIndexAssetMetadata> retrievedResponse = await warehouseClient.PollOnceRemoveIndexAssetAsync(operationName);
    ...
    // [END visionai_v1_generated_Warehouse_RemoveIndexAsset_async]
}
