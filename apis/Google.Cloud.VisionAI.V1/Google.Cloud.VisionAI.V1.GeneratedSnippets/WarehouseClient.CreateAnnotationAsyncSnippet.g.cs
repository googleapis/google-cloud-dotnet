...
{
    // [START visionai_v1_generated_Warehouse_CreateAnnotation_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task CreateAnnotationAsync()
        {
            ...
            string annotationId = "";
            // Make the request
            Annotation response = await warehouseClient.CreateAnnotationAsync(parent, annotation, annotationId);
        }
    }
    // [END visionai_v1_generated_Warehouse_CreateAnnotation_async_flattened]
}
