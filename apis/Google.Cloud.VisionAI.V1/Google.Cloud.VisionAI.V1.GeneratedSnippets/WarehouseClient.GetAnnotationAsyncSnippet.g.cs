...
{
    // [START visionai_v1_generated_Warehouse_GetAnnotation_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task GetAnnotationAsync()
        {
            ...
            // Make the request
            Annotation response = await warehouseClient.GetAnnotationAsync(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_GetAnnotation_async_flattened]
}
