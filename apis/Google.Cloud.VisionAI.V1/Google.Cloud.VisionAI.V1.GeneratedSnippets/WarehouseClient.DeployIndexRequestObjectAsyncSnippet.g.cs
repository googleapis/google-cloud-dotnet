...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task DeployIndexRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<DeployIndexResponse, DeployIndexMetadata> response = await warehouseClient.DeployIndexAsync(request);

            // Poll until the returned long-running operation is complete
            Operation<DeployIndexResponse, DeployIndexMetadata> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<DeployIndexResponse, DeployIndexMetadata> retrievedResponse = await warehouseClient.PollOnceDeployIndexAsync(operationName);
