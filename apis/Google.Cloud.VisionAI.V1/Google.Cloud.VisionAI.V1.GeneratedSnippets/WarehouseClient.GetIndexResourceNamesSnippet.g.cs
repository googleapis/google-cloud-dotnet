...
{
    // [START visionai_v1_generated_Warehouse_GetIndex_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void GetIndexResourceNames()
        {
            ...
            IndexName name = IndexName.FromProjectNumberLocationCorpusIndex("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[INDEX]");
            // Make the request
            Index response = warehouseClient.GetIndex(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_GetIndex_sync_flattened_resourceNames]
}
