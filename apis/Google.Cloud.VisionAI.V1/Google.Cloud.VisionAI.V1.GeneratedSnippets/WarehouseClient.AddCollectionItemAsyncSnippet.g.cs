...
{
    // [START visionai_v1_generated_Warehouse_AddCollectionItem_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task AddCollectionItemAsync()
        {
            ...
            // Make the request
            AddCollectionItemResponse response = await warehouseClient.AddCollectionItemAsync(item);
        }
    }
    // [END visionai_v1_generated_Warehouse_AddCollectionItem_async_flattened]
}
