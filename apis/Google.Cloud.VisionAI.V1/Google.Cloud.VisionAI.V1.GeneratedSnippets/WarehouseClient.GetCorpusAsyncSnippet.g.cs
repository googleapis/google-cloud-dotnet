...
{
    // [START visionai_v1_generated_Warehouse_GetCorpus_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task GetCorpusAsync()
        {
            ...
            // Make the request
            Corpus response = await warehouseClient.GetCorpusAsync(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_GetCorpus_async_flattened]
}
