...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void CreateIndexRequestObject()
        {
            ...
            // Make the request
            Operation<Index, CreateIndexMetadata> response = warehouseClient.CreateIndex(request);

            // Poll until the returned long-running operation is complete
            Operation<Index, CreateIndexMetadata> completedResponse = response.PollUntilCompleted();
            ...
            Operation<Index, CreateIndexMetadata> retrievedResponse = warehouseClient.PollOnceCreateIndex(operationName);
