...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task DeleteSearchHypernymRequestObjectAsync()
        {
            ...
            DeleteSearchHypernymRequest request = new DeleteSearchHypernymRequest
            {
                SearchHypernymName = SearchHypernymName.FromProjectNumberLocationCorpusSearchHypernym("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[SEARCH_HYPERNYM]"),
            };
            // Make the request
