...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void DeployIndexRequestObject()
        {
            ...
            // Make the request
            Operation<DeployIndexResponse, DeployIndexMetadata> response = warehouseClient.DeployIndex(request);

            // Poll until the returned long-running operation is complete
            Operation<DeployIndexResponse, DeployIndexMetadata> completedResponse = response.PollUntilCompleted();
            ...
            Operation<DeployIndexResponse, DeployIndexMetadata> retrievedResponse = warehouseClient.PollOnceDeployIndex(operationName);
