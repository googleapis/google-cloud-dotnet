...
{
    // [START visionai_v1_generated_Warehouse_GetCollection_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task GetCollectionAsync()
        {
            ...
            // Make the request
            Collection response = await warehouseClient.GetCollectionAsync(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_GetCollection_async_flattened]
}
