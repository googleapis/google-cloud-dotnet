...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task CreateAnnotationRequestObjectAsync()
        {
            ...
            {
                ParentAsAssetName = AssetName.FromProjectNumberLocationCorpusAsset("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[ASSET]"),
                Annotation = new Annotation(),
                AnnotationId = "",
            };
            // Make the request
            Annotation response = await warehouseClient.CreateAnnotationAsync(request);
        }
    }
