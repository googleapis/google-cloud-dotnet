...
{
    // [START visionai_v1_generated_Warehouse_UpdateAsset_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateAssetAsync()
        {
            ...
            // Make the request
            Asset response = await warehouseClient.UpdateAssetAsync(asset, updateMask);
        }
    }
    // [END visionai_v1_generated_Warehouse_UpdateAsset_async_flattened]
}
