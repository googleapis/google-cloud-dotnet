...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UndeployIndexRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<UndeployIndexResponse, UndeployIndexMetadata> response = await warehouseClient.UndeployIndexAsync(request);

            // Poll until the returned long-running operation is complete
            Operation<UndeployIndexResponse, UndeployIndexMetadata> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<UndeployIndexResponse, UndeployIndexMetadata> retrievedResponse = await warehouseClient.PollOnceUndeployIndexAsync(operationName);
