...
{
    // [START visionai_v1_generated_Warehouse_ViewCollectionItems_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void ViewCollectionItemsResourceNames()
        {
            ...
            CollectionName collection = CollectionName.FromProjectNumberLocationCorpusCollection("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[COLLECTION]");
            // Make the request
            PagedEnumerable<ViewCollectionItemsResponse, CollectionItem> response = warehouseClient.ViewCollectionItems(collection);
    ...
    // [END visionai_v1_generated_Warehouse_ViewCollectionItems_sync_flattened_resourceNames]
}
