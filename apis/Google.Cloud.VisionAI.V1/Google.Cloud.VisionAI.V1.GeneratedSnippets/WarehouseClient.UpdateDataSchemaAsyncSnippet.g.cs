...
{
    // [START visionai_v1_generated_Warehouse_UpdateDataSchema_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateDataSchemaAsync()
        {
            ...
            // Make the request
            DataSchema response = await warehouseClient.UpdateDataSchemaAsync(dataSchema, updateMask);
        }
    }
    // [END visionai_v1_generated_Warehouse_UpdateDataSchema_async_flattened]
}
