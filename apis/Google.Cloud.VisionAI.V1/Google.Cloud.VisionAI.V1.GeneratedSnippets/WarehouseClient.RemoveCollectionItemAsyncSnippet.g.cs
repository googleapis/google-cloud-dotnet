...
{
    // [START visionai_v1_generated_Warehouse_RemoveCollectionItem_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task RemoveCollectionItemAsync()
        {
            ...
            // Make the request
            RemoveCollectionItemResponse response = await warehouseClient.RemoveCollectionItemAsync(item);
        }
    }
    // [END visionai_v1_generated_Warehouse_RemoveCollectionItem_async_flattened]
}
