...
{
    // [START visionai_v1_generated_Warehouse_DeleteCorpus_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void DeleteCorpusResourceNames()
        {
            ...
            CorpusName name = CorpusName.FromProjectNumberLocationCorpus("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]");
            // Make the request
            warehouseClient.DeleteCorpus(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_DeleteCorpus_sync_flattened_resourceNames]
}
