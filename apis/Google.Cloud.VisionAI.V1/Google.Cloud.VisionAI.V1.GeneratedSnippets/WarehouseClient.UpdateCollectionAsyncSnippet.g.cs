...
{
    // [START visionai_v1_generated_Warehouse_UpdateCollection_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateCollectionAsync()
        {
            ...
            // Make the request
            Collection response = await warehouseClient.UpdateCollectionAsync(collection, updateMask);
        }
    }
    // [END visionai_v1_generated_Warehouse_UpdateCollection_async_flattened]
}
