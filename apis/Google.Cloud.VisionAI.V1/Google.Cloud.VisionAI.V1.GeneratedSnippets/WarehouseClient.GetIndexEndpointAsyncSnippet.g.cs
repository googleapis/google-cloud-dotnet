...
{
    // [START visionai_v1_generated_Warehouse_GetIndexEndpoint_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task GetIndexEndpointAsync()
        {
            ...
            // Make the request
            IndexEndpoint response = await warehouseClient.GetIndexEndpointAsync(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_GetIndexEndpoint_async_flattened]
}
