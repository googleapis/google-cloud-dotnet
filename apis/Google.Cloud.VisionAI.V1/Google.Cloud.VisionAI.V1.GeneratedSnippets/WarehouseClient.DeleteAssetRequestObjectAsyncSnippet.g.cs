...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task DeleteAssetRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Empty, DeleteAssetMetadata> response = await warehouseClient.DeleteAssetAsync(request);

            // Poll until the returned long-running operation is complete
            Operation<Empty, DeleteAssetMetadata> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<Empty, DeleteAssetMetadata> retrievedResponse = await warehouseClient.PollOnceDeleteAssetAsync(operationName);
