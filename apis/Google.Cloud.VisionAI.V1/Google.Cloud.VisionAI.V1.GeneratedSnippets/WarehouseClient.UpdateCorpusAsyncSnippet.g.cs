...
{
    // [START visionai_v1_generated_Warehouse_UpdateCorpus_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateCorpusAsync()
        {
            ...
            // Make the request
            Corpus response = await warehouseClient.UpdateCorpusAsync(corpus, updateMask);
        }
    }
    // [END visionai_v1_generated_Warehouse_UpdateCorpus_async_flattened]
}
