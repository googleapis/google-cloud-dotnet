...
{
    // [START visionai_v1_generated_Warehouse_DeleteAnnotation_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task DeleteAnnotationResourceNamesAsync()
        {
            ...
            AnnotationName name = AnnotationName.FromProjectNumberLocationCorpusAssetAnnotation("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[ASSET]", "[ANNOTATION]");
            // Make the request
            await warehouseClient.DeleteAnnotationAsync(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_DeleteAnnotation_async_flattened_resourceNames]
}
