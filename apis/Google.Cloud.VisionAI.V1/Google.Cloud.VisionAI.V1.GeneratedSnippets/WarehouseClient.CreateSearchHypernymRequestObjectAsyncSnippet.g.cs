...
{
    // [START visionai_v1_generated_Warehouse_CreateSearchHypernym_async]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task CreateSearchHypernymRequestObjectAsync()
        {
            ...
            CreateSearchHypernymRequest request = new CreateSearchHypernymRequest
            {
            ...
            // Make the request
            SearchHypernym response = await warehouseClient.CreateSearchHypernymAsync(request);
        }
    }
    // [END visionai_v1_generated_Warehouse_CreateSearchHypernym_async]
}
