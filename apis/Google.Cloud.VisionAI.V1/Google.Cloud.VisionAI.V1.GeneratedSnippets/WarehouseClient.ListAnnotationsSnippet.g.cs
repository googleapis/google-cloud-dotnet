...
{
    // [START visionai_v1_generated_Warehouse_ListAnnotations_sync_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void ListAnnotations()
        {
            ...
            // Make the request
            PagedEnumerable<ListAnnotationsResponse, Annotation> response = warehouseClient.ListAnnotations(parent);
    ...
    // [END visionai_v1_generated_Warehouse_ListAnnotations_sync_flattened]
}
