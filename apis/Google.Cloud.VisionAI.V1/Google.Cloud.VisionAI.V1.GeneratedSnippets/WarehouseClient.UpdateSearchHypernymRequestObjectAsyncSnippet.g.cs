...
{
    // [START visionai_v1_generated_Warehouse_UpdateSearchHypernym_async]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateSearchHypernymRequestObjectAsync()
        {
            ...
            UpdateSearchHypernymRequest request = new UpdateSearchHypernymRequest
            {
                SearchHypernym = new SearchHypernym(),
                UpdateMask = new FieldMask(),
            };
            // Make the request
            SearchHypernym response = await warehouseClient.UpdateSearchHypernymAsync(request);
        }
    }
