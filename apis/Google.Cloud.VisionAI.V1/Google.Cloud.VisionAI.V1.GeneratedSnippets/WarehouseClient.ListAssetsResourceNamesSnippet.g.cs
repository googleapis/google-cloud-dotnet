...
{
    // [START visionai_v1_generated_Warehouse_ListAssets_sync_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void ListAssetsResourceNames()
        {
            ...
            // Make the request
            PagedEnumerable<ListAssetsResponse, Asset> response = warehouseClient.ListAssets(parent);
    ...
    // [END visionai_v1_generated_Warehouse_ListAssets_sync_flattened_resourceNames]
}
