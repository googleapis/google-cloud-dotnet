...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void GetDataSchemaRequestObject()
        {
            ...
            GetDataSchemaRequest request = new GetDataSchemaRequest
            {
                DataSchemaName = DataSchemaName.FromProjectNumberLocationCorpusDataSchema("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[DATA_SCHEMA]"),
            };
            // Make the request
