...
{
    // [START visionai_v1_generated_Warehouse_UpdateSearchConfig_async]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateSearchConfigRequestObjectAsync()
        {
            ...
            UpdateSearchConfigRequest request = new UpdateSearchConfigRequest
            {
                SearchConfig = new SearchConfig(),
                UpdateMask = new FieldMask(),
            };
            // Make the request
            SearchConfig response = await warehouseClient.UpdateSearchConfigAsync(request);
        }
    }
