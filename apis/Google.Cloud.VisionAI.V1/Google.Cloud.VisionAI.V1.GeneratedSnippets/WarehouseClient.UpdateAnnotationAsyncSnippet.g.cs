...
{
    // [START visionai_v1_generated_Warehouse_UpdateAnnotation_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UpdateAnnotationAsync()
        {
            ...
            // Make the request
            Annotation response = await warehouseClient.UpdateAnnotationAsync(annotation, updateMask);
        }
    }
    // [END visionai_v1_generated_Warehouse_UpdateAnnotation_async_flattened]
}
