...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task RemoveCollectionItemRequestObjectAsync()
        {
            ...
            RemoveCollectionItemRequest request = new RemoveCollectionItemRequest
            {
                Item = new CollectionItem(),
            };
            // Make the request
            RemoveCollectionItemResponse response = await warehouseClient.RemoveCollectionItemAsync(request);
        }
    }
