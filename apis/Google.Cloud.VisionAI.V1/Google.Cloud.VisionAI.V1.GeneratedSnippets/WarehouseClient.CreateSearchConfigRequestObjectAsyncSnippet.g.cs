...
{
    // [START visionai_v1_generated_Warehouse_CreateSearchConfig_async]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task CreateSearchConfigRequestObjectAsync()
        {
            ...
            CreateSearchConfigRequest request = new CreateSearchConfigRequest
            {
            ...
            // Make the request
            SearchConfig response = await warehouseClient.CreateSearchConfigAsync(request);
        }
    }
    // [END visionai_v1_generated_Warehouse_CreateSearchConfig_async]
}
