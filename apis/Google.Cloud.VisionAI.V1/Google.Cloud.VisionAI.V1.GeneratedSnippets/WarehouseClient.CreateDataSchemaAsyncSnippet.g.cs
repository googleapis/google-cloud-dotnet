...
{
    // [START visionai_v1_generated_Warehouse_CreateDataSchema_async_flattened]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task CreateDataSchemaAsync()
        {
            ...
            // Make the request
            DataSchema response = await warehouseClient.CreateDataSchemaAsync(parent, dataSchema);
        }
    }
    // [END visionai_v1_generated_Warehouse_CreateDataSchema_async_flattened]
}
