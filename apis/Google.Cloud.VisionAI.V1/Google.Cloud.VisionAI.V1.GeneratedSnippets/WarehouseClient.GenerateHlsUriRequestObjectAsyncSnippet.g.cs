...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task GenerateHlsUriRequestObjectAsync()
        {
            ...
            GenerateHlsUriRequest request = new GenerateHlsUriRequest
            {
                AssetName = AssetName.FromProjectNumberLocationCorpusAsset("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[ASSET]"),
                TemporalPartitions =
                {
                    new Partition.Types.TemporalPartition(),
                },
                LiveViewEnabled = false,
            };
            // Make the request
            GenerateHlsUriResponse response = await warehouseClient.GenerateHlsUriAsync(request);
        }
    }
