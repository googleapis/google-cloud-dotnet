...
{
    // [START visionai_v1_generated_Warehouse_DeleteSearchConfig_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task DeleteSearchConfigResourceNamesAsync()
        {
            ...
            SearchConfigName name = SearchConfigName.FromProjectNumberLocationCorpusSearchConfig("[PROJECT_NUMBER]", "[LOCATION]", "[CORPUS]", "[SEARCH_CONFIG]");
            // Make the request
            await warehouseClient.DeleteSearchConfigAsync(name);
        }
    }
    // [END visionai_v1_generated_Warehouse_DeleteSearchConfig_async_flattened_resourceNames]
}
