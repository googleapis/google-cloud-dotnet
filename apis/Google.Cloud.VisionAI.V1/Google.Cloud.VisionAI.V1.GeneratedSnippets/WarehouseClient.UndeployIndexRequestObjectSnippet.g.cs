...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public void UndeployIndexRequestObject()
        {
            ...
            // Make the request
            Operation<UndeployIndexResponse, UndeployIndexMetadata> response = warehouseClient.UndeployIndex(request);

            // Poll until the returned long-running operation is complete
            Operation<UndeployIndexResponse, UndeployIndexMetadata> completedResponse = response.PollUntilCompleted();
            ...
            Operation<UndeployIndexResponse, UndeployIndexMetadata> retrievedResponse = warehouseClient.PollOnceUndeployIndex(operationName);
