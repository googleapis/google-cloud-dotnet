...
namespace GoogleCSharpSnippets
{
    ...
    public sealed partial class GeneratedWarehouseClientSnippets
    {
        ...
        public async Task UploadAssetRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<UploadAssetResponse, UploadAssetMetadata> response = await warehouseClient.UploadAssetAsync(request);

            // Poll until the returned long-running operation is complete
            Operation<UploadAssetResponse, UploadAssetMetadata> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<UploadAssetResponse, UploadAssetMetadata> retrievedResponse = await warehouseClient.PollOnceUploadAssetAsync(operationName);
