...
namespace Google.Cloud.Dialogflow.V2Beta1
{
    ...
    public sealed partial class ConversationsSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>ConversationsClient.BatchCreateMessages</c> and <c>ConversationsClient.BatchCreateMessagesAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings BatchCreateMessagesSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(100), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable)));
    ...
    public abstract partial class ConversationsClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual BatchCreateMessagesResponse BatchCreateMessages(BatchCreateMessagesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BatchCreateMessagesResponse> BatchCreateMessagesAsync(BatchCreateMessagesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BatchCreateMessagesResponse> BatchCreateMessagesAsync(BatchCreateMessagesRequest request, st::CancellationToken cancellationToken) =>
            BatchCreateMessagesAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    public sealed partial class ConversationsClientImpl : ConversationsClient
    {
        ...
        public ConversationsClientImpl(Conversations.ConversationsClient grpcClient, ConversationsSettings settings, mel::ILogger logger)
        {
            ...
            _callBatchCreateMessages = clientHelper.BuildApiCall<BatchCreateMessagesRequest, BatchCreateMessagesResponse>("BatchCreateMessages", grpcClient.BatchCreateMessagesAsync, grpcClient.BatchCreateMessages, effectiveSettings.BatchCreateMessagesSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callBatchCreateMessages);
            Modify_BatchCreateMessagesApiCall(ref _callBatchCreateMessages);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override BatchCreateMessagesResponse BatchCreateMessages(BatchCreateMessagesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_BatchCreateMessagesRequest(ref request, ref callSettings);
            return _callBatchCreateMessages.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<BatchCreateMessagesResponse> BatchCreateMessagesAsync(BatchCreateMessagesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_BatchCreateMessagesRequest(ref request, ref callSettings);
            return _callBatchCreateMessages.Async(request, callSettings);
        }
