...
namespace Google.Cloud.Dialogflow.V2Beta1
{
    ...
    public abstract partial class GeneratorsClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Generator CreateGenerator(string parent, Generator generator, string generatorId, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Generator> CreateGeneratorAsync(string parent, Generator generator, string generatorId, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Generator> CreateGeneratorAsync(string parent, Generator generator, string generatorId, st::CancellationToken cancellationToken) =>
            CreateGeneratorAsync(parent, generator, generatorId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Generator CreateGenerator(gagr::ProjectName parent, Generator generator, string generatorId, gaxgrpc::CallSettings callSettings = null) =>
            CreateGenerator(new CreateGeneratorRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Generator> CreateGeneratorAsync(gagr::ProjectName parent, Generator generator, string generatorId, gaxgrpc::CallSettings callSettings = null) =>
            CreateGeneratorAsync(new CreateGeneratorRequest
            {
                ParentAsProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Generator = gax::GaxPreconditions.CheckNotNull(generator, nameof(generator)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Generator> CreateGeneratorAsync(gagr::ProjectName parent, Generator generator, string generatorId, st::CancellationToken cancellationToken) =>
            CreateGeneratorAsync(parent, generator, generatorId, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Generator"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListGeneratorsResponse, Generator> ListGenerators(gagr::ProjectName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListGeneratorsRequest request = new ListGeneratorsRequest
            {
                ParentAsProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Generator"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListGeneratorsResponse, Generator> ListGeneratorsAsync(gagr::ProjectName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null)
        {
            ListGeneratorsRequest request = new ListGeneratorsRequest
            {
                ParentAsProjectName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
