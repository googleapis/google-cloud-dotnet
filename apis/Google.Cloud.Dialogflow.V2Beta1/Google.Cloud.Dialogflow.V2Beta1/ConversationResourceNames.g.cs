...
namespace Google.Cloud.Dialogflow.V2Beta1
{
    ...
    /// <summary>Resource name for the <c>CesTool</c> resource.</summary>
    public sealed partial class CesToolName : gax::IResourceName, sys::IEquatable<CesToolName>
    {
        /// <summary>The possible contents of <see cref="CesToolName"/>.</summary>
        public enum ResourceNameType
        {
            /// <summary>An unparsed resource name.</summary>
            Unparsed = 0,
        ...
        /// <summary>Creates a <see cref="CesToolName"/> containing an unparsed resource name.</summary>
        /// <param name="unparsedResourceName">The unparsed resource name. Must not be <c>null</c>.</param>
        /// <returns>
        /// A new instance of <see cref="CesToolName"/> containing the provided <paramref name="unparsedResourceName"/>.
        /// </returns>
        public static CesToolName FromUnparsed(gax::UnparsedResourceName unparsedResourceName) =>
            new CesToolName(ResourceNameType.Unparsed, gax::GaxPreconditions.CheckNotNull(unparsedResourceName, nameof(unparsedResourceName)));

        /// <summary>
        /// Creates a <see cref="CesToolName"/> with the pattern
        ...
        /// <returns>A new instance of <see cref="CesToolName"/> constructed from the provided ids.</returns>
        public static CesToolName FromProjectLocationAppTool(string projectId, string locationId, string appId, string toolId) =>
            new CesToolName(ResourceNameType.ProjectLocationAppTool, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), appId: gax::GaxPreconditions.CheckNotNullOrEmpty(appId, nameof(appId)), toolId: gax::GaxPreconditions.CheckNotNullOrEmpty(toolId, nameof(toolId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="CesToolName"/> with pattern
        /// <c>projects/{project}/locations/{location}/apps/{app}/tools/{tool}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <param name="toolId">The <c>Tool</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="CesToolName"/> with pattern
        /// <c>projects/{project}/locations/{location}/apps/{app}/tools/{tool}</c>.
        /// </returns>
        ...
        /// <summary>Parses the given resource name string into a new <see cref="CesToolName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item>
        ...
        /// </list>
        /// </remarks>
        /// <param name="cesToolName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <returns>The parsed <see cref="CesToolName"/> if successful.</returns>
        public static CesToolName Parse(string cesToolName) => Parse(cesToolName, false);

        /// <summary>
        /// Parses the given resource name string into a new <see cref="CesToolName"/> instance; optionally allowing an
        ...
        /// </param>
        /// <returns>The parsed <see cref="CesToolName"/> if successful.</returns>
        public static CesToolName Parse(string cesToolName, bool allowUnparsed) =>
            TryParse(cesToolName, allowUnparsed, out CesToolName result) ? result : throw new sys::ArgumentException("The given resource-name matches no pattern.");

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="CesToolName"/> instance.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        ...
        /// <param name="cesToolName">The resource name in string form. Must not be <c>null</c>.</param>
        /// <param name="result">
        /// When this method returns, the parsed <see cref="CesToolName"/>, or <c>null</c> if parsing failed.
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string cesToolName, out CesToolName result) => TryParse(cesToolName, false, out result);

        /// <summary>
        /// Tries to parse the given resource name string into a new <see cref="CesToolName"/> instance; optionally
        /// allowing an unparseable resource name.
        /// </summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        ...
        /// </param>
        /// <returns><c>true</c> if the name was parsed successfully; <c>false</c> otherwise.</returns>
        public static bool TryParse(string cesToolName, bool allowUnparsed, out CesToolName result)
        {
            gax::GaxPreconditions.CheckNotNull(cesToolName, nameof(cesToolName));
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationAppTool.TryParseName(cesToolName, out resourceName))
            {
            ...
            if (allowUnparsed)
            {
                if (gax::UnparsedResourceName.TryParse(cesToolName, out gax::UnparsedResourceName unparsedResourceName))
                {
                    result = FromUnparsed(unparsedResourceName);
                    return true;
                }
        ...
        private CesToolName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string appId = null, string locationId = null, string projectId = null, string toolId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            AppId = appId;
        ...
        /// <summary>
        /// Constructs a new instance of a <see cref="CesToolName"/> class from the component parts of pattern
        /// <c>projects/{project}/locations/{location}/apps/{app}/tools/{tool}</c>
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="appId">The <c>App</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="toolId">The <c>Tool</c> ID. Must not be <c>null</c> or empty.</param>
        public CesToolName(string projectId, string locationId, string appId, string toolId) : this(ResourceNameType.ProjectLocationAppTool, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), appId: gax::GaxPreconditions.CheckNotNullOrEmpty(appId, nameof(appId)), toolId: gax::GaxPreconditions.CheckNotNullOrEmpty(toolId, nameof(toolId)))
        {
        }
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as CesToolName);

        /// <inheritdoc/>
        public bool Equals(CesToolName other) => ToString() == other?.ToString();
        ...
        /// false.
        /// </returns>
        public static bool operator ==(CesToolName a, CesToolName b) => ReferenceEquals(a, b) || (a?.Equals(b) ?? false);
        ...
        /// false.
        /// </returns>
        public static bool operator !=(CesToolName a, CesToolName b) => !(a == b);
    }
