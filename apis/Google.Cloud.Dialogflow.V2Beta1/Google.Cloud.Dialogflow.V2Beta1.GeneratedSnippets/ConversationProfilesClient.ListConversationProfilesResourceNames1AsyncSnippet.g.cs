...
{
    // [START dialogflow_v2beta1_generated_ConversationProfiles_ListConversationProfiles_async_flattened_resourceNames1]
    ...
    public sealed partial class GeneratedConversationProfilesClientSnippets
    {
        ...
        public async Task ListConversationProfilesResourceNames1Async()
        {
            ...
            await foreach (ConversationProfile item in response)
            {
            ...
            await foreach (ListConversationProfilesResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2beta1_generated_ConversationProfiles_ListConversationProfiles_async_flattened_resourceNames1]
}
