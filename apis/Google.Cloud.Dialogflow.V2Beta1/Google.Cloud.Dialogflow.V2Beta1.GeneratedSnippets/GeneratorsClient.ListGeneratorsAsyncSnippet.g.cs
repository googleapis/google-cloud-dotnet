...
{
    // [START dialogflow_v2beta1_generated_Generators_ListGenerators_async_flattened]
    ...
    public sealed partial class GeneratedGeneratorsClientSnippets
    {
        ...
        public async Task ListGeneratorsAsync()
        {
            ...
            await foreach (Generator item in response)
            {
            ...
            await foreach (ListGeneratorsResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2beta1_generated_Generators_ListGenerators_async_flattened]
}
