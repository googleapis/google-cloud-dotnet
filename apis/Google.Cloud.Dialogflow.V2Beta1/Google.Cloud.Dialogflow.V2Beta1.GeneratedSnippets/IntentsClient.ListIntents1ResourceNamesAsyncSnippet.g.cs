...
{
    // [START dialogflow_v2beta1_generated_Intents_ListIntents_async_flattened1_resourceNames]
    ...
    public sealed partial class GeneratedIntentsClientSnippets
    {
        ...
        public async Task ListIntents1ResourceNamesAsync()
        {
            ...
            await foreach (Intent item in response)
            {
            ...
            await foreach (ListIntentsResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2beta1_generated_Intents_ListIntents_async_flattened1_resourceNames]
}
