...
{
    // [START dialogflow_v2beta1_generated_SessionEntityTypes_ListSessionEntityTypes_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSessionEntityTypesClientSnippets
    {
        ...
        public async Task ListSessionEntityTypesResourceNamesAsync()
        {
            ...
            await foreach (SessionEntityType item in response)
            {
            ...
            await foreach (ListSessionEntityTypesResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2beta1_generated_SessionEntityTypes_ListSessionEntityTypes_async_flattened_resourceNames]
}
