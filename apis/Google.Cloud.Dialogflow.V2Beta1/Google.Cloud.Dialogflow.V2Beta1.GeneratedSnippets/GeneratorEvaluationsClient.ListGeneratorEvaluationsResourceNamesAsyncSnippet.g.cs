...
{
    // [START dialogflow_v2beta1_generated_GeneratorEvaluations_ListGeneratorEvaluations_async_flattened_resourceNames]
    using Google.Api.Gax;
    using Google.Cloud.Dialogflow.V2Beta1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedGeneratorEvaluationsClientSnippets
    {
        ...
        public async Task ListGeneratorEvaluationsResourceNamesAsync()
        {
            ...
            await foreach (GeneratorEvaluation item in response)
            {
            ...
            await foreach (ListGeneratorEvaluationsResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2beta1_generated_GeneratorEvaluations_ListGeneratorEvaluations_async_flattened_resourceNames]
}
