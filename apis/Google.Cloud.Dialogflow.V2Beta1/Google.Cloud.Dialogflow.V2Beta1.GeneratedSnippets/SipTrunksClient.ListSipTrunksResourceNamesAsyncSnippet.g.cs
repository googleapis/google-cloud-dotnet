...
{
    // [START dialogflow_v2beta1_generated_SipTrunks_ListSipTrunks_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSipTrunksClientSnippets
    {
        ...
        public async Task ListSipTrunksResourceNamesAsync()
        {
            ...
            await foreach (SipTrunk item in response)
            {
            ...
            await foreach (ListSipTrunksResponse page in response.AsRawResponses())
            {
    ...
    // [END dialogflow_v2beta1_generated_SipTrunks_ListSipTrunks_async_flattened_resourceNames]
}
