...
namespace Google.Ads.DataManager.V1
{
    ...
    public sealed partial class UserListName : gax::IResourceName, sys::IEquatable<UserListName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>accountTypes/{account_type}/accounts/{account}/userLists/{user_list}</c>
            /// .
            /// </summary>
            AccountTypeAccountUserList = 1,
        }

        private static gax::PathTemplate s_accountTypeAccountUserList = new gax::PathTemplate("accountTypes/{account_type}/accounts/{account}/userLists/{user_list}");
        ...
        /// <summary>
        /// Creates a <see cref="UserListName"/> with the pattern
        /// <c>accountTypes/{account_type}/accounts/{account}/userLists/{user_list}</c>.
        /// </summary>
        ...
        public static UserListName FromAccountTypeAccountUserList(string accountTypeId, string accountId, string userListId) =>
            new UserListName(ResourceNameType.AccountTypeAccountUserList, accountTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountTypeId, nameof(accountTypeId)), accountId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountId, nameof(accountId)), userListId: gax::GaxPreconditions.CheckNotNullOrEmpty(userListId, nameof(userListId)));
        ...
        /// <c>accountTypes/{account_type}/accounts/{account}/userLists/{user_list}</c>.
        /// </returns>
        public static string Format(string accountTypeId, string accountId, string userListId) =>
            FormatAccountTypeAccountUserList(accountTypeId, accountId, userListId);
        ...
        /// <c>accountTypes/{account_type}/accounts/{account}/userLists/{user_list}</c>.
        /// </returns>
        public static string FormatAccountTypeAccountUserList(string accountTypeId, string accountId, string userListId) =>
            s_accountTypeAccountUserList.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(accountTypeId, nameof(accountTypeId)), gax::GaxPreconditions.CheckNotNullOrEmpty(accountId, nameof(accountId)), gax::GaxPreconditions.CheckNotNullOrEmpty(userListId, nameof(userListId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>accountTypes/{account_type}/accounts/{account}/userLists/{user_list}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string userListName, bool allowUnparsed, out UserListName result)
        {
            ...
            if (s_accountTypeAccountUserList.TryParseName(userListName, out resourceName))
            {
                result = FromAccountTypeAccountUserList(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private UserListName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string accountId = null, string accountTypeId = null, string userListId = null)
        {
            Type = type;
        ...
        /// <param name="accountId">The <c>Account</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="userListId">The <c>UserList</c> ID. Must not be <c>null</c> or empty.</param>
        public UserListName(string accountTypeId, string accountId, string userListId) : this(ResourceNameType.AccountTypeAccountUserList, accountTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountTypeId, nameof(accountTypeId)), accountId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountId, nameof(accountId)), userListId: gax::GaxPreconditions.CheckNotNullOrEmpty(userListId, nameof(userListId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.AccountTypeAccountUserList: return s_accountTypeAccountUserList.Expand(AccountTypeId, AccountId, UserListId);
