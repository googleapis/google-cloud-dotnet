...
namespace Google.Ads.DataManager.V1
{
    ...
    public sealed partial class AccountName : gax::IResourceName, sys::IEquatable<AccountName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>accountTypes/{account_type}/accounts/{account}</c>.</summary>
            AccountTypeAccount = 1,
        }

        private static gax::PathTemplate s_accountTypeAccount = new gax::PathTemplate("accountTypes/{account_type}/accounts/{account}");
        ...
        /// <summary>
        /// Creates a <see cref="AccountName"/> with the pattern <c>accountTypes/{account_type}/accounts/{account}</c>.
        /// </summary>
        ...
        public static AccountName FromAccountTypeAccount(string accountTypeId, string accountId) =>
            new AccountName(ResourceNameType.AccountTypeAccount, accountTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountTypeId, nameof(accountTypeId)), accountId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountId, nameof(accountId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="AccountName"/> with pattern
        /// <c>accountTypes/{account_type}/accounts/{account}</c>.
        /// </summary>
        /// <param name="accountTypeId">The <c>AccountType</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="accountId">The <c>Account</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="AccountName"/> with pattern
        /// <c>accountTypes/{account_type}/accounts/{account}</c>.
        /// </returns>
        public static string Format(string accountTypeId, string accountId) =>
            FormatAccountTypeAccount(accountTypeId, accountId);
        ...
        /// <c>accountTypes/{account_type}/accounts/{account}</c>.
        /// </returns>
        public static string FormatAccountTypeAccount(string accountTypeId, string accountId) =>
            s_accountTypeAccount.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(accountTypeId, nameof(accountTypeId)), gax::GaxPreconditions.CheckNotNullOrEmpty(accountId, nameof(accountId)));

        /// <summary>Parses the given resource name string into a new <see cref="AccountName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>accountTypes/{account_type}/accounts/{account}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string accountName, bool allowUnparsed, out AccountName result)
        {
            ...
            if (s_accountTypeAccount.TryParseName(accountName, out resourceName))
            {
                result = FromAccountTypeAccount(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private AccountName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string accountId = null, string accountTypeId = null)
        {
            Type = type;
        ...
        /// <param name="accountTypeId">The <c>AccountType</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="accountId">The <c>Account</c> ID. Must not be <c>null</c> or empty.</param>
        public AccountName(string accountTypeId, string accountId) : this(ResourceNameType.AccountTypeAccount, accountTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountTypeId, nameof(accountTypeId)), accountId: gax::GaxPreconditions.CheckNotNullOrEmpty(accountId, nameof(accountId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.AccountTypeAccount: return s_accountTypeAccount.Expand(AccountTypeId, AccountId);
