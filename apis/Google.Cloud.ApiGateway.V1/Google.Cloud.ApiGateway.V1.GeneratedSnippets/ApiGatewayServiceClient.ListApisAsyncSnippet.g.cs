...
{
    // [START apigateway_v1_generated_ApiGatewayService_ListApis_async_flattened]
    ...
    public sealed partial class GeneratedApiGatewayServiceClientSnippets
    {
        ...
        public async Task ListApisAsync()
        {
            ...
            await foreach (Api item in response)
            {
            ...
            await foreach (ListApisResponse page in response.AsRawResponses())
            {
    ...
    // [END apigateway_v1_generated_ApiGatewayService_ListApis_async_flattened]
}
