...
{
    // [START clouddeploy_v1_generated_CloudDeploy_ListAutomationRuns_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCloudDeployClientSnippets
    {
        ...
        public async Task ListAutomationRunsResourceNamesAsync()
        {
            ...
            await foreach (AutomationRun item in response)
            {
            ...
            await foreach (ListAutomationRunsResponse page in response.AsRawResponses())
            {
    ...
    // [END clouddeploy_v1_generated_CloudDeploy_ListAutomationRuns_async_flattened_resourceNames]
}
