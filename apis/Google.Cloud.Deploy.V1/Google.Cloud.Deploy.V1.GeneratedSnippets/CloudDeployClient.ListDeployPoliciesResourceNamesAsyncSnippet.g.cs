...
{
    // [START clouddeploy_v1_generated_CloudDeploy_ListDeployPolicies_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCloudDeployClientSnippets
    {
        ...
        public async Task ListDeployPoliciesResourceNamesAsync()
        {
            ...
            await foreach (DeployPolicy item in response)
            {
            ...
            await foreach (ListDeployPoliciesResponse page in response.AsRawResponses())
            {
    ...
    // [END clouddeploy_v1_generated_CloudDeploy_ListDeployPolicies_async_flattened_resourceNames]
}
