...
{
    // [START clouddeploy_v1_generated_CloudDeploy_ListAutomations_async_flattened]
    ...
    public sealed partial class GeneratedCloudDeployClientSnippets
    {
        ...
        public async Task ListAutomationsAsync()
        {
            ...
            await foreach (Automation item in response)
            {
            ...
            await foreach (ListAutomationsResponse page in response.AsRawResponses())
            {
    ...
    // [END clouddeploy_v1_generated_CloudDeploy_ListAutomations_async_flattened]
}
