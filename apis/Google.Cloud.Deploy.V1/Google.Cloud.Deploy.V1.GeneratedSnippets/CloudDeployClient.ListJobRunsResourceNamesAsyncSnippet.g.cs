...
{
    // [START clouddeploy_v1_generated_CloudDeploy_ListJobRuns_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCloudDeployClientSnippets
    {
        ...
        public async Task ListJobRunsResourceNamesAsync()
        {
            ...
            await foreach (JobRun item in response)
            {
            ...
            await foreach (ListJobRunsResponse page in response.AsRawResponses())
            {
    ...
    // [END clouddeploy_v1_generated_CloudDeploy_ListJobRuns_async_flattened_resourceNames]
}
