...
{
    // [START clouddeploy_v1_generated_CloudDeploy_ListCustomTargetTypes_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedCloudDeployClientSnippets
    {
        ...
        public async Task ListCustomTargetTypesResourceNamesAsync()
        {
            ...
            await foreach (CustomTargetType item in response)
            {
            ...
            await foreach (ListCustomTargetTypesResponse page in response.AsRawResponses())
            {
    ...
    // [END clouddeploy_v1_generated_CloudDeploy_ListCustomTargetTypes_async_flattened_resourceNames]
}
