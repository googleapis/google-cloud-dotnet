...
namespace Google.Cloud.DocumentAI.V1
{
    ...
    public sealed partial class DocumentProcessorServiceClientImpl : DocumentProcessorServiceClient
    {
        ...
        public DocumentProcessorServiceClientImpl(DocumentProcessorService.DocumentProcessorServiceClient grpcClient, DocumentProcessorServiceSettings settings)
        {
            ...
            DeleteProcessorVersionOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.DeleteProcessorVersionOperationsSettings);
            DeployProcessorVersionOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.DeployProcessorVersionOperationsSettings);
            UndeployProcessorVersionOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.UndeployProcessorVersionOperationsSettings);
            ...
            SetDefaultProcessorVersionOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.SetDefaultProcessorVersionOperationsSettings);
            ...
            _callGetProcessor = clientHelper.BuildApiCall<GetProcessorRequest, Processor>(grpcClient.GetProcessorAsync, grpcClient.GetProcessor, effectiveSettings.GetProcessorSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetProcessor);
            Modify_GetProcessorApiCall(ref _callGetProcessor);
            _callGetProcessorVersion = clientHelper.BuildApiCall<GetProcessorVersionRequest, ProcessorVersion>(grpcClient.GetProcessorVersionAsync, grpcClient.GetProcessorVersion, effectiveSettings.GetProcessorVersionSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetProcessorVersion);
            Modify_GetProcessorVersionApiCall(ref _callGetProcessorVersion);
            _callListProcessorVersions = clientHelper.BuildApiCall<ListProcessorVersionsRequest, ListProcessorVersionsResponse>(grpcClient.ListProcessorVersionsAsync, grpcClient.ListProcessorVersions, effectiveSettings.ListProcessorVersionsSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callListProcessorVersions);
            Modify_ListProcessorVersionsApiCall(ref _callListProcessorVersions);
            _callDeleteProcessorVersion = clientHelper.BuildApiCall<DeleteProcessorVersionRequest, lro::Operation>(grpcClient.DeleteProcessorVersionAsync, grpcClient.DeleteProcessorVersion, effectiveSettings.DeleteProcessorVersionSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callDeleteProcessorVersion);
            Modify_DeleteProcessorVersionApiCall(ref _callDeleteProcessorVersion);
            _callDeployProcessorVersion = clientHelper.BuildApiCall<DeployProcessorVersionRequest, lro::Operation>(grpcClient.DeployProcessorVersionAsync, grpcClient.DeployProcessorVersion, effectiveSettings.DeployProcessorVersionSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callDeployProcessorVersion);
            Modify_DeployProcessorVersionApiCall(ref _callDeployProcessorVersion);
            _callUndeployProcessorVersion = clientHelper.BuildApiCall<UndeployProcessorVersionRequest, lro::Operation>(grpcClient.UndeployProcessorVersionAsync, grpcClient.UndeployProcessorVersion, effectiveSettings.UndeployProcessorVersionSettings).WithGoogleRequestParam("name", request => request.Name);
            ...
            _callSetDefaultProcessorVersion = clientHelper.BuildApiCall<SetDefaultProcessorVersionRequest, lro::Operation>(grpcClient.SetDefaultProcessorVersionAsync, grpcClient.SetDefaultProcessorVersion, effectiveSettings.SetDefaultProcessorVersionSettings).WithGoogleRequestParam("processor", request => request.Processor);
