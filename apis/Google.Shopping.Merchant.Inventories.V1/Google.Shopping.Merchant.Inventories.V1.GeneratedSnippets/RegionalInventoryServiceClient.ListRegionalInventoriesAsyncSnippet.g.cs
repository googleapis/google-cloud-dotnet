...
{
    // [START merchantapi_v1_generated_RegionalInventoryService_ListRegionalInventories_async_flattened]
    using Google.Api.Gax;
    using Google.Shopping.Merchant.Inventories.V1;
    using System;
    ...
    public sealed partial class GeneratedRegionalInventoryServiceClientSnippets
    {
        ...
        public async Task ListRegionalInventoriesAsync()
        {
            ...
            await foreach (RegionalInventory item in response)
            {
            ...
            await foreach (ListRegionalInventoriesResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1_generated_RegionalInventoryService_ListRegionalInventories_async_flattened]
}
