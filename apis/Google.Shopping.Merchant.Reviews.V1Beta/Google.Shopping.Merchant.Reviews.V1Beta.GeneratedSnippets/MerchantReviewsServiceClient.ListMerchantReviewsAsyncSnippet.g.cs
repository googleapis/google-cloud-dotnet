...
{
    // [START merchantapi_v1beta_generated_MerchantReviewsService_ListMerchantReviews_async_flattened]
    ...
    public sealed partial class GeneratedMerchantReviewsServiceClientSnippets
    {
        ...
        public async Task ListMerchantReviewsAsync()
        {
            ...
            await foreach (MerchantReview item in response)
            {
            ...
            await foreach (ListMerchantReviewsResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_MerchantReviewsService_ListMerchantReviews_async_flattened]
}
