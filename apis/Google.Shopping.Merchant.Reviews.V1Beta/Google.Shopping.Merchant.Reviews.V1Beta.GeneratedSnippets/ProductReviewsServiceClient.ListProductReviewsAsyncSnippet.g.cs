...
{
    // [START merchantapi_v1beta_generated_ProductReviewsService_ListProductReviews_async_flattened]
    using Google.Api.Gax;
    using Google.Shopping.Merchant.Reviews.V1Beta;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedProductReviewsServiceClientSnippets
    {
        ...
        public async Task ListProductReviewsAsync()
        {
            ...
            await foreach (ProductReview item in response)
            {
            ...
            await foreach (ListProductReviewsResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_ProductReviewsService_ListProductReviews_async_flattened]
}
