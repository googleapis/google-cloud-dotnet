...
{
    // [START privilegedaccessmanager_v1_generated_PrivilegedAccessManager_ListGrants_async_flattened]
    ...
    public sealed partial class GeneratedPrivilegedAccessManagerClientSnippets
    {
        ...
        public async Task ListGrantsAsync()
        {
            ...
            await foreach (ListGrantsResponse page in response.AsRawResponses())
            {
    ...
    // [END privilegedaccessmanager_v1_generated_PrivilegedAccessManager_ListGrants_async_flattened]
}
