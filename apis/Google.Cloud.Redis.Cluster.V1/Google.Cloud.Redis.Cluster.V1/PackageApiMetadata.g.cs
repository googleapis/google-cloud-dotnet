...
namespace Google.Cloud.Redis.Cluster.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.Redis.Cluster.V1", GetFileDescriptors)
        ...
        private static scg::IEnumerable<gpr::FileDescriptor> GetFileDescriptors()
        {
            ...
            yield return CloudRedisClusterReflection.Descriptor;
