...
namespace Google.Cloud.Redis.Cluster.V1
{
    ...
    {
        /// <summary>
        /// <see cref="gcrcv::SharedRegionalCertificateAuthorityName"/>-typed view over the <see cref="Name"/> resource
        /// name property.
        /// </summary>
        public gcrcv::SharedRegionalCertificateAuthorityName SharedRegionalCertificateAuthorityName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcrcv::SharedRegionalCertificateAuthorityName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }
