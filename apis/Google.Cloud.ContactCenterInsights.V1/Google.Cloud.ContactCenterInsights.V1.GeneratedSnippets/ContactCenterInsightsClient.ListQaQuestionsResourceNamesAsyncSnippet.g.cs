...
{
    // [START contactcenterinsights_v1_generated_ContactCenterInsights_ListQaQuestions_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedContactCenterInsightsClientSnippets
    {
        ...
        public async Task ListQaQuestionsResourceNamesAsync()
        {
            ...
            await foreach (QaQuestion item in response)
            {
            ...
            await foreach (ListQaQuestionsResponse page in response.AsRawResponses())
            {
    ...
    // [END contactcenterinsights_v1_generated_ContactCenterInsights_ListQaQuestions_async_flattened_resourceNames]
}
