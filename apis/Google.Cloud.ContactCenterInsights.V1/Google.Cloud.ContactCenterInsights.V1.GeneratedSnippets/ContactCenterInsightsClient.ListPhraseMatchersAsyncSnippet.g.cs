...
{
    // [START contactcenterinsights_v1_generated_ContactCenterInsights_ListPhraseMatchers_async_flattened]
    ...
    public sealed partial class GeneratedContactCenterInsightsClientSnippets
    {
        ...
        public async Task ListPhraseMatchersAsync()
        {
            ...
            await foreach (PhraseMatcher item in response)
            {
            ...
            await foreach (ListPhraseMatchersResponse page in response.AsRawResponses())
            {
    ...
    // [END contactcenterinsights_v1_generated_ContactCenterInsights_ListPhraseMatchers_async_flattened]
}
