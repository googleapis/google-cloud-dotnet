...
{
    // [START contactcenterinsights_v1_generated_ContactCenterInsights_ListViews_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedContactCenterInsightsClientSnippets
    {
        ...
        public async Task ListViewsResourceNamesAsync()
        {
            ...
            await foreach (View item in response)
            {
            ...
            await foreach (ListViewsResponse page in response.AsRawResponses())
            {
    ...
    // [END contactcenterinsights_v1_generated_ContactCenterInsights_ListViews_async_flattened_resourceNames]
}
