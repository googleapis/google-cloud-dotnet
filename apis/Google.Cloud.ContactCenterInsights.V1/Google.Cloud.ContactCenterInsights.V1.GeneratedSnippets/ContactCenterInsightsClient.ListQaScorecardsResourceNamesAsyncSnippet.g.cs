...
{
    // [START contactcenterinsights_v1_generated_ContactCenterInsights_ListQaScorecards_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedContactCenterInsightsClientSnippets
    {
        ...
        public async Task ListQaScorecardsResourceNamesAsync()
        {
            ...
            await foreach (QaScorecard item in response)
            {
            ...
            await foreach (ListQaScorecardsResponse page in response.AsRawResponses())
            {
    ...
    // [END contactcenterinsights_v1_generated_ContactCenterInsights_ListQaScorecards_async_flattened_resourceNames]
}
