...
namespace Google.Maps.AddressValidation.V1
{
    ...
    public sealed partial class AddressValidationClientBuilder : gaxgrpc::ClientBuilderBase<AddressValidationClient>
    {
        ...
        private AddressValidationClient BuildImpl()
        {
            ...
            return AddressValidationClient.Create(callInvoker, Settings, Logger);
        }
    ...
    public abstract partial class AddressValidationClient
    {
        ...
        public static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(AddressValidation.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc | gax::ApiTransports.Rest, PackageApiMetadata.ApiMetadata);
