...
{
    // [START monitoring_v3_generated_ServiceMonitoringService_ListServiceLevelObjectives_async_flattened]
    ...
    public sealed partial class GeneratedServiceMonitoringServiceClientSnippets
    {
        ...
        public async Task ListServiceLevelObjectivesAsync()
        {
            ...
            await foreach (ServiceLevelObjective item in response)
            {
            ...
            await foreach (ListServiceLevelObjectivesResponse page in response.AsRawResponses())
            {
    ...
    // [END monitoring_v3_generated_ServiceMonitoringService_ListServiceLevelObjectives_async_flattened]
}
