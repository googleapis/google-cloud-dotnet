...
{
    // [START monitoring_v3_generated_SnoozeService_ListSnoozes_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedSnoozeServiceClientSnippets
    {
        ...
        public async Task ListSnoozesResourceNamesAsync()
        {
            ...
            await foreach (Snooze item in response)
            {
            ...
            await foreach (ListSnoozesResponse page in response.AsRawResponses())
            {
    ...
    // [END monitoring_v3_generated_SnoozeService_ListSnoozes_async_flattened_resourceNames]
}
