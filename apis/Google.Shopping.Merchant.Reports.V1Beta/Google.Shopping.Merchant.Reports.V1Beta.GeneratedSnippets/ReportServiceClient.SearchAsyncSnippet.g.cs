...
{
    // [START merchantapi_v1beta_generated_ReportService_Search_async_flattened]
    ...
    public sealed partial class GeneratedReportServiceClientSnippets
    {
        ...
        public async Task SearchAsync()
        {
            ...
            await foreach (ReportRow item in response)
            {
            ...
            await foreach (SearchResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1beta_generated_ReportService_Search_async_flattened]
}
