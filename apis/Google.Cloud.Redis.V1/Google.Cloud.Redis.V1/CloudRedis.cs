...
namespace Google.Cloud.Redis.V1 {
  ...
  public sealed partial class Instance : pb::IMessage<Instance> {
    ...
    private global::Google.Cloud.Redis.V1.Instance.Types.ConnectMode connectMode_ = 0;
    /// <summary>
