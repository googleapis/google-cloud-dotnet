...
{
    // [START datastream_v1_generated_Datastream_ListRoutes_async_flattened]
    ...
    public sealed partial class GeneratedDatastreamClientSnippets
    {
        ...
        public async Task ListRoutesAsync()
        {
            ...
            await foreach (Route item in response)
            {
            ...
            await foreach (ListRoutesResponse page in response.AsRawResponses())
            {
    ...
    // [END datastream_v1_generated_Datastream_ListRoutes_async_flattened]
}
