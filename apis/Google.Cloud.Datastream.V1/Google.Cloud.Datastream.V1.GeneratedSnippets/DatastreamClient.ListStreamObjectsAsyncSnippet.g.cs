...
{
    // [START datastream_v1_generated_Datastream_ListStreamObjects_async_flattened]
    ...
    public sealed partial class GeneratedDatastreamClientSnippets
    {
        ...
        public async Task ListStreamObjectsAsync()
        {
            ...
            await foreach (StreamObject item in response)
            {
            ...
            await foreach (ListStreamObjectsResponse page in response.AsRawResponses())
            {
    ...
    // [END datastream_v1_generated_Datastream_ListStreamObjects_async_flattened]
}
