...
namespace Google.Cloud.Billing.V1
{
    ...
    public sealed partial class CloudCatalogSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        public gaxgrpc::CallSettings ListServicesSettings { get; set; }
        ...
        /// </summary>
        /// <remarks>By default, retry will not be attempted.</remarks>
        public gaxgrpc::CallSettings ListSkusSettings { get; set; }
    ...
    public sealed partial class CloudCatalogClientBuilder : gaxgrpc::ClientBuilderBase<CloudCatalogClient>
    {
        ...
        /// <inheritdoc/>
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => CloudCatalogClient.DefaultEndpoint;
    ...
    public abstract partial class CloudCatalogClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="CloudCatalogClient"/>, applying defaults for all unspecified settings, 
        ...
        public static async stt::Task<CloudCatalogClient> CreateAsync(gaxgrpc::ServiceEndpoint endpoint = null, CloudCatalogSettings settings = null)
        {
        ...
        /// <summary>
        /// Synchronously creates a <see cref="CloudCatalogClient"/>, applying defaults for all unspecified settings, 
        /// and creating a channel connecting to the given endpoint with application default credentials where 
        /// necessary. See the example for how to use custom credentials.
        /// </summary>
        /// <example>
        ...
        public static CloudCatalogClient Create(gaxgrpc::ServiceEndpoint endpoint = null, CloudCatalogSettings settings = null)
        {
        ...
        /// <summary>
        /// Creates a <see cref="CloudCatalogClient"/> which uses the specified channel for remote operations.
        /// </summary>
        /// <param name="channel">The <see cref="grpccore::Channel"/> for remote operations. Must not be null.</param>
        /// <param name="settings">Optional <see cref="CloudCatalogSettings"/>.</param>
        /// <returns>The created <see cref="CloudCatalogClient"/>.</returns>
        public static CloudCatalogClient Create(grpccore::Channel channel, CloudCatalogSettings settings = null)
        {
        ...
        /// <see cref="Create(grpccore::CallInvoker,CloudCatalogSettings)"/> and
        /// <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,CloudCatalogSettings)"/>. Channels which weren't
        /// automatically created are not affected.
        /// </summary>
        /// <remarks>
        /// After calling this method, further calls to <see cref="Create(grpccore::CallInvoker,CloudCatalogSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint,CloudCatalogSettings)"/> will create new channels, which
