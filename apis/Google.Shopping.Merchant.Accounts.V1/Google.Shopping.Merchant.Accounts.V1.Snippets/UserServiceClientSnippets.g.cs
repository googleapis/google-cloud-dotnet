...
namespace GoogleCSharpSnippets
{
    ...
    public sealed class AllGeneratedUserServiceClientSnippets
    {
        ...
        {
            // Snippet: CreateUser(AccountName, User, string, CallSettings)
            // Create client
            UserServiceClient userServiceClient = UserServiceClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: CreateUserAsync(AccountName, User, string, CallSettings)
            // Additional: CreateUserAsync(AccountName, User, string, CancellationToken)
            // Create client
            UserServiceClient userServiceClient = await UserServiceClient.CreateAsync();
            // Initialize request argument(s)
            AccountName parent = AccountName.FromAccount("[ACCOUNT]");
