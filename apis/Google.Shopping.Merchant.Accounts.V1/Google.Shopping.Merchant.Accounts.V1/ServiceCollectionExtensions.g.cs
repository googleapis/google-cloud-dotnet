...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds a singleton <see cref="gsmav::AccountRelationshipsServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddAccountRelationshipsServiceClient(this IServiceCollection services, sys::Action<gsmav::AccountRelationshipsServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gsmav::AccountRelationshipsServiceClientBuilder builder = new gsmav::AccountRelationshipsServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddAccountRelationshipsServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gsmav::AccountRelationshipsServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gsmav::AccountRelationshipsServiceClientBuilder builder = new gsmav::AccountRelationshipsServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gsmav::AccountServicesServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddAccountServicesServiceClient(this IServiceCollection services, sys::Action<gsmav::AccountServicesServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gsmav::AccountServicesServiceClientBuilder builder = new gsmav::AccountServicesServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddAccountServicesServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gsmav::AccountServicesServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gsmav::AccountServicesServiceClientBuilder builder = new gsmav::AccountServicesServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gsmav::CheckoutSettingsServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddCheckoutSettingsServiceClient(this IServiceCollection services, sys::Action<gsmav::CheckoutSettingsServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gsmav::CheckoutSettingsServiceClientBuilder builder = new gsmav::CheckoutSettingsServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddCheckoutSettingsServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gsmav::CheckoutSettingsServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gsmav::CheckoutSettingsServiceClientBuilder builder = new gsmav::CheckoutSettingsServiceClientBuilder();
                action?.Invoke(provider, builder);
        ...
        /// <summary>
        /// Adds a singleton <see cref="gsmav::DeveloperRegistrationServiceClient"/> to <paramref name="services"/>.
        /// </summary>
        /// <param name="services">
        /// The service collection to add the client to. The services are used to configure the client when requested.
        /// </param>
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddDeveloperRegistrationServiceClient(this IServiceCollection services, sys::Action<gsmav::DeveloperRegistrationServiceClientBuilder> action = null) =>
            services.AddSingleton(provider =>
            {
                gsmav::DeveloperRegistrationServiceClientBuilder builder = new gsmav::DeveloperRegistrationServiceClientBuilder();
                action?.Invoke(builder);
                return builder.Build(provider);
            });
        ...
        /// <paramref name="services"/> are used.
        /// </param>
        public static IServiceCollection AddDeveloperRegistrationServiceClient(this IServiceCollection services, sys::Action<sys::IServiceProvider, gsmav::DeveloperRegistrationServiceClientBuilder> action) =>
            services.AddSingleton(provider =>
            {
                gsmav::DeveloperRegistrationServiceClientBuilder builder = new gsmav::DeveloperRegistrationServiceClientBuilder();
                action?.Invoke(provider, builder);
