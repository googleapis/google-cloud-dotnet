...
namespace Google.Shopping.Merchant.Accounts.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Shopping.Merchant.Accounts.V1", GetFileDescriptors)
        ...
        private static scg::IEnumerable<gpr::FileDescriptor> GetFileDescriptors()
        {
            ...
            yield return AccountrelationshipsReflection.Descriptor;
            ...
            yield return DeveloperregistrationReflection.Descriptor;
