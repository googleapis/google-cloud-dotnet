...
{
    // [START merchantapi_v1_generated_AccountServicesService_ListAccountServices_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedAccountServicesServiceClientSnippets
    {
        ...
        public async Task ListAccountServicesResourceNamesAsync()
        {
            ...
            await foreach (AccountService item in response)
            {
            ...
            await foreach (ListAccountServicesResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1_generated_AccountServicesService_ListAccountServices_async_flattened_resourceNames]
}
