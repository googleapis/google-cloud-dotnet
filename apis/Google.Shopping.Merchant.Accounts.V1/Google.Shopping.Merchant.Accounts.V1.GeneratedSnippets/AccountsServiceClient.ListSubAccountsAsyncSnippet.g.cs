...
{
    // [START merchantapi_v1_generated_AccountsService_ListSubAccounts_async_flattened]
    ...
    public sealed partial class GeneratedAccountsServiceClientSnippets
    {
        ...
        public async Task ListSubAccountsAsync()
        {
            ...
            await foreach (ListSubAccountsResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1_generated_AccountsService_ListSubAccounts_async_flattened]
}
