...
{
    // [START merchantapi_v1_generated_LfpProvidersService_FindLfpProviders_async_flattened_resourceNames]
    using Google.Api.Gax;
    using Google.Shopping.Merchant.Accounts.V1;
    using System;
    using System.Threading.Tasks;

    public sealed partial class GeneratedLfpProvidersServiceClientSnippets
    {
        ...
        public async Task FindLfpProvidersResourceNamesAsync()
        {
            ...
            await foreach (LfpProvider item in response)
            {
            ...
            await foreach (FindLfpProvidersResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1_generated_LfpProvidersService_FindLfpProviders_async_flattened_resourceNames]
}
