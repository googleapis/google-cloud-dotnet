...
{
    // [START merchantapi_v1_generated_AccountRelationshipsService_ListAccountRelationships_async]
    ...
    public sealed partial class GeneratedAccountRelationshipsServiceClientSnippets
    {
        ...
        public async Task ListAccountRelationshipsRequestObjectAsync()
        {
            ...
            await foreach (AccountRelationship item in response)
            {
            ...
            await foreach (ListAccountRelationshipsResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1_generated_AccountRelationshipsService_ListAccountRelationships_async]
}
