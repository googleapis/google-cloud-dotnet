...
{
    // [START merchantapi_v1_generated_GbpAccountsService_ListGbpAccounts_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedGbpAccountsServiceClientSnippets
    {
        ...
        public async Task ListGbpAccountsResourceNamesAsync()
        {
            ...
            await foreach (GbpAccount item in response)
            {
            ...
            await foreach (ListGbpAccountsResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1_generated_GbpAccountsService_ListGbpAccounts_async_flattened_resourceNames]
}
