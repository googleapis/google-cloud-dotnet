...
{
    // [START merchantapi_v1_generated_OnlineReturnPolicyService_ListOnlineReturnPolicies_async_flattened_resourceNames]
    ...
    public sealed partial class GeneratedOnlineReturnPolicyServiceClientSnippets
    {
        ...
        public async Task ListOnlineReturnPoliciesResourceNamesAsync()
        {
            ...
            await foreach (OnlineReturnPolicy item in response)
            {
            ...
            await foreach (ListOnlineReturnPoliciesResponse page in response.AsRawResponses())
            {
    ...
    // [END merchantapi_v1_generated_OnlineReturnPolicyService_ListOnlineReturnPolicies_async_flattened_resourceNames]
}
