...
namespace Google.Cloud.BigQuery.V2
{
    ...
    public abstract class JobCreationOptions
    {
        ...
        /// If specified, this is used to associates the job with a given session.
        /// </summary>
        public string SessionId { get; set; }

        /// <summary>
        /// If true, creates a new session, where the session ID will be generated by the serve.
        ...
        /// <summary>
        /// Creates a list of <see cref="ConnectionProperty"/> i.e ConnectionProperties.
        /// Currently only SessionId is supported in connection property.
        /// For more information refer to https://cloud.google.com/bigquery/docs/reference/rest/v2/ConnectionProperty.
        /// </summary>
        protected IList<ConnectionProperty> GetConnectionProperties()
        {
            ...
            return new ConnectionProperty[] { cp };
        }
    }
}
