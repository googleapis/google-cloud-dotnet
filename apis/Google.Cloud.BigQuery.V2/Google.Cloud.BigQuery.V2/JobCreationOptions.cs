...
namespace Google.Cloud.BigQuery.V2
{
    ...
    public abstract class JobCreationOptions
    {
        ...
        /// <summary>
        /// Execute the JobConfigurationModifier, if it is not null.
        /// </summary>
        /// <param name="jobConfiguration"></param>
        internal virtual void ModifyJobConfiguration(JobConfiguration jobConfiguration) => JobConfigurationModifier?.Invoke(jobConfiguration);
    }
}
