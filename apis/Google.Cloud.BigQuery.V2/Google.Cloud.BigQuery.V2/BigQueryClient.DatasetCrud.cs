...
namespace Google.Cloud.BigQuery.V2
{
    public abstract partial class BigQueryClient
    {
        ...
        /// This method just creates a <see cref="DatasetReference"/> and delegates to <see cref="GetOrCreateDataset(DatasetReference, GetDatasetOptions, Dataset, CreateDatasetOptions)"/>.
        /// </summary>
        /// <remarks>
        /// If <paramref name="resource" /><see cref="Dataset.DatasetReference" /> is specified, then it must be the same as the <see cref="DatasetReference" /> obtained from the other parameters.
        /// </remarks>
        ...
        public virtual BigQueryDataset GetOrCreateDataset(string datasetId, GetDatasetOptions getOptions = null, Dataset resource = null, CreateDatasetOptions createOptions = null) =>
            GetOrCreateDataset(GetDatasetReference(datasetId), getOptions, resource, createOptions);
        ...
        /// <param name="createOptions">The options for the "create" operation. May be null, in which case defaults will be supplied.</param>
        /// <returns>The existing or new dataset.</returns>
        public virtual BigQueryDataset GetOrCreateDataset(string projectId, string datasetId, GetDatasetOptions getOptions = null, Dataset resource = null, CreateDatasetOptions createOptions = null) =>
            GetOrCreateDataset(GetDatasetReference(projectId, datasetId), getOptions, resource, createOptions);
        ...
        /// <param name="createOptions">The options for the "create" operation. May be null, in which case defaults will be supplied.</param>
        /// <returns>The existing or new dataset.</returns>
        public virtual BigQueryDataset GetOrCreateDataset(DatasetReference datasetReference, GetDatasetOptions getOptions = null, Dataset resource = null, CreateDatasetOptions createOptions = null) =>
            throw new NotImplementedException();
        
        /// <summary>
        /// Asynchronously attempts to fetch the specified dataset within this client's project, creating it if it doesn't exist.
        /// This method just creates a <see cref="DatasetReference"/> and delegates to <see cref="GetOrCreateDatasetAsync(DatasetReference, GetDatasetOptions, Dataset, CreateDatasetOptions, CancellationToken)"/>.
        /// </summary>
        /// <remarks>
        /// If <paramref name="resource" /><see cref="Dataset.DatasetReference" /> is specified, then it must be the same as the <see cref="DatasetReference" /> obtained from the other parameters.
        /// </remarks>
        ...
        public virtual Task<BigQueryDataset> GetOrCreateDatasetAsync(string datasetId, GetDatasetOptions getOptions = null, Dataset resource = null, CreateDatasetOptions createOptions = null, CancellationToken cancellationToken = default) =>
            GetOrCreateDatasetAsync(GetDatasetReference(datasetId), getOptions, resource, createOptions, cancellationToken);
        ...
        /// <returns>A task representing the asynchronous operation. When complete, the result is
        /// the existing or new dataset.</returns>
        public virtual Task<BigQueryDataset> GetOrCreateDatasetAsync(string projectId, string datasetId, GetDatasetOptions getOptions = null, Dataset resource = null, CreateDatasetOptions createOptions = null, CancellationToken cancellationToken = default) =>
            GetOrCreateDatasetAsync(GetDatasetReference(projectId, datasetId), getOptions, resource, createOptions, cancellationToken);
        ...
        /// <returns>A task representing the asynchronous operation. When complete, the result is
        /// the existing or new dataset.</returns>
        public virtual Task<BigQueryDataset> GetOrCreateDatasetAsync(DatasetReference datasetReference, GetDatasetOptions getOptions = null, Dataset resource = null, CreateDatasetOptions createOptions = null, CancellationToken cancellationToken = default) =>
            throw new NotImplementedException();
        #endregion
