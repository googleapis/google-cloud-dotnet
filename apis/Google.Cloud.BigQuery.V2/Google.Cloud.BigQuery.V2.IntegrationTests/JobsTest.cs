...
namespace Google.Cloud.BigQuery.V2.IntegrationTests
{
    ...
    public class JobsTest
    {
        ...
        public void GetJob_JobLabels()
        {
            var client = BigQueryClient.Create(_fixture.ProjectId);
            var table = client.GetTable(_fixture.ProjectId, _fixture.DatasetId, _fixture.HighScoreTableId);
            var options = new QueryOptions { Labels = JobLabels, JobConfigurationModifier = jobConfiguration => jobConfiguration.Reservation = Reservation };
        ...
        public void ExtractJob_Labels()
        {
            ...
            var destinationObject = _fixture.GenerateStorageObjectName();
            var destinationUri = $"gs://{destinationBucket}/{destinationObject}";
            var options = new CreateExtractJobOptions { Labels = JobLabels, JobConfigurationModifier = jobConfiguration => jobConfiguration.Reservation = Reservation };
        ...
        public void CopyJob_Labels()
        {
            ...
            var options = new CreateCopyJobOptions { Labels = JobLabels, JobConfigurationModifier = jobConfiguration => jobConfiguration.Reservation = Reservation };
        ...
        public void LoadJob_Labels()
        {
            ...
            var loadJob = bqClient.CreateLoadJob(
                ...
                new CreateLoadJobOptions { SkipLeadingRows = 1, Labels = JobLabels, JobConfigurationModifier = jobConfiguration => jobConfiguration.Reservation = Reservation });
