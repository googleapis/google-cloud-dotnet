...
namespace Google.Cloud.ManagedIdentities.V1
{
    ...
    internal static class PackageApiMetadata
    {
        ...
        internal static gaxgrpc::ApiMetadata ApiMetadata { get; } = new gaxgrpc::ApiMetadata("Google.Cloud.ManagedIdentities.V1", GetFileDescriptors)
            ...
            .WithHttpRuleOverrides(new scg::Dictionary<string, proto::ByteString>
            {
                ...
                },
                {
                    ...
                    // { "get": "/v1/{name=projects/*/locations/global/operations}" }
                    proto::ByteString.FromBase64("EjEvdjEve25hbWU9cHJvamVjdHMvKi9sb2NhdGlvbnMvZ2xvYmFsL29wZXJhdGlvbnN9")
                },
            });
