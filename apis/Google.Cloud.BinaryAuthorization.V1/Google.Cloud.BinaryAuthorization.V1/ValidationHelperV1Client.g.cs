...
namespace Google.Cloud.BinaryAuthorization.V1
{
    ...
    public abstract partial class ValidationHelperV1Client
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(ValidationHelperV1.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
