...
namespace Google.Cloud.BinaryAuthorization.V1
{
    ...
    public abstract partial class BinauthzManagementServiceV1Client
    {
        ...
        internal static gaxgrpc::ServiceMetadata ServiceMetadata { get; } = new gaxgrpc::ServiceMetadata(BinauthzManagementServiceV1.Descriptor, DefaultEndpoint, DefaultScopes, true, gax::ApiTransports.Grpc, PackageApiMetadata.ApiMetadata);
