...
namespace Google.Cloud.BinaryAuthorization.V1.Tests
{
    ...
    public sealed class GeneratedBinauthzManagementServiceV1ClientTest
    {
        [xunit::FactAttribute]
        public void GetPolicyRequestObject()
        {
            moq::Mock<BinauthzManagementServiceV1.BinauthzManagementServiceV1Client> mockGrpcClient = new moq::Mock<BinauthzManagementServiceV1.BinauthzManagementServiceV1Client>(moq::MockBehavior.Strict);
            ...
            BinauthzManagementServiceV1Client client = new BinauthzManagementServiceV1ClientImpl(mockGrpcClient.Object, null, null);
        ...
        public void CreateAttestorRequestObject()
        {
            ...
            Attestor expectedResponse = new Attestor
            {
                ...
                UserOwnedGrafeasNote = new UserOwnedGrafeasNote(),
                UpdateTime = new wkt::Timestamp(),
                Description = "description2cf9da67",
            };
