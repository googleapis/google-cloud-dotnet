...
{
    // TODO: Add analyzers to the test projects so this can be used there, but include a ruleset file so we can turn off the other
    //       analyzers which shouldn't apply to tests.
    /// <summary>
