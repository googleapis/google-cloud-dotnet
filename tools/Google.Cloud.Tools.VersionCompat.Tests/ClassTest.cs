...
namespace Class
{
    namespace NoChange.A { public class C { public C() { } } }
    namespace NoChange.B { public class C { public C() { } } }

    namespace ToStatic.A { public class C { public C() { } } }
    ...
    namespace ToSealed.A { public class C { public C() { } } }
    namespace ToSealed.B { public sealed class C { public C() { } } }
    ...
    namespace FromSealed.A { public sealed class C { public C() { } } }
    namespace FromSealed.B { public class C { public C() { } } }
...
namespace Google.Cloud.Tools.VersionCompat.Tests
{
    public class ClassTest : TestBase
    {
        ...
        // TOOD: Enable this test after ctors are dealt with properly.
        // [Fact] public void ToStatic() => TestMajor(Cause.ClassModifierChanged);
        [Fact] public void ToStaticNoCtor() => TestNone();
