...
namespace TrimCoverageReport
{
    ...
    internal class Program
    {
        ...
        private const string TotalStatements = "TotalStatements";
        private const string CoveredStatements = "CoveredStatements";
        private const string CoveragePercent = "CoveragePercent";
        ...
        private static void ProcessDocument(XDocument document)
        {
        ...
        private static bool IsGeneratedFile(string path) =>
            File.ReadLines(path).Take(20).Any(line => line.StartsWith("// Generated") || line.StartsWith("// <auto-generated>"));
    }
}
